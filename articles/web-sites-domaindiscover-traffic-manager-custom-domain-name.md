<properties 
	pageTitle="Configuration d'un nom de domaine DomainDiscover pour un site Web Azure utilisant Traffic Manager" 
	description="Découvrez comment configurer un site Web Azure qui se sert de Traffic Manager pour utiliser un nom de domaine enregistré avec DomainDiscover - TierraNet" 
	services="web-sites" 
	documentationCenter="" 
	authors="blackmist" 
	manager="wpickett" 
...
Cet article contient des instructions permettant d'utiliser un nom de domaine personnalisé acheté auprès de [DomainDiscover.com](https://domaindiscover.com) avec Sites Web Azure. DomainDiscover.com fait partie de [TierraNet](https://www.tierra.net/).
