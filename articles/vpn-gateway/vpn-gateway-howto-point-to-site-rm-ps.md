...
![Diagramme point à site](./media/vpn-gateway-howto-point-to-site-rm-ps/p2srm.png "point à site")
...
## Partie 2 - Configuration d’un réseau virtuel 
...
## Partie 3 - Ajout de certificats approuvés
...
## Partie 4 - Création de la passerelle VPN
...
## Partie 5 - Téléchargement du package de configuration du client VPN
...
2. Dans la page de statut **Connexion**, cliquez sur **Connecter** pour démarrer la connexion. Si un écran **Sélectionner un certificat** apparaît, vérifiez que le certificat client affiché est celui que vous souhaitez utiliser pour la connexion. Dans le cas contraire, utilisez la flèche déroulante pour sélectionner le certificat approprié, puis cliquez sur **OK**.
	...
	![Client VPN 2](./media/vpn-gateway-howto-point-to-site-rm-ps/clientconnect.png "Connexion client VPN")
