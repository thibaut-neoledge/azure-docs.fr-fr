---
title: À propos des paramètres des passerelles VPN de réseau virtuel | Microsoft Docs
...
## <a name="<a-name="gwtype"></a>gateway-types"></a><a name="gwtype"></a>Types de passerelle
...
Si vous voulez mettre à niveau votre référence SKU de passerelle vers une plus puissante (De base/Standard vers HighPerformance) en utilisant l’applet de commande PowerShell `Resize-AzureRmVirtualNetworkGateway` . Vous pouvez également réduire la taille de référence SKU à l’aide de cet applet de commande.
...
## <a name="<a-name="connectiontype"></a>connection-types"></a><a name="connectiontype"></a>Types de connexion
...
## <a name="<a-name="vpntype"></a>vpn-types"></a><a name="vpntype"></a>Types de VPN
...
## <a name="<a-name="requirements"></a>gateway-requirements"></a><a name="requirements"></a>Conditions requises de la passerelle
[!INCLUDE [vpn-gateway-table-requirements](../../includes/vpn-gateway-table-requirements-include.md)]

## <a name="<a-name="gwsub"></a>gateway-subnet"></a><a name="gwsub"></a>Sous-réseau de passerelle
...
## <a name="<a-name="lng"></a>local-network-gateways"></a><a name="lng"></a>Passerelles de réseau local
