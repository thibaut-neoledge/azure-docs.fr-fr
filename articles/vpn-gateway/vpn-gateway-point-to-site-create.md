...
---
# <a name="configure-a-pointtosite-connection-to-a-vnet-using-the-classic-portal"></a>Configuration d’une connexion de point à site à un réseau virtuel à l’aide du portail Classic
