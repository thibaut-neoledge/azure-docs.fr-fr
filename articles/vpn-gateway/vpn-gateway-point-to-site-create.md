---
title: Configuration d’une connexion par passerelle VPN point à site à un réseau virtuel à l’aide du portail Classic | Microsoft Docs
...
---
# <a name="configure-a-point-to-site-connection-to-a-vnet-using-the-classic-portal"></a>Configuration d’une connexion de point à site à un réseau virtuel à l’aide du portail Classic
...
Cet article vous guide dans le processus de création d’un réseau virtuel avec une connexion de point à site dans le **modèle de déploiement Classic** à l’aide du **portail Classic**.
...
![Diagramme point à site](./media/vpn-gateway-point-to-site-create/p2sclassic.png "point-to-site")

## <a name="about-creating-a-point-to-site-connection"></a>À propos de la création d’une connexion point à site
...
## <a name="<a-name="vnetvpn"></a>section-1---create-a-virtual-network-and-a-vpn-gateway"></a><a name="vnetvpn"></a>Section 1 : créer un réseau virtuel et une passerelle VPN
...
## <a name="<a-name="generate"></a>section-2---generate-and-upload-certificates"></a><a name="generate"></a>Section 2 : générer et télécharger des certificats
...
### <a name="<a-name="root"></a>part-1:-obtain-the-.cer-file-for-the-root-certificate"></a><a name="root"></a>Partie 1 : obtenir le fichier .cer pour le certificat racine
...
### <a name="<a-name="upload"></a>part-2:-upload-the-root-certificate-.cer-file-to-the-azure-classic-portal"></a><a name="upload"></a>Partie 2 : charger le fichier de certificat racine .cert dans le portail Azure Classic
...
### <a name="<a-name="createclientcert"></a>part-3:-generate-a-client-certificate"></a><a name="createclientcert"></a>Partie 3 : générer un certificat client
...
## <a name="<a-name="installclientcert"></a>section-3---export-and-install-the-client-certificate"></a><a name="installclientcert"></a>Section 3 : exporter et installer le certificat client
...
## <a name="<a-name="vpnclientconfig"></a>section-4---configure-your-vpn-client"></a><a name="vpnclientconfig"></a>Section 4 : configurer votre client VPN
