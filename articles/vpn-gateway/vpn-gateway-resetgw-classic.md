...
## Réinitialiser une passerelle VPN avec le modèle de déploiement Gestion des ressources
...
## Réinitialiser une passerelle VPN avec le modèle de déploiement classique
