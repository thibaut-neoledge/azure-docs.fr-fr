---
title: "Créer et exporter des certificats pour les connexions de point à site : makecert : Azure | Microsoft Docs"
...
> [!NOTE]
> N’utilisez ces instructions que lorsque vous n’avez pas accès à un ordinateur Windows 10 pour générer des certificats auto-signés pour des connexions de point à site. Makecert est déconseillé. En outre, makecert ne peut pas créer un certificat SHA-2, uniquement SHA-1 (qui est toujours valide pour P2S). Pour ces raisons, il est recommandé d’utiliser les [étapes PowerShell](vpn-gateway-certificates-point-to-site.md), si possible. Les certificats que vous créez à l’aide de PowerShell ou makecert peuvent être installés sur n’importe quel [système d’exploitation client pris en charge](vpn-gateway-howto-point-to-site-resource-manager-portal.md#faq), pas seulement sur le système d’exploitation que vous avez utilisé pour les créer.
>
>
...
1. Téléchargez et installez [makecert](https://msdn.microsoft.com/en-us/library/windows/desktop/aa386968(v=vs.85).aspx).
