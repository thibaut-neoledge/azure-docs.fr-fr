...
### <a name="a-namecompareacross-premises-connectivity-options"></a><a name="compare"></a>Options de connectivité intersite
...
### <a name="a-namegwrequireagateway-requirements-by-vpn-type-and-sku"></a><a name="gwrequire"></a>Configuration requise de la passerelle par type de VPN et SKU
...
### <a name="a-namewfaworkflow"></a><a name="wf"></a>Flux de travail
...
### <a name="a-nametopologiesaconnection-topologies"></a><a name="topologies"></a>Topologies de connexion
...
### <a name="a-namedesignbasicsadesign-basics"></a><a name="designbasics"></a>Concepts de base
...
#### <a name="a-namesubnetsaabout-subnets"></a><a name="subnets"></a>À propos des sous-réseaux
...
#### <a name="a-namelocalaabout-local-network-gateways"></a><a name="local"></a>À propos des passerelles de réseau local
...
#### <a name="a-namegwtypeaabout-gateway-types"></a><a name="gwtype"></a>À propos des types de passerelles
...
#### <a name="a-nameconnectiontypeaabout-connection-types"></a><a name="connectiontype"></a>À propos des types de connexions
...
#### <a name="a-namevpntypeaabout-vpn-types"></a><a name="vpntype"></a>À propos des types de VPN
...
### <a name="a-namedevicesavpn-devices-for-site-to-site-connections"></a><a name="devices"></a>Périphériques VPN et connexions de site à site
...
### <a name="a-nameforcedtunnelaconsider-forced-tunnel-routing"></a><a name="forcedtunnel"></a>Envisager le routage avec tunneling forcé
