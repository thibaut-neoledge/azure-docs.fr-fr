...
Les sections suivantes présentent les principes de base d’une passerelle VPN. Voir également [Limitations des services de mise en réseau](../articles/azure-subscription-service-limits.md#networking-limits).
