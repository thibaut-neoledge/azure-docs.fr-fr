...
---
# <a name="create-a-vnet-with-a-sitetosite-connection-using-the-azure-portal"></a>Création d’un réseau virtuel avec une connexion de site à site à l’aide du portail Azure
...
### <a name="a-namevaluesasample-configuration-values-for-this-exercise"></a><a name="values"></a>Exemples de valeurs de configuration pour cet exercice
...
## <a name="a-namecreatvneta1-create-a-virtual-network"></a><a name="CreatVNet"></a>1. Créez un réseau virtuel
...
## <a name="a-namesubnetsa2-add-additional-address-space-and-subnets"></a><a name="subnets"></a>2. Ajouter des sous-réseaux et des espaces d’adressage supplémentaires
...
## <a name="a-namednsa3-specify-a-dns-server"></a><a name="dns"></a>3. Spécifier un serveur DNS
### <a name="to-specify-a-dns-server"></a>Pour spécifier un serveur DNS
[!INCLUDE [vpn-gateway-add-dns-rm-portal](../../includes/vpn-gateway-add-dns-rm-portal-include.md)]

## <a name="a-namegatewaysubneta4-create-a-gateway-subnet"></a><a name="gatewaysubnet"></a>4. Créer un sous-réseau de passerelle
...
## <a name="a-namelocalnetworkgatewaya6-create-a-local-network-gateway"></a><a name="LocalNetworkGateway"></a>6. Créer une passerelle de réseau local
...
## <a name="a-namevpndevicea7-configure-your-vpn-device"></a><a name="VPNDevice"></a>7. Configuration de votre périphérique VPN
[!INCLUDE [vpn-gateway-configure-vpn-device-rm](../../includes/vpn-gateway-configure-vpn-device-rm-include.md)]

## <a name="a-namecreateconnectiona8-create-a-sitetosite-vpn-connection"></a><a name="CreateConnection"></a>8. Créer une connexion VPN de site à site.
...
## <a name="a-nameverifyconnectiona9-verify-the-vpn-connection"></a><a name="VerifyConnection"></a>9. Vérifier la connexion VPN
