---
title: "Configurer une passerelle VPN dans le portail Azure Classic | Microsoft Azure"
...
---
# <a name="configure-a-vpn-gateway-for-the-classic-deployment-model"></a>Configurer une passerelle VPN pour le modèle de déploiement classique
...
2. [Collecter des informations pour la configuration de votre périphérique VPN](#gather-information-for-your-vpn-device-configuration)
3. [Configurer votre périphérique VPN](#configure-your-vpn-device)
4. [Vérifier vos plages de réseau local et l’adresse IP de la passerelle VPN](#verify-your-local-network-ranges-and-vpn-gateway-ip-address)
...
## <a name="gather-information-for-your-vpn-device-configuration"></a>Collecter des informations pour la configuration de votre périphérique VPN
...
## <a name="verify-your-local-network-ranges-and-vpn-gateway-ip-address"></a>Vérifier vos plages de réseau local et l’adresse IP de la passerelle VPN
...
Vous pouvez ajouter des machines virtuelles à votre réseau virtuel. Consultez [Création d’une machine virtuelle personnalisée](../virtual-machines/virtual-machines-windows-classic-createportal.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json).
