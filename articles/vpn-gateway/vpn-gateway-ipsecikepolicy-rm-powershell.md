...
> [!IMPORTANT]
> 1. Notez qu’une stratégie IPsec/IKE fonctionne uniquement sur des passerelles VPN ***Standard*** et ***HighPerformance*** ***Basées sur itinéraires***.
...
| Durée de vie de l’AS en mode rapide*  | Secondes (entier) et Ko (entier)                                      |
