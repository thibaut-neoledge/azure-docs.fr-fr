...
Les réseaux privés virtuels PolicyBased [AZURE.INCLUDE [vpn-gateway-gwsku-include](../../includes/vpn-gateway-gwsku-include.md)] ne peuvent être créés uniquement pour les passerelles à l’aide de la référence SKU de base.
