...
## <a name="a-namediagramsaconnection-topology-diagrams"></a><a name="diagrams"></a>Diagrammes de topologie de connexion
...
### <a name="site-to-site-and-multi-site-connections"></a>Connexions site à site et multi-sites
#### <a name="a-names2sasite-to-site"></a><a name="S2S"></a>Site à site
...
#### <a name="a-namemultiamulti-site"></a><a name="Multi"></a>Multi-sites
...
### <a name="a-namev2vavnet-to-vnet-connections"></a><a name="V2V"></a>Connexions de réseau virtuel à réseau virtuel
...
### <a name="a-namecoexistingasite-to-site-and-expressroute-coexisting-connections"></a><a name="coexisting"></a>Coexistence de connexions ExpressRoute et de site à site
