<properties 
   pageTitle="Débogage d’Azure Cloud Services | azure.microsoft.com/ Azure"
...
Vous pouvez utiliser différentes approches pour déboguer une application Azure à l’aide des outils Azure pour azure.microsoft.com/ Visual Studio et du Kit de développement logiciel (SDK) Azure :
...
- Si vous utilisez Visual Studio Enterprise pour écrire des rôles ciblés sur .NET Framework 4 ou .NET Framework 4.5, vous pouvez activer IntelliTrace au moment où vous déployez un service cloud Azure depuis Visual Studio. IntelliTrace fournit un journal que vous pouvez utiliser avec Visual Studio pour déboguer votre application comme si elle s’exécutait dans Azure. Pour plus d’informations, consultez [Débogage d’un service cloud publié avec IntelliTrace et Visual Studio](http://go.azure.microsoft.com/.com/fwlink/p/?LinkId=623016).
