...
**Remarque :** si vous devez installer Python ou les bibliothèques clientes, consultez le [Guide d'installation de Python](http://windowsazure.com/fr-fr/documentation/articles/python-how-to-install).
