...
La **mise en réseau hybride** fait partie de l'**Infrastructure**, qui est décrite en détail dans le document de l'architecture CPIF. 
...
[Mise en réseau hybride(pdf)](https://gallery.technet.microsoft.com/Cloud-Platform-Integration-5e401f38)
