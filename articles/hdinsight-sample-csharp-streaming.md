<properties 
	...
	description="Comment écrire des programmes MapReduce en langage C# qui utilise l'interface de diffusion Hadoop et comment les exécuter sur Azure HDInsight en utilisant des cmdlets Azure PowerShell." 
	editor="cgronlun" 
	manager="paulettm" 
	services="hdinsight" 
	documentationCenter="" 
...
# Exemple MapReduce WordCount (comptage de mots) de diffusion en continu C# dans Hadoop dans HDInsight
...
**Pour exécuter la tâche MapReduce, veuillez procéder comme suit**
