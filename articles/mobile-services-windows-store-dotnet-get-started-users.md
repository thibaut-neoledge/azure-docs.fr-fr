...
Ce didacticiel est basé sur le démarrage rapide de Mobile Services. Vous devez aussi commencer par suivre le didacticiel [Prise en main de Mobile Services](/fr-fr/documentation/articles/mobile-services-windows-store-get-started/).
...
1.  Dans Visual Studio 2012 Express pour Windows 8, ouvrez le projet que vous avez créé lorsque vous avez suivi le didacticiel [Prise en main de Mobile Services](/fr-fr/documentation/articles/mobile-services-windows-store-get-started).
