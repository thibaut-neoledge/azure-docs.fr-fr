...
Notez que les opérations **Insertion ou remplacement entité** et **Insertion ou fusion entité** ne procèdent *not* à des vérifications d'accès concurrentiel étant donné qu'elles n'envoient pas de valeur ETag au service de Table.  
...
- Architecture de stockage - [Microsoft Azure Storage : un service de stockage sur le cloud à haute disponibilité et à cohérence forte](http://blogs.msdn.com/b/windowsazurestorage/archive/2011/11/20/windows-azure-storage-a-highly-available-cloud-storage-service-with-strong-consistency.aspx)
