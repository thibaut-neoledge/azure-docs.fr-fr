...
Opération	|Renvoie valeur ETag conteneur|	Accepte en-têtes conditionnels|
------------|-----------------------|------------------------------------|
Création conteneur|	Oui|	Non|
Obtention propriétés conteneur|	Oui|	Non|
Obtention métadonnées conteneur|	Oui|	Non|
Définition métadonnées conteneur|	Oui|	Oui|
Obtention ACL conteneur|	Oui|	Non|
Définition ACL conteneur|	Oui|	Oui (*)|
Suppression conteneur|	Non|	Oui|
Bail conteneur|	Oui|	Oui|
Liste objets blob|	Non|	Non  
...
Opération	|Renvoie valeur ETag	|Accepte en-têtes conditionnels|
-----------|-------------------|----------------------------|
Placement objet blob|	Oui|	Oui|
Obtention objet blob|	Oui|	Oui|
Obtention propriétés objet blob|	Oui|	Oui|
Définition propriétés objet blob|	Oui|	Oui|
Obtention métadonnées objet blob|	Oui|	Oui|
Définition métadonnées objet blob|	Oui|	Oui|
Bail objet blob (*)|	Oui|	Oui|
Capture instantanée objet blob|	Oui|	Oui|
Copie objet blob|	Oui|	Oui (pour objet blob source et de destination)|
Annulation copie objet blob|	Non|	Non|
Suppression objet blob|	Non|	Oui|
Placement bloc|	Non|	Non|
Placement liste blocs|	Oui|	Oui|
Obtention liste blocs|	Oui|	Non|
Placement page|	Oui|	Oui|
Obtention pages|	Oui|	Oui|
...
Pour verrouiller un objet blob afin de l'utiliser de manière exclusive, vous pouvez obtenir un [bail](http://msdn.microsoft.com/fr-fr/library/azure/ee691972.aspx) . Lorsque vous obtenez un bail, vous spécifiez pendant combien de temps vous en avez besoin : cette durée peut être comprise entre 15 à 60 secondes ou peut être infinie, ce qui confère un verrouillage exclusif. Vous pouvez renouveler un bail à durée limitée et vous pouvez libérer un bail lorsque vous n'en avez plus besoin. Le service BLOB libère automatiquement les baux à durée limitée lorsqu'ils expirent.  
...
- [Bail d'un conteneur](http://msdn.microsoft.com/fr-fr/library/azure/jj159103.aspx)
- [Bail d'un objet blob ](http://msdn.microsoft.com/fr-fr/library/azure/ee691972.aspx) 
...
Pour désactiver de manière explicite la vérification d'accès concurrentiel, vous devez définir la propriété **ETag** de l'objet **employé** sur " * " avant d'exécuter l'opération de remplacement.  

customer.ETag = "*";  

Le tableau suivant résume la manière dont les opérations d'entités de table utilisent les valeurs ETag :  

Opération	|Renvoi valeur ETag	|Besoin en-tête demande If-Match|
------------|-------------------|--------------------------------|
Requête entités|	Oui|	Non|
Insertion entité|	Oui|	Non|
Mise à jour entité|	Oui|	Oui|
Fusion entité|	Oui|	Oui|
Suppression entité|	Non|	Oui|
Insertion ou remplacement entité|	Oui|	Non|
Insertion ou fusion entité|	Oui|	Non| 

Notez que les opérations **Insertion ou remplacement entité** et **Insertion ou fusion entité** ne procèdent *pas* à des vérifications d'accès concurrentiel étant donné qu'elles n'envoient pas de valeur ETag au service de table.  
