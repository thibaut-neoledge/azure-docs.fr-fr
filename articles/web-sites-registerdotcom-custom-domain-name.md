<properties 
	pageTitle="Configuration d'un nom de domaine Register.com pour un site Web Azure" 
...
-   [Activation du nom de domaine sur votre site Web](#enabledomain)
...
5. Lorsque vous cliquez sur le bouton **Edit**, vous accédez à un formulaire permettant de modifier les enregistrements existants ou d'en ajouter de nouveaux. Le formulaire est identique pour les enregistrements CNAME et A.
	...
	* Lors de l'ajout d'un enregistrement CNAME, vous devez définir le champ **.mydomainname.com** sur le sous-domaine à utiliser. Par exemple, **www**. Vous devez définir la valeur **points to** sur le nom de domaine **.azurewebsites.net** de votre site Web Azure. Par exemple, **contoso.azurewebsites.net**. Laissez le champ **Refers to Host Name** sur **Select**, car ce champ n'est pas obligatoire lors de la création d'un enregistrement CNAME à utiliser avec le service Sites Web Azure.
...
<h2><a name="enabledomain"></a>Activation du nom de domaine de votre site Web</h2>
