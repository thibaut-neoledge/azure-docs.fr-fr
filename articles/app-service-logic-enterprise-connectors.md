...
## Créer un connecteur
Vous pouvez créer un connecteur à l'aide du portail Azure ou avec des API REST. 
...
Paramètres du package | Entrez les paramètres du système d'entreprise, comme *SAP User Name* ou *SugarCRM Server URL*. Consultez [Propriétés spécifiques au système d'entreprise](#AddProperties) dans cette rubrique. 
...
Ajouter au Tableau d'accueil | Sélectionnez cette option pour ajouter le connecteur à votre Tableau d'accueil (la page d'accueil).
	...
	**<a name="AddProperties"></a>Propriétés spécifiques au système d'entreprise**
...
> [AZURE.IMPORTANT] Chaque connecteur possède des propriétés qui sont spécifiques à ce système d'entreprise. Lors de la connexion à SAP, vous entrez des propriétés spécifiques à SAP. Lors de la connexion à Salesforce, vous entrez des propriétés spécifiques à Salesforce, et ainsi de suite.	Le tableau suivant répertorie les propriétés de système d'entreprise obligatoires. 
	...
	Système d'entreprise | Propriétés obligatoires
--- | ---
Marketo | <ul><li>Point de terminaison</li><li>Nom du fournisseur</li></ul>
MongoDB| <ul><li>Chaîne de connexion</li><li>Hôte</li><li>Port</li><li>Nom d'utilisateur</li><li>Mot de passe</li><li>Base de données</li><li>Utiliser le chiffrement SSL</li><li>Local : entrez False si le système MongoDb est basé sur le cloud. S'il est local, entrez True et entrez les propriétés suivantes :<ul><li>Nom de la clé d'accès partagée</li><li>Espace de noms Service Bus</li><li>Chemin d'accès du relais</li><li>Clé d'envoi</li></ul></li></ul>
QuickBooks | <ul><li>ID de la société</li><li>Nom du fournisseur</li></ul>
SAP | <ul><li>Nom d'hôte</li><li>Langue</li><li>Nom d'utilisateur</li><li>Mot de passe</li><li>Numéro du système</li><li>Chaîne de connexion Service Bus</li><li>Noms RFC</li><li>Noms TRFC</li><li>Noms BAPI</li><li>Nom IDOC</li></ul>
Salesforce | <ul><li>Nom du fournisseur</li><li>Instance</li><li>Version</li><li>Entités (valeurs séparées par des virgules)</li></ul>
SugarCRM | <ul><li>URL du serveur</li><li>Nom du fournisseur</li><li>Noms des modules</li></ul>
...
[Intégrer un serveur SAP local](app-service-logic-integrate-with-an-on-premise-SAP-server.md)<br/>
