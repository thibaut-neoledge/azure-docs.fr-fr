...
2. Pour utiliser la commande **Hadoop** commande pour exécuter une tâche MapReduce d'exemple, utilisez le code suivant.
	...
	> [AZURE.NOTE] Pour plus d'informations sur cette tâche MapReduce et sur les exemples de données, consultez <a href="../hdinsight-use-mapreduce/">Utilisation de MapReduce dans HDInsight Hadoop</a>.
