...
> [!TIP]
> pour plus d’informations sur les fonctionnalités d’Azure et les meilleures pratiques relatives au chiffrement des données, voir [Azure Data Encryption Best Practices](azure-security-data-encryption-best-practices.md) (Meilleures pratiques relatives au chiffrement des données Azure).
> 
> 
