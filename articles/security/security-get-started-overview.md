...
Nous savons que la sécurité est la priorité dans le cloud et combien il est important que vous trouviez des informations précises et à jour sur la sécurité Azure. L’une des meilleures raisons d’utiliser Azure pour vos applications et services est de tirer parti de la large gamme de fonctionnalités et d’outils de sécurité que nous vous confions pour aider à rendre possible la création de solutions sécurisées sur la plateforme Azure sécurisée.

Cette page et ce site continueront à évoluer au fil du temps – de la même manière que les nouveaux services Azure sont constamment mis en ligne et que les services existants sont mis à jour rapidement, nous ferons de même ici. Nos offres de sécurité sont en constante amélioration, et nous vous présenterons ici les détails techniques de ces améliorations. Nous vous recommandons de revenir consulter ce site régulièrement pour découvrir les nouveautés !
...
> [AZURE.NOTE] Tous les articles du site d’informations sur la sécurité Azure apparaissent sur le côté gauche de la page. Pour voir tous les articles, il vous suffit de cliquer ou d’appuyer sur **En savoir plus** à la fin de la liste des catégories.
