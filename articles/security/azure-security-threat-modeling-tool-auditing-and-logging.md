...
## <a name="a-idsensitive-entitiesaidentify-sensitive-entities-in-your-solution-and-implement-change-auditing"></a><a id="sensitive-entities"></a>Identifier les entités sensibles dans votre solution et implémenter l’audit des modifications
...
## <a name="a-idauditingaensure-that-auditing-and-logging-is-enforced-on-the-application"></a><a id="auditing"></a>Vérifier que l’audit et la journalisation sont appliqués à l’application
...
## <a name="a-idlog-rotationaensure-that-log-rotation-and-separation-are-in-place"></a><a id="log-rotation"></a>Vérifier que la rotation et la séparation des journaux sont en place
...
## <a name="a-idlog-sensitive-dataaensure-that-the-application-does-not-log-sensitive-user-data"></a><a id="log-sensitive-data"></a>Vérifier que l’application n’enregistre pas de données utilisateur sensibles
...
## <a name="a-idlog-restricted-accessaensure-that-audit-and-log-files-have-restricted-access"></a><a id="log-restricted-access"></a>Vérifier que l’accès aux fichiers d’audit et journaux est restreint
...
## <a name="a-iduser-managementaensure-that-user-management-events-are-logged"></a><a id="user-management"></a>Vérifier que les événements de gestion des utilisateurs sont enregistrés
...
## <a name="a-idinbuilt-defensesaensure-that-the-system-has-inbuilt-defenses-against-misuse"></a><a id="inbuilt-defenses"></a>Vérifier que le système intègre des défenses contre l’utilisation malveillante
...
## <a name="a-iddiagnostics-loggingaenable-diagnostics-logging-for-web-apps-in-azure-app-service"></a><a id="diagnostics-logging"></a>Activer la journalisation des diagnostics pour les applications web dans Azure App Service
...
## <a name="a-ididentify-sensitive-entitiesaensure-that-login-auditing-is-enabled-on-sql-server"></a><a id="identify-sensitive-entities"></a>Vérifier que l’audit des connexions est activé sur SQL Server
...
| Technologies applicables | Générique |
| Attributs              | N/A  |
| Références              | [Configurer l’audit de connexion](https://msdn.microsoft.com/library/ms175850.aspx) |
...
## <a name="a-idthreat-detectionaenable-threat-detection-on-azure-sql"></a><a id="threat-detection"></a>Activer la détection des menaces sur SQL Azure
...
| Références              | [Prise en main de Threat Detection pour la base de données SQL](https://azure.microsoft.com/documentation/articles/sql-database-threat-detection-get-started/)|
...
## <a name="a-idanalyticsause-azure-storage-analytics-to-audit-access-of-azure-storage"></a><a id="analytics"></a>Utiliser Azure Storage Analytics pour auditer l’accès d’Azure Storage
...
| Technologies applicables | Générique |
| Attributs              | N/A |
| Références              | [Utilisation de Storage Analytics pour surveiller le type d’autorisation](https://azure.microsoft.com/documentation/articles/storage-security-guide/#storage-analytics) |
...
## <a name="a-idsufficient-loggingaimplement-sufficient-logging"></a><a id="sufficient-logging"></a>Implémenter une journalisation suffisante
...
## <a name="a-idaudit-failure-handlingaimplement-sufficient-audit-failure-handling"></a><a id="audit-failure-handling"></a>Implémenter une gestion suffisante des échecs d’audit
...
## <a name="a-idlogging-web-apiaensure-that-auditing-and-logging-is-enforced-on-web-api"></a><a id="logging-web-api"></a>Vérifier que l’audit et la journalisation sont appliqués à l’API web
...
## <a name="a-idlogging-field-gatewayaensure-that-appropriate-auditing-and-logging-is-enforced-on-field-gateway"></a><a id="logging-field-gateway"></a>Vérifier que l’audit et la journalisation appropriés sont appliqués sur la passerelle de champ
...
## <a name="a-idlogging-cloud-gatewayaensure-that-appropriate-auditing-and-logging-is-enforced-on-cloud-gateway"></a><a id="logging-cloud-gateway"></a>Vérifier que l’audit et la journalisation appropriés sont appliqués sur la passerelle de cloud
...
| Technologies applicables | Générique |
| Attributs              | N/A  |
| Références              | [Introduction à la surveillance des opérations IoT Hub](https://azure.microsoft.com/documentation/articles/iot-hub-operations-monitoring/) |
