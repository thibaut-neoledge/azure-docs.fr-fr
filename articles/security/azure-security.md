...
>
> Nous fournissons certaines informations générales, mais pour obtenir des informations plus détaillées sur la façon dont Microsoft sécurise la plateforme Azure proprement dite, consultez les informations du [Centre de gestion de la confidentialité](https://www.microsoft.com/TrustCenter/default.aspx).
...
## <a name="20-summary-azure-security-capabilities"></a>2.0 Résumé des fonctionnalités de sécurité Azure
...
### <a name="21-security-features-implemented-to-secure-the-azure-platform"></a>2.1 Fonctionnalités de sécurité implémentées pour sécuriser la plateforme Azure :
...
### <a name="22-security-features-offered-by-azure-to-secure-data-and-application"></a>2.2 Fonctionnalités de sécurité fournies par Azure pour sécuriser les données et applications
...
## <a name="30-operations"></a>3.0 Opérations
...
### <a name="31-operations-management-suite-security-and-audit-dashboard"></a>3.1 Tableau de bord Sécurité et audit d’Operations Management Suite
...
### <a name="36-azure-advisor"></a>3.6 Azure Advisor
...
## <a name="40-applications"></a>4.0 Applications
...
### <a name="41-web-application-vulnerability-scanning"></a>4.1 Analyse de la vulnérabilité des applications web
...
### <a name="42-penetration-testing"></a>4.2 Test de pénétration
...
### <a name="43-web-application-firewall"></a>4.3 Pare-feu d’applications web
...
### <a name="44-authentication-and-authorization-in-azure-app-service"></a>4.4 Authentification et autorisation dans Azure App Service
...
### <a name="45-layered-security-architecture"></a>4.5 Architecture de sécurité multiniveau
...
### <a name="46-web-server-diagnostics-and-application-diagnostics"></a>4.6 Diagnostics de serveur web et diagnostics d’application
...
#### <a name="461-web-server-diagnostics"></a>4.6.1 Diagnostics de serveur web
...
#### <a name="462-application-diagnostics"></a>4.6.2 Diagnostic d’application
...
## <a name="50-storage"></a>5.0 Stockage
...
### <a name="51-role-based-access-control-rbac"></a>5.1 Contrôle d’accès en fonction du rôle (RBAC)
...
### <a name="52-shared-access-signature"></a>5.2 Signature d’accès partagé
...
### <a name="53-encryption-in-transit"></a>5.3 Chiffrement en transit
...
### <a name="54-encryption-at-rest"></a>5.4 Chiffrement au repos
...
-    [Storage Service Encryption](https://docs.microsoft.com/azure/storage/storage-service-encryption) vous permet de demander que le service de stockage chiffre automatiquement les données lors de leur écriture dans Azure Storage.
...
### <a name="55-storage-analytics"></a>5.5 Analyse du stockage
...
### <a name="56-enabling-browser-based-clients-using-cors"></a>5.6 Activation de clients basés sur le navigateur à l’aide de CORS
...
## <a name="60-networking"></a>6.0 Mise en réseau
...
### <a name="61-network-layer-controls"></a>6.1 Contrôles de la couche réseau
...
#### <a name="611-network-security-groups"></a>6.1.1 Groupes de sécurité réseau
...
#### <a name="612-route-control-and-forced-tunneling"></a>6.1.2 Contrôle du routage et tunneling forcé
...
#### <a name="613-virtual-network-security-appliances"></a>6.1.3 Appliances de sécurité de réseau virtuel
...
### <a name="62-azure-virtual-network"></a>6.2 Réseau virtuel Azure
...
### <a name="63-vpn-gateway"></a>6.3 Passerelle VPN
...
### <a name="66-web-application-firewall"></a>6.6 Pare-feu d’applications web
...
### <a name="610-azure-dns"></a>6.10 DNS Azure
...
### <a name="611-log-analytics-nsgs"></a>6.11 Groupes de sécurité réseau Log Analytics
...
### <a name="71-antimalware--antivirus"></a>7.1 Logiciels anti-programmes malveillants et antivirus
...
### <a name="72-hardware-security-module"></a>7.2 Module de sécurité matériel
...
### <a name="75-sql-vm-tde"></a>7.5 TDE des machines virtuelles SQL
...
### <a name="76-vm-disk-encryption"></a>7.6 Chiffrement de disque de machine virtuelle
...
### <a name="77-virtual-networking"></a>7.7 Réseau virtuel
...
### <a name="78-patch-updates"></a>7.8 Mises à jour correctives
...
### <a name="79-security-policy-management-and-reporting"></a>7.9 Gestion des stratégies de sécurité et création de rapports
...
## <a name="80-identify-and-access-management"></a>8.0 Gestion des identités et accès
...
### <a name="81-secure-identity"></a>8.1 Identité sécurisée
...
### <a name="82-secure-apps-and-data"></a>8.2 Sécuriser les applications et données
