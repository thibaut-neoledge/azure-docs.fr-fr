...
Pour en savoir plus sur les réseaux virtuels Azure, consultez l’article [Présentation du réseau virtuel](../virtual-network/virtual-networks-overview.md).
...
Pour en savoir plus sur les **groupes de sécurité réseau**, consultez l’article [Groupes de sécurité réseau](../virtual-network/virtual-networks-nsg.md).
...
Pour en savoir plus sur les **itinéraires définis par l’utilisateur**, consultez l’article [Présentation des itinéraires définis par l’utilisateur et du transfert IP](../virtual-network/virtual-networks-udr-overview.md).
...
Pour en savoir plus sur la connectivité **VPN de point à site**, consultez l’article [Configurer une connexion point à site à un réseau virtuel à l’aide de PowerShell](../vpn-gateway/vpn-gateway-howto-point-to-site-rm-ps.md).
...
Pour en savoir plus sur les **connexions VPN de site à site vers Azure**, consultez l’article [Créer un réseau virtuel de gestionnaire de ressources avec une connexion VPN de site à site à l’aide du portail Azure](../vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-portal.md).

Pour en savoir plus sur la planification de la **connectivité intersite basée sur VPN**, consultez l’article [Planification et conception de la passerelle VPN](../vpn-gateway/vpn-gateway-plan-design.md).
...
Pour en savoir plus sur les **liaisons réseau étendu dédiées** entre votre site et les réseaux virtuels Azure, consultez l’article [Présentation technique d’ExpressRoute](../expressroute/expressroute-introduction.md).
...
Pour en savoir plus sur le VPN de site à site entre deux réseaux virtuels Azure, consultez l’article [Configurer une connexion de réseau virtuel à réseau virtuel à l’aide d’Azure Resource Manager et de PowerShell](../vpn-gateway/vpn-gateway-vnet-vnet-rm-ps.md).
...
Pour en savoir plus sur la passerelle Azure Application Gateway, consultez l’article [Vue d’ensemble d’Application Gateway](../application-gateway/application-gateway-introduction.md).
...
Pour en savoir plus sur l’équilibreur de charge externe Azure, consultez l’article [Équilibrage de charge accessible sur Internet entre plusieurs services ou machines virtuelles](../load-balancer/load-balancer-internet-overview.md).

Pour en savoir plus sur l’équilibreur de charge interne Azure, consultez l’article [Présentation de l’équilibrage de charge interne](../load-balancer/load-balancer-internal-overview.md).
...
Pour en savoir plus sur l’équilibrage de charge global avec Azure Traffic Manager, consultez l’article [Qu’est-ce que Traffic Manager ?](../traffic-manager/traffic-manager-overview.md).
...
Pour en savoir plus sur la journalisation des groupes de sécurité réseau, consultez l’article [Analyse de journaux pour les groupes de sécurité réseau (NSG)](../virtual-network/virtual-network-nsg-manage-log.md).
...
Pour en savoir plus sur le **serveur DNS associé au réseau virtuel Azure**, consultez l’article [Présentation du réseau virtuel](../virtual-network/virtual-networks-overview.md).

Pour en savoir plus sur l’utilisation de **vos propres serveurs DNS** sur un réseau virtuel Azure, consultez l’article [Gestion des serveurs DNS utilisés par un réseau virtuel](../virtual-network/virtual-networks-manage-dns-in-vnet.md).
...
Pour en savoir plus sur Azure DNS, consultez l’article [Vue d’ensemble d’Azure DNS](../dns/dns-overview.md).
...
Pour en savoir plus sur les zones DMZ dans Azure, consultez l’article [Services de cloud computing et sécurité réseau Microsoft](../best-practices-network-security.md).
...
Pour en savoir plus sur le Centre de sécurité Azure, consultez l’article [Présentation du Centre de sécurité Azure](../security-center/security-center-intro.md).
