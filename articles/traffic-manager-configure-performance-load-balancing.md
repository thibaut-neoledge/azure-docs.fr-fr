...
5. Pour **Paramètres de méthode d'équilibrage de charge**, vérifiez que la méthode d'équilibrage de charge est **Performances*. Si ce n'est pas le cas, cliquez sur **Performances** dans la liste déroulante.
