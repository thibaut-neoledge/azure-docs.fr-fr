<properties pageTitle="Application web Ruby on Rails sur Azure en utilisant une machine virtuelle Linux" description="Hébergement d'un site web Ruby on Rails sur Azure en utilisant une machine virtuelle Linux." services="virtual-machines" documentationCenter="ruby" authors="blackmist" manager="wpickett" editor=""/>
...
<!-- WA.com links -->
[blobs]: /fr-fr/documentation/articles/storage-ruby-how-to-use-blob-storage
...
[unicorn-nginx-capistrano]: /fr-fr/documentation/articles/virtual-machines-ruby-deploy-capistrano-host-nginx-unicorn/

[vm-instructions]: /fr-fr/documentation/articles/virtual-machines-linux-tutorial
