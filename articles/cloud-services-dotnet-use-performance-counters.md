<properties urlDisplayName="Performance Profiling" pageTitle="Utilisation des compteurs de performances dans Azure (.NET)" metaKeywords="Azure performance counters, Azure performance profiling, Azure performance counters C#, Azure performance profiling C#" description="D&eacute;couvrez comment activer et collecter des donn&eacute;es &agrave; partir des compteurs de performances dans les applications Azure. " metaCanonical="" services="cloud-services" documentationCenter=".NET" title="Utilisation de compteurs de performances dans Azure" authors="ryanwi" solutions="" manager="timlt" editor="" />
