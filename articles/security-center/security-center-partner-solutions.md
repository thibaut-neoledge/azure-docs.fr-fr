...
La vignette **Solutions de sécurité** sous **Vue d’ensemble** vous permet de surveiller d’un seul coup d’œil l’état d’intégrité des solutions partenaires intégrées à votre abonnement Azure.

![Mosaïque Solutions de partenaire][1]

Pour afficher l’intégrité de vos solutions de partenaire :

1. Sélectionnez la vignette **Solutions de sécurité**. Les **solutions de sécurité** s’ouvrent, avec la liste de vos solutions partenaires connectées à Security Center.
...
2. Sélectionnez une solution de partenaire. Un panneau s'ouvre et affiche l'état de la solution partenaire et des ressources associées à cette solution. Sélectionnez **Console de solution** afin d’ouvrir l’expérience de gestion du partenaire pour cette solution.
...
Ce document vous a présenté la vignette **Solutions de sécurité** de Security Center. Pour plus d’informations sur l’intégration des partenaires pour améliorer la sécurité globale, consultez la page [Intégration des partenaires et des solutions](security-center-partner-integration.md).
