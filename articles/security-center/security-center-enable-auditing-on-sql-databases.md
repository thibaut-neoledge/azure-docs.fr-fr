...
description: "Ce document vous explique comment implémenter la recommandation Azure Security Center **Activer l’audit et la détection des menaces pour les bases de données SQL**."
