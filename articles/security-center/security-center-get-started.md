...
1. Cliquez sur la vignette **Stratégie de sécurité** dans le panneau **Centre de sécurité**. ![Centre de sécurité][3]
...
5.	Sélectionnez un élément dans les **mesures préventives** pour afficher des informations supplémentaires et/ou configurer les contrôles nécessaires.
