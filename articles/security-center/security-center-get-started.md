---
title: Guide de démarrage rapide du Centre de sécurité Azure | Microsoft Docs
...
Afficher l’état d’intégrité et de sécurité de vos ressources avec **l’Intégrité des ressources** :
...
Afficher l’intégrité de vos **solutions de partenaires** :
...
2. Sélectionnez la vignette **Solutions de partenaires**. Un panneau vous présente la liste de vos solutions de partenaires connectées à Security Center. ![Solutions de partenaires][9]
