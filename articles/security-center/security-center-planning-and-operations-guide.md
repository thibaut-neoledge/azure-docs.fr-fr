...
Lorsque vous planifiez le contrôle d’accès à l’aide de RBAC dans le Centre de sécurité, veillez à identifier qui dans votre entreprise utilisera le Centre de sécurité et quels types de tâches ces personnes effectueront. Ensuite, configurez le contrôle RBAC en conséquence.
...
- [Surveillance de l’intégrité de la sécurité dans le Azure Security Center](security-center-monitoring.md) : découvrez comment surveiller l’intégrité de vos ressources Azure.
