<properties
   pageTitle="Sécurité des données du Centre de sécurité Azure | Microsoft Azure"
...
## Gestion de la collecte de données à partir de machines virtuelles
...
- [Guide des opérations et de planification du Centre de sécurité Azure](security-center-planning-and-operations-guide.md) - Découvrez comment planifier et comprendre les considérations de conceptions pour l’adoption du Centre de sécurité Azure.
...
- [Surveillance des solutions de partenaires avec le Centre de sécurité Azure](security-center-partner-solutions.md) : découvrez comment surveiller l’état d’intégrité de vos solutions de partenaires.
