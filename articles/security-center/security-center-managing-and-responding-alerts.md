...
Découvrez comment utiliser les fonctionnalités du Centre de sécurité Azure pour gérer et résoudre les alertes de sécurité grâce à cette procédure pas à pas.
...
## Comment le Centre de sécurité Azure gère-t-il les alertes de sécurité ?
...
1. Dans le tableau de bord **Centre de sécurité Azure**, recherchez la mosaïque **Alertes de sécurité**. 
...
- **Détection d’une attaque par force brute sur des données de point de terminaison** : ces détections sont basées sur des requêtes du Centre de sécurité Azure envoyées aux journaux des machines. Ainsi, vous pouvez distinguer les tentatives réussies des échecs. 
