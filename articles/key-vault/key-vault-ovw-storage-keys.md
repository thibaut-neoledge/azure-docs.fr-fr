...
- Obtenez l’ObjectId de l’identité Azure Key Vault : 
...
La sortie de la commande précédente comprend votre principal de service, que nous appellerons *yourKeyVaultServicePrincipalId*. 
