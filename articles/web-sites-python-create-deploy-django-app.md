...
> [WACOM.NOTE]Vous pouvez à présent sélectionner la version de Python que vous souhaitez utiliser dans le portail Sites Web Azure en ouvrant l'onglet Configurer de votre site web et en modifiant le paramètre **Version de Python**.
...
Dans la boîte de dialogue **Configurer le déploiement**, faites défiler vers le bas et sélectionnez l'option **Git local**. Cliquez sur la flèche droite pour continuer.
