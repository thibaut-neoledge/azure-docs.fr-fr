...
4. Nommez l’application **MonExemple**, puis cliquez sur **OK**.
	...
	![Boîte de dialogue Nouveau projet](./media/web-sites-dotnet-get-started-vs2013/GS13newprojdb.png)
...
6. Cliquez sur **OK**.
	...
	![Connecté à Azure](./media/web-sites-dotnet-get-started-vs2013/configuresitesettings2.png)
	...
	![Application Web créée](./media/web-sites-dotnet-get-started-vs2013/GS13sitecreated1.png)

	Par ailleurs, l’application web apparaît dans l’Explorateur de serveurs.

	![Application Web créée](./media/web-sites-dotnet-get-started-vs2013/siteinse.png)

## Déploiement de l'application dans Azure

7. Dans la fenêtre **Activité Azure App Service**, cliquez sur **Publier MonExemple dans cette application web**.

	![Application Web créée](./media/web-sites-dotnet-get-started-vs2013/GS13sitecreated.png)
...
12. Cliquez sur **Publier**.
	...
	![Application web exécutée dans Azure](./media/web-sites-dotnet-get-started-vs2013/GS13deployedsite.png)
...
1. Appuyez sur Ctrl+F5 pour voir le titre mis à jour en exécutant l’application web sur votre ordinateur local.
	...
	![Application web exécutée en local](./media/web-sites-dotnet-get-started-vs2013/localandazure.png)
...
2. Dans l’Assistant **Publier le site Web** cliquez sur **Publier**.
	...
	![Application web modifié déployée](./media/web-sites-dotnet-get-started-vs2013/deployedandazure.png)
...
![Barre d’outil Publication Web en un clic](./media/web-sites-dotnet-get-started-vs2013/weboneclickpublish.png)
...
2. Cliquez sur **Parcourir > Web Apps**, puis cliquez sur le nom de votre application web.
	...
	![Panneau Application web](./media/web-sites-dotnet-get-started-vs2013/portaldashboard.png)-->
...
4. Cliquez sur **Paramètres de l’application** pour voir un exemple des paramètres configurables dans le portail.
	...
	![Onglet de configuration de l’application web sur le portail](./media/web-sites-dotnet-get-started-vs2013/portalconfigure2.png)
...
* [Comment choisir ou créer un plan App Service](azure-web-sites-web-hosting-plans-in-depth-overview.md)
