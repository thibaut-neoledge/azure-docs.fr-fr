...
-   [Création d'une file d'attente](#bkmk_HowToCreateQueue)
...
L'exemple suivant montre comment envoyer cinq messages de test au client **MessageSender** « TestQueue » obtenu dans l'extrait de code précédent :
    ...
    for (int i=0; i<5; i++)
    {
         // Créez un message, en transmettant un message de chaîne pour le corps.
         BrokeredMessage message = new BrokeredMessage("Test message " + i);
         // Définissez une propriété supplémentaire propre à l'application.
     ...
     try
    {
        ...
        while(true)  { 
            ...
            if (message != null && message.getMessageId() != null)
            {
                ...
                // Affichez le message en file d'attente.
