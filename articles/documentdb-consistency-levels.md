...
**Bounded Staleness (En fonction de l'obsolescence)** : le niveau de cohérence Bounded Staleness (En fonction de l'obsolescence) garantit l'ordre global de propagation des écritures, mais avec la possibilité que des lectures soient potentiellement retardées derrière les écritures par, au plus, des préfixes K. La lecture est toujours reconnue par un quorum majoritaire de réplicas. La réponse d'une demande de lecture spécifie son actualisation relative (en termes de K).  

Le niveau Bounded Staleness (En fonction de l'obsolescence) fournit un comportement plus prévisible pour la cohérence des lectures, tout en offrant des écritures avec la latence la plus faible. Comme les lectures sont reconnues par un quorum majoritaire, la latence associée n'est pas la plus faible offerte par le système.    

**Session** : contrairement aux modèles de cohérence globaux offerts par les niveaux de cohérence Strong (Fort) et Bounded staleness (En fonction de l'obsolescence), le niveau Session (Par session) est adapté à une session client spécifique. Il est généralement suffisant, car il fournit des lectures unitones garanties, des écritures et la possibilité de lire vos propres écritures. Une demande de lecture pour le niveau de cohérence Session (Par session) est émise sur un réplica pouvant servir la version demandée par le client (portion du cookie de session).  
...
**Eventual (Éventuel)** : ce niveau de cohérence est la forme de cohérence la plus faible où un client peut obtenir des valeurs plus anciennes que celles qu'il a pu voir précédemment. En l'absence d'autres écritures, les réplicas du groupe finiront par converger. La demande de lecture est servie par un réplica secondaire.  

Le niveau Eventual (Éventuel) fournit la cohérence la plus faible en matière de lecture, tout en offrant la latence la moins élevée pour les lectures et les écritures. 
...
-------------|-------|---------
Cohérent (par défaut)|	Choisir parmi Strong (Fort), Bounded Staleness (En fonction de l'obsolescence), Session (Par session) et Eventual (Éventuel)|	Choisir parmi Strong (Fort), Bounded Staleness (En fonction de l'obsolescence), Session (Par session) et Eventual (Éventuel)|
En douceur|	Choisir parmi Strong (Fort), Bounded Staleness (En fonction de l'obsolescence), Session (Par session) et Eventual (Éventuel)|	Eventual (Éventuel)  
...
-	Doug Terry. Le niveau Session (Par session) garantit des données répliquées peu cohérentes.   
...
-	Daniel Abadi. Compromis en termes de cohérence dans la conception des systèmes de base de données distribués modernes : CAP n'est qu'une partie de l'histoire ".   
