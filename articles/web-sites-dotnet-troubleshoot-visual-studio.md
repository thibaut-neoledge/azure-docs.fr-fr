...
1.  Ajoutez un [élément de suivi](http://msdn.microsoft.com/fr-fr/library/vstudio/6915t83k(v=vs.100).aspx) sous `<system.web>` dans le fichier Web.config, comme dans l'exemple suivant :
