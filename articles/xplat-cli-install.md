...
Installez rapidement l’interface de ligne de commande Azure (Azure CLI) pour bénéficier d’un ensemble de commandes shell open source permettant de créer et gérer les ressources dans Microsoft Azure. Plusieurs choix s’offrent à vous : utilisez un des packages de programme d’installation fournis pour installer cette interface sur votre système d’exploitation, installez l’interface de ligne de commande à l’aide de Node.js et **npm**, ou installez l’interface de ligne de commande Azure en tant que conteneur dans un hôte Docker. Pour obtenir davantage d’options générales et de contexte, consultez le référentiel du projet sur [GitHub](https://github.com/azure/azure-xplat-cli).
...
* [Commandes de l’interface de ligne de commande Azure du mode Azure Resource Manager (ARM)][cliarm]

* [Commandes de l’interface de ligne de commande Azure du mode Azure Service Management (ASM)][cliasm]
