...
-   [Types d'enregistrement DNS][Types d'enregistrement DNS]
-   [Recherche de l'adresse IP virtuelle][Recherche de l'adresse IP virtuelle]
-   [Création des enregistrements DNS][Création des enregistrements DNS]
-   [Création d'un enregistrement « awverify » (enregistrements A uniquement)][Création d'un enregistrement « awverify » (enregistrements A uniquement)]
-   [Activation du nom de domaine sur votre site Web][Activation du nom de domaine sur votre site Web]
...
3.  Cliquez sur **Gérer les domaines** en bas de la page. (Si cette option est désactivée, assurez-vous d’utiliser le mode Partagé, De base ou Standard. Pour plus d'informations, consultez la page [Mise à l'échelle de sites Web][Mise à l'échelle de sites Web].)
