<properties 
	pageTitle="Configuration d'un nom de domaine personnalisé pour un site Web Azure" 
	description="Apprenez à utiliser un nom de domaine personnalisé avec Sites Web Azure" 
	services="web-sites" 
	documentationCenter="" 
	authors="blackmist" 
	manager="wpickett" 
...
Lorsque vous créez un site Web, Azure l'attribue à un sous-domaine azurewebsites.net. Par exemple, si votre site Web s'appelle **contoso**, son URL sera **contoso.azurewebsites.net**. Azure attribue également une adresse IP virtuelle.
...
> [AZURE.NOTE] L'adresse IP peut être modifiée si vous supprimez, recréez votre site Web ou le faites de nouveau passer en mode Gratuit.
...
- *Si l'enregistrement A mappe le domaine racine ou un domaine générique:* créez un enregistrement CNAME qui mappe à partir de **awverify.&lt;votredomaine&gt;** vers **awverify.&lt;nomdevotresiteweb&gt;.azurewebsites.net**. Par exemple, si l'enregistrement A est pour **contoso.com**, créez un enregistrement CNAME pour **awverify.contoso.com**.
- *Si l'enregistrement A mappe un sous-domaine spécifique :* créez un enregistrement CNAME qui mappe à partir de **awverify.&lt;sous-domaine&gt;** vers **awverify.&lt;nomdevotresiteweb&gt;.azurewebsites.net**. Par exemple, si l'enregistrement A est pour **blogs.contoso.com**, créez un enregistrement CNAME pour **awverify.blogs.contoso.com**.
