...
Supprimez une ligne dans une table de données. Appelez la méthode [done][done] sur l'objet [Promise][done] renvoyé pour obtenir une copie de l'objet inséré et gérer les éventuelles erreurs.
