...
4. Dans le panneau **Créer un équilibreur de charge**, tapez le **Nom** de votre équilibreur de charge.
5. Sous **Schéma**, cliquez sur **Interne**.
...
6. Sous **Attribution d’adresses IP**, cliquez sur **Dynamique** ou **Statique**, selon que vous souhaitez une adresse IP statique ou non pour l’équilibreur de charge.
...
4. Sous **Intervalle**, spécifiez la fréquence de sondage de l’application.
