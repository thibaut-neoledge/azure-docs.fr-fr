<properties 
   pageTitle="Prise en main de la création d’un équilibreur de charge accessible sur Internet dans un modèle de déploiement classique à l’aide du portail Azure | Microsoft Azure"
...
# Prise en main de la création d’un équilibreur de charge accessible sur Internet (classique) dans le portail Azure
