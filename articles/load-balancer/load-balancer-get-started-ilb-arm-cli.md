...
1. Si vous n’avez jamais utilisé l’interface de ligne de commande Azure, consultez [Installer l’interface de ligne de commande Azure](../xplat-cli-install.md) et suivez les instructions jusqu’à l’étape où vous sélectionnez votre compte et votre abonnement Azure.
...
- **-e** - ID de la règle NAT qui sera associée à la ressource de la carte réseau - commence par /subscriptions/####################################/resourceGroups/<nom-groupe-de-ressources>/providers/Microsoft.Network/loadBalancers/<nom-equilibreur-de-charge>/inboundNatRules/<nom-regle-nat>
