---
title: Créer un équilibreur de charge interne à l’aide de l’interface de ligne de commande Azure (CLI) dans le modèle de déploiement classique | Microsoft Docs
