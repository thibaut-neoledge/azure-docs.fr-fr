<properties pageTitle="Présentation des plans d'hébergement web" description="Web hosting plan overview" title="What is a web hosting plan?" services="web-sites" authors="adamab" manager="wpickett" />
