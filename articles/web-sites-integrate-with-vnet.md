<properties 
	pageTitle="Intégration d'un site Web Azure à un réseau virtuel Azure" 
	description="Montre comment connecter un site Web Azure à un réseau virtuel Azure, nouveau ou existant" 
...
Vous pouvez connecter un site Web à un réseau virtuel nouveau ou existant.  Si vous créez un nouveau réseau, une passerelle est alors préconfigurée pour vous.  Notez que la création et la configuration d'un nouveau réseau virtuel prendront quelques minutes.  
