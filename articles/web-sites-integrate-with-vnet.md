...
Vous pouvez connecter une application web à un réseau virtuel nouveau ou existant.  Si vous créez un nouveau réseau, une passerelle est alors préconfigurée pour vous.  Notez que la création et la configuration d'un nouveau réseau virtuel prendra quelques minutes.  
...
## Créer un réseau virtuel et se connecter à ce dernier ##
...
##Gestion de la connexion au réseau virtuel##
