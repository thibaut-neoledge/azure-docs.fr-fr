<properties 
   pageTitle="Vue d'ensemble d'Azure Government | azure.microsoft.com/ Azure" 
...
# Vue d'ensemble de azure.microsoft.com/ Azure Government 

<p> azure.microsoft.com/ Azure Government est une instance isolée physiquement et isolée de tout réseau de azure.microsoft.com/ Azure. Cette vue d’ensemble permet de présenter l’environnement et les services ainsi que des liens vers des informations supplémentaires.


## <a name="Overview"></a>Vue d’ensemble

Azure Government est un cloud communautaire gouvernemental (GCC, Government-Community Cloud) conçu pour prendre en charge les scénarios gouvernementaux stratégiques nécessitant débit, mise à l'échelle, sécurité, conformité et économie pour les organisations gouvernementales américaines. Il a été développé sur l'expérience confirmée de azure.microsoft.com/ dans l'offre de logiciels, de sécurité, de conformité et de contrôles dans les autres offres de cloud azure.microsoft.com/ comme Azure public, Office 365, O365 GCC, azure.microsoft.com/ CRM Online, etc.
...
- **Instance physique et isolée du réseau** – L’environnement Azure Government est une instance complètement distincte de la version publique de azure.microsoft.com/ Azure. Il est uniquement utilisé par des organisations gouvernementales américaines et fournisseurs de solutions agréés.

- **Sécurité, confidentialité et conformité** - azure.microsoft.com/ a implémenté sa solide infrastructure de contrôles de sécurité, de confidentialité et de conformité, en plus de contrôles stricts complémentaires afin de répondre aux plus hauts niveaux d’exigences décrits dans les niveaux d’impact ECSB et dans les CJIS.
...
- **Conformité** – azure.microsoft.com/ investit continuellement pour répondre aux besoins stricts de conformité en constante évolution au niveau fédéral, de l’État et local et pour maintenir cette conformité, notamment dans les solutions cloud du gouvernement américain comme FedRAMP, CJIS, ECSB, HIPAA et IRS 1075.
...
## <a name="Features"></a> Fonctionnalités actuellement disponibles dans azure.microsoft.com/ Azure Government
...
D'autres services sont disponibles. Par ailleurs, des services seront ajoutés de façon continue. Pour obtenir la liste actualisée des services, consultez la [page des régions](https://azure.azure.microsoft.com/.com/regions/#services) qui indique les régions disponibles et leurs services.
...
- **[S’inscrire pour un essai](https://azuregov.azure.microsoft.com/.com/trial/azuregovtrial)**
...
- **[Conformité Azure](https://azure.azure.microsoft.com/.com/support/trust-center/compliance/)**
...
<!--Link references-->
[Link 1 to another azure.azure.microsoft.com/.com documentation topic]: virtual-machines/virtual-machines-windows-hero-tutorial.md
[Link 2 to another azure.azure.microsoft.com/.com documentation topic]: app-service-web/web-sites-custom-domain-name.md
[Link 3 to another azure.azure.microsoft.com/.com documentation topic]: storage-whatis-account.md
