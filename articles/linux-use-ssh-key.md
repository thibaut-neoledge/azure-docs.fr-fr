...
1.  Téléchargez et installez msysgit à partir de l'emplacement suivant : [http://msysgit.github.com/][1]
2.  Exécutez `msys` à partir du répertoire installé (par exemple : c:\\msysgit\\msys.exe)
3.  Modifiez le répertoire `bin` en tapant `cd bin`

### Utilisation de GitHub pour Windows

1.  Téléchargez et installez GitHub pour Windows à partir de l'emplacement suivant : [http://windows.github.com/][2]
2.  Exécutez Git Shell à partir du menu Démarrer > Tous les programmes > GitHub, Inc

### Utilisation de cygwin

1.  Téléchargez et installez Cygwin à partir de l'emplacement suivant : [http://cygwin.com/][3]
...
1.  Téléchargez et installez puttygen à partir de l'emplacement suivant : [http://www.chiark.greenend.org.uk/~sgtatham/putty/download.html][4]
...
1.  Téléchargez et installez putty à partir de l'emplacement suivant : [http://www.chiark.greenend.org.uk/~sgtatham/putty/download.html][4]
