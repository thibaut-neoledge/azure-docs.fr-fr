...
[Personnalisation du portail des développeurs dans Gestion des API Azure]: api-management-customize-portal.md
...
[Protection de votre API avec des limites de débits à l’aide de Gestion des API Azure]: api-management-howto-product-with-rules.md
