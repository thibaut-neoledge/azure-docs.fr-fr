...
-	[Stratégies de transformation][] 
	...
	-	[Mask URLs in content][] : réécrit (masque) les liens dans le corps de la réponse et dans l’en-tête de l’emplacement afin qu’ils pointent vers un lien équivalent via le proxy.
