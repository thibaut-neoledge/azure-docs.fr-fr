...
Le contenu du portail des développeurs se modifie grâce au portail des éditeurs, accessible via le portail de gestion Azure. Pour accéder au portail des éditeurs de l’API, cliquez sur **Gérer** dans le portail Azure pour votre service Gestion des API.
...
> Pour ouvrir le portail des développeurs lorsque vous vous trouvez dans le portail des éditeurs, cliquez sur **Portail des développeurs** dans la barre supérieure.
