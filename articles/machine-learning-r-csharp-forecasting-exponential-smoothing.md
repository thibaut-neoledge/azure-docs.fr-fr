<properties title="Forecasting-Exponential Smoothing" pageTitle="Prévisions - Lissage exponentiel | Azure" description="Service web : Prévisions - Lissage exponentiel" metaKeywords="" services="machine-learning" solutions="" documentationCenter="" authors="jaymathe" manager="paulettm" editor="cgronlun" videoId="" scriptId="" />
