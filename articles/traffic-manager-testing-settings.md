<properties 
   pageTitle="Test des paramètres de Traffic Manager"
...
3. Entrez `nslookup <your Traffic Manager domain name>`. Par exemple, la commande suivante permet de contrôler un nom de domaine doté du préfixe *myapp.contoso* :
