...
Pour activer la diffusion en continu via les [applets de commande Azure PowerShell](../monitoring-and-diagnostics/insights-powershell-samples.md), vous pouvez utiliser l’applet de commande `Set-AzureRmDiagnosticSetting` avec ces paramètres :
...
Pour activer la diffusion en continu via [l’interface de ligne de commande Azure](../monitoring-and-diagnostics/insights-cli-samples.md), vous pouvez utiliser la commande `insights diagnostic set` comme suit :
...
Une liste de tous les fournisseurs de ressources qui prennent en charge la diffusion en continu vers Event Hubs est disponible [ici](../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md).
