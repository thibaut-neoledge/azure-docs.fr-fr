---
title: Utiliser l’interface de ligne de commande (CLI) multiplateforme pour créer des alertes pour les services Azure | Microsoft Docs
...
1. Pour lister les règles existantes dans un groupe de ressources, utilisez le format suivant **azure insights alerts rule list** *[options] &lt;groupeRessources&gt;*
