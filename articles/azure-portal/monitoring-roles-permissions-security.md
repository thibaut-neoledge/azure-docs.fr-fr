...
---
# Familiarisation avec les rôles, les autorisations et la sécurité dans Azure Monitor
...
* Requête de mesures avec [l’API REST Azure Monitor](https://msdn.microsoft.com/library/azure/dn931930.aspx), [les applets de commande PowerShell](../monitoring-and-diagnostics/insights-powershell-samples.md) ou [le CLI multiplateforme](../monitoring-and-diagnostics/insights-cli-samples.md).
...
* Affichez les [Paramètres de diagnostic](../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md#diagnostic-settings) pour une ressource.
* Afficher le [profil de journalisation](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md#export-the-activity-log-with-log-profiles) pour un abonnement.
...
* Définissez les [Paramètres de diagnostic](../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md#diagnostic-settings) pour une ressource.*
* Définir le [profil de journal](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md#export-the-activity-log-with-log-profiles) pour un abonnement.*
...
## Autorisations d’analyse et rôles RBAC personnalisés
...
### Limiter l’accès aux comptes de stockage liés à l’analyse
...
### Limiter l’accès aux hubs d’événements liés à l’analyse
...
* [Lire la vue d’ensemble de l’analyse dans Azure](../monitoring-and-diagnostics/monitoring-overview.md)
