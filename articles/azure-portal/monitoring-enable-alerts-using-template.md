...
---
# Créer une alerte de mesure avec un modèle Resource Manager
...
## Modèle Resource Manager pour une alerte de mesure
...
## Modèle Resource Manager pour une ressource avec une alerte
...
* [Ajout de paramètres de diagnostic](../monitoring-and-diagnostics/monitoring-enable-diagnostic-logs-using-template.md) à votre modèle Resource Manager
