...
* [Diffusez-les en continu vers **Event Hubs**](../monitoring-and-diagnostics/monitoring-stream-diagnostic-logs-to-event-hubs.md) pour qu’un service tiers ou une solution d’analyse personnalisée (p. ex. PowerBI) les ingère.
...
> [!WARNING]
> Les mesures et les journaux de diagnostic des ressources de calcul (p. ex. les machines virtuelles ou Service Fabric) utilisent [un mécanisme distinct pour la configuration et la sélection des sorties](../azure-diagnostics.md).
> 
> 
...
[Cet article vous explique comment utiliser un modèle de ressource pour activer les paramètres de diagnostic lors de la création d’une ressource](../monitoring-and-diagnostics/monitoring-enable-diagnostic-logs-using-template.md)
...
## Gérer les paramètres de diagnostic dans le portail
Pour vous assurer que toutes vos ressources sont correctement configurées avec les paramètres de diagnostic, vous pouvez accéder au panneau **Analyse** du portail et ouvrir le panneau **Journaux de diagnostic**.
...
## Étapes suivantes
* [Stream Azure Diagnostic Logs to **Event Hubs**](../monitoring-and-diagnostics/monitoring-stream-diagnostic-logs-to-event-hubs.md) (Diffuser en continu les journaux de diagnostic Azure vers Event Hubs)
