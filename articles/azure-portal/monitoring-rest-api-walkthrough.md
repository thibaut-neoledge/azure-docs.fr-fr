...
**URI de demande** : https://management.azure.com/subscriptions/_{subscription-id}_/resourceGroups/_{resource-group-name}_/providers/_{resource-provider-namespace}_/_{resource-type}_/_{resource-name}_/providers/microsoft.insights/metrics?$filter=_{filter}_&api-version=_{apiVersion}_
...
3. Saisissez _armclient GET [id\_ressource]/providers/microsoft.insights/metricdefinitions?api-version=2016-03-01_

4. Saisissez _armclient GET [id\_ressource]/providers/microsoft.insights/metrics?api-version=2016-06-01_
...
* **IoT Hub** - /subscriptions/_{id-abonnement}_/resourceGroups/_{nom-groupe-ressources}_/providers/Microsoft.Devices/IotHubs/_{iot-hub}_

* **Pool élastique SQL** -/subscriptions/_{id d’abonnement}_/resourceGroups/_{groupe-ressources}_/providers/Microsoft.Sql/servers/_{bd-pool}_/elasticpools/_{nom-pool-sql}_

* **Base de données SQL (v12)** -/subscriptions/_{id-abonnement}_/resourceGroups/_{nom-groupe-ressource}_/providers/Microsoft.Sql/servers/_{nom\_serveur}_/databases/_{nom-bd}_

* **Service Bus** - /subscriptions/_{subscription-id}_/resourceGroups/_{nom-groupe-ressources}_/providers/Microsoft.ServiceBus/_{espace-noms}_/_{nom-servicebus}_

* **Jeux de mise à l’échelle de machine virtuelle** -/subscriptions/_{id-abonnement}_/resourceGroups/_{nom-groupe-ressources}_/providers/Microsoft.Compute/virtualMachineScaleSets/_{nom-vm}_

* **Machines virtuelles** - /subscriptions/_{id-abonnement}_/resourceGroups/_{nom-groupe-ressources}_/providers/Microsoft.Compute/virtualMachines/_{nom-vm}_

* **Hubs d’événements** -/subscriptions/_{id-abonnement}_/resourceGroups/_{nom-groupe-ressources}_/providers/Microsoft.EventHub/namespaces/_{espace-noms-hub}_
