...
3. Saisissez *armclient GET [id\_ressource]/providers/microsoft.insights/metricdefinitions?api-version=2016-03-01*
4. Saisissez *armclient GET [id\_ressource]/providers/microsoft.insights/metrics?api-version=2016-06-01*
...
* **IoT Hub** - /subscriptions/*{id-abonnement}*/resourceGroups/*{nom-groupe-ressources}*/providers/Microsoft.Devices/IotHubs/*{iot-hub}*
* **Pool élastique SQL** -/subscriptions/*{id d’abonnement}*/resourceGroups/*{groupe-ressources}*/providers/Microsoft.Sql/servers/*{bd-pool}*/elasticpools/*{nom-pool-sql}*
* **Base de données SQL (v12)** -/subscriptions/*{id-abonnement}*/resourceGroups/*{nom-groupe-ressource}*/providers/Microsoft.Sql/servers/*{nom\_serveur}*/databases/*{nom-bd}*
* **Service Bus** - /subscriptions/*{subscription-id}*/resourceGroups/*{nom-groupe-ressources}*/providers/Microsoft.ServiceBus/*{espace-noms}*/*{nom-servicebus}*
* **Jeux de mise à l’échelle de machine virtuelle** -/subscriptions/*{id-abonnement}*/resourceGroups/*{nom-groupe-ressources}*/providers/Microsoft.Compute/virtualMachineScaleSets/*{nom-vm}*
* **Machines virtuelles** - /subscriptions/*{id-abonnement}*/resourceGroups/*{nom-groupe-ressources}*/providers/Microsoft.Compute/virtualMachines/*{nom-vm}*
* **Hubs d’événements** -/subscriptions/*{id-abonnement}*/resourceGroups/*{nom-groupe-ressources}*/providers/Microsoft.EventHub/namespaces/*{espace-noms-hub}*
...
## Étapes suivantes
* Consultez la [Vue d’ensemble de l’analyse](../monitoring-and-diagnostics/monitoring-overview.md).
* Affichez les [Mesures prises en charge avec Azure Monitor](../monitoring-and-diagnostics/monitoring-supported-metrics.md).
