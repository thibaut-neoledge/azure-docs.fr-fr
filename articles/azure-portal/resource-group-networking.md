...
![Modèle de ressource réseau](./media/resource-group-networking/Figure1.png)
...
![Modèle de ressource réseau](./media/resource-group-networking/Figure2.png)
...
![Cartes d'interface réseau sur une seule machine virtuelle](./media/resource-group-networking/Figure3.png)
...
![Cartes d'interface réseau sur une seule machine virtuelle](./media/resource-group-networking/Figure4.png)
...
![Cartes d’interface réseau sur une seule machine virtuelle](./media/resource-group-networking/Figure5.png)
...
![Exemple de déploiement de modèle](./media/resource-group-networking/Figure6.png)
