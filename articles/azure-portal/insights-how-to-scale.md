---
title: Mise à l’échelle manuelle ou automatique du nombre d’instances | Microsoft Docs
...
1. Vous pouvez modifier manuellement le nombre d’**instances** à l’aide du curseur.
2. Cliquez sur la commande **Enregistrer** pour augmenter ou diminuer presque immédiatement le nombre d'instances.
...
> [!NOTE]
> La mise à l'échelle automatique utilisera les règles de passage à l’heure d’été pour n’importe quel **fuseau horaire** que vous sélectionnez. Cependant, lors du passage à l’heure d’été, le décalage UTC indiquera le décalage de base, et non le décalage UTC du passage à l’heure d’été.
> 
> 

1. Cliquez sur **OK**.
2. Vous devez ajouter les règles que vous souhaitez appliquer à votre second profil. Cliquez sur **Ajouter une règle** et établissez la même règle qui est appliquée à votre profil par défaut. ![Ajouter une règle pour s’absenter du bureau](./media/insights-how-to-scale/Insights_RuleOffWork.png)
3. Assurez-vous de créer une règle relative à l’extension et à la réduction des instances, sinon le nombre d’instances ne fera qu’augmenter (ou diminuer) sur ce profil.
