---
title: 'Azure Insights : exemples de démarrage rapide de l’interface de ligne de commande (CLI) Azure Insights | Microsoft Docs'
...
Pour utiliser les commandes Azure Resource Manager et Azure Insights, vous devez être en mode Azure Resource Manager.
