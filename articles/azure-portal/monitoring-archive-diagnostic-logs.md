...
## Archivage des journaux de diagnostic à l’aide des applets de commande PowerShell
```
...
## Archivage des journaux de diagnostic à l’aide de l’API REST
[Consultez ce document](https://msdn.microsoft.com/library/azure/dn931931.aspx) pour obtenir plus d’informations sur la configuration d’un paramètre de diagnostic à l’aide de l’API REST Azure Insights.

## Schéma des journaux de diagnostic dans le compte de stockage
...
* [Diffuser en continu le journal des activités Azure sur les Event Hubs](../monitoring-and-diagnostics/monitoring-stream-diagnostic-logs-to-event-hubs.md)
