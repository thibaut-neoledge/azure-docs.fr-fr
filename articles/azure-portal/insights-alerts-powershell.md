...
7. Pour créer une alerte qui se déclenche selon une condition spécifique dans le journal d’activité, utilisez des commandes au format suivant
...
8. Vérifiez que vos alertes ont été correctement créées en examinant les règles en particulier.
...
9. Supprimez vos alertes. Ces commandes suppriment les règles créées précédemment dans cet article.
