...
Vous pouvez également configurer une alerte à publier vers un URI de webhook à l’aide des [applets de commande Azure PowerShell](../monitoring-and-diagnostics/insights-powershell-samples.md#create-alert-rules), de [l’interface de ligne de commande multiplateforme](../monitoring-and-diagnostics/insights-cli-samples.md#work-with-alerts) ou de [l’API REST Insights](https://msdn.microsoft.com/library/azure/dn933805.aspx).
...
> [!NOTE]
> Le champ properties est uniquement définissable à l’aide de [l’API REST Insights](https://msdn.microsoft.com/library/azure/dn933805.aspx).
> 
> 
