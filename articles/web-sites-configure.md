<properties urlDisplayName="How to configure" pageTitle="Configuration de sites web - Gestion des services Azure" metaKeywords="Azure websites, configuring Azure websites, Azure SQL database, Azure MySQL" description="Découvrez comment configurer des sites web dans Azure, y compris comment configurer un site web pour qu'il utilise une base de données de base de données SQL ou MySQL." metaCanonical="" services="web-sites" documentationCenter="" title="How to Configure Websites" authors="mwasson" solutions="" manager="wpickett" editor="mollybos" />
