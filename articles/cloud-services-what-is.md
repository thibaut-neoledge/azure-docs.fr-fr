...
-   **Azure Diagnostics :** il s'agit de l'API qui vous permet de recueillir des données de diagnostic provenant des applications exécutées dans Azure. Azure Diagnostics doit être activé pour les rôles de service cloud afin de pouvoir utiliser la surveillance détaillée.
