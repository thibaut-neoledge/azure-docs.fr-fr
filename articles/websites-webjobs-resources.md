<properties pageTitle="Azure WebJobs - Ressources recommandées" metaKeywords="Azure WebJobs, Azure WebJobs SDK, Azure storage, Azure queues, Azure tables, Azure Service Bus" description="Ressources recommandées pour apprendre à utiliser Azure WebJobs et le Kit de développement logiciel (SDK) WebJobs." metaCanonical="" services="web-sites,storage" documentationCenter=".NET" title="Azure WebJobs Recommended Resources" authors="tdykstra" solutions="" manager="wpickett" editor="jimbe" />
...
* [Utilisation du stockage de files d'attente Azure à l'aide du Kit de développement logiciel (SDK) WebJobs](../websites-dotnet-webjobs-sdk-storage-queues-how-to)
* Vidéos
...
Consultez également les sections suivantes sur le [déploiement des tâches web WebJobs](#deploy) et le [test et le débogage des tâches web WebJobs](#debug).

##<a name="deploy"></a>Déploiement de WebJobs

* [Déploiement de tâches web Azure sur des sites web Azure](../websites-dotnet-deploy-webjobs/)
...
* [Résolution des problèmes de Sites Web Azure dans Visual Studio](../web-sites-dotnet-troubleshoot-visual-studio/).
...
* [Exécution des tâches web WebJobs Powershell sur Sites Web Azure](http://blogs.msdn.com/b/nicktrog/archive/2014/01/22/running-powershell-web-jobs-on-azure-websites.aspx)
* [Notification au déclenchement des tâches web WebJobs terminées](http://blog.amitapple.com/post/2014/03/webjobs-notification/)
* [Sites Web Azure : Architecture des applications web prêtes à être utilisées par les entreprise à grande échelle](https://channel9.msdn.com/Events/Build/2014/3-626). Couvre la mise à l'échelle de Sites Web Azure avec WebJobs, notamment le Kit de développement logiciel (SDK) WebJobs.
...
* [Blog Azure](/blog)
* [Amit Apple's blog](http://blog.amitapple.com/). Se concentre sur WebJobs (pas sur le Kit de développement logiciel (SDK)).
