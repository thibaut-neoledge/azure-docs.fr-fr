...
-   [Ajout d'API à un produit][Ajout d'API à un produit]
-   [Ajout d'informations descriptives à un produit][Ajout d'informations descriptives à un produit]
-   [Publication d'un produit][Publication d'un produit]
-   [Rendre un produit visible pour les développeurs][Rendre un produit visible pour les développeurs]
-   [Affichage des abonnés à un produit][Affichage des abonnés à un produit]
...
> Pour plus d'informations, consultez la page [Création et utilisation de groupes pour gérer les comptes de développeurs dans Gestion des API Azure][Création et utilisation de groupes pour gérer les comptes de développeurs dans Gestion des API Azure].
