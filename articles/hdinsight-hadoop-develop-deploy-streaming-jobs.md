...
- Émulateur HDInsight Azure installé. Pour obtenir des instructions, consultez la rubrique [Prise en main de l'émulateur HDInsight][hdinsight-get-started-emulator].
...
7. Cliquez sur **Oui** pour confirmer les changements de noms de toutes les références.
...
4. Dans l'Explorateur de solutions, cliquez avec le bouton droit sur P**Program.cs**, puis cliquez sur **Renommer**.
...
**Copie des fichiers texte vers l'émulateur HDFS**
...
6. Exécutez les commandes suivantes pour envoyer la tâche MapReduce et attendez qu'elle soit terminée :
...
1. Sur le Bureau, cliquez sur **État de Hadoop YARN** ou accédez à **http://localhost:50030/jobtracker.jsp**.
