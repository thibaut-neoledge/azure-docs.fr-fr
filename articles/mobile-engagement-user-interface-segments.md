<properties 
   ...
   description="Présentation de l'interface utilisateur de la section Segments d'Azure Mobile Engagement" 
...
<a href="../mobile-engagement-user-interface-reach" title="Reach">Couverture</a>
...
- [Documentation sur les API - API Segments][Link 4], [Guide de résolution des problèmes - Analyse][Link 2]

Vous pouvez créer un segment à partir de 10 critères maximum sur une période passée donnée de 60 jours maximum à partir de la section Analyse. 
...
**Exemples de segments que vous pouvez créer à partir des principaux éléments d'Azure Mobile Engagement :**
...
**Exemple : créer un segment simple en fonction des informations de " Session ".**
...
1. Sélectionnez l'opérateur pertinent dans la liste : = ; ≥ ou ≤.
