<properties urlDisplayName="" pageTitle="Signatures d'accès partagé : présentation du modèle SAP | Microsoft Azure" metaKeywords="Azure blob, Azure table, Azure queue, shared access signatures" description="Découvrez comment déléguer l'accès aux ressources d'objets blob, de files d'attente et de tables avec les signatures d'accès partagé" metaCanonical="" services="storage" documentationCenter="" title="Part 1: Understanding the SAS Model" solutions="" authors="tamram" manager="adinah" />
