...
> Pour plus d'informations concernant OAuth 2.0, voir la spécification à l'adresse [][]<http://oauth.net/2/></a>.

## Dans cette rubrique

-   [Configuration requise][]
-   [Configuration du serveur d'autorisation OAuth 2.0 dans Gestion des API][]
-   [Configuration d'une API pour utiliser l'autorisation utilisateur OAuth 2.0][]
-   [Tests de l'autorisation utilisateur OAuth 2.0 dans le portail de développement][]
...
> Pour plus d'informations sur la configuration de OAuth 2.0 à l'aide de Azure Active Directory, voir l'exemple [WebApp-GraphAPI-DotNet][].
...
À présent, vous pouvez configurer les valeurs souhaitées pour les paramètres restants, puis soumettre la demande.
  ...
  [Nouveau serveur]: ./media/api-management-howto-oauth2/api-management-oauth2-server-1.png
  ...
  [Autorisation utilisateur]: ./media/api-management-howto-oauth2/api-management-user-authorization.png
  [5]: ./media/api-management-howto-oauth2/api-management-user-authorization-save.png
  [Portail des développeurs]: ./media/api-management-howto-oauth2/api-management-developer-portal-menu.png
  [API Echo]: ./media/api-management-howto-oauth2/api-management-apis-echo-api.png
  [Open console]: ./media/api-management-howto-oauth2/api-management-open-console.png
  [Connexion]: ./media/api-management-howto-oauth2/api-management-oauth2-signin.png
  [Jeton d'en-tête de demande]: ./media/api-management-howto-oauth2/api-management-request-header-token.png
