...
> [AZURE.NOTE] Seuls les membres du groupe « AAD DC Administrators » disposent des privilèges requis pour créer une UO personnalisée. Veillez à effectuer les étapes suivantes en tant qu’utilisateur appartenant à ce groupe.
...
## <a name="permissions/security-for-newly-created-ous"></a>Sécurité/autorisations associées aux nouvelles unités d’organisation
