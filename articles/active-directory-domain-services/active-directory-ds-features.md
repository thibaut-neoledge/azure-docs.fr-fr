...
- **Disponibilité dans plusieurs régions Azure :** pour obtenir la liste des régions Azure dans lesquelles les services de domaine Azure AD sont disponibles, consultez la page [Prise en charge des régions Azure](active-directory-ds-regions.md).
