...
6. Créez un groupe nommé **AAD DC Administrators**.
    ...
    > [AZURE.WARNING] Créez un groupe portant exactement ce nom pour activer l’accès au sein des services de domaine Azure AD.
