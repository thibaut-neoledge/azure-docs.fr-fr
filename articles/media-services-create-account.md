...
## <a id="quick"></a>Procédure : Création d'un compte Media Services grâce à la méthode Création rapide
...
<!-- Anchors. -->
  ...
  [Procédure : Création d'un compte Media Services grâce à la méthode Création rapide]: #quick
