---
title: 'Didacticiel : Intégration d’Azure AD à Skydesk Email | Microsoft Docs'
...
1. Dans la page de configuration **Configurer l’authentification unique sur Skydesk Email**, procédez comme suit :
    ...
    b. Cliquez sur **Next**.
2. Pour activer l’authentification unique dans **Skydesk Email**, procédez comme suit :
...
3. Dans la page de boîte de dialogue **SAML Authentication**, procédez comme suit :
   
    ![Configurer l’authentification unique](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_56.png)
   
   > [!NOTE]
   > Pour utiliser l’authentification SAML, un **domaine vérifié** ou l’**URL du portail** doit être configuré(e). Vous pouvez définir l’URL du portail avec un nom unique.
   > 
   > 
