...
3. Sur la page **Configurer les paramètres d’application** , procédez comme suit :
    ...
    a. Dans la zone de texte URL de connexion, tapez l’URL entrée par vos utilisateurs pour se connecter à votre application Skydesk Email au format suivant: **“https://mail.skydesk.jp/portal/\<nom d’entreprise\>“**.
