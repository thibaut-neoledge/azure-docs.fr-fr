...
8. Configurez les autorisations pour votre application : dans le menu Paramètres, cliquez sur la section « Autorisations requises », cliquez sur **Ajouter**, sur **Sélectionner une API**, puis sélectionnez « Windows Azure Active Directory » (il s’agit de l’API AADGraph). Ensuite, cliquez sur **Sélectionner les autorisations** et sélectionnez **Lire les données de l’annuaire**. Cela permet à votre application d’interroger l’API Graph concernant les utilisateurs.
