...
4. **[Création d’un utilisateur de test @Tasktest](#creating-a-halogen-software-test-user)** pour avoir un équivalent de Britta Simon dans @Taskthat lié à la représentation Azure AD associée.
