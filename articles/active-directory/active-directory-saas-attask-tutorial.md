---
title: "Didacticiel : Intégration de Azure Active Directory à @Task | Microsoft Docs"
...
Pour configurer l’intégration de Azure AD avec @Task, vous avez besoin des éléments suivants :
