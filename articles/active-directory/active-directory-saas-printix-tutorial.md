...
Pour ce faire, affectez la valeur du **nom d’utilisateur** dans Azure AD comme valeur de **Username** dans Printix.
...
1. Dans le portail classique, dans la page d’intégration d’application **Printix**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
...
7. Sous l’onglet **Setup** (Configuration), sélectionnez **Enable Azure/Office 365 authentication** (Activer l’authentification Azure/Office 365).
   
    ![Configurer l’authentification unique](./media/active-directory-saas-printix-tutorial/tutorial_printix_07.png)

8. Sous l’onglet **Azure**, entrez l’URL des métadonnées de fédération dans la zone de texte **Federation metadata document** (Document de métadonnées de fédération). 
...
9. Cliquez sur le bouton **Test**, puis sur le bouton **OK** si le test a réussi.
...
> [!NOTE]
> Si vous devez créer un utilisateur manuellement, contactez l’équipe de support Printix.
> 
> 
