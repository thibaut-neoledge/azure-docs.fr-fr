...
* Un abonnement Egnyte pour lequel l’authentification unique (SSO) est activée
...
## <a name="enable-the-application-integration-for-egnyte"></a>Activer l’intégration d’applications pour Egnyte
Cette section décrit l’activation de l’intégration d’application pour Egnyte.

**Pour activer l’intégration d’applications pour Egnyte, suivez les étapes ci-dessous :**
...
4. Cliquez sur **Ajouter** en bas de la page.
   ...
   ![Ajouter une application](./media/active-directory-saas-egnyte-tutorial/IC749321.png "Ajouter une application")
...
**Pour affecter des utilisateurs à Egnyte, suivez les étapes ci-dessous :**
