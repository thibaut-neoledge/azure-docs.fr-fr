...
> [AZURE.NOTE]Quand vous exécutez $aadAdminCred = Get-Credential,,utilisez le format user@example.com pour le nom d’utilisateur des informations d’identification entrées lorsque la fenêtre contextuelle Get-Credential s’affiche.  
