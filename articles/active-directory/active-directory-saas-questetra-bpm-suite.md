...
1. Dans le portail Azure AD, dans la page d'intégration d'application **Questetra BPM Suite**, cliquez sur **Configurer l'authentification unique** pour ouvrir la boîte de dialogue **Configurer l'authentification unique**.<br><br> ![Configurer l’authentification unique][8]
...
6. Dans la page **Configurer les paramètres d'application** du portail Azure, procédez comme suit : <br><br>![Configurer les paramètres d’application][13]
...
8. Sur votre site d'entreprise **Questetra BPM Suite**, procédez comme suit : <br><br>![Configurer l’authentification unique][15]
    ...
    b. Dans le portail Azure, copiez la valeur **URL de l’émetteur** et collez-la dans la zone de texte **ID d'entité**.

    c. Dans le portail Azure, copiez la valeur **URL du service d'authentification unique**, puis collez-la dans la zone de texte **URL de page de connexion**.

    d. Dans le portail Azure, copiez la valeur **URL du service de déconnexion unique**, puis collez-la dans la zone de texte **URL de page de déconnexion**.
