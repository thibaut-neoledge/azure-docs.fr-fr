...
Microsoft a testé ces expériences d’authentification unique à l’aide de fournisseurs d’identité non-Microsoft par rapport à un ensemble de cas d’utilisation courants avec Azure Active Directory.

>[AZURE.IMPORTANT] Microsoft a uniquement testé la fonctionnalité de fédération de ces scénarios d’authentification unique. Microsoft n’a pas testé les composants de synchronisation, d’authentification à 2 facteurs, etc., de ces scénarios d’authentification unique.
...
Pour plus d’informations sur l’utilisation d’Azure Active Directory avec AD FS, voir [Liste de contrôle : Utiliser AD FS pour mettre en œuvre et gérer l’authentification unique](active-directory-aadconnect-get-started-custom.md#configuring-federation-with-ad-fs)

Pour plus d’informations sur l’utilisation d’Azure Active Directory avec une synchronisation de mot de passe, voir [Intégration de vos identités locales avec Azure Active Directory](active-directory-aadconnect.md)
...
| Clients de messagerie riches (p. ex., Outlook et ActiveSync) | Pris en charge |Pour plus d’informations sur les stratégies d’accès des clients, voir [Limiting Access to Office 365 Services Based on the Location of the Client](https://technet.microsoft.com/library/hh526961.aspx) (Limitation de l’accès aux services Office 365 en fonction de l’emplacement du client).|
...
Pour obtenir des instructions sur la façon de configurer ce STS pour fournir une expérience d’authentification unique à vos utilisateurs Active Directory avec PingFederate, voir [ici](http://documentation.pingidentity.com/display/PF72/PingFederate+7.2).
...
Pour plus d’informations sur IBM Tivoli Federated Identity Manager, voir [IBM Security Access Manager for Microsoft Applications](http://www-01.ibm.com/support/docview.wss?uid=swg24029517) (IBM Security Access Manager pour applications Microsoft).
...
Pour plus d’informations sur CA SiteMinder, voir [CA SiteMinder Federation](http://www.ca.com/us/products/ca-single-sign-on.html).
...
Pour plus d’informations sur BIG-IP Access Policy Manager, voir [BIG-IP Access Policy Manager.](https://f5.com/products/modules/access-policy-manager)
...
Pour plus d’informations sur IceWall Federation, voir [ici](http://h50146.www5.hp.com/products/software/security/icewall/eng/federation/) et [ici](http://h50146.www5.hp.com/products/software/security/icewall/federation/office365.html).
...
Pour plus d’informations sur CA Secure Cloud, voir [CA Secure Cloud](http://www.ca.com/us/products/security-as-a-service.aspx).
