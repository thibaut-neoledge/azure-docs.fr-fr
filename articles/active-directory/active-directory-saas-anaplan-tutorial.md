<properties
	pageTitle="Didacticiel : Intégration d’Azure Active Directory à Anaplan | Microsoft Azure"
...
# Didacticiel : Intégration d’Azure Active Directory à Anaplan
...
## Ajout d’Anaplan à partir de la galerie
...
### Création d’un utilisateur de test Anaplan

Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans Anaplan. Veuillez contacter l’équipe de support Anaplan via <mailto:support@anaplan.com> pour ajouter les utilisateurs sur la plate-forme Anaplan.
