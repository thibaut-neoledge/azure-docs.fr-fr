...
L’objectif de cette section est de vous montrer comment configurer et tester l’authentification unique Azure AD avec Anaplan au moyen d’un utilisateur de test appelé « Britta Simon ».
...
Pour configurer et tester l’authentification unique Azure AD avec Anaplan, vous devez suivre les indications des sections ci-après :
...
Dans cette section, vous allez activer l’authentification unique Azure AD dans le portail Azure Classic et configurer l’authentification unique dans votre application Anaplan.
...
3. Dans la page de boîte de dialogue **Configurer les paramètres d’application**, procédez comme suit et cliquez sur **Suivant** :
  ...
  1. Dans la zone de texte **URL de connexion**, tapez une URL au format suivant : `https://sdp.anaplan.com/frontdoor/saml/<tenant name>`
  2. Cliquez sur **Suivant**.

    > [!NOTE] 
    > La valeur de l’URL de connexion dans ce didacticiel est simplement un espace réservé. Pour obtenir la valeur réelle pour votre environnement, contactez l’équipe de support technique d’Anaplan.
    > 
4. Dans la page **Configurer l’authentification unique sur Anaplan**, procédez comme suit et cliquez sur **Suivant** :
  ...
  2. Cliquez sur **Suivant**.
5. Pour obtenir la configuration de l’authentification unique pour votre application, contactez l’équipe de support d’Anaplan à l’adresse [support@anaplan.com](mailto:support@anaplan.com) , et envoyez-lui les éléments suivants :
...
### <a name="create-a-anaplan-test-user"></a>Créer un utilisateur de test Anaplan
