<properties
    pageTitle="Mettre à niveau depuis DirSync et Azure AD Sync | Microsoft Azure"
...
Solution | Scénario
----- | -----
[Mise à niveau à partir de DirSync](./aad-connect/active-directory-aadconnect-dirsync-upgrade-get-started.md) | <li>Si vous disposez d’un serveur DirSync existant déjà en cours d’exécution.</li>
