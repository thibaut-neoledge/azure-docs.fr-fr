...
Pour ce faire, affectez la valeur de **nom d’utilisateur** dans Azure AD comme valeur de **nom d’utilisateur** dans SAP Business ByDesign.
...
5. Dans la page **Comment voulez-vous que les utilisateurs se connectent à SAP Business ByDesign**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**.
...
6. Sur la page **Configurer les paramètres d’application** , procédez comme suit :
    ...
    a. Dans la zone de texte **URL de connexion**, tapez l’URL entrée par vos utilisateurs pour se connecter à votre application SAP Business ByDesign, au format suivant : `https://<servername>.sapbydesign.com`
...
### <a name="creating-an-sap-business-bydesign-test-user"></a>Créer un utilisateur de test pour SAP Business ByDesign
