<properties
	pageTitle="Didacticiel : Intégration d’Azure Active Directory dans &amp;frankly | azure.microsoft.com/ Azure"
...
# Didacticiel : Intégration d’Azure Active Directory dans &frankly

L’objectif de ce didacticiel est de vous montrer comment intégrer &frankly dans Azure AD (Azure Active Directory).
...
## Ajout de &frankly à partir de la galerie
...
6. Dans la zone de recherche, tapez **&frankly**.

	![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-andfrankly-tutorial/tutorial_andfrankly_01.png)

7. Dans le volet des résultats, sélectionnez **&frankly**, puis cliquez sur **Terminer** pour ajouter l’application.
...
Pour cela, affectez la valeur du **nom d’utilisateur** dans Azure AD comme valeur du **nom d’utilisateur** dans &frankly.
...
1. Dans la page d’intégration de l’application **&frankly** sur le portail Azure Classic, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
	 
	![Configurer l’authentification unique][6]

2. Dans la page **Comment voulez-vous que les utilisateurs se connectent à &frankly**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**.
...
3. Dans la page de boîte de dialogue **Configurer les paramètres d’application**, si vous souhaitez configurer l’application en **mode lancé par le fournisseur d’identité**, procédez comme suit et cliquez sur **Suivant** :
    ...
    b. Dans la zone de texte **URL de réponse**, saisissez une URL au format suivant : `https://andfrankly.com/saml/simplesaml/www/module.php/saml/sp/saml2-acs.php/<tenant id>`
...
4. Si vous souhaitez configurer l’application en **mode lancé par le fournisseur de service** dans la page de boîte de dialogue **Configurer les paramètres d’application**, cliquez sur **Affichez les paramètres avancés (facultatif)**, saisissez **l’URL de connexion** et cliquez sur **Suivant**.
	...
	> [AZURE.NOTE] Notez qu’il ne s’agit pas des valeurs réelles. Vous devez mettre à jour ces valeurs avec l’URL d’authentification, l’identificateur et l’URL de réponse [help@andfrankly.com](emailTo:help@andfrankly.com).
...
### Création d’un utilisateur de test dans &frankly
