...
## <a name="*2.-set-up-your-app-to-use-the-owin-authentication-pipeline*"></a>*2. Configuration de votre application pour utiliser le pipeline d’authentification OWIN*
...
## <a name="*3.-use-owin-to-issue-sign-in-and-sign-out-requests-to-azure-ad*"></a>*3. Utilisation d’OWIN pour émettre des demandes de connexion et de déconnexion dans Azure AD*
...
## <a name="*4.-display-user-information*"></a>*4.  Affichage des informations utilisateur*
