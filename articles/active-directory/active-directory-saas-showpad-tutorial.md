---
title: 'Didacticiel : Intégration d’Azure Active Directory avec Showpad | Microsoft Docs'
...
1. Dans la page **Configure single sign-on at Showpad** (Configurer l’authentification unique sur Showpad), procédez comme suit et cliquez sur **Suivant** :
    ...
    b. Cliquez sur **Next**.
2. Connectez-vous à votre client Showpad en tant qu’administrateur.
...
4. Accédez à « **Authentification unique** » et cliquez sur « **Activer** ».
...
5. Dans la boîte de dialogue **Add a SAML 2.0 Service** (Ajouter un service SAML 2.0), procédez comme suit :
