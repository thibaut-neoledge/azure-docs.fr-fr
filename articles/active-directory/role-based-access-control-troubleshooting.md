...
Ce document vous permet de savoir ce à quoi vous pouvez vous attendre quand vous utilisez les rôles sur le portail Azure. Ces trois rôles inclus couvrent tous les types de ressources :
