...
3. Sous **Propriétés**, définissez **Méthode d’authentification interne** sur **Authentification Windows intégrée**.<br>![Configuration avancée des applications](./media/active-directory-application-proxy-sso-using-kcd/cwap_auth2.png)
