...
L’objectif de ce didacticiel est de vous montrer comment intégrer le portail de gestion cloud pour Microsoft Azure avec Azure Active Directory (Azure AD).  
...
1. Dans la page d’intégration d’application **Cloud Management Portal for Microsoft Azure** du Portail Azure Classic, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
