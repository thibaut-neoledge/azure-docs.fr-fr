...
# Didacticiel : Intégration d’Azure Active Directory avec Bynder
...
3. Dans la page de boîte de dialogue **Configurer les paramètres d’application**, si vous souhaitez configurer l’application en **mode lancé par le fournisseur d’identité**, procédez comme suit et cliquez sur **Suivant** :
    ...
    a. Dans la zone de texte **URL de réponse**, saisissez une URL au format suivant : `https://<company name>.getbynder.com/sso/SAML/authenticate/`
...
### Création d’un utilisateur de test Bynder
...
> [AZURE.NOTE] Si vous devez créer un utilisateur manuellement, contactez l’équipe du support technique Bynder.
