...
4. Dans la zone de recherche, tapez **Kindling**.

    ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-kindling-tutorial/tutorial_kindling_search.png)

5. Dans le panneau de résultats, sélectionnez **Kindling**, puis cliquez sur **Ajouter** pour ajouter l’application.
...
3. **[Création d'un utilisateur de test Kindling](#creating-a-kindling-test-user)** pour avoir un équivalent de Britta Simon dans Kindling lié à la représentation d’un utilisateur Azure AD.
...
3. Dans la section **Domaine et URL Kindling**, procédez comme suit :
...
6. Pour ouvrir la fenêtre **Configurer l’authentification**, dans la section **Configuration de Kindling**, cliquez sur **Configurer Kindling**. Copiez **l’URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**

    ![Configurer l’authentification unique](./media/active-directory-saas-kindling-tutorial/tutorial_kindling_configure.png) 

7. Pour configurer l’authentification unique côté **Kindling**, vous devez envoyer le **Certificat (Base64)** téléchargé, l’**URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à l’[équipe de support Kindling](mailto:support@kindlingapp.com).
