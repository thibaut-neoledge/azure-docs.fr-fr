...
Pour autoriser un accès utilisateur au niveau *annuaire* dans Azure AD Connect Health, ouvrez le panneau principal dans Azure AD Connect Health.<br>
[//]: # (RBAC\_MainBladeSS)
