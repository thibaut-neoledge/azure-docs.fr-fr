...
4. Sélectionnez la case à cocher pour configurer les notifications par courrier électronique pour l’ensemble des administrateurs généraux des locataires.
5. Si vous souhaitez recevoir des notifications par courrier électronique sur d’autres adresses, indiquez-les dans les zones Destinataires d’e-mail supplémentaires. Pour supprimer une adresse de messagerie de cette liste, cliquez avec le bouton droit sur l’entrée, puis sélectionnez Supprimer.
