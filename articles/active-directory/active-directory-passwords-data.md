...
---
# Déployer la réinitialisation du mot de passe sans demander l’inscription de l’utilisateur final
...
## Définir et lire les données d’authentification à l’aide de PowerShell
...
#### Définir les données d’authentification avec PowerShell V1
...
#### Lire les données d’authentification avec PowerShell V1
...
#### Téléphone d’authentification et E-mail d’authentification ne peuvent être lus qu’à l’aide de Powershell V1 en utilisant les commandes qui suivent
...
#### Définir les données d’authentification avec PowerShell V2
...
### Lire les données d’authentification avec PowerShell V2
