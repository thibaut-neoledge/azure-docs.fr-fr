...
Le rapport du portail O365 affiche uniquement les objets **Utilisateur** qui présentent ces erreurs. Il n’affichera pas les informations sur les conflits entre **Groupes**, **Contacts** ou **PublicFolders**.
...
2.	Cliquez sur **Utilisateurs -> Utilisateurs actifs** ![Utilisateurs actifs](./media/active-directory-aadconnectsyncservice-duplicate-attribute-resiliency/2.png "Utilisateurs actifs")

3.	Un avertissement s’affichera en haut de la page en présence d’erreurs d’attribut en double pour un objet quelconque dans le client : ![Utilisateurs actifs](./media/active-directory-aadconnectsyncservice-duplicate-attribute-resiliency/3.png "Utilisateurs actifs")

4.	Pour afficher les détails spécifiques d’objets, sélectionnez « Utilisateurs avec erreurs » dans la liste déroulante « Sélectionner un affichage » : ![Utilisateurs actifs](./media/active-directory-aadconnectsyncservice-duplicate-attribute-resiliency/4.png "Utilisateurs actifs")

5.	Cliquez sur un objet pour avoir plus d’informations sur le conflit ; celles-ci seront affichées dans le coin inférieur droit de l’écran : ![Utilisateurs actifs](./media/active-directory-aadconnectsyncservice-duplicate-attribute-resiliency/5.png "Utilisateurs actifs")
...
L’article suivant expose différentes stratégies de dépannage et de résolution : [Duplicate or invalid attributes prevent directory synchronization in Office 365](https://support.microsoft.com/kb/2647098) (Les attributs en double ou non valides empêchent la synchronisation de répertoires dans Office 365).
