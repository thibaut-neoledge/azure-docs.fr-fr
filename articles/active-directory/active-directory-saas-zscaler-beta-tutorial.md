<properties 
    pageTitle="Didacticiel : Intégration d’Azure AD à Zscaler Beta | azure.microsoft.com/ Azure" 
...
2.  Dans la page **Comment voulez-vous que les utilisateurs se connectent à Zscaler Beta**, sélectionnez **Authentification unique azure.microsoft.com/ Azure AD**, puis cliquez sur **Suivant**.
