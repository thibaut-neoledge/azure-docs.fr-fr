...
1. Sur la page **Configurer l’authentification unique sur Soonr Workplace**, procédez comme suit :
    ...
    b. Cliquez sur **Next**.
2. Pour configurer l’authentification unique pour votre application, consultez le guide Soonr Workplace SSO Integration ou contactez vos partenaires d’intégration pour plus de détails.
...
> [!NOTE]
> Si vous devez créer un utilisateur manuellement, contactez l’équipe du support technique Soonr Workplace.
> 
> 
