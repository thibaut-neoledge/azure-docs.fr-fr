...
## <a name="how-to-access-password-management-reports-from-an-api"></a>Comment accéder aux rapports de gestion des mots de passe depuis une API
...
## <a name="view-password-reset-registration-activity"></a>Visualiser l’activité d’inscription à la réinitialisation de mot de passe dans votre organisation
...
## <a name="view-password-reset-activity"></a>Visualiser l’activité de réinitialisation de mot de passe dans votre organisation
