<properties
	pageTitle="Didacticiel : Intégration d’Azure Active Directory à HireVue | Microsoft Azure"
...
# Didacticiel : Intégration d’Azure AD à HireVue
...
## Ajout de HireVue depuis la galerie
...
Pour cela, affectez la valeur de **nom d’utilisateur** dans Azure AD comme valeur de **nom d’utilisateur** dans Fuse.
...
1. Dans le portail Classic, dans la page d’intégration d’applications **HireVue**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
...
5. Dans la page de boîte de dialogue **Dites-nous en plus sur cet utilisateur**, procédez comme suit : ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-hirevue-tutorial/create_aaduser_05.png)
...
6.  Sur la page **Profil utilisateur**, procédez comme suit : ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-hirevue-tutorial/create_aaduser_06.png)
...
### Création d’un utilisateur de test HireVue
