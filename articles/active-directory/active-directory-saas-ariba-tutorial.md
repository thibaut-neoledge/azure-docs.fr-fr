...
* Vous pouvez autoriser vos utilisateurs à se connecter automatiquement à Ariba via l’authentification unique (SSO) avec leur compte Azure AD.
...
L’objectif de cette section est d’activer l’authentification unique Azure AD dans le portail Azure Classic et de la configurer dans votre application Ariba.
...
3. Sur la page de boîte de dialogue **Configurer les paramètres de l’application** , procédez comme suit :
  ...
  1. Dans la zone de texte URL de connexion, tapez l’URL utilisée par vos utilisateurs pour se connecter à votre application Ariba, au format suivant : « **https://<companyname>.sourcing.ariba.com** » ou « **https://<CompanyName>.supplier.ariba.com** ».
...
### <a name="create-a-ariba-test-user"></a>Créer un utilisateur de test Ariba
L’objectif de cette section est de créer un utilisateur appelé Britta Simon dans Ariba. Collaborez avec l’équipe du support technique Ariba pour ajouter des utilisateurs dans le système Ariba. 
 ...
 >[!NOTE]
 >Si vous devez créer un utilisateur manuellement, contactez l’équipe du support technique Ariba.
 >  
