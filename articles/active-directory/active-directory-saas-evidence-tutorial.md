...
---
# <a name="tutorial:-azure-active-directory-integration-with-evidence.com"></a>Didacticiel : Intégration d’Azure Active Directory à Evidence.com
...
## <a name="add-evidence.com-to-your-directory"></a>Ajout de Evidence.com à votre répertoire
...
3. Dans l’écran Configurer l’URL de l’application, entrez l’URL à laquelle les utilisateurs se connecteront à votre client Evidence.com (exemple : https://votreclient.evidence.com), puis cliquez sur **Suivant**. 
...
## <a name="creating-an-evidence.com-test-user"></a>Création d’un utilisateur de test Evidence.com
...
## <a name="assigning-users-to-evidence.com"></a>Affectation d’utilisateurs à Evidence.com
