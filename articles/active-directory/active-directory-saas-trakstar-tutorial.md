...
L’objectif de ce didacticiel est de vous montrer comment intégrer Trakstar dans Azure Active Directory (Azure AD).  
...
5. Dans la boîte de dialogue **Que voulez-vous faire ?**, cliquez sur **Ajouter une application à partir de la galerie**.
    ...
    ![Applications][4]
6. Dans la zone de recherche, tapez **Trakstar**.
   
    ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-trakstar-tutorial/tutorial_trakstar_01.png)
7. Dans le volet de résultats, sélectionnez **Trakstar**, puis cliquez sur **Terminer** pour ajouter l’application.
...
Pour ce faire, affectez la valeur de **nom d’utilisateur** dans Azure AD comme valeur de **nom d’utilisateur** dans Trakstar.
...
1. Dans le portail Azure Classic, dans la page d’intégration d’application **Trakstar**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
   
    ![Configurer l’authentification unique][6] 
2. Dans la page **Comment voulez-vous que les utilisateurs se connectent à Trakstar**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**.
...
3. Sur la page **Configurer les paramètres d’application** , procédez comme suit :
    ...
    a. Dans la zone de texte URL de connexion, tapez l’URL entrée par vos utilisateurs pour se connecter à votre application Trakstar au format suivant : **https://app.trakstar.com/auth/saml/callback?namespace=&lt;espace de noms&gt;**.

    b. Cliquez sur **Next**.

1. Dans la page de configuration **Configurer l’authentification unique sur Trakstar** , procédez comme suit :
    ...
    b. Cliquez sur **Next**.
2. Pour obtenir la configuration de l’authentification unique pour votre application, contactez votre équipe de support Trakstar à l’adresse [integrations@trakstar.com](mailto:integrations@trakstar.com) et fournissez-lui les éléments suivants :
...
> [!NOTE]
> Si vous devez créer un utilisateur manuellement, contactez l'équipe de support Trakstar.
> 
> 

### <a name="assigning-the-azure-ad-test-user"></a>Affectation de l’utilisateur de test Azure AD
L’objectif de cette section est de permettre à Britta Simon d’utiliser l’authentification unique Azure en lui accordant l’accès à Trakstar.
