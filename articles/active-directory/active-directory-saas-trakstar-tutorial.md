...
L’objectif de ce didacticiel est de vous montrer comment intégrer Trakstar dans Azure Active Directory (Azure AD). L’intégration de Trakstar dans Azure AD vous offre les avantages suivants :
...
7. Dans le volet des résultats, sélectionnez **Trakstar**, puis cliquez sur **Terminer** pour ajouter l’application.
...
1. Dans le portail Azure Classic, puis sur la page d’intégration d’applications **Trakstar**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
   
    ![Configurer l’authentification unique][6]
2. Sur la page **Comment voulez-vous que les utilisateurs se connectent à Trakstar**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**.
