...
Certaines applications Exchange ActiveSync sur iOS 9 ou version ultérieure sont prises en charge. Pour déterminer si votre application de messagerie prend en charge cette fonctionnalité, contactez le développeur de votre application. Pour ce scénario, l’authentification fédérée avec un certificat client n’est pas prise en charge.
