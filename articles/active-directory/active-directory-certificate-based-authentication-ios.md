---
title: "Prise en main de l’authentification par certificat sur iOS | Microsoft Docs"
...
---
# <a name="get-started-with-certificate-based-authentication-on-ios---public-preview"></a>Prise en main de l’authentification par certificat sur iOS - Version préliminaire publique
...
Pour télécharger les informations, vous pouvez utiliser le module Azure AD via Windows PowerShell.  
Vous trouverez ci-dessous des exemples d’ajout, de suppression ou de modification d’une autorité de certification. 
...
### <a name="testing-eas-client-applications-on-ios"></a>Test des applications clientes EAS sur iOS
