...
## Vue d'ensemble
Vous pouvez commencer avec un pilote de la fonctionnalité de gestion des mots de passe Azure AD en moins de cinq minutes, et effectuer un déploiement dans l’ensemble de l’organisation en quelques heures. Voici quelques ressources utiles pour utiliser le service :
...
## Possibilités offertes par la gestion des mots de passe Azure AD
...
**Prise en charge du rappel invitant les utilisateurs à mettre à jour leurs données enregistrées au cours de l’authentification** - En cours
