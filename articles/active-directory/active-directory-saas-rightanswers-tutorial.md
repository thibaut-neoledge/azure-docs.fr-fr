...
## <a name="enable-the-application-integration-for-rightanswers"></a>Activer l’intégration d’applications pour RightAnswers
Cette section décrit l’activation de l’intégration d’application pour RightAnswers.

**Pour activer l’intégration d’applications pour RightAnswers, procédez comme suit :**
