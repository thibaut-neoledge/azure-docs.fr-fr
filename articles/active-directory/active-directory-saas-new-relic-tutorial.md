...
##Activation de l’intégration d’application pour New Relic
...
4.  Cliquez sur **Ajouter** en bas de la page.
    ...
    ![Ajouter l’application](./media/active-directory-saas-new-relic-tutorial/IC749321.png "Ajouter l’application")
...
8.  Dans la page de boîte de dialogue SAML, procédez comme suit :
    ...
    2.  Dans la page **Configurer l’authentification unique sur New Relic** du portail Microsoft Azure, copiez la valeur de **URL de connexion distante** et collez-la dans la zone de texte **Remote login URL**.
...
>[AZURE.NOTE]Vous pouvez utiliser n’importe quel outil ou API de création de compte d’utilisateur, fourni par New Relic, pour approvisionner des comptes utilisateur AAD.
