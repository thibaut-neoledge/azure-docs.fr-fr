...
4. Dans la zone de recherche, tapez **Cimpl**.

    ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-cimpl-tutorial/tutorial_cimpl_search.png)

5. Dans le volet de résultats, sélectionnez **Cimpl**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
3. **[Création d’un utilisateur de test Cimpl](#creating-a-cimpl-test-user)** pour avoir un équivalent de Britta Simon dans Cimpl, lié à la représentation Azure AD de l’utilisateur.
...
3. Dans la section **Domaine et URL Cimpl**, procédez comme suit :
...
6. Dans la section **Configuration de Cimpl**, cliquez sur **Configurer Cimpl** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide**.

    ![Configurer l’authentification unique](./media/active-directory-saas-cimpl-tutorial/tutorial_cimpl_configure.png) 

7. Pour configurer l’authentification unique côté **Cimpl**, vous devez envoyer le **Certificat (Base64)** téléchargé, **l’URL du service d’authentification unique SAML et l’ID d’entité SAML** à l’équipe du support technique Cimpl en composant le **+1 866-982-8250**.
