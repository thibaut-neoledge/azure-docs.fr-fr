...
>[AZURE.NOTE]Cette commande doit être exécutée dans le contexte de chaque utilisateur du domaine qui s’est connecté à l’ordinateur. Observateur d’événements et erreurs pour les appareils joints à un domaine Windows 7
