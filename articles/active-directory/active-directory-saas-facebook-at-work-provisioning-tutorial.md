---
title: "Didacticiel : Configuration de Workplace by Facebook pour l’approvisionnement des utilisateurs | Microsoft Docs"
...
4. Définissez le **Mode d’approvisionnement** sur **Automatique**. 
    ...
    ![approvisionnement](./media/active-directory-saas-facebook-at-work-provisioning-tutorial/provisioning.png)

5. Dans la section **Informations d’identification de l’administrateur**, entrez le jeton secret et l’URL d’abonné de votre administrateur Workplace by Facebook.
