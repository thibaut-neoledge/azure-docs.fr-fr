...
---
# <a name="using-azure-ad-connect-health-for-sync"></a>Utilisation d’Azure AD Connect Health pour la synchronisation
...
Sélectionnez le bouton « Exporter » pour télécharger un fichier CSV contenant tous les détails sur toutes les erreurs.
