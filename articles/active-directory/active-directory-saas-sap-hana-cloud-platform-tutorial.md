...
6. Dans le portail Azure Classic, dans la page **Configurer l’URL de l’application**, procédez comme suit, puis cliquez sur **Suivant**.
    ...
    b. Ouvrez le fichier de métadonnées SAP HANA Cloud Platform téléchargé et recherchez la balise **ns3:AssertionConsumerService** .

    c. Copiez la valeur de l’attribut **Location** et collez-la dans la zone de texte **SAP HANA Cloud Platform Reply URL**.
