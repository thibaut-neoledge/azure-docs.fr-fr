...
- En savoir plus sur l’authentification unique entre applications en utilisant ADAL, sur [Android](active-directory-sso-android.md) et sur les appareils [iOS](active-directory-sso-ios.md)
