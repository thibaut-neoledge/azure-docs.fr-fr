...
* Vous pouvez autoriser les utilisateurs à se connecter automatiquement à HackerOne par le biais de l’authentification unique (SSO) avec leur compte Azure AD.
...
* Si vous n’avez pas d’environnement d’évaluation Azure AD, vous pouvez obtenir un [essai d’un mois](https://azure.microsoft.com/pricing/free-trial/).
...
3. Dans la boîte de dialogue **Configurer les paramètres de l’application**, procédez comme suit, puis cliquez sur **Suivant** :
    ...
    1. Dans la zone de texte **URL de connexion**, tapez l’URL utilisée par vos utilisateurs pour se connecter à votre application HackerOne, au format suivant : **https://hackerone.com/\<nomentreprise\>/authentication**. 
    2. Contactez l’équipe de support HackerOne à l’adresse [support@hackerone.com](mailto:support@hackerone.com) pour obtenir l’URL du locataire.
...
5. Connectez-vous à votre client HackerOne en tant qu’administrateur.
...
7. Accédez à **Authentication** et cliquez sur **Add SAML settings**.
   
    ![Configurer l’authentification unique](./media/active-directory-saas-hackerone-tutorial/tutorial_hackerone_003.png) 
8. Dans la boîte de dialogue **SAML Settings** (Paramètres SAML), procédez comme suit :
   
    ![Configurer l’authentification unique](./media/active-directory-saas-hackerone-tutorial/tutorial_hackerone_004.png) 
    1. Dans la zone de texte **Email Domain** , entrez un domaine enregistré.
    2. Dans le portail Azure Classic, copiez la valeur de l’ **URL du service d’authentification unique**et collez-la dans la zone de texte URL d’authentification unique.
    3. Créez un fichier **codé en base 64** à partir du certificat téléchargé.  
       ...
       >
    4. Ouvrez votre certificat codé en base&64; dans le Bloc-notes, copiez son contenu dans le Presse-papiers, puis collez-le dans la zone de texte **X509 Certificate** .
    5. Cliquez sur **Save**.
9. Dans la boîte de dialogue Authentication Settings, procédez comme suit :
    ...
    2. Si la valeur du champ **Status** est égale à **Last test status: created**, contactez votre équipe de support HackerOne à l’adresse [support@hackerone.com](mailto:support@hackerone.com) pour demander une révision de votre configuration.
...
### <a name="create-a-hackerone-test-user"></a>Créer un utilisateur de test HackerOne
