...
# Version préliminaire du modèle d’application v2.0 : Ajouter une connexion à une application AngularJS Single Page - NodeJS

Dans cet article, nous ajouterons la connexion avec des comptes Microsoft à une application AngularJS, à l’aide du modèle d’application v2.0 d’Azure Active Directory. Le modèle d’application v2.0 vous permet d’effectuer une intégration unique dans votre application et d’authentifier les utilisateurs avec des comptes personnels et des comptes professionnels ou scolaires.
...
Pour poursuivre l’apprentissage sur la version préliminaire du modèle d’application v2.0, consultez de nouveau notre [guide du développeur v2.0](active-directory-appmodel-v2-overview.md). Pour obtenir des ressources supplémentaires, consultez :
