---
title: "Procédure détaillée pour l’utilisation de l’aperçu de la collaboration B2B d’Azure Active Directory | Microsoft Docs"
...
---
# <a name="azure-ad-b2b-collaboration-preview-detailed-walkthrough"></a>Version préliminaire d’Azure AD B2B Collaboration : procédure pas à pas
...
## <a name="adding-alice-to-the-contoso-directory"></a>Ajout d’Alice à l’annuaire Contoso
...
## <a name="adding-bob-to-the-contoso-directory-and-granting-access-to-apps"></a>Ajout de Bob à l’annuaire Contoso et accès aux applications
...
## <a name="adding-carol-to-the-contoso-directory-granting-access-to-apps-and-giving-group-membership"></a>Ajout de Carol à l’annuaire Contoso, accès aux applications et appartenance à un groupe
