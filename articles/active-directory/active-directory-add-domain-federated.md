<properties
	pageTitle="Ajouter votre nom de domaine personnalisé et configurer l’authentification fédérée sur Azure Active Directory | Microsoft Azure"
	description="Découvrez comment ajouter les noms de domaine de votre entreprise à Azure Active Directory et comment configurer l’authentification fédérée entre Azure Active Directory et votre solution de fédération locale."
...
1. Connectez-vous au [portail Azure Classic](https://manage.windowsazure.com/) en utilisant un compte d’utilisateur administrateur général de votre annuaire Azure AD.
