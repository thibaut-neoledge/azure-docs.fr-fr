---
title: Bibliothèques Azure Active Directory v2.0 | Microsoft Docs
...
---
# <a name="azure-active-directory-(ad)-v2.0-and-authentication-libraries"></a>Azure Active Directory (AD) v2.0 et bibliothèques d’authentification
...
* **Bibliothèques clientes** : les bibliothèques clientes sont utilisées sur des clients natifs et sur des serveurs pour obtenir des jetons d’accès pour appeler une ressource telle que Microsoft Graph.
...
|:---:|:---:|:---:|:---:|:---:|
| .NET, Windows Store, Xamarin |Microsoft Authentication Library (MSAL) pour .NET |[Microsoft.Identity.Client (NuGet)][ClientLib-NET-Lib] |[MSAL for .NET (GitHub)][ClientLib-NET-Repo] |[Exemple de client natif de bureau Windows][ClientLib-NET-Sample] |
...
Consultez la [vue d’ensemble du modèle d’application Azure AD v2][AAD-App-Model-V2-Overview] pour plus d’informations sur le point de terminaison Azure AD V2.0. 
