...
2. Sur la page **Configurer les paramètres d’application** , procédez comme suit :
    ...
    a. Dans la zone de texte URL de connexion, entrez l’URL utilisée par vos utilisateurs pour se connecter à votre application Asset Bank au format suivant : **https://\<nom_entreprise\>.assetbank-server.com**.
...
### <a name="creating-a-asset-bank-test-user"></a>Création d’un utilisateur de test Asset Bank
