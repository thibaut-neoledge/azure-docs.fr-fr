<properties
    pageTitle="Instructions de renouvellement des certificats pour les utilisateurs d’Office 365 et d’Azure Active Directory | Microsoft Azure"
...
## <a name="check-if-the-certificates-need-to-be-updated-<a-name="managecerts"></a>"></a>Vérifiez si les certificats doivent être mis à jour <a name="managecerts"></a>
...
[AZURE.NOTE] Si vous utilisez AD FS 2.0, commencez par exécuter Add-Pssnapin Microsoft.Adfs.Powershell.
...
## <a name="renew-the-token-signing-certificate-automatically-(recommended)-<a-name="autorenew"></a>"></a>Renouveler le certificat de signature de jetons automatiquement (recommandé) <a name="autorenew"></a>
...
## <a name="renew-the-token-signing-certificate-manually-<a-name="manualrenew"></a>"></a>Renouveler le certificat de signature de jetons manuellement <a name="manualrenew"></a>
...
2. Vérifiez les certificats de signature actuels dans AD FS en ouvrant une fenêtre de commande PowerShell et en exécutant la commande suivante :
    ...
    >[AZURE.NOTE] Si vous utilisez AD FS 2.0, vous devez commencer par exécuter Add-Pssnapin Microsoft.Adfs.Powershell.
...
## <a name="repair-azure-ad-trust-by-using-azure-ad-connect-<a-name="connectrenew"></a>"></a>Réparer l’approbation Azure AD à l’aide d’Azure AD Connect <a name="connectrenew"></a>
