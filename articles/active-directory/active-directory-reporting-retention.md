<properties
	pageTitle="Stratégies de rétention des rapports Azure Active Directory | Microsoft Azure"
...
Les rapports Azure Active Directory (Azure AD) conservent les données pendant un certain nombre de jours, indiqués ici.
