...
Vous pouvez également utiliser la fonction ExtractMailPrefix() spéciale pour supprimer le suffixe de domaine de l’adresse e-mail ou le nom d’utilisateur principal résultant uniquement de la première partie du nom d’utilisateur (par exemple, « joesmith » au lieu de joesmith@contoso.com).
