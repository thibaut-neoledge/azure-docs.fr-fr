...
4. Dans la zone de recherche, entrez **Softeon WMS**.

    ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_search.png)

5. Dans le volet de résultats, sélectionnez **Softeon WMS**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
3. **[Création d’un utilisateur de test Softeon WMS](#creating-a-softeon-wms-test-user)** pour avoir un équivalent de Britta Simon dans Softeon WMS lié à la représentation Azure AD de l’utilisateur.
...
3. Dans la section **Domaine et URL Softeon WMS**, procédez comme suit :
...
6. Dans la section **Configuration de Softeon WMS**, cliquez sur **Configurer Softeon WMS** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide**.

    ![Configurer l’authentification unique](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_configure.png) 

7. Pour configurer l’authentification unique côté **Softeon WMS**, vous devez envoyer le **Certificat (Base64) téléchargé, l’URL d’entité SAML et l’URL du service d’authentification unique SAML** à [l’équipe du support technique Softeon WMS](mailto:contact@softeon.com). Elle configure ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
