<properties
	pageTitle="Azure AD et applications : affectations de groupes à une application | Microsoft Azure"
...
Cet article suppose que vous avez déjà créé des groupes dans le répertoire actif que vous utilisez pour cette application. La procédure est détaillée dans la vidéo ci-après.
