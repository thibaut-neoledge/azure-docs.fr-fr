...
1. Dans le portail classique, dans la page d’intégration d’application **RightScale**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
