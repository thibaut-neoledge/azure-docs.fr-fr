...
> [!IMPORTANT]
> Le tableau reflète la configuration de port requise pour la version la plus récente du connecteur. Si vous avez un connecteur antérieur à la version 1.5, vous devez également activer les ports 9350, 9352 et 5671. Ces ports activent la communication entre les anciens connecteurs et le service Azure pour les requêtes entrantes. 
