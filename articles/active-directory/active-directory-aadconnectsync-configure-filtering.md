...
Si vous avez modifié la configuration à l’aide d’un filtrage par **domaine** ou **unité d’organisation**, vous devez procéder à une **importation complète** suivie d’une **synchronisation différentielle**.
