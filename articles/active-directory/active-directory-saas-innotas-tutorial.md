...
## <a name="enable-the-application-integration-for-innotas"></a>Activer l’intégration d’applications pour Innotas
Cette section décrit l’activation de l’intégration d’application pour Innotas.

**Pour activer l’intégration d’applications pour Innotas, suivez les étapes ci-dessous :**
...
4. Cliquez sur **Ajouter** en bas de la page.
   ...
   ![Ajouter une application](./media/active-directory-saas-innotas-tutorial/IC749321.png "Ajouter une application")
...
**Pour affecter des utilisateurs à Innotas, suivez les étapes ci-dessous :**

1. Dans le portail Azure Classic, créez un compte de test.
2. Sur la page d’intégration d’applications **Innotas**, cliquez sur **Affecter des utilisateurs**.
