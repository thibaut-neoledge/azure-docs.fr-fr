...
## <a name="select-your-custom-domain"></a>Sélectionner votre domaine personnalisé
...
R : Oui, les certificats auto-signés sont autorisés. Si vous utilisez une autorité de certification privée, le point de distribution de la liste de révocation de certificats du certificat doit être public.  
