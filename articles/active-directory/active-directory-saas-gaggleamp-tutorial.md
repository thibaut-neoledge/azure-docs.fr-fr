...
6. Dans la zone de recherche, entrez **GaggleAMP**. ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_01.png)
...
Pour cela, affectez la valeur de **nom d’utilisateur** dans Azure AD comme valeur de **nom d’utilisateur** dans GaggleAMP.
...
1. Dans le portail Azure Classic, sur la page d’intégration d’application **GaggleAMP**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
...
2. Dans la liste des applications, sélectionnez **GaggleAMP**. ![Liste Azure](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_50.png)
