...
3. **[Création d’un utilisateur de test Litmos](#creating-a-halogen-software-test-user)** pour avoir un équivalent de Britta Simon dans Litmos lié à la représentation Azure AD associée.
...
3. Connectez-vous à votre site d’entreprise Litmos (p. ex., *https://azureapptest.litmos.com/account/Login*) en tant qu’administrateur.
...
13. Dans le menu situé en haut, cliquez sur **Attributs** pour ouvrir la boîte de dialogue **Attributs du jeton SAML**.
