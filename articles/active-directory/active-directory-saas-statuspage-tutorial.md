---
title: 'Didacticiel : Intégration d’Azure Active Directory avec StatusPage | Microsoft Docs'
...
1. Sur la page **Configurer l’authentification unique sur StatusPage** , procédez comme suit :
...
2. Dans une autre fenêtre de navigateur, connectez-vous à votre site d’entreprise StatusPage en tant qu’administrateur.
3. Dans la barre d’outils principale, cliquez sur **Manage Account**(Gérer le compte).
   
    ![Configurer l’authentification unique](./media/active-directory-saas-statuspage-tutorial/tutorial_statuspage_06.png) 
4. Cliquez sur l’onglet **Single Sign-on** (Authentification unique). 
