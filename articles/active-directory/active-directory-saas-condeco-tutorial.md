...
3. **[Création d’un utilisateur de test Condeco](#creating-a-Condeco-test-user)** pour avoir un équivalent de Britta Simon dans Condeco lié à la représentation Azure AD associée.
