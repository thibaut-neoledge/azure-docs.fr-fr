---
title: "Inscription automatique d’appareils auprès d’Azure Active Directory pour les appareils joints à un domaine Windows| Microsoft Docs"
...
## <a name="configure-an-additional-azure-active-directory-relying-party-trust-authentication-class-reference"></a>Configurez une classe de référence d’authentification d’approbation de partie de confiance Azure Active Directory supplémentaire.
...
## <a name="ad-fs-global-authentication-policy"></a>Stratégie d’authentification globale d’AD FS
...
## <a name="configure-azure-active-directory-device-registration-discovery"></a>Configurer la détection du service d’inscription d’appareils Azure Active Directory
...
* [Vue d’ensemble du service Azure Active Directory Device Registration](active-directory-device-registration-get-started.md)
