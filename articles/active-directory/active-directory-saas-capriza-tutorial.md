...
L’objectif de ce didacticiel est de vous montrer comment intégrer Capriza dans Azure Active Directory (Azure AD). L’intégration de Capriza dans Azure AD vous offre les avantages suivants :
...
3. **[Création d’un utilisateur de test Capriza](#creating-a-capriza-test-user)** pour avoir un équivalent de Britta Simon dans Capriza lié à la représentation Azure AD associée.
...
2. Sur la page **Comment voulez-vous que les utilisateurs se connectent à Capriza**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**.
