---
title: "Didacticiel : intégration d’Azure Active Directory à Capriza | Microsoft Docs"
...
---
# <a name="tutorial-azure-active-directory-integration-with-capriza"></a>Didacticiel : Intégration d’Azure Active Directory à Capriza
L’objectif de ce didacticiel est de vous montrer comment intégrer Capriza dans Azure Active Directory (Azure AD).  
L’intégration de Capriza dans Azure AD vous offre les avantages suivants :
...
5. Dans la boîte de dialogue **Que voulez-vous faire ?**, cliquez sur **Ajouter une application à partir de la galerie**.
    ...
    ![Applications][4]
6. Dans la zone de recherche, tapez **Capriza**.
   
    ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_01.png)
7. Dans le volet de résultats, sélectionnez **Capriza**, puis cliquez sur **Terminer** pour ajouter l’application.
...
Pour que l'authentification unique fonctionne, Azure AD doit savoir qui est l'utilisateur Capriza équivalent dans Azure AD. En d’autres termes, une relation entre un utilisateur Azure AD et un utilisateur Capriza associé doit être établie.  
Pour ce faire, affectez la valeur du **nom d’utilisateur** dans Azure AD comme valeur du **nom d’utilisateur** dans Capriza.
...
3. **[Création d'un utilisateur test Capriza](#creating-a-capriza-test-user)** pour avoir un équivalent de Britta Simon dans Capriza lié à la représentation Azure AD associée.
...
1. Dans le portail Azure Classic, dans la page d’intégration d’application **Capriza**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
   
    ![Configurer l’authentification unique][6] 
2. Dans la page **Comment voulez-vous que les utilisateurs se connectent à Capriza**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**.
...
3. Sur la page **Configurer les paramètres d’application** , procédez comme suit :
    ...
    a. Dans la zone de texte URL d’authentification, tapez l’URL utilisée par vos utilisateurs pour se connecter à votre application Capriza, au format suivant : **« https://nom_entreprise.capriza.com/id_client »**.

    b. Cliquez sur **Suivant**.


1. Dans la page **Configurer l’authentification unique sur Capriza** , procédez comme suit :
   
    ![Configurer l’authentification unique](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_05.png) 
...
### <a name="creating-a-capriza-test-user"></a>Création d'un utilisateur test Capriza
...
> [!NOTE]
> Si vous devez créer un utilisateur manuellement, contactez l'équipe de support Capriza.
> 
> 

### <a name="assigning-the-azure-ad-test-user"></a>Affectation de l’utilisateur de test Azure AD
L’objectif de cette section est de permettre à Britta Simon d’utiliser l’authentification unique Azure en lui accordant l’accès à Capriza.
...
Lorsque vous cliquez sur la mosaïque Capriza dans le volet d'accès, vous devez être connecté automatiquement à votre application Capriza.
