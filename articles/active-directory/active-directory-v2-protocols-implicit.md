...
> [AZURE.TIP] Essayez de coller cette requête dans un navigateur (mais si vous voulez que la requête aboutisse, modifiez d’abord les valeurs de domain\_hint et login\_hint)
