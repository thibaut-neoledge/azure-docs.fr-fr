<properties
	pageTitle="Flux implicite d’Azure AD v2.0 | Microsoft Azure"
...
> [AZURE.TIP] Essayez de coller cette requête dans un navigateur ! (mais si vous voulez que la requête aboutisse, modifiez d’abord les valeurs de domain\_hint & login\_hint)
