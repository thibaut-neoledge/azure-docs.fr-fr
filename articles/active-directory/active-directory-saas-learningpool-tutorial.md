...
* Un abonnement Learningpool pour lequel l’authentification unique (SSO) est activée
...
4. Cliquez sur **Ajouter** en bas de la page.
   ...
   ![Ajouter une application](./media/active-directory-saas-learningpool-tutorial/IC749321.png "Ajouter une application")
...
9. Transférez ce fichier de métadonnées à l’équipe de support de Learningpool.
   ...
   >[!NOTE]
   >L’authentification unique (SSO) doit être activée par l’équipe de support de Learningpool.
   > 
