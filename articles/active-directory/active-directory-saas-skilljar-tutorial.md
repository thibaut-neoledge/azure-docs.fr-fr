---
title: 'Didacticiel : Intégration d''Azure Active Directory à Skilljar | Microsoft Docs'
...
1. Dans la page de configuration **Configurer l'authentification unique sur Skilljar**, procédez comme suit :
    ...
    c. Cliquez sur **Next**.
2. Pour obtenir la configuration de l'authentification unique pour votre application, contactez votre équipe de support Skilljar par courrier électronique, incluez la valeur **Format de l'identification du nom** à partir de l'étape précédente et joignez le fichier de métadonnées téléchargé.
...
> [!NOTE]
> Si vous devez créer un utilisateur manuellement, contactez l'équipe de support Skilljar.
> 
> 
