...
|:---:|:---:|:---:|
|[Xamarin](active-directory-devquickstarts-xamarin.md) |[Cordova](active-directory-devquickstarts-cordova.md) |[Intégration directe</br>à OAuth 2.0](active-directory-protocols-oauth-code.md) |
...
|:---:|:---:|:---:|
| [.NET](active-directory-devquickstarts-webapp-dotnet.md) |[Java](active-directory-devquickstarts-webapp-java.md) |[AngularJS](active-directory-devquickstarts-angular.md) |[JavaScript](https://github.com/Azure-Samples/active-directory-javascript-singlepageapp-dotnet-webapi) |[Node.JS](active-directory-devquickstarts-openidconnect-nodejs.md) |[Intégration directe</br>à OpenID Connect](active-directory-protocols-openid-connect-code.md) |
...
|:---:|:---:|:---:|
|[JavaScript](https://github.com/Azure-Samples/active-directory-javascript-singlepageapp-dotnet-webapi) |[Node.JS](active-directory-devquickstarts-openidconnect-nodejs.md) |[Intégration directe</br>à OpenID Connect](active-directory-protocols-openid-connect-code.md) |
...
### <a name="microsoft-graph-and-azure-ad-graph-api-quick-start-guides"></a>Guides de démarrage rapide pour Microsoft Graph et API Graph Azure AD
| [![Microsoft Graph](./media/active-directory-developers-guide/msgraph.png)](https://developer.microsoft.com/graph/quick-start) | [![API Graph Azure AD](./media/active-directory-developers-guide/graph.png)](active-directory-graph-api-quickstart.md) |
|:---:|:---:|
| [Microsoft Graph](https://developer.microsoft.com/graph/quick-start) | [API Graph Azure AD](active-directory-graph-api-quickstart.md) |
...
* [Utiliser un certificat au lieu d’un secret pour authentifier l’identité d’une application](https://github.com/Azure-Samples/active-directory-dotnet-daemon-certificate-credential/)
...
### <a name="microsoft-graph-and-azure-ad-graph-api"></a>Microsoft Graph et API Graph Azure AD
> [!IMPORTANT]
...
* [Microsoft Graph](https://graph.microsoft.io/) : Documentation, référence, exemples et Kits de développement logiciel (SDK) de Microsoft Graph. 
* [Informations de référence sur l’API Graph Azure AD](https://msdn.microsoft.com/Library/Azure/Ad/Graph/api/api-catalog) : informations de référence REST pour l’API Graph Azure Active Directory. 
* [Étendues d’autorisation de l’API Graph Azure AD](https://msdn.microsoft.com/Library/Azure/Ad/Graph/howto/azure-ad-graph-api-permission-scopes) : étendues d’autorisation OAuth 2.0 utilisées pour contrôler l’accès d’une application aux données d’annuaire d’un client.
...
* [Blog de l’équipe Azure Active Directory Graph](https://blogs.msdn.microsoft.com/aadgraphteam): informations Azure Active Directory spécifiques à l’API Graph.
