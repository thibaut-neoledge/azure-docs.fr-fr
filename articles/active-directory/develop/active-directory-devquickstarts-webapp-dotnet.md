...
## <a name="3-use-owin-to-issue-sign-in-and-sign-out-requests-to-azure-ad"></a>3. Utiliser OWIN pour émettre des demandes de connexion et de déconnexion dans Azure AD
