...
7.  Lorsque vous créez un objet Principal de service à l’aide du [module Azure AD PowerShell](https://docs.microsoft.com/powershell/azuread/v2/azureactivedirectory).
