<properties
	pageTitle="Association des abonnements Azure avec Azure Active Directory | Microsoft Azure"
...
Cette rubrique vous indique comment vous connecter à Microsoft Azure et aborde des problèmes connexes, tels que la relation entre un abonnement Azure et Azure Active Directory (Azure AD).
