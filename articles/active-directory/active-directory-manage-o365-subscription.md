<properties
   pageTitle="Gestion du répertoire de l’abonnement Office 365 dans Azure"
   description="Gestion d'un annuaire de comptes d'abonnements Office 365 à l'aide d'Azure Active Directory et du portail de gestion"
...
Cet article décrit comment gérer un annuaire qui a été créé pour un abonnement à Office 365 dans le portail de gestion Azure. Les étapes à effectuer diffèrent selon que vous ayez déjà ou non un abonnement Azure. Vous devez être un administrateur de service ou un co-administrateur d’un abonnement Azure pour vous connecter au portail de gestion Azure.
...
Une fois que vous êtes abonné à Azure, vous pouvez vous connecter au portail de gestion Azure et accéder aux services Azure. Cliquez sur l'extension Active Directory pour gérer l'annuaire qui authentifie les utilisateurs Office 365.
...
1.	Connectez-vous au portail de gestion Azure en tant que msmith@hotmail.com.
...
4.	Connectez-vous au portail de gestion Azure en tant qu'administrateur global de Contoso.onmicrosoft.com (par exemple, msmith@contoso.com)).
...
7.	Connectez-vous au portail de gestion en tant que msmith@hotmail.com. L’annuaire Contoso et l’annuaire par défaut apparaissent dans l'extension Active Directory.
...
Supposons maintenant que John Doe doit se connecter au portail de gestion Azure et administrer les sites web et ressources de base de données associés à l'abonnement Azure de msmith@hotmail.com. Pour cela, Michael Smith a besoin effectuer ces étapes supplémentaires :

1.	Connectez-vous au portail de gestion en utilisant le compte d'administrateur de service de l'abonnement Azure (dans cet exemple, msmith@hotmail.com)).
