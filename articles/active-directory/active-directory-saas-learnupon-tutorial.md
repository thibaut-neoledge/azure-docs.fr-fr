<properties
	pageTitle="Didacticiel : Intégration d’Azure Active Directory à Novatus | azure.microsoft.com/ Azure"
...
L’objectif de ce didacticiel est de vous montrer comment intégrer LearnUpon dans Azure AD (Azure Active Directory). L’intégration de LearnUpon à Azure AD vous offre les avantages suivants :
...
L’objectif de cette section est de tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès. Quand vous cliquez sur la vignette LearnUpon dans le volet d’accès, vous devez être connecté automatiquement à votre application LearnUpon.
