...
<a id="how-to-recognize-differences-between-delegated-and-application-permissions" class="xliff"></a>

# Comment reconnaître les différences entre les autorisations déléguées et d’application
