...
5. Sur votre locataire Dropbox for Business, dans la section **Authentification unique** de la page **Authentification**, exécutez les opérations suivantes : <br><br> ![Configurer l’authentification unique](./media/active-directory-saas-dropboxforbusiness-tutorial/IC769516.png "Configurer l’authentification unique")
	...
	> [AZURE.TIP] Pour plus d’informations, consultez [Comment convertir un certificat binaire en fichier texte](http://youtu.be/PlgrzUZ-Y1o).
     ...
     5\.4. Cliquez sur le bouton **« Choisir un certificat »**, puis recherchez votre **fichier de certificat codé en base 64**.


     5\.5. Cliquez sur le bouton **« Enregistrer les modifications »** pour terminer la configuration de votre locataire DropBox for Business.
...
5. Pour terminer la configuration, cliquez sur le bouton **Compléter**. <br><br> ![Approvisionnement d'utilisateurs](./media/active-directory-saas-dropboxforbusiness-tutorial/IC769520.png "Approvisionnement d'utilisateurs")
