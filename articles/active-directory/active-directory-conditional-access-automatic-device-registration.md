...
# Inscription automatique d’appareils auprès d’Azure Active Directory pour les appareils joints à un domaine Windows
...
## Conditions requises pour l’inscription automatique d’appareils joints à un domaine Windows auprès d’Azure Active Directory
...
-----------------------------------------------------------------------------------------------------
9. Sur votre serveur de fédération, ouvrez une fenêtre de commande Windows PowerShell et tapez :
...
-----------------------------------------------------------------------------
1. Configurez la stratégie d’authentification principale globale d’AD FS pour permettre l’authentification Windows intégrée pour l’intranet (c’est la valeur par défaut).


Configuration d’Internet Explorer
------------------------------------------------------------------------------
1. Configurez les paramètres suivants sur Internet Explorer sur vos appareils Windows pour la zone de sécurité Intranet local :
