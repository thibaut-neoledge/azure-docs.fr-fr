<properties
	pageTitle="Didacticiel : Intégration d’Azure AD à YouEarnedIt | Microsoft Azure"
...
# Didacticiel : Intégration d’Azure AD à YouEarnedIt
...
## Ajout d’YouEarnedIt depuis la galerie
...
Pour cela, affectez la valeur de **nom d’utilisateur** dans Azure AD comme valeur de **nom d’utilisateur** dans YouEarnedIt.
...
1. Dans le portail Classic, dans la page d’intégration d’applications **YouEarnedIt**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
...
5. Dans la page de boîte de dialogue **Dites-nous en plus sur cet utilisateur**, procédez comme suit : ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-youearnedit-tutorial/create_aaduser_05.png)
...
6.  Sur la page **Profil utilisateur**, procédez comme suit : ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-youearnedit-tutorial/create_aaduser_06.png)
...
### Création d’un utilisateur de test YouEarnedIt
