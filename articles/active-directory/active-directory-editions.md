...
> [AZURE.NOTE] Pour bénéficier d’une vue différente sur ces données, consultez les [fonctionnalités d’Azure Active Directory](https://www.microsoft.com/server-cloud/products/azure-active-directory/Features.aspx).
...
| Édition gratuite| Édition de base| Édition Premium| Applications Office 365 uniquement |
| :-: | :-: | :-: | :-: |
| 10 applications par utilisateur [1] <br>(applications SaaS pré-intégrées et applications intégrées par le développeur)| 10 applications par utilisateur [1] <br>(niveau gratuit + proxy d’application) | Aucune limite [2] <br> (niveaux gratuit et de base + modèles d’intégration d’applications libre-service)| 10 applications par utilisateurs [1] <br> (applications SaaS pré-intégrées et applications intégrées par le développeur)|
