...
* Vous pouvez autoriser vos utilisateurs à se connecter automatiquement à Tidemark via l’authentification unique (SSO) avec leur compte Azure AD
...
* Un abonnement Tidemark pour lequel l’authentification unique (SSO) est activée
...
## <a name="add-tidemark-from-the-gallery"></a>Ajouter Tidemark depuis la galerie
...
L’objectif de cette section est de vous montrer comment configurer et tester l’authentification unique (SSO) Azure AD avec Tidemark, avec un utilisateur de test appelé « Britta Simon ».
...
Pour configurer et tester l’authentification unique (SSO) Azure AD avec Tidemark, vous devez suivre les indications des sections suivantes :
...
3. Sur la page **Configurer les paramètres d’application** , procédez comme suit :
  ...
  * Dans la zone de texte URL de connexion, tapez l’URL dont vos utilisateurs se servent pour se connecter à votre application Tidemark, au format suivant : **« https://contoso.tidemark.com/login »** ou **« https://contoso.tidemark.net/login »**.
4. Sur la page **Configurer l’authentification unique sur Tidemark** , procédez comme suit :
...
### <a name="create-a-tidemark-test-user"></a>Créer un utilisateur de test Tidemark
...
L’objectif de cette section est de permettre à Britta Simon d’utiliser l’authentification unique (SSO) Azure en lui accordant l’accès à Tidemark.
