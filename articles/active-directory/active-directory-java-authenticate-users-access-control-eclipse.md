...
1. Dans le [portail de gestion Azure][portail de gestion Azure], cliquez **Active Directory**, sélectionnez un espace de noms de contrôle d'accès, puis cliquez sur **Manage**. Le portail de gestion ACS s'ouvre.
