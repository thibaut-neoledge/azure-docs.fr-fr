...
- [Article Index for Application Management in Azure Active Directory (Index d’articles pour la gestion des applications dans Azure Active Directory)](active-directory-apps-index.md)
