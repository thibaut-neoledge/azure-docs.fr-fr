---
title: Comprendre les jetons utilisateur Azure Active Directory B2B Collaboration | Microsoft Docs
...
# <a name="understand-user-tokens-in-azure-active-directory-b2b-collaboration"></a>Comprendre les jetons utilisateur Azure Active Directory B2B Collaboration

Si vous souhaitez savoir à quoi ressemble le jeton pour un utilisateur de B2B Collaboration, voici les détails du jeton du porteur et le contenu des jetons pour les invités AAD et MSA dans le locataire de la ressource (pour tenantid:04dcc6ab-388a-4559-b527-fbec656300ea). Vous pouvez utiliser [https://jwt.io/](https://jwt.io/) ou [http://calebb.net](http://calebb.net/)/ pour afficher le contenu des jetons JWT.

## <a name="azure-ad-guest-user-token"></a>Jeton d’utilisateur invité Azure AD
```
...
## <a name="microsoft-account-guest"></a>Invité de compte Microsoft
```
