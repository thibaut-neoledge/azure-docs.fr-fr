...
**Description :** La fonction CGuid convertit la représentation sous forme de chaîne d’un GUID en sa représentation binaire.
...
**Description :** La fonction ConvertFromUTF8Hex convertit la valeur encodée hexadécimale UTF8 spécifiée en chaîne.
...
**Description :** La fonction CStr convertit en un type de données de chaîne.
...
**Description :** La fonction FormatDateTime sert à mettre en forme une valeur DateTime en chaîne dans le format spécifié.
...
`Word("This,string!has&many separators",3,",!&#")` Retourne « has ».
