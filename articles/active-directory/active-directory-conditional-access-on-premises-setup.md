...
5.  Dans la section **déploiement et gestion** , suivez les étapes 1 à 3 pour intégrer Azure Active Directory à votre répertoire local.
  ...
  2.    Installez et exécutez Azure AD Connect : installez Azure AD Connect à l'aide des instructions suivantes, [Installation personnalisée d'Azure AD Connect](./aad-connect/active-directory-aadconnect-get-started-custom.md).
...
###<a name="join-a-windows-8.1-device-using-azure-active-directory-device-registration"></a>Joindre un appareil Windows 8.1 à l’aide du service Azure Active Directory Device Registration
