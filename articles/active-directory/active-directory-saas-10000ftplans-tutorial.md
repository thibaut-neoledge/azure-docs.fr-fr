...
# Didacticiel : Intégration d’Azure AD avec 10,000ft Plans

L’objectif de ce didacticiel est de vous montrer comment intégrer 10,000ft Plans à Azure Active Directory (Azure AD). L’intégration de 10,000ft Plans avec Azure AD vous offre les avantages suivants :
...
## Ajout de 10,000ft Plans à partir de la galerie
...
Pour que l’authentification unique fonctionne, Azure AD doit savoir qui est l’utilisateur 10,000ft Plans équivalent dans Azure AD. En d’autres termes, une relation entre un utilisateur Azure AD et un utilisateur 10,000ft Plans associé doit être établie. Pour cela, affectez la valeur de **nom d’utilisateur** dans Azure AD comme valeur de **nom d’utilisateur** dans 10,000ft Plans.
...
1. Dans le portail Azure Classic, puis sur la page d’intégration d’application **10,000ft Plans**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.

	![Configurer l’authentification unique][6]

2. Sur la page **Comment voulez-vous que les utilisateurs se connectent à 10,000ft Plans**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**.
...
3. Dans la boîte de dialogue **Configurer les paramètres de l’application**, procédez comme suit, puis cliquez sur **Suivant** :
	...
	> [AZURE.NOTE] La valeur de **l’identificateur** est différente si vous avez un domaine personnalisé. Si vous avez besoin d’aide, contactez votre [équipe d’assistance 10,000ft Plans](mailto:support@10000ft.com).

	c. Cliquez sur **Suivant**


4. Dans la page **Configure single sign-on at 10,000ft Plans** (Configurer l’authentification unique sur 10,000ft Plans), procédez comme suit et cliquez sur **Suivant** :
...
5. Pour configurer l’authentification unique pour votre application, contactez votre [équipe de support technique 10,000ft Plans](mailto:support@10000ft.com), joignez le certificat téléchargé et fournissez-lui l’URL de l’émetteur, l’URL d’authentification unique SAML et l’URL de déconnexion unique.
...
### Création d’un utilisateur de test 10,000ft Plans
...
L’objectif de cette section est de tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès. Lorsque vous cliquez sur la vignette 10,000ft Plans dans le volet d’accès, vous devez être connecté automatiquement à votre application 10,000ft Plans.
