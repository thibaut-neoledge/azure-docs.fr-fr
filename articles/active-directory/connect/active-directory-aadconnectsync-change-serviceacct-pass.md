...
# Modification du mot de passe du compte de service de synchronisation Azure AD
...
## Abandon de la clé de chiffrement Azure AD Connect Sync
>[!IMPORTANT]
...
#### Fournissez le mot de passe du compte AD DS
...
#### Réinitialisation du mot de passe du compte Azure AD Sync
