...
4. Une fois l’analyse terminée, nous proposons des recommandations sur la marche à suivre.  
   ...
   * Si vous utilisez une instance SQL Server complète pour DirSync, vous voyez cette page à la place :  
     ![Analyse terminée, mise à niveau à partir de DirSync prête](./media/active-directory-aadconnect-dirsync-upgrade-get-started/AnalysisReadyFullSQL.png)  
   ...
   * Si vous avez plus de 50 000 objets, vous voyez cet écran à la place :  
     ![Analyse terminée, mise à niveau à partir de DirSync prête](./media/active-directory-aadconnect-dirsync-upgrade-get-started/AnalysisRecommendParallel.png)  
