...
[!NOTE]
Le dernier numéro de l’expression régulière définit le nombre de domaines parents dans votre domaine racine. Dans le cas présent, j’ai bmcontoso.com. Deux domaines parents sont donc nécessaires. Si trois domaines parents doivent être conservés (par exemple corp.bmcontoso.com), le nombre indiqué est « trois ». Vous pouvez indiquer une plage. Dans ce cas, la correspondance est toujours effectuée pour faire correspondre le nombre maximal de domaines. « {2,3} » correspond à deux ou trois domaines (par exemple bmfabrikam.com et corp.bmcontoso.com).
