...
- Vous pouvez autoriser les utilisateurs à se connecter automatiquement à EasyTerritory (via une authentification unique) avec leurs comptes Azure AD.
...
- Si vous n’avez pas d’environnement d’essai Azure AD, vous pouvez bénéficier d’[une période d’essai d’un mois](https://azure.microsoft.com/pricing/free-trial/).
...
Dans cette section, vous allez configurer et tester l’authentification unique Azure AD auprès d’EasyTerritory, avec un utilisateur de test nommé « Britta Simon ».
...
Pour configurer et tester l’authentification unique (SSO) Azure AD avec EasyTerritory, vous devez suivre les indications des sections suivantes :
...
**Pour configurer l’authentification unique Azure AD auprès de EasyTerritory, procédez comme suit :**
...
3. Dans la section **Domaines et URL EasyTerritory**, si vous voulez configurer l’application en **Mode initié par IDP**, procédez comme suit :
   ...
   1. Dans la zone de texte **Identificateur**, tapez une URL au format suivant : `https://apps.easyterritory.com/<tenant id>/DEV/`
   2. Dans la zone de texte **URL de réponse** , tapez une URL au format suivant : `https://apps.easyterritory.com/<tenant id>/DEV/AuthServices/Acs`
...
4. Si vous voulez configurer l’application en **Mode initié par SP**, dans la section **Domaine et URL EasyTerritory**, procédez comme suit :
  ...
  1. Cliquez sur l’option **Afficher les paramètres d’URL avancés**.
  2. Dans la zone de texte **URL de connexion**, tapez une URL au format suivant : `https://<company name>.easyterritory.com/`

    >[!NOTE] 
    >Il ne s’agit pas des valeurs réelles. Vous devez mettre à jour ces valeurs avec l’URL d’authentification, l’identificateur et l’URL de réponse. Contactez [l’équipe de support technique EasyTerritory](mailto:sales@easyterritory.com) pour obtenir ces valeurs.
...
1. Dans le panneau de navigation gauche du **Portail de gestion Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Créer un utilisateur de test Azure AD](./media/active-directory-saas-easyterritory-tutorial/create_aaduser_01.png) 

2. Accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs** pour afficher la liste des utilisateurs.
    
    ![Créer un utilisateur de test Azure AD](./media/active-directory-saas-easyterritory-tutorial/create_aaduser_02.png) 

3. En haut de la boîte de dialogue, cliquez sur **Ajouter** pour ouvrir la boîte de dialogue **Utilisateur**.
 
    ![Créer un utilisateur de test Azure AD](./media/active-directory-saas-easyterritory-tutorial/create_aaduser_03.png) 

4. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Créer un utilisateur de test Azure AD](./media/active-directory-saas-easyterritory-tutorial/create_aaduser_04.png) 
...
### <a name="create-an-easyterritory-test-user"></a>Créer un utilisateur de test EasyTerritory
...
Dans cette section, vous allez autoriser Britta Simon à utiliser l’authentification unique (SSO) Azure en lui accordant l’accès à EasyTerritory.
