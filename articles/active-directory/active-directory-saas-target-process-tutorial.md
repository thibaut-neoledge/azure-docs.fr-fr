...
1. Sur la page **Configurer l’authentification unique sur TargetProcess** , procédez comme suit :
    ...
    b. Cliquez sur **Next**.
2. Connectez-vous à votre application TargetProcess en tant qu’administrateur.
3. Dans le menu situé en haut, cliquez sur **Setup**.
...
6. Dans la boîte de dialogue Paramètres d’authentification unique, procédez comme suit :
