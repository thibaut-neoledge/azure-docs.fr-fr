...
* Vous pouvez autoriser les utilisateurs à se connecter automatiquement à TargetProcess par le biais de l’authentification unique (SSO) avec leur compte Azure AD.
...
Cette section vous indique comment configurer et tester l’authentification unique Azure AD avec TargetProcess au moyen d’un utilisateur de test appelé « Britta Simon ».
...
3. **[Création d’un utilisateur de test TargetProcess](#creating-a-targetprocess-test-user)** pour avoir un équivalent de Britta Simon dans TargetProcess lié à la représentation Azure AD associée.
4. **[Affectation de l’utilisateur de test Azure AD](#assigning-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Test de l’authentification unique](#testing-single-sign-on)** pour vérifier si la configuration fonctionne.

### <a name="configure-azure-ad-sso"></a>Configurer l’authentification unique Azure AD
L’objectif de cette section est d’activer l’authentification unique Azure AD dans le Portail Azure Classic et de configurer l’authentification unique dans votre application TargetProcess. 
...
Pour configurer l’authentification unique pour TargetProcess, vous devez disposer d’un domaine inscrit. Si vous n’avez pas encore de domaine enregistré, contactez votre équipe de support TargetProcess via [support@flatterfiles.com](mailto:support@flatterfiles.com).  
...
3. Sur la page **Configurer les paramètres d’application** , procédez comme suit :
  ...
  1. Dans la zone de texte **URL d’authentification**, entrez l’URL utilisée par vos utilisateurs pour se connecter à votre application TargetProcess (p. ex., *https://fabrikam.TargetProcess.com/*).
...
4. Sur la page **Configurer l’authentification unique sur TargetProcess** , procédez comme suit :
  ...
  2. Cliquez sur **Suivant**.
5. Connectez-vous à votre application TargetProcess en tant qu’administrateur.
...
8. Cliquez sur **Single Sign-on**.
   
    ![Configurer l’authentification unique](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_07.png) 
9. Dans la boîte de dialogue Paramètres d’authentification unique, procédez comme suit :
   
    ![Configurer l’authentification unique](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_08.png)   
  1. Cliquez sur **Enable Single Sign-on**.
  2. Sur la page **Configurer l’authentification unique sur TargetProcess** du portail Azure Classic, copiez la valeur de **l’URL du service d’authentification unique**, puis collez-la dans la zone de texte **URL de connexion**.
  3. Ouvrez le certificat que vous avez téléchargé dans le Bloc-notes, copiez son contenu, puis collez-le dans la zone de texte **Certificat** .
  4. Cliquez sur **Activer la configuration JIT**.
...
TargetProcess prend en charge l’approvisionnement juste-à-temps. Vous l’avez déjà activé dans [Configuration de l’authentification unique Azure AD](#configuring-azure-ad-single-single-sign-on).
