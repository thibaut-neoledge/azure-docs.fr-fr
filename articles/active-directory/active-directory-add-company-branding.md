...
Après une personnalisation, cette page ressemble à ce qui suit :
...
Voici comment elle apparaîtra une fois le navigateur redimensionné vers le haut :
...
1. Connectez-vous au [portail Azure Classic](https://manage.windowsazure.com) en tant qu’administrateur du répertoire que vous voulez personnaliser.
