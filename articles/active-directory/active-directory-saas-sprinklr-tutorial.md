---
title: 'Didacticiel : Intégration d’Azure AD à Sprinklr | Microsoft Docs'
...
5. Dans la page **Edit User**, procédez comme suit :
   ...
   > [!IMPORTANT]
   > Décochez **Password Disabled** pour permettre à un utilisateur de se connecter par le biais d’un fournisseur d’identité.
   > 
   > 
