...
Pour configurer et tester l’authentification unique Azure AD avec IBM Kenexa Survey Enterprise, vous devez suivre les indications des sections ci-après :
...
3. Sur la page **Configurer les paramètres d’application** , procédez comme suit :
  ...
  1. Dans la zone de texte **Identificateur**, tapez une URL au format suivant : `https://surveys.kenexa.com/<company code>` 
  2. Dans la zone de texte **URL de réponse** , tapez une URL au format suivant : `https://surveys.kenexa.com/<company code>/tools/sso.asp`
...
9. Dans la boîte de dialogue **Attributs du jeton SAML** , procédez comme suit :
 1. Sélectionnez l’attribut de **NameIdentifier** et cliquez sur l’icône **Modifier**.
 
    ![Configurer l’authentification unique](./media/active-directory-saas-kenexasurvey-tutorial/tutorial_kenexasurvey_07.png)  
 2. À partir de la liste **Valeur de l’attribut**, tapez la valeur d’attribut d’ID d’authentification unique configurée dans le système Kenexa.  
...
Vous pouvez collaborer avec l’équipe de support technique IBM Kenexa pour mapper l’ID d’authentification unique pour l’ensemble des utilisateurs. Par ailleurs, cet ID doit être mappé à la valeur NameIdentifier fournie par Azure AD. Vous pouvez modifier ces paramètres par défaut en accédant à l’onglet Attribut.
