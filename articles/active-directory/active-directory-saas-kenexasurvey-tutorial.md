...
1. Sur la page **Configurer l’authentification unique sur IBM Kenexa Survey Enterprise**, procédez comme suit :
    ...
    b. Cliquez sur **Next**.
2. Pour obtenir la configuration de l’authentification unique pour votre application, contactez l’équipe de support IBM Kenexa et fournissez-lui les éléments suivants :
