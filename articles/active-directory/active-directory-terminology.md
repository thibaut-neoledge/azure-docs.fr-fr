---
title: Terminologie Azure AD | Microsoft Docs
...
| Azure Active Directory Connect |L'application qui fournit une synchronisation unidirectionnelle des objets répertoire d’un service local Active Directory de l’entreprise vers Azure Active Directory. |
...
| Synchronisation de répertoires |Utilisée pour synchroniser des objets répertoire locaux (utilisateurs, groupes, contacts) sur le cloud pour contribuer à réduire la surcharge administrative. La synchronisation de répertoires est également appelée synchronisation de répertoires dans le portail Azure et le portail Azure Classic. Une fois la synchronisation de répertoires configurée, les administrateurs peuvent effectuer l’approvisionnement des objets répertoires dans une application Active Directory locale vers une instance Azure AD. |
