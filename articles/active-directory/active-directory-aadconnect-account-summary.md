<properties
	pageTitle="Autorisations et informations d’identification Azure AD Connect | Microsoft Azure"
...
Autorisations SQL Server|Le compte de service Azure AD Connect Sync nécessite des autorisations dbo dans SQL. Ces autorisations sont définies pendant l’installation d’Azure AD Connect et elles ne sont pas modifiables.
...
------------- | ------------- |------------- |
Compte Azure AD pour la synchronisation|Rôle de synchronisation d’annuaire dédié|Opérations de synchronisation continue (compte MA Azure AD)
