...
5. Envoyez le fichier de métadonnées téléchargé à l’équipe de support technique Chromeriver.
   ...
   > [!NOTE]
   > L’équipe de support technique Chromeriver doit se charger de la configuration de l’authentification unique. Vous recevrez une notification lorsque l’authentification unique aura été activée pour votre abonnement.
   > 
   > 
