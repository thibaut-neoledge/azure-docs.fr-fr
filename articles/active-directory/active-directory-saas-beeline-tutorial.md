---
title: 'Didacticiel : Intégration d’Azure Active Directory avec Beeline | Microsoft Docs'
...
3. **[Création d’un utilisateur de test Beeline](#creating-an-beeline-test-user)** pour avoir un équivalent de Britta Simon dans Beeline lié à la représentation Azure AD associée.
