...
> [!IMPORTANT]
> **Votre tâche : vous assurer que votre application ne dépend pas de l’existence de la valeur `profile_info`.**
> 
> 
...
> [!IMPORTANT]
> **Votre tâche : vous assurer que votre application ne dépend pas de l’existence de la valeur `id_token_expires_in`.**
> 
> 
...
> [!IMPORTANT]
> **Votre tâche : ajouter les étendues `profile` et `email` si votre application requiert des informations sur l’utilisateur.** Notez que la bibliothèque ADAL inclut ces deux autorisations dans les requêtes par défaut.
> 
> 
