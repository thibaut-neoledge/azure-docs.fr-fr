<properties
	pageTitle="Modifications apportées au modèle d’application v2.0 Azure AD | Microsoft Azure"
...
Cela étant dit, le point de terminaison v2.0 est toujours à l’état préliminaire. En d’autres termes, vous devez être prudent lors de la publication des applications de production qui en dépendent, et être prêt à effectuer des changements lorsque des situations comme celles-ci se produisent. C’est seulement lorsque le point de terminaison v2.0 atteindra le niveau de disponibilité générale que nous inciterons les développeurs à prendre des dépendances dans l’état actuel du service.

Pour finir, nous souhaitons vous remercier d’avoir procédé à des essais pendant cette période d’évaluation. Les informations et les expériences de nos utilisateurs précoces nous ont été très utiles jusqu’à présent, et nous espérons que vous continuerez de partager vos opinions et vos idées.
