...
Les professionnels de l’information peuvent utiliser le [panneau d’accès aux applications](http://myapps.microsoft.com) pour ajouter des utilisateurs de B2B Collaboration à des groupes et applications dont ils sont administrateur.
