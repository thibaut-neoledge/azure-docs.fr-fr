<properties
	pageTitle="Gérer les groupes dont votre groupe est membre dans la version préliminaire d’Azure Active Directory | Microsoft Azure"
...
9. Lorsque vous avez terminé de modifier les appartenances aux groupes de votre groupe, sélectionnez **Enregistrer**.
