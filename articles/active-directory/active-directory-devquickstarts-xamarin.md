...
---
# <a name="integrate-azure-ad-into-a-xamarin-app"></a>Intégration d’Azure AD dans une application Xamarin
...
1. configurer votre environnement de développement Xamarin ;
2. inscrire votre application auprès d’Azure AD ;
3. installer et configurer la bibliothèque ADAL ;
4. utiliser la bibliothèque ADAL pour obtenir des jetons à partir d’Azure AD.
...
## <a name="0-set-up-your-xamarin-development-environment"></a>*0. Configuration de votre environnement de développement Xamarin*
...
* Configurez les autorisations pour votre application : dans le menu Paramètres, cliquez sur la section « Autorisations requises », cliquez sur **Ajouter**, sur **Sélectionner une API**, puis sélectionnez « Windows Azure Active Directory » (il s’agit de l’API AADGraph). Ensuite, cliquez sur **Sélectionner les autorisations** et sélectionnez **Lire les données de l’annuaire**. Cela permet à votre application d’interroger l’API Graph concernant les utilisateurs.
