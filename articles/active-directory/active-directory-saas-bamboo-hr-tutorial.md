...
* Un abonnement BambooHR pour lequel l’authentification unique (SSO) est activée
...
## <a name="enable-the-application-integration-for-bamboohr"></a>Activer l’intégration d’applications pour BambooHR
Cette section décrit l’activation de l’intégration d’applications pour BambooHR.

**Pour activer l’intégration d’applications pour BambooHR, suivez les étapes ci-dessous :**
...
1. Sur la page d’intégration d’applications **BambooHR** du Portail Azure Classic, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
...
2. Sur la page d’intégration d’applications **BambooHR**, cliquez sur **Affecter des utilisateurs**.
