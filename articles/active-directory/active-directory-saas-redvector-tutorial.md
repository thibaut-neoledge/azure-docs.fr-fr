...
* Vous pouvez autoriser les utilisateurs à se connecter automatiquement à RedVector via l’authentification unique (SSO) avec leur compte Azure AD.
...
## <a name="add-redvector-from-the-gallery"></a>Ajouter RedVector à partir de la galerie
...
Dans cette section, vous allez configurer et tester l’authentification unique Azure AD avec RedVector, avec un utilisateur de test nommé « Britta Simon ».
...
3. **[Création d’un utilisateur de test RedVector](#creating-a-RedVector-test-user)** pour avoir un équivalent de Britta Simon dans RedVector lié à la représentation Azure AD associée.
4. **[Affectation de l’utilisateur de test Azure AD](#assigning-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Test de l’authentification unique](#testing-single-sign-on)** pour vérifier si la configuration fonctionne.

### <a name="configure-azure-ad-sso"></a>Configurer l’authentification unique Azure AD
L’objectif de cette section est d’activer l’authentification unique Azure AD dans le portail Azure Classic et de la configurer dans votre application RedVector.
...
2. Dans le portail Azure Classic, dans la page d’intégration d’application **RedVector**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
...
4. Sur la page **Configurer les paramètres d’application** , procédez comme suit : 
 ...
 1. Dans la zone de texte URL de connexion, tapez une URL au format suivant : `https://sso2.redvector.com/adfs/<Companyname>`. Vous devrez peut-être contacter le support Redvector à l’adresse <sso@redvector.com> pour obtenir les valeurs correctes pour votre environnement.
...
6. Pour que l’authentification unique soit configurée pour votre application, contactez l’équipe du support technique RedVector à l’adresse <mailto:sso@redvector.com>. Ils vous aideront à configurer l’authentification unique à l’aide du canal approprié. Dans l’e-mail, fournissez-leur les éléments suivants : 
...
### <a name="create-a-redvector-test-user"></a>Créer un utilisateur de test RedVector
Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans RedVector. Si vous ne savez pas comment ajouter Britta Simon dans RedVector, rapprochez-vous de l’équipe de support RedVector pour ajouter l’utilisateur de test et activer l’authentification unique. Contactez-la à <mailto:sso@redvector.com>.
