...
Le proxy d’application Azure AD est une fonctionnalité qui n’est disponible que si vous effectuez une mise à niveau l’édition Premium ou De base d’Azure Active Directory. Pour plus d’informations, consultez la page [Éditions d’Azure Active Directory](active-directory-editions).
...
Pour commencer à utiliser le proxy d’application, procédez comme suit : 1. [Activez les services de proxy d’application](https://msdn.microsoft.com/library/azure/dn768214.aspx) 2. [Publiez des applications avec le proxy d’application](https://msdn.microsoft.com/library/azure/dn768220.aspx)
