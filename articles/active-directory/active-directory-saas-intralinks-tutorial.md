...
3. **[Création d’un utilisateur de test Intralinks](#creating-an-intralinks-test-user)** pour avoir un équivalent de l’utilisateur Britta Simon dans Intralinks, qui soit lié à la représentation Azure AD associée.
...
> [!NOTE]
> Remarque : cette fonctionnalité est uniquement disponible pour les clients Microsoft Azure AD Premium. Les clients dotés de la version gratuite ou de base du logiciel ne peuvent pas l’utiliser.
> 
> 
