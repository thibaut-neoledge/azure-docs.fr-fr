...
| [Conditions préalables](connect/active-directory-aadconnect-get-started-custom.md#ad-fs-configuration-pre-requisites) |Conditions préalables à l’installation d’AD FS via Azure AD Connect |
| [Configurer la batterie de serveurs AD FS](connect/active-directory-aadconnect-get-started-custom.md#configuring-federation-with-ad-fs) |Installation d’une nouvelle batterie de serveurs AD FS avec Azure AD Connect |
