...
---
# Nouveautés relatives à la gestion des applications d’entreprise dans Azure Active Directory
...
## Amélioration de la galerie d’applications Azure Active Directory
...
## Ajout d’applications personnalisées à partir d’un seul emplacement
...
### Déploiement d’applications existantes
...
## Démarrage rapide : utilisez immédiatement votre nouvelle application
...
## Mise à jour de la configuration du proxy d’application
...
## Configuration d’une authentification unique fédérée avancée
...
### Paramètre Relay State (État du relais)
...
## Apport de vos propres applications avec authentification unique par mot de passe
