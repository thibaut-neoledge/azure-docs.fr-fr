...
3.  Dans la page **Configurer l’URL de l’application**, dans la zone de texte **URL de connexion de Kudos**, tapez votre URL selon le modèle suivant « **https://company.kudosnow.com*", puis cliquez sur **Suivant**.
