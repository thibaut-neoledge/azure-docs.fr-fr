---
title: 'Tutoriel : Configurer Workday pour la synchronisation entrante | Microsoft Docs'
...
---
# <a name="tutorial-configure-workday-for-inbound-synchronization"></a>Tutoriel : Configurer Workday pour la synchronisation entrante
...
**Pour activer l’intégration d’applications pour Workday :**
...
## <a name="configure-user-import-in-azure-ad"></a>Configurer l’importation d’utilisateurs dans Azure AD
Cette section décrit la configuration d’Azure AD pour importer des utilisateurs à partir de Workday.

**Pour configurer l’importation d’utilisateurs :**
...
2. Sur la page **Paramètres et informations d’identification administrateur**, procédez comme suit, puis cliquez sur **Suivant** : 
  ...
  1. Dans la zone de texte **Nom d’utilisateur Admin Workday**, entrez le nom de l’utilisateur que vous avez créé dans la section Création d’un utilisateur de système d’intégration.
  2. Dans la zone de texte **Mot de passe Admin Workday**, entrez le mot de passe de l’utilisateur que vous avez créé dans la section Création d’un utilisateur de système d’intégration.
