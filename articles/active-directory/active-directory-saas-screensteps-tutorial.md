...
> [!NOTE]
> Vous pouvez utiliser n’importe quel autre outil ou API de création de compte d’utilisateur, fourni par ScreenSteps, pour approvisionner des comptes d’utilisateur AAD.
> 
> 
