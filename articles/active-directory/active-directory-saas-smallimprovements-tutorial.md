<properties
	pageTitle="Didacticiel : intégration d’Azure Active Directory avec Small Improvements | azure.microsoft.com/ Azure"
...
L’objectif de ce didacticiel est de vous montrer comment intégrer Small Improvements à Azure Active Directory (Azure AD). L’intégration de Small Improvements à Azure AD vous offre les avantages suivants :
...
2. Sur la page **Comment voulez-vous que les utilisateurs se connectent à Small Improvements**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**.
...
1. Cliquez sur l’onglet **Add Team Member** (Ajouter un membre d’équipe). ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_11.png)

1. Tapez l’adresse électronique, le prénom et le nom d’un utilisateur valide que vous souhaitez configurer dans les zones de texte correspondantes, à savoir, **First Name**, **Last Name** et **Email Address**. ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_12.png)
