...
7. Dans le volet de résultats, sélectionnez **Small Improvements**, puis cliquez sur **Terminer** pour ajouter l’application. <br><br>
...
1. Dans le portail Azure Classic, sur la page d’intégration d’application **Small Improvements**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**. <br><br> ![Configurer l’authentification unique][6] <br>

2. Sur la page **Comment voulez-vous que les utilisateurs se connectent à Small Improvements**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**. <br><br>![Configurer l’authentification unique](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_03.png)<br>

3. Sur la page **Configurer les paramètres d’application**, procédez comme suit : <br><br>![Configurer l’authentification unique](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_04.png) <br>

    > [AZURE.NOTE]Contactez l'équipe du support technique de Small Improvements [Support@small-improvements.com](mailto:support@small-improvements.com) pour configurer un nom de domaine pour votre compte. Cela est nécessaire pour que l'authentification unique fonctionne.
...
4. Sur la page **Configurer l’authentification unique sur Small Improvements**, procédez comme suit : <br><br>![Configurer l’authentification unique](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_05.png) <br>
...
1. Sur la page de configuration de l’authentification unique, procédez comme suit : <br><br>![Configurer l’authentification unique](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_08.png) <br>

    a. Dans la page **Configurer l’authentification unique sur Small Improvements** du portail Azure Classic, copiez la valeur de l’**URL SSO SAML**, puis collez-la dans la zone de texte **Point de terminaison HTTP**.
...
6. Dans le portail Azure Classic, sélectionnez la confirmation de la configuration de l’authentification unique, puis cliquez sur **Next**. <br><br>![Authentification unique Azure AD][10]<br>

7. Sur la page **Confirmation de l’authentification unique**, cliquez sur **Complete**. <br><br>![Authentification unique Azure AD][11]
...
1. Dans le volet de navigation gauche du **portail Azure Classic**, cliquez sur **Active Directory**. <br><br> ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/create_aaduser_09.png)<br>

2. Dans la liste **Annuaire**, sélectionnez l'annuaire pour lequel vous voulez activer l'intégration d'annuaire.

3. Pour afficher la liste des utilisateurs, dans le menu du haut, cliquez sur **Users**. <br><br> ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/create_aaduser_03.png) <br>

4. Pour ouvrir la boîte de dialogue **Ajouter un utilisateur**, dans la barre d’outils située en bas, cliquez sur **Ajouter un utilisateur**. <br><br> ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/create_aaduser_04.png) <br>

5. Sur la page de boîte de dialogue **Parlez-nous de cet utilisateur**, procédez comme suit : <br><br> ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/create_aaduser_05.png) <br>

    a. Dans Type d’utilisateur, sélectionnez Nouvel utilisateur dans votre organisation.

    b. Dans la zone de texte **User Name**, entrez **BrittaSimon**.

    c. Cliquez sur **Next**.

6.  Sur la page de boîte de dialogue **User Profile**, procédez comme suit : <br><br>![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/create_aaduser_06.png) <br>

    a. Dans la zone de texte **First Name**, entrez **Britta**.

    b. Dans la zone de texte **Last Name**, entrez **Simon**.

    c. Dans la zone de texte **Display Name**, entrez **Britta Simon**.

    d. Dans la liste **Role**, sélectionnez **User**. e. Cliquez sur **Next**.

7. Sur la page de boîte de dialogue **Obtenir un mot de passe temporaire**, cliquez sur **Créer**. <br><br> ![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/create_aaduser_07.png) <br>

8. Sur la page de boîte de dialogue **Obtenir un mot de passe temporaire**, procédez comme suit : <br><br>![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/create_aaduser_08.png) <br>
...
1. À partir de la page d'accueil, accédez au menu de gauche, cliquez sur **Administration**.

1. Cliquez sur le bouton **User Directory** bouton à partir de la section User Management. <br><br>![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_10.png) <br>

1. Cliquez sur **Add Team Member**. <br><br>![Création d’un utilisateur de test Azure AD](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_11.png) <br>
...
1. Vous pouvez également choisir de saisir le message personnel dans la zone **Envoyer un e-mail de notification**. Décochez cette case si vous ne souhaitez envoyer de notification.
