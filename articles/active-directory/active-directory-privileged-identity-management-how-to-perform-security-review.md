...
# Azure Privileged Identity Management : comment effectuer une révision de la sécurité
...
Vous pouvez exporter une révision pour une utilisation avec Excel ou tout autre programme qui peut utiliser des fichiers CSV.
...
> AVERTISSEMENT AZURE [la suppression ayant lieu sans qu’un avertissement soit préalablement affiché, assurez-vous que vous *voulez* supprimer cette révision.]
