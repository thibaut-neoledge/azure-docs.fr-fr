---
title: "En savoir plus : Gestion des mots de passe Azure AD | Microsoft Docs"
...
> [!NOTE]
> Le téléphone professionnel n’apparaît pas dans le portail d’inscription, car les utilisateurs ne sont pas actuellement en mesure de modifier cette propriété dans l’annuaire.
>
>
...
#### <a name="data-accessible-with-azure-ad-powershell"></a>Données accessibles avec Azure AD PowerShell
...
##### <a name="alternate-email"></a>Autre adresse de messagerie
```
Connect-MsolService
...
##### <a name="authentication-phone"></a>Téléphone d’authentification
```
Connect-MsolService
Get-MsolUser -UserPrincipalName user@domain.com | select -Expand StrongAuthenticationUserDetails | select PhoneNumber
```

##### <a name="authentication-email"></a>E-mail d’authentification
```
Connect-MsolService
