...
---
# <a name="view-all-existing-groups-in-azure-active-directory-preview"></a>Afficher tous les groupes existants dans la version préliminaire d’Azure Active Directory
