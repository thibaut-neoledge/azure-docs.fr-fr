...
1. Sur la page **Configurer l’authentification unique sur Kiteworks** , procédez comme suit :
    ...
    b. Cliquez sur **Next**.
2. Connectez-vous à votre site d’entreprise Kiteworks en tant qu’administrateur.
3. Dans la barre d’outils située en haut, cliquez sur **Settings**.
   
    ![Configurer l’authentification unique](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_06.png) 
4. Dans la section **Authentification et autorisation**, cliquez sur **SSO Setup** (Configuration de l’authentification unique). 
...
5. Sur la page de configuration de l’authentification unique, procédez comme suit :
    ...
    c. Dans le portail Azure Classic, sur la page **Configurer l’authentification unique sur Kiteworks**, copiez la valeur de **ID d’entité**, puis collez-la dans la zone de texte **ID d’entité du fournisseur d’identité**. 
   
    d. Dans le portail Azure Classic, sur la page **Configurer l’authentification unique sur Kiteworks**, copiez la valeur de **URL du service d’authentification unique**, puis collez-la dans la zone de texte **URL du service d’authentification unique**.
   
    e. Dans le portail Azure Classic, sur la page **Configurer l’authentification unique sur Kiteworks**, copiez la valeur de **URL du service de déconnexion unique**, puis collez-la dans la zone de texte **URL du service de déconnexion unique**.
...
Kiteworks prend en charge l’approvisionnement juste-à-temps, option activée par défaut.

Vous n’avez aucune opération à effectuer dans cette section.
Un utilisateur est créé lors d’une tentative d’accès à Kiteworks s’il n’existe pas déjà.
