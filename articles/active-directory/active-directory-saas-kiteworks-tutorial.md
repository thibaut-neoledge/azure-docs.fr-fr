...
L’objectif de ce didacticiel est de vous montrer comment intégrer Kiteworks dans Azure AD (Azure Active Directory). 
...
* Vous pouvez autoriser les utilisateurs à se connecter automatiquement à Kiteworks via l’authentification unique (SSO) avec leur compte Azure AD.
...
L’objectif de cette section est d’activer l’authentification unique Azure AD dans le portail Azure Classic et de la configurer dans votre application Kiteworks. 
...
Pour configurer l’authentification unique pour Kiteworks, vous avez besoin d’un domaine inscrit. Si vous n’avez pas encore de domaine enregistré, contactez votre équipe de support Kiteworks.  

**Pour configurer l’authentification unique Azure AD avec Kiteworks, procédez comme suit :**

1. Dans le portail Azure Classic, sur la page d’intégration d’applications **Kiteworks**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
...
3. Sur la page de boîte de dialogue **Configurer les paramètres de l’application** , procédez comme suit :
  ...
  1. Dans la zone de texte **URL d’authentification**, entrez l’URL utilisée par vos utilisateurs pour se connecter à votre application Kiteworks (p. ex., *https://fabrikam.kiteworks.com/*).
...
4. Sur la page **Configurer l’authentification unique sur Kiteworks** , procédez comme suit :
  ...
  2. Cliquez sur **Suivant**.
5. Connectez-vous à votre site d’entreprise Kiteworks en tant qu’administrateur.
...
7. Dans la section **Authentification et autorisation**, cliquez sur **SSO Setup** (Configuration de l’authentification unique). 
...
8. Sur la page de configuration de l’authentification unique, procédez comme suit :
  ...
  1. Sélectionnez **Authenticate via SSO**.
  2. Sélectionnez **Initiate AuthnRequest**.
  3. Dans le portail Azure Classic, sur la page **Configurer l’authentification unique sur Kiteworks**, copiez la valeur de **ID d’entité**, puis collez-la dans la zone de texte **ID d’entité du fournisseur d’identité**. 
  4. Dans le portail Azure Classic, sur la page **Configurer l’authentification unique sur Kiteworks**, copiez la valeur de **URL du service d’authentification unique**, puis collez-la dans la zone de texte **URL du service d’authentification unique**.
  5. Dans le portail Azure Classic, sur la page **Configurer l’authentification unique sur Kiteworks**, copiez la valeur de **URL du service de déconnexion unique**, puis collez-la dans la zone de texte **URL du service de déconnexion unique**.
  6. Ouvrez le certificat que vous avez téléchargé dans le Bloc-notes, copiez son contenu, puis collez-le dans la zone de texte **RSA Public Key Certificate** . 
  7. Cliquez sur **Save**.
...
### <a name="create-a-kiteworks-test-user"></a>Créer un utilisateur de test Kiteworks
...
>[!NOTE]
>Si vous devez créer un utilisateur manuellement, contactez l’équipe de support Kiteworks.
>  
