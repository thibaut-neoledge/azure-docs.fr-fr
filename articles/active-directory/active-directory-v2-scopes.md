...
## Demande de consentement d’un client entier
...
## Étendues restreintes aux administrateurs
...
| redirect\_uri | required | Le redirect\_uri où vous souhaitez que la réponse soit envoyée pour être gérée par votre application. Il doit correspondre exactement à l’un des URI de redirection enregistrés dans le portail. |
