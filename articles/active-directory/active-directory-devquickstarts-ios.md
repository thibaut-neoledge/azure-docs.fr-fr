...
## <a name="1-determine-what-your-redirect-uri-will-be-for-ios"></a>*1. Déterminer votre URI de redirection pour iOS*
...
5. Suivez les invites et créez une **application cliente native**. Le **nom** de l’application doit décrire votre application aux utilisateurs finaux. **URI de redirection** correspond à l’URI utilisé pour renvoyer les jetons à votre application. Entrez une valeur spécifique à votre application. Cliquez sur **Créer** pour créer l’application.
...
## <a name="3-install--configure-adal"></a>*3. Installation et configuration de la bibliothèque ADAL*
