...
5. Sur le **faites-nous part de cet utilisateur** boîte de dialogue de page, procédez comme suit : ![création d’un utilisateur de test Azure AD](./media/active-directory-saas-Halosys-tutorial/create_aaduser_05.png) 
