...
* Un abonnement Mimecast Admin Console pour lequel l’authentification unique (SSO) est activée
...
4. Cliquez sur **Ajouter** en bas de la page.
   ...
   ![Ajouter une application](./media/active-directory-saas-mimecast-admin-console-tutorial/IC749321.png "Ajouter une application")
