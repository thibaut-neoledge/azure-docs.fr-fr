...
## <a name="table-3---azure-ad-connect-and-federation-servers/wap"></a>Tableau 3 - Azure AD Connect et serveurs de fédération/WAP
...
## <a name="table-6a-&-6b---azure-ad-connect-health-agent-for-(ad-fs/sync)-and-azure-ad"></a>Tableau 6a & 6b - Agent Azure AD Connect Health pour (AD FS/Sync) et Azure AD
...
### <a name="table-6a---ports-and-protocols-for-azure-ad-connect-health-agent-for-(ad-fs/sync)-and-azure-ad"></a>Tableau 6a - Ports et protocoles pour l’agent Azure AD Connect Health pour (AD FS/Sync) et Azure AD
...
### <a name="6b---endpoints-for-azure-ad-connect-health-agent-for-(ad-fs/sync)-and-azure-ad"></a>6b - Points de terminaison pour l’agent Azure AD Connect Health pour (AD FS/Sync) et Azure AD
