...
## <a name="table-3---azure-ad-connect-and-federation-serverswap"></a>Tableau 3 - Azure AD Connect et serveurs de fédération/WAP
...
### <a name="6b---endpoints-for-azure-ad-connect-health-agent-for-ad-fssync-and-azure-ad"></a>6b - Points de terminaison pour l’agent Azure AD Connect Health pour (AD FS/Sync) et Azure AD
