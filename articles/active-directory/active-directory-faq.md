...
## <a name="accessing-azure-and-azure-active-directory"></a>Accès à Azure et Azure Active Directory
...
- - -
## <a name="getting-started-with-hybrid-azure-ad"></a>Prise en main d’Azure AD hybride
