---
title: "Exécuter une révision d’accès | Microsoft Docs"
description: "Exécuter une révision d’accès avec Azure Active Directory"
...
---
# <a name="how-to-review-your-access"></a>Exécuter une révision d’accès
...
Vous pouvez voir les révisions d’accès en attente en cliquant sur le lien dans l’e-mail.  Si vous n’avez pas reçu l’e-mail, vous pouvez localiser les révisions d’accès en effectuant les actions suivantes :
...
Sélectionnez une révision d’accès dans la liste et vous pouvez voir votre accès.  Vous pouvez cliquer sur la ligne et choisir d’accepter ou de refuser l’accès continu.

Le réviseur peut demander que vous fournissiez une justification en cas d’acceptation d’un accès permanent.

## <a name="next-steps"></a>Étapes suivantes

Notez qu’un accès refusé n’est pas supprimé immédiatement, alors si vous souhaitez modifier votre réponse et accepter, réinitialisez la réponse et choisissez une nouvelle réponse.  Vous pouvez effectuer cela jusqu'à la fin de la révision d’accès.
