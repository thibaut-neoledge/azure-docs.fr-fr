...
![Utilisateurs - icône](./media/role-based-access-control-configure/users_icon.png)
...
![Ajouter - icône](./media/role-based-access-control-configure/add_icon.png)  
...
![Supprimer - icône](./media/role-based-access-control-configure/remove_icon.png)
