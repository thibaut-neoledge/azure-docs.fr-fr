...
1.  Dans le portail Azure AD, dans la page d’intégration d’application **15Five**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
...
4.  Dans la page **Configurer l’authentification unique sur 15Five**, cliquez sur **Télécharger les métadonnées**, puis transférez le fichier de métadonnées à l’équipe de support 15Five.
    ...
    >[AZURE.NOTE]L’authentification unique doit être activée par l’équipe de support 15Five.
...
>[AZURE.NOTE]Vous pouvez utiliser n’importe quel autre outil ou API de création de compte d’utilisateur 15Five fourni par ce service pour approvisionner des comptes d’utilisateurs Azure Active Directory.
