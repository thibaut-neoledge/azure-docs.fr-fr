...
# Problèmes de connexion à une application de la galerie Azure AD configurée pour l’authentification unique fédérée
...
9.  [Affecter des utilisateurs à l’application](#_How_to_assign)
