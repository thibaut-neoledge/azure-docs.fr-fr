<properties
	pageTitle="Didacticiel : Intégration d’Azure Active Directory avec eDigitalResearch | Microsoft Azure"
...
# Didacticiel : Intégration d’Azure Active Directory avec eDigitalResearch
...
## Ajout d’eDigitalResearch à partir de la galerie
...
L’objectif de cette section est de vous montrer comment configurer et tester l’authentification unique Azure AD avec eDigitalResearch au moyen d’un utilisateur de test appelé « Britta Simon ».
...
Dans cette section, vous allez activer l’authentification unique Azure AD dans le portail Azure Classic et configurer l’authentification unique dans votre application eDigitalResearch.
...
2. Dans la page **Comment voulez-vous que les utilisateurs se connectent à eDigitalResearch**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**.
...
3. Dans la page de boîte de dialogue **Configurer les paramètres d’application**, procédez comme suit et cliquez sur **Suivant** :
	...
	> [AZURE.NOTE] Dans ce didacticiel, la valeur de l’URL de réponse est un espace réservé. Pour obtenir la valeur réelle pour votre environnement, contactez eDigitalResearch.
...
### Création d’un utilisateur de test eDigitalResearch
