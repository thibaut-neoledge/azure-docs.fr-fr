---
title: 'Didacticiel : Intégration d’Azure Active Directory avec Amazon Web Service (AWS) | Microsoft Docs'
...
3. **[Création d’un utilisateur de test Amazon Web Service (AWS)](#creating-a-halogen-software-test-user)** pour avoir un équivalent de Britta Simon dans Amazon Web Service (AWS) lié à sa représentation dans Azure AD.
