<properties
	pageTitle="Considérations relatives à la conception d'identités hybrides Azure Active Directory - Suite | Microsoft Azure"
...
#Considérations relatives à la conception d'identités hybrides Azure Active Directory - Suite
...
- Les solutions [Microsoft System Center](https://technet.microsoft.com/fr-FR/library/cc507089.aspx) peuvent vous aider à recueillir et à agréger des informations sur votre infrastructure, les stratégies, les processus et les meilleures pratiques afin que votre personnel informatique puisse créer des systèmes gérables et automatiser les opérations.
- [Microsoft Intune](https://technet.microsoft.com/fr-FR/library/jj676587.aspx) est un service cloud de gestion des périphériques qui vous aide à gérer vos ordinateurs et périphériques mobiles et à sécuriser les informations de votre société.
- [GPM pour Office 365](https://technet.microsoft.com/fr-FR/library/ms.o365.cc.devicepolicy.aspx) vous permet de gérer et de sécuriser les périphériques mobiles lorsqu'ils sont connectés à votre organisation Office 365. Vous pouvez utiliser la GPM pour Office 365 afin de définir des règles d'accès et des stratégies de sécurité des périphériques et de réinitialiser les périphériques mobiles s'ils sont perdus ou volés.

## Ressources sur les identités hybrides
