<properties
	pageTitle="Gérer les paramètres des groupes dans la version préliminaire d’Azure Active Directory | Microsoft Azure"
...
# Gérer les paramètres des groupes dans la version préliminaire d’Azure Active Directory
