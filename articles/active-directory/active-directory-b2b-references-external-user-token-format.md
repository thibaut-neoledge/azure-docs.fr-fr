...
---
# <a name="azure-ad-b2b-collaboration-preview-external-user-token-format"></a>Version préliminaire d’Azure AD B2B Collaboration : Format de jeton utilisateur externe
...
* **TID :** l’ID client du client de la ressource<br/>
