...
* Un abonnement Kontiki pour lequel l’authentification unique (SSO) est activée
...
## <a name="enable-the-application-integration-for-kontiki"></a>Activer l'intégration d'applications pour Kontiki
...
4. Cliquez sur **Ajouter** en bas de la page.
   ...
   ![Ajouter une application](./media/active-directory-saas-kontiki-tutorial/IC749321.png "Ajouter une application")
...
>!REMARQUE] Si aucun compte d'utilisateur n’est disponible, Kontiki le crée automatiquement.
>
