...
Si vous sélectionnez **Groupe** en tant que **Type d’activité**, vous obtenez une autre option de filtrage qui vous permet également de filtrer en fonction des **Sources d’activité** suivantes :
