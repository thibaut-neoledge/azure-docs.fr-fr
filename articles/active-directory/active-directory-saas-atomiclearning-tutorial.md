...
Pour que l’authentification unique fonctionne, Azure AD doit savoir qui est l’utilisateur Atomic Learning équivalent dans Azure AD. En d’autres termes, une relation entre l’utilisateur Azure AD et l’utilisateur Atomic Learning associé doit être établie.
...
3. **[Création d’un utilisateur de test Atomic Learning](#creating-an-atomic-learning-test-user)** pour avoir un équivalent de Britta Simon dans Atomic Learning lié à la représentation Azure AD associée.
...
2. Dans le portail Classic, dans la page d’intégration d’application **Atomic Learning**, cliquez sur **Configurer l’authentification unique** pour ouvrir la boîte de dialogue **Configurer l’authentification unique**.
   
    ![Configurer l’authentification unique][7] 

3. Dans la page **Comment voulez-vous que les utilisateurs se connectent à Atomic Learning**, sélectionnez **Authentification unique Azure AD**, puis cliquez sur **Suivant**.
...
1. Dans la page **Configurer l’authentification unique sur Atomic Learning**, cliquez sur **Télécharger les métadonnées**, puis enregistrez le fichier sur votre ordinateur.
   
    ![Configurer l’authentification unique](./media/active-directory-saas-atomiclearning-tutorial/tutorial_atomiclearning_08.png)

2. Pour que l’authentification unique soit configurée pour votre application, contactez votre équipe du support technique Atomic Learning. Ils vous aideront à configurer l’authentification unique à l’aide du canal approprié. Notez que vous devez envoyer un e-mail en y joignant le fichier de métadonnées téléchargé à l’adresse <mailto:cs@atomiclearning.com>.
...
### <a name="creating-a-atomic-learning-test-user"></a>Création d’un utilisateur de test Atomic Learning
