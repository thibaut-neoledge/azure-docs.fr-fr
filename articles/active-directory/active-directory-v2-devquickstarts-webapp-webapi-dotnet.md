---
title: Application Web .NET v2.0 Azure AD | Microsoft Docs
...
## <a name="use-adal-to-get-access-tokens"></a>Utilisation d’ADAL pour obtenir des jetons d’accès
...
## <a name="4.-call-the-web-api"></a>4. Appel de l’API web
