<properties pageTitle="Didacticiel : Intégration d’Azure Active Directory à Boomi | Microsoft Azure" description="Apprenez à utiliser Boomi avec Azure Active Directory pour activer l’authentification unique, l’approvisionnement automatique et bien plus encore." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Didacticiel : Intégration d’Azure Active Directory à Boomi
>[AZURE.TIP]Pour envoyer des commentaires, cliquez [ici](http://go.microsoft.com/fwlink/?LinkId=529589).
...
À l’issue de ce didacticiel, les utilisateurs Azure AD que vous avez affectés à Boomi pourront s’authentifier de manière unique dans l’application sur votre site d’entreprise Boomi (connexion initiée par le fournisseur du service) ou à l’aide de la [Présentation du volet d’accès](https://msdn.microsoft.com/library/dn308586).
...
6.  Dans la barre d’outils située en haut, cliquez sur le nom de votre société, puis sur **Paramétrage**.
...
8.  Dans la section **Options d’authentification unique**, procédez comme suit :
    ...
    1.  Sélectionnez **Activer l’authentification unique SAML**.
    2.  Pour charger le certificat téléchargé, cliquez sur **Importer**.
    3.  Dans le portail Azure, dans la page de boîte de dialogue **Configurer l’authentification unique sur Boomi**, copiez la valeur **URL de connexion distante** et collez-la dans la zone de texte **URL de connexion du fournisseur d’identité**.
    4.  Comme **Emplacement de l’ID de fédération**, sélectionnez**L’ID de fédération est dans l’élément NameID de l’objet**.
...
4.  Dans la page de boîte de dialogue **Ajouter des rôles d’utilisateur**, procédez comme suit :

    ![Ajouter un utilisateur](./media/active-directory-saas-boomi-tutorial/IC790833.png "Ajouter un utilisateur")

    1.  Tapez le **prénom**, le **nom** et l’**adresse de messagerie** d’un compte AAD valide que vous souhaitez approvisionner dans les zones de texte correspondantes.
    2.  Cliquez sur OK.
