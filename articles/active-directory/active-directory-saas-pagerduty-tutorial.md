...
À l’issue de ce didacticiel, les utilisateurs d’Azure AD que vous avez affectés à Pagerduty pourront s’authentifier de manière unique (SSO) dans l’application sur votre site d’entreprise Pagerduty (connexion initiée par le fournisseur du service) ou en s’aidant de la [Présentation du volet d’accès](active-directory-saas-access-panel-introduction.md).
...
4. Cliquez sur **Ajouter** en bas de la page.
   ...
   ![Ajouter une application](./media/active-directory-saas-pagerduty-tutorial/IC749321.png "Ajouter une application")
