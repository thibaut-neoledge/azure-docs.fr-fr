...
![Approbations de partie de confiance, clic droit sur le nom de l’application – capture d’écran][1]
...
![Ajouter un point de terminaison, définition de la valeur de l’URL approuvée – capture d’écran][2]
