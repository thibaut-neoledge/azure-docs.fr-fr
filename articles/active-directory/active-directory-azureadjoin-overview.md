...
| --- | --- | --- |
| Les utilisateurs peuvent se connecter à Windows à l’aide des informations d’identification de leur compte professionnel (comme ils le font déjà). |Les utilisateurs peuvent se connecter à Windows avec les informations d'identification de leur compte professionnel gérées dans Azure AD. Cela s’applique aux appareils d’entreprise dans trois cas : <ol><li>L’organisation ne dispose pas d’Active Directory localement (cas, par exemple, d’une petite entreprise).</li><li>L’organisation ne crée pas la totalité de ses comptes d’utilisateur dans Active Directory (par exemple, les comptes d’étudiants, de consultants ou d’employés saisonniers ne sont pas créés dans Active Directory).</li><li>L’organisation dispose d’appareils d’entreprise qui ne peuvent pas être joints à un domaine (local), comme les téléphones ou tablettes exécutant une version mobile (par exemple, un appareil secondaire emporté à l’atelier ou dans la surface de vente).</li></ol> Azure AD Join prend en charge la jonction d’appareils d’entreprise pour les organisations gérées et fédérées. |Les utilisateurs se connectent à Windows à l’aide des informations d’identification de leur compte Microsoft personnel (comme ils le font déjà). |
