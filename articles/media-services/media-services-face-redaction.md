<properties
	pageTitle="Rédaction de face avec Azure Media Analytics | Microsoft Azure"
...
1. Créer un travail avec une tâche de rédaction de face basée sur un fichier de configuration qui contient la présélection JSON suivante.
