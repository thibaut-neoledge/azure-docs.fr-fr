...
1. Cliquez sur **Créer un canal**. ![Elemental](./media/media-services-elemental-live-encoder/media-services-elemental12.png)
...
3. Créez une nouvelle sortie en sélectionnant **New Stream**, puis en cliquant sur **Add Output**.
   ...
   > [!NOTE]
   > Il est recommandé que le code horaire de l’événement Elemental soit défini sur Horloge système pour aider l’encodeur à se reconnecter en cas d’échec d’un flux.
   > 
   > 
...
1. Obtenez l’URL d’entrée du canal.
...
2. Collez ces informations dans le champ **Primary Destination** d’Elemental. Tous les autres paramètres peuvent rester inchangés.
...
3. Cliquez sur **Create** (si un événement a été créé) ou **Update** (en cas de modification d’un événement existant), puis procédez au démarrage de l’encodeur.

> [!IMPORTANT]
> Avant de cliquer sur **Start** dans l’interface web Elemental Live, vous **devez** vérifier que le canal est prêt. Veillez également à ne pas laisser le canal à l’état d’exécution sans événement pendant plus de 15 minutes.
> 
> 
