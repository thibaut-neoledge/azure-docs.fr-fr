...
> [!IMPORTANT]
> Avant de cliquer sur **Start** dans l’interface web Elemental Live, vous **devez** vérifier que le canal est prêt.
> Veillez également à ne pas laisser le canal à l’état d’exécution sans événement pendant plus de 15 minutes.
>
>
