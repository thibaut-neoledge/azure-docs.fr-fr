<properties 
	pageTitle="Gérer les points de terminaison de streaming avec le Portail Azure | Microsoft Azure" 
...
#Gérer les points de terminaison de streaming avec le Portail Azure
...
>[AZURE.NOTE]Vous êtes facturé uniquement lorsque votre point de terminaison de streaming est en cours d’exécution.
...
## Commencer à gérer des points de terminaison de streaming
...
##Ajouter/supprimer un point de terminaison de streaming
...
2. Cliquez sur le bouton **Démarrer** pour démarrer le point de terminaison de streaming.
