...
# Procédure
## Gérer
### [Gérer les points de terminaison de streaming dans le portail](media-services-portal-manage-streaming-endpoints.md)
### Gérer des entités
#### [.NET](media-services-dotnet-manage-entities.md)
#### [REST](media-services-rest-manage-entities.md)
### [Gérer des comptes avec PowerShell](media-services-manage-with-powershell.md)
### [Rogner des vidéos avec l’encodeur multimédia standard](media-services-crop-video.md)
### [Guide pratique pour mettre à jour Media Services après la substitution de clés d’accès de stockage](media-services-roll-storage-access-keys.md)
### [Quotas et limitations](media-services-quotas-and-limitations.md)
### Filtres
#### [Création de filtres avec le Kit de développement logiciel (SDK) .NET Azure Media Services](media-services-dotnet-dynamic-manifest.md)
#### [Encodage d’un élément multimédia à l’aide de Media Encoder Standard](media-services-rest-encode-asset.md)
...
## Encoder
### [Contenu](media-services-encode-asset.md)
#### Encoder un élément multimédia à l’aide de Media Encoder Standard
...
#### [Encodage avancé](media-services-advanced-encoding-with-mes.md)
...
#### Encodeurs hérités
##### [Utilisation d’Azure Media Packager](media-services-static-packaging.md)

### [Diffusions en direct](media-services-manage-channels-overview.md)
#### [Encodeurs locaux](media-services-live-streaming-with-onprem-encoders.md)
#### Didacticiels sur les encodeurs locaux
##### [Portail](media-services-portal-live-passthrough-get-started.md)
##### [.NET](media-services-dotnet-live-encode-with-onpremises-encoders.md)
#### [Streaming en direct à l’aide d’un encodeur cloud](media-services-manage-live-encoder-enabled-channels.md)
#### Didacticiels sur les encodeurs cloud
...
### Configurer des encodeurs pour une diffusion temps réel à débit binaire unique
...
### [Chiffrer votre contenu avec le chiffrement de stockage à l'aide de l'API REST AMS](media-services-rest-storage-encryption.md)
...
### [Traiter avec la rédaction de face](media-services-face-redaction.md)
...
### [Utilisation de castLabs pour fournir des licences Widevine à Azure Media Services](media-services-castlabs-integration.md)
...
# Référence
## [Kit de développement logiciel (SDK) .NET de Media Services](media-services-dotnet-how-to-use.md)
## [API REST Media Services](media-services-rest-how-to-use.md)
