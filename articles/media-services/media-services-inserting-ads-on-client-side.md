...
###Utilisation d’un fichier VAST (Video Ad Service Template)
...
###Utilisation d’un fichier MAST (Media Abstract Sequencing Template)
...
###Utilisation de VPAID (Video Player-Ad Interface Definition)
...
###Planification de publicités avec VAST
