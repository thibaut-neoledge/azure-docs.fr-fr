...
## <a name="connecting-to-media-services"></a>Connexion à Media Services
...
> [!NOTE]
> La classe **CloudMediaContext** n'est pas thread-safe. Vous devez créer un nouveau CloudMediaContext par thread ou par ensemble d’opérations.
> 
> 
