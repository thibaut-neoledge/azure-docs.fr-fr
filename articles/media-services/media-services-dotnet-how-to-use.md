...
9. Ouvrez le fichier App.config et ajoutez-y une section *appSettings*.     
...
10. Remplacez les instructions **using** existantes au début du fichier Program.cs par le code suivant.
