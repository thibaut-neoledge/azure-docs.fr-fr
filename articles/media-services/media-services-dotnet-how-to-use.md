...
1. Créez une application de console C# dans Visual Studio 2010 SP1 ou versions ultérieures. Entrez le **nom**, l’**emplacement** et le **nom de solution**, puis cliquez sur OK.
