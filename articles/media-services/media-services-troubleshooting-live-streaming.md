<properties 
    pageTitle="Guide de dépannage de la vidéo en flux continu | Microsoft Azure" 
...
>[AZURE.NOTE] Si, après avoir suivi la procédure de dépannage, vous ne pouvez toujours pas diffuser en continu avec succès, envoyez un ticket de support en utilisant le portail Azure.
