...
---
#  <a name="use-azure-media-standard-to-auto-generate-a-bitrate-ladder"></a>Utilisation d’Azure Media Standard pour générer automatiquement une échelle des vitesses de transmission
