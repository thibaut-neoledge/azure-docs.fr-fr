---
title: " Prendre en main la diffusion de contenus à la demande à l’aide du portail Azure | Microsoft Docs"
...
3. Dans **CREATE MEDIA SERVICES ACCOUNT** (CRÉER UN COMPTE MEDIA SERVICES), entrez les valeurs requises.
   ...
   3. Dans **Groupe de ressources**, sélectionnez la ressource (nouvelle ou existante). Un groupe de ressources désigne une collection de ressources qui partagent un cycle de vie, des autorisations et des stratégies. En savoir plus [ici](../resource-group-overview.md#resource-groups).
