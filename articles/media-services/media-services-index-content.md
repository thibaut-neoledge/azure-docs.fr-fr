...
<tr><td>NomFichierEntrée.smi<br/>NomFichierEntrée.ttml<br/>InputFileName.vtt</td>
...
<tr><td>NomFichierEntrée.kw.xml
<br/>
InputFileName.info
</td>
<td>Fichiers de mots clés et d’informations.
<br/><br/>
...
<br/><br/>
Un fichier d’informations est un fichier de texte brut qui contient des informations précises sur chaque terme reconnu. La première ligne est spéciale et contient le score Recognizability. Chaque ligne suivante est une liste des données suivantes séparées par des tabulations&#160;: heure de début, heure de fin, mot/expression, fiabilité. Les heures sont exprimées en secondes et la fiabilité est exprimée comme un nombre compris entre&#160;0 et&#160;1.  <br/><br/>Exemple de ligne&#160;: «&#160;1,20 &#160;&#160;&#160;1,45 &#160;&#160;&#160;mot &#160;&#160;&#160;0,67&#160;»
<br/><br/>
Ces fichiers peuvent être utilisés à différentes fins, par exemple pour effectuer une analyse vocale ou être exposé à des moteurs de recherche comme Bing, Google ou Microsoft SharePoint pour rendre les fichiers multimédias plus détectables, ou même pour fournir des publicités plus pertinentes.</td></tr>
</table>
...
Lorsqu’il existe plusieurs fichiers multimédias d’entrée, Indexer génère un fichier manifeste pour les sorties de la tâche, nommé « JobResult.txt ». Pour chaque fichier multimédia d’entrée, les fichiers AIB, SAMI, TTML et WebVTT et les fichiers de mots clés qui en résultent sont numérotés de façon séquentielle, comme indiqué ci-dessous.
