...
> [WACOM.NOTE]Cette rubrique prend en charge les applications Windows Phone Store 8.1. Pour ajouter des notifications Push à une application Windows Phone 8 ou Silverlight pour Windows Phone 8.1, consultez cette version de [Prise en main des notifications Push dans Mobile Services][].
