...
6. (Facultatif) Si vous n'utilisez pas le projet de démarrage rapide généré par le portail de gestion, ouvrez le fichier Package.appxmanifest et vérifiez sous l'onglet **Interface utilisateur de l'application** que la valeur de **Compatible toast** est définie sur **Oui**.
...
[Envoi de notifications aux abonnés]: /fr-fr/documentation/articles/notification-hubs-windows-store-dotnet-send-breaking-news/
