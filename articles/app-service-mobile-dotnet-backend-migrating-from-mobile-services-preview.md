...
[Kit de développement logiciel (SDK) de serveur Mobile App]: http://www.nuget.org/packages/microsoft.azure.mobile.server
...
[Tâche web]: websites-webjobs-resources.md
