---
title: "Exemple JSON Azure Policy - Références (SKU) de comptes de stockage autorisées | Microsoft Docs"
description: "Cet exemple de stratégie JSON exige que les comptes de stockage utilisent une référence (SKU) approuvée."
...
---
# <a name="allowed-storage-account-skus"></a>Références SKU de compte de stockage autorisées

Cette stratégie exige que les comptes de stockage utilisent une référence (SKU) approuvée. Vous spécifiez un tableau de références (SKU) approuvées.
