---
title: Exemple JSON Azure Policy - Autoriser seulement le trafic HTTPS pour le compte de stockage | Microsoft Docs
description: "Cet exemple de stratégie JSON exige que les comptes de stockage utilisent le trafic HTTPS."
...
---
# <a name="ensure-https-traffic-only-for-storage-account"></a>Autoriser seulement le trafic HTTPS pour le compte de stockage

Cette stratégie exige que les comptes de stockage utilisent le trafic HTTPS.
