...
Cette stratégie exige qu’un groupe de sécurité réseau spécifique soit utilisé avec chaque sous-réseau virtuel. Vous spécifiez l’ID du groupe de sécurité réseau à utiliser.
