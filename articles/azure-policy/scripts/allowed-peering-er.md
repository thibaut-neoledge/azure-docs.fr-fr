...
Cette stratégie exige que les routes Express Route utilisent des emplacements d’appairage spécifiés. Vous spécifiez un tableau d’emplacements d’appairage autorisés.
