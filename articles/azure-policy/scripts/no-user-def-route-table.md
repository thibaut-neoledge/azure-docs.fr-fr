---
title: "Exemple JSON Azure Policy - Pas de table de routage définie par l’utilisateur | Microsoft Docs"
description: "Cet exemple de stratégie JSON interdit le déploiement de réseaux virtuels avec une table de routage définie par l’utilisateur."
...
---
# <a name="no-user-defined-route-table"></a>Pas de table de routage définie par l’utilisateur

Cette stratégie interdit le déploiement de réseaux virtuels avec une table de routage définie par l’utilisateur.
