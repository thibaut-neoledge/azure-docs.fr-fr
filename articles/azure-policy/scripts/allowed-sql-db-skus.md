---
title: "Exemple JSON Azure Policy - Références (SKU) de base de données SQL autorisées | Microsoft Docs"
description: "Cet exemple de stratégie JSON exige que les bases de données SQL utilisent une référence (SKU) approuvée."
...
---
# <a name="allowed-sql-db-skus"></a>Références (SKU) de base de données SQL autorisées

Cette stratégie JSON exige que les bases de données SQL utilisent une référence (SKU) approuvée. Vous spécifiez un tableau d’identifiants des références (SKU) autorisées ou un tableau de noms des références (SKU) autorisées.
