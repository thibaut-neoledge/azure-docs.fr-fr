...
Cette stratégie JSON vérifie si une extension n’est pas déployée avec une machine virtuelle. Vous spécifiez le serveur de publication et le type de l’extension dont vous voulez vérifier si elle a été déployée.
