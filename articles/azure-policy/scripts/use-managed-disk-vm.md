---
title: "Exemple JSON Azure Policy - Créer une machine virtuelle en utilisant un disque managé | Microsoft Docs"
description: "Cet exemple de stratégie JSON exige que les machines virtuelles utilisent des disques managés."
