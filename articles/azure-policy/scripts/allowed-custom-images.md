...
Cette stratégie exige que seules des images personnalisées approuvées soient déployées dans votre environnement. Vous spécifiez un tableau d’identifiants d’images approuvées.
