<properties title="How to create web test" pageTitle="Création de tests web" description="Découvrez comment créer des tests web dans Azure." authors="awills" manager="kamrani" />
