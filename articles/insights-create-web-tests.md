<properties title="How to create web test" pageTitle="Création de tests web" description="Learn how to create web tests in Azure." authors="awills" manager="kamrani" />
