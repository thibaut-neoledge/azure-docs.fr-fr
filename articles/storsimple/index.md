...
StorSimple et Microsoft Azure offrent une solution unique et intégrée d’archivage du stockage principal et de récupération d’urgence à l’aide d’Azure en tant qu’extension du stockage local. Découvrez comment déployer votre solution StorSimple.
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p>Gamme StorSimple 5000-7000</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="downloadHolder">
    <a href="https://opbuildstorageprod.blob.core.windows.net/output-pdf-files/en-us/Azure.azure-documents/live/storsimple.pdf">
        <div class="img"></div>
        <div class="text">
Télécharger la documentation StorSimple </div>
    </a>
</div>
