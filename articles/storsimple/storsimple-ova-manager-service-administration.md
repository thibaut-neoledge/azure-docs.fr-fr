...
|À propos des comptes de stockage</br>Ajout d’un compte de stockage</br>Modifier un compte de stockage</br>Supprimer un compte de stockage|Service StorSimple Manager → Configuration|[Gérer les comptes de stockage pour le StorSimple Virtual Array](storsimple-ova-manage-storage-accounts.md)|
...
|Configurer des paramètres d’alerte</br>Recevoir des notifications d’alerte</br>Gérer les alertes</br>Consulter les alertes|Service StorSimple Manager → Alertes|[Afficher et gérer les alertes pour le StorSimple Virtual Array](storsimple-ova-manage-alerts.md)|
