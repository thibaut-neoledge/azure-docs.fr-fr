...
[!INCLUDE [Création d'un appareil virtuel](../../includes/storsimple-create-virtual-device-u2.md)]
...
[!INCLUDE [Configuration et inscription de l’appareil virtuel](../../includes/storsimple-configure-register-virtual-device.md)]
...
[!INCLUDE [Configuration de la gestion à distance via le protocole HTTP pour l’appareil virtuel](../../includes/storsimple-configure-remote-management-http-device.md)]
...
[!INCLUDE [Création de points de terminaison publics sur un appareil virtuel](../../includes/storsimple-create-public-endpoints-virtual-device.md)]
...
[!INCLUDE [Arrêt et redémarrage d’un appareil virtuel](../../includes/storsimple-stop-restart-virtual-device.md)]
...
[!INCLUDE [Arrêt d’un appareil virtuel](../../includes/storsimple-shutdown-virtual-device.md)]

[!INCLUDE [Suppression d’un appareil virtuel](../../includes/storsimple-delete-virtual-device.md)]
