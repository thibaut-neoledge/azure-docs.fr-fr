...
| RSA | 2 048 | RSA PKCS 1 v1.7 est utilisé par le portail de gestion pour chiffrer la partie publique de la clé de chiffrement des données du service avant de la conserver dans le stockage local du portail. |
