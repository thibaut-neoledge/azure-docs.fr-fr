<properties
   pageTitle="Basculement d'appareil et récupération d'urgence pour votre StorSimple Virtual Array"
...
## Configuration requise pour le basculement d'appareil
...
### Vérifications préalables à la récupération d'urgence
...
3. Après confirmation, la désactivation démarre. Une fois la désactivation terminée avec succès, vous serez averti.
...
9. Un travail de basculement sera lancé et vous serez averti. Cliquez sur **Afficher le travail** pour contrôler le basculement.
...
## Erreurs lors de la récupération d'urgence
