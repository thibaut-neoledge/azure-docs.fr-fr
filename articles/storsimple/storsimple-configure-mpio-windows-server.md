...
> [!NOTE]
> **Cette procédure est applicable pour la gamme StorSimple 8000 uniquement. La solution MPIO n’est actuellement pas prise en charge sur un appareil virtuel StorSimple.**
> 
> 
...
3. Dans l’Assistant **Ajouter des rôles et fonctionnalités** , procédez comme suit :
   ...
   * Sur la page **Sélectionner le type d’installation**, acceptez le paramètre par défaut de l’installation **Installation basée sur un rôle ou une fonctionnalité**. Cliquez sur **Suivant**.![Assistant Ajouter des rôles et fonctionnalités 2](./media/storsimple-configure-mpio-windows-server/IC740999.png)
   ...
   * Sur la page **Sélectionner des fonctionnalités**, sélectionnez **MPIO (Multipath I/O)**, puis cliquez sur **Suivant**.![Assistant Ajout de rôles et de fonctionnalités 5](./media/storsimple-configure-mpio-windows-server/IC741000.png)
   * Sur la page **Confirmer les sélections pour l’installation**, confirmez la sélection, puis sélectionnez **Redémarrer automatiquement le serveur de destination, si nécessaire**, comme illustré ci-dessous. Cliquez sur **Installer**.![Assistant Ajout de rôles et de fonctionnalités 8](./media/storsimple-configure-mpio-windows-server/IC741001.png)
   * Vous recevrez une notification une fois l’installation terminée. Cliquez sur **Fermer** pour fermer l’assistant.![Assistant Ajout de rôles et fonctionnalités 9](./media/storsimple-configure-mpio-windows-server/IC741002.png)
