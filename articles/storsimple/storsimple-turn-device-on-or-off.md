...
> [!IMPORTANT]
> Avant d'arrêter le boîtier principal et le boîtier EBOD, assurez-vous que tous les composants de l'appareil sont intègres. Dans le portail de gestion, accédez à **Périphériques** > **Maintenance** > **État du matériel** et assurez-vous que tous les composants sont intègres.
> 
> 
