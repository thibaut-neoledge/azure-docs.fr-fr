...
---
# <a name="turn-your-storsimple-device-on-or-off"></a>Activation ou désactivation de votre appareil StorSimple
...
| Arrêter un appareil en cours d'exécution |[Désactiver un appareil en cours d'exécution](#turn-off-a-running-device)<ul><li>[Appareil avec boîtier principal uniquement](#8100a)</li><li>[Appareil avec boîtier EBOD](#8600a)</li></ul> |
