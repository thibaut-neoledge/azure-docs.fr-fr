<properties 
   pageTitle="Utiliser le Gestionnaire d’instantanés StorSimple pour gérer votre solution StorSimple | Microsoft Azure"
   description="Fournit des liens vers d’autres informations sur les tâches et les flux de travail d’administration du Gestionnaire d’instantanés StorSimple."
   services="storsimple"
