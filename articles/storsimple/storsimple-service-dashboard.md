---
title: "Tableau de bord du service StorSimple Manager | Microsoft Docs"
...
## <a name="view-or-regenerate-the-service-registration-key"></a>Affichage ou régénération de la clé d’inscription
...
## <a name="change-the-service-data-encryption-key"></a>Modification de la clé de chiffrement des données de service
...
## <a name="view-the-operations-logs"></a>Affichage des journaux des opérations
