...
| 6 |Copie côté hôte |Dans les versions précédentes du logiciel, un bogue lié à l’horodatage ODX survenait parfois lors de la copie des données d’un volume vers un autre. Ce problème entraînait un basculement du contrôleur, avec le risque de voir le système passer en mode de récupération. Ce bogue est résolu dans cette version. |yes |Non |
