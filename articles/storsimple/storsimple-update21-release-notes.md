<properties 
   pageTitle="Notes de publication de StorSimple série 8000 Update 2.1 | Microsoft Azure"
   description="Décrit les nouvelles fonctionnalités, les problèmes et les solutions de contournement associés à StorSimple série 8000 Update 2.1."
   services="storsimple"
...
>[AZURE.IMPORTANT]
> 
> - Update 2.1 contient uniquement des mises à jour logicielles. L’installation de cette mise à jour prend entre 1 h 30 et 2 h. 
...
## Nouveautés d’Update 2.1

Update 2.1 comporte les principales améliorations suivantes.
...
## Problèmes résolus dans Update 2.1

Le tableau suivant récapitule les problèmes qui ont été résolus dans Update 2.1.
...
## Problèmes connus dans Update 2.1
...
## Mises à jour du contrôleur et du microprogramme dans Update 2.1
...
Pour plus d’informations sur la procédure d’installation du pilote, de Storport, de Spaceport et du microprogramme de disque, voir [Install Update 2.1 on your StorSimple device](storsimple-install-update-21.md) (Installation d’Update 2.1 sur votre appareil StorSimple).

 
## Mises à jour des appareils virtuels dans Update 2.1
