...
| 20 |Message d’aperçu lors de la création du service StorSimple Manager | Le message d’aperçu qui s'affiche lors de la création d'un Service StorSimple Manager s'applique uniquement à la série Microsoft Azure StorSimple Virtual Array. La série Virtual Array qui a été lancée récemment est une offre en version préliminaire couverte par les [Conditions d’utilisation supplémentaires de la version préliminaire](https://azure.microsoft.com/support/legal/preview-supplemental-terms/). Le service StorSimple Manager et la série de périphérique physique StorSimple sont des solutions déjà commercialisées auxquelles les conditions d’utilisation supplémentaires de la version préliminaire ne s’appliquent pas. | | |
