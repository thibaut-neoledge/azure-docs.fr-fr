...
---
# <a name="use-the-storsimple-manager-service-to-view-jobs-for-the-storsimple-virtual-array"></a>Utiliser le service StorSimple Manager pour afficher les tâches liées au StorSimple Virtual Array
