<properties 
   pageTitle="FAQ sur les volumes StorSimple épinglés localement | Microsoft Azure"
...
## Questions sur la création d’un volume épinglé localement
...
## Questions sur la conversion d’un volume à plusieurs niveaux en volume épinglé localement
...
## Questions sur la restauration d’un volume épinglé localement
...
**A.** Oui, vous pouvez. Cependant, le volume épinglé localement sera par défaut cloné en tant que volume à plusieurs niveaux. Plus d’informations sur comment [cloner un volume épinglé localement](storsimple-clone-volume-u2)

## Questions sur le basculement d’un volume épinglé localement
...
Plus d’informations sur [le basculement et la récupération d’urgence de volumes épinglés localement en fonction des versions](storsimple-device-failover-disaster-recover.md#device-failover-across-software-versions)
