...
Microsoft Azure StorSimple Virtual Array est une solution de stockage intégrée qui gère les tâches de stockage entre un groupe virtuel local exécuté dans un hyperviseur et le stockage cloud Microsoft Azure. Le groupe virtuel est un serveur de fichiers ou une solution de serveur iSCSI efficace, abordable et facile à gérer qui élimine la plupart des problèmes et des frais liés à la protection des données et du stockage d’entreprise. Il est particulièrement adapté aux scénarios de bureaux distants (ROBO).

Cette rubrique fournit une vue d’ensemble du groupe virtuel. Voici d’autres ressources :
...
| Taille du volume |À plusieurs niveaux : de 500 Go à 5 To ; épinglé localement : de 50 Go à 500 Go |
