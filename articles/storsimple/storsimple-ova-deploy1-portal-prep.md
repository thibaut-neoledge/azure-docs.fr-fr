...
## <a name="step-3-download-the-virtual-device-image"></a>Étape 3 : Téléchargement de l'image de l’appareil virtuel
...
#### <a name="to-get-the-virtual-device-image"></a>Pour obtenir l'image de l’appareil virtuel
