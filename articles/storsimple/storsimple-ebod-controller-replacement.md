...
>[AZURE.IMPORTANT]Avant de retirer et de remplacer un contrôleur EBOD, passez en revue les informations de sécurité dans [Remplacement des composants matériels StorSimple](storsimple-hardware-component-replacement.md).
...
5. Notez le port SAS du module de contrôleur EBOD qui était connecté au contrôleur. Vous devrez restaurer le système dans cette configuration après le remplacement du module EBOD.
    ...
    >[AZURE.NOTE]En règle générale, il s’agit du Port A, qui est libellé **Entrée hôte (host in)** dans le diagramme suivant.
