...
# Application des mises à jour et des correctifs logiciels à StorSimple Virtual Array
...
N'oubliez pas que l'installation d'une mise à jour ou d'un correctif logiciel peut redémarrer votre appareil. Étant donné que StorSimple Virtual Array est un appareil à nœud unique, les E/S en cours seront interrompues et votre appareil subira des temps d'arrêt. Nous vous recommandons également de mettre les volumes ou les partages hors connexion sur l’ordinateur hôte puis l’appareil avant d’appliquer la mise à jour. Vous réduisez ainsi toute possibilité d’altération des données.
