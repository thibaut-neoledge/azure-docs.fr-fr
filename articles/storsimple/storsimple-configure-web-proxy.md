...
Le proxy web est désormais également activé. Vous pouvez ignorer l'étape d'[activation du proxy web](#enable-web-proxy) et passer directement à l'[affichage des paramètres du proxy web dans le Portail de gestion](#view-web-proxy-settings-in-the-management-portal).
