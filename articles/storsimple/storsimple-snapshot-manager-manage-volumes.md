...
### <a name="step-1-use-disk-management-to-create-a-dynamic-mirrored-volume"></a>Étape 1 : Utilisez la gestion des disques pour créer un volume dynamique en miroir
