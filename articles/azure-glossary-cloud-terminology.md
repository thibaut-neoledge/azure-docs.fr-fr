...
### <a name="availabilityset"></a>Groupe à haute disponibilité  
...
### <a name="classicmodel"></a>Modèle de déploiement Azure Classic  
...
### <a name="armmodel"></a>Modèle de déploiement Azure Resource Manager  
...
### <a name="georeplication"></a>Géo-réplication  
...
### <a name="loadbalancer"></a>Équilibreur de charge  
...
### <a name="resourcegroup"></a>Groupe de ressources  
...
### <a name="rmtemplate"></a>Modèle Azure Resource Manager  
...
### <a name="resourceprovider"></a>Fournisseur de ressources  
...
### <a name="storageaccount"></a>Compte de stockage  
...
### <a name="updatedomain"></a>Domaine de mise à jour  
...
### <a name="vmextension"></a>Extension de machine virtuelle  
