...
4. [Configuration du backend mobile pour l'envoi de demandes push]
5. [Mise à jour du serveur pour l'envoi de notifications push](#update-server)
6. [Publication du backend mobile sur Azure]
7. [Ajout de notifications push à l'application]
8. [Test de l'application]

Ce didacticiel requiert les éléments suivants :

+ [Kit de développement logiciel (SDK) App Service Mobile App iOS]
...
## Ajout des notifications push à votre application
...
[Configuration du backend mobile pour l'envoi de demandes push]: #configure
[Mise à jour du serveur pour l'envoi de notifications push]: #update-server
[Publication du backend mobile sur Azure]: #publish-mobile-service
...
[Kit de développement logiciel (SDK) App Service Mobile iOS]: https://go.microsoft.com/fwLink/p/?LinkID=266533
