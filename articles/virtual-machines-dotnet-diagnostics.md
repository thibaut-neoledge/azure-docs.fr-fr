<properties
	pageTitle="Utilisation des diagnostics Azure dans Virtual Machines | Microsoft Azure"
...
# Activation des diagnostics dans Azure Virtual Machines
...
1.	Sur votre ordinateur de développement, lancez Visual Studio 2013.
2.	Créez une nouvelle application console Visual C# qui cible .NET Framework 4.5. Nommez le projet « WadExampleVM ». ![CloudServices\_diag\_new\_project](./media/virtual-machines-dotnet-diagnostics/NewProject.png)
