...
## <a name="consistency-guarantees"></a>Garanties de cohérence
Le tableau suivant répertorie les différentes garanties de cohérence correspondant aux quatre niveaux de cohérence.

| Garantie | Remarque | Obsolescence limitée | session | Eventual (Éventuel) |
| --- | --- | --- | --- | --- |
...
> [!NOTE]
> La configuration du niveau de cohérence par défaut n’est pas prise en charge dans [l’émulateur Azure DocumentDB](documentdb-nosql-local-emulator.md). 
...
| Aucun |Choisir parmi Fort, Obsolescence limitée, Session et Éventuel |Non applicable |
