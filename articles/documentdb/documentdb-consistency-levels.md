...
**Éventuel** : ce niveau de cohérence est la forme de cohérence la plus faible où un client peut obtenir des valeurs plus anciennes que celles qu'il a pu voir précédemment. En l'absence d'autres écritures, les réplicas du groupe finiront par converger. La demande de lecture est servie par un index secondaire.  
