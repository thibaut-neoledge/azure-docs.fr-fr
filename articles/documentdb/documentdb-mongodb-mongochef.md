---
title: Utiliser MongoChef avec un compte DocumentDB prenant en charge le protocole MongoDB | Microsoft Docs
...
5. Dans la fenêtre **Nouvelle connexion**, sous l’onglet **SSL**, cochez la case **Use SSL protocol to connect** (Utiliser le protocole SSL pour se connecter) et cliquez sur la case d’option **Accept self-signed SSL certificates** (Accepter les certificats SSL auto-signés).
