...
### <a name="ordering-using-sql-with-filtering"></a>Classement à l'aide de SQL avec filtrage
...
### <a name="indexing-for-order-by-for-a-single-property"></a>Indexation pour la clause Order By d'une propriété unique
...
Order By n’est pas prise en charge actuellement pour les requêtes entre partitions en cas d’utilisation de l’Explorateur de requête dans le portail Azure.
