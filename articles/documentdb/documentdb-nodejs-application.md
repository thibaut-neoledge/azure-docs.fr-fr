...
4. Copiez le code suivant dans **docdbUtils.js**
   ...
   > 
   > Pour en savoir plus sur les types d’offre Azure Cosmos DB, reportez-vous aux [niveaux de performances d’Azure Cosmos DB](documentdb-performance-levels.md). 
   > 
   > 
