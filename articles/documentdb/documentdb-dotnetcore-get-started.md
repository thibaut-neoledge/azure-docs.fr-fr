...
---
# <a name="nosql-tutorial-build-a-documentdb-c-console-application-on-net-core"></a>Didacticiel NoSQL : générer une application de console C# DocumentDB sur .NET Core
...
Bienvenue dans le didacticiel NoSQL pour le Kit de développement logiciel (SDK) .NET Core d’Azure DocumentDB ! À la fin de ce didacticiel, vous disposerez d’une application console qui crée et interroge des ressources DocumentDB.
...
* [Visual Studio 2015 Update 3](https://go.microsoft.com/fwlink/?LinkId=691129) et [.NET Core 1.0.1 - VS 2015 Tooling Preview 2](https://go.microsoft.com/fwlink/?LinkID=827546)
