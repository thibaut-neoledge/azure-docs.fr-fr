<properties 
	pageTitle="Forum Aux Questions (FAQ) sur DocumentDB | Microsoft Azure" 
	description="Réponses aux questions du forum sur Azure DocumentDB, un service de base de données de documents NoSQL." 
	services="documentdb" 
	authors="mimig1" 
	manager="jhubbard" 
	editor="monicar" 
...
## Concepts de base de Microsoft Azure DocumentDB
...
Pour avoir des informations sur le déploiement et l'utilisation de ce service, consultez la [page de documentation de DocumentDB](http://azure.microsoft.com/documentation/services/documentdb/).
...
Si vous débutez avec Azure, vous pouvez vous inscrire pour bénéficier d’une [version d'évaluation gratuite d’Azure](https://azure.microsoft.com/fr-fr/pricing/free-trial/), qui vous offre 30 jours et 200 USD pour essayer tous les services Azure. Si vous possédez un abonnement MSDN, vous pouvez bénéficier de [150 USD de crédits Azure gratuits par mois](http://azure.microsoft.com/pricing/member-offers/msdn-benefits/?WT.mc_id=azurebg_US_sem_bing_BR_BRMSDN_Nontest_MSDN_msdnazure&WT.srch=1), à utiliser sur n'importe quel service Azure. Si vous souhaitez essayer gratuitement DocumentDB pendant 30 jours, sans utiliser votre carte de crédit, envoyez un message électronique à askdocdb@microsoft.com avec une ligne d'objet du Forum Aux Questions de Documentation, une version d'évaluation d’Azure et bénéficiez en retour d’un code promo (dans la limite des stocks disponibles).
...
## Développement avec Microsoft Azure DocumentDB
