...
#### [Présentation de la prise en charge des protocoles pour MongoDB](documentdb-protocol-mongodb.md)
...
### [Analyser des données en temps réel avec Azure Stream Analytics](../stream-analytics/stream-analytics-define-outputs.md#documentdb.md)
