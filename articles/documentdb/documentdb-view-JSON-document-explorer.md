...
Cet article fournit une vue d’ensemble de l’Explorateur de documents [Microsoft Azure DocumentDB](http://azure.microsoft.com/services/documentdb/), un outil du portail Azure en version préliminaire qui vous permet d’afficher, de modifier, de créer et de télécharger des documents JSON avec DocumentDB.
