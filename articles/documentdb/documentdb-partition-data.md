---
title: "Partitionnement et mise à l’échelle dans Azure DocumentDB | Microsoft Docs"
...
> [!NOTE]
> Afin d’optimiser le débit total de la collection, vous devez choisir une clé de partition qui vous permet de répartir uniformément les demandes entre plusieurs valeurs de clé de partition distinctes.
> 
> 
...
> [!TIP]
> Pour accélérer l’importation, envisagez de porter le nombre de demandes parallèles à 100 voire davantage, afin de tirer parti du débit plus élevé disponible pour les collections partitionnées. 
> 
> 
...
### <a name="partition-key-as-the-transaction-boundary"></a>Clé de partition en tant que limite de la transaction
