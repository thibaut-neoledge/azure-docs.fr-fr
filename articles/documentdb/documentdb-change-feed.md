...
![Utilisation du flux de modification d’Azure Cosmos DB pour alimenter les analyses en temps réel et les scénarios de calcul pilotés par les événements](./media/documentdb-change-feed/changefeed.png)
...
![Pipeline lambda Azure Cosmos DB pour l’ingestion et l’interrogation](./media/documentdb-change-feed/lambda.png)
...
![Utilisation de l’hôte du processus de flux de modification Azure Cosmos DB](./media/documentdb-change-feed/changefeedprocessor.png)
...
* Apprenez-en davantage sur [le modèle de ressources et la hiérarchie d’Azure DB](documentdb-resources.md).
