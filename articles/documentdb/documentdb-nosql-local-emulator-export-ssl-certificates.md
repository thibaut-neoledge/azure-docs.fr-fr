...
Les certificats de l’émulateur local Azure Cosmos DB sont générés lors de la première exécution de l’émulateur. Il existe deux certificats. L’un des deux est utilisé pour connecter l’émulateur local, l’autre pour gérer les clés secrètes au sein de l’émulateur. Le certificat à exporter est le certificat de connexion présentant le nom convivial « Azure Cosmos DBEmulatorCertificate ».
...
![Réinitialiser les données de l’émulateur local Azure Cosmos DB](./media/documentdb-nosql-local-emulator/azure-documentdb-database-local-emulator-reset-data.png)

## <a name="how-to-export-the-azure-cosmos-db-ssl-certificate"></a>Comment exporter le certificat SSL Azure Cosmos DB

1. Démarrez le gestionnaire de certificats Windows en exécutant certlm.msc et en accédant au dossier Personnel > Certificats, puis en ouvrant le certificat portant le nom convivial **Azure Cosmos DBEmulatorCertificate**.

    ![Étape 1 - Exporter dans l’émulateur local Azure Cosmos DB](./media/documentdb-nosql-local-emulator/azure-documentdb-database-local-emulator-export-step-1.png)

2. Cliquez sur **Détails**, puis sur **OK**.

    ![Étape 2 - Exporter dans l’émulateur local Azure Cosmos DB](./media/documentdb-nosql-local-emulator/azure-documentdb-database-local-emulator-export-step-2.png)

3. Cliquez sur **Copier dans un fichier...**.

    ![Étape 3 - Exporter dans l’émulateur local Azure Cosmos DB](./media/documentdb-nosql-local-emulator/azure-documentdb-database-local-emulator-export-step-3.png)

4. Cliquez sur **Suivant**.

    ![Étape 4 - Exporter dans l’émulateur local Azure Cosmos DB](./media/documentdb-nosql-local-emulator/azure-documentdb-database-local-emulator-export-step-4.png)

5. Cliquez sur l’option de **refus d’exportation de la clé privée**, puis sur **Suivant**.

    ![Étape 5 - Exporter dans l’émulateur local Azure Cosmos DB](./media/documentdb-nosql-local-emulator/azure-documentdb-database-local-emulator-export-step-5.png)

6. Cliquez sur **X.509 encodé en base 64 (.cer)**, puis sur **Suivant**.

    ![Étape 6 - Exporter dans l’émulateur local Azure Cosmos DB](./media/documentdb-nosql-local-emulator/azure-documentdb-database-local-emulator-export-step-6.png)

7. Attribuez un nom au certificat. Ici, cliquez sur **documentdbemulatorcert**, puis sur **Suivant**.

    ![Étape 7 - Exporter dans l’émulateur local Azure Cosmos DB](./media/documentdb-nosql-local-emulator/azure-documentdb-database-local-emulator-export-step-7.png)

8. Cliquez sur **Terminer**.

    ![Étape 8 - Exporter dans l’émulateur local Azure Cosmos DB](./media/documentdb-nosql-local-emulator/azure-documentdb-database-local-emulator-export-step-8.png)
...
> [Diffusion mondiale](../documentdb/documentdb-distribute-data-globally.md) 
