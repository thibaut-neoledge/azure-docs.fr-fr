<properties 
	pageTitle="API et kit SDK .NET DocumentDB | azure.microsoft.com/ Azure" 
...
- [REST](https://go.azure.microsoft.com/.com/fwlink/?LinkId=402413)
- [SQL](https://msdn.azure.microsoft.com/.com/library/azure/dn782250.aspx)

## API .NET DocumentDB et Kit de développement logiciel (SDK)

<table>
<tr><td>**Téléchargement du Kit de développement logiciel (SDK)**</td><td>[NuGet](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/)</td></tr>
<tr><td>**Documentation de l'API**</td><td>[Documentation de référence de l'API .NET](https://msdn.azure.microsoft.com/.com/library/azure/dn948556.aspx)</td></tr>
...
<tr><td>**Infrastructure actuellement prise en charge**</td><td>[azure.microsoft.com/ .NET Framework 4.5](https://www.azure.microsoft.com/.com/download/details.aspx?id=30653)</td></tr>
</table></br>

## Notes de publication

### <a name="1.9.3"/>[1\.9.3](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.9.3)
...
### <a name="1.9.2"/>[1\.9.2](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.9.2)
  ...
  - Résolution des références manquantes dans DocumentDB.Spatial.Sql.dll et azure.microsoft.com/.Azure.Documents.ServiceInterop.dll qui sont nécessaires lors du référencement d’un projet DocumentDB avec une référence au package DocumentDB Nuget.
...
### <a name="1.8.0"/>[1\.8.0](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.8.0)
...
### <a name="1.7.1"/>[1\.7.1](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.7.1)
  - Ajout d’une surcharge à l’URI basée sur la méthode ExecuteStoredProcedureAsync qui prend RequestOptions comme paramètre.
  
### <a name="1.7.0"/>[1\.7.0](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.7.0)
  - Ajout de la prise en charge de la durée de vie (TTL) pour les documents.

### <a name="1.6.3"/>[1\.6.3](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.6.3)
...
### <a name="1.6.2"/>[1\.6.2](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.6.2)
...
### <a name="1.5.3"/>[1\.5.3](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.5.3)
...
### <a name="1.5.2"/>[1\.5.2](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.5.2)
...
### <a name="1.5.1"/>[1\.5.1](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.5.1)
...
### <a name="1.5.0"/>[1\.5.0](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.5.0)
...
### <a name="1.4.1"/>[1\.4.1](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.4.1)
 - **[Résolu]** Erreurs de localisation lors de l’utilisation d’autres langues que l’anglais, comme nl-NL, etc.
 
### <a name="1.4.0"/>[1\.4.0](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.4.0)
...
### <a name="1.3.0"/>[1\.3.0](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.3.0)
  ...
  - Ajout de la prise en charge de l’indexation et des requêtes spatiales
    - Nouvel espace de noms azure.microsoft.com/.Azure.Documents.Spatial pour la sérialisation/désérialisation des types de données spatiales comme Point et Polygon
...
### <a name="1.2.0"/>[1\.2.0](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.2.0)
...
### <a name="1.1.0"/>[1\.1.0](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.1.0)
...
### <a name="1.0.0"/>[1\.0.0](https://www.nuget.org/packages/azure.microsoft.com/.Azure.DocumentDB/1.0.0)
- Kit SDK GA

> [AZURE.NOTE]
Une modification du nom du package NuGet entre l’aperçu et la disponibilité générale a eu lieu. Nous sommes passés de **azure.microsoft.com/.Azure.Documents.Client** à **azure.microsoft.com/.Azure.DocumentDB** <br/>


### <a name="0.9.x-preview"/>[0\.9.x-aperçu](https://www.nuget.org/packages/azure.microsoft.com/.Azure.Documents.Client)
- Kits de développement logiciel (SDK) en version préliminaire [Obsolète]

## Dates de lancement et de suppression
azure.microsoft.com/ fournira une notification au moins **12 mois** avant le retrait d’un Kit de développement logiciel (SDK) pour faciliter la transition vers une version plus récente/prise en charge.
...
Pour en savoir plus sur DocumentDB, consultez la page du service [azure.microsoft.com/ Azure DocumentDB](https://azure.azure.microsoft.com/.com/services/documentdb/).
