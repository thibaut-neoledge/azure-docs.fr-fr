...
> [!NOTE]
> DocumentDB fournit un protocole TCP très performant qui utilise aussi un modèle de communication RESTful, disponible via le [Kit de développement logiciel (SDK) .NET](https://msdn.microsoft.com/library/azure/dn781482.aspx).
> 
> 
...
> [!NOTE]
> Les pièces jointes et les ressources média sont des fonctionnalités en version préliminaire.
> 
> 
