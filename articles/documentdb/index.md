---
title: "Documentation Azure DocumentDB - Didacticiels, informations de référence sur les API | Microsoft Docs"
description: "Découvrez comment utiliser DocumentDB, un service de bases de données de documents NoSQL sans schéma. Des didacticiels illustrent l’intégration à des applications et l’utilisation de requêtes SQL sur des documents JSON."
services: documentdb
author: carolz
manager: carolz
layout: LandingPage
...
Découvrez comment utiliser DocumentDB dans des applications hautes performances pour le web, les mobiles, les jeux et l’Internet des objets (IoT). Des didacticiels et des documents vous montrent comment stocker des données JSON et effectuer des requêtes SQL sur un schéma flexible dans ce service de base de données NoSQL.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>En savoir plus sur Azure DocumentDB</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bibliothèque vidéo Azure DocumentDB</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prise en main d’Azure DocumentDB</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bien démarrer avec DocumentDB en utilisant .NET</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bien démarrer avec DocumentDB en utilisant Node.js</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bien démarrer avec DocumentDB en utilisant une application web Python Flask</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/rest/api/documentdbresourceprovider/">API REST des fournisseurs de ressources</a></p>
                    </div>
                </div>
            </div>
        </div>
