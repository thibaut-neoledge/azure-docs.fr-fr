...
3. Ouvrez l’application **Administrateur de sources de données ODBC** sur votre ordinateur ; pour cela, tapez **Sources de données ODBC** dans la fenêtre de recherche Windows. 
    ...
    ![Administrateur de sources de données ODBC Azure Cosmos DB](./media/documentdb-nosql-odbc-driver/documentdb-nosql-odbc-driver.png)
...
3. Dans la fenêtre **Azure Cosmos DB ODBC Driver SDN Setup (Configuration DSN du pilote ODBC Azure Cosmos DB)**, répondez aux questions suivantes : 
    ...
    ![Fenêtre de configuration DSN du pilote ODBC Azure Cosmos DB](./media/documentdb-nosql-odbc-driver/documentdb-nosql-odbc-driver-dsn-setup.png)
    ...
    ![Panneau Azure Cosmos DB Keys (Clés Azure Cosmos DB)](./media/documentdb-nosql-odbc-driver/documentdb-nosql-odbc-driver-keys.png)
...
6. Une fois que vous avez terminé et fermé la fenêtre de **configuration DSN du pilote ODBC Azure Cosmos DB**, le DSN du nouvel utilisateur est ajouté à l’onglet DSN utilisateur.
    ...
    ![Nouveau DSN ODBC Azure Cosmos DB dans l’onglet DSN utilisateur](./media/documentdb-nosql-odbc-driver/documentdb-nosql-odbc-driver-user-dsn.png)
...
1. Après avoir terminé les étapes 1 à 4 de la rubrique [Se connecter à votre base de données Azure Cosmos DB](#connect), cliquez sur **Éditeur de schéma** dans la fenêtre de **configuration DSN du pilote ODBC Azure Cosmos DB**.
    ...
    ![Bouton Éditeur de schéma dans la fenêtre de configuration du DSN du pilote ODBC Azure Cosmos DB](./media/documentdb-nosql-odbc-driver/documentdb-nosql-odbc-driver-schema-editor.png)
...
Pour en savoir plus sur Azure Cosmos DB, consultez [Bienvenue dans Azure Cosmos DB](documentdb-introduction.md).
