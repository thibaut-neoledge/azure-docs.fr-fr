---
title: "Explorateur de requêtes DocumentDB : Un éditeur de requête SQL | Microsoft Docs"
...
---
# <a name="write-edit-and-run-sql-queries-for-documentdb-using-query-explorer"></a>Écrire, modifier et exécuter des requêtes SQL pour DocumentDB à l’aide de l’Explorateur de requêtes
