...
## <a id="Config"></a>Étape 3 : copier les détails de la connexion à partir du Portail Azure pour votre base de données DocumentDB
...
## <a id="QueryDB"></a>Étape 7 : interroger les ressources DocumentDB
