<properties 
	pageTitle="Création d’une machine virtuelle Windows avec le Gestionnaire de ressources Azure et PowerShell" 
...
# Création d’une machine virtuelle Windows avec le Gestionnaire de ressources Azure et PowerShell
...
Ensuite, vous devez basculer le mode d'Azure PowerShell sur le Gestionnaire de ressources. Exécutez cette commande.
