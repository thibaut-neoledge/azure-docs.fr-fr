...
3. Dans la boîte de dialogue **Ajouter un service connecté**, choisissez **Azure Storage**, puis choisissez le bouton **Configurer**. Si vous n’êtes pas encore connecté à Azure, vous serez invité à le faire.
   
    ![Boîte de dialogue Ajouter des services connectés - Stockage](./media/vs-azure-tools-connected-services-storage/IC796703.png)
4. Dans la boîte de dialogue **Azure Storage**, sélectionnez un compte de stockage existant, puis sélectionnez **Ajouter**.
