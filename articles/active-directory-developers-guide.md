...
1. **[Intégration avec Azure AD](active-directory-how-to-integrate.md)** : découvrez pourquoi l’intégration avec Active Directory Azure offre la meilleure solution pour une connexion et une autorisation sécurisées.
...
#### Vidéos
Si vous préférez utiliser des vidéos, consultez ces présentations sur le développement d’applications avec Azure Active Directory. Elles mettent généralement en scène des intervenants qui travaillent directement au sein de l’équipe d’ingénierie et passent en revue étape par étape des sujets fondamentaux comme IDMaaS, l’authentification, la fédération d’identité et l’authentification unique.
