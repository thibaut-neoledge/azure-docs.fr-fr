...
Azure propose plusieurs manières d’héberger des sites web : [Azure App Service][], [Azure Cloud Services][] et [Azure Virtual Machines][]. Cet article vous aidera à comprendre ces différentes possibilités et à faire le bon choix en fonction de votre application web.
...
En outre, Azure App Service dispose d’une nouvelle fonctionnalité en version préliminaire pour les API REST : API Apps. Pour plus d’informations sur API Apps, consultez la rubrique [Que sont les applications API ?](app-service-api-apps-why-best-platform.md).
...
* [Sites Web Azure](/documentation/services/app-service/)
