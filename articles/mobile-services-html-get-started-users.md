...
>[AZURE.NOTE]La connexion étant opérée dans une fenêtre contextuelle, vous devez appeler la méthode <strong>login</strong> à partir de l'événement Click du bouton. Sinon, certains navigateurs suppriment la fenêtre de connexion.
...
[Guide de fonctionnement de Mobile Services avec HTML/JavaScript]: /documentation/articles/mobile-services-html-how-to-use-client-library
