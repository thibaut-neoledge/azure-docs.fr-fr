...
Ce guide vous présente le service Azure Automation et la manière de l'utiliser pour gérer plus simplement vos machines virtuelles Azure.
...
## Comment Azure Automation peut-il aider à gérer des machines virtuelles Azure ?

Des machines virtuelles peuvent être gérées dans Azure Automation à l'aide des applets de commande PowerShell qui sont disponibles dans les [outils Azure PowerShell](https://msdn.microsoft.com/library/azure/jj156055.aspx). Azure Automation dispose dès le départ de ces applets de commande PowerShell pour machines virtuelles, de sorte que vous pouvez effectuer toutes vos tâches de gestion de machines virtuelles au sein du service. Dans Azure Automation, vous pouvez également associer ces applets de commande à des applets de commande d'autres services Azure, afin d'automatiser des tâches complexes entre des services Azure et des systèmes tiers.


## Étapes suivantes

Maintenant que vous avez appris les bases d'Azure Automation et la manière de l'utiliser pour gérer les machines virtuelles Azure, cliquez sur ces liens pour en savoir plus sur Azure Automation.

Consultez le [didacticiel de prise en main d'Azure Automation](automation-create-runbook-from-samples.md)
