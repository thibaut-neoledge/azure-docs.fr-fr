...
Pour plus d’informations sur les plans App Service, consultez les pages [Qu’est-ce qu’un plan App Service ?](web-sites-web-hosting-plan-overview.md) et [Présentation approfondie des plans Azure App Service](azure-web-sites-web-hosting-plans-in-depth-overview.md). Pour plus d’informations sur la tarification et les fonctionnalités de chaque plan App Service, consultez la page [Détails sur la tarification d’App Service](/pricing/details/web-sites/).
