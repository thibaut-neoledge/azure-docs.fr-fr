<properties pageTitle="Autorisation c&ocirc;t&eacute; service (Android) | Centre de d&eacute;veloppement mobile" metaKeywords="" description="Apprenez &agrave; autoriser les utilisateurs dans le service principal .NET d'Azure Mobile Services." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Autorisation c&ocirc;t&eacute; service des utilisateurs Mobile Services" authors="glenga" solutions="" manager="dwrede" editor="" />
...
-   [Guide de fonctionnement Mobile Services Android][Guide de fonctionnement Mobile Services Android]
...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [Guide de fonctionnement Mobile Services Android]: /fr-fr/documentation/articles/mobile-services-android-how-to-use-client-library/
