...
3. Vérifiez que la passerelle a bien été supprimée à l’aide de l’applet de commande **Get-AzureRmApplicationGateway**.
...
Pour vérifier que le service a bien été supprimé, vous pouvez utiliser l’applet de commande **Get-AzureRmApplicationGateway**. Cette étape n'est pas requise.
