---
title: Créer une sonde personnalisée pour la plateforme d’application à l’aide du portail | Microsoft Docs
...
> [!IMPORTANT]
> le nom d’hôte n’est pas le nom du serveur. Il s’agit du nom de l’hôte virtuel en cours d’exécution sur le serveur d’application. La sonde est envoyée à http://(host name):(port from httpsetting)/urlPath
> 
> 
