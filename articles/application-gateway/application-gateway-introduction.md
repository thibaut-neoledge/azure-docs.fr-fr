...
---
# <a name="application-gateway-overview"></a>Vue d’ensemble d’Application Gateway
...
> [!NOTE]
> Ces valeurs sont des valeurs approximatives pour un débit de passerelle d’application. Le débit réel dépend de divers détails d’environnement, tels que la taille de page moyenne, l’emplacement des instances de serveur principal et le temps de traitement d’une page par le serveur. Pour connaître le nombre de performances exact, vous devez exécuter vos propres tests, ces valeurs sont fournies uniquement pour des conseils de planification de capacité.
>
>
