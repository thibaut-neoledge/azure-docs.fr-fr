<properties
   pageTitle="Activation d’une stratégie SSL de bout en bout sur la passerelle Application Gateway | Microsoft Azure"
...
# Activation d’une stratégie SSL de bout en bout sur la passerelle Application Gateway
...
## Chiffrement SSL de bout en bout et liste blanche de certificats
...
## Stratégie SSL de la passerelle Application Gateway
...
2. La définition de la stratégie SSL vous permet de désactiver les 3 protocoles suivants : TLSv1_0, TLSv1_1, TLSv1\_2.
3. Si aucune stratégie SSL n’est définie, les trois protocoles (TLSv1_0, TLSv1_1, TLSv1\_2) sont activés.
