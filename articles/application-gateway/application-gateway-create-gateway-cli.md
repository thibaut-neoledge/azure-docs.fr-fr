...
>[REMARQUE] Vous pouvez également utiliser `az login` sans le switch destiné à la connexion de l’appareil et qui nécessite la saisie d’un code sur aka.ms/devicelogin.
