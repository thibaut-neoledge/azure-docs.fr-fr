...
---
title: Création d’une passerelle d’application à l’aide du modèle Azure Resource Manager | Microsoft Docs
...
1. Vérifiez le contenu sous **resources** et notez les éléments suivants :
...
2. Revenez à [https://github.com/Azure/azure-quickstart-templates/blob/master/101-application-gateway-create/](https://github.com/Azure/azure-quickstart-templates/blob/master/101-application-gateway-create).
3. Cliquez sur **azuredeploy-paremeters.json**, puis cliquez sur **RAW**.
4. Enregistrez le fichier dans un dossier local sur votre ordinateur.
5. Ouvrez le fichier que vous avez enregistré et modifiez les valeurs des paramètres. Utilisez les valeurs suivantes pour déployer la passerelle Application Gateway décrite dans notre scénario.
...
6. Enregistrez le fichier . Vous pouvez tester le modèle JSON et le modèle de paramètres à l’aide des outils de validation JSON en ligne comme [JSlint.com](http://www.jslint.com/).
