<properties title="Search Service: workflow for developers" pageTitle="Service de recherche : flux de travail pour les développeurs" description="Search Service: workflow for developers" metaKeywords="" services="" solutions="" documentationCenter="" authors="Heidist" manager="mblythe" videoId="" scriptId="" />
