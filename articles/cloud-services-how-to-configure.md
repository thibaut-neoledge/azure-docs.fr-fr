<properties urlDisplayName="How to configure" pageTitle="Configuration d'un service cloud - Azure" metaKeywords="Configuring cloud services" description="D&eacute;couvrez comment configurer des services cloud dans Azure. Apprenez &agrave; mettre &agrave; jour la configuration d'un service cloud et &agrave; configurer l'acc&egrave;s distant aux instances de r&ocirc;le." metaCanonical="" services="cloud-services" documentationCenter="" title="Configuration des services cloud" authors="davidmu" solutions="" manager="timlt" editor="" />
...
-   [Mise à jour de la configuration d'un service cloud][Mise à jour de la configuration d'un service cloud]
-   [Configuration de l'accès à distance aux instances de rôle][Configuration de l'accès à distance aux instances de rôle]

## <span id="update"></span></a> Mise à jour de la configuration d'un service cloud

1.  Dans le [portail de gestion Azure][portail de gestion Azure], cliquez sur **Cloud Services**, cliquez sur le nom du service cloud, puis cliquez sur **Configurer**.
...
2.  Après la mise à jour du fichier de configuration de service, téléchargez et appliquez les mises à jour de la configuration :
    ...
    a. Sur la page **Configurer**, cliquez sur **Télécharger**.

    ![Télécharger une configuration][Télécharger une configuration]
...
2.  Cliquez sur **Distant**.
    ...
    ![Services cloud à distance][Services cloud à distance]

    **Avertissement :** toutes les instances de rôle sont redémarrées lorsque vous activez pour la première fois le Bureau à distance et cliquez sur OK (coche). Pour éviter un redémarrage, le certificat utilisé pour chiffrer le mot de passe doit être installé sur le rôle.

    Pour éviter un redémarrage, installez un certificat, puis revenez dans cette boîte de dialogue (pour plus d'informations, consultez la page [Utilisation du Bureau à distance avec des rôles Azure][Utilisation du Bureau à distance avec des rôles Azure]). Si vous choisissez un certificat existant, une mise à jour de la configuration sera envoyée à toutes les instances dans le rôle.
