---
title: "Commencez par exécuter l’Assistant Activer la base de données pour Stretch | Microsoft Docs"
...
---
# <a name="get-started-by-running-the-enable-database-for-stretch-wizard"></a>Commencez par exécuter l’Assistant Activer la base de données pour Stretch
...
2. Cliquez avec le bouton droit et sélectionnez **Tâches**, puis sélectionnez **Stretch** et **Activer** pour lancer l’Assistant.

## <a name="a-nameintroaintroduction"></a><a name="Intro"></a>Introduction
...
## <a name="a-nametablesaselect-tables"></a><a name="Tables"></a>Sélectionner des tables
...
## <a name="a-namefilteraoptionally-provide-a-row-filter"></a><a name="Filter"></a>Fournir un filtre de ligne (facultatif)
...
## <a name="a-nameconfigureaconfigure-azure-deployment"></a><a name="Configure"></a>Configurer un déploiement Azure
...
## <a name="a-namecredentialsasecure-credentials"></a><a name="Credentials"></a>Informations d’identification sécurisées
...
## <a name="a-namenetworkaselect-ip-address"></a><a name="Network"></a>Sélectionner l’adresse IP
...
## <a name="a-namesummaryasummary"></a><a name="Summary"></a>Résumé
...
## <a name="a-nameresultsaresults"></a><a name="Results"></a>Résultats
...
## <a name="a-nameknownissuesatroubleshooting-the-wizard"></a><a name="KnownIssues"></a>Dépannage de l’Assistant
