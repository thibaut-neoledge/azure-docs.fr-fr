...
Une fois Stretch Database activée pour une instance SQL Server, une base de données et au moins une table, elle commence à migrer vos données brutes en mode silencieux vers Azure.
