...
## <a name="a-nameenablewizardtableause-the-wizard-to-enable-stretch-database-on-a-table"></a><a name="EnableWizardTable"></a>Utiliser l’Assistant pour activer Stretch Database sur une table
**Lancer l’Assistant**
...
2. Cliquez avec le bouton droit et sélectionnez **Stretch**, puis **Activer** pour lancer l’Assistant.
...
## <a name="a-nameenabletsqltableause-transact-sql-to-enable-stretch-database-on-a-table"></a><a name="EnableTSQLTable"></a>Utiliser Transact\-SQL pour activer Stretch Database sur une table
...
### <a name="create-a-new-table-with-stretch-database-enabled"></a>Créer une table avec Stretch Database activé
