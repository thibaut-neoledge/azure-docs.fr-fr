---
title: Découvrez Data Lake Analytics et U-SQL en utilisant les didacticiels interactifs du portail Azure | Microsoft Docs
...
> [!NOTE]
> Si vous souhaitez suivre ce même didacticiel à l'aide de Visual Studio, consultez [Analyser les journaux des sites web à l'aide de Data Lake Analytics](data-lake-analytics-analyze-weblogs.md). D'autres didacticiels interactifs à ajouter au portail.
> 
> 
...
7. Tapez ou sélectionnez les valeurs suivantes :
...
6. Cliquez sur **1 Introduction**, puis suivez les instructions.
