...
---
# <a name="tutorial-analyze-website-logs-using-azure-data-lake-analytics"></a>Didacticiel : Analyser les journaux des sites web à l'aide d'Azure Data Lake Analytics
...
> [!NOTE]
> Vous ne pouvez pas lire ou écrire dans une table U-SQL qui a été créée ou modifiée dans le même script.  C'est pourquoi nous utilisons deux scripts pour cet exemple.
>
>
