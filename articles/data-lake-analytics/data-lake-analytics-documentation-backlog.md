<properties
   pageTitle="Backlog de la documentation Azure Data Lake Analytics | Microsoft Azure"
...
Nous continuerons d’alimenter la nouvelle documentation pour accompagner Azure Data Lake Analytics au fur et à mesure de son évolution et pour attirer l'attention sur les options et les cas d’utilisation courants. Cette page répertorie la documentation que nous avons planifiée. Vous pouvez nous faire savoir sur quel sujet vous aimeriez que nous portions notre attention en ajoutant un commentaire à cet article, en envoyant une requête de tirage dans GitHub ou en nous envoyant un e-mail.

## Backlog de la documentation

Domaine |Rubrique | Priorité | État | Affecté à | Demandé par 
------------- | ------------- | -------------- | -------------- | --------------- | --------------
de diffusion en continu | Refonte du contenu | 1 | En cours de traitement | [@edmacauley](https://github.com/edmacauley) |
...
de diffusion en continu | Interaction avec Curl | 3 |Pending |[@mumian](https://github.com/mumian)
...
de diffusion en continu | Sécurisation des travaux, données et tables dans Data Lake Analytics |1| en cours | [@mumian](https://github.com/mumian) | [@MikeRys](https://github.com/mikerys)
de diffusion en continu | Déplacement de la sortie d’un travail vers SQL Data Warehouse à l’aide de Data Factory |1 | en cours | [@mumian](https://github.com/mumian) | 
...
## Documents terminés du backlog

Domaine |Rubrique | location
------------- | ------------- | -------------- 
de diffusion en continu | Coordination du déploiement de Data Lake Analytics avec d’autres services Azure à l’aide de modèles ARM | [location](data-lake-analytics-manage-use-powershell.md)
