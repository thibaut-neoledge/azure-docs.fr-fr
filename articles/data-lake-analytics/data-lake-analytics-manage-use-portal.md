---
title: Gestion d'Azure Data Lake Analytics à l'aide du portail Azure | Microsoft Docs
...
Le fait de supprimer un compte Analytics ne supprime pas le compte Data Lake Store dépendant. Pour obtenir des instructions sur la suppression de comptes de stockage Data Lake, consultez [Supprimer un compte Data Lake Store](../data-lake-store/data-lake-store-get-started-portal.md#delete-azure-data-lake-store-account).
