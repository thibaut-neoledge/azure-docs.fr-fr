...
2. Préparer les données source. Les travaux Data Lake Analytics peuvent lire les données depuis les comptes Azure Data Lake Store ou les comptes de stockage d'objets Blob Azure.   
