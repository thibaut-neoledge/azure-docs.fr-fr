<properties
   pageTitle="Afficher l'historique des modifications d'un profil Traffic Manager"
   description="Cet article vous permettra d'afficher l'historique des modifications de votre profil Traffic Manager."
