<properties title="How to debug with events" pageTitle="Débogage avec des événements" description="Learn how to see events in Azure." authors="hanikn" manager="kamrani" />
