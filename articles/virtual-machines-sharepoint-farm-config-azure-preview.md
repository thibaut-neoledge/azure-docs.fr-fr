<properties title="Informations de configuration de la batterie de serveurs SharePoint" pageTitle="Informations de configuration de la batterie de serveurs SharePoint" description="D&eacute;crit la configuration par d&eacute;faut des batteries de serveurs&nbsp;SharePoint" metaKeywords="" services="virtual-machines" solutions="" documentationCenter="" authors="josephd" videoId="" scriptId="" manager="timlt"/>
