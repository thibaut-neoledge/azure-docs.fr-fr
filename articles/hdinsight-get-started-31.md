...
4.  Dans l'onglet Détails du cluster, entrez ou sélectionnez les valeurs suivantes :
    ...
    | **Version de HDInsight** | Choisissez **3.1** pour créer un cluster Hadoop 2.4 dans HDInsight.                                                                                                                                                                                                                                                 |
...
**Ouverture d'un tableau de bord de cluster HDInsight**
...
4.  Cliquez sur **GÉRER LE CLUSTER** en bas de page pour ouvrir le tableau de bord du cluster HDInsight. Une page web s'ouvre dans un autre onglet du navigateur.
...
1.  Dans le tableau de bord du cluster HDInsight, en haut, cliquez sur **Éditeur Hive**.
...
1.  Dans le tableau de bord du cluster HDInsight, en haut, cliquez sur **Fichiers**.
