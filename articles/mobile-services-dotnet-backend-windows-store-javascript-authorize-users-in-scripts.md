<properties pageTitle="Autorisation côté service (Windows Store) | Centre de développement mobile" description="Apprenez à autoriser les utilisateurs dans le service principal .NET d'Azure Mobile Services." services="" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
...
* [Comment utiliser un client HTML/JavaScript pour Azure Mobile Services]
...
[Comment utiliser un client HTML/JavaScript pour Azure Mobile Services]: /fr-fr/documentation/articles/mobile-services-html-how-to-use-client-library
