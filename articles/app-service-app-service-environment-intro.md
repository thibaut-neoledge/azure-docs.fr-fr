...
## Vue d'ensemble ##
Un environnement App Service est une option de plan de service [Premium][PremiumTier] d'Azure App Service qui fournit un environnement totalement isolé et dédié pour l'exécution sécurisée de toutes vos applications. Cela inclut les fonctionnalités [Applications web][WebApps], [Applications mobiles][MobileApps], [Applications Api][APIApps] et [Applications logique][LogicApps] avec des options de mise à l'échelle étendues.
