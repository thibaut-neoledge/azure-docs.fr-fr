<properties 
	pageTitle="Sites Web Python avec Bottle - Didacticiel Azure" 
...
Pour Git, nous vous recommandons les versions [Git pour Windows](http://msysgit.github.io/) ou [GitHub pour Windows](https://windows.github.com/).  Si vous utilisez Visual Studio, vous pouvez utiliser la prise en charge de Git intégré.
...
Une fenêtre répertoriant les applications disponibles dans la galerie apparaît. Cliquez sur la catégorie **INFRASTRUCTURES D'APPLICATIONS**située sur le côté gauche, et sélectionnez **Bottle**.
...
La configuration du site s'effectue très rapidement. Cliquez sur le bouton **PARCOURIR** situé en bas de la barre d'outils pour découvrir votre nouvelle application Bottle s'exécutant sur Azure.

![](./media/web-sites-python-create-deploy-bottle-app/portal-website-bottle.png)
 
Vous ajouterez ensuite la prise en charge de la publication via Git.  Pour ce faire, choisissez **Configurer le déploiement à partir du contrôle de code source**.
...
Votre application peut comporter des dépendances au-delà de Python et Bottle.
...
Suivez ces liens pour en savoir plus sur Bottle et Python Tools pour Visual Studio : 
...
- [Bottle et le stockage de tables Azure sur Azure avec Python Tools 2.1 pour Visual Studio][]


<!--Link references-->
[Bottle et MongoDB sur Azure avec Python Tools 2.1 pour Visual Studio]: ../web-sites-python-ptvs-bottle-table-storage
[Bottle et le stockage de tables Azure sur Azure avec Python Tools 2.1 pour Visual Studio]: ../web-sites-python-ptvs-bottle-mongodb
