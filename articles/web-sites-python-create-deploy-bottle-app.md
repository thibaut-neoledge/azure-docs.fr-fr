...
Le portail affiche une fenêtre répertoriant les applications disponibles dans la galerie. Cliquez sur la catégorie **INFRASTRUCTURES D'APPLICATION**, présente sur la gauche, puis sélectionnez **Bottle**.
...
Le site est configuré rapidement. Vous pouvez cliquer sur le bouton **PARCOURIR** de la barre d'outils inférieure pour découvrir votre nouvelle application Bottle s'exécutant sur Azure.

![](./media/web-sites-python-create-deploy-bottle-app/portal-website-bottle.png)
 
Ensuite, vous allez ajouter la prise en charge de la publication via Git.  Pour cela, sélectionnez **Configurer le déploiement à partir du contrôle de code source**.
...
<!--Link references-->
[Bottle et MongoDB sur Azure avec Python Tools 2.1 pour Visual Studio]: web-sites-python-ptvs-bottle-table-storage.md
[Bottle et stockage de tables Azure sur Azure avec Python Tools 2.1 pour Visual Studio]: web-sites-python-ptvs-bottle-mongodb.md
