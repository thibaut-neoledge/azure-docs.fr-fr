<properties 
	pageTitle="Protection de votre contenu" 
	description="Cette rubrique présente une vue d’ensemble de la protection de votre contenu avec Media Services." 
	authors="Juliako" 
	manager="dwrede" 
	editor="" 
...
Azure Media Services vous permet de sécuriser votre contenu multimédia dès lors qu’il quitte votre ordinateur via le stockage, le traitement et la remise. Lorsque vous travaillez avec Media Services, un des scénarios les plus courants est :

###protection du contenu stocké et diffusion du contenu multimédia chiffré dynamiquement en continu  
...
Cette rubrique présente une vue d’ensemble des principaux [concepts](media-services-protecting-content-overview.md#concepts) et des liens vers les rubriques expliquant comment effectuer les [tâches](media-services-protecting-content-overview.md#tasks) liées à la distribution de contenu.
