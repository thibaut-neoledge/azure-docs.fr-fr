<properties 
	pageTitle="Configuration de Tomcat7 sur une machine virtuelle Linux avec Microsoft Azure" 
...
Si vous avez installé open-jdk, vous devez voir un message semblable au suivant :
![][14] 

Si vous avez installé oracle-jdk, vous devez voir un message semblable au suivant :
![][15] 
...
Pour vérifier que tomcat7 est correctement installé, recherchez le nom DNS de votre serveur tomcat (http://tomcatexample.cloudapp.net/ is the example URL in this article). Si vous voyez une page similaire à celle-ci, tomcat7 est correctement installé.
![][16] 
