<properties pageTitle="Prise en main des concentrateurs de notifications Push à l'aide du runtime .NET dans Mobile Services" metaKeywords="" description="Découvrez comment utiliser les services mobiles d'exécution Microsoft Azure .Net et Notification Hubs pour envoyer des notifications Push à votre application Windows Phone." metaCanonical="" services="mobile-services,notification-hubs" documentationCenter="Mobile" title="Get started with push notifications in Mobile Services" authors="wesmc"  solutions="" writer="wesmc" manager="dwrede" editor=""  />
