...
7. Sur la page **Nouveau jeton d’accès personnel** entrez une **Description du jeton**, acceptez les éléments par défaut dans le **Choix des étendues**, puis sélectionnez **Générer le jeton**.
...
3. Pour afficher l’URL de clonage, sélectionnez sur la page **Code** du projet l’option **Cloner**.
...
5. Dans le panneau **Configuration** du laboratoire, sélectionnez le **Dépôts d’artefacts**.
