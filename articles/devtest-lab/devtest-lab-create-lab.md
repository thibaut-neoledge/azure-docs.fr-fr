...
3. Dans le panneau **Laboratoires de test et développement**, sélectionnez **Ajouter**.
...
4. Dans le panneau **Créer un laboratoire de test et développement** :
   ...
   5. Sélectionnez le **Type de stockage** pour indiquer le type de disque de stockage pour les machines virtuelles du laboratoire.
