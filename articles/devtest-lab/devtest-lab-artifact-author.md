<properties 
	pageTitle="Créez des artefacts personnalisés pour vos machines virtuelles DevTest Lab | Microsoft Azure"
...
1. Stockage de l'artefact dans un référentiel git
	...
	![Exemple de référentiel git d'artefacts](./media/devtest-lab-artifact-author/git-repo.png)

1. Ajoutez le référentiel d'artefacts au laboratoire, reportez-vous à l'article [Ajouter un référentiel d'artefacts Git à votre laboratoire DevTest](devtest-lab-add-artifact-repo.md).

## Étapes suivantes

Découvrez comment [ajouter un référentiel d'artefacts Git à votre laboratoire DevTest](devtest-lab-add-artifact-repo.md).
