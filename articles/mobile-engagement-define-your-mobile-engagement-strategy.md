...
Les `erreurs` peuvent également être analysées pour savoir si les utilisateurs rencontrent des problèmes dans votre application. Par exemple, s'ils rencontrent souvent des problèmes de connexion. 
