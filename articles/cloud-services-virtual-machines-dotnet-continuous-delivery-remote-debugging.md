<properties urlDisplayName="Enable remote debugging with continuous delivery" pageTitle="Activation du d&eacute;bogage distant avec la remise continue" metaKeywords="" description="D&eacute;couvrez comment activer le d&eacute;bogage distant lors de l'utilisation de la remise continue pour publier sur Azure." metaCanonical="" services="cloud-services,virtual machines" documentationCenter=".NET" title="Activation du d&eacute;bogage distant lors de l'utilisation de la remise continue pour publier sur Azure" authors="kempb" solutions="" manager="douge" editor="" />
