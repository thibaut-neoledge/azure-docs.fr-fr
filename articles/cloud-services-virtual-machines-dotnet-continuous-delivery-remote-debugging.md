...
1. Créez une machine virtuelle Azure. Consultez [Création d'une machine virtuelle exécutant Windows Server](virtual-machines/virtual-machines-windows-tutorial.md) ou [Création de machines virtuelles Azure dans Visual Studio](http://msdn.microsoft.com/library/azure/dn569263.aspx).
