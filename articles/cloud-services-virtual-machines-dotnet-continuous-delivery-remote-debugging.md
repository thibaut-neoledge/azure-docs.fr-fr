...
2. L'exécution du débogage distant (msvsmon.exe) étant nécessaire pour ce package, installez les [Outils de contrôle à distance pour Visual Studio 2013](http://www.microsoft.com/fr-fr/download/details.aspx?id=40781) (ou les [Outils de contrôle à distance pour Visual Studio 2012 Update 4](http://www.microsoft.com/fr-fr/download/details.aspx?id=38184) si vous utilisez Visual Studio 2012). Une autre méthode consiste à copier les fichiers binaires de débogage distant à partir d'un système sur lequel Visual Studio est installé.
