<properties 
	...
	description="Découvrez comment créer des applications API de connecteur de protocole Microsoft Azure et ajouter l'application API à votre application logique ; microservices" 
...
Vous pouvez créer un connecteur à l'aide du portail Azure ou avec des API REST. [Créer des connecteurs avec des API REST](http://go.microsoft.com/fwlink/p/?LinkId=529766)
