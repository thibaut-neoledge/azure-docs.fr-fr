<properties pageTitle="Didacticiel Application web Python avec Django sur Mac - Azure" description="Didacticiel qui explique comment héberger un site web Django dans Azure à l'aide d'une machine virtuelle Linux." services="virtual-machines" documentationCenter="python" authors="huguesv" manager="wpickett" editor=""/>
