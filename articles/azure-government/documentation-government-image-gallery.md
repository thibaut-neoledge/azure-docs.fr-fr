...
| Éditeur | Nom de l'image |
| --- | --- |
| Esri |ArcGIS 10.4.1 for Server |
| Barracuda Networks, Inc. |Barracuda NextGen Control Center (BYOL) |
| Barracuda Networks, Inc. |Barracuda NextGen Firewall série F (BYOL) |
| Microsoft |BizTalk Server 2016 Community Technology Preview 2 |
| Microsoft |{BYOL} SQL Server 2012 SP3 Enterprise sur Windows Server 2012 R2 |
| Microsoft |{BYOL} SQL Server 2012 SP3 Standard sur Windows Server 2012 R2 |
...
| OpenLogic |Basé sur CentOS 6.7 |
| OpenLogic |Basé sur CentOS 6.8 |
| OpenLogic |Basé sur CentOS 7.2 |
...
| Bitnami |Moodle |
| Citrix |NetScaler VPX BYOL (apportez votre propre licence) |
| SUSE |openSUSE Leap 42.1 |
| Red Hat |Red Hat Enterprise Linux 6.8 |
| Red Hat |Red Hat Enterprise Linux 7.2 |
| Microsoft |SQL Server 2012 SP3 Enterprise sur Windows Server 2012 R2 |
| Microsoft |SQL Server 2012 SP3 Standard sur Windows Server 2012 R2 |
...
| Barracuda Networks, Inc. |Pare-feu d’applications web Barracuda (WAF) - BYOL |
...
| Microsoft Open Technologies, Inc. |Oracle WebLogic Server 12c Standard Edition sur Windows Server 2012 |Oracle WebLogic Server http://www.oracle.com/weblogicserver 12c Standard Edition (12.1.2.0) est un serveur d’applications Java EE qui délivre des applications de nouvelle génération... |Windows |128 Go |
...
| Microsoft Open Technologies, Inc. |Oracle WebLogic Server 12c Enterprise Edition sur Windows Server 2012 |Oracle WebLogic Server http://www.oracle.com/weblogicserver 12c Enterprise Edition (12.1.2.0) est un serveur d’applications Java EE qui délivre des applications de nouvelle génération... |Windows |128 Go |
...
Accédez au référentiel GitHub de modèles de démarrage rapide Azure, et faites votre choix dans la liste des modèles de solution ci-dessous :
...
| <a href="https://github.com/Azure/azure-quickstart-templates/tree/058f18cbb43165b043e5bb56a82a406290c02dac/cisco-csr-1000v"> Cisco CSR1000v (2 cartes d’interface réseau) </a> |
| <a href="https://github.com/Azure/azure-quickstart-templates/tree/058f18cbb43165b043e5bb56a82a406290c02dac/cisco-csr-1000v-4-nic"> Cisco CSR1000v (4 cartes d’interface réseau) </a> |
| <a href="https://github.com/Azure/azure-quickstart-templates/tree/058f18cbb43165b043e5bb56a82a406290c02dac/cisco-csr-1000v-existing-vnet-4-nic"> Cisco CSR1000v (4 cartes d’interface réseau virtuel existant) </a> |

### <a name="step-2"></a>Étape 2
Dans le fichier Lisez-moi, lancez le modèle en cliquant sur le bouton/lien « Déployer vers Azure Government » en haut de la page.

### <a name="step-3"></a>Étape 3 :
Une page de navigateur ouvre le panneau de déploiement de modèles dans le portail Azure Government. Dans le panneau Paramètres, renseignez les champs requis, puis cliquez sur « OK ».

### <a name="step-4"></a>Étape 4
Acceptez les conditions légales, cochez la case « Épingler au tableau de bord », puis cliquez sur Créer.

> [!NOTE]
> Vous aurez besoin d’un compte Azure Government valide pour pouvoir continuer. Pour bénéficier de la puissance d’Azure Government pour votre organisation, inscrivez-vous à un [essai d’Azure Government](https://azuregov.microsoft.com/trial/azuregovtrial).
> 
> 

### <a name="step-5"></a>Étape 5
Les panneaux se ferment et vous revenez à la vue tableau de bord du portail affichant le déploiement de l’image. Ceci peut prendre plusieurs minutes. Une fois la solution de machine virtuelle exécutée, elle s’affiche dans votre tableau de bord. Si vous n’avez pas sélectionné l’option « Épingler au tableau de bord » à l’étape 4, vous devez rechercher la machine virtuelle dans vos ressources.

> [!NOTE]
> Des modèles de solution sont fournis par Microsoft et des fournisseurs tiers en guise de point de départ uniquement. Vous êtes seul responsable du développement, de l’implémentation et de la gestion de vos applications et/ou abonnements exécutés sur Microsoft Azure et Azure Government, conformément aux lois, réglementations et obligations contractuelles applicables.  Ces modèles sont fournis « EN L’ÉTAT » sans garantie d’aucune sorte, expresse, implicite ou légale, et Microsoft décline expressément toute garantie de qualité marchande, d’adéquation à un usage particulier ou de non-contravention à la loi.
> 
> 

## <a name="next-steps"></a>Étapes suivantes
Les ressources ci-dessous fournissent des informations supplémentaires sur le déploiement à partir de la bibliothèque d'images ou sur la création de votre propre disque dur virtuel.  Consultez le [Guide du développeur Azure Government](documentation-government-developer-guide.md) pour découvrir les différences de programmation au niveau des points de terminaison lorsque vous travaillez avec Azure Government.

### <a name="other-resources"></a>Autres ressources :
* [Déploiement d'un ordinateur virtuel Windows](../virtual-machines/virtual-machines-windows-hero-tutorial.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
* [FAQ sur les ordinateurs virtuels](../virtual-machines/virtual-machines-windows-faq.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
* [Capture d'image d'ordinateur virtuel Linux](../virtual-machines/virtual-machines-linux-classic-capture-image.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
