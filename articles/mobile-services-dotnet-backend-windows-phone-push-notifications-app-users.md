...
Ce didacticiel concerne les applications Windows Phone 8.0 et Windows Phone 8.1 (Silverlight). Pour les applications Windows Phone 8.1 Store, reportez-vous à la [version de Windows Store de cette rubrique](/fr-fr/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-push-notifications-app-users).
