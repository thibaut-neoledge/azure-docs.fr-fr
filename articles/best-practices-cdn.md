...
![Logo des modèles et pratiques](./media/best-practices-cdn/pnp-logo.png)
...
Pour plus d’informations, voir [Modèles d’utilisation du CDN d’analyse](./cdn/cdn-analyze-usage-patterns.md/).
