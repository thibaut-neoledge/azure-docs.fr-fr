...
-   [Kit de développement logiciel (SDK) Azure Mobile Services version 1.3.0-alpha4 (ou versions ultérieures)][]
-   [Azure Mobile Services SQLite Store version 1.0.0-alpha4 (ou versions ultérieures)][]
