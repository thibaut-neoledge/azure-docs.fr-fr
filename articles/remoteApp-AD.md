<properties title="Configure Active Directory for Azure RemoteApp" pageTitle="Configuration d'Active Directory pour Azure RemoteApp" description="Découvrez comment configurer Active Directory de façon à utiliser Azure RemoteApp." metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo"  />
...
Vous n'avez pas encore ajouté de services de domaine Active Directory à votre environnement Windows Server 2012 R2 ? Consultez [ces instructions](http://technet.microsoft.com/fr-fr/library/cc731053(v=WS.10).aspx) pour plus d'informations sur la façon de procéder.
...
1. Accordez au compte de service RemoteApp l'autorisation d'ajouter et de supprimer des ordinateurs dans cette 
...
- [Ajout de votre domaine](http://technet.microsoft.com/fr-fr/library/hh969247.aspx) : utilisez ces informations pour ajouter un domaine correspondant au suffixe de domaine UPN de votre domaine Active Directory local.
- [Intégration d'annuaire](http://technet.microsoft.com/fr-fr/library/jj573653.aspx) : utilisez ces informations pour choisir une option d'intégration d'annuaire, [DirSync avec synchronisation de mot de passe](http://technet.microsoft.com/fr-fr/library/dn441214.aspx) ou [DirSync avec fédération](http://technet.microsoft.com/fr-fr/library/dn441213.aspx).

Vous pouvez également configurer l'[authentification multifacteur](http://technet.microsoft.com/fr-fr/library/dn249466.aspx).
