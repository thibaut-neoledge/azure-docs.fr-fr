...
+ [Envoi de notifications Push aux utilisateurs authentifiés](mobile-services-javascript-backend-android-push-notifications-app-users.md)<br/>Étend le didacticiel précédent pour autoriser uniquement les utilisateurs signés à s'inscrire aux notifications.
