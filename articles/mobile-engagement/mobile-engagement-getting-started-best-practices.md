<properties 
	pageTitle="Azure Mobile Engagement - Guide de prise en main et meilleures pratiques"
...
La configuration d’Azure Mobile Engagement est très simple. Toute la documentation relative à l’interface utilisateur est disponible sur le site web Azure Mobile Engagement, sur la page [Comment naviguer dans l’interface utilisateur](mobile-engagement-user-interface-navigation.md).
...
Ensuite : - Enregistrez le deviceID à tester sur votre appareil. -Accédez aux paramètres de votre compte et configurez le fuseau horaire pour que les graphiques et l’heure de remise des notifications soient définis sur votre fuseau horaire. -Accédez aux paramètres de votre application et enregistrez les « informations de l’application » dont vous avez besoin pour cibler l’utilisateur final dans les limites de la couverture.
