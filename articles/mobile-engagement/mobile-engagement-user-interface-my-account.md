...
3. À partir d’une annonce Reach, si l’URL de l’action associée à l’annonce contient le modèle {deviceid}, il sera automatiquement remplacé par l’identificateur de l’appareil à l’origine de l’action. http://<exemple>.com/registeruser?deviceid={deviceid}&otherparam=myparamdata sera remplacé par : http://<exemple>.com/registeruser?deviceid=XXXXXXXXXXXXXXXX&otherparam=myparamdata
