<properties
	pageTitle="Intégration du Kit de développement logiciel (SDK) de Windows Universal"
...
#Intégration du Kit de développement logiciel (SDK) Windows Universal pour Azure Engagement Mobile
