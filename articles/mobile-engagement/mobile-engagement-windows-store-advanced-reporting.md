<properties
	pageTitle="Génération de rapports avancés pour des applications Windows Universal avec Mobile Apps Engagement"
...
# Génération de rapports avancés avec le Kit de développement logiciel (SDK) des applications Windows Universal Engagement
...
## Spécification de la configuration d’Engagement lors de l’exécution
