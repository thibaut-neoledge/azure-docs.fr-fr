...
1. Démarrez Xcode et sélectionnez **Créer un nouveau projet Xcode** dans la fenêtre contextuelle.
...
3. Renseignez le **nom de produit**, le **nom de l’organisation** et l’**identificateur de l’organisation**. Assurez-vous que vous avez sélectionné **Objective-C** dans la zone **Langage**.
...
7. Ouvrez le fichier d’implémentation de votre délégué d’application et ajoutez la ligne de code suivante.

		#import "EngagementAgent.h"

8. Collez ensuite la chaîne de connexion dans le délégué `didFinishLaunchingWithOptions`.
...
- Ouvrez le fichier **ViewController.h**, importez **EngagementViewController.h** et remplacez la superclasse de l’interface **ViewController** par **EngagementViewController**, comme illustré ci-dessous :
...
2. Vous accédez à la page **Paramètres** de votre application via le portail Engagement. De là, cliquez sur l’onglet **Surveiller** :
...
4. Revenez dans Xcode, démarrez votre application dans le simulateur ou dans un appareil connecté
...
2. Sélectionnez **Ajouter le fichier à**.
...
1. En haut de votre fichier d’implémentation, importez le module Engagement Reach.

		#import "AEReachModule.h"

2. Dans la méthode **application:didFinishLaunchingWithOptions**, créez un module Reach et transmettez-le à la ligne d’initialisation d’Engagement existante :
...
###Accorder à Mobile Engagement l’accès à votre certificat push

Pour autoriser Mobile Engagement à envoyer des notifications push en votre nom, vous devez lui accorder l’accès à votre certificat. Pour ce faire, configurez votre certificat et entrez-le dans le portail Mobile Engagement. Assurez-vous d’obtenir votre certificat .p12 comme expliqué dans la documentation d’Apple.
...
2. Vous accédez à la page **Paramètres** via le portail Engagement. De là, cliquez sur la section **Push natif** pour télécharger votre certificat p12 :
...
3. Configurez le premier champ de votre campagne :
	...
	- 	Sélectionnez **Hors de l’application uniquement** pour **Heure de distribution** : il s’agit du type simple de notification Push Apple qui comprend du texte.
...
5. Vous avez terminé de définir la campagne de base la plus simple possible. Maintenant, faites défiler vers le bas de nouveau, puis créez votre campagne pour l’enregistrer ! ![][38]
