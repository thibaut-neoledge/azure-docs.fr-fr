<properties 
	pageTitle="Créer un pont iOS WebView avec le Kit SDK Mobile Engagement iOS natif" 
...
#Créer un pont iOS WebView avec le Kit SDK Mobile Engagement iOS natif
...
5. Maintenant, nous revenons à **ViewController.m** et nous le mettons à jour avec le code suivant :
...
9. Exécutez l’application. Vous verrez ce qui suit. Maintenant, fournissez un nom pour un événement de test comme celui qui suit et cliquez sur **Send** à côté.
