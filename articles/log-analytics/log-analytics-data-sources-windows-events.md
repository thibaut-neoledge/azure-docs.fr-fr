<properties 
   pageTitle="Journaux des événements Windows dans Log Analytics | Microsoft Azure"
...
# Sources de données de journal d’événements Windows dans Log Analytics
...
Configurez les journaux d’événements Windows à partir du [menu Données dans Paramètres de Log Analytics](log-analytics-data-sources.md/configuring-data-sources).
...
| SourceSystem | Type d’agent auprès duquel l’événement a été collecté. <br> OpsManager – Agent Windows, connexion directe ou SCOM <br> Linux – Tous les agents Linux <br> AzureStorage – Diagnostics Azure |
...
## Recherches de journaux avec des événements Windows
