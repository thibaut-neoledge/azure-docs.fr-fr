...
2. Configurez Log Analytics pour lire les journaux du Stockage Blob en suivant la procédure décrite dans [Fichiers JSON dans le Stockage Blob](log-analytics-azure-storage-json.md).
