...
>[AZURE.NOTE] Pour les ordinateurs virtuels s’exécutant dans Azure, vous pouvez simplifier installation à l’aide de l’[extension de machine virtuelle](log-analytics-azure-vm-extension.md).
...
4. À droite du champ **Clé primaire**, cliquez sur l’icône de copie et collez la clé dans le Bloc-notes.     
    ![Copier l’ID et la clé primaire de l’espace de travail](./media/log-analytics-windows-agents/oms-direct-agent-primary-key.png)
...
## <a name="optionally,-configure-agents-to-use-the-oms-log-analytics-forwarder"></a>Vous pouvez éventuellement configurer les agents afin qu’ils utilisent OMS Log Analytics Forwarder
