...
| ---                                                                                        | ---                                                                       | ---                                                                                                       | ---   |
| Log Analytics des activités                                                                     | <ul><li>Insight&nbsp;&&nbsp;Analytics</li><li>Log Analytics</li></ul>     | Gratuit<br> Standard<br> Premium&nbsp;(OMS)<br> Par&nbsp;Go&nbsp;(autonome)<br> Par&nbsp;nœud&nbsp;(OMS)     | 90 jours de données disponibles gratuitement<br>Données non soumises à la limite du niveau gratuit |
...
| Intégrité de l’agent                                                                                  | <ul><li>Insight&nbsp;&&nbsp;Analytics</li><li>Log Analytics</li></ul>     | Gratuit<br> Standard<br> Premium&nbsp;(OMS)<br> Par&nbsp;Go&nbsp;(autonome)<br> Par&nbsp;nœud&nbsp;(OMS)     | Données non soumises à la limite du niveau gratuit |
