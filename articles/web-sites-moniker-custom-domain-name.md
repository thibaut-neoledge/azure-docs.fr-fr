...
Cet article contient des instructions permettant d'utiliser un nom de domaine personnalisé acheté auprès de [Moniker.com][Moniker.com] avec le service Sites Web Azure.
