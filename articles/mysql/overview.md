...
- [Création d’un serveur Azure Database pour MySQL à l’aide d’Azure CLI](quickstart-create-mysql-server-database-using-azure-cli.md)
...
- Consulter la page des tarifs pour comparer les coûts à l’aide des calculatrices. [Tarifs](https://azure.microsoft.com/pricing/details/mysql/)
- Commencer en créant votre premier serveur. [Création d’un serveur Azure Database pour MySQL à l’aide du portail Azure](quickstart-create-mysql-server-database-using-azure-portal.md)
