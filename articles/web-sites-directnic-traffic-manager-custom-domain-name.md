<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Directnic" pageTitle="Configuration d'un nom de domaine Directnic pour un site web Azure utilisant Traffic Manager" metaKeywords="Windows Azure, Windows Azure Web Sites, Directnic, Traffic Manager" description="Découvrez comment configurer un site web Azure qui se sert de Traffic Manager pour utiliser un nom de domaine enregistré avec Directnic" services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
