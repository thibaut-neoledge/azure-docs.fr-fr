<properties 
	...
	description="Utilisation de ShardMapManager pour le routage selon les données, une fonctionnalité de mise à l'échelle flexible pour la base de données SQL Azure" 
