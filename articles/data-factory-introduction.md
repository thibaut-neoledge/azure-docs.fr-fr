<properties title="Introduction to Azure Data Factory" pageTitle="Présentation d'Azure Data Factory" description="Découvrez comment utiliser le service Azure Data Factory pour composer le traitement des données, le stockage de données et les services de déplacement de données pour créer des pipelines qui génèrent des informations fiables." metaKeywords=""  services="data-factory" solutions=""  documentationCenter="" authors="spelluru" manager="jhubbard" editor="monicar" />
