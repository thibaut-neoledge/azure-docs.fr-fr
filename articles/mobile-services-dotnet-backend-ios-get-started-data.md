...
8. [Test de l'application avec Mobile Services]

Ce didacticiel requiert les éléments suivants :

+ [Kit de développement logiciel (SDK) Mobile Services pour iOS] et [XCode 4.5][Installer Xcode] et iOS 5.0 ou versions ultérieures.
...
##<a name="test-app"></a>Test de l'application sur votre nouveau service mobile
