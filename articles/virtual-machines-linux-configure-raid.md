...
- Sélectionnez le point de départ de la nouvelle partition ou appuyez tout simplement sur `<entrée>` pour accepter le paramètre par défaut et placer la partition au début de l'espace libre sur le disque :
