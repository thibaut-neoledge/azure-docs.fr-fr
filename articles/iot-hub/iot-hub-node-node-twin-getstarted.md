<properties
    pageTitle="Prise en main des représentations | Microsoft Azure"
...
7. Ajoutez le code suivant à la fin de  **AddTagsAndQuery.js** pour implémenter la fonction **queryTwins**:
