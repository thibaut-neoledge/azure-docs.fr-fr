...
2. Cliquez sur **Informations d’identification du déploiement**, créez un nom d’utilisateur et un mot de passe pour vous connecter au référentiel Git dans Azure, puis cliquez sur **Enregistrer**.
