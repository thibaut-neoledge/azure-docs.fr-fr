...
# Prise en main du Kit de démarrage de la passerelle IoT avec un SensorTag
...
## Leçon 3 : Recevoir des messages à partir de SensorTag et lire des messages à partir de votre IoT Hub
