...
| ---- | ------- | ---------- |
| Modèles de communication | Permet une entrée d’événement appareil vers cloud et de messagerie cloud vers appareil. | Permet uniquement une entrée d’événement (en général utilisé pour les scénarios appareil vers cloud). |
