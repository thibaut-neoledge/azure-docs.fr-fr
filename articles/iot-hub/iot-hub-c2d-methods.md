...
> [!NOTE]
> Actuellement, les méthodes directes sont accessibles uniquement à partir d’appareils qui se connectent à l’IoT Hub en utilisant le protocole MQTT. Pour obtenir des instructions sur la conversion d’une application d’appareil existante pour utiliser MQTT, voir [Support MQTT][lnk-devguide-mqtt].
> 
> 
