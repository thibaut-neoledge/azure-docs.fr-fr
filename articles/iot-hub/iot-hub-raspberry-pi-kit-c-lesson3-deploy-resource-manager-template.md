...
* Le fichier `main.c` se trouvant dans le sous-dossier `app` est le fichier source clé. Ce fichier source contient le code pour envoyer un message 20 fois à votre IoT hub et faire clignoter la LED pour chaque message envoyé.
...
[Exécution d’un exemple d’application pour envoyer des messages appareil-à-cloud](iot-hub-raspberry-pi-kit-c-lesson3-run-azure-blink.md)
