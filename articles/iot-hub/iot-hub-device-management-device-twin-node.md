---
title: Gestion des appareils IoT Hub - Représentations d’appareils | Microsoft Docs
...
---
# Didacticiel : Utilisation des représentations d’appareil physique avec Node.js (version préliminaire)
...
3. Exécutez `node jobClient_devicePropertyReadWrite.js`.
...
1. Lecture partielle : imprime les propriétés `BatteryLevel` et `Timezone` de l’appareil sur une représentation d’appareil.
2. Lecture approfondie : lire la propriété `Timezone` de l’appareil à partir de l’appareil physique.
3. Lecture partielle : imprime les propriétés `BatteryLevel` et `Timezone` de l’appareil sur une représentation d’appareil.
4. Écriture approfondie : écrit la propriété de l’appareil **Fuseau horaire** sur l’appareil physique.
5. Lecture approfondie : lit la propriété de l’appareil **Fuseau horaire** à partir de l’appareil physique pour voir qu’elle a été modifiée.
6. Lecture partielle : imprime les propriétés `BatteryLevel` et `Timezone` de l’appareil sur une représentation d’appareil.
