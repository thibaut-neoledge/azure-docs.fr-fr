---
title: Utiliser l’interface utilisateur de gestion d’appareils IoT Hub | Microsoft Docs
...
> [!NOTE]
> Si l’état de vos travaux enfants est défini comme étant « échoué », vérifiez que vos appareils simulés sont encore en cours d’exécution sur votre système de test. Si ce n’est pas le cas, exécutez à nouveau le script simulate.bat ou simulate.sh et répétez les étapes relatives au travail d’appareil de redémarrage dans la section précédente.
> 
> 
