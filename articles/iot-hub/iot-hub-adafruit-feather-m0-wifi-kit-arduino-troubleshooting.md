...
## Problèmes matériels
Pour plus d’informations sur la résolution de problèmes courants sur votre carte Adafruit Feather M0 WiFi Arduino, consultez la [page officielle de résolution des problèmes](https://learn.adafruit.com/adafruit-feather-m0-wifi-atwinc1500?view=all#faq).

<a id="nodejs-package-issues" class="xliff"></a>

## Problèmes de package Node.js
<a id="no-response-during-gulp-tasks" class="xliff"></a>

### Aucune réponse lors des tâches gulp
...
Vous pouvez également ajouter `--listen` pour ouvrir le port série afin d'obtenir la sortie du journal de l'appareil.
...
## Problèmes liés à l'interface de ligne de commande Azure
...
### Problèmes d’installation héritée (macOS)
...
## Problèmes liés à Azure IoT Hub
...
## Problèmes liés au Stockage Azure
