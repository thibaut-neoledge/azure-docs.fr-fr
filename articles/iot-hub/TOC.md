...
# Prise en main
## Prise en main d’un appareil simulé
...
#### [Exécuter l’exemple d’application pour recevoir des messages](iot-hub-raspberry-pi-kit-node-lesson4-send-cloud-to-device-messages.md)
...
## [Didacticiel sur le chargement de fichiers à partir d’appareils](iot-hub-csharp-csharp-file-upload.md)
## [Envoyer des messages cloud-à-appareil (.NET)](iot-hub-csharp-csharp-c2d.md)
## [Envoyer des messages cloud-à-appareil (Java)](iot-hub-java-java-c2d.md)
## [Envoyer des messages cloud-à-appareil (Node)](iot-hub-node-node-c2d.md)
## [Prise en main des représentations d’appareils (Node)](iot-hub-node-node-twin-getstarted.md)
## [Prise en main des représentations d’appareils (.NET/Node)](iot-hub-csharp-node-twin-getstarted.md)
## [Utiliser les méthodes directes pour Node.js](iot-hub-node-node-direct-methods.md)
## [Utiliser les méthodes directes pour .NET/Node](iot-hub-csharp-node-direct-methods.md)
## [Prise en main de la gestion d’appareils pour Node.js](iot-hub-node-node-device-management-get-started.md)
## [Prise en main de la gestion d’appareils pour .NET/Node](iot-hub-csharp-node-device-management-get-started.md)
## [Utilisation des propriétés des représentations (Node)](iot-hub-node-node-twin-how-to-configure.md)
## [Utilisation des propriétés des représentations (.NET/Node)](iot-hub-csharp-node-twin-how-to-configure.md)
## [Utiliser des travaux d’appareils pour la mise à jour du microprogramme de Node.js](iot-hub-node-node-firmware-update.md)
...
### [Configurer le chargement de fichiers](iot-hub-configure-file-upload.md)
...
### [Didacticiel sur la simulation d’un appareil avec le kit de développement logiciel (SDK) Gateway (Linux)](iot-hub-linux-gateway-sdk-simulated-device.md)
### [Didacticiel sur la simulation d’un appareil avec le Kit de développement logiciel (SDK) Gateway (Windows)](iot-hub-windows-gateway-sdk-simulated-device.md)
### [Didacticiel sur l’envoi de messages à partir d’un appareil avec le kit de développement logiciel (SDK) Gateway](iot-hub-gateway-sdk-physical-device.md)
## Sécuriser
