...
- [Gérer IoT Hub via le portail Azure en version préliminaire][lnk-manage-portal] explique comment utiliser le portail Azure en version préliminaire pour gérer votre concentrateur IoT.
