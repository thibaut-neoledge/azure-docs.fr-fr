...
### TI SensorTag ne peut pas être connecté
...
### Problèmes de détection d’appareil
...
### Configuration de Visual Studio Code pour la connexion à l’appareil distant
...
### Attacher à l’application distante
...
## Problèmes d’interface de ligne de commande Azure
