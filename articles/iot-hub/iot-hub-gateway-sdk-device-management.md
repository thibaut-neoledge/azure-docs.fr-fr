---
title: Gestion des appareils avec le Kit de développement logiciel (SDK) de passerelle | Microsoft Docs
...
> [!NOTE]
> L’exécution du script qui crée l’image personnalisée peut durer 6 heures sur un ordinateur quadricœur. Vous pouvez réduire ce délai en utilisant un ordinateur plus puissant qui possède plus de cœurs de processeur.
> 
> 
