...
-   [Suppression du message suivant dans la file d'attente](#dequeue-message)
...
1.  référencer le fichier de chargeur automatique à l'aide de l'instruction [require\_once](http://www.php.net/manual/en/function.require-once.php) ; et
...
> [WACOM.NOTE] Ne tenez pas compte de la différence entre majuscules et minuscules pour les clés de métadonnées. Toutes les clés sont lues en minuscules sur le service.
