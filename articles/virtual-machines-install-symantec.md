<properties pageTitle="Installation et configuration de Symantec Endpoint Protection sur une machine virtuelle Azure" description="Explique l'installation et la configuration de Symantec Endpoint Protection sur une machine virtuelle dans Azure" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
