...
3. Accédez à la [page d’accueil de l’API Recommendations Cognitive Services](https://www.microsoft.com/cognitive-services/fr-FR/recommendations-api) pour en savoir plus sur le service et consulter la documentation.
