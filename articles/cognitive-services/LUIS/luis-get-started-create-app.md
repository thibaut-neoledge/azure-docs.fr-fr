...
# <a name="create-your-first-luis-app-in-ten-minutes"></a>Create your first LUIS app in ten minutes
...
## <a name="2-add-intents"></a>2. Add intents
...
## <a name="3-add-utterances"></a>3. Add utterances
...
## <a name="4-add-entities"></a>4. Add entities
...
## <a name="5-label-entities-in-utterances"></a>5. Label entities in utterances
...
## <a name="6-add-prebuilt-entities"></a>6. Add prebuilt entities
...
## <a name="7-train-your-app"></a>7. Train your app
...
## <a name="8-test-your-app"></a>8. Test your app
...
## <a name="9-publish-your-app"></a>9. Publish your app
Select **Publish App** from the left-side menu and click **Publish**. 

## <a name="10-use-your-app"></a>10. Use your app
