...
ms.openlocfilehash: d88d2cc87d29ae1a95ee6f3e16f611810e7ecfd3
...
## <a name="use-the-subteam-command"></a>Use the Subteam command ##

Scroll down the page and use the "**Add Subteam**" button to bring up the name dialog.

![Add Subteam](images/1-teams-1.png)

## <a name="name-your-subteam"></a>Name your subteam ##

Enter your subteam name in the dialog. 

![Subteam Name](images/1-Teams-2.PNG)

## <a name="assign-members-from-your-default-team"></a>Assign members from your default team ##
...
## <a name="assign-reviews-to-your-subteam"></a>Assign reviews to your subteam ##
...
For images: ![Assign image review to subteam](images/3-review-image-subteam-1.png)
...
## <a name="review-content-within-a-subteam"></a>Review content within a subteam ##
