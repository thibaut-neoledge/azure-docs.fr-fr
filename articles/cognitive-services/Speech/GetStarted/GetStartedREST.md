...
## <a name="rest-end-point"></a>REST end point
...
## <a name="chunked-transfer-encoding"></a>Chunked transfer encoding
...
## <a name="speech-recognition-response"></a>Speech recognition response
