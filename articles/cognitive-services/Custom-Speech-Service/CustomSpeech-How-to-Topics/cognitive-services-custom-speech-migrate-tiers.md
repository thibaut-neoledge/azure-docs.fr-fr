...
ms.openlocfilehash: cd6370cba43896014b107fc44a8781d6c0c75f56
...
# <a name="how-to-migrate-deployments-from-pricing-model-to-new-pricing-model"></a>How to migrate deployments from pricing model to new pricing model
...
## <a name="step-1-check-your-existing-deployment"></a>Step 1: Check your existing deployment
...
## <a name="step-2-go-to-your-azure-portal-and-select-the-new-pricing-tier"></a>Step 2: Go to your Azure portal and select the new pricing tier
...
## <a name="step-3-check-migration-status-on-custom-speech-service-portal"></a>Step 3: Check migration status on Custom Speech Service portal
