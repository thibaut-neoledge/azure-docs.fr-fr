<properties
	pageTitle="Connecter Azure Search avec les applications web ASP.NET | Microsoft Azure"
...
#Processus d’intégration d’Azure Search avec des applications web ASP.NET
