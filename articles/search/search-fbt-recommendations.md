...
- Créez une instance HDInsight (activation du Bureau à distance) et connectez-vous à l'ordinateur via le Bureau à distance (disponible à partir du portail Azure)
