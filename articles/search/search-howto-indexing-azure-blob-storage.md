...
> [!IMPORTANT]
> En l’absence de mappage explicite pour le champ de clé dans l’index, Azure Search utilisera automatiquement `metadata_storage_path` (la deuxième option ci-dessus) en guise de clé et activera le codage base 64 des clés.
> 
> 
...
> [!WARNING]
> Si vous supprimez simplement les objets blob au lieu d’utiliser une stratégie de détection des suppressions, les documents correspondants ne seront pas supprimés de l’index de recherche.
> 
> 
