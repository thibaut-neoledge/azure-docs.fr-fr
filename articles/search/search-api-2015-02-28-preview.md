...
> [!NOTE]
> Pendant l’appel de **Search** à l’aide de POST, ce paramètre est nommé `skip` au lieu de `$skip`.
> 
> 
...
> [!NOTE]
> Pendant l’appel de **Search** à l’aide de POST, ce paramètre est nommé `top` au lieu de `$top`.
> 
> 
...
> [!NOTE]
> Pendant l’appel de **Search** à l’aide de POST, ce paramètre est nommé `count` au lieu de `$count`.
> 
> 
...
> [!NOTE]
> Pendant l’appel de **Search** à l’aide de POST, ce paramètre est nommé `orderby` au lieu de `$orderby`.
> 
> 
...
> [!NOTE]
> Pendant l’appel de **Search** à l’aide de POST, ce paramètre est nommé `select` au lieu de `$select`.
> 
> 
...
> [!NOTE]
> Pendant l’appel de **Search** à l’aide de POST, ce paramètre est nommé `facets` au lieu de `facet`. En outre, vous le spécifiez sous forme de tableau JSON de chaînes où chaque chaîne est une expression de facette distincte.
> 
> 
...
> [!NOTE]
> Pendant l’appel de **Search** à l’aide de POST, ce paramètre est nommé `filter` au lieu de `$filter`.
> 
> 
...
> [!NOTE]
> Pendant l’appel de **Search** à l’aide de POST, ce paramètre est nommé `scoringParameters` au lieu de `scoringParameter`. En outre, vous le spécifiez sous forme de tableau JSON de chaînes où chaque chaîne est une paire `name-values` distincte.
> 
> 
...
`$select=[string]` (facultatif) : liste de champs à récupérer séparés par des virgules. Si aucune valeur n’est spécifiée, seuls la clé du document et le texte de suggestion sont retournés. Vous pouvez demander explicitement tous les champs en définissant ce paramètre avec la valeur `*`.
