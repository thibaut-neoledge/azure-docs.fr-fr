<properties
   pageTitle="Création d'une définition d'index de document dans plusieurs langues dans Azure Search | Microsoft Azure"
...
# Création d'une définition d'index de document dans plusieurs langues dans Azure Search
