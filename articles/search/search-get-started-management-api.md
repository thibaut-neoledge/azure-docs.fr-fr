...
Si vous n'avez pas encore [téléchargé l'exemple d'application à partir de Codeplex](https://azuresearchmgmtapi.codeplex.com/), vous en aurez besoin pour cette étape.
