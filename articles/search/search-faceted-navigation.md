...
## <a name="what-it-looks-like"></a>Apparence
 ![][1]
...
## <a name="know-the-fundamentals"></a>Les notions de base
...
## <a name="how-to-build-it"></a>Procédure de création
...
## <a name="facet-navigation-based-on-a-range-values"></a>Navigation à facettes basée sur une plage de valeurs
...
### <a name="build-a-filter-for-facet-ranges"></a>Création d'un filtre pour les plages de facettes
...
## <a name="filtered-navigation-based-on-geopoints"></a>Navigation à facettes basée sur des points géographiques
