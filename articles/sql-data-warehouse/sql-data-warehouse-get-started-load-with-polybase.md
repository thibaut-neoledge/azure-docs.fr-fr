...
* L’utilitaire de ligne de commande AzCopy Téléchargez et installez la [dernière version d’AzCopy][dernière version d’AzCopy] qui s’installe avec les outils Microsoft Azure Storage.
...
Voir aussi [Prise en main de l’utilitaire de ligne de commande AzCopy][Prise en main de l’utilitaire de ligne de commande AzCopy].
