...
[Mise à l’échelle de la puissance de calcul avec le portail Azure]: ./sql-data-warehouse-manage-compute-tasks-portal.md#task-1-scale-performance
[Mise à l’échelle de la puissance de calcul avec PowerShell]: ./sql-data-warehouse-manage-compute-tasks-powershell.md#task-1-scale-performance
[Mise à l’échelle de la puissance de calcul avec les API REST]: ./sql-data-warehouse-manage-compute-tasks-rest-api.md#task-1-scale-performance
[Mise à l’échelle de la puissance de calcul avec TSQL]: ./sql-data-warehouse-manage-compute-tasks-tsql.md
