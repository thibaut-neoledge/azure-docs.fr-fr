...
|:--- |:--- |
| [ANSI\_NULLS][ANSI\_NULLS] |ACTIVÉ |
| [QUOTED\_IDENTIFIERS][QUOTED\_IDENTIFIERS] |ACTIVÉ |
| [DATEFORMAT][DATEFORMAT] |mdy |
| [DATEFIRST][DATEFIRST] |7 |

## Étapes suivantes
Pour vous connecter et interroger avec Visual Studio, consultez la page [Interroger Azure SQL Data Warehouse (sqlcmd) (Visual Studio)][Interroger Azure SQL Data Warehouse (sqlcmd) (Visual Studio)]. Pour en savoir plus sur les options d’authentification, consultez la page [Authentification sur Azure SQL Data Warehouse][Authentification sur Azure SQL Data Warehouse].
