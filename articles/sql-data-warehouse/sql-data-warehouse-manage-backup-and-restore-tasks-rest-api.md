<properties
   pageTitle="Sauvegarde et restauration dans Azure SQL Data Warehouse (REST) | Microsoft Azure"
...
# Sauvegarde et restauration d’une base de données dans Azure SQL Data Warehouse (REST)
...
Comment sauvegarder et restaurer une base de données dans SQL Data Warehouse à l’aide d’API REST.
