...
1. [Téléchargez les exemples de données][Téléchargez les exemples de données]. Ces données ajoutent trois années de données de ventes à vos exemples de données AdventureWorksDW.
