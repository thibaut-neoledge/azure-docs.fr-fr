<properties
   pageTitle="Partenaires de SQL Data Warehouse en matière d’intégration de données | Microsoft Azure"
...
# Partenaires de SQL Data Warehouse en matière d’intégration de données
...
| ![Informatica][4] | **Informatica Cloud**<br>Le portefeuille d’intégration d’Informatica Cloud vous permet de vous connecter facilement à diverses sources de données cloud, locales, mobiles et sociales. Vous pouvez utiliser Informatica Cloud pour partager efficacement vos informations professionnelles pertinentes et fiables. Nous proposons la suite la plus complète d’intégration cloud pour les modèles par lots et en temps réel, la gestion des données de test cloud, la qualité des données cloud et les applications de gestion de données de référence cloud. | [Marketplace][informatica_Cloud_Services_marketplace]<br>[Essai gratuit][informatica_cloud_free_trial]<br>[Guide de configuration][informatica_cloud_services_config]<br>[Site Web][informatica_Cloud_Services_website]<br>[Fiche technique][informatica_cloud_datasheet]<br>[Twitter][informatica_cloud_twitter]<br>[YouTube][informatica_cloud_youtube] | |
...
Pour en savoir plus sur certains de nos autres partenaires, voir [Partenaires en matière d’aide à la décision][bi_partners] et [Partenaires en matière de gestion des données][dm_partners].
