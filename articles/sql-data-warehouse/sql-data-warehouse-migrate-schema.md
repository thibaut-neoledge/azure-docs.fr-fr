...
SQL Data Warehouse prend en charge les types de données métiers courants. Consultez l’article sur les [types de données][types de données] pour obtenir la liste [des types de données non pris en charge][des types de données non pris en charge] et pris en charge. L’article sur les [types de données][types de données] contient également une requête pour identifier les [types de données non pris en charge][types de données non pris en charge]. Lors de la conversion de vos types de données, veillez à consulter les [meilleures pratiques relatives aux types de données][meilleures pratiques relatives aux types de données].
