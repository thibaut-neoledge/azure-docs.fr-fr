<properties
   pageTitle="Recherche de requêtes longues dans Azure SQL Data Warehouse | Microsoft Azure"
   description="Découvrez comment surveiller votre charge de travail et rechercher des requêtes longues dans Azure SQL Data Warehouse à l’aide des vues de gestion dynamique (DMV)."
