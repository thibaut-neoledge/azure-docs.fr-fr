...
- [dbo.server\_quotas (base de données SQL Azure)](http://msdn.microsoft.com/library/dn308512.aspx)
- [sys.bandwidth\_usage (base de données SQL Azure)](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database\_connection\_stats (base de données SQL Azure)](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database\_firewall\_rules (base de données SQL Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database\_usage (base de données SQL Azure)](https://msdn.microsoft.com/library/dn270020.aspx)
- [sys.event\_log (base de données SQL Azure)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database\_firewall\_rules (base de données SQL Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall\_rules (base de données SQL Azure)](https://msdn.microsoft.com/library/dn269980.aspx)
- [sys.resource\_stats (base de données SQL Azure)](http://msdn.microsoft.com/library/dn269979.aspx)
- [sys.resource\_usage (base de données SQL Azure)](https://msdn.microsoft.com/library/dn270016.aspx)
