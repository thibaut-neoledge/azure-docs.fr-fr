...
7. Sélectionnez votre **plan de support**.
    ...
    Si vous avez un plan de support Premier, vous pouvez également signaler les problèmes liés à SQL Data Warehouse sur le [portail en ligne Microsoft Premier][].
...
En outre, vous pouvez contacter la communauté SQL Data Warehouse à l'aide de la balise azure-sqldw sur [Stack Overflow][] ou le [forum MSDN Azure SQL Data Warehouse][].

<!-- External links -->

[Portail Azure Classic]: https://portal.azure.com/
[Plans de support Azure]: http://azure.microsoft.com/support/plans/?WT.mc_id=Support_Plan_510979/
