...
* [procédures stockées][procédures stockées] , vous pouvez limiter le nombre d’actions susceptibles d’être exécutées sur la base de données.
