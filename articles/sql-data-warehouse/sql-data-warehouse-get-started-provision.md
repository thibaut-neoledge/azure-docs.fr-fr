...
* **Serveur SQL Azure** : pour en savoir plus, consultez [Créer un serveur SQL logique dans le portail Azure][Create an Azure SQL Database logical server with the Azure portal].
