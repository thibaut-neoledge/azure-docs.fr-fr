...
> [AZURE.NOTE] <a name="note"></a>Un serveur logique SQL :
  ...
  > + N’est pas un matériel physique, contrairement à un serveur local. Il fait partie du logiciel de service. C’est pourquoi nous utilisons le terme de *serveur logique*.
...
3. Renseignez les informations correspondant au **Nouveau serveur**.
