...
# Partenaires décisionnels de SQL Data Warehouse

Pour créer votre solution d’entrepôt de données de bout en bout, vous pouvez choisir parmi un large éventail d’outils performants.

Cet article répertorie les entreprises partenaires qui disposent de solutions décisionnelles pour SQL Data Warehouse.

## Nos partenaires décisionnels

| Partenaire | Description | Liens | Vidéos |
| ------- | ----------- | ----- | ------ |
| ![Birst][1] |**Birst**<br>Birst est un leader mondial en matière d’outils décisionnels cloud et d’outils d’analyse. Les entreprises peuvent créer une source de données approuvée dans le contexte de chaque utilisateur professionnel clé. Les utilisateurs professionnels de l’organisation peuvent alors générer des rapports et analyser les informations à l’aide d’outils décisionnels de premier ordre.| [Marketplace][birst_marketplace]<br>[Site web][birst_website]<br>[Twitter][birst_twitter]<br>[YouTube][birst_youtube] | |
| ![ClearStory Data][2] |**ClearStory Data**<br>ClearStory Data assure une analyse rapide d’un ensemble de données disparates stockées dans SQL Data Warehouse. La plateforme Spark intégrée et l’application d’analyse de ClearStory accélèrent l’accès aux données et l’harmonisation de jeux de données hétéroclites. Elles permettent de procéder à une exploration collaborative rapide qui offre aux utilisateurs professionnels l’assurance d’acquérir de précieuses informations.| [Site web][clearstory_website]<br>[Fiche technique][clearstory_datasheet]<br>[Twitter][clearstory_twitter]<br>[YouTube][clearstory_youtube] | |
| ![Dell Statistica][3] |**Dell Statistica**<br>Dell Statistica est une plateforme d’analyse avancée permettant aux organisations d’effectuer des prévisions, d’optimiser les processus , d’alléger les coûts et d’augmenter les revenus. Dell Statistica simplifie l’analyse des données volumineuses (« Big Data »), rationalise l’implémentation et le déploiement, extrait des informations exploitables à partir d’un texte et répond aux besoins de votre entreprise. | [Marketplace][dell_statistica_marketplace]<br>[Site web][dell_statistica_website]<br>[Fiche technique][dell_statistica_datasheet]<br>[Twitter][dell_statistica_twitter]<br>[YouTube][dell_statistica_youtube] | [![Vidéo Statistica](./media/sql-data-warehouse-integrate-solution-partners/dell_statistica_video.jpg)](https://www.youtube.com/watch?v=0b8sPW2UHrU) |
| ![Dundas][4] |**Dundas BI**<br>Dundas Data Visualization est un fournisseur mondial majeur de logiciels décisionnels et de solutions de visualisation de données. Les tableaux de bord, les fonctions de création de rapports et les outils d’analyse visuelle des données conçus par Dundas s’intègrent de façon transparente aux applications d’entreprise, contribuant ainsi à améliorer la prise de décision et à accélérer l’obtention de vues d’ensemble. | [Marketplace][dundas_bi_marketplace]<br>[Site web][dundas_bi_website]<br>[Fiche technique][dundas_bi_datasheet]<br>[Twitter][dundas_bi_twitter]<br>[YouTube][dundas_bi_youtube] | [![Vidéo dundas](./media/sql-data-warehouse-integrate-solution-partners/dundas_bi_video.jpg)](https://www.youtube.com/watch?v=TEbc3_e7o60) |
| ![Jinfonet][5] |**JReport**<br>JReport est une solution décisionnelle intégrable pour l’entreprise. Cette solution permet aux utilisateurs de créer des rapports, des tableaux de bord et des analyses de données à partir de sources de données de type cloud, Big Data et transactionnelles. En visualisant les données, les utilisateurs peuvent procéder à leurs propres tâches de création de rapports et de découverte de données, bénéficiant ainsi d’une possibilité de prise de décision agile à la volée.| [Site web][jinfonet_website]<br>[Fiche technique][jinfonet_datasheet]<br>[Twitter][jinfonet_twitter]<br>[YouTube][jinfonet_youtube] | [![Vidéo jreport](./media/sql-data-warehouse-integrate-solution-partners/jinfonet_video.jpg)](https://www.youtube.com/watch?v=KYqh8TuMpds) |
| ![LogiAnalytics][6] |**Logi Analytics**<br>Utilisés conjointement, Logi Analytics et Microsoft Azure SQL Data Warehouse permettent désormais à votre organisation de collecter, d’analyser et d’exploiter immédiatement les jeux de données les plus volumineux et les plus diversifiés du monde afin d’optimiser le rendement de l’entreprise. | [Marketplace][logianalytics_marketplace]<br>[Site web][logianalytics_website]<br>[Fiche technique][logianalytics_datasheet]<br>[Twitter][logianalytics_twitter]<br>[YouTube][logianalytics_youtube] | [![Vidéo logianalytics](./media/sql-data-warehouse-integrate-solution-partners/logianalytics_video.jpg)](https://www.youtube.com/watch?v=7U0Sfi3Ndpk) |
| ![Looker][7] |**Looker BI**<br>Looker permet à tous les utilisateurs de votre entreprise d’explorer et de comprendre les données sur lesquelles repose votre activité, tout en offrant à l’analyste de données une couche de modélisation flexible et réutilisable pour le contrôle et le traitement de ces données. Looker a fait office de catalyseur en contribuant à révolutionner la culture des entreprises. | [Marketplace][looker_marketplace]<br>[Site web][looker_website]<br>[Fiche technique][looker_datasheet]<br>[Twitter][looker_twitter]<br>[YouTube][looker_youtube] | [![Vidéo looker](./media/sql-data-warehouse-integrate-solution-partners/looker_video.jpg)](https://www.youtube.com/watch?v=WwO4ADK8ZfA) |
| ![Qlik][8] |**Qlikview**<br>Qlik propose une approche de l’analyse visuelle orientée plateforme qui s’appuie sur Microsoft Azure SQL Data Warehouse. En tirant parti des fonctionnalités d’entreprise disponibles dans l’entrepôt de données élastique de Microsoft, Qlik permet à l’ensemble de l’organisation de prendre des décisions rapides en toute confiance. Qlik offre des informations utiles et précises au moment stratégique, à savoir au point de prise de décision. | [Marketplace][qlik_marketplace]<br>[Site web][qlik_website]<br>[Fiche technique][qlik_datasheet]<br>[Twitter][qlik_twitter]<br>[YouTube][qlik_youtube] | [![Vidéo qlikview](./media/sql-data-warehouse-integrate-solution-partners/qlik_video.jpg)](https://www.youtube.com/watch?v=sqILcEwlHSI) |
| ![SiSense][9] |**SiSense**<br>SiSense est un logiciel décisionnel à pile complète intégrant les outils dont une entreprise a besoin pour analyser et visualiser les données : une base de données analytique hautement performante, la possibilité d’associer plusieurs sources, une extraction de données simple (ETL, extraction, transformation et chargement), ainsi qu’une visualisation des données web. Commencez à analyser et à visualiser des jeux de données volumineux avec le logiciel décisionnel et d’analyse SiSense dès aujourd’hui. | [Marketplace][sisense_marketplace]<br>[Site web][sisense_website]<br>[Fiche technique][sisense_datasheet]<br>[Twitter][sisense_twitter]<br>[YouTube][sisense_youtube] | [![Vidéo sisense](./media/sql-data-warehouse-integrate-solution-partners/sisense_video.jpg)](https://www.youtube.com/watch?v=6N3mkTWI5R4) |
...
| ![Targit][11] |**Targit**<br>Targit Decision Suite offre une plateforme décisionnelle et d’analyse regroupant dans une même solution cohésive des tableaux de bord en temps réel, des analyses en libre service, des fonctions de création de rapports conviviales, de remarquables fonctionnalités mobiles et une technologie de découverte de données simple. Targit encourage les entreprises à passer à l’action. | [Marketplace][targit_marketplace]<br>[Site web][targit_website]<br>[Twitter][targit_twitter]<br>[YouTube][targit_youtube] | [![Vidéo targit](./media/sql-data-warehouse-integrate-solution-partners/targit_video.jpg)](https://www.youtube.com/watch?v=A0vET80Ker4) |
| ![Yellowfin][12] |**Yellowfin**<br>Yellowfin, figurant en tête du classement de l’étude sur le décisionnel menée par BARC (Business Application Research Center), est un fournisseur de solutions décisionnelles cloud pour la création de rapports et de tableaux de bord ad hoc. Connectez-vous à Azure SQL Data Warehouse, puis créez et partagez de remarquables rapports et tableaux de bord par le biais de fonctionnalités décisionnelles et géodécisionnelles collaboratives primées. | [Marketplace][yellowfin_marketplace]<br>[Site web][yellowfin_website]<br>[Fiche technique][yellowfin_datasheet]<br>[Twitter][yellowfin_twitter]<br>[YouTube][yellowfin_youtube] | [![Vidéo yellowfin](./media/sql-data-warehouse-integrate-solution-partners/yellowfin_video.jpg)](https://www.youtube.com/watch?v=i1q33AftI0A) |

<!--https://img.youtube.com/vi/0b8sPW2UHrU/0.jpg-->

## Étapes suivantes

Pour en savoir plus sur certains de nos autres partenaires, consultez les articles suivants :
- [Partenaires d’intégration de données][di_partners]
- [Partenaires de gestion de données][dm_partners]
