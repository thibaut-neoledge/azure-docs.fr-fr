<properties
   pageTitle="Schémas définis par l’utilisateur dans SQL Data Warehouse | Microsoft Azure"
...
> [AZURE.NOTE]SQL Data Warehouse ne prend pas en charge les requêtes de base de données croisées, de quelque nature que ce soit. Par conséquent, les implémentations d’entrepôt de données tirant parti de ce modèle devront être modifiées.
...
2. Conservation du nom de schéma hérité et ajout au nom de la table ; utilisation de schémas pour la limite de charge de travail
...
3. Conservation des noms de schémas hérités via des vues
