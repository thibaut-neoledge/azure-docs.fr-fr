...
- Règles d'affectation des noms aux objets
...
## Lots, contrôle de flux et variables
...
## Caractères génériques à comparer
- [= (Est égal à)](https://msdn.microsoft.com/library/ms175118.aspx)
- [> (Est supérieur à)](https://msdn.microsoft.com/library/ms178590.aspx)
- [< (Moins que)](https://msdn.microsoft.com/library/ms179873.aspx)
...
- [!= (Non égal à)](https://msdn.microsoft.com/library/vstudio/bb399278.aspx)
