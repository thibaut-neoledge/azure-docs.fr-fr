...
## Étapes suivantes
Une fois votre base de données SQL Data Warehouse approvisionnée, vous pouvez [charger des exemples de données][] ou découvrir comment [développer][], charger ou [migrer][] les données.
...
[charger des exemples de données]: ./sql-data-warehouse-get-started-manually-load-samples.md
