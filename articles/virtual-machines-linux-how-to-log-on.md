...
4. Connectez-vous à la machine virtuelle à l'aide du compte spécifié à la création de la machine. Pour plus d'informations sur la création d'une machine virtuelle avec nom d'utilisateur et mot de passe, consultez [Création d'une machine virtuelle exécutant Linux](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-tutorial/) 
...
<!-- LINKS -->
[Réinitialisation d'un mot de passe ou de SSH pour les machines virtuelles Linux]: http://go.microsoft.com/fwlink/p/?LinkId=512138
