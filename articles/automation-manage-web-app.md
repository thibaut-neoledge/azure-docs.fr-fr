...
Dans Azure Automation, une application web Azure est gérée à l'aide d'applets de commande PowerShell qui sont fournis dans les [Outils Azure PowerShell](https://msdn.microsoft.com/library/azure/jj156055.aspx). Azure Automation fournit des applets de commande PowerShell prêts à l'emploi, qui vous permettent d'exécuter toutes vos tâches de gestion d'application web dans ce service. Dans Azure Automation, vous pouvez également associer ces applets de commande à des applets de commande d'autres services Azure, afin d'automatiser des tâches complexes entre des services Azure et des systèmes tiers.
...
* Consultez la rubrique [Didacticiel de prise en main d'Azure Automation](automation-create-runbook-from-samples.md) 
