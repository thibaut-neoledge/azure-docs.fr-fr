...
# Résolution des problèmes de sauvegarde lente de fichiers et de dossiers dans Azure Backup
...
<a id="cause1"></a>
## Cause : goulots d’étranglement de performances sur l’ordinateur
...
| Disque logique (disque physique)--% moy. disque s/lecture ou disque s/écriture | • 0,001 ms à 0,015 ms = sain</br>• 0,015 ms à 0,025 ms = avertissement ou surveillance</br>• 0,026 ms ou plus = critique ou hors spécifications|
...
> [AZURE.NOTE] Si vous déterminez que l’infrastructure est la cause du problème, nous vous recommandons de défragmenter les disques régulièrement pour de meilleures performances.

<a id="cause2"></a>
## Cause : un autre processus ou logiciel antivirus interfère avec Azure Backup
...
<a id="cause3"></a>
## Cause : l’agent de sauvegarde est en cours d’exécution sur une machine virtuelle Azure
...
<a id="cause4"></a>
## Cause : vous sauvegardez un grand nombre de fichiers (plusieurs millions)
