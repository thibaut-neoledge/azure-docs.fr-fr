        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prise en main de la sauvegarde des machines virtuelles Azure avec le serveur de sauvegarde Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/recoveryservices">Informations de référence sur l’API REST de Recovery Services</a></p>
                    </div>
                </div>
            </div>
        </div>
