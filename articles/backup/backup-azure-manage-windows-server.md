...
## Tableau de bord
Sélectionnez **Dashboard** pour afficher l’aperçu de l’utilisation du serveur. En bas du tableau de bord, vous pouvez réaliser les tâches suivantes :
