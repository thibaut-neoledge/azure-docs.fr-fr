...
Cet article offre une vue d’ensemble des tâches de gestion des sauvegardes disponibles via le portail de gestion et l’agent Microsoft Azure Backup.

>[AZURE.NOTE] Cet article fournit les procédures permettant de travailler dans le modèle de déploiement classique.
...
2. Cliquez sur **Recovery Services**, puis sur le nom du coffre de sauvegarde pour afficher la page de démarrage rapide.
    ...
    ![Gérer les onglets d’Azure Backup](./media/backup-azure-manage-windows-server/rs-left-nav.png)

Sélectionnez les options situées en haut de la page de démarrage rapide pour afficher les tâches de gestion disponibles.

![Gérer les onglets d’Azure Backup](./media/backup-azure-manage-windows-server/qs-page.png)
...
![Éléments inscrits](./media/backup-azure-manage-windows-server/registered-items.png)
...
![Éléments protégés](./media/backup-azure-manage-windows-server/protected-items.png)
...
![Configuration](./media/backup-azure-manage-windows-server/configure.png)
...
2. Sélectionnez la case **Activer la limitation de la bande passante sur Internet pour les opérations de sauvegarde**.
