...
| /sk:<*StorageAccountKey*> | Clé du compte de stockage vers lequel les données seront importées. Elle doit être identique à celle qui a été entrée lors de la création de la stratégie de sauvegarde/du groupe de protection.|
