...
| Sauvegardes cohérentes des applications | L’exécution de sauvegardes cohérentes au niveau applicatif sur Windows évite l’application de correctifs au moment de la restauration. Cela permet de réduire le RTO et de rétablir plus rapidement l’environnement du client. |
...
| Azure Backup (extension de machine virtuelle) | <p>Oui</p> <p>Spécialisé dans la [sauvegarde des machines virtuelles Azure IaaS](backup-azure-vms-introduction.md).</p> | <p>**Non**</p> <p>Utilisez SCDPM pour sauvegarder des machines virtuelles dans votre centre de données.</p> | <p>Coffre Azure Backup</p> |

## Quelles applications et charges de travail puis-je sauvegarder ?
...
### 3\. Charges de travail prises en charge
...
### 5\. Sauvegarde et rétention

| | Agent Azure Backup | SCDPM et Azure Backup Server | Azure Backup (extension de machine virtuelle) |
| --- | --- | --- | --- |
