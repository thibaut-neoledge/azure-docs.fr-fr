<properties 
	pageTitle="Gestion d’Azure Backup à l’aide d’Azure Automation" 
	description="Découvrez comment utiliser le service Azure Automation pour gérer Azure Backup." 
...
Ce guide vous présente le service Azure Automation et décrit comment l’utiliser pour simplifier la gestion d’Azure Backup.
...
Dans Azure Automation, la gestion d’Azure Backup peut être effectuée à l’aide d’applets de commande PowerShell qui sont fournies dans le [module Windows MSOnlineBackup](https://technet.microsoft.com/fr-fr/library/hh770400.aspx). Azure Automation peut appeler ces applets de commande PowerShell pour vous permettre d'effectuer toutes vos tâches de gestion d'Azure Backup au sein du service. Dans Azure Automation, vous pouvez également associer ces applets de commande à des applets de commande d'autres services Azure, afin d'automatiser des tâches complexes entre des services Azure et des systèmes tiers.


## Étapes suivantes

Maintenant que vous connaissez les bases d’Azure Automation et que vous savez l’utiliser pour gérer Azure Backup, cliquez sur les liens ci-dessous pour en savoir plus sur Azure Automation.
