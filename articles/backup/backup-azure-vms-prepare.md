...
2. Dans l’**Assistant Nouvelle règle de trafic entrant**, choisissez l’option **personnalisée** comme **Type de règle**, puis cliquez sur **Suivant**. Dans la page servant à sélectionner le **programme**, choisissez **Tous les programmes**, puis cliquez sur **Suivant**.

3. Dans la page **Protocoles et ports**, utilisez les entrées du tableau ci-dessous et cliquez sur **Suivant** :
...
| Port local | Dans la liste déroulante, sélectionnez **Ports spécifiques**. Dans la zone de texte, saisissez le ```<Proxy Port>``` configuré. |
