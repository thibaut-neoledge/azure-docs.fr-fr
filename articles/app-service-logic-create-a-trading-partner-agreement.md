...
Les partenaires commerciaux sont des entités impliquées dans des communications B2B (entreprise à entreprise). Quand deux partenaires établissent une relation, on emploie le terme  *Agreement*. L'accord défini est basé sur le type de communication dont les deux partenaires souhaitent bénéficier. Il est spécifique au protocole ou au transport. Les différents protocoles et transports B2B pris en charge  par Azure App Service sont les suivants :
