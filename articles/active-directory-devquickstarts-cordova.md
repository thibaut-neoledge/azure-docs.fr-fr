...
## *2. Clonage des référentiels requis pour le didacticiel*
...
##### Pour générer et exécuter une version d’application Windows Tablet/PC
...
##### Pour générer et exécuter l’application sur Windows Phone 8.1
...
##### Pour générer et exécuter sur un appareil Android
...
##### Pour générer et exécuter sur un appareil iOS
