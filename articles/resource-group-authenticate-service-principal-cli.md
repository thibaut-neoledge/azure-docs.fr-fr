...
2. Connectez-vous en tant que principal du service.
...
4. Connectez-vous à votre compte.
        ...
        azure config mode arm
        azure login
5. Créez un principal du service pour votre application. Indiquez un nom d’affichage, l’URI vers une page décrivant votre application, les URI identifiant votre application et les données de certificat que vous avez copiées. Cette commande crée à la fois l’application AD et le principal du service.
