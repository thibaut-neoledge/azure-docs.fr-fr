...
For details about storage account capacity and throughput, see [Azure Storage Scalability and Performance Targets][].
...
-   To learn more about Azure Storage, see the Azure Storage documentation on [azure.com][] and on [MSDN][].
