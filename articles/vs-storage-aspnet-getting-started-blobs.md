<properties pageTitle="Prise en main d'Azure Storage" description="" services="storage" documentationCenter="" authors="kempb" manager="douge" editor=""/>
...
> [AZURE.SELECTOR]
> - [Prise en main](/documentation/articles/vs-storage-aspnet-getting-started-blobs/)
...
Pour plus d'informations, consultez le sit [ASP.NET](http://www.asp.net).
