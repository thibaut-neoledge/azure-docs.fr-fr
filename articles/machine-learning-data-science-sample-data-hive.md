<properties 
	pageTitle="Échantillonner des données dans des tables Hive Azure HDInsight | Azure" 
...
Pour plus d'informations sur les méthodes d'échantillonnage plus élaborées qui sont disponibles dans Hive, voir la [page consacrée aux méthodes d'échantillonnage dans le manuel du langage Hive (en anglais)](https://cwiki.apache.org/confluence/display/Hive/LanguageManual+Sampling).
