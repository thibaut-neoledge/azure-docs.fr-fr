...
<div class="dev-center-tutorial-subselector">
    ...
    <a href="/fr-fr/documentation/articles/mobile-services-windows-store-dotnet-get-started-data/" title="JavaScript backend">JavaScript backend</a>
</div>
...
4.  Dans Visual Studio, ouvrez le fichier App.xaml.cs. Collez l'extrait de code au début de la définition de classe `App`. Ajoutez l'instruction `using` suivante au début du fichier et enregistrez-le :
