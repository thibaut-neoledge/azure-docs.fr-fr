...
[.NET backend](/fr-fr/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started-data/ ".NET backend") | [JavaScript backend](/en-us/develop/mobile/tutorials/get-started-with-data-dotnet/ "JavaScript backend")
...
Création d'un service mobileCréation d'un service mobile
--------------------------------------------------------
...
1.  Dans Visual Studio, ouvrez App.xaml.cs. Placez en commentaire le code permettant de créer le client `MobileServiceClient` qui se connecte au service mobile hébergé localement. Annulez le commentaire du code permettant de créer le client `MobileServiceClient` qui se connecte à votre service sous Azure. Enregistrez vos modifications dans le fichier.
         ...
         sealed partial class App : Application
         {
             ...
             //);
             // Utilisez plutôt ce constructeur après publication sur le cloud
             public static MobileServiceClient MobileService = new MobileServiceClient(
...
[Get started with Mobile Services]: /fr-fr/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started/
