<properties 
   pageTitle="Interface utilisateur d'Azure Mobile Engagement - Navigation" 
   description="Vue d'ensemble de l'interface utilisateur pour la section Navigation de d'Azure Mobile Engagement" 
...
Le portail frontal de l'interface utilisateur à : https://YourApp.portal.mobileengagementwindows.net/ contient les éléments de navigation suivants : une en-tête, un pied de page, un encadré, une barre de navigation avec cookies et un ruban spécifiques aux applications.
 
![Navigation1][1] 

## En-tête :
- **Azure Mobile Engagement (Logo)** : la page d'accueil de votre application Azure Mobile Engagement
- **Votre nom** : le profile de Mon Compte
- **Documentation** :[Documentation relative à Azure Mobile Engagement][Link 10]
- **Se déconnecter** : se déconnecter de Azure Mobile Engagement
 
## Pied de page :
- **Conditions du service** [http://azure.microsoft.com/support/legal/](http://azure.microsoft.com/support/legal/)
- **Confidentialité et cookies** [http://www.microsoft.com/privacystatement/OnlineServices/Default.aspx](http://www.microsoft.com/privacystatement/OnlineServices/Default.aspx)
 
## Cookie :
- Naviguez rapidement vers les précédentes pages menant à la page où vous vous trouvez actuellement.
