<properties title="How to create a PHP website in Azure Websites" pageTitle="Création d'un site web PHP dans Sites Web Azure" metaKeywords="Sites Web Azure PHP" description="Learn how to create a PHP website in Azure Websites" documentationCenter="PHP" services="Web Sites" editor="mollybos" manager="wpickett" authors="tomfitz" />
