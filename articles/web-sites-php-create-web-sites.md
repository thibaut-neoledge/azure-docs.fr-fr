<properties title="How to create a PHP website in Azure Websites" pageTitle="Création d'un site web PHP dans Sites Web Azure" metaKeywords="PHP Azure Web Sites" description="Découvrez comment créer un site web PHP dans Sites Web Azure." documentationCenter="PHP" services="Web Sites" editor="mollybos" manager="wpickett" authors="tomfitz" />
...
1. Cliquez sur **Nouveau** en bas de la page, puis sélectionnez **Calculer**, **Site Web** et **Création rapide**. Indiquez une **URL** pour votre site web, puis sélectionnez la **Région** de votre site web. Pour finir, cliquez sur **Créer un site web**.
	...
	![Sélectionnez Création rapide](./media/web-sites-php-create-web-sites/select-quickcreate-website.png)
...
1. Installez les outils en ligne de commande Azure en suivant les instructions disponibles ici : [Comment installer les outils en ligne de commande Azure pour Mac et Linux](/fr-fr/develop/php/how-to-guides/command-line-tools/#Download).

1. Téléchargez et importez votre fichier de paramètres de publication en suivant les instructions disponibles ici : [Comment télécharger et importer les paramètres de publication](/fr-fr/develop/php/how-to-guides/command-line-tools/#Account).

1. Exécutez la commande suivante depuis une invite de commandes :

		azure site create MySiteName

L'URL du site web nouvellement créé sera " http://NomDeMonSiteWeb.azurewebsites.net ".  
 
Notez que vous pouvez exécuter la commande `azure site create` avec n'importe laquelle des options suivantes :
...
Pour plus d'informations sur les options supplémentaires, consultez [Comment créer et gérer un site web Azure](/fr-fr/develop/php/how-to-guides/command-line-tools/#WebSites).
...
Notez que vous pouvez exécuter la commande `New-AzureWebSite` avec n'importe laquelle des options suivantes :
...
Pour obtenir des didacticiels complets, rendez-vous sur la page [Didacticiels du Centre de développement PHP](/fr-fr/develop/php/tutorials/) .
