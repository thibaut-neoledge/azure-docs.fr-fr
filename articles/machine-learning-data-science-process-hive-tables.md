...
dans un navigateur Web. Notez que vous devez saisir les identifiants du cluster Hadoop pour vous y connecter. L'autre solution consiste à [envoyer des requêtes Hive à l'aide de PowerShell](hdinsight-submit-hadoop-jobs-programmatically.md#hive-powershell). 
