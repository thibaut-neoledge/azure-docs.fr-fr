<properties 
	...
	description="Découvrez comment utiliser Azure .Net Runtime Mobile Services et Notification Hubs pour envoyer des notifications Push à votre application Windows Store JavaScript." 
