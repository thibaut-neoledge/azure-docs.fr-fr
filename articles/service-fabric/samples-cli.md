...
La table suivante contient des liens vers des exemples de scripts [Service Fabric CLI](service-fabric-cli.md) qui gèrent les clusters, applications et services Service Fabric.
