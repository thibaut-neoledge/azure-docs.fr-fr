...
---
# Cycle de vie des acteurs, Garbage Collection automatique et suppression manuelle
...
> [!TIP]
> Le runtime Fabric Actors émet des [événements liés à l'activation et la désactivation des acteurs](service-fabric-reliable-actors-diagnostics.md#actor-activation-and-deactivation-events). Ces derniers sont utiles dans les diagnostics et la surveillance des performances.
> 
> 
...
## Suppression des acteurs et de leur état
