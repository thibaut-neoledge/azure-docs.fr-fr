...
# Connexion à un cluster sécurisé sans AAD
...
## Se connecter à un cluster sécurisé avec l’interface de ligne de commande Azure sans AAD
...
## Se connecter à un cluster sécurisé via PowerShell, sans AAD
