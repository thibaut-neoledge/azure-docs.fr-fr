...
Le SDK Service Fabric fournit le même ensemble de modèles ASP.NET Core que ceux disponibles pour les projets ASP.NET Core autonomes : vide, [API Web][aspnet-webapi] et [Application Web][aspnet-webapp].
