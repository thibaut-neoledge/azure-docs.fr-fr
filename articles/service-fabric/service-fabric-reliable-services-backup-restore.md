...
* En cas de perte permanente d’un cluster Service Fabric complet ou de tous les nœuds exécutant une partition donnée. Cela peut se produire, par exemple, si l’état n’est pas répliqué géographiquement, et que votre cluster entier se trouve dans un centre de données qui tombe en panne.
