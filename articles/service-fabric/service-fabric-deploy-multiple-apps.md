---
title: Déploiement d'une application Node.js à l'aide de MongoDB | Microsoft Docs
...
> [!NOTE]
> Avec Visual Studio, vous pouvez publier l’application localement en effectuant le débogage (F5) ou en utilisant l’assistant de publication.
> 
> 
