...
Les fonctionnalités de testabilité se trouvent dans System.Fabric.Testability.dll. Ce fichier dll se trouve dans le package NuGet Microsoft.ServiceFabric.Testability.nupack. Pour pouvoir utiliser les fonctionnalités de testabilité, incorporez le package NuGet en tant que référence dans votre projet.
