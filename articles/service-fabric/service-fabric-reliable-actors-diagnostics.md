...
Le runtime Reliable Actors émet les événements suivants liés aux [réplicas d'acteur](service-fabric-reliable-actors-platform.md#service-fabric-partition-concepts-for-stateful-actors).
