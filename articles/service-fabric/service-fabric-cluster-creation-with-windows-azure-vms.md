...
1. Connectez-vous au portail Azure et créez une machine virtuelle Windows Server 2012 R2 Datacenter dans un groupe de ressources. Lisez l’article [Créer une machine virtuelle Windows dans le portail Azure](../virtual-machines/virtual-machines-windows-hero-tutorial.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) pour plus d’informations.
