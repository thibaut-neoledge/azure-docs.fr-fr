...
* **Empaqueter** : assemble l'application en package. Cette action peut être utile pour préparer le déploiement de l'application sur un autre cluster, par exemple, sur Azure.
