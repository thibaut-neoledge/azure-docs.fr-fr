<properties
   pageTitle="Gérer un service Service Fabric | Microsoft Azure"
   description="Informations conceptuelles et didacticiels qui vous aideront à gérer un service Service Fabric."
...
- [Sécuriser le trafic de réplication des services avec état](service-fabric-replication-security.md)
...
Les articles suivants décrivent la mise à l'échelle et le partitionnement :
