...
## <a name="create-and-run-the-web-performance-and-load-test-project"></a>Créer et exécuter le projet de test de performance web et de charge
...
3. Dans la section **Combinaison de tests**, cliquez sur le bouton **Ajouter**, puis sélectionnez le test que vous voulez ajouter au test de charge. Vous pouvez utiliser la colonne **Distribution** pour spécifier le pourcentage du nombre total de tests exécutés pour chaque test.
4. Dans la section **Paramètres d’exécution** , spécifiez la durée du test de charge.

   > [!NOTE]
   > L’option **Itérations de tests** est disponible uniquement quand vous exécutez un test de charge localement à l’aide de Visual Studio.
   >
   >
...
## <a name="view-and-analyze-the-load-test-results"></a>Afficher et analyser les résultats du test de charge
