...
# Configurer les stratégies de sécurité de votre application
...
## Configurer la stratégie pour le service SetupEntryPoint
...
### Configurer la stratégie à l’aide d’un compte local
...
###  Configurer la stratégie à l’aide de comptes système locaux
...
## Configurer la stratégie pour les packages de code de service 
...
~~~
### À l’aide d’un utilisateur ou groupe de domaine Active Directory
