<properties
   pageTitle="Modèle de conception Smart Cache d'Azure Service Fabric Actors"
   description="Modèle de conception sur l'utilisation de Service Fabric Actors comme infrastructure de mise en cache dans les applications Web"
