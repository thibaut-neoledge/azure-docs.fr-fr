...
## Empaquetage d’un exécutable existant
...
<a id="manually"></a>
## Empaquetage et déploiement manuels d’un exécutable existant
...
#### Mise à jour de l’élément ServiceTypes
...
#### Mise à jour de l’élément CodePackage
...
#### Facultatif : mise à jour de l’élément SetupEntrypoint
...
#### Mise à jour de l’élément Entrypoint
...
#### Mise à jour des points de terminaison et inscription auprès du service d’affectation de noms à des fins de communication
