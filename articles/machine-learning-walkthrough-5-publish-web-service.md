...
Vous voici arrivé à la cinquième étape du didacticiel pas à pas [Développement d'une solution de prévision avec Azure ML][Développement d'une solution de prévision avec Azure ML] :
...
1.  Cliquez sur **Enregistrer sous** sous le canevas.
...
2.  Supprimez les modules **Former le modèle** et **Noter le modèle** associés.
...
Pour publier un service web dérivé de notre expérience, cliquez sur **PUBLIER LE SERVICE WEB** sous le canevas et cliquez sur **OUI** à l'invite. ML Studio publie l'expérience en tant que service web sur le serveur intermédiaire ML et vous amène au tableau de bord du service.
...
Dans l'onglet **CONFIGURATION**, cliquez sur « OUI » à côté de **PRÊT POUR LA PRODUCTION ?**. Cette action signale à votre administrateur informatique que ce service web est prêt à entrer en activité. L'administrateur peut alors le transférer sur le serveur en activité.

![Promoting the service to the live environment][Promoting the service to the live environment]

------------------------------------------------------------------------

**Suivant : [Accès au service web][Accès au service web]**
