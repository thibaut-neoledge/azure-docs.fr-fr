<properties urlDisplayName="Get started with cross-platform settings sync in Mobile Services" pageTitle="Prise en main de la synchronisation des paramètres multiplateformes dans Mobile Services | Centre de développement mobile" metaKeywords="" description="Learn how to get started with cross-platform settings sync in Mobile Services." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Get started with cross-platform settings sync in Mobile Services" authors="mahender" manager="dwrede" />
...
# Prise en main de la synchronisation des paramètres multiplateforme dans Mobile Services
