...
##### Activation de la connexion point à site dans un réseau virtuel Classic #####
...
##### Activation de la connexion point à site dans un réseau virtuel Resource Manager #####
...
- **Présence d’un pare-feu** Si vous utilisez un pare-feu, vous dépasserez le délai d’expiration TCP. Dans ce cas, il est de 21 secondes. Utilisez l’outil tcpping pour tester la connectivité. Les délais d’expiration TCP peuvent avoir de nombreuses autres origines, mais commencez par vérifier ce point.
