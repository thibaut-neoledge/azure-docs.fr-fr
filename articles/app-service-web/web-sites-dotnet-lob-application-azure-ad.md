...
9. Faites défiler jusqu’à la section **Clés** et ajoutez une clé en sélectionnant une durée. Ensuite, cliquez sur **Autorisations déléguées** et sélectionnez **Lire les données de l’annuaire**. Cliquez sur **Enregistrer**.
...
13. Ouvrez ~\\App\_Start\\BundleConfig.cs et apportez les modifications suivantes :
