---
title: "Déployer votre première application web Node.js dans Azure en 5 minutes (CLI 2.0 version préliminaire) | Microsoft Docs"
...
---
# <a name="deploy-your-first-nodejs-web-app-to-azure-in-five-minutes-cli-20-preview"></a>Déployer votre première application web Node.js dans Azure en 5 minutes (CLI 2.0 version préliminaire)
...
4. Vous obtenez ensuite l’exemple de code Node.js que vous souhaitez déployer. Passez à un répertoire de travail (`CD`) et clonez l’exemple d’application comme ce qui suit :
...
[Créez, configurez et déployez une application web Node.js Express dans Azure](app-service-web-nodejs-get-started.md). En suivant ce didacticiel, vous acquerrez les compétences de base nécessaires pour exécuter n’importe quelle application web Node.js dans Azure. Vous apprendrez notamment à :
