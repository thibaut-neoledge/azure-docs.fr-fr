...
1.  Dans l’**Explorateur de serveurs**, accédez à **Azure > App Service > MonExempleGroupe**, puis développez le nœud pour votre application web.
