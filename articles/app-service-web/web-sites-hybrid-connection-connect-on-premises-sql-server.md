...
[Connexion à un serveur SQL Server local à partir d’un service mobile Azure au moyen de connexions hybrides](../mobile-services/mobile-services-dotnet-backend-hybrid-connections-get-started.md)
