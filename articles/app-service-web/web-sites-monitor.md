...
> [AZURE.NOTE] Si la commande **azure** n’est pas installée, consultez la page [Installer l’interface de ligne de commande Azure](../xplat-cli-install.md) pour en savoir plus sur l’installation et la configuration de cette commande.
