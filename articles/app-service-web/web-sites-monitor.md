...
> [AZURE.NOTE] Si la commande **azure** n’est pas installée, consultez la page [Utilisation de la ligne de commande Azure](../virtual-machines/virtual-machines-command-line-tools.md) pour en savoir plus sur l’installation et la configuration de cette commande.
