...
Votre application web est créée en quelques instants. Pour visualiser l’application web, dans le panneau **Web Apps** du portail Azure, cliquez sur l’application web que vous venez de créer, puis sur son URL.
