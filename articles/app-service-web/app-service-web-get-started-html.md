---
title: "Déployer votre première application web HTML dans Azure en 5 minutes (CLI 2.0 version préliminaire) | Microsoft Docs"
...
---
# <a name="deploy-your-first-html-web-app-to-azure-in-five-minutes-cli-20-preview"></a>Déployer votre première application web HTML dans Azure en 5 minutes (CLI 2.0 version préliminaire)
...
- [Azure CLI 1.0](app-service-web-get-started-html-cli-nodejs.md) : notre interface de ligne de commande pour les modèles de déploiement Classique et Resource Manager
- [Azure CLI 2.0 (version préliminaire)](app-service-web-get-started-html.md) : notre interface de ligne de commande nouvelle génération pour le modèle de déploiement Resource Manager
...
4. Vous obtenez ensuite l’exemple de site HTML que vous souhaitez déployer. Passez à un répertoire de travail (`CD`) et clonez l’exemple d’application comme ce qui suit :
