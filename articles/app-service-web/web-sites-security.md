...
## Réalisation de tests d’intrusion sur votre application

L’une des méthodes les plus simples pour démarrer les tests de vulnérabilité de votre application App Service consiste à utiliser l’[intégration dans Tinfoil Security](/blog/web-vulnerability-scanning-for-azure-app-service-powered-by-tinfoil-security/) pour effectuer l’analyse des vulnérabilités sur votre application en un clic. Vous pouvez afficher les résultats des tests dans un rapport facile à comprendre et découvrir comment résoudre chaque problème de vulnérabilité grâce à des instructions pas à pas.
