...
9. Dans l’**Explorateur de serveurs**, cliquez avec le bouton droit sur votre application web, puis cliquez sur **Attacher le débogueur**.
    ...
    **Remarque :** si rencontrez des problèmes au démarrage du débogueur, essayez d’utiliser le **Cloud Explorer** au lieu de l’**Explorateur de serveurs**.
...
5. Dans la barre d’adresse du navigateur, ajoutez *trace.axd* à l’URL, puis appuyez sur Entrée (l’URL ressemblera à http://localhost:53370/trace.axd).
...
1. Dans l’**Explorateur de serveurs**, cliquez avec le bouton droit sur l’application Web, puis cliquez sur **Paramètres d’affichage**, comme vous l’avez fait précédemment.
2. Remplacez **Application Logging (File System)** par **Commentaires**, puis cliquez sur **Enregistrer**.
...
6. Sous l’onglet **Configurer** du portail Azure Classic, faites défiler vers le bas jusqu’à la section Diagnostic d’application, puis définissez **Journal des applications (Stockage de tables)** sur **Actif**.
...
12. Dans l’onglet **Journaux** de la fenêtre **Application web Microsoft Azure**, au sein de Visual Studio, cliquez sur **Actualiser** sous **Récapitulatif du diagnostic**.
