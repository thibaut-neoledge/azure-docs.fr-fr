...
## <a name="resourcecomposition"></a>Élaboration d’une solution
...
* des frais plus élevés pour le transfert de données sortantes entre les régions comme indiqué sur la [page de tarification Azure](https://azure.microsoft.com/pricing/details/data-transfers).

La colocalisation des ressources Azure composant une solution dans la même région constitue une meilleure pratique. Lors de la création de ressources, assurez-vous que celles-ci se trouvent dans la même région Azure, à moins que des motifs commerciaux ou conceptuels spécifiques entravent cette possibilité. Vous pouvez déplacer une application App Service vers la région dans laquelle se trouve votre base de données en tirant parti de la [fonctionnalité de clonage de l’application App Service](app-service-web-app-cloning-portal.md), actuellement disponible pour les applications du plan App Service Premium.

## <a name="resourcemanagement"></a>Optimisation de l’environnement Runtime
