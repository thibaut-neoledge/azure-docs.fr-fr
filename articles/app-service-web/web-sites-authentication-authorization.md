<properties 
	pageTitle="Authentification avec Active Directory local dans votre application Azure | Microsoft Azure" 
...
# Authentification avec Active Directory en local dans votre application Azure #
...
## S’authentifier via Azure Active Directory
...
-	L’[API Graph Azure AD](http://msdn.microsoft.com/library/azure/hh974476.aspx) permet à l’application d’accéder aux données d’annuaire depuis votre application Azure AD.
...
## S’authentifier via un service STS local
