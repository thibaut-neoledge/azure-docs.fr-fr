...
1.  Dans **l’Explorateur de solutions**, cliquez avec le bouton droit sur le nœud du projet, sélectionnez **Python**, puis **Django Migrate (Migration de Django)**. Sélectionnez ensuite **Django Create Superuser (Créer un superutilisateur Django)**.
...
1.  Installez le package `pyodbc` en utilisant **pip**.
