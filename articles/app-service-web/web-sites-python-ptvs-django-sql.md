...
2. En bas du panneau de navigation, cliquez sur **NOUVEAU**, puis sur **Données + stockage** > **Base de données SQL**.
...
6. Dans le panneau **Paramètres de pare-feu**, ajoutez une règle de pare-feu avec les champs **IP de début** et **IP de fin** définis sur l’adresse IP publique de votre ordinateur de développement. Cliquez sur **Enregistrer**.
