...
| [az webapp config container set](https://docs.microsoft.com/cli/azure/webapp/config/container#set) | Définit le conteneur Docker pour l’application web Azure. |
