...
1.  Accédez à la section **Paramètres de l’application** et définissez les valeurs **REPOSITORY_NAME**, **STORAGE_NAME** et **STORAGE_KEY** comme décrit dans la section **Configuration du projet**.
