---
title: "Création d’une application web Node.js dans Azure App Service | Microsoft Docs"
...
---
# <a name="create-a-nodejs-web-app-in-azure-app-service"></a>Créer une application web Node.js dans Azure App Service
...
3. Copiez le code suivant dans le fichier **server.js** , puis enregistrez le fichier :
...
4. Ouvrez la ligne de commande, puis utilisez la commande suivante pour démarrer l’application web localement.
   
        node server.js
5. Ouvrez votre navigateur web et accédez à la page http://localhost:1337. 
...
2. À partir de la ligne de commande, remplacez les répertoires par le répertoire **helloworld** , puis entrez la commande suivante pour initialiser un référentiel Git local.
   
        git init
3. Utilisez les commandes suivantes pour ajouter des fichiers au référentiel :
   
        git add .
        git commit -m "initial commit"
4. Ajoutez un Git distant pour la transmission des mises à jour vers l’application web créée précédemment, en utilisant la commande suivante :
   
        git remote add azure [URL for remote repository]
5. Transférez vos modifications dans Azure en utilisant la commande suivante :
...
6. Pour afficher votre application, cliquez sur le bouton **Parcourir** dans la partie **Application web** du portail Azure.
...
3. Dans la ligne de commande, remplacez les répertoires par le répertoire **helloworld** et exécutez les commandes suivantes :
...
4. Actualisez la fenêtre du navigateur avec laquelle vous avez accédé à l’URL de l’application web.
...
Cet article utilise le portail Azure pour créer une application web. Vous pouvez également utiliser l’[interface de ligne de commande Azure](../cli-install-nodejs.md) ou [Azure PowerShell](/powershell/azureps-cmdlets-docs) pour effectuer les mêmes opérations.
