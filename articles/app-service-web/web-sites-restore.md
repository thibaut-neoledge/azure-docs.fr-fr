...
La fonctionnalité de restauration App Service, accessible dans le panneau **Sauvegardes** du [portail Azure](https://portal.azure.com), n'est disponible que dans les niveaux de tarification Standard et Premium. Pour plus d'informations sur la mise à l'échelle de votre application en utilisant le niveau Standard ou Premium, consultez la page [Mise à l'échelle d'une application dans Azure App Service](web-sites-scale.md). Notez que le niveau Premium autorise un plus grand nombre de sauvegardes quotidiennes que le niveau Standard.
