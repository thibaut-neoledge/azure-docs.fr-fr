<properties 
	pageTitle="Architecture de sécurité en couche avec les environnements App Service" 
...
[InboundTraffic]: https://azure.microsoft.com/fr-FR/documentation/articles/app-service-app-service-environment-control-inbound-traffic/
