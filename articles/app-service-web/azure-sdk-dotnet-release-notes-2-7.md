...
# <a name="azure-sdk-for-.net-2.7-and-.net-2.7.1-release-notes"></a>Notes de publication du Kit de développement logiciel (SDK) Azure pour .NET 2.7 et .NET 2.7.1
...
##<a name="azure-sdk-for-.net-2.7"></a>Kit de développement logiciel (SDK) Azure pour .NET 2.7
...
###<a name="<a-name="cloud_explorer"></a>cloud-explorer-for-visual-studio-2015"></a><a name="cloud_explorer"></a>Cloud Explorer pour Visual Studio 2015
...
##<a name="azure-sdk-for-.net-2.7.1"></a>Kit de développement logiciel (SDK) Azure pour .NET 2.7.1
