...
Bien que le sujet ne soit pas abordé dans cette rubrique, n’oubliez pas que chaque instance individuelle de l’application doit également enregistrer le domaine personnalisé. Si ce n’est pas le cas, si une demande s’adresse à une instance d’application et que l’application ne dispose pas d’un domaine personnalisé enregistré avec l’application, la demande échoue.
