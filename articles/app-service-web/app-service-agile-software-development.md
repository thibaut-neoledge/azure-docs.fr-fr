...
5. Lorsque vous y êtes invité, tapez le nom d’utilisateur et le mot de passe souhaités pour l’accès à la base de données.
   ...
   > [!TIP]
   > Examinez *&lt;racine\_référentiel>*\\ARMTemplates\\Deploy.ps1 pour voir comment il génère des ressources avec des ID uniques. Vous pouvez utiliser la même approche pour créer des clones de déploiement sans vous soucier des noms de ressource en conflit.
   > 
   > 
