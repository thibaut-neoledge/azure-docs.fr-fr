...
4. À partir du menu de gauche, cliquez sur **App Services** > **&lt;nom_application** > **Outils**.
    ...
    >[AZURE.TIP] Si vous cliquez sur **Paramètres** au lieu de l’option **Outils**, vous accéderez au panneau **Paramètres de l’application** 
...
4. Faites défiler le panneau jusqu’en bas et accédez au répertoire virtuel racine pour pointer vers **site\wwwroot\public** au lieu de **site\wwwroot**.
