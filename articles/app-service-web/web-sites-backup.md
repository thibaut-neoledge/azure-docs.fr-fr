...
* toutes bases de données SQL Azure ou bases de données MySQL connectées à votre application (vous pouvez choisir l’élément à inclure dans votre sauvegarde).
