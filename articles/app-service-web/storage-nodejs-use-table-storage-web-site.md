<properties
	...
	description="Ce didacticiel vous explique comment utiliser le service de Table Azure pour stocker les données d'une application Node.hs hébergée dans Azure App Service Web Apps."
	tags="azure-portal"
