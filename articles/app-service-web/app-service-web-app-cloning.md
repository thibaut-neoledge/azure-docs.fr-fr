...
Scénario : un utilisateur dispose déjà d’un profil Traffic Manager Azure Resource Manager auquel il souhaite ajouter les deux applications web comme points de terminaison. Pour ce faire, nous devons tout d’abord assembler l’ID de profil Traffic Manager existant. Nous avons besoin de l’ID d’abonnement, du nom de groupe de ressources et du nom du profil Traffic Manager existant.
