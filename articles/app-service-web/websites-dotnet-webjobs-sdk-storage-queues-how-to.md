...
## <a name="a-idtriggera-how-to-trigger-a-function-when-a-queue-message-is-received"></a><a id="trigger"></a> Comment déclencher une fonction lors de la réception d’un message de file d’attente
...
### <a name="a-idqtattributetypesa-types-the-queuetrigger-attribute-works-with"></a><a id="qtattributetypes"></a> Types gérés par l’attribut QueueTrigger
...
### <a name="a-idpollinga-polling-algorithm"></a><a id="polling"></a> Algorithme d’interrogation
...
### <a name="a-idinstancesa-multiple-instances"></a><a id="instances"></a> Instances multiples
...
### <a name="a-idparallela-parallel-execution"></a><a id="parallel"></a> Exécution en parallèle
...
### <a name="a-idqueuemetadataaget-queue-or-queue-message-metadata"></a><a id="queuemetadata"></a>Obtenir des métadonnées de file d’attente ou de message en file d’attente
...
### <a name="a-idgracefulagraceful-shutdown"></a><a id="graceful"></a>Arrêt approprié
...
## <a name="a-idcreatequeuea-how-to-create-a-queue-message-while-processing-a-queue-message"></a><a id="createqueue"></a> Comment créer un message de file d’attente lors du traitement d’un message de file d’attente
...
### <a name="a-idibinderause-webjobs-sdk-attributes-in-the-body-of-a-function"></a><a id="ibinder"></a>Utilisation des attributs du Kit de développement logiciel (SDK) WebJobs dans le corps d’une fonction
...
## <a name="a-idblobsa-how-to-read-and-write-blobs-and-tables-while-processing-a-queue-message"></a><a id="blobs"></a> Comment lire et écrire des objets blob et des tables lors du traitement d’un message en file d’attente
...
### <a name="a-idpocoblobsa-poco-plain-old-clr-objecthttpenwikipediaorgwikiplainoldclrobject-queue-messages"></a><a id="pocoblobs"></a> Messages en file d’attente POCO [(Plain Old CLR Object](http://en.wikipedia.org/wiki/Plain_Old_CLR_Object))
...
### <a name="a-idblobattributetypesa-types-you-can-use-the-blob-attribute-with"></a><a id="blobattributetypes"></a> Types avec lesquels vous pouvez utiliser l’attribut blob
...
## <a name="a-idpoisona-how-to-handle-poison-messages"></a><a id="poison"></a> Gestion des messages incohérents
...
## <a name="a-idconfiga-how-to-set-configuration-options"></a><a id="config"></a> Définition des options de configuration
...
### <a name="a-idsetconnstraset-sdk-connection-strings-in-code"></a><a id="setconnstr"></a>Définition des chaînes de connexion du Kit de développement logiciel (SDK) dans le code
...
### <a name="a-idconfigqueueaconfigure-queuetrigger--settings"></a><a id="configqueue"></a>Configuration des paramètres QueueTrigger
...
### <a name="a-idsetnamesincodeaset-values-for-webjobs-sdk-constructor-parameters-in-code"></a><a id="setnamesincode"></a>Définition des valeurs des paramètres de constructeur du Kit de développement logiciel (SDK) WebJobs dans le code
...
## <a name="a-idmanualahow-to-trigger-a-function-manually"></a><a id="manual"></a>Déclenchement manuel d’une fonction
...
## <a name="a-idlogsahow-to-write-logs"></a><a id="logs"></a>Écriture de journaux
...
## <a name="a-iderrorsahow-to-handle-errors-and-configure-timeouts"></a><a id="errors"></a>Gestion des erreurs et configuration des délais d'attente
