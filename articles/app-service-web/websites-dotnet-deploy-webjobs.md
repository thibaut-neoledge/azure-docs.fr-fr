...
Les fonctionnalités de déploiement de WebJobs sont disponibles dans Visual Studio lorsque vous installez le Kit de développement logiciel (SDK) Azure pour .NET :
