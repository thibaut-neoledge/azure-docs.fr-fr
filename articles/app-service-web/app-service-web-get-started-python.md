...
description: "Découvrez la facilité avec laquelle vous pouvez exécuter des applications web dans App Service en déployant un exemple d’application Python."
...
---
# <a name="create-your-first-python-web-app-in-azure-in-five-minutes"></a>Créer votre première application web Python dans Azure en&5; minutes
[!INCLUDE [app-service-web-selector-get-started](../../includes/app-service-web-selector-get-started.md)]

Ce démarrage rapide vous permet de déployer votre première application web Python dans [Azure App Service](../app-service/app-service-value-prop-what-is.md) en quelques minutes.
...
4. Déployez un exemple d’application Python à partir de GitHub.
...
Félicitations, votre première application web Python s’exécute en temps réel dans Azure App Service.
