<properties
	pageTitle="Comparaison entre Azure App Service, Virtual Machines, Service Fabric et Cloud Services | Microsoft Azure"
...
Azure propose plusieurs manières d’héberger des sites web : [Azure App Service][], [Virtual Machines][], [Service Fabric][] et [Cloud Services][]. Cet article vous aidera à comprendre ces différentes possibilités et à faire le bon choix en fonction de votre application web.
