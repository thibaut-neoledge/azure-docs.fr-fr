<properties 
    pageTitle="Notes de publication de StorSimple - Février 2015"
...
# Notes de publication de StorSimple - Février 2015

## Vue d'ensemble

Les notes de publication suivantes identifient les problèmes critiques de la version de février 2015 de Microsoft Azure StorSimple. Elles contiennent également une liste des mises à jour du logiciel et du microprogramme StorSimple incluses dans cette version. Il s’agit de la troisième version après la version mise à la disposition générale de Microsoft Azure StorSimple.
...
## Problèmes résolus dans la version de février
...
## Problèmes connus dans la version de février
...
## Mises à jour de l’appareil physique dans la version de février
...
## Mises à jour pour le microprogramme et le contrôleur SAS (Serial Attached SCSI) dans la version de février
...
## Mises à jour pour l’appareil virtuel dans la version de février
