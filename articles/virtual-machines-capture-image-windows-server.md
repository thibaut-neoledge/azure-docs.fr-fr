...
Azure traite ce modèle comme une image et le stocke sous **Mes images**. C'est aussi là que sont stockées les images que vous avez chargées. Pour plus d'informations sur les images, consultez [À propos des images de machines virtuelles dans Azure][À propos des images de machine virtuelle dans Azure].
