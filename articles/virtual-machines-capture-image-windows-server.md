<properties urlDisplayName="Capture an image" pageTitle="Capture de l'image d'une machine virtuelle ex&eacute;cutant Windows&nbsp;Server" metaKeywords="Azure capture image vm, capturing vm" description="Apprenez &agrave; capturer une image d'une machine virtuelle&nbsp;Azure ex&eacute;cutant Windows&nbsp;Server&nbsp;2008&nbsp;R2. " metaCanonical="" services="virtual-machines" documentationCenter="" title="Capture de l'image d'une machine virtuelle ex&eacute;cutant Windows Server" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
-   [Association d’un disque de données avec une machine virtuelle][Association d’un disque de données avec une machine virtuelle]

## Capture de la machine virtuelle

1.  Connectez-vous à la machine virtuelle en cliquant sur **Connecter** dans la barre de commandes. Pour plus d'informations, consultez [Connexion à une machine virtuelle exécutant Windows Server][Connexion à une machine virtuelle exécutant Windows Server].
...
4.  La boîte de dialogue **Outil de préparation système** apparaît. Effectuez les actions suivantes :
    ...
    -   Dans **Action de nettoyage du système**, sélectionnez **Enter System Out-of-Box Experience (OOBE)** et vérifiez que la case à cocher **Generalize** est activée. Pour plus d'informations sur l'utilisation de Sysprep, consultez la page [Utilisation de Sysprep : introduction][Utilisation de Sysprep : introduction].

    -   Dans **Shutdown Options**, sélectionnez **Shutdown**.

    -   Cliquez sur **OK**.

    ![Exécutez Sysprep][Exécutez Sysprep]

5.  Sysprep arrête la machine virtuelle, ce qui définit l'état de la machine virtuelle dans le [portail de gestion][portail de gestion] sur **Arrêté**.
...
7.  Dans la barre de commandes, cliquez sur **Capture**.
    ...
    ![Capture machine virtuelle][Capture machine virtuelle]
...
10. Cliquez sur la coche pour capturer l'image. Lorsque vous capturez l'image d'une machine virtuelle généralisée, la machine virtuelle est supprimée.
    ...
    ![Capture d'image réussie][Capture d'image réussie]
