...
- Les pages [Cache Redis Microsoft Azure](https://azure.microsoft.com/services/cache/), [Azure DocumentDB](https://azure.microsoft.com/services/documentdb/) et [HDInsight](https://azure.microsoft.com/services/hdinsight/) sur le site web Microsoft.
- La page [Utilisation des files d’attente](service-bus-dotnet-how-to-use-queues.md) sur le site web Microsoft.
- L’article [Business Intelligence de SQL Server dans les machines virtuelles Azure](./virtual-machines/virtual-machines-windows-classic-ps-sql-bi.md) sur le site web Microsoft.
