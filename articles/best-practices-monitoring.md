...
Les données de performance de niveau inférieur pour les composants individuels dans un système peuvent être disponibles via des fonctionnalités telles que les compteurs de performances Windows et les diagnostics Windows Azure.
...
- L’article [Windows Azure: Telemetry Basics and Troubleshooting](http://social.technet.microsoft.com/wiki/contents/articles/18146.windows-azure-telemetry-basics-and-troubleshooting.aspx) sur le site web Microsoft.
