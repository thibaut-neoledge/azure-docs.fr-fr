...
Les plans d'hébergement web représentent un ensemble de fonctionnalités et de capacités que vous pouvez partager sur vos sites web.  Ils prennent en charge les 4 niveaux de tarification de Sites Web Azure (Gratuit, Partagé, De base et Standard), chacun étant doté de ses propres fonctionnalités.  Les sites d'un même abonnement, groupe de ressources ou emplacement géographique peuvent partager le même plan d'hébergement web. Tous les sites qui partagent un plan d'hébergement web peuvent tirer profit de l'ensemble des possibilités définies par ce plan. Tous les sites web associés à un plan d'hébergement web utilisent les ressources définies par ce plan. Par exemple, si votre plan d'hébergement web est configuré pour utiliser deux " petites " machines virtuelles, tous les sites associés à ce plan utiliseront les deux machines virtuelles. Comme toujours avec Sites Web Azure, les machines virtuelles que vos sites exécutent sont hautement disponibles et entièrement gérées.
</br>
...
Vous remarquerez également que vous disposez d'un groupe de ressources par défaut généré automatiquement dans chaque région dans laquelle vous avez déjà des sites web. Le nom du groupe de ressources généré automatiquement des sites web est *Default-Web-<NOM DE L'EMPLACEMENT>*, où le nom de l'emplacement représente une région Azure (par exemple *Default-Web-WestUS*). Dans chaque groupe de ressources, vous retrouvez tous vos sites pour la région du groupe. Chaque site que vous avez créé ou que vous allez créer dans la version préliminaire du portail Azure ou sa version complète sera disponible sur les deux portails. 
</br>
...
* Tous vos sites web du niveau **Gratuit** sont associés à un plan d'hébergement web **par défaut** avec le niveau de tarification défini sur **Gratuit**. 
</br>
* Tous vos sites web du niveau **Partagé** sont associés à un plan d'hébergement web **par défaut** avec le niveau de tarification défini sur **Partagé**
</br>
* Tous vos sites web du niveau **Standard** sont associés à un plan d'hébergement web par défaut avec le niveau de tarification défini sur **Standard**. 
</br>
...
**Réponse** : Un plan d'hébergement web est un conteneur. Vous ne pouvez donc pas créer de plan d'hébergement web vide. Toutefois, un nouveau plan d'hébergement web est explicitement créé pendant la création du site.
</br>
Pour ce faire, utilisez l'interface utilisateur de la nouvelle **version préliminaire du portail Azure **, cliquez sur **NOUVEAU** et sélectionnez **Site web** afin d'ouvrir le panneau de création de site web. Dans la première image ci-dessous, vous pouvez voir l'icône **NOUVEAU** en bas à gauche, et dans la seconde image, le panneau de création de **site web**, le panneau **Plan d'hébergement web** et le panneau **Niveau de tarification** :
</br>
</br>
...
**Réponse** : Les sites sont affectés à un plan d'hébergement web au cours du processus de création du site. Pour ce faire, utilisez l'interface utilisateur de la nouvelle **version préliminaire du portail Azure**, cliquez sur **NOUVEAU** et sélectionnez **Site web** :
</br>
</br>
...
Notez que chaque plan d'hébergement web a son propre niveau de tarification. Lorsque vous passez un site d'un plan d'hébergement web avec l'option **Gratuit** à un plan d'hébergement web **Standard**, votre site web peut utiliser toutes les fonctionnalités et les ressources du niveau Standard. 
</br>
</br>
...
Une autre méthode consiste à mettre à l'échelle un plan en augmentant son nombre d'instances. L'image ci-dessous présente les volets **Plan d'hébergement web** et **Échelle**. Cliquez sur la zone Mettre à l'échelle du panneau **Plan d'hébergement web** pour le développer, ce qui vous permet de modifier le nombre d'instances du plan :
</br>
</br>
