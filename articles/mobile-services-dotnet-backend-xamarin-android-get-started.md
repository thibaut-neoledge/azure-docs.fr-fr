...
2. Cliquez sur le bouton **Exécuter** pour générer le projet et démarrer l'application. Vous êtes invité à sélectionner un émulateur ou un périphérique USB connecté. 
...
[version relative au service principal JavaScript]: partner-xamarin-mobile-services-android-get-started.md
