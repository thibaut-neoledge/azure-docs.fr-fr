<properties urlDisplayName="Get Started with Mobile Services for Xamarin Android apps" pageTitle="Prise en main de Mobile Services pour les applications Xamarin Android - Azure Mobile Services" metaKeywords="" description="Follow this tutorial to get started using Azure Mobile Services for Xamarin Android development" metaCanonical="" services="" documentationCenter="Mobile" title="Get Started with Mobile Services for Xamarin Android apps" authors="donnam" solutions="" manager="dwrede" editor="mollybos" />
