...
Connectez-vous à un serveur FTP pour gérer vos fichiers. Vous pouvez effectuer différentes tâches sur le serveur FTP, telles que le chargement de fichiers et la suppression les fichiers.

L'API FTP peut être utilisée à partir d'applications logiques.
