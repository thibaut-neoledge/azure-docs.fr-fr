...
| --- | --- |
| Aucun. | <ul><li>Créer un fichier</li><li>Copier un fichier</li><li>Supprimer un fichier</li><li>Extraire une archive dans un dossier</li><li>Obtenir le contenu d’un fichier</li><li>Obtenir le contenu du fichier à l’aide du chemin</li><li>Obtenir les métadonnées d’un fichier</li><li>Obtenir les métadonnées d’un fichier à l’aide d’un chemin d’accès</li><li>Mettre à jour le fichier</li></ul> |
