<properties 
	pageTitle="Création d'un élément multimédia chiffré et chargement dans Azure Storage" 
	description="Apprenez à obtenir du contenu multimédia dans Media Services en créant et en chargeant un élément multimédia chiffré." 
