---
title: "Recommandations en matière de partitionnement | Microsoft Docs"
...
---
# <a name="data-partitioning-guidance"></a>Recommandations en matière de partitionnement des données
...
> Le terme *partitionnement* utilisé dans ces recommandations désigne le processus de division physique des données au sein de magasins de données distincts. Il convient de le distinguer du partitionnement de tables SQL Server, qui est un concept différent.
>
>
...
* Si le message appartient à une session, tous les messages présentant la même valeur concernant la propriété *SessionId* sont envoyés au même fragment.
...
## <a name="partitioning-strategies-for-azure-documentdb-databases"></a>Stratégies de partitionnement pour des bases de données Azure DocumentDB
...
*Figure 8 :  Structure de l’architecture DocumentDB*
...
*Figure 9 : Implémentation du partitionnement à l’aide d’une base de données Azure DocumentDB*
...
*Figure 10 : Structure suggérée au sein du stockage Redis pour enregistrer les commandes des clients et les détails associés*
...
> [!NOTE]
> Le mappage des collections de bases de données DocumentDB aux serveurs est transparent, mais il se peut que vous atteigniez tout de même les limites de capacité de stockage et de débit d’un compte DocumentDB. Dans ce cas, vous devrez peut-être revoir votre schéma de partitionnement et migrer les données.
>
>
...
[Federations Migration Utility]: https://code.msdn.microsoft.com/vstudio/Federations-Migration-ce61e9c1 (Utilitaire de migration de fédérations)
...
[Quotas de Service Bus]: ./service-bus-messaging/service-bus-quotas.md
