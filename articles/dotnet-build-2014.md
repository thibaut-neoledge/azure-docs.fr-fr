...
Pour plus d'informations sur le Kit de développement logiciel (SDK) Azure pour .NET 2.3, [consultez les notes de publication](http://go.microsoft.com/fwlink/p/?LinkId=393548).

[Regardez les vidéos de Build](http://go.microsoft.com/fwlink/?LinkId=394377&clcid=0x409), en live du 2 au 4 avril, puis en diffusion à la demande.
...
Développement et publication Web
--------------------------------

Le Kit de développement logiciel (SDK) Azure 2.3 inclut plusieurs mises à jour qui facilitent le développement et la publication Web avec Azure. Vous pouvez désormais mettre en service et créer un site Web Azure ou une machine virtuelle lorsque vous créez une application Web et utiliser Web Deploy pour la déployer sur votre site Web ou machine virtuelle. Pour plus d'informations et pour accéder aux didacticiels qui expliquent comment utiliser les nouvelles fonctionnalités, consultez les ressources suivantes :
...
-   [Prise en main d'Azure et ASP.NET](http://azure.microsoft.com/en-us/documentation/articles/web-sites-dotnet-get-started/)
...
Vous pouvez désormais afficher et déboguer des applications déployées sur le service Sites Web Azure directement depuis Visual Studio. Pour en savoir plus, voir :

-   [Résolution des problèmes liés au service Sites Web Azure dans Visual Studio](http://www.windowsazure.com/en-us/documentation/articles/web-sites-dotnet-troubleshoot-visual-studio)

Gestion des services Azure dans Visual Studio
---------------------------------------------
...
Installez Azure Powershell pour utiliser les nouveaux cmdlets pour Web Sites, WebJobs, etc. Pour plus d'informations, consultez les rubriques :
...
-   [Utilisation de scripts de déploiement Windows PowerShell pour publier des projets Web dans Azure](http://msdn.microsoft.com/en-us/library/windowsazure/dn642480.aspx)

Développement mobile avec .NET
------------------------------

Azure Mobile Services propose désormais une option qui permet d'utiliser les serveurs principaux .NET pour vos applications mobiles ciblant les plateformes mobiles, y compris Windows Store, Windows Phone, iOS et Android. Pour en savoir plus, consultez le [centre de développement mobile](/en-us/develop/mobile/).
...
-   [Utilisation de l'interface de ligne de commande interplateforme Azure avec le Gestionnaire de ressources](/en-us/documentation/articles/xplat-cli-azure-resource-manager/)
