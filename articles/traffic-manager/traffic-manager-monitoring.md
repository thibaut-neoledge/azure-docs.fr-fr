...
>[AZURE.NOTE] Traffic Manager considère qu’un point de terminaison a l’état En ligne uniquement lorsqu’il reçoit un message 200 OK. Un point de terminaison est défectueux lorsque l’un des événements suivants se produit :
