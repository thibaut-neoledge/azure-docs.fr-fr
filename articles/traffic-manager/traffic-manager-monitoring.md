...
La liste ci-dessous répertorie les adresses IP dont peuvent provenir les contrôles d’intégrité de Traffic Manager. Vous pouvez utiliser cette liste pour vérifier que les connexions entrantes à partir de ces adresses IP sont autorisées aux points de terminaison pour vérifier leur état d’intégrité.
