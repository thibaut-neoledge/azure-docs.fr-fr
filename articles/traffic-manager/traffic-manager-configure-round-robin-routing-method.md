---
title: "Configurer une méthode de routage du trafic en tourniquet de Traffic Manager | Microsoft Docs"
...
# <a name="configure-round-robin-routing-method"></a>Configurer la méthode de routage du trafic en tourniquet (round robin)
...
## <a name="routing-traffic-equally-round-robin-across-a-set-of-endpoints"></a>Router le trafic de manière équitable (tourniquet) sur un ensemble de points de terminaison :
