...
## [Mesures des utilisateurs réels](traffic-manager-rum-overview.md)
...
## Envoyer des mesures des utilisateurs réels à Traffic Manager 
### [Utilisation du kit SDK Visual Studio](traffic-manager-create-rum-visual-studio.md)
### [Utilisation des pages web](traffic-manager-create-rum-web-pages.md)
...
## [Utiliser Azure PowerShell pour gérer Traffic Manager](traffic-manager-powershell-arm.md)
