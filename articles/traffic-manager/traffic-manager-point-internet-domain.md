<properties
   ...
   description="Cet article vous aidera à rediriger votre nom de domaine d'entreprise vers un nom de domaine Traffic Manager."
...
Toutes les demandes de trafic vers *www.contoso.com* seront désormais dirigées vers *contoso.trafficmanager.net*.

>[AZURE.IMPORTANT]Vous ne pouvez pas rediriger un domaine de deuxième niveau tel que *contoso.com* vers le domaine Traffic Manager. Il s'agit d'une limitation du protocole DNS qui n'autorise pas les enregistrements CNAME pour les noms de domaine de deuxième niveau.
