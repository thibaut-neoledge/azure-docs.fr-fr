...
- **Tourniquet** : sélectionnez cette méthode quand vous souhaitez répartir la charge sur un ensemble de points de terminaison situés dans le même centre de données ou dans différents centres de données. Pour plus d’informations, consultez [Méthode d’équilibrage de charge de tourniquet](#round-robin-load-balancing-method).
