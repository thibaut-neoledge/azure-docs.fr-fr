...
PréparationPréparation à des incidents potentiels
-------------------------------------------------
...
VigilanceVigilance face aux signes révélateurs d'un problème
------------------------------------------------------------
...
4.  Vous pouvez à présent utiliser votre service secondaire pour récupérer votre service principal.
    ...
    **Remarque**
    ...
    Plusieurs minutes peuvent être nécessaires avant que l'exécution de la commande aboutisse et que les modifications soient visibles dans le portail.
