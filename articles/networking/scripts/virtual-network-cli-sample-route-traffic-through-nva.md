...
[!code-azurecli[principal](../../../cli_scripts/virtual-network/route-traffic-through-nva/route-traffic-through-nva.sh "Acheminer le trafic via une appliance virtuelle réseau")]
