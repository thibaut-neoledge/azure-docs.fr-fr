...
1.  Dans Eclipse, ouvrez le projet que vous avez créé avec le didacticiel [Prise en main de Mobile Services][].
...
<p>Si vous utilisez un fournisseur d'identit&eacute; autre que Microsoft, remplacez la valeur transmise &agrave; la m&eacute;thode <strong>login</strong> ci-dessus par l'une des valeurs suivantes&nbsp;: <i>Facebook</i>, <i>Google</i>, <i>Twitter</i> ou <i>WindowsAzureActiveDirectory</i>.</p>
</div>
