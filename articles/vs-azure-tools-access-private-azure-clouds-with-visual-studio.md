<properties 
   pageTitle="Accès à des clouds Azure privés avec Visual Studio | azure.microsoft.com/ Azure"
...
1. Dans le [portail classique Azure](http://go.azure.microsoft.com/.com/fwlink/?LinkID=213885) du cloud privé, téléchargez votre fichier de paramètres de publication, ou contactez votre administrateur pour obtenir un fichier de paramètres de publication. Sur la version publique d'Azure, le lien de téléchargement est [https://manage.windowsazure.com/publishsettings/](https://manage.windowsazure.com/publishsettings/). (Le fichier que vous téléchargez doit avoir une extension .publishsettings.)
...
[Téléchargement et importation des paramètres de publication et des informations d’abonnement] (https://msdn.azure.microsoft.com/.com/library/dn385850(v=nav.70).aspx)
