...
1. Obtenez les informations d’identification de la base de données.
   ...
   * Cliquez sur votre base de données. Dans le nouveau panneau contextuel, le nom de votre serveur de base de données apparaît dans la partie supérieure. Le nom de votre serveur de base de données doit être au format **nom_solution+nombre_aléatoire+database.windows.net,1433** (par exemple, montest12345.database.windows.net,1433).
