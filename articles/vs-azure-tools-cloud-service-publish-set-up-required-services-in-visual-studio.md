...
### <a name="to-create-a-cloud-service-by-using-visual-studio"></a>Pour créer un service cloud à l’aide de Visual Studio
...
### <a name="to-create-a-cloud-service-by-using-the-azure-classic-portal"></a>Pour créer un service cloud à l’aide du portail Azure Classic
...
### <a name="to-create-a-storage-account-by-using-the-azure-classic-portal"></a>Pour créer un compte de stockage à l’aide du portail Azure Classic
1. Connectez-vous au [portail Azure Classic](http://go.microsoft.com/fwlink/?LinkId=253103) sur le site web Microsoft.
...
### <a name="to-configure-your-application-to-use-services-that-the-storage-account-provides"></a>Pour configurer votre application afin d’utiliser les services fournis par le compte de stockage
...
5. Sous **Se connecter avec**, sélectionnez l’option **Votre abonnement**.
...
9. Dans le champ **Nom du compte** , entrez le nom de votre compte de stockage.
   ...
   >
   >
10. Dans la zone **Clé du compte** , entrez votre clé primaire, ou copiez-collez-la à partir du [portail Azure Classic](http://go.microsoft.com/fwlink/?LinkID=213885).
