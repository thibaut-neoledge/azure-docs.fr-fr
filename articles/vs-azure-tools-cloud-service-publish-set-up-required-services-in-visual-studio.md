...
1. Dans la liste **Services cloud**, sélectionnez **Créer**. La boîte de dialogue **Créer des services Azure** apparaît.

1. Notez le nom de votre service cloud. Le nom constitue une partie de l'URL de votre service et doit par conséquent être unique d’un point de vue global. Le nom ne respecte pas la casse.

### Pour créer un service cloud à l’aide du portail de gestion Azure

1. Connectez-vous au [portail de gestion Azure](http://go.microsoft.com/fwlink/?LinkId=253103) sur le site web Microsoft.
...
1. Connectez-vous au [portail de gestion de la plateforme Azure](http://go.microsoft.com/fwlink/?LinkId=253103) sur le site web Microsoft.
...
1. Dans le coin inférieur gauche de la page, sélectionnez l’icône **+**.

1. Dans le menu qui s’affiche, sélectionnez **Stockage**, puis sélectionnez **Création rapide**.

1. Attribuez au compte de stockage un nom qui donne lieu à une URL unique.

1. Attribuez un nom à votre service cloud. L'URL complète s'affiche en regard du nom.
...
1. Dans la liste **Configuration de service** sélectionnez le nom de la configuration de service que vous souhaitez modifier. Si vous souhaitez apporter des modifications à toutes les configurations de service pour ce rôle, vous pouvez sélectionner **Toutes les configurations**. Pour plus d'informations sur la mise à jour des configurations de service, consultez [Gérer les chaînes de connexion pour les comptes de stockage](https://msdn.microsoft.com/library/azure/8cda8963-ef0e-4f64-8d29-5eac467e5f53#ConnectionStrings).

1. Pour modifier les paramètres d’une chaîne de connexion, sélectionnez le bouton **...** en regard du paramètre. La boîte de dialogue **Créer une chaîne de connexion de stockage** s'affiche.

1. Sous **Connexion avec**, sélectionnez l’option **Votre abonnement**.
...
1. Dans la zone **Clé du compte**, entrez votre clé primaire, ou copiez-collez-la à partir du [portail de gestion](http://go.microsoft.com/fwlink/?LinkID=213885). Pour copier cette clé à partir du portail de gestion :

    1. En bas de la page du compte de stockage approprié, sélectionnez le bouton **Gérer les clés**.

    1. Sur la page **Gérer l'accès aux clés**, sélectionnez le texte de la clé d'accès primaire, puis appuyez sur les touches Ctrl+C.

    1. Dans les outils Azure, collez la clé dans la zone **Clé du compte**.
