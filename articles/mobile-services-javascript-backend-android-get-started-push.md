...
Ce didacticiel est basé sur le démarrage rapide de Mobile Services. Avant de le lancer, suivez le didacticiel [Prise en main de Mobile Services] ou [Prise en main des données] pour connecter votre projet au service mobile.  
...
2. Cliquez sur l'onglet **Notifications Push**, entrez la valeur **Clé API** fournie par GCM au cours de la procédure précédente, puis cliquez sur **Enregistrer**.
...
L'étape suivante consiste à installer les services Google Play. Google Cloud Messaging présente des exigences d'API minimales pour le développement et les tests, auxquelles la propriété **minSdkVersion** du manifeste doit se conformer. 
...
[WACOM.INCLUDE [Ajout de services Google Play](../includes/mobile-services-add-Google-play-services.md)]
...
2. Dans l'application, entrez un texte explicite, tel que _Nouvelle tâche Mobile Services_ puis cliquez sur le bouton **Ajouter**.
...
[Notifications Push pour les utilisateurs d'application]: /fr-fr/develop/mobile/tutorials/push-notifications-to-users-js
...
[Envoi de notifications aux abonnés]: /fr-fr/documentation/articles/notification-hubs-android-send-breaking-news/
