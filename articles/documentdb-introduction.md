<properties title="Pr&eacute;sentation de Microsoft Azure DocumentDB" pageTitle="Pr&eacute;sentation de Microsoft Azure DocumentDB | Azure" description="D&eacute;couvrez Azure DocumentDB et l'int&eacute;r&ecirc;t qu'il pr&eacute;sente pour les applications cloud et mobiles. D&eacute;couvrez &eacute;galement la fa&ccedil;on dont il permet de g&eacute;rer les donn&eacute;es et la fa&ccedil;on dont vous pouvez l'utiliser pour le d&eacute;veloppement d'applications." metaKeywords="" services="documentdb" solutions="data-management"  authors="bradsev" manager="jhubbard" editor="cgronlun" videoId="" scriptId="" />
...
-   [Test de DocumentDB][Test de DocumentDB]
-   [Présentation des concepts DocumentDB][Présentation des concepts DocumentDB]
-   [Interaction avec DocumentD][Interaction avec DocumentD]
-   [Création d'un compte de base de données][Création d'un compte de base de données]
-   [Prise en main de DocumentDB][Prise en main de DocumentDB]
  ...
  [Test de DocumentDB]: https://portal.azure.com/#gallery/Microsoft.DocumentDB
  [Présentation des concepts DocumentDB]: /documentation/articles/documentdb-resources/
  [Interaction avec DocumentD]: /documentation/articles/documentdb-interactions-with-resources/
