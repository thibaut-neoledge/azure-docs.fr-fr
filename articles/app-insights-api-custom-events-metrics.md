...
![Sélectionnez une instance, puis sélectionnez « ... »](./media/appinsights/appinsights-23-customevents-4.png)


Utilisez le champ de recherche pour voir les occurrences de l'événement présentant une valeur de propriété particulière.


![Tapez un terme dans Rechercher](./media/appinsights/appinsights-23-customevents-5.png)
...
![Filtre d'utilisation dans le panneau Vue d'ensemble](./media/appinsights/appinsights-47usage-2.png)
