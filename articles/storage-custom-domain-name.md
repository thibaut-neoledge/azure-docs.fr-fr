...
Si votre domaine personnalisé prend en charge une application qui ne peut supporter une interruption de service, utilisez la procédure décrite à la rubrique [Enregistrement d'un domaine personnalisé pour votre compte de stockage à l'aide du sous-domaine intermédiaire asverify][enregistrer un domaine personnalisé pour votre compte de stockage à l'aide du sous-domaine intermédiaire asverify ;].
...
## <a name="register-asverify"></a>Enregistrement d'un domaine personnalisé pour votre compte de stockage à l'aide du sous-domaine intermédiaire asverify
