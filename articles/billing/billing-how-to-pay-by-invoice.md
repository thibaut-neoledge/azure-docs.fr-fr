...
3. Dans le panneau **Problème**, sélectionnez **Payer by invoice** (Payer par facture) dans la zone **Type de problème**.
4. Entrez les informations suivantes dans la zone **Détails** puis sélectionnez **Suivant**.

    - Nom de la société
    - Adresse de facturation
    - [Adresse de messagerie de l’administrateur de compte](billing-add-change-azure-subscription-administrator.md#check-the-account-administrator-of-the-subscription)
