...
>[AZURE.NOTE]Visual Studio 2013 facilite l'inscription du package de votre application Windows Store auprès de Mobile Services. Pour plus d'informations, consultez la rubrique <a href="http://go.microsoft.com/fwlink/p/?LinkId=309101">Démarrage rapide : Ajout de notifications Push à un service mobile</a> dans le Centre de développement Windows.
...
[Prise en main des utilisateurs C#]: /develop/mobile/tutorials/get-started-with-users-dotnet/
[Prise en main des utilisateurs JavaScript]: /develop/mobile/tutorials/get-started-with-users-js/
