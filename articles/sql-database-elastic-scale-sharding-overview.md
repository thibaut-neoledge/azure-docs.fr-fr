<properties 
	pageTitle="Présentation du partitionnement" 
	description="Décrit les raisons du partitionnement : mettre les ressources de base de données à l'échelle pour augmenter la disponibilité ou les performances." 
