<properties 
    pageTitle="Utilisation du stockage de tables (C++) | Microsoft Azure" 
    description="Découvrez comment utiliser le service de stockage de tables dans Azure. Les exemples sont écrits en C++." 
    services="storage" 
...
# Utilisation du stockage de tables à partir de C++

[AZURE.INCLUDE [storage-selector-table-include](../includes/storage-selector-table-include.md)]

## Vue d'ensemble  
Ce guide décrit le déroulement de scénarios courants dans le cadre de l’utilisation du service de stockage de table Azure. Les exemples ont été écrits en C++ et utilisent la [bibliothèque cliente Azure Storage pour C++](https://github.com/Azure/azure-storage-cpp/blob/v0.5.0-preview/README.md). Les scénarios traités incluent la **création et suppression d’une table**, ainsi que l’**utilisation d’entités de table**.
...
La requête de cet exemple affiche toutes les entités qui correspondent aux critères de filtre. Si vous avez des tables volumineuses et que vous devez télécharger les entités de table si souvent, nous vous recommandons de plutôt stocker vos données dans des objets blob d’Azure Storage.
...
## Étapes suivantes
Maintenant que vous connaissez les bases du stockage des tables, consultez les liens suivants pour en savoir plus sur Azure Storage.
