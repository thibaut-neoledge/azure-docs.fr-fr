...
> [!NOTE]
> Azure lance régulièrement de nouveaux services qui pourraient être utiles dans votre scénario. Si vous avez des questions, contactez un [partenaire Azure](https://pinpoint.microsoft.com/fr-FR/search?keyword=azure) ou envoyez un e-mail à *bigcompute@microsoft.com*.
> 
> 
