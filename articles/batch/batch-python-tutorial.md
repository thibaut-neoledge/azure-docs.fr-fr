...
Vous devez également installer les packages Python **Azure Batch** et **Stockage Azure**. Vous pouvez le faire avec **pip** et le fichier*requirements.txt* disponibles ici :
