...
4. Dans le panneau **Ajouter des autorisations**, sélectionnez le rôle **Collaborateur** et recherchez l’API Batch. Recherchez chacune de ces chaînes, jusqu’à ce que vous trouviez l’API :
