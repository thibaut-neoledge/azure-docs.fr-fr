...
- Nous recommandons à tous les nouveaux utilisateurs de Batch de lire l’article [Vue d’ensemble des fonctionnalités d’Azure Batch](batch-api-basics.md).
