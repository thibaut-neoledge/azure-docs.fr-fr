---
title: Didacticiel - Prise en main de la bibliothèque .NET Azure Batch | Microsoft Docs
...
> [!TIP]
> [How to use Blob Storage from .NET](../storage/storage-dotnet-how-to-use-blobs.md) offre un bon aperçu de l’utilisation des conteneurs Azure Storage et des objets blob. Il doit se trouver au début de votre liste de lecture lorsque vous commencez à travailler avec le traitement Batch.
> 
> 
...
> [!TIP]
> Pour en savoir plus sur la sécurisation de l’accès aux données présentes dans votre compte Azure Storage, consultez la série sur les signatures d’accès partagé en deux parties, [Partie 1 : Présentation du modèle de signature d’accès partagé (SAP)](../storage/storage-dotnet-shared-access-signature-part-1.md) et [Partie 2 : Création et utilisation d’une signature d’accès partagé avec Blob Storage](../storage/storage-dotnet-shared-access-signature-part-2.md).
> 
> 
...
> [!IMPORTANT]
> Les ressources de calcul dans Batch vous sont facturées. Pour réduire les coûts, vous pouvez diminuer la valeur du paramètre `targetDedicated` et la définir sur 1 avant d’exécuter l’exemple.
> 
> 
