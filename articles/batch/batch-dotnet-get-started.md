...
---
# <a name="get-started-with-the-azure-batch-library-for-net"></a>Prise en main de la bibliothèque Azure Batch pour .NET
...
Ensuite, un pool de nœuds de calcul est créé dans le compte Batch avec un appel de `CreatePoolAsync`. `CreatePoolAsync` utilise la méthode [BatchClient.PoolOperations.CreatePool][net_pool_create] pour créer un pool dans le service Batch.
...
[7]: ./media/batch-dotnet-get-started/batch_workflow_07_sm.png "Télécharger la sortie des tâches à partir du stockage"
