...
# Créer une API SQL Server dans PowerApps Enterprise

Ajoutez l’API SQL Server à l’environnement de service d’application (locataire) de votre organisation.
...
- [VPN de site à site](../vpn-gateway/vpn-gateway-create-site-to-site-rm-powershell.md)
- [Connectivité de point à site](../vpn-gateway/vpn-gateway-point-to-site-create.md)  
...
3.  Dans **Paramètres**, sélectionnez **Mise en réseau**. Sélectionnez **Configurer les points de terminaison de connexion hybride**, puis suivez [ces instructions](../app-service-web/web-sites-hybrid-connection-get-started.md) pour créer la connexion hybride : ![Mise en réseau](./media/powerapps-create-api-sqlserver/network.png)
