...
Pour savoir comment personnaliser la définition de l'API Swagger 2.0 en général, consultez [Personnaliser des définitions d’API générées par Swashbuckle](../app-service-api/app-service-api-dotnet-swashbuckle-customize.md).
