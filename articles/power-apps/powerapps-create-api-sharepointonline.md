...
# Créer une API SharePoint Online dans l’environnement App Service de votre organisation
...
b) Entrez une **URI ID D’APPLICATION** valide pour votre application. c) Sélectionnez **OK**.
