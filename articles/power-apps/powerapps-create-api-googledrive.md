...
# Créer une API Google Drive dans l’environnement App Service de votre organisation
...
10. Dans la page Créer un ID client :
	...
	(a) dans **TYPE D'APPLICATION**, sélectionnez **APPLICATION WEB**. (b) Entrez le nom du client. c) Définissez l'URL de redirection sur l'URL de redirection que vous avez reçue lorsque vous avez ajouté la nouvelle API Google Drive dans le portail Azure (dans cette rubrique). Sélectionnez d) **CRÉER**.
