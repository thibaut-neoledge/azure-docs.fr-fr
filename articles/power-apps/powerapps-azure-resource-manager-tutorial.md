...
>[AZURE.IMPORTANT] Cette rubrique a été déplacée vers powerapps.microsoft.com dans [Didacticiel : Créer une API ARM AAD protégée personnalisée pour PowerApps et des flux](https://powerapps.microsoft.com/tutorials/customapi-azure-resource-manager-tutorial/). Accédez à PowerApps pour la dernière version. Ce lien Azure est archivé.
