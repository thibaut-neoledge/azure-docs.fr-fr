---
title: 'Didacticiel : Créer une API personnalisée à l''aide d’Azure Resource Manager dans PowerApps et les flux logiques | Microsoft Docs'
...
> [!IMPORTANT]
> Cette rubrique a été déplacée vers powerapps.microsoft.com dans [Didacticiel : Créer une API ARM AAD protégée personnalisée pour PowerApps et des flux](https://powerapps.microsoft.com/tutorials/customapi-azure-resource-manager-tutorial/). Accédez à PowerApps pour la dernière version. Ce lien Azure est archivé.
> 
> 
...
7. Sous **Clés**, sélectionnez une durée. **Copiez et enregistrez la clé dans un emplacement sûr** ; nous aurons besoin de cette clé plus tard. Prenez également note de l’**ID client** : ![](./media/powerapps-azure-resource-manager-tutorial/configurekeys.png "Configurer les clés")
8. Sous **Authentification unique**, entrez l’URL suivante dans **reply-URL** : https://msmanaged-na.consent.azure-apim.net/redirect : ![](./media/powerapps-azure-resource-manager-tutorial/redirecturl.png "URL de redirection")
...
1. Ouvrez le [portail web PowerApps][1], accédez à l’onglet **Connexions** puis sélectionnez **Ajouter une connexion** dans le coin supérieur droit : ![](./media/powerapps-azure-resource-manager-tutorial/createnewconnection.png "Création d'API personnalisée")
2. Sélectionnez **Ajouter une API personnalisée** : ![](./media/powerapps-azure-resource-manager-tutorial/connecttocustomapi.png "Création d'API personnalisée")
