...
2. Dans la barre des tâches, sélectionnez **Parcourir** : ![][7]
...
Informations de référence sur l’[API REST Microsoft Translator](../connectors/connectors-create-api-microsofttranslator.md).
