...
- Inscription d’applications à l’aide d’une définition d’API Swagger 2.0.

Cet article vous montre comment **enregistrer une définition API Swagger 2.0** que vous avez créée à partir d’une API existante.
