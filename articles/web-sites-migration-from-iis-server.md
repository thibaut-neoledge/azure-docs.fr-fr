<properties 
	...
	description="Montre comment utiliser l'Assistant Migration de Sites Web Azure pour migrer rapidement les sites Web IIS existants vers des sites Web Azure" 
	services="web-sites" 
	documentationCenter="" 
	authors="cephalin" 
	writer="cephalin" 
...
1.	Sur le serveur IIS ou sur votre ordinateur client, accédez à [https://www.movemetothecloud.net/](https://www.movemetothecloud.net/) 
...
8.	La capture d'écran ci-dessous illustre trois sites : **Site Web par défaut**, **TimeTracker**, et **CommerceNet4**. Tous ces sites sont associés à une base de données à migrer. Sélectionnez tous les sites que vous souhaitez évaluer, puis cliquez sur **Suivant**.
