<properties urlDisplayName="Website Using Socket.IO" pageTitle="Didacticiel Node.js avec Socket.IO - Azure" metaKeywords="Azure Node.js socket.io tutorial, Azure Node.js socket.io, Azure Node.js tutorial" description="Ce didacticiel présente l'utilisation de socket.io dans une application node.js hébergée sur Azure." metaCanonical="" services="web-sites" documentationCenter="nodejs" title="Build a Node.js Chat Application with Socket.IO on an Azure Website" authors="larryfr" solutions="" videoId="" scriptId="" manager="wpickett" editor="mollybos" />
