...
2.	Dans la page 'Créer une application logique', indiquez les détails requis, comme le nom, le plan de service de l'application et l'emplacement.

	![][2]

3.	Cliquez sur 'Déclencheurs et actions'. L'éditeur d'application logique s'affiche. Sélectionnez 'Exécuter cette logique manuellement', ce qui signifie que cette application ne peut être appelée que manuellement.
...
6.	Sélectionnez l'action 'Créer un compte'. Les paramètres d'entrée s'affichent.
...
14.	Sélectionnez 'Mettre à jour le compte' dans la liste des actions. Les paramètres d'entrée de l'action 'Mettre à jour le compte' s'affichent.

	![][6]

15.	Cliquez sur '+' en regard de 'ID de l'enregistrement' pour sélectionner l'ID dans la sortie de l'action 'Créer un compte'. 
...
17. Cliquez sur OK dans l'éditeur d'application logique, puis sur  'Créer'. Environ 30 secondes sont nécessaires pour terminer la création.
