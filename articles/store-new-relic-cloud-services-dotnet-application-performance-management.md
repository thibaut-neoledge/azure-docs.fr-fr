...
New Relic Standard est gratuit pour les utilisateurs d'Azure. New Relic Pro est fourni en fonction de la taille d’instance d’Azure Cloud Services. Pour plus d’informations sur la tarification, consultez la [page New Relic](https://azure.microsoft.com/marketplace/partners/newrelic/newrelic/) dans Azure Marketplace ou contactez New Relic (sales@newrelic.com) pour la tarification aux entreprises.
...
## Utilisation de New Relic avec Azure
