<properties urlDisplayName="Get Started with Data (HTML5)" pageTitle="Prise en main des données (HTML 5) | Centre de développement mobile" metaKeywords="" description="Découvrez comment utiliser Mobile Services pour tirer profit des données de votre application HTML." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Get started with data in Mobile Services" authors="glenga" solutions="" manager="dwrede" editor="" />
...
4. Rechargez l'URL <a href="http://localhost:8000/" target="_blank">http://localhost:8000/</a> dans un navigateur web pour démarrer l'application.
    ...
    <div class="dev-callout"><b>Remarque</b>
	<p>Si vous devez redémarrer le serveur Web, répétez les étapes de la première section.</p>
    </div>
