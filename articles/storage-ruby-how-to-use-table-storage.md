...
Service de tables Windows Azure. Les exemples sont écrits en utilisant
l'API Ruby. Les scénarios traités incluent **la création et la suppression d'une
table, l'insertion et l'interrogation d'entités dans une table**. Pour plus
d'informations sur les tables, consultez la section [Étapes suivantes](#next-steps).
...
pour obtenir les informations obligatoires pour se connecter à votre compte de stockage Azure. Si ces variables d'environnement ne sont pas définies, vous devez spécifier les informations de compte avant d'utiliser **Azure::TableService** grâce au code suivant :
...
## <a id="how-to-create-a-table"></a>Création d'une table
...
## <a id="how-to-update-an-entity"></a> Mise à jour d'une entité
...
## <a id="how-to-work-with-groups-of-entities"></a> Utilisation des groupes d'entités
...
## <a id="how-to-query-for-an-entity"></a> Interrogation d'une entité
...
## <a id="how-to-query-a-set-of-entities"></a> Interrogation d'un ensemble d'entités
...
## <a id="how-to-query-a-subset-of-entity-properties"></a> Interrogation d'un sous-ensemble de propriétés d'entité
...
## <a id="how-to-delete-an-entity"></a> Suppression d'une entité
...
## <a id="how-to-delete-a-table"></a> Suppression d'une table
