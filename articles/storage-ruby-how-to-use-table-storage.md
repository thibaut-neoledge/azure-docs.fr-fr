...
Le module Azure lit les variables d'environnement **AZURE\_STORAGE\_ACCOUNT** et **AZURE\_STORAGE\_ACCESS\_KEY**  pour obtenir les informations obligatoires pour se connecter à votre compte de stockage Azure. Si ces variables d'environnement ne sont pas définies, vous devez spécifier les informations de compte avant d'utiliser **Azure::TableService** avec le code suivant :
...
## <a id="how-to-work-with-groups-of-entities"></a>Utilisation Utilisation des groupes d'entités
...
## <a id="how-to-query-for-an-entity"></a>Utilisation Interrogation d'une entité
...
## <a id="how-to-query-a-set-of-entities"></a>Utilisation Interrogation d'un ensemble d'entités
...
## <a id="how-to-delete-a-table"></a>Utilisation Suppression d'une table
