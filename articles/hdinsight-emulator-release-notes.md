...
-   Pour plus d'informations sur le service HDInsight, voir http://www.windowsazure.com/en-us/manage/services/hdinsight.
...
-   Échec du chargement de la console JavaScript
    ...
    -   Sur certaines installations, la console JavaScript échoue, signalée sur la page par une erreur HTTP 404. Pour contourner ce problème, accédez directement à l'adresse http://localhost:8080 pour utiliser la console.
