...
Ce guide décrit le déroulement de scénarios courants dans le cadre de l'utilisation du service de stockage d'objets blob Azure. Les exemples sont écrits en utilisant l'API Python. Les scénarios couverts comprennent le **chargement**, l'**énumération**, le **téléchargement** et la  **suppression** d'objets blob. Pour plus d'informations sur les objets blob, consultez la section  [Étapes suivantes][].
...
[Présentation du stockage d'objets blob][]   
 ...
 [Procédure : Énumération des objets blob dans un conteneur][]   
 [Procédure : Téléchargement d'objets blob][]   
 [Procédure : Suppression d'un objet blob][]   
 [Procédure : Chargement et téléchargement d'objets blob volumineux][]   
 [Étapes suivantes][]
...
## <a name="create-container"> </a>Utilisation Création d'un conteneur
...
## <a name="list-blob"> </a>Utilisation Création d'une liste d'objets blob dans un conteneur

Pour énumérer les objets blob d'un conteneur, utilisez la méthode **list\_blobs** avec une boucle
**for** pour afficher le nom de chaque objet blob du conteneur. Exemple
code suivant génère le **nom** et l'**url** de chaque objet blob d'un conteneur sur la console.
...
## <a name="download-blobs"> </a>Utilisation Téléchargement d'objets blob
...
## <a name="delete-blobs"> </a>Utilisation Suppression d'un objet blob
...
-   Consultez le [blog de l'équipe Azure Storage][]
  ...
  [Procédure : Énumération des objets blob dans un conteneur]: #list-blob
