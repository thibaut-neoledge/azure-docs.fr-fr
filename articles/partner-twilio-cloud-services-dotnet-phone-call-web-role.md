...
## <a name="a-nametwilio-prereqsaprerequisites"></a><a name="twilio-prereqs"></a>Configuration requise
...
## <a name="a-namehowtocreateformahow-to-create-a-web-form-for-making-a-call"></a><a name="howtocreateform"></a>Procédure : création d’un formulaire web pour établir un appel
...
## <a name="a-idhowtocreatecodeahow-to-create-the-code-to-make-the-call"></a><a id="howtocreatecode"></a>Procédure : création du code pour établir l’appel
