...
Dans ce didacticiel, vous allez ajouter des notifications Push utilisant les services de notifications Windows (WNS) au projet de démarrage rapide. Une fois que vous avez terminé, votre service mobile envoie une notification Push à chaque fois qu'un enregistrement est inséré.
...
<h2><a name="add-push"></a><span class="short-header">Ajout de notifications</span>PushAjout de notifications Push à l'application</h2>
...
4.  Ajoutez le code suivant après le code qui crée l'instance **MobileServiceClient** :
...
<h2><a name="update-scripts"></a><span class="short-header">Mise à jour du script d'insertion</span>Mise à jour du script d'insertion inscrit dans le portail de gestion</h2>
...
<h2><a name="test"></a><span class="short-header">Test de l'applicationTest des notifications</span>Push dans l'application</h2>
