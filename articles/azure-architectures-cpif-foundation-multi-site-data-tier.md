<properties 
   ...
   description="Le niveau de données multi-sites fait partie de la Fondation, qui est décrite en détail dans le document de l'architecture CPIF." 
   services="" 
   documentationCenter="" 
   authors="arynes" 
   manager="fredhar" 
...
Le modèle du **niveau de données** fait partie de la **Fondation**, qui est décrite en détail dans le document de l'architecture CPIF. 
...
[Niveau de données à charge équilibrée (pdf)](https://gallery.technet.microsoft.com/Cloud-Platform-Integration-dfb09e41)
