...
Diagnostic et atténuation des erreurs
-------------------------------------
...
-   **Atténuation** : créez le cluster dans une région qui prend actuellement en charge les clusters : Europe du Nord, Est des États-Unis ou Ouest des États-Unis.
...
-   **Atténuation** : spécifiez une région qui prend en charge les clusters HDInsight. Les régions publiquement prises en charge sont les suivantes : Est des États-Unis, Ouest des États-Unis, Europe du Nord
