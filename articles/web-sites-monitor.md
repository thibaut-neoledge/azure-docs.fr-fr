...
## <a name="resourceusage"></a> Réduction de l'utilisation des ressources
...
-   Plus le nombre de sites Web configuré pour s'exécuter en mode partagé est important, plus la probabilité de dépasser les quotas d'utilisation des ressources en mode partagé est grande.
    Pensez ainsi à réduire le nombre de sites configurés pour s'exécuter en mode partagé si les quotas sont dépassés.
-   De même, plus le nombre d'instances d'un site Web s'exécutant en mode partagé augmente, plus la probabilité de dépasser les quotas d'utilisation des ressources en mode partagé est grande.
    En conséquence, il est conseillé de réduire le nombre d'instances des sites Web en mode partagé si les quotas d'utilisation des ressources sont dépassés.

## <a name="exceeded"></a>Scénario dans lequel un quota d'utilisation des ressources est dépassé
...
## <a name="howtoconfigdiagnostics"></a> Configuration des diagnostics et téléchargement des journaux d'un site Web

Les diagnostics sont activés sur la page d'administration **Configurer** du site Web. Deux types de diagnostics sont disponibles : le **diagnostic d'application** et le **diagnostic de site**.
...
<div class="dev-callout"> 
    <b>Remarque</b> 
    <p>Les options <b>Diagnostic d'application (syst&egrave;me de fichiers)</b>, <b>Diagnostic d'application (stockage de table)</b> et <b>Diagnostic d'application (stockage d&rsquo;objets blob)</b> peuvent &ecirc;tre activ&eacute;es simultan&eacute;ment et &ecirc;tre associ&eacute;es &agrave; des niveaux de journalisation sp&eacute;cifiques. Ainsi, vous pouvez par exemple consigner les erreurs et les avertissements pour &ecirc;tre stock&eacute;s dans le cadre d'une solution de journalisation &agrave; long terme, tout en activant un niveau d&eacute;taill&eacute; de journalisation du syst&egrave;me de fichiers une fois le code de l'application instrument&eacute; pour r&eacute;soudre un probl&egrave;me.</p> </div>

<div class="dev-callout"> 
    <b>Remarque</b> 
    <p>Les diagnostics peuvent &eacute;galement &ecirc;tre activ&eacute;s &agrave; partir du module Azure PowerShell via la cmdlet <b>Set-AzureWebsite</b>.</p><p>Si vous n'avez pas install&eacute; ou configur&eacute; Azure PowerShell de mani&egrave;re &agrave; utiliser votre abonnement Azure, consultez la page <a href="http://www.windowsazure.com/fr-fr/develop/nodejs/how-to-guides/powershell-cmdlets/">Utilisation d'Azure PowerShell</a>.</p></div>

<div class="dev-callout"> 
<b>Remarque</b> 
<p>La journalisation des applications s'appuie sur les informations de journalisation g&eacute;n&eacute;r&eacute;es par votre application. La m&eacute;thode permettant de g&eacute;n&eacute;rer ce type d'informations, ainsi que le format des informations, sont propres au langage de votre application. Pour obtenir des informations sur le langage utilis&eacute; dans le cadre de la journalisation des applications, lisez les articles suivants&nbsp;:</p>
<ul>
<li><b>.NET</b> - <a href="/fr-fr/develop/net/common-tasks/diagnostics-logging-and-instrumentation/">Activation de la journalisation de diagnostic pour Sites Web Azure</a></li>
<li><b>Node.js</b> - <a href="/fr-fr/develop/nodejs/how-to-guides/Debug-Website/">D&eacute;bogage d'une application Node.js dans Sites Web Azure</a></li>
</ul>
...
<div class="dev-callout"> 
<b>Important</b> 
<p>Les activit&eacute;s de journalisation et de suivi repr&eacute;sentent une charge importante sur un site Web. Il est recommand&eacute; de d&eacute;sactiver la journalisation et le suivi une fois que vous avez pu reproduire le ou les probl&egrave;me(s) que vous essayez de r&eacute;soudre.</p> 
</div>
...
1.  À partir de l'**écran d'accueil** ou du **menu Démarrer**, recherchez **Azure PowerShell**. Cliquez avec le bouton droit sur l'entrée **Azure PowerShell** et sélectionnez **Exécuter en tant qu'administrateur**.
    ...
    <div class="dev-callout"> 
<b>Remarque</b> 
<p>Si <b>Azure PowerShell</b> n'est pas install&eacute;, consultez la page <a href="http://msdn.microsoft.com/fr-fr/library/windowsazure/jj554332.aspx">Mise en route des cmdlets Azure PowerShell</a> pour plus d'informations sur l'installation et la configuration.</p> 
</div>
...
<div class="dev-callout"> 
<b>Remarque</b> 
<p>Si la commande <b>azure</b> n'est pas install&eacute;e, consultez la page <a href="http://www.windowsazure.com/fr-fr/develop/nodejs/how-to-guides/command-line-tools/">Utilisation des outils en ligne de commande Azure</a> pour plus d'informations sur l'installation et la configuration.</p>
</div>
...
5.  Entrez l'URL du service devant être surveillé. Par exemple, [][]<http://contoso.cloudapp.net></a>.
