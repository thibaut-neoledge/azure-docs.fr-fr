...
La dernière étape consiste à déployer votre code dans Web Apps grâce à Git ou ou protocole FTP.

Si vous utilisez la méthode FTP, obtenez le nom d'hôte et le nom d'utilisateur FTP grâce au tableau de bord du [portail Azure](https://portal.azure.com). Ensuite, utilisez un client FTP pour télécharger les fichiers Drupal dans le dossier **/site/wwwroot** du site distant.
...
- [Azure App Service, Azure Cloud Services et Azures Virtual Machines : que choisir ?][]
...
* Pour obtenir des informations détaillées sur le passage de l'ancien portail au nouveau portail, consultez : [Référence pour la navigation dans le portail en version préliminaire](http://go.microsoft.com/fwlink/?LinkId=529715)
  ...
  [Azure App Service, Azure Cloud Services et Azures Virtual Machines : que choisir ?]: http://go.microsoft.com/fwlink/?LinkId=310123
