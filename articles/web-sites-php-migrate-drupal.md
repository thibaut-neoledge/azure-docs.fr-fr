<properties urlDisplayName="Migrating Drupal to Azure Websites" pageTitle="Migration de Drupal vers le service Sites Web Azure" metaKeywords="Drupal, PHP, Web Sites" description="Migrez un site PHP Drupal vers Sites Web Azure." metaCanonical="" services="web-sites" documentationCenter="PHP" title="Migrating Drupal to Azure Websites" authors="tomfitz" solutions="" manager="wpickett" editor="mollybos" />
...
- [Module de stockage d'objets blob Azure](https://drupal.org/project/azure_blob)
  ...
  [Création et déploiement d'un site Web Azure PHP-MySQL avec Git]: http://www.windowsazure.com/fr-fr/develop/php/tutorials/website-w-mysql-and-git/
