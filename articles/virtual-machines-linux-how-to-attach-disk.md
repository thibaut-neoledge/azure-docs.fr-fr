<properties pageTitle="Association d'un disque à une machine virtuelle exécutant Linux dans Azure" description="Apprenez à associer un disque à une machine virtuelle Azure et initialisez-le afin qu'il soit prêt à l'utilisation." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor="tysonn"/>
