...
Le [connecteur AS2](app-service-logic-connector-as2.md) expose la capacité à archiver des messages. L’archivage stocke le message dans le **conteneur d’objets blob Azure** qui fait partie des paramètres du package.
