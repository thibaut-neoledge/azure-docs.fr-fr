...
### <a name="connect-to-encode-as2-message-using-the-following-steps"></a>Connectez-vous à Encode AS2 Message en procédant comme suit :
...
## <a name="the-as2-encode-does-the-following"></a>Le codage AS2 effectue les opérations suivantes :
