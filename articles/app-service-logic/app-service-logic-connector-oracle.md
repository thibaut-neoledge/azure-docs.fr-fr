...
Un connecteur peut être créé dans une application logique ou directement à partir d'Azure Marketplace. Pour créer un connecteur à l’aide d’Azure Marketplace :
...
App Service utilise le Gestionnaire des configurations hybrides pour se connecter en toute sécurité à votre système local. Si votre connecteur utilise Oracle en local, le Gestionnaire des connexions hybrides est requis.
