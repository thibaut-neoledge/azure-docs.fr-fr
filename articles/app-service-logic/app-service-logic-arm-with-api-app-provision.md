...
Pour le modèle complet, consultez le [modèle d'application logique avec application API](https://github.com/tfitzmac/AppServiceTemplates/blob/master/LogicAppAndAPIApp.json).
