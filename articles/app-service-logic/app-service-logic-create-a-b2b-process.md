...
1. Créez un flux dans lequel la première étape est AS2. Faites glisser le **Connecteur AS2** et choisissez l’instance déjà créée. Choisissez Déclencheur comme fonctionnalité.
