---
title: Utilisation du connecteur Office 365 dans des applications logiques | Microsoft Docs
...
5. Pour la connexion à Office 365, vous devez autoriser l’application logique à accéder à votre compte. Une fois l’application créée, cliquez sur Autoriser pour indiquer les informations d’identification Office 365 : ![][5]
6. Vous êtes redirigé vers la page de connexion Office 365, puis vous pouvez vous authentifier avec vos informations d'identification Office 365 : ![][6]![][7]
7. Une fois que l'autorisation est terminée, les déclencheurs Office 365 s'affichent : ![][8]
8. Sélectionnez le déclencheur Nouveau message et les paramètres d'entrée s'affichent.
9. Remplacez la fréquence de déclenchement par Minutes et cliquez sur ✓ : ![][9]
10. Le déclencheur Office 365 Nouvel e-mail est configuré et vous pouvez également voir les paramètres de sortie : ![][10]
11. Sélectionnez Connecteur Office 365 dans la section des éléments récemment utilisés dans la galerie et une nouvelle action Office 365 est ajoutée.
12. Sélectionnez Envoyer un événement dans la liste des actions et les paramètres d'entrée de cette action s'affichent : ![][11]
13. Spécifiez les détails de l'événement, puis cliquez sur ✓ : ![][12]
14. Sélectionnez Connecteur Office 365 dans la section des éléments récemment utilisés dans la galerie et une nouvelle action Office 365 est ajoutée.
15. Sélectionnez Ajouter un contact dans la liste des actions et les paramètres d'entrée de cette action s'affichent : ![][13]
16. Cliquez sur + en regard du champ Adresse électronique, puis sélectionnez la valeur du champ de sortie De à partir du déclencheur : ![][14]
17. Cliquez sur ✓. La configuration de l'action est terminée : ![][15]
18. Sélectionnez Connecteur Office 365 dans la section des éléments récemment utilisés dans la galerie et une nouvelle action Office 365 est ajoutée.
19. Sélectionnez Envoyer un message dans la liste des actions et les paramètres d'entrée de cette action s'affichent : ![][19]
20. Indiquez les détails requis pour envoyer le message électronique. Vous pouvez rédiger un message en tapant quelque chose comme ci-dessous. Une fois l’action d’envoi du message configurée, cliquez sur ✓ :
    
     Body - @concat('You got a new sales enquiry from',triggers().output.body.From)
    
    ![][20]
21. Sélectionnez Connecteur Office 365 dans la section des éléments récemment utilisés dans la galerie et une nouvelle action Office 365 est ajoutée.
22. Sélectionnez Répondre dans la liste des actions et les paramètres d'entrée de cette action s'affichent : ![][16]
23. Cliquez sur + en regard du champ De et sélectionnez la valeur de l’ID de message de sortie du déclencheur, puis cliquez sur ✓ : ![][17]
24. Cliquez sur OK dans l’éditeur d’application logique, puis cliquez sur Créer. Environ 30 secondes sont nécessaires pour terminer la création.
25. Envoyez un message électronique au compte avec lequel vous avez configuré votre déclencheur. Un message électronique doit apparaître dans votre compte de messagerie personnel et un événement de calendrier ainsi qu'un contact doivent apparaître dans votre compte de messagerie professionnel. De plus, vous devez obtenir une réponse confirmant que la demande de renseignements commerciaux sera traitée dans les meilleurs délais.
