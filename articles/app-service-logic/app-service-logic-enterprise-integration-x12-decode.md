---
title: En savoir plus sur le connecteur Enterprise Integration Pack Decode X12 Message | Microsoft Docs
...
---
# <a name="get-started-with-decode-x12-message"></a>Prise en main de Decode X12 Message
...
### <a name="connect-to-decode-x12-message-using-the-following-steps"></a>Connectez-vous à Decode X12 Message en procédant comme suit :
...
## <a name="x12-decode-does-following"></a>X12 Decode effectue les actions suivantes
