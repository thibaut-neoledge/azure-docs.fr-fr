---
title: Gestion et contrôle de vos connecteurs et applications API dans App Service | Microsoft Docs
...
> [!NOTE]
> Le Gestionnaire de connexion hybride est requis uniquement si vous vous connectez à une ressource locale derrière le pare-feu. Si vous n’êtes pas connecté à un système local, le Gestionnaire de connexion hybride peut ne pas figurer dans le panneau de votre connecteur.
> 
> 
...
> [!IMPORTANT]
> Lorsque vous ouvrez les propriétés de votre application API et regardez sous l’onglet **Bases**, les liens **Hôte** et **Passerelle** ouvrent de nouveaux panneaux :
> 
> ![][host]
> 
