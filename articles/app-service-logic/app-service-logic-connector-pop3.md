...
Pour utiliser le connecteur POP3, vous devez d’abord créer une instance de l’application API de ce connecteur. Cette opération est possible à partir du concepteur d'application logique, directement ou de l'extérieur. Vous pouvez créer une instance de l’extérieur du concepteur de l'extérieur en procédant comme suit :
