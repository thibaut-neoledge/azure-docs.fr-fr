...
>[AZURE.NOTE]Cette page traite les fonctionnalités X12 de Logic Apps. Pour plus d’informations sur EDIFACT, cliquez [ici](app-service-logic-enterprise-integration-edifact.md).
...
8. Sélectionnez **Paramètres de réception** pour configurer la façon dont les messages reçus dans le cadre de ce contrat doivent être traités.
...
11. Sélectionnez **Paramètres d’envoi** pour configurer la façon dont les messages envoyés dans le cadre de ce contrat doivent être traités.
...
13. Sélectionnez la mosaïque **Contrats** dans le panneau Compte d’intégration pour afficher le nouveau contrat ajouté. ![](./media/app-service-logic-enterprise-integration-x12/x12-7.png)
