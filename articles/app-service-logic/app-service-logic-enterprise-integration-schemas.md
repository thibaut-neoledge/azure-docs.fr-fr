...
3. Sélectionnez le **compte d’intégration** auquel vous ajouterez le schéma ![](./media/app-service-logic-enterprise-integration-overview/overview-31.png)
...
7. Pour ajouter un fichier de schéma supérieur à 2 Mo (maximum de 8 Mo)
   ...
   * Sélectionnez Fichier volumineux dans Ajouter un schéma et indiquez l’URI dans URI du contenu ![](./media/app-service-logic-enterprise-integration-schemas/schema-largefile.png) 8. Vous devriez voir le nouveau schéma ![](./media/app-service-logic-enterprise-integration-schemas/schema-41.png)
...
6. Vous recevrez une notification indiquant que le téléchargement a réussi
