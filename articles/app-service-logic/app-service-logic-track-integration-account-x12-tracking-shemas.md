---
title: "Schémas de suivi X12 | Microsoft Docs"
description: "En savoir plus sur les schémas de suivi X12"
author: padmavc
manager: erikre
editor: 
services: logic-apps
...
* En savoir plus sur les [schémas de suivi personnalisé B2B](app-service-logic-track-integration-account-custom-tracking-shema.md).
