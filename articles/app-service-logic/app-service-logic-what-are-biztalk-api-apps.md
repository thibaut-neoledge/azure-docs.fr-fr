...
## Règles
Les règles d'entreprise englobent les stratégies et les décisions qui contrôlent les processus d'entreprise. En règle générale, les règles sont dynamiques et changent au fil du temps pour différentes raisons, y compris les plans d’activités, les réglementations, etc. Les [règles BizTalk](app-service-logic-use-biztalk-rules.md) vous permettent de découpler ces stratégies de votre code d’application et de simplifier et d’accélérer le processus de modification.
