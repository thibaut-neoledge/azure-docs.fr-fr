---
title: Utilisation du connecteur Informix dans Microsoft Azure App Service | Microsoft Docs
...
> [!TIP]
> L’instruction « *Post to EntitySet* » d’Informix Connection renvoie la valeur de la colonne d’identité et l’instruction « *API Insert* » renvoie les lignes affectées
> 
> 
...
> [!TIP]
> Utilisez les instructions SQL suivantes pour créer les exemples de tables et de procédures stockées.
> 
> 
...
> [!NOTE]
> Cette étape n’est requise que si vous utilisez le connecteur DB2 en local derrière votre pare-feu.
> 
> 
