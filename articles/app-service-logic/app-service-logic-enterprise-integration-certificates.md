...
### Certificat privé
Vous pouvez également télécharger des certificats privés sur votre compte d’intégration. Pour cela, vous devrez exécuter la procédure suivante :
1. [Télécharger votre clé privée dans Key Vault](../key-vault/key-vault-get-started.md "En savoir plus sur le coffre de clés")
2. Créer un certificat privé puis télécharger le certificat privé sur votre compte d’intégration
