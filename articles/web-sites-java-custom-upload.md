...
Chargement d'un site Web Java personnalisé dans Azure
=====================================================

Cette rubrique explique comment charger un site Web Java personnalisé dans Azure. Vous y trouverez des informations s'appliquant à tous les sites Web Java ainsi que quelques exemples d'applications spécifiques.

Remarquez qu'Azure permet de créer des sites Web Java en utilisant l'interface utilisateur de configuration du portail Azure ainsi que la galerie d'applications Azure, comme décrit dans la page [Prise en main des sites Web Azure et de Java](../web-sites-java-get-started). Ce didacticiel est consacré aux scénarios pour lesquels vous ne souhaitez pas utiliser l'interface utilisateur de configuration Azure ni la galerie d'applications Azure.
...
-   Les applications qui requièrent des répertoires avec autorisation d'accès en écriture doivent être situées dans le répertoire de contenu du site Web Azure, c'est-à-dire à l'emplacement **D:\\home**.
...
Bien qu'il existe sur Tomcat deux variations fournies avec les sites Web Azure, il est également possible de charger des instances spécifiques du client. Voici un exemple d'installation de Tomcat avec une JVM différente :
      ...
      <system.webServer>
        ...
        <httpPlatform processPath="d:\home\site\wwwroot\bin\tomcat\bin\startup.bat" 
          ...
          <environmentVariables>
            ...
            <environmentVariable name="JRE_HOME" value="d:\home\site\wwwroot\bin\java" /> <!-- facultatif, si elle n'est pas spécifiée, la valeur par défaut est %programfiles%\Java -->
...
1.  Dans la racine de votre site Web Azure, c'est-à-dire **d:\\home\\site\\wwwroot**, créez un répertoire **webapps** (s'il n'y en a pas déjà un) et placez Hudson.war dans **d:\\home\\site\\wwwroot\\webapps**.
...
3.  Créez web.config dans **d:\\home\\site\\wwwroot** et collez-y le contenu suivant :
    ...
    Le site Web peut désormais être redémarré afin de prendre en compte les modifications. Connectez-vous à http://yoursite/hudson pour démarrer Hudson.
...
Pour plus d'informations sur Hudson, consultez la page <http://hudson-ci.org>.
...
Une fois ces modifications effectuées, redémarrez votre site Web qui exécute Liferay, puis ouvrez la page http://yoursite. Le portail Liferay est disponible depuis la racine du site Web.

Pour plus d'informations sur Liferay, consultez la page <http://www.liferay.com>.
