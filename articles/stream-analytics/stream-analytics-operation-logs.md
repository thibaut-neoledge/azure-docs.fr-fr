...
# Présentation des journaux des opérations Stream Analytics
...
## Rechercher des journaux d’opérations dans le portail Azure Classic
...
Dans le portail Azure Classic, cliquez sur le bouton **Détails** au bas de la fenêtre pour afficher plus de détails sur un événement sélectionné.
...
Dans le portail Azure Classic, cliquez sur l’icône Rechercher et tapez « échoué ». Vous obtenez comme résultat tous les journaux avec des erreurs.
