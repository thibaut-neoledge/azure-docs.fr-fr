...
2. Spécifiez le type de la sortie :
    ...
    ![Choisir le type de déplacement des données dans le portail Azure en version préliminaire](./media/stream-analytics-add-outputs/6-stream-analytics-add-outputs.png)
