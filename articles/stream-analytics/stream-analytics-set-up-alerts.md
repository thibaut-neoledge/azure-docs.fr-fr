...
# Configuration d'alertes dans Azure Stream Analytics
...
## Configuration d'alertes par le biais du portail Azure Classic
...
## Configuration d'alertes dans le portail Azure ##
