<properties title="Learn how to configure an Azure website to use a domain name registered with Dotster" pageTitle="Configuration d'un nom de domaine Dotster pour un site web Azure" metaKeywords="Azure, Azure Web Sites, Dotster" description="Découvrez comment configurer un site web Azure pour qu'il utilise un nom de domaine enregistré avec Dotster" services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
