...
* Un compte Azure actif. Si vous ne possédez pas de compte, vous pouvez créer un compte d'évaluation gratuit en quelques minutes. Pour plus d'informations, consultez la page [Version d'évaluation gratuite d'Azure](http://azure.microsoft.com/fr-fr/pricing/free-trial/?WT.mc_id=A0E0E5C02&returnurl=http%3A%2F%2Fazure.microsoft.com%2Ffr-fr%2Fdocumentation%2Farticles%2Fmobile-services-dotnet-backend-windows-universal-dotnet-get-started-data%2F).
...
<ol start="7"><li><p>Dans l'Explorateur de solutions, ouvrez le fichier de code App.xaml.cs dans le dossier de projet GetStartedWithData.Shared, et voyez comment le nouveau champ statique a été ajouté à la classe <strong>App</strong> dans un bloc de compilation conditionnelle de l'application du Windows Store, pour ressembler à l'exemple suivant :</p> 
	...
	<p>Ce code fournit un accès à votre nouveau service mobile dans votre application à l'aide d'une instance de la classe <a href="http://go.microsoft.com/fwlink/p/?LinkId=302030">MobileServiceClient</a>. Le client est créé en fournissant l'URI et la clé de l'application du nouveau service mobile. Ce champ statique est disponible pour toutes les pages de votre application.</p>
</li>
...
Les deux applications du Windows Store et Windows Phone Store sont maintenant connectées au nouveau service mobile. L'étape suivante consiste à tester le nouveau projet de service mobile.
...
[Téléchargement d'un projet d'application du Windows Store]: #download-app
[Création d'un service mobile à partir de Visual Studio]: #create-service
[Test du projet de service mobile en local]: #test-the-service-locally
[Mise à jour de l'application pour utiliser le service mobile]: #update-app
[Test de l'application sur le service hébergé en local]: #test-locally-hosted
...
[Prise en main de la synchronisation de données hors connexion]: /fr-fr/documentation/articles/mobile-services-windows-store-dotnet-get-started-offline-data/
