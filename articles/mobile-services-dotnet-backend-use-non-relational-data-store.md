<properties urlDisplayName="Build a Service Using a Non-Relational Data Store" pageTitle="Création d'un service à l'aide d'un magasin de données non relationnelles - Azure Mobile Services" metaKeywords="" description="Learn how to use a non-relational data store such as MongoDB or Azure Table Storage with your .NET based mobile service" metaCanonical="" services="" documentationCenter="Mobile" title="Build a Service Using a Non-Relational Data Store" authors="yavorg, mahender" solutions="" manager="dwrede" editor="mollybos" />
