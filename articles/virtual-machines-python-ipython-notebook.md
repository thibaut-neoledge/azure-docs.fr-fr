...
Installez [NumPy][numpy], [Matplotlib][matplotlib], [Tornado][tornado] et les autres dépendances d’IPython en procédant comme suit :
...
1.  Installez [Tornado][tornado] et [PyZMQ][pyzmq] et les autres dépendances d’IPython en procédant comme suit :
...
1.  Téléchargez et installez [OpenSSL][].
	...
	* Vous trouverez le composant **Visual C++ 2008 Redistributable** requis sur la même page de téléchargement.
