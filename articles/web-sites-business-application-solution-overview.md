...
<p>Ce guide pr&eacute;sente les domaines et les t&acirc;ches parmi les plus courants s'adaptant au d&eacute;veloppement de sites .COM publics. Cependant, Sites Web Azure offre encore d'autres fonctionnalit&eacute;s, que vous pouvez utiliser pour votre impl&eacute;mentation sp&eacute;cifique. Pour les d&eacute;couvrir, consultez &eacute;galement les autres guides concernant la <a href="http://www.windowsazure.com/fr-fr/manage/services/web-sites/global-web-presence-solution-overview/">Pr&eacute;sence sur le Web &agrave; l'international</a> et les <a href="http://www.windowsazure.com/fr-fr/manage/services/web-sites/digital-marketing-campaign-solution-overview">Campagnes marketing num&eacute;riques</a>.</p>
</div>
...
<tr>
  ...
  [service Azure Active Directory]: /fr-fr/documentation/services/active-directory/
  [Utilisation d'Azure Active Directory]: /fr-fr/manage/windows/fundamentals/identity/#ad
  [Exécution de Windows Server Active Directory sur les machines virtuelles]: /fr-fr/manage/windows/fundamentals/identity/#adinvm
  ...
  [Azure Access Control Service]: http://msdn.microsoft.com/library/windowsazure/hh147631.aspx
  [Utilisation du contrôle d'accès Azure Active Directory]: /fr-fr/manage/windows/fundamentals/identity/#ac
  [Présentation d'Azure AD]: http://technet.microsoft.com/fr-fr/library/jj573650.aspx
  ...
  [Ajout de l'authentification à une application Web à l'aide d'Azure AD]: http://msdn.microsoft.com/library/windowsazure/dn151790.aspx
  [Intégration d'un annuaire]: http://technet.microsoft.com/fr-fr/library/jj573653.aspx
  ...
  [Inscription de l'application auprès d'Azure Active Directory]: #registerwaadapp
  ...
  [Authentification Azure]: http://www.asp.net/aspnet/overview/aspnet-and-visual-studio-2012/windows-azure-authentication
  ...
  [service de relais Azure Service Bus]: http://msdn.microsoft.com/fr-fr/library/windowsazure/jj860549.aspx
  ...
  [Utilisation du service Service Bus Relay]: /fr-fr/develop/net/how-to-guides/service-bus-relay/
  [Didacticiel relatif à la messagerie par relais Service Bus]: http://msdn.microsoft.com/fr-fr/library/windowsazure/ee706736.aspx
  [Pizzeria - Connexion de sites Web à un réseau local via Service Bus]: http://code.msdn.microsoft.com/windowsazure/Enterprise-Pizza-e2d8f2fa
  [2]: /fr-fr/manage/services/web-sites/digital-marketing-campaign-solution-overview
