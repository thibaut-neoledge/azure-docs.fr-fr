<properties urlDisplayName="How to Make a Phone Call from Twilio in Java" pageTitle="Exécution d'un appel téléphonique à partir de Twilio (Java) - Azure" metaKeywords="appel Azure Twilio, site web appel Twilio, Azure Twilio Java" description="Learn how to make a phone call from a web page using Twilio in a Java application on Azure." metaCanonical="" services="" documentationCenter="Java" title="How to Make a Phone Call Using Twilio in a Java Application on Azure" authors="MicrosoftHelp@twilio.com; robmcm" videoId="" scriptId="" solutions="" manager="twilio" editor="mollybos" />
