...
Vous pouvez en savoir plus sur les scénarios d’authentification pour les applications SaaS en lisant l’article [Scénarios d’authentification pour Azure AD](./active-directory/active-directory-authentication-scenarios.md).
