...
Ensuite, nous utiliserons l’API d’utilisation pour remplir la feuille _UsageAPI_, puis corréler les informations avec les données de consommation de l’API de facturation de la feuille _PublishData_.
