<properties
	title="Creating an Oracle Database virtual machine in Azure"
...
2.	Cliquez sur **Marketplace**, sur **Calculer**, puis saisissez **Oracle** dans la zone de recherche.
...
6.	Créez une variable d’environnement nommée **ORACLE\_HOSTNAME** dont la valeur définie correspond au nom de la machine virtuelle. Vous pouvez créer cette variable d’environnement en procédant comme suit :
	...
	b. Sélectionnez l’onglet **Avancé**, puis cliquez sur **Variables d’environnement**.

	c. Sous la section **Variables système**, cliquez sur **Nouveau** afin de créer la variable.

	d. Dans la boîte de dialogue **Nouvelle variable système**, saisissez le nom de variable **ORACLE\_HOSTNAME**, puis entrez le nom de la machine virtuelle en guise de valeur. Pour déterminer le nom de la machine, ouvrez une invite de commandes et exécutez la commande **SET COMPUTERNAME** (la sortie de cette commande indique le nom de la machine).
...
7.	Dans Windows, cliquez sur **Démarrer**, puis entrez **Database Configuration Assistant**. Cliquez sur l’icône **Database Configuration Assistant**.

8.	Dans l’assistant **Database Configuration Assistant**, renseignez les valeurs attendues pour chaque étape de la boîte de dialogue :

	a. **Étape 1 :** cliquez sur **Create Database**, puis cliquez sur **Next**.

		![](media/virtual-machines-creating-oracle-database-virtual-machine/image5.png)

	b. **Étape 2 :** saisissez une valeur pour le nom **Global database name**. Entrez une valeur pour le mot de passe **Administrative Password**, puis confirmez. Ce mot de passe est dédié à votre utilisateur **SYSTEM** de base de données Oracle. Décochez la case **Create As Container Database**. Cliquez sur **Next**.

		![](media/virtual-machines-creating-oracle-database-virtual-machine/image6.png)

	c. **Étape 3 :** les vérifications préalables s’effectuent automatiquement. Passez à l’**étape 4**.

	d. **Étape 4 :** passez en revue les options **Create Database - Summary**, puis cliquez sur **Finish**.
...
1.	En restant connecté à votre machine virtuelle, démarrez une invite de commande SQL Plus. Dans Windows, cliquez sur *Démarrer**, puis entrez **SQL Plus**. Cliquez sur l’icône **SQL Plus**.
...
> [AZURE.NOTE]Vous pouvez exécuter la commande **lsnrctl status** afin de vérifier l’état de l’écouteur. Lorsque vous souhaitez arrêter l’écouteur, vous pouvez exécuter la commande **lsnrctl stop**.

### Ouvrir le port 1521 dans le pare-feu de votre machine virtuelle

1.	Tout en restant connecté à votre machine virtuelle, dans Windows, cliquez sur **Démarrer**, saisissez **Pare-feu Windows avec sécurité avancée**, puis cliquez sur l’icône **Pare-feu Windows avec sécurité avancée**. Cette opération ouvre la console de gestion **Pare-feu Windows avec sécurité avancée**.
...
8.	Saisissez le nom du point de terminaison :
	...
	c. Pour le port privé, indiquez **1521**.
