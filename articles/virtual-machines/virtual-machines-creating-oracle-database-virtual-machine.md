...
8.	Définissez la configuration facultative si nécessaire, en tenant compte des considérations suivantes :
	...
	b. Conservez la valeur « Non configuré » pour le champ **Groupe à haute disponibilité**.
...
8.	Dans l’Assistant **Database Configuration Assistant**, fournissez les valeurs nécessaires pour chaque étape de la boîte de dialogue :
	...
	b. **Étape 2 :** saisissez un nom pour **Global Database Name**. Entrez et confirmez une valeur de mot de passe pour **Administrative Password**. Ce mot de passe est dédié à votre utilisateur **SYSTEM** de base de données Oracle. Désactivez l’option **Create As Container Database**. Cliquez sur **Next**.
