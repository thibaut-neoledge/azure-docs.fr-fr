...
# <a name="moving-files-to-and-from-a-linux-vm-using-scp"></a>Déplacement de fichiers vers et à partir d’une machine virtuelle Linux à l’aide de SCP
...
Pour plus d’informations sur la configuration de votre `~/.ssh/config` et les clés publique et privée SSH, consultez l’article [Créer des clés SSH](virtual-machines-linux-mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
