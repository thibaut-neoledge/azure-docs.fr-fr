...
[Déployer et gérer des machines virtuelles Azure à l’aide de modèles Resource Manager et de PowerShell](virtual-machines-windows-ps-manage.md)

[Création d’une machine virtuelle Windows avec un modèle Resource Manager et PowerShell](virtual-machines-windows-ps-template.md)
