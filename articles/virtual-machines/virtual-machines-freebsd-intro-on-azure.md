...
* Si vous souhaitez utiliser votre propre FreeBSD dans Azure, consultez [Créer et charger un VHD FreeBSD dans Azure](linux/classic/freebsd-create-upload-vhd.md).
