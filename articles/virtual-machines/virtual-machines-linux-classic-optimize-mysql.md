...
Les étapes suivantes décrivent la [configuration logicielle de RAID sur Linux](virtual-machines-linux-configure-raid.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
### <a name="a-nameappendixaaappendix-a"></a><a name="AppendixA"></a>Annexe A  
...
### <a name="a-nameappendixbaappendix-b"></a><a name="AppendixB"></a>Annexe B  
...
### <a name="a-nameappendixcaappendix-c"></a><a name="AppendixC"></a>Annexe C   
...
### <a name="a-nameappendixdaappendix-d"></a><a name="AppendixD"></a>Annexe D  
