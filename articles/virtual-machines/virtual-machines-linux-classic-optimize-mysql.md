---
title: "Optimiser les performances de MySQL sur des machines virtuelles Linux | Microsoft Docs"
...
---
# <a name="optimizing-mysql-performance-on-azure-linux-vms"></a>Optimisation des performances MySQL sur les machines virtuelles Linux Azure
...
> [!IMPORTANT] 
> Azure dispose de deux modèles de déploiement différents pour créer et utiliser des ressources : [le déploiement Resource Manager et le déploiement classique](../azure-resource-manager/resource-manager-deployment-model.md). Cet article traite du modèle de déploiement classique. Pour la plupart des nouveaux déploiements, Microsoft recommande d’utiliser le modèle Resource Manager. Pour plus d’informations sur les optimisations de machines virtuelles Linux avec le modèle Resource Manager, suivez [ce lien](virtual-machines-linux-optimization.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
### <a name="setting-up-raid-on-azure"></a>Configuration de RAID sur Azure
...
#### <a name="step-1-add-a-data-disk-to-your-virtual-machine"></a>Étape 1 : Ajout d’un disque de données à votre machine virtuelle
...
#### <a name="step-2-create-raid-with-the-additional-disks"></a>Étape 2: Création de RAID avec les disques supplémentaires
...
> [!NOTE]
> Si vous utilisez le système de fichiers XFS, suivez les étapes ci-dessous après avoir créé le RAID.
> 
> 
...
#### <a name="step-3-set-up-a-new-storage-path"></a>Étape 3 : Configuration d’un nouveau chemin d’accès de stockage
Utilisez la commande suivante :  

    root@mysqlnode1:~# mkdir -p /RAID0/mysql

#### <a name="step-4-copy-the-original-data-to-the-new-storage-path"></a>Étape 4 : Copie des données d’origine vers le nouveau chemin d’accès de stockage
Utilisez la commande suivante :  

    root@mysqlnode1:~# cp -rp /var/lib/mysql/* /RAID0/mysql/

#### <a name="step-5-modify-permissions-so-mysql-can-access-read-and-write-the-data-disk"></a>Étape 5 : Modification des autorisations pour que MySQL puisse accéder (en lecture et écriture) au disque de données
Utilisez la commande suivante :  
...
### <a name="step-1view-the-current-io-scheduler"></a>Étape 1. Affichage du planificateur d’E/S actuel
Utilisez la commande suivante :  
...
### <a name="step-2-change-the-current-device-devsda-of-io-scheduling-algorithm"></a>Étape 2. Changement du dispositif actuel (/dev/sda) de l’algorithme de planification d’E/S
...
### <a name="step-1-modify-the-limitsconf-file"></a>Étape 1 : Modification du fichier limits.conf
...
### <a name="step-3-ensure-that-the-limits-are-updated-at-boot-time"></a>Étape 3 : Assurez-vous que les limites sont mises à jour au moment du démarrage
...
### <a name="step-1-modify-mycnf-file-by-adding-the-following-lines-to-the-end"></a>Étape 1 : Modifiez le fichier my.cnf en ajoutant les lignes suivantes à la fin
    long_query_time = 2
    slow_query_log = 1
...
### <a name="step-3-check-whether-the-setting-is-taking-effect-using-the-show-command"></a>Étape 3 : Vérifiez si le paramètre prend effet à l’aide de la commande « show »
![][7]   
