<properties
	pageTitle="Mettre automatiquement à l’échelle les groupes de machines virtuelles à échelle identique | Microsoft Azure"
	description="Prise en main de la création et de la gestion de vos premiers groupes de machines virtuelles à échelle identique Azure à l’aide de l’interface de ligne de commande Azure"
...
3. Des variables peuvent être utilisées dans un modèle pour spécifier des valeurs qui changent fréquemment ou qui doivent être créées à partir d’une combinaison de valeurs de paramètres.
	...
	- La taille des machines virtuelles utilisées dans le groupe à échelle identique. Pour plus d’informations sur les tailles de machines virtuelles, voir [Tailles des machines virtuelles](virtual-machines-linux-sizes.md).
...
4. Dans ce didacticiel, vous allez déployer les ressources et les extensions suivantes :
 ...
 - Microsoft.Insights/autoscaleSettings
	...
	Pour plus d’informations sur les ressources de Resource Manager, consultez [Calcul, réseau et fournisseurs de stockage Azure sous Azure Resource Manager](virtual-machines-windows-compare-deployment-models.md).
...
8. Ajoutez la ressource d’interface réseau qui est utilisée par la machine virtuelle jumpbox. Les machines présentes dans le groupe de machines virtuelles à échelle identique n’étant pas directement accessibles par le biais d’une adresse IP publique, une machine virtuelle jumpbox est créée dans le même réseau virtuel que le groupe à échelle identique et est utilisée pour accéder à distance aux machines du groupe.
...
9. Ajoutez la machine virtuelle jumpbox dans le même réseau que le groupe à échelle identique.
...
10.	Ajoutez la ressource de groupe de machines virtuelles à échelle identique et spécifiez l’extension de Diagnostics installée sur toutes les machines virtuelles du groupe à échelle identique. La plupart des paramètres de cette ressource sont similaires à la ressource de machine virtuelle. Voici les principales différences :
...
11.	Ajoutez la ressource autoscaleSettings qui définit le mode d’ajustement du groupe à échelle identique en fonction de l’utilisation du processeur sur les machines virtuelles du groupe. Pour ce didacticiel, il s’agit de valeurs importantes :
