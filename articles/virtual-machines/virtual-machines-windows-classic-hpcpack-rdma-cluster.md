...
Cet article présente deux scénarios, ainsi que des liens ves des instructions détaillées, pour déployer les instances A8 et A9 en cluster avec Microsoft HPC Pack.
...
1. **Créer un nœud principal de cluster et des machines virtuelles à nœud de calcul en exécutant le script de déploiement de HPC Pack IaaS sur un ordinateur client**
    ...
    Pour déployer les nœuds de calcul de taille A8 et A9, notez les considérations supplémentaires.
