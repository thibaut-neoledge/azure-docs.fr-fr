...
3. Sur la page **Choisir une image**, cliquez sur **SQL SERVER**. Sélectionnez ensuite une image SQL Server. Cliquez sur la flèche suivante en bas à droite de la page.
	...
	![Choisir une image](./media/virtual-machines-windows-classic-portal-sql/choose-sql-vm.png)

Pour obtenir les informations les plus récentes concernant les images SQL Server prises en charge sur Azure, consultez la rubrique [Vue d'ensemble de SQL Server sur les machines virtuelles Azure](virtual-machines-windows-classic-sql-overview.md).
...
2. Cliquer sur le bouton **Ouvrir**.
	...
	![Cliquer sur le bouton Ouvrir](./media/virtual-machines-windows-classic-portal-sql/click-open-to-connect.png)

3. Dans la boîte de dialogue **Sécurité de Windows**, cliquez sur **Utiliser un autre compte**.

	![Cliquer sur Utiliser un autre compte](./media/virtual-machines-windows-classic-portal-sql/credentials.png)
...
- [Se connecter à une machine virtuelle SQL Server sur Azure](virtual-machines-windows-classic-sql-connect.md)

- [Meilleures pratiques relatives aux performances de SQL Server sur les machines virtuelles Azure](virtual-machines-windows-classic-sql-perf.md)

- [Considérations relatives à la sécurité de SQL Server sur les machines virtuelles Azure](virtual-machines-windows-classic-sql-security.md)

### Haute disponibilité et récupération d’urgence :
- [Haute disponibilité et récupération d’urgence pour SQL Server sur des machines virtuelles Azure](virtual-machines-windows-classic-sql-dr.md)

- [Sauvegarde et restauration de SQL Server dans les machines virtuelles Azure](virtual-machines-windows-classic-sql-br.md)
