...
* **ImageName** : nom de l’image de machine virtuelle Azure, qui peut être obtenue par le biais du portail Azure ou de l’applet de commande Azure PowerShell **Get-AzureVMImage**. L’image doit répondre aux exigences suivantes :
