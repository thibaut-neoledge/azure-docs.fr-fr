...
L'option **À partir de la galerie** ouvre un Assistant qui vous aide à configurer la machine virtuelle. Utilisez la dernière page de l’Assistant pour installer l’agent de machine virtuelle et l’extension de sécurité Trend Micro. Pour des instructions générales, consultez [Création d’une machine virtuelle sous Windows dans le Portail Azure Classic](virtual-machines-windows-classic-tutorial.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json). Lorsque vous atteignez la dernière page de l’Assistant, procédez comme suit :
...
2. Sous **Extensions de sécurité**, cochez **Trend Micro Deep Security Agent**.
   ...
   ![Installez l'agent de machine virtuelle et l'agent Deep Security.](./media/virtual-machines-windows-classic-install-trend/InstallVMAgentandTrend.png)
