...
ms.openlocfilehash: 2cf7f9fd531c7f54d0b39f3b76a1e64516a413aa
ms.lasthandoff: 04/04/2017


---
# <a name="sap-netweaver-on-azure-virtual-machines--dbms-deployment-guide"></a>SAP NetWeaver sur machines virtuelles Azure – Guide de déploiement SGBD
...
* Outils tiers : pour une description plus complète de la sauvegarde et de SAP sur Azure, consultez [le Guide de la sauvegarde SAP](sap-hana-backup-guide.md).
