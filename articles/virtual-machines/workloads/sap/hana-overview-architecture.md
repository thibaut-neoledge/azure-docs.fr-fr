...
| --- | --- | --- | --- | --- |
| Optimisée pour OLAP : SAP BW, BW/4HANA<br /> ou SAP HANA pour les charges de travail OLAP génériques | SAP HANA sur Azure S72<br /> - 2 x processeurs Intel® Xeon® E7-8890 v3 |  768 Go |  3 To | Disponible |
| --- | SAP HANA sur Azure S144<br /> - 4 x processeurs Intel® Xeon® E7-8890 v3 |  1,5 To |  6 To | Plus proposé |
| --- | SAP HANA sur Azure S192<br /> - 4 x processeurs Intel® Xeon® E7-8890 v4 |  2 TO |  8 To | Disponible |
| --- | SAP HANA sur Azure S384<br /> - 8 x processeurs Intel® Xeon® E7-8890 v4 |  4 TO |  16 TO | Prêt à commander |
| Optimisée pour OLTP : SAP Business Suite<br /> sur SAP HANA ou S/4HANA (OLTP),<br /> OLTP générique | SAP HANA sur Azure S72m<br /> - 2 x processeurs Intel® Xeon® E7-8890 v3 |  1,5 To |  6 To | Disponible |
|---| SAP HANA sur Azure S144m<br /> - 4 x processeurs Intel® Xeon® E7-8890 v3 |  3 TO |  12 To | Plus proposé |
|---| SAP HANA sur Azure S192m<br /> - 4 x processeurs Intel® Xeon® E7-8890 v4 |  4 TO |  16 TO | Disponible |
|---| SAP HANA sur Azure S384m<br /> - 8 x processeurs Intel® Xeon® E7-8890 v4 |  6,0 To |  18 To | Prêt à commander |
|---| SAP HANA sur Azure S384xm<br /> - 8 x processeurs Intel® Xeon® E7-8890 v4 |  8,0 To |  22 To |  Prêt à commander |
|---| SAP HANA sur Azure S576<br /> - 12 x processeurs Intel® Xeon® E7-8890 v4 |  12,0 To |  28 To | Prêt à commander |
|---| SAP HANA sur Azure S768<br /> - 16 x processeurs Intel® Xeon® E7-8890 v4 |  16,0 To |  36 To | Prêt à commander |
|---| SAP HANA sur Azure S960<br /> - 20 x processeurs Intel® Xeon® E7-8890 v4 |  20,0 To |  46 To | Prêt à commander |
| --- | --- | --- | --- | --- |
...
De nombreux clients sont déployés sur le tampon de grande instance SAP HANA, et chacun est protégé des autres par le déploiement de leurs propres réseaux locaux virtuels. Pour connecter les grandes instances HANA à un réseau virtuel Azure, les composants réseau en place connectent les locataires des unités de grande instance HANA de manière isolée dans les réseaux virtuels de l’abonnement Azure du locataire. 
...
**SDDC :** le logiciel de gestion qui est utilisé pour gérer un centre de données comme une entité logicielle définie. Il permet à Microsoft de regrouper des ressources à des fins de mise à l’échelle, de disponibilité et de performances.
