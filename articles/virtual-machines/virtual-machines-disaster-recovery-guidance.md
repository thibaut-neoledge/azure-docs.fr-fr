...
Pour une compréhension technique détaillée des fonctionnalités de la plateforme cloud, consultez le [guide technique Azure Business Continuity](http://aka.ms/bctechguide).
