...
1. Exécutez les commandes redirigées suivantes pour créer les machines virtuelles SQL Server, nommées **ContosoSQL1** et **ContosoSQL2**.
...
## <a name="initialize-the-wsfc-cluster-vms"></a>Initialisation des machines virtuelles du cluster WSFC
...
1. Créez une base de données sur **ContosoSQL1** nommée **MyDB1**, effectuez une sauvegarde complète et une sauvegarde de fichier journal, puis restaurez-les sur **ContosoSQL2** avec l’option **WITH NORECOVERY**.
