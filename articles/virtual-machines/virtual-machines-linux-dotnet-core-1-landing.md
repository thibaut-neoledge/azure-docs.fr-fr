...
| --- | --- |
| SSHKEYDATA |Données de clé SSH utilisées pour sécuriser l’accès à la machine virtuelle. Pour plus d’informations sur la création d’une paire de clés SSH, voir [Création de clés SSH pour machines virtuelles Linux dans Azure](virtual-machines-linux-mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json). |
...
[Étape 1 : architecture d’application avec les modèles Azure Resource Manager](virtual-machines-linux-dotnet-core-2-architecture.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
