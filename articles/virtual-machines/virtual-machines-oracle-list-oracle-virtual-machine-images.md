<properties
	pageTitle="Liste d’images de machines virtuelles Oracle" description="Obtenez la liste des images Oracle dans la galerie Azure et apprenez à créer une machine virtuelle Oracle basée sur l’une d’elles." 
...
Pour créer des machines virtuelles basées sur les images Oracle, connectez-vous au [Portail Azure](https://ms.portal.azure.com/), cliquez sur le **Marketplace**, cliquez sur **Compute**, puis tapez **Oracle** dans la zone de recherche. Choisissez une image et suivez les instructions pour l’installer sur Microsoft Azure. Notez que les images Oracle de Microsoft dans le [Portail Azure](https://ms.portal.azure.com/) s’exécutent sur Windows et que les images Oracle d’Oracle s’exécutent sur Oracle Linux.

![](media/virtual-machines-oracle-list-oracle-virtual-machine-images/image1.png)

##Images de machines virtuelles Windows
Voici une liste des images de machines virtuelles Oracle disponibles qui s’exécutent sur Windows Server dans Azure. Ces images sont fournies moyennant un paiement à l’utilisation. Cela signifie que les frais de licence Oracle sont inclus dans l’utilisation de ces images. Vous pouvez également ajouter votre propre licence pour exécuter le logiciel Oracle sur Windows ou Linux. Consultez ci-dessous des informations complètes sur [la tarification et les licences relatives aux machines virtuelles et images de galerie des machines virtuelles](http://azure.microsoft.com/pricing/details/virtual-machines/#oracle-software). Cliquez sur l’onglet **Oracle** pour des informations sur la tarification spécifique d’Oracle.
...
[Nouveauté : Images Oracle tout-en-un sur Azure Marketplace](https://msopentech.com/blog/2015/02/19/new-one-oracle-images-azure-marketplace/)
