...
Si vous continuez à planifier le déploiement de SQL Server dans une machine virtuelle Azure, vous trouverez des conseils concernant le provisionnement dans le didacticiel suivant : [Configuration d’une machine virtuelle SQL Server sur Azure avec Azure Resource Manager](virtual-machines-sql-server-provision-resource-manager.md).
