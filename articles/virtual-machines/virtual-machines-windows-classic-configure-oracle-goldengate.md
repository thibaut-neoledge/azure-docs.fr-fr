...
---
# <a name="configuring-oracle-goldengate-for-azure"></a>Configuration de GoldenGate Oracle pour Azure
...
* Vous avez déjà consulté la section Considérations relatives à la haute disponibilité et à la récupération d’urgence de la rubrique [Images de machines virtuelles Oracle - Considérations diverses](virtual-machines-windows-classic-oracle-considerations.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json) . Remarquez qu’Azure prend actuellement en charge des instances autonomes d’Oracle Database, mais pas Oracle Real Application Clusters (Oracle RAC).
...
* Vous avez créé deux machines virtuelles dans Azure à l’aide d’Oracle Enterprise Edition sur Windows Server. Assurez-vous que les machines virtuelles sont présentes au sein du [même service cloud](virtual-machines-linux-load-balance.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) et du même [réseau virtuel](https://azure.microsoft.com/documentation/services/virtual-network/) pour garantir qu’elles peuvent accéder l’une à l’autre via l’adresse IP privée persistante.
...
## <a name="1-setup-database-on-site-a-and-site-b"></a>1. Configurer la base de données sur les sites A et B
...
Localisez ensuite le fichier INIT\<SID_de_la_base_de_données\>.ORA dans le dossier %ORACLE\_HOME%\\database sur les sites A et B, puis ajoutez les paramètres de base de données suivants au fichier INITTEST.ora :
...
### <a name="perform-initial-data-load"></a>Charger les données initiales
...
## <a name="2-prepare-site-a-and-site-b-for-database-replication"></a>2. Préparer les sites A et B pour la réplication de base de données
...
## <a name="4-configure-goldengate-manager-on-site-a-and-site-b"></a>4. Configurer GoldenGate Manager sur les sites A et B
...
## <a name="5-create-extract-group-and-data-pump-processes-on-site-a-and-site-b"></a>5. Créer un groupe Extract et des processus Data Pump sur les sites A et B
### <a name="create-extract-and-data-pump-processes-on-site-a"></a>Créer des processus Extract et Data Pump sur le site A
...
### <a name="create-a-goldengate-checkpoint-table-on-site-b"></a>Créer une table de points de contrôle GoldenGate sur le site B
...
### <a name="add-replicat-on-site-b"></a>Commande ADD REPLICAT sur le site B
...
### <a name="create-extract-and-data-pump-processes-on-site-b"></a>Créer des processus Extract et Data Pump sur le site B
...
### <a name="create-a-goldengate-checkpoint-table-on-site-a"></a>Créer une table de points de contrôle GoldenGate sur le site A
...
### <a name="add-replicat-on-site-a"></a>Commande ADD REPLICAT sur le site A
...
### <a name="add-trandata-on-site-a-and-site-b"></a>Commande ADD TRANSDATA sur les sites A et B
...
### <a name="start-extract-and-data-pump-processes-on-site-a"></a>Démarrer les processus Extract et Data Pump sur le site A
...
### <a name="start-extract-and-data-pump-processes-on-site-b"></a>Démarrer les processus Extract et Data Pump sur le site B
...
### <a name="start-replicat-process-on-site-a"></a>Démarrer le processus REPLICAT sur le site A
...
### <a name="start-replicat-process-on-site-b"></a>Démarrer le processus REPLICAT sur le site B
...
## <a name="6-verify-the-bi-directional-replication-process"></a>6. Vérifier le processus de réplication bidirectionnelle
...
[Liste des images de machines virtuelles Oracle pour Azure](virtual-machines-linux-classic-oracle-images.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
