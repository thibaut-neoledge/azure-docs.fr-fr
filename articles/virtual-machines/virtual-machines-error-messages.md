---
title: "Messages d’erreur des machines virtuelles Azure"
description: 
...
---
# <a name="azure-virtual-machine-error-messages"></a>Messages d’erreur des machines virtuelles Azure
Cet article décrit les codes d’erreur courants et les messages que vous rencontrez lors de la gestion d’une machine virtuelle Azure.  

>[!NOTE]
>Laissez des commentaires sur cette page à propos des messages d’erreur ou dans la page des [commentaires Azure](https://feedback.azure.com/forums/216843-virtual-machines) avec la balise #azerrormessage.
>
>
...
Une réponse d’erreur inclut toujours un code d’état, un objet d’erreur. Chaque objet d’erreur contient toujours un code d’erreur et un message d’erreur. Si le déploiement de la machine virtuelle est créé via un modèle, l’objet d’erreur contient également une section de détails, qui contient un niveau interne de codes et de messages d’erreur. Normalement, le niveau le plus interne des messages d’erreur est l’échec principal. 


## <a name="common-virtual-machine-management-error"></a>Erreurs courantes de gestion des machines virtuelles

Cette section répertorie les messages d’erreur courants de gestion de votre machine virtuelle.
