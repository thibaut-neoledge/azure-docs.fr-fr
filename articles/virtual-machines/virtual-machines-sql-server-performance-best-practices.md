...
Si vous voulez obtenir davantage d’informations sur SQL Server et le stockage Premium, voir l’article [Utilisation du stockage Premium Azure avec SQL Server sur des machines virtuelles](virtual-machines-sql-server-use-premium-storage.md).

Pour les meilleures pratiques de sécurité, voir [Considérations relatives à la sécurité de SQL Server sur les machines virtuelles Azure](virtual-machines-sql-server-security-considerations.md).
