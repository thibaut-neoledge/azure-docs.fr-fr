...
### <a name="to-add-a-reference-to-microsoft.reportviewer.common"></a>Pour ajouter une référence à Microsoft.ReportViewer.Common
...
### <a name="to-make-the-assemblies-locally-accessible-by-your-asp.net-application"></a>Pour rendre les assemblys accessibles en local par votre application ASP.NET
...
## <a name="publish-the-asp.net-web-application-to-azure"></a>Publier l’application web ASP.NET sur Azure
