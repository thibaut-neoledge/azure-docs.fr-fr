...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] Pour plus d’informations sur le modèle Resource Manager, consultez [Créer une copie d’une machine virtuelle Windows exécutant Azure](virtual-machines-windows-vhd-copy.md).
...
4.  La boîte de dialogue **Outil de préparation système** apparaît. Effectuez les actions suivantes :
    ...
    - Dans **Action de nettoyage du système**, sélectionnez **Entrer en mode OOBE (OOBE)** et vérifiez que la case à cocher **Généraliser** est activée. Pour plus d’informations sur l’utilisation de Sysprep, voir la page [Introduction à l’utilisation de Sysprep][].
