...
Le modèle que vous créez dans ce didacticiel est similaire à un modèle qui se trouve dans la galerie de modèles. Pour en savoir plus, consultez [Déployer un groupe de machines virtuelles à échelle identique simple avec des machines virtuelles Linux et une Jumpbox](https://azure.microsoft.com/documentation/templates/201-vmss-linux-jumpbox/).
