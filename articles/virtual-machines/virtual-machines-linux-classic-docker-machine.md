<properties
   pageTitle="Utiliser docker-machine avec Azure | Microsoft Azure"
   description="Montre comment être opérationnel sur Azure avec Docker Machine sur Ubuntu, en utilisant le modèle de déploiement classique."
...
## Étapes suivantes
Accédez au [guide de l’utilisateur Docker](https://docs.docker.com/userguide/) et créez des applications sur Microsoft Azure. Ou bien, expérimentez [Docker et Swarm sur Azure] et découvrez comment [swarm](https://github.com/docker/swarm) peut être utilisé avec Docker et Azure.
...
[Docker et Swarm sur Azure]: virtual-machines-linux-docker-swarm.md
