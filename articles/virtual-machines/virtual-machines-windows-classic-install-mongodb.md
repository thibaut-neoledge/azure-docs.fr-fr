...
Pour installer et configurer MongoDB à l’aide du modèle de déploiement Resource Manager, consultez [cet article](virtual-machines-windows-classic-install-mongodb.md).
