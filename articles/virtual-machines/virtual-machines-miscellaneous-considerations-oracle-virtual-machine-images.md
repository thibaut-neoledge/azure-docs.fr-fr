<properties 
pageTitle="Remarques diverses concernant les images de machines virtuelles Oracle"
	description="Consultez des remarques supplémentaires avant de déployer une machine virtuelle Oracle dans Azure."
