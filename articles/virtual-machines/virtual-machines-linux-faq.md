...
Oui. Le nom d’ordinateur peut avoir une longueur maximale de 64 caractères. Consultez la rubrique [Instructions de dénomination d’infrastructure](virtual-machines-linux-infrastructure-naming-guidelines.md) pour plus d’informations sur la dénomination de ressources.
