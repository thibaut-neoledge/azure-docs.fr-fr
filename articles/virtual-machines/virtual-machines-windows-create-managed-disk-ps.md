...
- Si vous disposez déjà d’une machine virtuelle, vous pouvez y [attacher un disque de données](virtual-machines-windows-attach-disk-portal.md).
