<properties
	pageTitle="Configuration de PostgreSQL sur une machine virtuelle Linux | Microsoft Azure"
...
> [AZURE.NOTE] Vous devez déjà disposer d’une machine virtuelle Microsoft Azure exécutant Linux pour effectuer ce didacticiel. Consultez le [didacticiel sur les machines virtuelles Linux Azure](virtual-machines-linux-cli-create.md) pour créer et configurer une machine virtuelle Linux avant de continuer.
