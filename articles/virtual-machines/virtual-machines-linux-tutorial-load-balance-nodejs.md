...
# <a name="build-a-highly-available-application-on-linux-virtual-machines-in-azure"></a>Création d’une application hautement disponible sur les machines virtuelles Linux dans Azure
...
![Exécution de l’application Node.js](./media/virtual-machines-linux-tutorial-load-balance-nodejs/running-nodejs-app.png)
...
- [Gestion de la disponibilité des machines virtuelles Linux](virtual-machines-linux-manage-availability.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
- [Exemples de scripts CLI Azure](virtual-machines-linux-cli-samples.md)
