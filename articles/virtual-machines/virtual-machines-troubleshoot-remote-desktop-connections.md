...
Si aucune de ces erreurs ne s’est produite et que vous ne parvenez toujours pas à vous connecter à la machine virtuelle par le biais du Bureau à distance, consultez le [guide de dépannage détaillé du Bureau à distance](virtual-machines-rdp-detailed-troubleshoot.md).
