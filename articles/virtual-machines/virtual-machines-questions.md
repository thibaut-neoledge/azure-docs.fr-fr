...
- Pour obtenir des instructions concernant Windows, référez-vous à [Création et téléchargement d’un disque dur virtuel Windows Server dans Azure](virtual-machines-create-upload-vhd-windows-server.md).
...
- Consultez [Résolution des problèmes de connexion Bureau à distance avec une machine virtuelle Azure exécutant Windows](virtual-machines-troubleshoot-remote-desktop-connections.md).
