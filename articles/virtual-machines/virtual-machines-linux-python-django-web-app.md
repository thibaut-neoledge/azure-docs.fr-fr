...
1. Suivez les instructions fournies [ici](virtual-machines-linux-quick-create-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) pour créer une machine virtuelle Azure de la distribution *Ubuntu Server 14.04 LTS*.  Si vous préférez, vous pouvez choisir l'authentification par de mot de passe au lieu d’utiliser la clé publique SSH.
...
3. Par défaut, votre nouvelle machine virtuelle n'a pas de nom de domaine complet (FQDN).  Vous pouvez en créer un en suivant les instructions indiquées [ici](virtual-machines-linux-portal-create-fqdn.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).  Cette étape est facultative pour la suite de ce didacticiel.
