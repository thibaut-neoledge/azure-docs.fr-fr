...
3. Par défaut, votre nouvelle machine virtuelle n'a pas de nom de domaine complet (FQDN). Vous pouvez en créer un en suivant les instructions [présentes ici](virtual-machines-linux-portal-create-fqdn.md). Cette étape est facultative pour la suite de ce didacticiel.
