<properties 
   pageTitle="Commandes de base de l’interface de ligne de commande Azure pour Linux et Mac | Microsoft Azure"
   description="Commandes de base de l’interface de ligne de commande Azure vous permettant de prendre en main la gestion de vos machines virtuelles en mode Azure Resource Manager sous Linux et Mac"
...
# Commandes courantes de l’interface de ligne de commande Azure sur Mac et Linux
...
Cet article traite des commandes de base que vous utiliserez avec l’interface de ligne de commande Azure pour gérer et interagir avec vos ressources ARM (principalement des machines virtuelles) dans votre abonnement Azure. Pour plus d’aide sur les options et commutations de ligne de commande spécifiques, vous pouvez utiliser les options et une aide en ligne de commande en tapant `azure <command> <subcommand> --help` ou `azure help <command> <subcommand>`.
...
* Pour d'autres exemples de commandes de l'interface de ligne de commande dépassant la gestion de base des machines virtuelles, référez-vous à la rubrique traitant de l’[utilisation de l'interface de ligne de commande Azure avec l’Azure Resource Manager](azure-cli-arm-commands.md).
