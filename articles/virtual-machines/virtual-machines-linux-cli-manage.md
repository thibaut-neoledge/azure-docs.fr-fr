...
# Commandes équivalentes de Resource Manager et de Service Management pour les tâches de machine virtuelle Linux avec l’interface de ligne de commande Azure
