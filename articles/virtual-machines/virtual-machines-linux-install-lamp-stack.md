...
1. Configurez **Apache**
	...
	- Par défaut, Apache écoute sur le port 80. Il est possible que vous ayez besoin d'un point de terminaison pour accéder à votre serveur Apache à distance. Pour plus d'informations, veuillez consulter la documentation sur la [configuration de points de terminaison](virtual-machines-windows-classic-setup-endpoints.md).
