<properties
	pageTitle="Création et téléchargement d'un VHD Oracle Linux | Microsoft Azure"
...
- Vérifiez que le référentiel `Addons` est activé. Modifiez le fichier `/etc/yum.repo.d/public-yum-ol6.repo`(Oracle Linux 6) ou `/etc/yum.repo.d/public-yum-ol7.repo`(Oracle Linux), remplacez la ligne `enabled=0` par `enabled=1` sous **[ol6\_addons]** ou **[ol7\_addons]** dans ce fichier.
