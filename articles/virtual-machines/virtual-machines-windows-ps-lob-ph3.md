...
Souvenez-vous que vous avez défini la table M au cours de la [Phase 2](virtual-machines-windows-ps-lob-ph2.md), et les tables V, S, ST et A au cours de la [Phase 1](virtual-machines-windows-ps-lob-ph1.md).
...
9.	Dans **Nom de connexion**, tapez *domain*\\sqladmin (où *domain* désigne le nom du domaine dans lequel le compte sqladmin a été créé au cours de la [Phase 2](virtual-machines-windows-ps-lob-ph2.md)). 
...
Notez que, au moment de l’exécution de la commande **Add-Computer**, vous devez fournir des informations d’identification de compte de domaine.
...
1.	Connectez-vous à la machine virtuelle SQL Server principale avec le compte sqladmin créé au cours de la [Phase 2](virtual-machines-windows-ps-lob-ph2.md).
...
5.	Dans la page **Sélectionner les serveurs**, entrez le nom de la machine SQL Server principale, cliquez sur **Ajouter**, puis cliquez sur **Suivant**.
