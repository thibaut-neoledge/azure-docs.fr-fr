...
Découvrez comment [effectuer ces étapes à l’aide du modèle Resource Manager](virtual-machines-windows-ps-create.md).
...
## <a name="<a-id="examples"></a>examples"></a><a id="examples"></a>Exemples
