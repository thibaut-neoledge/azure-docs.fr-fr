...
> * [Classique](virtual-machines-linux-classic-restart-resize-error-troubleshooting.md)
> * [Gestionnaire de ressources](virtual-machines-linux-restart-resize-error-troubleshooting.md)
> 
> 
...
## Étapes suivantes
Si vous rencontrez des problèmes lorsque vous créez une machine virtuelle Linux dans Azure, consultez [Résoudre les problèmes de déploiement liés à la création d’une machine virtuelle Linux dans Azure](virtual-machines-linux-troubleshoot-deployment-new-vm.md).
