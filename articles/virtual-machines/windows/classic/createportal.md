...
description: "Découvrez comment créer une machine virtuelle Windows personnalisée à partir du Portail Azure à l’aide du modèle de déploiement classique."
...
Vous pouvez également [créer une machine virtuelle personnalisée exécutant Linux](../../linux/classic/createportal.md).
