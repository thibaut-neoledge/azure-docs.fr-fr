...
ms.openlocfilehash: 7552f95c1c62aaa59dbe4a8e986a56ad036e0d1a
...
Pour une vue d’ensemble complète de la préparation, du téléchargement et de la création d’une machine virtuelle à l’aide de disques gérés, consultez [Créer une machine virtuelle à partir d’un disque dur virtuel généralisé chargé dans Azure à l’aide de Managed Disks](upload-generalized-managed.md) ou [Téléchargement d’un disque dur virtuel spécialisé pour créer une machine virtuelle dans Azure](upload-specialized.md).
...
* **Disque dur virtuel généralisé** : toutes les informations de votre compte personnel de ce type de disque ont été supprimées avec Sysprep. Si vous prévoyez d’utiliser le disque dur virtuel en tant qu’image pour créer des machines virtuelles, vous devez :
  ...
  * [Préparer un disque dur virtuel Windows à charger sur Azure](prepare-for-upload-vhd-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). 
  * [Généraliser la machine virtuelle avec Sysprep](generalize-vhd.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). 
...
* [Créer une machine virtuelle dans Azure à partir d’un disque dur virtuel généralisée](create-vm-generalized.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
* [Créez une machine virtuelle dans Azure à partir d’un disque dur virtuel spécialisé](create-vm-specialized.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) en le joignant comme disque de système d’exploitation lorsque vous créez une nouvelle machine virtuelle.
