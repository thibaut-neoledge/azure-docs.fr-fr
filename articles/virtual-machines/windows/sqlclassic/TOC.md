...
## [Provisionner une machine virtuelle avec Azure PowerShell](virtual-machines-windows-classic-ps-sql-create.md)
## [Se connecter à une machine virtuelle](virtual-machines-windows-classic-sql-connect.md)
...
### [Configurer un groupe de disponibilité Always On dans le portail classique](virtual-machines-windows-classic-portal-sql-alwayson-availability-groups.md)
### [Configurer un groupe de disponibilité Always On avec PowerShell](virtual-machines-windows-classic-ps-sql-alwayson-availability-groups.md)
...
### [Business Intelligence de Microsoft SQL Server dans les machines virtuelles Azure](virtual-machines-windows-classic-ps-sql-bi.md)
### [Utiliser ReportViewer sur un site web hébergé dans Azure](virtual-machines-windows-classic-sql-server-reportviewer.md)
### [Utiliser Azure PowerShell pour créer une machine virtuelle Azure avec un serveur de rapports](virtual-machines-windows-classic-ps-sql-report.md)
...
## [Pilotes SQL Server](https://docs.microsoft.com/sql/connect/sql-server-drivers)
## [REST](/rest/api/)
