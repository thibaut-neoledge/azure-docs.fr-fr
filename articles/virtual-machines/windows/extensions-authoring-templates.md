...
Pour voir un exemple de configuration pour les extensions Windows, consultez la page [Exemples d’extensions Windows](extensions-configuration-samples.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
