...
---
<a id="azure-availability-sets-guidelines-for-windows-vms" class="xliff"></a>

# Instructions pour les groupes à haute disponibilité Azure pour les machines virtuelles Windows
