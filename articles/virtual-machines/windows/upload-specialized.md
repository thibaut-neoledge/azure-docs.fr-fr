...
Si vous prévoyez d’utiliser le disque dur virtuel spécialisé tel quel pour créer une machine virtuelle, veillez à effectuer les étapes suivantes. 
  * Si vous prévoyez d’utiliser Managed Disks, consultez [Planification de la migration vers Managed Disks](on-prem-to-azure.md#plan-for-the-migration-to-managed-disks).
  * [Préparer un disque dur virtuel Windows à charger sur Azure](prepare-for-upload-vhd-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). **Ne généralisez pas** la machine virtuelle à l’aide de Sysprep.
