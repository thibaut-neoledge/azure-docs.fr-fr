# Vue d'ensemble
## [Qu’est-ce que SQL Server sur machines virtuelles Azure ?](virtual-machines-windows-sql-server-iaas-overview.md) 
...
### [Considérations relatives à la sécurité](virtual-machines-windows-sql-security.md)
