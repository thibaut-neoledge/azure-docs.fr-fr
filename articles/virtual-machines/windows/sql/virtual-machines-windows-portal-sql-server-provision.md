...
3. Dans le panneau **Nouveau**, cliquez sur **Machines virtuelles**.
4. Pour afficher toutes les images disponibles, cliquez sur **Tout afficher** dans le panneau **Machines virtuelles**.
