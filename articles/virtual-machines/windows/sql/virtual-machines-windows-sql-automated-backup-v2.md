---
title: "Sauvegarde automatisée version 2 pour les machines virtuelles Azure SQL Server 2016 | Microsoft Docs"
...
Dans ce cas, une sauvegarde automatisée commencera à sauvegarder les bases de données restantes le lendemain, mercredi à 1 h 00 pendant 1 heure. Si les bases de données n’ont pas toutes été sauvegardées pendant cette période, une nouvelle tentative de sauvegarde sera effectuée le lendemain à la même heure. Cette opération se poursuit jusqu'à ce que toutes les bases de données aient été correctement sauvegardées.
