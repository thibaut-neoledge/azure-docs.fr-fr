...
## <a name="steps-for-manually-configuring-sql-server-connectivity-in-an-azure-vm"></a>Procédure de configuration manuelle de la connectivité SQL Server dans une machine virtuelle Azure
