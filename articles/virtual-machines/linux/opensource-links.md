...
* [Forum aux questions sur les machines virtuelles Azure créées avec le modèle de déploiement classique](classic/faq.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [Connexion à une machine virtuelle exécutant Linux à l’aide du Portail Azure Classic](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)

## <a name="set-up"></a>Installation
* [Installer l’interface de ligne de commande Microsoft Azure](../../cli-install-nodejs.md)

## <a name="tutorials"></a>Didacticiels
* [Installation de la pile LAMP sur une machine virtuelle Linux dans Azure](create-lamp-stack.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Utilisation de l’extension Docker VM à partir de l’interface de ligne de commande Microsoft Azure](classic/cli-use-docker.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
* [Utilisation de l’extension Docker VM avec le portail Azure](classic/portal-use-docker.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
* [Comment utiliser docker-machine sur Azure](docker-machine.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Concepts de base : capture d'une machine virtuelle Linux pour en faire un modèle](classic/capture-image.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [comment réinitialiser un mot de passe ou des propriétés SSH pour Linux](classic/reset-access.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [agent Linux Azure](../windows/agent-user-guide.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [association d'un disque de données à une machine virtuelle Linux](../windows/classic/attach-disk.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [Comment configurer des points de terminaison sur une machine virtuelle classique dans Azure](../windows/classic/setup-endpoints.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)

## <a name="troubleshooting"></a>Résolution de problèmes
* [Résolution des problèmes des connexions SSH avec une machine virtuelle Azure Linux](troubleshoot-ssh-connection.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
