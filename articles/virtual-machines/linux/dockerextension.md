...
---
# Création d’un environnement Docker dans Azure à l’aide de l’extension Docker VM
<a id="create-a-docker-environment-in-azure-using-the-docker-vm-extension" class="xliff"></a>
