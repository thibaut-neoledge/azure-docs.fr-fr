...
- [Azure CLI 2.0](../linux/quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) ou [Azure CLI 1.0](quick-create-cli-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
- [Portail Azure](../linux/quick-create-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)

Vous devez également être connecté à un [compte Azure actif](https://azure.microsoft.com/pricing/free-trial/).


## <a name="quick-commands"></a>Commandes rapides
Si vous avez besoin d’accomplir rapidement cette tâche, la section suivante décrit les commandes de base pour installer et configurer un bureau à distance sur votre machine virtuelle. Pour obtenir plus d’informations et davantage de contexte pour chaque étape, lisez la suite de ce document, à partir de [cette section](#install-graphical-environment-on-linux-vm).

L’exemple suivant installe l’environnement de bureau léger [xfce4](https://www.xfce.org/) sur une machine virtuelle Ubuntu. Les autres distributions et environnements de bureau varient légèrement. Par exemple, utilisez **yum** pour effectuer une installation sur Red Hat Enterprise Linux et configurez les règles **selinux** appropriées, ou utilisez **zypper** pour une installation sur SUSE.

Connectez-vous avec SSH à votre machine virtuelle. Installez l’environnement de bureau xfce comme suit :
...
Installez xrdp comme suit :

```bash
sudo apt-get install xrdp
```

Configurez xrdp pour utiliser xfce en tant qu’environnement de bureau comme suit :
...
Définissez un mot de passe pour votre compte d’utilisateur si actuellement vous utilisez uniquement la clé SSH pour l’authentification :
...
Tout d’abord, connectez-vous avec SSH à votre machine virtuelle. L’exemple suivant se connecte à la machine virtuelle nommée `myvm.westus.cloudapp.azure.com` avec le nom d’utilisateur `ops` :
...
Si vous ne recevez pas de réponse dans votre client Bureau à distance et que vous ne voyez aucun événement dans le journal système, cela indique que le trafic du bureau à distance ne peut pas joindre la machine virtuelle. Passez en revue vos règles de groupe de sécurité réseau pour vous assurer que vous disposez d’une règle autorisant TCP sur le port 3389. Pour plus d’informations, consultez [Résoudre les problèmes de connectivité des applications sur une machine virtuelle Linux Azure](../windows/troubleshoot-app-connection.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).


## <a name="next-steps"></a>Étapes suivantes
Pour plus d’informations sur la création et l’utilisation de clés SSH avec les machines virtuelles Linux, consultez [Create SSH keys for Linux VMs in Azure](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) (Création de clés SSH pour les machines virtuelles Linux dans Azure).

Pour plus d’informations sur l’utilisation de SSH avec Windows, consultez la page [Utilisation de clés SSH avec Windows sur Azure](ssh-from-windows.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
