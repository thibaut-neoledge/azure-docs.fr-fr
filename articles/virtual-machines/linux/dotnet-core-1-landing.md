---
title: "Didacticiel sur DotNet Core pour les machines virtuelles Linux Azure 1 | Microsoft Docs"
...
Le modèle Resource Manager du Store musique se trouve ici : [Modèle Linux du Store musique](https://github.com/neilpeterson/nepeters-azure-templates/tree/master/dotnet-core-music-linux-vm-sql-db)
...
| --- | --- |
| SSHKEYDATA |Données de clé SSH utilisées pour sécuriser l’accès à la machine virtuelle. Pour plus d’informations sur la création d’une paire de clés SSH, voir [Création de clés SSH pour machines virtuelles Linux dans Azure](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json). |
| ADMINUSERNAME |Nom d’utilisateur administrateur utilisé sur la machine virtuelle et la base de données Azure SQL Database. |
| SQLADMINPASSWORD |Mot de passe utilisé sur la base de données Azure SQL Database. |
...
[Étape 1 : architecture d’application avec les modèles Azure Resource Manager](dotnet-core-2-architecture.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)

[Étape 2 : accès et sécurité dans les modèles Azure Resource Manager](dotnet-core-3-access-security.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
[Étape 4 : déploiement d’application avec des modèles Azure Resource Manager](dotnet-core-5-app-deployment.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
