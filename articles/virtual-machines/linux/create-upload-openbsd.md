...
Pour contrôler l’accès au compte de stockage, obtenez la clé de stockage avec la commande [az storage account keys list](/cli/azure/storage/account/keys#list) comme suit :
