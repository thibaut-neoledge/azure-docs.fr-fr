...
| [Mémoire optimisée](sizes-memory.md)         | M, GS, G, DSv2, DS, Dv2, D   | Ratio mémoire/coeur élevé. Idéal pour les serveurs de base de données relationnelle, les caches moyens à grands et l’analytique en mémoire.                 |
