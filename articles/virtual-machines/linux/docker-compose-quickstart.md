...
Si vous utilisez l’extension de machine virtuelle Docker, votre machine virtuelle est automatiquement configurée en tant qu’hôte Docker et Compose est déjà installé.
