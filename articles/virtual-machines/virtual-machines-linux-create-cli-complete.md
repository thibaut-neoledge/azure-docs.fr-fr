...
- Déployer un groupe de ressources
- Déployer un compte de stockage
- Déployer un réseau virtuel et un sous-réseau
- Configurer un Groupe de sécurité réseau (NSG) et des règles de trafic entrant
- Affecter une adresse IP publique à la carte d’interface réseau (NIC)
- Affecter le NSG à la NIC
- Déployer une machine virtuelle Ubuntu 14.04 LTS

## Composants requis

- Compte Azure.
  - [Obtenez une version d’évaluation gratuite.](https://azure.microsoft.com/pricing/free-trial/) 
  - [Portail Azure](https://portal.azure.com)
- Outil d’analyse JSON : cet exemple utilise [jq](https://stedolan.github.io/jq/)
...
_Les exemples fournis dans la section Commandes rapides utilisent des noms que vous devrez remplacer par vos propres paramètres ; modifiez ces exemples selon vos besoins._
