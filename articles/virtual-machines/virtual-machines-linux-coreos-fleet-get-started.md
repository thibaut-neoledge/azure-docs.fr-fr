<properties
	...
	description="Fournit des exemples simples d’utilisation de Fleet et de Docker avec un cluster de machine virtuelle CoreOS Linux créée avec le modèle de déploiement classique sur Azure."
...
## <a id='highavail'>Exemple 2 : serveur nginx hautement disponible</a>
