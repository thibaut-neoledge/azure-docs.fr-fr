...
6. **Installation de l’Agent Azure**
    ...
    **Important** : après l’installation, vous pouvez valider la version et vérifier qu’elle s’exécute.
...
7. **Annuler l’approvisionnement**

    Il consiste à nettoyer le système afin de le rendre prêt pour un réapprovisionnement. La commande ci-dessous supprime également le dernier compte d'utilisateur approvisionné et les données associées.
...
4. Entrez : `Import-AzurePublishSettingsFile <PathToFile>`
   ...
   Pour plus d’information sur l’installation et la configuration de PowerShell, consultez [Installation et configuration de Microsoft Azure PowerShell](../powershell-install-configure.md).
...
2. À l’issue de ces étapes, la nouvelle image apparaît sous l’onglet **Images** du portail Azure Classic.
    ...
    ![ajouter une image](./media/virtual-machines-linux-classic-freebsd-create-upload-vhd/addfreebsdimage.png)
