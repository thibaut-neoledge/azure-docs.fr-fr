...
| SUSE Linux Enterprise |SLES 11 SP4, SLES 12+ et  <p>  SLES pour SAP 11.3+ |Dans le noyau |Package: dans le référentiel [Cloud:Tools](https://build.opensuse.org/project/show/Cloud:Tools) sous « python-azure-agent » <br/>Code source : [GitHub](http://go.microsoft.com/fwlink/p/?LinkID=250998) |
...
| Ubuntu |Ubuntu 12.04, 14.04 et 16.04 |Dans le noyau |Package : dans le référentiel sous « python-azure-agent » <br/>Code source : [GitHub](https://github.com/Azure/WALinuxAgent) |
