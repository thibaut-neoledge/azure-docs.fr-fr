...
- [Azure CLI 2.0 (version préliminaire)](#azure-cli-20-preview) : notre interface de ligne de commande nouvelle génération pour le modèle de déploiement Resource Manager
