...
Ensuite, créez une machine virtuelle Azure pour SQL1 avec ces commandes à l'invite de commandes Azure PowerShell sur votre ordinateur local. Avant d'exécuter ces commandes, renseignez les valeurs des variables et supprimez les caractères < and >.
