...
L’agent Linux Azure (/usr/sbin/waagent) gère l’interaction entre la machine virtuelle et le contrôleur de structure Microsoft Azure. Découvrez également la procédure de [mise à jour de l’Agent Linux Azure](virtual-machines-linux-update-agent.md) pour plus d’informations sur l’installation et la mise à jour de l’agent sur une machine virtuelle en cours d’exécution.

L’Agent Linux Azure est responsable des tâches suivantes :

> [AZURE.NOTE] Consultez le fichier [README](https://github.com/Azure/WALinuxAgent/blob/master/README.md) (Lisez-moi) de l’Agent Linux Azure pour découvrir la dernière version de ce guide.
