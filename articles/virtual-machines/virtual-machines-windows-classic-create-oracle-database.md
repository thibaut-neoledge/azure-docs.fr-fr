<properties
	pageTitle="Créer une machine virtuelle Oracle Database à l’aide du portail Azure Classic | Microsoft Azure"
	description="Découvrez comment créer une machine virtuelle sur laquelle figure une base de données Oracle Database à l’aide du modèle de déploiement classique et du portail Azure."
...
L’exemple suivant vous montre comment créer une base de données Oracle sur une machine virtuelle Windows Server vous avez préalablement créée et installée avec Oracle Database 12c. La procédure à suivre implique deux étapes. Tout d’abord, connectez la machine virtuelle, puis créez la base de données Oracle dans la machine virtuelle. L’exemple présenté concerne Oracle Database version 12c, mais les étapes sont presque identiques pour la version 11g.
...
2.	Lorsque vous y êtes invité, connectez-vous à l’aide du nom d’utilisateur de **SYSTEM** et du mot de passe que vous avez spécifié lors de la création de la base de données Oracle.
...
-	[Images de machines virtuelles Oracle – Considérations diverses](virtual-machines-windows-classic-oracle-considerations.md)

-	[Oracle Database 12c Documentation Library (en anglais)](http://www.oracle.com/pls/db1211/homepage)
