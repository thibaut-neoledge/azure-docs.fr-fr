<properties
	pageTitle="À propos des machines virtuelles Puppet et Azure | Microsoft Azure"
	description="Décrit l’installation et la configuration de Puppet sur une machine virtuelle dans Azure"
...
Puppet est un système client-serveur. Puppet Master et Puppet Enterprise Agent peuvent être installés via Microsoft Azure :
...
Pour obtenir des instructions, téléchargez le « Guide de prise en main » sur la page [Microsoft Windows et Azure](http://puppetlabs.com/solutions/microsoft).
