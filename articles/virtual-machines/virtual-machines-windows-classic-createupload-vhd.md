...
* **[Microsoft Azure PowerShell](/powershell/azureps-cmdlets-docs)** : le module Microsoft Azure PowerShell est installé et configuré de façon à utiliser votre abonnement.
...
Vous pouvez à présent [créer une machine virtuelle personnalisée](virtual-machines-windows-classic-createportal.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json) à l’aide de l’image que vous avez chargée.
