...
Chef a trois principaux composants architecturaux. Le **serveur Chef, le client Chef (nœud)** et le **Chef de station de travail.**
...
Inscrivez-vous à un compte de Chef hébergé : <a href="https://manage.chef.io/signup" target="_blank">https://manage.chef.io/signup</a>
...
**Remarque :** à l’aide de la ligne de commande, nous automatisons également les règles de filtrage du réseau de point de terminaison à l’aide du paramètre –tcp-endpoints. Nous avons ouvert les ports 80 et 3389 pour fournir l’accès à notre page Web et à la session RDP.
