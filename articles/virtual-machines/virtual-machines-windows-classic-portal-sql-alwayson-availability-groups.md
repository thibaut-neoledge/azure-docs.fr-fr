...
2. Cliquez sur **Services réseau**, puis cliquez sur **Réseau virtuel,** puis sur **Création personnalisée**, comme illustré ci-dessous.
    ...
    ![Création d’un réseau virtuel](./media/virtual-machines-windows-classic-portal-sql-alwayson-availability-groups/IC665512.gif)
...
5. Sélectionnez **Suivant** jusqu'à ce que vous atteigniez la section **Rôles des serveurs**.
...
6. Créez deux utilisateurs supplémentaires avec les mêmes étapes : **CORP\\SQLSvc1** et **CORP\\SQLSvc2**. Ces comptes seront utilisés pour les instances de SQL Server. Ensuite, vous devez donner à **CORP\\Install** les autorisations nécessaires pour la configuration des clusters de basculement Windows Service (WSFC).
...
12. Dans **Nom de l'ordinateur**, cliquez sur **Modifier**.
13. Sélectionnez le **Domaine** et saisissez **corp.contoso.com** dans la zone de texte. Cliquez sur **OK**.
...
5. Lorsque l’installation de la fonctionnalité de **Clustering de basculement** est terminée, cliquez sur **Fermer**.
...
11. Dans l’**Assistant Ajout de nœud**, cliquez sur **Suivant**. Dans la page **Sélectionner des serveurs**, ajoutez **ContosoSQL2** et **ContosoWSFCNode** à la liste en tapant le nom du serveur dans **Entrez le nom du serveur**, puis en cliquant sur **Ajouter**. Une fois ces opérations effectuées, cliquez sur **Suivant**.
...
9. Tapez **CORP\\Install** dans **Nom de connexion**.
10. Dans la page **Rôles de serveur**, cliquez sur **sysadmin**. Cliquez ensuite sur **OK**. Une fois la connexion créée, vous pouvez l'afficher en développant **Connexions** dans l'**Explorateur d'objets**.
11. Puis, créez une règle de pare-feu pour un serveur SQL. Lancez le **Pare-feu Windows avec fonctions avancées de sécurité** à partir de l’écran d’**accueil**.
...
6. Créez ensuite la base de données. À partir du menu **Démarrer**, lancez **SQL Server Management Studio**, puis cliquez sur **Connexion** pour vous connecter à l'instance de SQL Server par défaut.
...
8. Dans **Nom de base de données**, tapez **MyDB1**, puis cliquez sur **OK**.
...
5. Puis, effectuez une sauvegarde du journal des transactions de la base de données. Dans l’**Explorateur d’objets**, développez **Bases de données**, cliquez sur **MyDB1**, pointez sur **Tâches**, puis cliquez sur **Sauvegarder**.
...
8. À partir du menu d’**accueil**, lancez **SQL Server Management Studio**, puis cliquez sur **Connexion** pour vous connecter à l’instance de SQL Server par défaut.
9. Dans l’**Explorateur d’objets**, cliquez avec le bouton droit sur **Bases de données**, puis cliquez sur **Restaurer une base de données**.
...
2. Sur la page **Introduction**, cliquez sur **Suivant**. Dans la page **Spécifier le nom du groupe de disponibilité**, tapez **AG1** dans **Nom du groupe de disponibilité**, puis cliquez à nouveau sur **Suivant**.
