...
>[AZURE.NOTE] Pour plus d’informations sur les capacités des machines virtuelles, voir [Tailles des machines virtuelles Windows](virtual-machines-windows-sizes.md).
