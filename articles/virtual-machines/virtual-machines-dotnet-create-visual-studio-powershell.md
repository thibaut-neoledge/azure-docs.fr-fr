...
1. Dans Visual Studio, cliquez sur **Fichier** > **Nouveau** > **Projet** > **Web**, puis choisissez **Application ASP.NET Web** (sous les nœuds **Visual C#** oo **Visual Basic**).
...
3. Dans la liste déroulante sous Microsoft Azure, choisissez **Machine virtuelle**, puis cliquez sur le bouton **OK**.
