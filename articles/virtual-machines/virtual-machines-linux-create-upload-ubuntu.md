...
## Étapes manuelles
> [!NOTE]
> Avant de créer votre propre image Ubuntu personnalisée pour Azure, envisagez d’utiliser plutôt les images disponibles à l’adresse [http://cloud-images.ubuntu.com/](http://cloud-images.ubuntu.com/).
> 
> 
