...
# Commandes équivalentes de Resource Manager et de Service Management pour les tâches de machine virtuelle avec l’interface de ligne de commande Azure
