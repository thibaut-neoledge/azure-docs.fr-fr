...
- [Comment capturer une machine virtuelle Windows pour l’utiliser comme modèle][]
...
[Comment capturer une machine virtuelle Windows pour l’utiliser comme modèle]: virtual-machines-capture-image-windows-server.md
