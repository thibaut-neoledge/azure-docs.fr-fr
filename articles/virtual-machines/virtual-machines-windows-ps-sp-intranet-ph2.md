...
Souvenez-vous que vous avez défini les tables V, S, ST et A au cours de la [Phase 1 : configurer Azure](virtual-machines-windows-ps-sp-intranet-ph1.md).
...
- Pour poursuivre la configuration de cette charge de travail, utilisez la [Phase 3](virtual-machines-windows-ps-sp-intranet-ph3.md).
