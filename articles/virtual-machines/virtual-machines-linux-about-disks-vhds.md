...
>[AZURE.WARNING] Ne stockez pas de données sur le disque temporaire. Il assure un stockage temporaire pour les applications et les processus et est destiné à stocker uniquement des données telles que les fichiers d’échange.
...
>[AZURE.NOTE] Pour plus d’informations sur les capacités des machines virtuelles, voir [Tailles des machines virtuelles Linux](virtual-machines-linux-sizes.md).
