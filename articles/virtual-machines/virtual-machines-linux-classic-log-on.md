...
4. Connectez-vous à la machine virtuelle à l’aide du compte spécifié à la création de la machine. Pour plus d’informations sur la création d’une machine virtuelle avec nom d’utilisateur et mot de passe, consultez [Création d’une machine virtuelle exécutant Linux](virtual-machines-linux-classic-createportal.md).
