...
![Capture d'écran](./media/virtual-machines-python-ipython-notebook/ipy-notebook-spectral.png) Utilisation des packages SciPy et Matplotlib pour analyser la structure d’un enregistrement.
...
![Capture d'écran](./media/virtual-machines-python-ipython-notebook/anaconda-install.png)
...
![Capture d'écran](./media/virtual-machines-python-ipython-notebook/jupyter-tree-view.png)

### Utilisation de Jupyter Notebook

Si vous cliquez sur le bouton **Nouveau**, la page d’ouverture suivante s’affiche.

![Capture d'écran](./media/virtual-machines-python-ipython-notebook/jupyter-untitled-notebook.png)
...
![Capture d'écran](./media/virtual-machines-python-ipython-notebook/jupyter-editing-experience.png)
