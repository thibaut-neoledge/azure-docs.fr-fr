...
Ouvrez votre navigateur et entrez l’URL **http://<nom DNS de votre serveur tomcat>/manager/html**. Par exemple, dans cet article, l’URL est http://tomcatexample.cloudapp.net/manager/html.
