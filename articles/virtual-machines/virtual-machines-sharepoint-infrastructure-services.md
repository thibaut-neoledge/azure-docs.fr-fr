...
Pour les machines virtuelles créées à l’aide du modèle de déploiement classique, utilisez la fonctionnalité [Batterie de serveurs SharePoint](virtual-machines-sharepoint-farm-azure-preview.md) du portail Azure en version préliminaire pour créer une batterie de serveurs de développement/test de base pour un site web SharePoint accessible sur Internet.
...
Pour créer une configuration similaire avec le modèle de déploiement Resource Manager, utilisez un modèle. Consultez la page [Déployer une batterie de serveurs SharePoint à trois serveurs](virtual-machines-workload-template-sharepoint.md#deploy-a-three-server-sharepoint-farm).

## Batterie de serveurs de développement/test SharePoint haute disponibilité

Pour les machines virtuelles classiques, utilisez la fonctionnalité [Batterie de serveurs SharePoint](virtual-machines-sharepoint-farm-azure-preview.md) du portail Azure en version préliminaire pour créer une batterie de serveurs de développement/test SharePoint haute disponibilité pour un site web SharePoint accessible sur Internet.
...
Pour créer une configuration similaire avec des machines virtuelles Resource Manager, utilisez un modèle. Consultez la page [Déployer une batterie de serveurs SharePoint à neuf serveurs](virtual-machines-workload-template-sharepoint.md#deploy-a-nine-server-sharepoint-farm).
