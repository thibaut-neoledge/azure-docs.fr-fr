...
---
title: "Créer une configuration SAP multi-SID | Microsoft Docs"
...
# <a name="create-an-sap-multi-sid-configuration"></a>Créer une configuration SAP multi-SID
...
5. [Installez le deuxième nœud de cluster][sap-ha-guide-9.3].  
