...
Une machine virtuelle Azure exécute le système d’exploitation basé sur l’image que vous choisissez pendant la création. Ces images sont conservées au format VHD, dans des fichiers .vhd au sein de votre compte de stockage. Pour plus d'informations, consultez les pages relatives aux [disques dans Azure](virtual-machines-linux-about-disks-vhds.md) et aux [images dans Azure](virtual-machines-linux-classic-about-images.md).


Lors de la création de la machine virtuelle, vous pouvez personnaliser certains paramètres du système d'exploitation pour qu'ils correspondent à l'application que vous souhaitez exécuter. Pour obtenir des instructions, consultez le guide [Création d'une machine virtuelle personnalisée](virtual-machines-windows-classic-createportal.md).
...
Consultez également les **[Notes d'installation Linux](virtual-machines-linux-create-upload-generic.md#linuxinstall)** pour obtenir d’autres conseils sur la préparation d'images Linux pour Azure.
