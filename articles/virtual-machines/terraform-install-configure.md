...
En outre, si vous utilisez Terraform avec Azure - Chine, Azure Government ou Azure - Allemagne, vous devez définir la variable d’environnement de façon appropriée.
