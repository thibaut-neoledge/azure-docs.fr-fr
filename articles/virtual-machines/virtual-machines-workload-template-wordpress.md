<properties 
	pageTitle="Déployer un serveur WordPress sur Ubuntu à l’aide d’un modèle Azure Resource Manager" 
...
# Déployer un serveur WordPress sur Ubuntu à l’aide d’un modèle Azure Resource Manager
