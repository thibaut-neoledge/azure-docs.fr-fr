...
2.	Dans le volet gauche de **SQL Server Management Studio**, cliquez avec le bouton droit sur **Haute disponibilité Always On**, puis cliquez sur **Assistant Nouveau groupe de disponibilité**.
...
Vous avez configuré un groupe de disponibilité SQL Server Always On pour vos bases de données d’applications.
