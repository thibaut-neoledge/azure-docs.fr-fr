...
## Définition du mode Resource Manager

Utilisez la commande suivante pour activer les commandes Resource Manager de l’interface de ligne de commande Azure.
