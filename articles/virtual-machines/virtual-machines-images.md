<properties
	pageTitle="À propos des images pour les machines virtuelles | Microsoft Azure"
...
Pour plus d’informations sur l’utilisation de ces outils avec les déploiements de Resource Manager, consultez [Recherche par navigation et sélection d’images de machines virtuelles Azure avec PowerShell et l’interface de ligne de commande Azure](resource-groups-vm-searching.md).
...
- Pour Azure PowerShell, consultez la liste de commandes suivantes. Pour obtenir un exemple de recherche d’image pour créer une machine virtuelle, consultez « Étape 3 : déterminer le paramètre ImageFamily » dans [Utilisation d’Azure PowerShell pour créer et préconfigurer des machines virtuelles basées sur Windows](virtual-machines-ps-create-preconfigure-windows-vms.md)
