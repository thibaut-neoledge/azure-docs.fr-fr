...
> [!NOTE]
> Vous devrez peut-être réinstaller Azure PowerShell pour utiliser les fonctionnalités de cet article. Les fonctionnalités de disque géré sont disponibles dans la version 3.5 et les versions ultérieures.
> 
> 
