...
- création d’une machine virtuelle exécutant Windows Server 2012 R2 dans le portail Azure ;
...
10.	Sur la page **Type et réseau**, spécifiez le type de configuration et les options de connectivité requises, notamment le port TCP si nécessaire. Sélectionnez **Afficher les options avancées**, puis **Suivant**.
...
1.	Dans le portail Azure, cliquez sur **Machines virtuelles**, sur le nom de votre machine virtuelle MySQL, puis sur **Points de terminaison**.
...
1.	Dans le portail Azure, cliquez sur **Machines virtuelles**, sur le nom de votre machine virtuelle MySQL Server, puis sur **Tableau de bord**.
