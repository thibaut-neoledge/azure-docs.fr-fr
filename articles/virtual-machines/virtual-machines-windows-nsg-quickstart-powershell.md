...
Tout d’abord, vous devez créer une règle pour autoriser le trafic HTTP sur le port TCP 80 de la manière suivante en entrant votre propre nom et votre description :
...
Ensuite, créez votre groupe de sécurité réseau et attribuer la règle HTTP que vous venez de créer comme suit, en entrant le nom et l’emplacement de votre groupe de ressources :
...
Maintenant, il s’agit d’affecter votre groupe de sécurité réseau à un sous-réseau. Sélectionnez le réseau virtuel de la manière suivante :

```
$vnet = Get-AzureRmVirtualNetwork -ResourceGroupName TestRG -Name TestVNet
```

Associez votre groupe de sécurité réseau à votre sous-réseau comme suit :
