<properties
   pageTitle="Articles techniques concernant les machines virtuelles Windows | Microsoft Azure"
...
[Résoudre les problèmes de déploiement Classic liés à la création d’une machine virtuelle Windows dans Azure](virtual-machines-windows-classic-troubleshoot-deployment-new-vm.md)
