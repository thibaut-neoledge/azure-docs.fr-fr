...
# Résoudre les problèmes d’allocation pendant la création, le redémarrage ou le redimensionnement de machines virtuelles dans Azure
...
Dans cet article, les sections « Résoudre les problèmes courants liés à l’allocation » répertorient les étapes permettant de résoudre les problèmes courants. Les sections « Résoudre des scénarios d’échec d’allocation spécifiques » indiquent une procédure de résolution pour des messages d’erreur spécifiques. Avant de commencer, voici quelques informations contextuelles qui vous permettront de comprendre le fonctionnement de l’allocation et pourquoi des échecs d’allocation se produisent.
...
### Résoudre des scénarios d’échecs d’allocation spécifiques dans le modèle de déploiement classique
...
S’il est possible d’utiliser une autre adresse IP virtuelle, supprimez les machines virtuelles arrêtées (désallouées) tout en conservant les disques associés, puis ajoutez les machines virtuelles par le biais d’un autre service cloud. Utilisez un réseau virtuel régional pour connecter vos services cloud : - Si votre service cloud existant utilise un réseau virtuel régional, ajoutez simplement le nouveau service cloud au même réseau virtuel. -Si votre service cloud existant n’utilise pas de réseau virtuel régional, créez un réseau virtuel pour le nouveau service cloud, puis [connectez votre réseau virtuel existant au nouveau réseau virtuel](https://azure.microsoft.com/blog/vnet-to-vnet-connecting-virtual-networks-in-azure-across-different-regions/). En savoir plus sur les [réseaux virtuels régionaux](https://azure.microsoft.com/blog/2014/05/14/regional-virtual-networks/).
...
Si vous n’avez pas besoin de groupe d’affinités, créez un réseau virtuel régional pour les nouvelles ressources que vous souhaitez ajouter, puis [connectez votre réseau virtuel existant au nouveau réseau virtuel](https://azure.microsoft.com/blog/vnet-to-vnet-connecting-virtual-networks-in-azure-across-different-regions/). En savoir plus sur les [réseaux virtuels régionaux](https://azure.microsoft.com/blog/2014/05/14/regional-virtual-networks/).

Vous pouvez également [migrer votre réseau virtuel par groupe d’affinités vers un réseau virtuel régional](https://azure.microsoft.com/blog/2014/11/26/migrating-existing-services-to-regional-scope/), puis ajouter les ressources souhaitées.

### Résoudre des échecs de scénarios d’allocation spécifiques dans le modèle de déploiement Azure Resource Manager
Voici des scénarios courants d’allocation qui entraînent l’épinglage d’une demande d’allocation. Nous aborderons chaque scénario ultérieurement dans cet article.
