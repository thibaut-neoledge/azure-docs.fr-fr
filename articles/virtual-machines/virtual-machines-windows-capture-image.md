---
title: Création d’une image de machine virtuelle à partir d’une machine virtuelle Azure | Microsoft Docs
...
Cette section vous montre comment généraliser votre machine virtuelle Windows de manière à pouvoir l’utiliser comme image. Sauvegardez la machine virtuelle avant d’exécuter Sysprep.

> [!WARNING]
> Vous ne peut pas vous connecter à la machine virtuelle par le biais du RDP une fois qu’elle est généralisée, étant donné que le processus supprime tous les comptes d’utilisateur. Les modifications sont irréversibles.
> 
> 
...
> [!NOTE]
> La machine virtuelle doit se trouver dans le même compte de stockage que le disque dur original.
> 
> 
