<properties
   pageTitle="Automatisation du déploiement d’application avec des extensions de machine virtuelle | Microsoft Azure"
...
# Déploiement d’applications avec des modèles Azure Resource Manager
...
## Extension de script de machine virtuelle
...
Pour plus d’informations sur l’utilisation des extensions de script personnalisé, consultez [Extensions de script personnalisé avec des modèles Resource Manager](./virtual-machines-linux-extensions-customscript.md).
