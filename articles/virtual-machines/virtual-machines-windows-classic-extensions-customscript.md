---
title: Extension de script personnalisé pour machine virtuelle Windows | Microsoft Docs
...
Découvrez comment [effectuer ces étapes à l’aide du modèle Resource Manager](virtual-machines-windows-extensions-customscript.md).
