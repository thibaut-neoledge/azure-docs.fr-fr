...
Découvrez en quoi consiste la maintenance planifiée Azure et son incidence possible sur la disponibilité de vos machines virtuelles Linux. Vous pouvez également en apprendre davantage sur la [maintenance planifiée des machines virtuelles Windows](virtual-machines-windows-planned-maintenance.md).
