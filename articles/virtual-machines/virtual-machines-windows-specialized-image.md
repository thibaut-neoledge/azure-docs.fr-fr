...
1. Sur votre ordinateur local, ouvrez une fenêtre de commande et naviguez jusqu’au dossier dans lequel AzCopy est installé (ce dossier peut être semblable à *C:\\Program Files (x86)\\Microsoft SDKs\\Azure\\AzCopy*). À partir de ce dossier, exécutez la commande suivante : </br>
...
>[AZURE.NOTE] Vous devez copier séparément les disques de système d’exploitation et de données, en utilisant l’utilitaire AzCopy comme décrit précédemment.
