...
- [Azure CLI 2.0 (version préliminaire)](virtual-machines-linux-creation-choices.md) : notre interface de ligne de commande nouvelle génération pour le modèle de déploiement Resource Manager
