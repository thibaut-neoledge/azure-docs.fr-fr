...
[!code-azurecli-interactive[principal](../../../cli_scripts/virtual-machine/create-docker-host/create-docker-host.sh "Hôte Docker")]
...
| [azure vm extension set](https://docs.microsoft.com/cli/azure/vm/extension#az_vm_extension_set) | Ajoute et exécute une extension de machine virtuelle sur une machine virtuelle. Dans cet exemple, l’extension de machine virtuelle Docker est utilisée pour configurer un hôte Docker.|
