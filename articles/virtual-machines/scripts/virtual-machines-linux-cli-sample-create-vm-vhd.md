...
[!code-azurecli-interactive[main](../../../cli_scripts/virtual-machine/create-vm-vhd/create-vm-vhd.sh "Créer une machine virtuelle à l’aide d’un disque dur virtuel (VHD)")]
