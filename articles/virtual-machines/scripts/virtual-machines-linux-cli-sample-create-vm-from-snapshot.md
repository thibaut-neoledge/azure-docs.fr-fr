...
[!code-azurecli[main](../../../cli_scripts/virtual-machine/create-vm-from-snapshot/create-vm-from-snapshot.sh "Créer une machine virtuelle à partir d’une capture instantanée")]
