...
Le modèle que vous créez dans ce didacticiel est similaire à un modèle qui se trouve dans la galerie de modèles. Pour plus d’informations, consultez [Déployer un groupe de machines virtuelles identiques avec des machines virtuelles Windows et une Jumpbox](https://azure.microsoft.com/documentation/templates/201-vmss-windows-jumpbox/).
