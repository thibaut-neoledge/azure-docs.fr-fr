<properties
	...
	description="Déployez facilement deux serveurs utilisés comme contrôleurs de domaine Active Directory Domain Services à l'aide d'un modèle Resource Manager et du portail Azure, d'Azure PowerShell ou de l'interface de ligne de commande Azure."
