...
* [l’interface de ligne de commande Azure (CLI)](../xplat-cli-install.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) connectée à `azure login` ;
