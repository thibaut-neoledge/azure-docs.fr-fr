...
![Mise à jour corrective automatique SQL dans le portail Azure](./media/virtual-machines-windows-classic-ps-sql-patch/IC778484.jpg)
...
![Configuration d’une mise à jour corrective automatisée dans le portail Azure](./media/virtual-machines-windows-classic-ps-sql-patch/IC792132.jpg)
...
La [sauvegarde automatisée pour SQL Server dans les machines virtuelles Azure](virtual-machines-windows-classic-ps-sql-backup.md) est une fonctionnalité associée pour SQL Server dans des machines virtuelles Azure.
