<properties
	...
	description="Décrit comment installer et configurer Chef sur une machine virtuelle dans Azure"
...
Chef est un système client-serveur. Pour découvrir les options d’utilisation d’un serveur Chef, consultez [Choose your installation](http://www.getchef.com/chef/choose-your-version/) (Choisir votre installation). Vous aurez besoin des informations relatives au serveur Chef pour configurer le client.

Pour installer le client Chef sur une machine virtuelle Azure, vous disposez des options suivantes :

- Utilisez le portail Azure pour installer le client Chef quand vous créez une machine virtuelle exécutant Windows Server 2012 ou Windows Server 2012 R2. Pour obtenir des instructions, consultez [Portail Azure](https://docs.chef.io/azure_portal.html).
...
[Gérer les extensions]: http://go.microsoft.com/fwlink/p/?linkid=390493&clcid=0x409
