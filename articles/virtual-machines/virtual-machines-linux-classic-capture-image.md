...
Azure stocke l’image sous **Images**, avec les images que vous avez chargées. Pour plus d’informations sur les images, consultez [À propos des images de machine virtuelle dans Azure][À propos des images de machine virtuelle dans Azure].
