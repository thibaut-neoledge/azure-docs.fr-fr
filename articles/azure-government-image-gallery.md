...
Éditeur|Nom de l'image|Description|Taille du disque
---|---|---|---
Barracuda Networks, Inc.|Barracuda Web Application Firewall (WAF) 7.8 PatchLevel 4|Remarque : cet appareil est géré via une interface utilisateur web et TCP/8000 doit être transféré pour cela. Consultez le fichier Lisez-moi de déploiement https://cloudvm.cudasvc.com/azure/deployment-readme-waf.html pour obtenir ...|Linux|50 Go
Barracuda Networks, Inc.|Barracuda NG Firewall 5.4.3-182 PatchLevel 4|Remarque : cet appareil est géré via une application cliente et TCP/807 doit être transféré pour cela. Consultez le fichier Lisez-moi de déploiement https://cloudvm.cudasvc.com/azure/deployment-readme-ng.html pour ...|Linux|80 Go
...
Bitnami|LAMP Stack 5.6|Bitnami LAMPStack simplifie considérablement le développement et le déploiement des applications PHP. Il comprend des versions prêtes à l'emploi d'Apache, MySQL, PHP et phpMyAdmin et tous les autre logiciels nécessaires pour...|Linux|30 Go
Bitnami|LAMP Stack 5.4|Bitnami LAMPStack simplifie considérablement le développement et le déploiement des applications PHP. Il comprend des versions prêtes à l'emploi d'Apache, MySQL, PHP et phpMyAdmin et tous les autre logiciels nécessaires pour...|Linux|30 Go
...
SUSE|SUSE Linux Enterprise Server 11 SP3|Exécutez vos charges de travail de production en toute confiance sur SUSE Linux Enterprise Server sur Microsoft Azure, avec des niveaux de service garantis et avec l’aide des ingénieurs Microsoft et de SUSE, si vous...|Linux|30 Go
SUSE|SUSE Linux Enterprise Server 11 SP3 (Image Premium)|Exécutez vos charges de travail de production en toute confiance sur SUSE Linux Enterprise Server sur Microsoft Azure, avec des niveaux de service garantis et avec l’aide des ingénieurs Microsoft et de SUSE, si vous...|Linux|30 Go
SUSE|SUSE Linux Enterprise Server 12 (Image Premium)|Exécutez vos charges de travail de production en toute confiance sur SUSE Linux Enterprise Server sur Microsoft Azure, avec des niveaux de service garantis et avec l’aide des ingénieurs Microsoft et de SUSE, si vous...|Linux|30 Go
...
- [Déploiement d'un ordinateur virtuel Windows](../virtual-machines/virtual-machines-windows-tutorial.md)

- [Déploiement d'un ordinateur virtuel Linux](../virtual-machines/virtual-machines-linux-tutorial.md)

- [FAQ sur les ordinateurs virtuels](http://msdn.microsoft.com/library/azure/dn683781.aspx)

- [Créer et télécharger votre propre disque dur virtuel](../virtual-machines-create-upload-vhd-windows-server/)

- [Capture d'image d'ordinateur virtuel Linux](../virtual-machines/virtual-machines-linux-capture-image.md)
