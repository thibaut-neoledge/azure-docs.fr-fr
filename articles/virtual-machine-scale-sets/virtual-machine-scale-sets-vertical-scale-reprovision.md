---
title: Mettre à l’échelle verticalement des jeux de mise à l’échelle de machine virtuelle Azure | Microsoft Docs
...
* [Exemple de démarrage rapide de l’interface de ligne de commande (CLI) multiplateforme Azure Insights](../monitoring-and-diagnostics/insights-cli-samples.md)
