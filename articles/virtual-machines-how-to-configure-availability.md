<properties title="Configuration d'un groupe &agrave; haute disponibilit&eacute; pour des machines virtuelles" pageTitle="Configuration d'un groupe &agrave; haute disponibilit&eacute; pour des machines virtuelles" description="Indique les op&eacute;rations &agrave; effectuer pour configurer un groupe &agrave; haute disponibilit&eacute; pour une machine virtuelle dans&nbsp;Azure" metaKeywords="" services="virtual-machines" solutions="" documentationCenter="" authors="kathydav" manager="timlt" videoId="" scriptId="" />
...
-   [Option 1 : Créez simultanément une machine virtuelle et un groupe à haute disponibilité][Option 1 : Créez simultanément une machine virtuelle et un groupe à haute disponibilité]. Ajoutez ensuite de nouvelles machines virtuelles au groupe lorsque vous les créez.
-   [Option 2 : Ajoutez une machine virtuelle existante à un groupe à haute disponibilité][Option 2 : Ajoutez une machine virtuelle existante à un groupe à haute disponibilité].
...
## <span id="createset"></span> </a>Option 1 : création simultanée d'une machine virtuelle et d'un groupe à haute disponibilité
...
4.  Utilisez les deux premiers écrans pour sélectionner une image, un nom d'utilisateur et un mot de passe, et ainsi de suite. Pour en savoir plus, consultez la page [Création d'une machine virtuelle exécutant Windows][Création d'une machine virtuelle exécutant Windows].
...
2.  Obtenez le nom de l'image que vous voulez utiliser pour créer la machine virtuelle et enregistrez-le dans une variable. Cette commande utilise le numéro d'index et la propriété ImageName de l'objet image :

    `C:\PS> $image = (Get-AzureVMImage)[4].ImageName`

    > [WACOM.NOTE] Pour obtenir la liste de toutes les images disponibles pour votre abonnement, exécutez `Get-AzureVMImage` sans paramètres.
...
## <span id="addmachine"></span> </a>Option 2 : ajout d'une machine virtuelle existante à un groupe à haute disponibilité
...
1.  Si ce n’est déjà fait, connectez-vous au [portail de gestion][portail de gestion] Azure.
...
<!-- LINKS -->
  ...
  [Option 1 : Créez simultanément une machine virtuelle et un groupe à haute disponibilité]: #createset
  [Option 2 : Ajoutez une machine virtuelle existante à un groupe à haute disponibilité]: #addmachine
