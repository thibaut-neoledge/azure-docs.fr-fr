...
5. Dans la zone Paramètres, recherchez **Jeu de disponibilité**. Effectuez l’une des actions suivantes :
	...
	B. Sélectionnez **Sélectionner un groupe à haute disponibilité** et choisissez un groupe dans la liste.
