<properties 
   pageTitle="Gestion des ressources Azure avec Cloud Explorer"
...
- Vous devez disposer également d’un compte Azure et être connecté pour afficher les ressources Azure dans Cloud Explorer. Pour plus d’informations, consultez [Création d’un compte Azure et activation des fonctionnalités préliminaires](../php-create-account/).
