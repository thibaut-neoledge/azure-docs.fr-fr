...
- [Présentation de Linux sous Azure](http://azure.microsoft.com/documentation/articles/introduction-linux/)

- [Utilisation des outils en ligne de commande Azure pour Mac et Linux](http://azure.microsoft.com/documentation/articles/xplat-cli/)
