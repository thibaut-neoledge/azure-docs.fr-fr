<properties title="Download the Azure SDK for PHP" pageTitle="Téléchargement du Kit de développement logiciel (SDK) Azure pour PHP" metaKeywords="" description="Learn how to download and install the Azure SDK for PHP." documentationCenter="PHP" services="" solutions="web" authors="tomfitz" manager="wpickett" />
