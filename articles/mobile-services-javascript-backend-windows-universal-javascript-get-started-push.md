...
<ol start="6">
<li><p>Accédez au dossier de projet <code>\services\mobileServices\scripts</code>, copiez le fichier de script &lt;<em>nom_de_votre_service</em>&gt;.push.register.js dans le dossier partagé <code>\js</code>, puis supprimez ce fichier des deux projets d'application Windows et WindowsPhone individuels.</p></li> 
<li><p>Ouvrez ce fichier de script dans le dossier de projet <code>\js</code> partagé, identifiez le code dans l'écouteur d'événements <em>activé</em> qui enregistre l'URL de canal d'appareil avec le concentrateur de notification, puis supprimez la fonction de promesse <strong>done</strong>.</p>
