...
<ol start="6">
<li><p>Accédez au dossier de projet <code>\services\mobileServices\scripts</code>, copiez le fichier de script <<em>nom_de_votre_service</em>>.push.register.js dans le dossier <code>\js</code> partagé, puis supprimez ce fichier des deux projets d'application Windows et WindowsPhone individuels.</p></li> 
