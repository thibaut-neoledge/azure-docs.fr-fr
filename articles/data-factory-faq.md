<properties title="Azure Data Factory - Frequently Asked Questions" pageTitle="Azure Data Factory - Forum aux Questions" description="Frequently asked questions about Azure Data Factory." metaKeywords=""  services="data-factory" solutions=""  documentationCenter="" authors="spelluru" manager="jhubbard" editor="monicar" />
...
- Les développeurs de données : ils sont responsables de la création de services d'intégration entre Hadoop et d'autres systèmes :
...
- Les professionnels de l'informatique : ils cherchent à intégrer des données plus variées dans leur infrastructure informatique :
...
Consultez la [page de tarification de Data Factory][adf-pricing-details] pour obtenir plus d'informations sur la tarification d'Azure Data Factory.  
...
- **Sources de données prises en charge :** le stockage Azure (objets blob et tables), SQL Server, base de données SQL Azure. 
- **Prise en charge des activités :** activité de copie (du niveau local vers le cloud et du cloud vers le niveau local), activité HDInsight (transformations Pig et Hive) et les activités personnalisées C#.
...
**Q : Quelles régions sont-elles prises en charge par l'activité de copie ?**
...
La région de destination de la copie | Région utilisée pour le routage
-------------------------- | -----------------------
...
**Q : Quand vous utilisez un cluster HDInsight, quelles régions sont-elles prises en charge par HDInsight ?**

Consultez la section Disponibilité géographique dans l'article suivant : ou [Détails de la tarification HDInsight][hdinsight-supported-regions].

**Q : Quelle région est-elle utilisée par un cluster HDInsight à la demande ?**
...
[hdinsight-supported-regions]: http://azure.microsoft.com/fr-fr/pricing/details/hdinsight/
