...
<p>Cette fonctionnalit&eacute; capture uniquement les journaux des op&eacute;rations de gestion relatives &agrave; BizTalk Services telles que le moment o&ugrave; le service est d&eacute;marr&eacute;, sauvegard&eacute;, etc. Ces op&eacute;rations sont suivies qu'elles soient effectu&eacute;es via le portail de gestion Azure ou les <a href="http://msdn.microsoft.com/fr-fr/library/windowsazure/dn232347.aspx">API REST BizTalk Services</a>. Pour obtenir la liste compl&egrave;te des op&eacute;rations suivies &agrave; l'aide des services de gestion, consultez la rubrique <a href="#bizops">Op&eacute;rations suivies &agrave; l'aide des services de gestion Azure</a>.</p>
<p>Cette fonctionnalit&eacute; ne capture pas les journaux des activit&eacute;s li&eacute;es &agrave; l'ex&eacute;cution de BizTalk Services (comme les messages trait&eacute;s par ponts, etc.). Pour afficher ces journaux, vous devez utiliser la vue Suivi du portail BizTalk Services. Pour plus d'informations, consultez la rubrique <a HREF="http://msdn.microsoft.com/library/windowsazure/hh949805.aspx">Messages de suivi</a>.</p>
</div>
