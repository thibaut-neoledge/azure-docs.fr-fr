<properties
   pageTitle="Présentation - Operations Management Suite (OMS) | Microsoft Azure"
...
# <a name="operations-management-suite-(oms)-overview"></a>Présentation - Operations Management Suite (OMS)
...
## <a name="![protection-and-recovery](media/operations-management-suite-overview/icon-protection-recovery.png)-protection-and-disaster-recovery"></a>![Protection et récupération](media/operations-management-suite-overview/icon-protection-recovery.png) Protection et récupération d’urgence
...
## <a name="![oms-security-and-compliance](media/operations-management-suite-overview/icon-security-compliance.png)-security-and-compliance"></a>![Sécurité et conformité d’OMS](media/operations-management-suite-overview/icon-security-compliance.png)  Sécurité et conformité
...
- La [solution anti-programmes malveillants](log-analytics-malware.md ) fournit des rapports sur l’état de protection des systèmes gérés contre les programmes malveillants.  
