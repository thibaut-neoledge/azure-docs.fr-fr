<properties
   pageTitle="Solution de sécurité et d’audit d’Operations Management Suite - Évaluation de la base de référence | Microsoft Azure"
...
> [AZURE.NOTE] Pour en savoir plus sur CCE, accédez à la [base de données nationale des vulnérabilités (NVD)](https://nvd.nist.gov/cce/index.cfm) américaine.
