<properties
    pageTitle="Solution de gestion des mises à jour dans OMS | Microsoft Azure"
...
# <a name="![update-management-solution-in-oms](./media/oms-solution-update-management/update-management-solution-icon.png)-update-management-solution-in-oms"></a>![Solution de gestion des mises à jour dans OMS](./media/oms-solution-update-management/update-management-solution-icon.png) Solution de gestion des mises à jour dans OMS
...
-   Les agents Windows doivent être configurés pour communiquer avec un serveur WSUS (Windows Server Update Services) ou avoir accès à Microsoft Update.  
    ...
    >[AZURE.NOTE] L’agent Windows ne peut pas être géré simultanément par System Center Configuration Manager.  
