<properties
   pageTitle="Solution de sécurité et d’audit d’Operations Management Suite - Sécurité des données | Microsoft Azure"
...
> [AZURE.NOTE] L’emplacement des données est configuré au niveau de l’espace de travail OMS, lors de la création de ce dernier, opération entrant dans le processus de configuration de la solution de sécurité et d’audit d’OMS.
