...
[Qu’est-ce qu’une application logique ?](app-service-logic-what-are-logic-apps.md)<br/> [Sites web et applications web dans Azure App Service](app-service-web-app-azure-portal.md)
