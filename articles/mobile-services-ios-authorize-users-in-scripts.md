<properties pageTitle="Autorisation côté service (iOS) | Centre de développement mobile" description="Apprenez à autoriser les utilisateurs dans le service principal JavaScript d'Azure Mobile Services." services="" documentationCenter="ios" authors="krisragh" manager="dwrede" editor=""/>
