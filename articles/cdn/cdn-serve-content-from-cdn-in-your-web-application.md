...
-	Un [compte Microsoft Azure](/account/) actif. Vous pouvez demander un compte d'évaluation gratuit.
...
Quand je publie une mise à jour CSS et que j'utilise un numéro de version différent dans mon URL CSS : <pre class="prettyprint"> &lt;link href=&quot;http://az623979.vo.msecnd.net/MyMvcApp/Content/bootstrap.css<mark>?v=3.1.1</mark>&quot; rel=&quot;stylesheet&quot;/&gt; </pre>
...
Avec les services [Azure App Service Web Apps](http://go.microsoft.com/fwlink/?LinkId=529714) et [Azure Cloud Services](/services/cloud-services/), vous pouvez obtenir la meilleure intégration CDN grâce au [regroupement et à la minimisation ASP.NET](http://www.asp.net/mvc/tutorials/mvc-4/bundling-and-minification).
