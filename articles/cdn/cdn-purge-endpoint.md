...
> [!IMPORTANT]
> Le traitement des demandes de vidage prennent environ 2 à 3 minutes avec le **CDN Azure fourni par Verizon** (Standard et Premium) et environ 7 minutes avec le **CDN Azure fourni par Akamai**. Le CDN Azure impose une limite de 50 demandes de vidage simultanées à un moment donné.
> 
> 
