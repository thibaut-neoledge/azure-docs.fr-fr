...
> [!NOTE]
> Le préchargement des ressources est utile lors de grands événements ou lorsque le contenu est disponible simultanément à un grand nombre d'utilisateurs, par exemple lors de la sortie d’un film ou d'une mise à jour logicielle.
> 
> 
...
> [!NOTE]
> Il existe une limite de 10 demandes de chargement par minute et par profil CDN.
> 
> 
