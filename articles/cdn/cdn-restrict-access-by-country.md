...
>[AZURE.NOTE]Une fois la configuration définie, elle s’applique à tous les points de terminaison du **CDN Azure fourni par Verizon** inclus dans votre abonnement.
