<properties 
	...
	description="Découvrez comment valider, modifier et compléter les données pour votre application Windows Store JavaScript avec Microsoft Azure Mobile Services sur le serveur principal .Net." 
