<properties title="Get started with scoring profiles in Azure Search" pageTitle="Prise en main des profils de score dans Azure Search" description="Get started with scoring profiles in Azure Search" metaKeywords="" services="" solutions="" documentationCenter="" authors="Heidist" manager="mblythe" videoId="" scriptId="" />
...
<h2 id="sub-2">Téléchargement de l'exemple d'application</h2>
...
<h2 id="sub-3">Modification du fichier app.config</h2>
...
<h2 id="sub-4">Exploration de l'application</h2>
...
- Supprime le " musicstoreindex " s'il existe.
...
<h2 id="sub-5">Génération et exécution de l'application</h2>
...
[Téléchargement de l'exemple d'application]: #sub-2
[Modification du fichier app.config]: #sub-3
[Exploration de l'application]: #sub-4
[Génération et exécution de l'application]: #sub-5
