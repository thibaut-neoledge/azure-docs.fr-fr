...
**Remarque :** si vous créez les messages de file d'attente dans une application qui n'utilise pas SDK WebJobs, veillez à définir [BrokeredMessage.ContentType](http://msdn.microsoft.com/fr-fr/library/microsoft.servicebus.messaging.brokeredmessage.contenttype.aspx) sur " texte/brut ".
