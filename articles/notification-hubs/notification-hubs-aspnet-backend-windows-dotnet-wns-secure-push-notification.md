...
## <a name="modify-the-windows-phone-project"></a>Modification du projet Windows Phone
...
## <a name="create-the-push-background-component"></a>Création du composant en arrière-plan pour les notifications Push
