...
> [!NOTE]
> Si vous utilisez Mobile Apps dans App Service comme service principal, consultez la [version Mobile App](../app-service-mobile/app-service-mobile-windows-store-dotnet-get-started-push.md) de ce didacticiel.
> 
> 
