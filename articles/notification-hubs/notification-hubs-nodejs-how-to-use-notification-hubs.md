...
3.  Vous pouvez exécuter manuellement la commande **ls** ou **dir** pour vérifier que le dossier **node_modules** a été créé. Dans ce dossier, recherchez le package **azure**, qui contient les bibliothèques nécessaires pour accéder à Notification Hubs.
