...
Nous présenterons ici une solution plus efficace utilisant Azure Service Bus : un modèle de rubrique/d'abonnement qui réduit la complexité tout en rendant la solution évolutive. 
...
L'exemple de code complet est disponible sur la page [Exemples de Notification Hub]. Il est divisé en trois composants :
...
2. **ReceiveAndSendNotification**
	...
	e. Pour publier ceci sous forme de **WebJob**, cliquez avec le bouton droit sur la solution dans Visual Studio et sélectionnez **Publier en tant que WebJob**

	![][2]

	f. Sélectionnez votre profil de publication et créez un nouveau Site Web Azure s'il n'existe pas déjà : il hébergera ce WebJob. Lorsque vous disposez du Site Web, utilisez **Publier**. 
...
3. **EnterprisePushMobileApp**
	...
	a. Il s'agit d'une application Windows Store qui reçoit des notifications toast du WebJob en cours d'exécution dans le cadre de votre serveur principal Mobile et les affiche. Ceci est basé sur [Notification Hubs : didacticiel Windows universel].  
