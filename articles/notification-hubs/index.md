...
Azure Notification Hubs fournit une infrastructure de notifications Push simple d’utilisation, multiplateforme et avec montée en charge, vous permettant d’envoyer des notifications Push mobiles à partir de n’importe quel serveur principal (dans le cloud ou en local) vers une plateforme mobile quelconque.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>En savoir plus sur Notification Hubs</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bibliothèque vidéo Notification Hubs</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prendre en main Notification Hubs à l’aide de Baidu</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prise en main de Notification Hubs pour les applications de plateforme Windows universelle</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>PowerShell</h3>
                        <p>Applets de commande PowerShell de Notification Hubs</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>.NET</h3>
                        <p>Référence API .NET de Notification Hubs</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p>Référence API REST de Notification Hubs</p>
                    </div>
                </div>
            </div>
        </div>
