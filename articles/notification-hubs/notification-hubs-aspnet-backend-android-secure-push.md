<properties
	pageTitle="Envoi de notifications push sécurisées avec Azure Notification Hubs"
...
Ce didacticiel vous montre comment envoyer des notifications push sécurisées. Il s'appuie sur le didacticiel [Envoi de notifications à des utilisateurs](notification-hubs-aspnet-backend-android-notify-users.md). Vous devez donc suivre ce dernier au préalable si ce n'est déjà fait.
