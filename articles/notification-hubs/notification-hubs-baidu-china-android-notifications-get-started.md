...
13. Ajoutez une autre nouvelle classe appelée **MyPushMessageReceiver.java** et ajoutez-lui le code ci-dessous. Il s’agit de la classe qui gère les notifications push reçues à partir du serveur push Baidu.
