<properties 
   ...
   description="Le niveau de traitement par lots hors site fait partie de l'Infrastructure, qui est décrite en détail dans le document de l'architecture CPIF" 
   services="" 
   documentationCenter="" 
   authors="arynes" 
   manager="fredhar" 
...
Le modèle du **niveau de traitement par lots hors site** fait partie de l'**Infrastructure**, qui est décrite en détail dans le document d'architecture CPIF 
...
## Voir aussi
[Architecture CPIF](https://gallery.technet.microsoft.com/Cloud-Platform-Integration-bd1e434a) 
...
[Mise en réseau hybride](https://gallery.technet.microsoft.com/Cloud-Platform-Integration-5e401f38)
