...
Ce didacticiel est basé sur le démarrage rapide de Mobile Services. Vous devez aussi commencer par suivre le didacticiel [Prise en main de Mobile Services](/fr-fr/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started/).
