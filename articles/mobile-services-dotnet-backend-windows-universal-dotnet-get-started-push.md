...
> Si vous ne pouvez pas procéder à la mise à niveau vers Visual Studio Professional 2013 Update 3 ou préférez ajouter manuellement votre projet de service mobile à une solution d'application Windows Store, consultez [cette version](mobile-services-dotnet-backend-windows-store-dotnet-get-started-push.md) de la rubrique.
