...
6. La logique principale de l'application se trouve dans **SamplePlayerViewController.m** dans le dossier Partagé. La plupart des extraits de code décrits ci-dessous sont situés dans ce fichier. 
