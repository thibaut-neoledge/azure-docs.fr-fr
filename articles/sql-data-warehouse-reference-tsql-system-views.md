...
## Vues de catalogue de la base de données SQL

- [dbo.server_quotas (base de données SQL Azure)](http://msdn.microsoft.com/library/dn308512.aspx)
- [sys.bandwidth_usage (base de données SQL Azure)](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database_connection_stats (base de données SQL Azure)](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database_firewall_rules (base de données SQL Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database_usage (base de données SQL Azure)](http://msdn.microsoft.com/library/azure/ff951626.aspx)
- [sys.event_log (base de données SQL Azure)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database_firewall_rules (base de données SQL Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall_rules (base de données SQL Azure)](http://msdn.microsoft.com/library/azure/ff951627.aspx)
- [sys.resource_stats (base de données SQL Azure)](http://msdn.microsoft.com/library/dn269979.aspx)
- sys.resource_usage (base de données SQL Azure)
...
## Liste des vues de gestion dynamique SQL Server disponibles dans SQL Data Warehouse
...
>[AZURE.NOTE]Pour utiliser ces vues, insérez « pdw_nodes_ » dans le nom, comme indiqué dans le tableau suivant.
...
| sys.dm_pdw_nodes_os_dispatchers | La documentation de Transact-SQL n'est pas disponible. |
...
| sys.dm_pdw_nodes_os_memory_node_access_stats | La documentation de Transact-SQL n'est pas disponible. |
...
| sys.dm_pdw_nodes_tran_commit_table | La documentation de Transact-SQL n'est pas disponible. |
...
## Vues de gestion dynamique de la base de données SQL disponibles dans SQL Data Warehouse
...
Voici des liens vers les vues du schéma d'informations SQL Server disponibles dans SQL Server PDW. Toutes les vues INFORMATION_SCHEMA que vous souhaitiez découvrir dans SQL Server sont disponibles dans SQL Server PDW .
