...
Contrairement aux administrateurs de services (SA) et aux coadministrateurs (CA) qui disposent d’un accès au [portail](https://manage.windowsazure.com/), un propriétaire de compte peut accéder uniquement au [Centre des comptes](https://account.windowsazure.com/).

Cliquez sur les liens ci-dessous pour obtenir des instructions sur la mise à jour des rôles d’administrateur :

- [Pour mettre à jour le rôle de SA sur votre compte](./billing-add-change-azure-subscription-administrator.md#change-service-administrator-for-a-subscription)

- [Pour ajouter un nouveau CA dans le portail de gestion](./billing-add-change-azure-subscription-administrator.md#add-a-co-administrator-for-a-subscription)
