<properties
	pageTitle="Prise en main de l'authentification pour Mobile Apps dans l'application Xamarin.Forms | Microsoft Azure"
...
4. Ouvrez AppDelegate.cs dans le projet iOS et ajoutez les instructions `using` suivantes :
...
7. (Facultatif) Dans le projet **WinPhone81**, ouvrez MainPage.xaml.cs et ajoutez les instructions `using` suivantes :
...
8.  Ajoutez la substitution de méthode **OnActivated** suivante à la classe **App** :
