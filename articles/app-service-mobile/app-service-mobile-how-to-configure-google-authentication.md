...
1. Connectez-vous au [portail de gestion Azure] et accédez à votre application mobile. Copiez votre **URL**. Vous vous en servirez ultérieurement avec votre application Google.
...
9. Dans le [portail de gestion Azure], dans le panneau des paramètres Google pour votre application mobile, collez les valeurs d'identifiant client et de code secret du client que vous avez obtenues précédemment. Cliquez ensuite sur **Enregistrer**.
