...
### <a name="a-namegradle-buildaupdate-the-gradle-build-file"></a><a name="gradle-build"></a>Mise à jour du fichier de construction Gradle
...
### <a name="a-nameenable-internetaenable-internet-permission"></a><a name="enable-internet"></a>activer les autorisations Internet.
...
### <a name="a-namedata-objectadefine-client-data-classes"></a><a name="data-object"></a>Définition des classes de données client
...
### <a name="a-namecreate-clientahow-to-create-the-client-context"></a><a name="create-client"></a>Création du contexte client
...
### <a name="a-nameinstantiatingahow-to-create-a-table-reference"></a><a name="instantiating"></a>Procédure : création d'une référence de table
...
### <a name="a-namebindingahow-to-bind-data-to-the-user-interface"></a><a name="binding"></a>Liaison des données dans l’interface utilisateur
...
#### <a name="a-namelayoutahow-to-define-the-layout"></a><a name="layout"></a>Procédure de définition de la mise en page
...
#### <a name="a-nameadapterahow-to-define-the-adapter"></a><a name="adapter"></a>Procédure de définition de l’adaptateur
...
### <a name="a-nameapiathe-api-structure"></a><a name="api"></a>Structure de l'API
...
#### <a name="a-nameuse-adapterahow-to-use-the-adapter"></a><a name="use-adapter"></a>Procédure d’utilisation de l'adaptateur
...
## <a name="a-namequeryingahow-to-query-data-from-your-mobile-app-backend"></a><a name="querying"></a>Procédure : interrogation des données à partir de votre back-end Mobile Apps
...
### <a name="a-nameshowallahow-to-return-all-items-from-a-table"></a><a name="showAll"></a>Procédure de renvoi de tous les éléments d’une table
...
### <a name="a-namefilteringahow-to-filter-returned-data"></a><a name="filtering"></a>Procédure : filtrage des données renvoyées
...
### <a name="a-namesortingahow-to-sort-returned-data"></a><a name="sorting"></a>Procédure : tri des données renvoyées
...
### <a name="a-namepagingahow-to-return-data-in-pages"></a><a name="paging"></a>Procédure : renvoi de données dans les pages
...
### <a name="a-nameselectingahow-to-select-specific-columns"></a><a name="selecting"></a>Procédure : sélection de colonnes spécifiques
...
### <a name="a-namechainingahow-to-concatenate-query-methods"></a><a name="chaining"></a>Procédure de concaténation de méthodes de requête
...
## <a name="a-nameinsertingahow-to-insert-data-into-the-backend"></a><a name="inserting"></a>Procédure : insertion de données dans le back-end
...
## <a name="a-nameupdatingahow-to-update-data-in-a-mobile-app"></a><a name="updating"></a>Mise à jour des données dans une application mobile
...
## <a name="a-namedeletingahow-to-delete-data-in-a-mobile-app"></a><a name="deleting"></a>Suppression de données dans une application mobile
...
## <a name="a-namelookupahow-to-look-up-a-specific-item"></a><a name="lookup"></a>Recherche d’un élément spécifique
...
## <a name="a-nameuntypedahow-to-work-with-untyped-data"></a><a name="untyped"></a>Procédure : utilisation de données non typées
...
### <a name="a-namejsoninstanceahow-to-create-an-instance-of-an-untyped-table"></a><a name="json_instance"></a>Procédure de création d'une instance de table non typée
...
### <a name="a-namejsoninsertahow-to-insert-into-an-untyped-table"></a><a name="json_insert"></a>Procédure d’insertion dans une table non typée
...
### <a name="a-namejsondeleteahow-to-delete-from-an-untyped-table"></a><a name="json_delete"></a>Procédure de suppression dans une table non typée
...
### <a name="a-namejsongetahow-to-return-all-rows-from-an-untyped-table"></a><a name="json_get"></a>Procédure de récupération de toutes les lignes d'une table non typée
...
## <a name="a-namecustom-apiahow-to-call-a-custom-api"></a><a name="custom-api"></a>Procédure : appel d’une API personnalisée
...
## <a name="a-nameauthenticationahow-to-add-authentication-to-your-app"></a><a name="authentication"></a>Ajout d’une authentification à votre application
...
### <a name="a-namecachingahow-to-add-authentication-code-to-your-app"></a><a name="caching"></a>Procédure d’ajout de code d’authentification à votre application
...
### <a name="a-namecachingahow-to-cache-authentication-tokens"></a><a name="caching"></a>Procédure de mise en cache des jetons d'authentification
...
## <a name="a-nameadalahow-to-authenticate-users-with-the-active-directory-authentication-library"></a><a name="adal"></a>Procédure : authentifier des utilisateurs avec la bibliothèque Active Directory Authentication Library
...
## <a name="a-namecustomizingahow-to-customize-the-client"></a><a name="customizing"></a>Procédure : personnalisation du client
Plusieurs méthodes permettent de personnaliser le comportement par défaut du client.

### <a name="a-nameheadersahow-to-customize-request-headers"></a><a name="headers"></a>Procédure de personnalisation des en-têtes de requête
...
### <a name="a-nameserializationahow-to-customize-serialization"></a><a name="serialization"></a>Procédure : personnalisation de la sérialisation
...
### <a name="a-namecolumnsahow-to-map-different-client-and-server-names"></a><a name="columns"></a>Procédure de mappage de noms de client et de serveur différents
...
### <a name="a-nametableahow-to-map-different-table-names-between-the-client-and-the-backend"></a><a name="table"></a>Procédure de mappage de noms de table différents entre le client et le serveur principal
...
### <a name="a-nameconversionsahow-to-automate-column-name-mappings"></a><a name="conversions"></a>
...
### <a name="a-namecomplexahow-to-store-an-object-or-array-property-into-a-table"></a><a name="complex"></a>Procédure de stockage d'un objet ou d'une propriété de tableau dans une table
