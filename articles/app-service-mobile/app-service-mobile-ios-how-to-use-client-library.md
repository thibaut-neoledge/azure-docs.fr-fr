...
La documentation de référence du Kit de développement logiciel (SDK) du client iOS se trouve ici : [Référence du client iOS Azure Mobile Apps][2].
...
##<a name="<a-name="create-client"></a>how-to:-create-client"></a><a name="create-client"></a>Création du client
...
##<a name="<a-name="table-reference"></a>how-to:-create-table-reference"></a><a name="table-reference"></a>Procédure : création d'une référence de table
...
##<a name="<a-name="querying"></a>how-to:-query-data"></a><a name="querying"></a>Procédure : interrogation des données
...
##<a name="<a-name="query-object"></a>how-to:-use-msquery"></a><a name="query-object"></a>Procédure : utilisation de MSQuery
...
## <a name="<a-name="sorting"></a>how-to:-sort-data-with-msquery"></a><a name="sorting"></a>Procédure : trier des données avec MSQuery
...
## <a name="<a-name="selecting"></a><a-name="parameters"></a>how-to:-limit-fields-and-expand-query-string-parameters-with-msquery"></a><a name="selecting"></a><a name="parameters"></a>Procédure : limitation des champs et développement des paramètres de chaîne de requête avec MSQuery
...
## <a name="<a-name="paging"></a>how-to:-configure-page-size"></a><a name="paging"></a>Procédure : configuration du format de page
...
Ce paramètre correspond également au _nombre_ d’enregistrements de données, non à la _taille en octets_.

Si vous augmentez le format de page côté client, [vous devez également augmenter le format de page sur le serveur](app-service-mobile-dotnet-backend-how-to-use-server-sdk.md#_how-to-adjust-the-table-paging-size).
...
##<a name="<a-name="inserting"></a>how-to:-insert-data"></a><a name="inserting"></a>Procédure : insertion de données
...
##<a name="<a-name="modifying"></a>how-to:-modify-data"></a><a name="modifying"></a>Procédure : modification des données
...
##<a name="<a-name="deleting"></a>how-to:-delete-data"></a><a name="deleting"></a>Procédure : suppression de données
...
##<a name="<a-name="customapi"></a>how-to:-call-custom-api"></a><a name="customapi"></a>Procédure : appel d’une API personnalisée
...
##<a name="<a-name="templates"></a>how-to:-register-push-templates-to-send-cross-platform-notifications"></a><a name="templates"></a>Inscription de modèles de notifications Push pour envoyer des notifications multiplateforme
...
## <a name="<a-name="facebook-sdk"></a>how-to:-authenticate-users-with-the-facebook-sdk-for-ios"></a><a name="facebook-sdk"></a>Procédure : authentifier les utilisateurs avec le kit de développement logiciel (SDK) Facebook pour iOS
...
1. Si vous souhaitez configurer le backend de votre application mobile pour utiliser la connexion Facebook, suivez le didacticiel [Comment configurer votre application App Service de manière à utiliser la connexion via Facebook][9].

2. Installez le kit de développement logiciel (SDK) Facebook pour iOS en suivant la documentation [Kit de développement logiciel (SDK) Facebook pour iOS : prise en main][10] (en anglais). Au lieu de créer une application, vous pouvez ajouter la plateforme iOS à votre inscription existante. 
...
## <a name="<a-name="twitter-fabric"></a>how-to:-authenticate-users-with-twitter-fabric-for-ios"></a><a name="twitter-fabric"></a>Procédure : authentifier les utilisateurs avec Twitter Fabric pour iOS
...
## <a name="<a-name="google-sdk"></a>how-to:-authenticate-users-with-the-google-sign-in-sdk-for-ios"></a><a name="google-sdk"></a>Procédure : authentifier les utilisateurs avec le kit de développement logiciel (SDK) Google Sign-In pour iOS
...
[Procédure : modification de données dans un service mobile]: #modifying
...
[Procédure : conception de tests unitaires]: #unit-testing
...
[Prise en main de Mobile Services]: /develop/mobile/tutorials/get-started-ios
[Validation et modification des données dans Mobile Services à l'aide des scripts serveur]: /develop/mobile/tutorials/validate-modify-and-augment-data-ios
...
[Utilisation de scripts pour autoriser des utilisateurs]: /develop/mobile/tutorials/authorize-users-in-scripts-ios
[schéma dynamique]: http://go.microsoft.com/fwlink/p/?LinkId=296271
[Procédure : accès aux paramètres personnalisés]: /develop/mobile/how-to-guides/work-with-server-scripts#access-headers
