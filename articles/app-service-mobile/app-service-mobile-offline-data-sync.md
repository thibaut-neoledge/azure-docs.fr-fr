...
Un magasin local est associé au contexte de synchronisation à l’aide d’une méthode d’initialisation comme dans le [Kit de développement logiciel (SDK) client .NET].
