...
>[AZURE.NOTE] Les procédures décrites dans cet article s’appliquent aux services web Azure Machine Learning classiques. Pour plus d’informations sur la gestion des services web dans le portail des services web Azure Machine Learning, voir [Gérer un service web à l’aide du portail des services web Azure Machine Learning](machine-learning-manage-new-webservice.md).
...
[Utiliser]: machine-learning-consume-web-services.md
[Place de marché]: machine-learning-publish-web-service-to-azure-marketplace.md
