...
Azure Storage Explorer est un outil Windows gratuit qui permet d’examiner et de modifier des données dans un compte de stockage Azure. Cette rubrique décrit comment l'utiliser pour charger et télécharger des données depuis le stockage d'objets blob Azure. L’outil est téléchargeable sur le site [Azure Storage Explorer](http://storageexplorer.com/).
