---
title: Copier le travail d’autres personnes pour la science des données - tester l’exemple | Microsoft Docs
...
## Trouver des exemples dans la galerie Cortana Intelligence
...
## Rechercher et utiliser un exemple de clustering
...
![Ouverture d’une expérience de galerie dans Machine Learning Studio](./media/machine-learning-data-science-for-beginners-copy-other-peoples-work-to-do-data-science/cluster-experiment-open-in-studio.png)
...
## Découvrir des expériences qui illustrent les techniques d’apprentissage automatique
...
![Ouverture d’une expérience de galerie dans Machine Learning Studio](./media/machine-learning-data-science-for-beginners-copy-other-peoples-work-to-do-data-science/experiment-methods-for-handling-missing-values.png)
