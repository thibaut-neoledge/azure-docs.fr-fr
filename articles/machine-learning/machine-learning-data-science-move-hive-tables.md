...
dans un navigateur Web. Notez que vous devrez saisir les identifiants du cluster Hadoop pour vous y connecter. L'autre solution consiste à [envoyer des travaux Hive à l'aide de PowerShell](../hdinsight/hdinsight-submit-hadoop-jobs-programmatically.md#hive-powershell). 
