...
> [!NOTE]
> Cette même sortie imprimée est disponible dans la sortie de l’appareil R du module [Exécuter un script R][execute-r-script]. Nous évoquerons les sorties du module [Exécuter un script R][execute-r-script] dans la section suivante.  
> 
> 
...
> [!NOTE]
> À partir de maintenant, dans cette section, je ne vous montrerai que le code supplémentaire que j’ajoute dans le module [Exécuter un script R][execute-r-script]. Chaque nouvelle ligne sera ajoutée **avant** la fonction `str()`. J’utilise cette fonction pour vérifier les résultats dans Azure Machine Learning Studio.
> 
> 
