...
Sélectionnez **Jetons d’authentification** dans le menu général et notez votre **Jeton d’autorisation principal**.![3](./media/linux-dsvm-walkthrough/workspace-token.png)
