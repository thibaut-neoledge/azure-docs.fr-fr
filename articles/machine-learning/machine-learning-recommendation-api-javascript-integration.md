...
2. Encodez votre &lt;dataMarketUser&gt;:&lt;dataMarketKey&gt; avec base64. (Cela est utilisé pour l’authentification de base afin d’autoriser le code JS à appeler les API).
