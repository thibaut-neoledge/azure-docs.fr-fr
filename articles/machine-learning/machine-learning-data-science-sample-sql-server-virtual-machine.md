<properties 
	pageTitle="Échantillonner des données dans SQL Server sur Azure| Azure" 
...
Ce document traite de l'échantillonnage des données stockées dans SQL Server sur Azure à l'aide des méthodes suivantes :

1. [Utilisation de SQL](#sql)
2. [Utilisation du langage de programmation Python](#python) 

**Remarque**
>L'exemple de code SQL figurant dans ce document repose sur l'hypothèse que les données sont stockées dans SQL Server sur Azure. Dans le cas contraire, reportez-vous à la cartographie du processus de science des données dans le cloud pour découvrir comment déplacer vos données vers SQL Server dans Azure.
...
3. Lire les données de l'objet blob Azure à l'aide du *Reader Module* d'Azure Machine Learning comme illustré dans la capture d'écran ci-dessous :
