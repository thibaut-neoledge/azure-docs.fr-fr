...
2. Cliquez sur l'onglet **Studio** en haut de la fenêtre.
...
> [!TIP]
> Pour gérer les jeux de données que vous avez téléchargés dans Studio, cliquez sur l'onglet **JEUX DE DONNÉES** à gauche de la fenêtre de Studio.
> 
> 
