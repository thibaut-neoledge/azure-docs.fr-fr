...
- **Un abonnement Azure** : consultez la page [Obtenir une version d'évaluation gratuite d'Azure](http://azure.microsoft.com/documentation/videos/get-azure-free-trial-for-testing-hadoop-in-hdinsight/).

*   **Un compte de stockage Azure** : pour créer un compte, référez-vous à la rubrique [Création d'un compte de stockage Azure](storage-whatis-account.md). Le compte de stockage peut être également créé dans le cadre du processus de création de la machine virtuelle si vous ne souhaitez pas utiliser un compte existant.


## Créer votre machine virtuelle pour la science des données

Voici les étapes de création d'une instance de la machine virtuelle data science :

1.	Connectez-vous au [portail Azure](https://ms.portal.azure.com/).
2.	Accédez à **Nouveau** -> **Calculer** -> **Marketplace** et recherchez *Data Science Virtual Machine*.![provision-data-science-vm](./media/machine-learning-data-science-provision-vm/provision-data-science-virtual-machine.png)
3.	Sélectionnez la machine virtuelle intitulée « **Data Science Virtual Machine** » et publiée par Microsoft pour afficher un panneau décrivant cette machine virtuelle. 	
4.	 Cliquez sur le bouton **Créer** au bas de l'écran pour accéder à un Assistant.![configure-data-science-vm](./media/machine-learning-data-science-provision-vm/configure-data-science-virtual-machine.png)
5.	 Les sections suivantes fournissent les **entrées** de chacune des **5 étapes** (énumérées à droite de la figure ci-dessus) de l'Assistant utilisé pour créer la machine virtuelle Data Science. Voici les entrées nécessaires à la configuration de chacune de ces étapes :
