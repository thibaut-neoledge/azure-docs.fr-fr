...
####[Spark avec PySpark et Scala](data-science-process-walkthroughs-spark.md)
...
####[Hive avec HDInsight Hadoop](data-science-process-walkthroughs-hdinsight-hadoop.md)
####[U-SQL avec Azure Data Lake](data-science-process-walkthroughs-azure-data-lake.md)
####[R, Python et T-SQL avec SQL Server](data-science-process-walkthroughs-sql-server.md)
####[T-SQL et Python avec SQL DW](data-science-process-walkthroughs-sql-data-warehouse.md)
...
### [1 : Cinq questions](machine-learning-data-science-for-beginners-the-5-questions-data-science-answers.md)
...
#### [Créer](machine-learning-create-workspace.md)
#### [Gérer](machine-learning-manage-workspace.md)
#### [Résolution des problèmes](machine-learning-troubleshooting-creating-ml-workspace.md)
...
### [Besoins techniques](machine-learning-data-science-plan-your-environment.md)
### [Identifier votre scénario](machine-learning-data-science-plan-sample-scenarios.md)

## Acquérir et comprendre les données
...
#### [Charger à partir des tables de partition SQL](machine-learning-data-science-parallel-load-sql-partitioned-tables.md)
...
##### [Utilisez la machine virtuelle SQL](machine-learning-data-science-explore-data-sql-server.md)
...
### Créer et sélectionner des fonctionnalités
...
#### [Sélection de fonctionnalités TDSP](machine-learning-data-science-select-features.md)
### Créer et former des modèles
#### [Gestion du cycle de vie des expériences](machine-learning-version-control.md)
#### [Gérer les itérations](machine-learning-manage-experiment-iterations.md)
...
#### [Préparer le déploiement](machine-learning-convert-training-experiment-to-scoring-experiment.md)
...
#### [Utiliser le portail de Services Web](machine-learning-manage-new-webservice.md)
...
## [Exemples de code](https://azure.microsoft.com/en-us/resources/samples/?service=machine-learning)
## [Module PowerShell (nouveau)](/powershell/module/azurerm.machinelearning)
## [Module PowerShell (classique)](machine-learning-powershell-module.md)
## [Algorithmes et informations de référence sur les modules](https://msdn.microsoft.com/library/azure/dn905974.aspx)
## [Référence d’API REST](/rest/api/machinelearning)
## [Codes d’erreur de service web](machine-learning-web-service-error-codes.md)
...
## Solutions de partenaires Cortana Intelligence
### [Guide de publication Cortana Intelligence](cortana-intelligence-appsource-publishing-guide.md)
### [Outil d’évaluation de la solution Cortana Intelligence](cortana-intelligence-appsource-evaluation-tool.md)

## Cortana Analytics
### API
#### [Détection des anomalies](machine-learning-apps-anomaly-detection-api.md)
