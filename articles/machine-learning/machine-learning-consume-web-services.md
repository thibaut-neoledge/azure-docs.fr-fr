<properties
    pageTitle="Utilisation d’un service web de Machine Learning | Microsoft Azure"
...
> [AZURE.TIP] Pour un moyen simple de créer une application web pour accéder à votre service web prédictif, voir [Utilisation d’un service web Microsoft Azure Machine Learning avec un modèle d’application web](machine-learning-consume-web-service-with-web-app-template.md).
