...
3.	utilisation du module de [Split][split] (avec le mode *Expression Relative*) pour répartir les données dans les mêmes jeux apprentissage que dans Excel ;  
