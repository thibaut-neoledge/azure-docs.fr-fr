...
3. utilisation du module [Fractionner les données][split] (avec le mode *Expression relative*) pour répartir les données dans les mêmes jeux d’apprentissage que dans Excel ;  
...
* Lorsque vous utilisez le module [Régression linéaire][linear-regression] dans Azure ML, deux méthodes sont fournies :
