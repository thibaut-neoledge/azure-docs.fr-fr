...
---
# Accédez aux jeux de données avec Python grâce à la bibliothèque cliente Python d'Azure Machine Learning
...
9. Sélectionnez l’extrait de code dans la fenêtre qui s’affiche et copiez-le dans votre presse-papiers.
   
    ![Code d'accès][intermediate-dataset-access-code]
10. Collez le code dans votre bloc-notes.
    
     ![Bloc-notes][ipython-intermediate-dataset]
11. Vous pouvez visualiser les données à l'aide de matplotlib. Cela les affiche dans un histogramme pour la colonne âge :
