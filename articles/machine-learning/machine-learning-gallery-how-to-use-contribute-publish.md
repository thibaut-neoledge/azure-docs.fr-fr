...
Connectez-vous à l'aide de votre compte Microsoft pour profiter de ces avantages supplémentaires :
...
Consultez les expériences partagées par un auteur spécifique en cliquant sur le nom de l’auteur depuis n'importe quelle vignette d'expérience.

Si vous êtes intéressé par une expérience en particulier, vous pouvez lire des informations supplémentaires relatives à cette expérience sur la page de détails de l'expérience.
...
**Dois-je publier une nouvelle expérience même si je dois seulement modifier des balises ou la description ?** Le type de modifications suivant peut être apporté à une expérience que vous avez déjà partagée, sans que vous soyez contraint de la publier à nouveau :
