...
Vous avez le choix entre plusieurs exemples de jeux de données sont inclus dans ML Studio. Vous pouvez importer des données à partir de nombreuses sources. Pour les besoins de cet exemple, nous allons utiliser un jeu de données inclus nommé **Données sur le prix des véhicules automobiles (brutes)**.
Ce jeu de données comprend des entrées pour plusieurs véhicules, notamment des informations sur la marque, le modèle, les caractéristiques techniques et le prix.

1. Démarrez une nouvelle expérience en cliquant sur l’option **+NOUVEAU** située en bas de la fenêtre Machine Learning Studio, sélectionnez **EXPÉRIENCE**, puis **Expérience vide**. Sélectionnez le nom d’expérience par défaut, situé en haut de la zone de dessin, et remplacez-le par un nom significatif, par exemple : **Prédiction de prix d’une voiture**.
2. Sur la gauche de la zone de dessin de l’expérience se trouve une palette de jeux de données et de modules. Tapez la valeur **automobile** dans la zone de recherche se trouvant en haut de cette palette, afin de rechercher le jeu de données **Données sur le prix des véhicules automobiles (brutes)**.
...
## <a name="step-2-preprocess-data"></a>Étape 2 : traitement préalable des données
...
> [!TIP]
> Utilisez le bouton **ENREGISTRER SOUS** qui figure sous la zone de dessin de l’expérience afin de copier toute itération de votre expérience. Vous pouvez afficher toutes les itérations de votre expérience en cliquant sur l’option **AFFICHER L’HISTORIQUE D’EXÉCUTION** , sous la zone de dessin. Pour en savoir plus, consultez la section [Gérer les itérations des expériences dans Microsoft Azure Machine Learning Studio][runhistory].
> 
> 

[runhistory]: machine-learning-manage-experiment-iterations.md

Une fois satisfait de votre modèle, vous pouvez le déployer en tant que service web permettant de prévoir l’évolution des prix dans le secteur automobile, en utilisant de nouvelles données. Consultez [Déployer un service web Microsoft Azure Machine Learning][publish] pour en savoir plus.
...
<!-- Images -->
[écran1]:./media/machine-learning-create-experiment/screen1.png
[écran1a]:./media/machine-learning-create-experiment/screen1a.png
[écran1b]:./media/machine-learning-create-experiment/screen1b.png
[écran1c]: ./media/machine-learning-create-experiment/screen1c.png
[écran2]:./media/machine-learning-create-experiment/screen2.png
[écran3]:./media/machine-learning-create-experiment/screen3.png
[écran4]:./media/machine-learning-create-experiment/screen4.png
[écran4a]:./media/machine-learning-create-experiment/screen4a.png
[écran5]:./media/machine-learning-create-experiment/screen5.png
[écran6]:./media/machine-learning-create-experiment/screen6.png
[écran7]:./media/machine-learning-create-experiment/screen7.png
[écran8]:./media/machine-learning-create-experiment/screen8.png
[écran8a]:./media/machine-learning-create-experiment/screen8a.png
[écran9]:./media/machine-learning-create-experiment/screen9.png
[écran10]:./media/machine-learning-create-experiment/complete-linear-regression-experiment.png
