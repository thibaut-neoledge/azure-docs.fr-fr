...
3. Sélectionnez la région et l’espace de travail à utiliser.
    ...
    ![Ouvrir le bloc-notes Jupyter à partir de la galerie](./media/gallery-jupyter-notebooks/open-notebook-from-gallery.png)
...
3. Pointez votre souris sur un bloc-notes, puis sélectionnez **Ouvrir le bloc-notes**.
    ...
    ![Ouvrir un bloc-notes de galerie à partir de Machine Learning Studio](./media/gallery-jupyter-notebooks/open-notebook-from-studio.png)
