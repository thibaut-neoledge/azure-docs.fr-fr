...
![Sélectionnez Collections sur la page d’accueil de la galerie](./media/gallery-collections/select-collections-in-gallery.png)
...
2.  Sélectionnez votre image en haut de la page, puis sélectionnez votre nom.
    ...
    ![Sélectionnez le nom de votre compte](./media/gallery-collections/click-account-name.png)
...
4. Sur la page **Description**, pour **TYPE D’ÉLÉMENT**, sélectionnez **Collection**. Entrez un nom pour votre collection, un bref résumé, une description détaillée et toutes les balises susceptibles d’aider les autres utilisateurs à trouver votre collection.
    ...
    ![Entrer des informations pour une nouvelle collection](./media/gallery-collections/create-collection-page-1.png)
5. Sur la page **Sélection de l’image**, sélectionnez une image qui est affichée avec la collection. Vous pouvez charger votre propre fichier image ou sélectionner une image de banque d’images. Choisissez une image qui pourrait aider les utilisateurs à identifier le contenu et l’objectif de la collection.
    ...
    ![Entrer des informations pour une nouvelle collection](./media/gallery-collections/create-collection-page-2.png)
...
![Ajouter des éléments à une collection à partir de la page de détails](./media/gallery-collections/add-to-collection-from-details-page.png)
...
![Ajouter à la collection](./media/gallery-collections/add-to-collection.png)
...
![Ajouter des éléments à une collection à partir de la page de détails](./media/gallery-collections/add-to-collection-from-item-details.png)
...
![Modifier les détails d’une collection](./media/gallery-collections/change-collection-details.png)
