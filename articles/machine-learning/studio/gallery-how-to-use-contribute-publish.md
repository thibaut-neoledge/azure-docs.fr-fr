...
* **[Solutions](gallery-solutions.md)** - Créer rapidement des Solutions Cortana Intelligence à partir de solutions préconfigurées, d’architectures de référence et de modèles de conception. Appropriez-les vous propres avec les instructions fournies, ou à l’aide d’un partenaire proposé.
* **[Didacticiels](gallery-tutorials.md)** : une série de didacticiels est disponible pour vous guider à travers les concepts et les technologies Machine Learning, ou pour décrire les méthodes avancées de résolution des divers problèmes Machine Learning.

Ces ressources de base de la galerie peuvent être regroupées logiquement de différentes façons :

* **[Collections](gallery-collections.md)** : une collection vous permet de regrouper des expériences, des API et d’autres éléments de la galerie qui répondent à une solution ou à un concept spécifiques.
* **[Secteurs d’activité](gallery-industries.md)** : la section Secteurs d’activité de la galerie rassemble diverses ressources qui sont spécifiques à des secteurs d’activité tels que la vente au détail, la fabrication, les banques et la santé.
...
Vous pouvez également télécharger des expériences et des blocs-notes Jupyter dans votre propre espace de travail Machine Learning Studio.
...
![Affichage des contributions d’un auteur](./media/gallery-how-to-use-contribute-publish/view-by-author.png)
...
![Partager cet élément avec des amis](./media/gallery-how-to-use-contribute-publish/comment-and-share.png)
...
![Partager cet élément avec des amis](./media/gallery-how-to-use-contribute-publish/view-and-download-counts.png)
...
![Suivez des commentaires de l’utilisateur](./media/gallery-how-to-use-contribute-publish/follow-comments.png)
...
* **[Expériences](gallery-experiments.md#contribute)**
* **[Didacticiels](gallery-tutorials.md#contribute)**
