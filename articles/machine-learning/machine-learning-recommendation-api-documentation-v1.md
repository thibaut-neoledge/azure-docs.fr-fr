<properties 
	pageTitle="Documentation sur les API Azure Machine Learning Recommendations | Microsoft Azure" 
	description="Documentation sur les API Azure Machine Learning Recommendations" 
...
Version : 1.0<br> Vous trouverez la dernière version [ici](machine-learning-recommendation-api-documentation.md)
...
|	Nom du paramètre |	Valeurs valides |
|:--------			|:--------								|
| buildId | L’identificateur unique de la build. |
| apiVersion | 1\.0 |
