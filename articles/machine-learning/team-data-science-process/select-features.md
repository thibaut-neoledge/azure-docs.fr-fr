...
La conception et la sélection de fonctionnalités constituent une partie du processus TDSP présenté dans [Qu’est ce que le processus TDSP (Team Data Science Process) ?](overview.md). La conception et la sélection de fonctionnalités sont des parties de l’étape de **développement de fonctionnalités** du processus TDSP.
