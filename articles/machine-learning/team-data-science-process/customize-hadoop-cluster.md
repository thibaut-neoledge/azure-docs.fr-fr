...
Le menu suivant pointe vers des rubriques qui décrivent comment configurer les différents environnements de science de données utilisés par le [processus TDSP (Team Data Science Process)](overview.md).
...
![Create workspace](./media/customize-hadoop-cluster/customize-cluster-img1.png)
...
![Create workspace](./media/customize-hadoop-cluster/customize-cluster-img3.png)
...
![Create workspace](./media/customize-hadoop-cluster/customize-cluster-img4.png)
...
![Create workspace](./media/customize-hadoop-cluster/customize-cluster-img5.png)
...
![Create workspace](./media/customize-hadoop-cluster/script-actions.png)
...
1. Connectez-vous au [**portail Azure Classic**](https://manage.windowsazure.com/), sélectionnez la valeur **HDInsight** sur la gauche, choisissez le cluster Hadoop dans la liste des clusters, cliquez sur l’onglet **CONFIGURATION** puis sur l’icône **ACTIVER DISTANT**, dans la partie inférieure de la page.
    ...
    ![Create workspace](./media/customize-hadoop-cluster/enable-remote-access-1.png)
...
![Create workspace](./media/customize-hadoop-cluster/enable-remote-access-3.png)
