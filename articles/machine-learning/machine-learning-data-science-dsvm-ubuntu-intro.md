---
title: "Approvisionner une machine virtuelle pour la science des données pour Linux (Ubuntu) on Azure | Microsoft Docs"
...
2. Cliquez sur **Créer** (en bas) pour ouvrir l’Assistant.![configure-data-science-vm](./media/machine-learning-data-science-dsvm-ubuntu-intro/configure-data-science-virtual-machine.png)
...
Microsoft Cognitive Toolkit, également appelé CNTK, est un kit de ressources d’apprentissage approfondi open source. Les liaisons Python sont disponibles dans les environnements Conda racine et py35. Il contient également un outil en ligne de commande (cntk) qui est déjà dans PATH.
...
* La procédure [Science des données sur la machine virtuelle pour la science des données pour Linux](machine-learning-data-science-linux-dsvm-walkthrough.md) vous montre comment effectuer plusieurs tâches courantes relatives à la science des données avec la machine virtuelle pour la science des données Linux configurée ici. 
