...
## <a name="<a-name="uniform"></a>-uniform-random-sampling"></a><a name="uniform"></a> Échantillonnage aléatoire uniforme
...
## <a name="<a-name="group"></a>-random-sampling-by-groups"></a><a name="group"></a> Échantillonnage aléatoire par groupe
...
## <a name="<a-name="stratified"></a>stratified-sampling"></a><a name="stratified"></a>Échantillonnage stratifié
