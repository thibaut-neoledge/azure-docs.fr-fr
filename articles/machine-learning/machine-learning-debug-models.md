...
Cet article explique comment déboguer vos modèles dans Microsoft Azure Machine Learning. Plus précisément, il décrit les raisons possibles pour lesquelles l’exécution d’un modèle peut donner lieu à l’un des deux échecs suivants :
...
le module [Former le modèle][train-model] attend les deux entrées suivantes :
...
## <a name="score-model-module-does-not-produce-correct-results"></a>Le module Noter le modèle produit des résultats incorrects
