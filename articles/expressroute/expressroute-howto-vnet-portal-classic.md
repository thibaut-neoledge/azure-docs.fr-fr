...
## <a name="a-namegwacreate-the-gateway"></a><a name="gw"></a>Créer la passerelle
...
## <a name="a-nameconfigaconfigure-an-existing-classic-vnet-for-expressroute"></a><a name="config"></a>Configurer un réseau virtuel classique existant pour ExpressRoute
