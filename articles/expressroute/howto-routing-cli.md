...
### <a name="to-add-ipv6-microsoft-peering-settings-to-an-existing-ipv4-configuration"></a>Pour ajouter des paramètres d’homologation Microsoft IPv6 à une configuration IPv4 existante
