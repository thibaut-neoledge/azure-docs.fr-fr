...
## <a name="<a-name="add"></a>to-configure-coexsiting-connections-for-an-already-existing-vnet"></a><a name="add"></a>Configurer des connexions qui coexistent pour un réseau virtuel existant
