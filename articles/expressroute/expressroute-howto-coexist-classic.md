...
# Configurer la coexistence de connexions de site à site et ExpressRoute pour le modèle de déploiement classique
...
4. <a name="gw"></a>Créez une passerelle ExpressRoute. Veillez à spécifier la valeur *Standard* ou *HighPerformance* pour le paramètre GatewaySKU, et la valeur *DynamicRouting* pour le paramètre GatewayType.
