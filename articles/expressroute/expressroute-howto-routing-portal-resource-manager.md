<properties
   pageTitle="Configuration du routage pour un circuit ExpressRoute utilisant le portail Azure | Microsoft Azure"
...
6. Une fois la configuration acceptée, vous verrez quelque chose de similaire à l'exemple ci-dessous.

	![](./media/expressroute-howto-routing-portal-resource-manager/rmicrosoft7.png)
	

### Pour afficher les détails de l’homologation Microsoft
