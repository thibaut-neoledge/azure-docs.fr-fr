...
## Conditions préalables à l’utilisation des tables ARP
...
## Tables ARP pour votre circuit ExpressRoute
...
### Table ARP lorsqu’un circuit est à l’état opérationnel (attendu)
...
### Table ARP en cas de problèmes en local ou côté fournisseur de connectivité
...
>[AZURE.NOTE] Si vous rencontrez un problème de ce type, ouvrez une demande de support auprès de votre fournisseur de connectivité pour le résoudre.
