...
Si vous souhaitez créer un réseau virtuel cloud uniquement, consultez l’article [Didacticiel : Création d’un réseau virtuel cloud uniquement dans Azure](create-virtual-network.md). Si vous voulez créer un VPN pointant vers un site en utilisant des certificats et un client VPN, consultez la page [Configuration d'un VPN pointant vers un site dans le portail de gestion](http://go.microsoft.com/fwlink/p/?LinkId=296653).
