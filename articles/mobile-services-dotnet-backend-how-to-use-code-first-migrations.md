...
13. (Facultatif) Dans le [portail Azure Management Portal], sélectionnez votre service mobile, cliquez sur l'onglet **Configurer**, puis sur le lien **Base de données SQL**.
...
[portail Azure Management Portal]: https://manage.windowsazure.com/
