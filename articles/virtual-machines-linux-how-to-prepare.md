...
> -   [SLES 11 SP2 pour Azure dans SUSE Studio Gallery][SLES 11 SP2 pour Azure dans SUSE Studio Gallery]
...
> -   [openSUSE 12,3 pour Azure dans SUSE Studio Gallery][openSUSE 12,3 pour Azure dans SUSE Studio Gallery]
...
-   Depuis la fenêtre Azure PowerShell utilisée lors de l'étape précédente, tapez :
    ...
    Pour plus d'informations, consultez la page [Add-AzureVhd][Add-AzureVhd].
...
1.  Vous devez vous assurer, au choix, que vous utilisez un noyau qui incorpore les derniers pilotes LIS pour Hyper-V ou que vous les avez compilés correctement (ils sont disponibles en open source). Les pilotes sont disponibles [ici][ici]
