<properties 
	...
	description="Apprenez à utiliser Mobile Services pour authentifier les utilisateurs de votre application Windows Store par l'intermédiaire de divers fournisseurs d'identité, notamment Google, Facebook, Twitter et Microsoft." 
...
5. [Stockage des jetons d'authentification sur le client]
...
>[AZURE.NOTE]Ce didacticiel vous explique comment authentifier les utilisateurs dans les applications Windows Store et Windows Phone Store 8.1. Pour une application Windows Phone 8.0 ou Windows Phone Silverlight 8.1, reportez-vous à cette version du didacticiel [Prise en main de l'authentification dans Mobile Services](mobile-services-windows-phone-get-started-users.md).
...
<ol start="5">
<li><p>(Facultatif) Suivez la procédure décrite dans la rubrique <a href="mobile-services-how-to-register-store-app-package-microsoft-authentication.md">Inscription du package de votre application Windows Store pour l'authentification Microsoft</a>.</p>
...
[Prise en main des données]: mobile-services-javascript-backend-windows-store-dotnet-get-started-data.md
[Prise en main de l'authentification]: mobile-services-javascript-backend-windows-store-dotnet-get-started-users.md
[Prise en main des notifications Push]: mobile-services-javascript-backend-windows-store-dotnet-get-started-push.md
[Autorisation des utilisateurs avec des scripts]: mobile-services-windows-store-dotnet-authorize-users-in-scripts.md
[JavaScript et HTML]: mobile-services-windows-store-javascript-get-started-users.md
