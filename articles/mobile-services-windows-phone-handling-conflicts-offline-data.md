...
2. Dans l'Explorateur de solutions pour Visual Studio, dans votre projet de service, développez le dossier **Models** et ouvrez ToDoItem.cs. Ajoutez la propriété  `DueDate` comme suit.
