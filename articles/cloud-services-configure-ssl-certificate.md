...
Les procédures de cette tâche s'appliquent à Azure Cloud Services. Pour Sites Web Azure, consultez la page [Configuration d'un certificat SSL pour un site Web Azure](../web-sites-configure-ssl-certificate/).
...
Obtention d'un certificat SSLÉtape 1 : obtention d'un certificat SSL
--------------------------------------------------------------------
...
Modification des fichiers de service et de configurationÉtape 2 : modification des fichiers de définition de service et de configuration
----------------------------------------------------------------------------------------------------------------------------------------
...
Téléchargement dans AzureÉtape 3 : téléchargement du package de déploiement et du certificat
--------------------------------------------------------------------------------------------
...
6.  Dans la boîte de dialogue **Add Certificate**, entrez l'emplacement du fichier .pfx du certificat SSL, le mot de passe du certificat, puis cliquez sur **Attach certificate**.
...
Connexion avec HTTPSÉtape 4 : connexion de l'instance de rôle à l'aide de HTTPS
-------------------------------------------------------------------------------
