<properties 
	pageTitle="Bottle et le stockage de tables Azure sur Azure avec Python Tools 2.1 pour Visual Studio" 
	description="Découvrez comment utiliser les outils Python pour Visual Studio pour créer une application Bottle qui stocke les données dans le stockage de tables Azure et peut être déployée vers un site Web." 
	services="web-sites" 
