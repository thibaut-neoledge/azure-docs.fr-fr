...
[Service Management Automation (SMA)](http://technet.microsoft.com/library/dn469260.aspx) vise à automatiser les tâches de gestion dans le cloud privé. Il est installé localement dans votre centre de données en tant que composant de [Windows Azure Pack](https://www.microsoft.com/fr-FR/server-cloud/). SMA et Azure Automation utilisent le même format de runbook basé sur un Windows PowerShell et Windows PowerShell Workflow, mais SMA ne prend pas en charge les [runbooks graphiques](automation-graphical-authoring-intro.md).
...
* [Azure Automation Cmdlets](https://msdn.microsoft.com/library/mt244122.aspx) fournit des informations pour l'automatisation des tâches d'administration. Il contient des applets de commande pour gérer les comptes Automation, les ressources, les Runbooks et DSC.
