...
2. Cliquez sur la partie **Certificats** afin d’ouvrir le panneau **Certificats**.
3. Cliquez sur **Ajouter un certificat** en haut du panneau.
4. Tapez un nom pour le certificat dans la zone **Nom**.
5. Cliquez sur **Sélectionner un fichier** sous **Télécharger un fichier de certificat** pour rechercher un fichier .cer ou .pfx. Si vous sélectionnez un fichier .pfx, spécifiez un mot de passe et s’il est autorisé à être exporté.
