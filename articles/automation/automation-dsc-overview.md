...
- [Gestion de machines avec Azure Automation DSC](../automation/automation-dsc-onboarding.md)
- [Compilation de configurations dans Azure Automation DSC](../automation/automation-dsc-compile.md)
