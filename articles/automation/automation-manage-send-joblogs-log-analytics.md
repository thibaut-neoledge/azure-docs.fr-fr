---
title: "Transférer l’état d’un travail et des flux de travail d’Automation vers Log Analytics (OMS) | Microsoft Docs"
...
1. Un abonnement OMS. Pour plus d’informations, consultez l’article [Prise en main de Log Analytics](../log-analytics/log-analytics-get-started.md).  
   ...
   > [!NOTE]
   > L’espace de travail OMS et le compte Automation doivent se trouver dans le même abonnement Azure pour que cette configuration fonctionne correctement.
   >
   >
2. Un [compte de stockage Azure](../storage/storage-create-storage-account.md).  

   > [!NOTE]
   > Le compte de stockage *doit* se trouver dans la même région que le compte Automation.
   >
   >
...
## <a name="setup-integration-with-log-analytics"></a>Configurer l’intégration avec Log Analytics
