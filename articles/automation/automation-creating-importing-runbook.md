...
1. Dans le portail Azure Classic, sélectionnez **Automation**, puis choisissez le nom d’un compte Automation.
...
5. Le nouveau runbook apparaît sur l’onglet **Runbooks** du compte Automation.
