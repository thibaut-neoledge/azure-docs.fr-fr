...
2. Cliquez sur **Webhook** en haut du panneau pour ouvrir le panneau **Ajouter un webhook**. <br> ![Bouton Webhooks](media/automation-webhooks/webhooks-button.png)
...
5. Cliquez sur l'icône de copie et appuyez sur Ctrl + C pour copier l'URL du webhook. Puis enregistrez-la dans un endroit sûr. **Une fois que vous avez créé le webhook,vous ne pouvez pas récupérer l'URL à nouveau.** <br> ![URL du webhook](media/automation-webhooks/copy-webhook-url.png)
