...
Les lignes suivantes définissent les [informations d’identification](automation-credentials.md) et l’abonnement Azure qui seront utilisés pour le reste du runbook.
