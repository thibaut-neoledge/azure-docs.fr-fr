                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Guide de prise en main pour les développeurs Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Guide de l’architecture des applications Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <ul class="pivots">
                        ...
                        <ul id="get-started1" class="cardsL">
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Déployer l’infrastructure</h3>
                                                <ul class="noBullet">
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/machine-learning/preview">Services de Machine Learning</a></li>
                            ...
                            <li class="bottomRightItem">
                                <a href="https://aka.ms/j3wr7y">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Afficher tous les services Azure<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li>
                ...
                <ul id="products">
                        ...
                        <ul id="all" class="directory">
                            <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/mysql/">
                                                ...
                                                <p>Base de données Azure pour MySQL</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/postgresql/">
                                                <img src="media/index/PostgreSQL.svg" alt="" />
                                                <p>Base de données Azure pour PostgreSQL</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/azure-stack/">
                                                ...
                                                <p>Opérateur Azure Stack</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/azure-stack/user">
                                                <img src="media/index/azure-stack.svg" alt="" />
                                                <p>Utilisateur Azure Stack</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Clouds souverains</h3>
                                    <ul>
                                        <li>
                                ...
                                <div class="group">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/networking/networking-overview">
                                                ...
                                                <p>Vue d’ensemble de la mise en réseau</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cdn/">
                                                ...
                                                <p>Réseau de distribution de contenu</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <h3>Intelligence artificielle + Services cognitifs</h3>
                                    <ul>
                                        <li>
                                            <a href="/azure/machine-learning/preview">
                                                <img src="media/index/MachineLearning.svg" alt="" />
                                                <p>Services de Machine Learning</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/bing-spell-check/proof-text">
                                                ...
                                                <p>Vérification orthographique Bing</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/speaker-recognition/home">
                                                ...
                                                <p>Reconnaissance de l’orateur</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/Custom-Vision-Service/home">
                                                ...
                                                <p>Recherche de Vision personnalisée</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/active-directory-domain-services">
                                                <img src="media/index/ActiveDirectory.svg" alt="" />
                                                <p>Azure Active Directory pour les services de domaine</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Approvisionnez des machines virtuelles Ubuntu, Red Hat et bien d’autres</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Mettre à l’échelle et orchestrer des conteneurs à l’aide de Kubernetes, DC/OS ou Docker Swarm</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#network">Mise en réseau</a>
...
Équilibreur de charge Layer 7 avec équilibrage de charge HTTP et contrôle de distribution intégrés </p>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Passerelle VPN</h3>
                                                    <p>Établissez une connectivité sécurisée intersite</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>DNS Azure</h3>
                                                    <p>Hébergez votre domaine DNS dans Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Routez le trafic entrant assurant des performances et une disponibilité élevées</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Stockage de disques pour machines virtuelles</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Encodez, stockez et diffusez du contenu audio et vidéo à grande échelle</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Base de données Azure pour MySQL</h3>
                                                    <p>Service géré de base de données MySQL pour développeurs d’applications</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Base de données Azure pour PostgreSQL</h3>
                                                    <p>Service géré de base de données PostgreSQL pour développeurs d’applications</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#analytics">Données + Analytique</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Traitement en temps réel de flux de données provenant de millions d’appareils IoT</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Event Hubs</h3>
                                                    <p>Recevez des données de télémétrie provenant de millions d’appareils</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Data Factory</h3>
                                                    <p>Orchestrez et gérez la transformation et le déplacement des données</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#cognitive">Intelligence artificielle + Services cognitifs</a>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/computer-vision/"><img src="media/index/API_Vis_ComputerVision.svg" alt="" />Vision par ordinateur</a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/Custom-Vision-Service/home"><img src="media/index/cs-custom-vision.svg" alt="" /><span>Recherche de Vision personnalisée&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/emotion/home"><img src="media/index/API_Vis_Emotion.svg" alt="" /><span>API Émotion&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/face/"><img src="media/index/API_Vis_Face.svg" alt="" />API Visage</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/video/home"><img src="media/index/cs-video.svg" alt="" /><span>API vidéo&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/video-indexer/video-indexer-overview"><img src="media/index/cs-video-indexer.svg" alt="" /><span>Video Indexer&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <li>
                                        <div class="cardSize">
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        <h3>Microsoft Speech</h3>
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/speech/"><img src="media/index/API_Spc_CustomSpeechService.svg" alt="" />Service de reconnaissance vocale Bing</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/custom-speech-service/cognitive-services-custom-speech-home"><img src="media/index/API_Spc_CustomSpeechService.svg" alt="" /><span>Service de reconnaissance vocal personnalisé&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/speaker-recognition/home"><img src="media/index/API_Spc_SpeakerRecognition.svg" alt="" /><span>Reconnaissance de l’orateur&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-spell-check/proof-text"><img src="media/index/API_Lang_BingSpellCheck.svg" alt="" />Vérification orthographique Bing</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/luis/home"><img src="media/index/API_Lang_LanguageUnderstanding.svg" alt="" /><span>LUIS (Language Understanding Intelligent Services)&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/linguisticanalysisapi/home"><img src="media/index/API_Lang_LinguisticAnalysis.svg" alt="" /><span>Analyse linguistique&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/text-analytics/overview"><img src="media/index/API_Lang_TextAnalytics.svg" alt="" /><span>Analyse de texte&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/translator/"><img src="media/index/cognitive-services-translator.svg" alt="" />API de traduction de texte Translator Text</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/web-language-model/home"><img src="media/index/API_Lang_WebLM.svg" alt="" /><span>Modèle de langage web&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/custom-decision-service/custom-decision-service-overview"><img src="media/index/cs-decision-maker.svg" alt="" /><span>Service Décision personnalisée&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/entitylinking/home"><img src="media/index/API_Know_EntityLink.svg" alt="" /><span>Entity Linking&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/kes/overview"><img src="media/index/API_Know_Exploration.svg" alt="" /><span>Service d’exploration des connaissances (KES)&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/qnamaker/home"><img src="media/index/API_Know_QandA_Maker.svg" alt="" /><span>QnAMaker&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/recommendations/overview"><img src="media/index/API_Know_Recommendations.svg" alt="" /><span>Recommandations&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-news-search/search-the-web"><img src="media/index/API_Sear_BingNewsSearch.svg" alt="" />Actualités Bing</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-video-search/search-the-web"><img src="media/index/API_Sear_BingVideoSearch.svg" alt="" />Recherche de vidéos Bing</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-web-search/search-the-web"><img src="media/index/API_Sear_BingSearch.svg" alt="" />Recherche web Bing</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-autosuggest/get-suggested-search-terms"><img src="media/index/API_Sear_BingAutoSuggest.svg" alt="" />Suggestion automatique Bing</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-custom-search/overview"><img src="media/index/API_Sear_BingSearch.svg" alt="" /><span>Recherche personnalisée Bing&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-entities-search/overview"><img src="media/index/API_Sear_BingSearch.svg" alt="" /><span>Recherche des entités Bing&nbsp;<sup style="font-size:70%">VERSION PRÉLIMINAIRE</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-image-search/search-the-web"><img src="media/index/API_Sear_BingImageSearch.svg" alt="" />Recherche d’images Bing</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                    ...
                    <li>
                        <a href="#iot">Internet des objets</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Centre de développement IoT</h3>
                                                    <p>Commencez à connecter vos appareils</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Service Bus</h3>
                                                    <p>Connectez-vous à des environnements de cloud privés et publics</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#security">Sécurité et identité</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Synchronisez les répertoires locaux et activez l’authentification unique</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Active Directory pour les services de domaine</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Créez rapidement des environnements avec des modèles et des artefacts réutilisables</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HockeyApp</h3>
                                                    <p>Déployez des applications mobiles, collectez des commentaires et des rapports d’incidents, et surveillez l’utilisation</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mgmt">Surveillance et gestion</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Simplifiez la gestion du cloud en automatisant les processus</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#other">Clouds souverains</a>
            ...
            <li>
                <a href="#sdkstools">Kits de développement logiciel/outils</a>
                <ul id="sdkstools">
                    <li>
                        <a href="#sdkstools-all">Tout</a>
                        <ul id="sdkstools-all" class="cardsF">
                            <li>
                                <div class="container">
                                    <h2>Langages &amp; infrastructures</h2>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/dotnet/azure">Prise en main</a>
                                                </p>
                                                <p>
                                                    <a href="/dotnet/api/overview/azure/?view=azure-dotnet">Référence API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/python/azure/python-sdk-azure-install">Obtention de bibliothèques Azure pour Python</a>
                                                </h3>
                                                <p>
                                                    <a href="/python/azure">Prise en main</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/overview/azure/">Référence API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/java/azure">Prise en main</a>
                                                </p>
                                                <p>
                                                    <a href="/java/api/overview/azure">Référence API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/samples/?platform=ruby">Accéder aux exemples</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/ruby/">En savoir plus</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/rest/api/">Prise en main de REST</a>
                                                </h3>
                                                <p>
                                                    <a href="/rest/api">Référence</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/samples/?platform=rest">Accéder aux exemples</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/powershell/azure/install-azurerm-ps">Télécharger PowerShell</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://github.com/Microsoft/DockerToolsDocs">Outils Docker</a>
                                                </h3>
                                                <p>
                                                    <a href="/dotnet/articles/core/docker/visual-studio-tools-for-docker">Prise en main</a>
                                                </p>
                                                <p>
