...
---
# <a name="audit-operations-with-resource-manager"></a>Opérations d’audit avec Resource Manager
...
## <a name="portal-to-view-activity-logs"></a>Afficher les journaux d’activité à l’aide du portail
...
## <a name="powershell-to-view-activity-logs"></a>Afficher les journaux d’activité à l’aide de PowerShell
...
## <a name="azure-cli-to-view-activity-logs"></a>Afficher les journaux d’activité à l’aide de la CLI Azure
...
## <a name="rest-api-to-view-audit-logs"></a>API REST pour afficher les journaux d’audit
