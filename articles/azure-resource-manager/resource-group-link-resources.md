...
## <a name="linking-in-templates"></a>Modèles de liaisons
...
## <a name="linking-with-rest-api"></a>Liaison avec une API REST
...
Pour consulter d’autres exemples traitant notamment de la récupération d’informations à propos des liaisons, consultez la section [Ressources liées](https://docs.microsoft.com/rest/api/resources/resourcelinks).
