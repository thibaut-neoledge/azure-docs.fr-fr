...
Cet article décrit le schéma et les propriétés de tous les éléments pris en charge d’une fonction CreateUiDefinition. Le schéma pour la plupart des éléments est le suivant :
