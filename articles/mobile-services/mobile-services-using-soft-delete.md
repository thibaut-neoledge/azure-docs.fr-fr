---
title: Utilisation de la suppression réversible dans Mobile Services (Windows Store) | Microsoft Docs
...
4. Dans l'Explorateur de solutions de Visual Studio, développez le nœud **Contrôleurs** sous votre projet de backend .NET et ouvrez la source du contrôleur. Par exemple, *TodoItemController.cs*.
