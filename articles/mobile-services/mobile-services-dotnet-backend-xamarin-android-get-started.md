...
>[AZURE.TIP]Si vous êtes novice dans le développement mobile avec Microsoft Azure, [commencez par la prise en main des applications Azure Mobile](app-service-mobile-dotnet-backend-xamarin-android-get-started-preview.md) plutôt que par celle d’Azure Mobile Services ; vous bénéficierez ainsi d’[avantages supplémentaires](app-service-mobile-value-prop-migration-from-mobile-services-preview.md).
