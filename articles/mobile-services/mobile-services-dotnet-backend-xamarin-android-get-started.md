...
>[AZURE.TIP] Si vous êtes novice en matière de développement mobile avec Microsoft Azure, [commencez avec Azure Mobile Apps](../app-service-mobile/app-service-mobile-dotnet-backend-xamarin-android-get-started-preview.md) plutôt qu’avec Azure Mobile Services. Vous bénéficierez ainsi d’[avantages supplémentaires](app-service-mobile-value-prop-migration-from-mobile-services-preview.md).
...
1. Dans le [portail classic], cliquez sur **Mobile Services**, puis sur le service mobile que vous venez de créer.
...
5. Sous **Télécharger et publier votre service dans le cloud**, sélectionnez **Android** et cliquez sur **Télécharger**.
  	...
  	Cela permet de télécharger une solution contenant les projets à la fois pour le service mobile et l’exemple d’application _liste des tâches_ connectée à votre service mobile. Enregistrez le fichier projet compressé sur votre ordinateur local et notez l'emplacement où vous l'avez enregistré.
