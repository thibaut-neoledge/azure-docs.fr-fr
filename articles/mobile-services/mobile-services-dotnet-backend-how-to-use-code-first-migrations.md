---
title: Modifications des modèles de données pour un service mobile de backend .NET
...
5. Développez le dossier App\_Start, ouvrez le fichier de projet WebApiConfig.cs et ajoutez les instructions **using** suivantes :
    ...
    Dans le code ci-dessus, vous devez remplacer la chaîne *todolistService* par l'espace de noms de votre projet, qui, pour le projet de démarrage rapide téléchargé, est <em>nom&#95;service&#95;mobile</em>Service.
...
11. (Facultatif) Dans le [portail Azure Classic], sélectionnez votre service mobile, cliquez sur **Configurer** > **Base de données SQL**. Vous accédez ainsi à la page de la base de données SQL de la base de données de votre service mobile.
12. (Facultatif) Cliquez sur **Gérer**, connectez-vous au serveur de base de données SQL, puis cliquez sur **Conception** et vérifiez que les modifications de schéma ont été effectuées dans Azure.
