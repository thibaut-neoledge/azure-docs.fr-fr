...
4. Dans la fenêtre Explorateur de solutions de Visual Studio, ouvrez le fichier MainPage.cs et ajoutez les lignes suivantes à l'aide d'instructions.
...
8. Dans le code de la méthode `AuthenticateAsync` ci-dessus, remplacez **INSERT-CLIENT-ID-HERE** par l'ID client que vous avez copié depuis l'application cliente native.
