...
5. Cliquez sur **API et authentification** > **Informations d’identification** > **Écran de consentement OAuth**, sélectionnez votre **Adresse de messagerie**, entrez un **Nom de produit**, puis cliquez sur **Enregistrer**.
