...
>[AZURE.NOTE]Actuellement, ce plug-in ne prend en charge que les appareils iOS et Android. Pour une solution qui inclut également les appareils Windows, consultez l'article [Push Notifications to PhoneGap Apps using Notification Hubs Integration](http://blogs.msdn.com/b/azuremobile/archive/2014/06/17/push-notifications-to-phonegap-apps-using-notification-hubs-integration.aspx).
...
[Authentification de votre application avec l'authentification unique]: mobile-services-windows-store-javascript-single-sign-on.md
