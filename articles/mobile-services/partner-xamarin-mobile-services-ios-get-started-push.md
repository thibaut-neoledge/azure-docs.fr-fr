---
title: Ajouter des notifications push à votre application (Xamarin.iOS) - Mobile Services
...
> Pour la version Mobile Apps équivalente de cette rubrique, consultez [Ajouter des notifications Push à votre application Xamarin.iOS](../app-service-mobile/app-service-mobile-xamarin-ios-get-started-push.md).
> 
> 
...
> [!IMPORTANT]
> En raison de la configuration requise pour APNS, vous devez déployer et tester les notifications Push sur un appareil compatible iOS (iPhone ou iPad) au lieu d'un émulateur.
> 
> 
