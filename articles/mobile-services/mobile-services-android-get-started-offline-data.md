---
title: Ajouter la synchronisation des données hors connexion à votre application de services mobiles Android | Microsoft Docs
...
3. Affichez le contenu de la table Azure *TodoItem*. Vérifiez que les nouveaux éléments n’ont *pas* été synchronisés avec le serveur :
