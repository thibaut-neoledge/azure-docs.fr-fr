---
title: Ajout de notifications Push à votre application Windows 8.1 universelle | Microsoft Docs
...
> [!NOTE]
> N'utilisez jamais de service mobile de production pour les tests et le développement. Pour les tests, publiez toujours votre projet de service mobile vers un service intermédiaire.
> 
> 
