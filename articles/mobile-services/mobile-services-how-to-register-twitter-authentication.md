...
7. Cliquez sur l'onglet **Paramètres**, faites défiler vers le bas et vérifiez que la case **Autoriser cette application à se connecter à votre compte Twitter** est cochée, puis cliquez sur **Mettre à jour les paramètres**.
