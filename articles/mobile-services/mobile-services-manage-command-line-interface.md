---
title: Administration d'un service mobile à partir d'une invite de commandes | Microsoft Docs
...
> [!NOTE]
> Les commandes de la CLI liées à « liste » et à « script » fonctionnent uniquement avec le backend JavaScript.
> 
> 
