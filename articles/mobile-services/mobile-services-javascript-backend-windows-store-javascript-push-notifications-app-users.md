<properties 
	...
	description="Découvrez comment utiliser Azure Mobile Services pour envoyer des notifications Push à des utilisateurs spécifiques de votre application Windows JavaScript universelle." 
...
<!-- URLs. -->
[Ajout de l’authentification à votre application]: mobile-services-windows-store-javascript-get-started-users.md
[Ajout de notifications Push à votre application]: mobile-services-javascript-backend-windows-store-javascript-get-started-push.md
