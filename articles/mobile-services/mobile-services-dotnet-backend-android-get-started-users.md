---
title: Prise en main de l'authentification (Android) | Microsoft Docs
...
1. Ouvrez le projet que vous avez créé avec le didacticiel [Prise en main de Mobile Services].
2. Dans le menu **Exécuter**, cliquez sur **Exécuter l'application** pour démarrer l'application ; vérifiez qu'une exception non prise en charge avec le code d'état 401 (Non autorisé) est générée après le démarrage de l'application.
