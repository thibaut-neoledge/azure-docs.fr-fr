---
title: Prise en main de l'authentification (Xamarin.iOS) - Mobile Services
...
[Xamarin Studio], XCode 6.0 et iOS 7.0 ou versions ultérieures sont requis pour suivre ce didacticiel.
...
1. Dans Xcode, ouvrez le projet que vous avez créé avec le didacticiel [Prise en main de Mobile Services].
...
2. Ensuite, ajoutez une nouvelle méthode intitulée **Authenticate** à **ToDoService** en la définissant comme suit :
   ...
   > [!NOTE]
   > Si vous utilisez un autre fournisseur d'identité qu'un compte Microsoft, remplacez la valeur passée à la méthode **LoginAsync** ci-dessus par l'une des valeurs suivantes : *Facebook*, *Twitter*, *Google* ou *WindowsAzureActiveDirectory*.
   > 
   > 
...
1. Supprimez l'appel initial à **RefreshAsync** dans **TodoListViewController.ViewDidLoad**.
