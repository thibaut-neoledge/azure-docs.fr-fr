...
2. Dans le [portail Azure Classic], cliquez sur **Mobile Services**, puis sur le service mobile que vous venez de créer.
3. Dans l'onglet de démarrage rapide, cliquez sur **Xamarin** sous **Choisissez une plateforme** et développez **Créer une application Xamarin**.
      ...
      ![][7]
4. Sous **Télécharger et publier votre service dans le cloud**, sélectionnez **iOS** et cliquez sur **Télécharger**.
...
> [!NOTE]
> Vous pouvez vérifier le code (se trouvant dans le fichier C# QSTodoService.cs) qui accède au service mobile pour exécuter une requête et insérer des données.
> 
> 
