...
3. Dans Visual Studio, développez le dossier `\js` de l'Explorateur de solutions, ouvrez le projet default.js, puis ajoutez les lignes de code suivantes après le code définissant la variable **client** :
...
[Prise en main de Mobile Services]: mobile-services-javascript-backend-windows-store-javascript-get-started.md
[Ajout de Mobile Services à une application existante]: ../mobile-services-windows-store-javascript-get-started.md
