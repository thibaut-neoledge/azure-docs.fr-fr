...
3. Ouvrez un outil en ligne de commande Git, tel que **GitBash** (Windows) ou **Bash** (Unix Shell), puis tapez la commande suivante dans l'invite de commandes Git :
	...
	Celle-ci permet de télécharger le nouveau module `newrelic` sur votre service mobile.
...
##<a name="enable-service"></a>Activation de l’analyse développeur New Relic pour le service mobile
...
[page New Relic dans l'Azure Store]: /gallery/store/new-relic/new-relic/
