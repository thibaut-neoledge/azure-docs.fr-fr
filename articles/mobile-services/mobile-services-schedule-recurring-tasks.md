---
title: Planifier des tâches de backend dans un service mobile de backend JavaScript | Microsoft Docs
description: Utilisez le planificateur dans Azure Mobile Services pour définir des tâches de backend JavaScript qui s’exécutent selon une planification.
...
1. Dans le [portail Azure Classic], cliquez sur l'onglet **Données** de votre service mobile, puis cliquez sur **+Créer**.
...
3. Cliquez sur la tâche que vous venez de créer, cliquez sur l'onglet **Script** et remplacez la fonction de l'espace réservé **getUpdates** par le code suivant :
...
1. Cliquez sur **Exécuter une fois** pour tester le script.
   
       Le travail est exécuté et enregistré, tout en restant désactivé dans le planificateur.
2. Cliquez sur le bouton Précédent, sur **Données**, sur la table **Updates**, sur **Parcourir** et vérifiez que les données Twitter ont été insérées dans la table.
3. Cliquez sur le bouton Précédent, sur **Scheduler**, sélectionnez **getUpdates**, puis cliquez sur **Activer**.
