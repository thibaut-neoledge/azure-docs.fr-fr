...
3. Sélectionnez la mesure pour laquelle vous souhaitez définir une alerte, puis sélectionnez **Ajouter une règle** ![Portail de gestion Azure - Alerte SQL][PortalSqlAddAlert].
...
5. Spécifiez la valeur à utiliser comme seuil d'alerte. Vous pouvez indiquer **80 %** pour vous ménager un temps de réaction. Veillez également à spécifier une adresse de messagerie que vous surveillez activement. ![Portail de gestion Azure - Courrier électronique et seuil d'alerte SQL][PortalSqlAddAlert3]
