---
title: Mise à l’échelle des services mobiles soutenus par une base de données SQL Azure | Microsoft Docs
...
Pour plus d'informations sur les index, consultez la page sur les [annotations d'index dans Entity Framework][annotations d'index dans Entity Framework]. Pour plus d'informations sur l'optimisation des index, consultez la section [Indexation avancée](#AdvancedIndexing) à la fin de ce document.
...
* [Créer des index non cluster][Créer des index non cluster]
* [Créer des index cluster][Créer des index cluster]
* [Créer des index uniques][Créer des index uniques]
...
Pour plus d'informations, consultez les pages [Contrôle de Base de données SQL Azure à l'aide de vues de gestion dynamique][Contrôle de Base de données SQL Azure à l'aide de vues de gestion dynamique] et [Vues de gestion dynamique des index manquants][Vues de gestion dynamique des index manquants].
...
## Voir aussi
* [Documentation sur la base de données SQL Azure][Documentation sur la base de données SQL Azure]
...
* [Dépannage de la base de données SQL Azure][Dépannage de la base de données SQL Azure]

### Indexation
* [Notions fondamentales sur les index][Notions fondamentales sur les index]
* [Instructions générales sur la création d'index][Instructions générales sur la création d'index]
* [Instructions sur la création d'index uniques][Instructions sur la création d'index uniques]
* [Instructions sur la création d'index cluster][Instructions sur la création d'index cluster]
* [Contraintes de clé primaire et de clé étrangère][Contraintes de clé primaire et de clé étrangère]
