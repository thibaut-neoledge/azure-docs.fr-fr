---
title: Ajout de l'authentification à votre application HTML/JavaScript | Microsoft Docs
...
2. Dans le fichier page.js, recherchez la ligne de code tout en bas du fichier qui appelle la fonction refreshTodoItems, puis remplacez-la par le code suivant :
   ...
   > [!IMPORTANT]
   > Dans une application PhoneGap, vous devez également ajouter les plug-ins suivants au projet :
   > 
