---
title: Envoi de notifications Push aux utilisateurs authentifiés (application Windows 8.1 universelle) | Microsoft Docs
...
> Pour la version Mobile Apps équivalente de cette rubrique, consultez [How to: Send push notifications to an authenticated user](../app-service-mobile/app-service-mobile-dotnet-backend-how-to-use-server-sdk.md#push-user).
> 
> 
...
[Prise en main des notifications Push]: mobile-services-dotnet-backend-windows-universal-dotnet-get-started-push.md
