<properties urlDisplayName="Service Management API" pageTitle="Utilisation de l'API de gestion des services pour les machines virtuelles - Azure" metaKeywords="" description="Apprenez &agrave; utiliser l'API de gestion des services&nbsp;Azure pour une machine virtuelle&nbsp;Linux." metaCanonical="" services="virtual-machines" documentationCenter="" title="Utilisation de l'API de gestion des services" authors="timlt" solutions="" manager="timlt" editor="" />
