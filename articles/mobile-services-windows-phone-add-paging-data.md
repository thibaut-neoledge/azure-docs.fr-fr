<properties pageTitle="Ajout d'une pagination aux données (Windows Phone) | Centre de développement mobile" metaKeywords="" description="Learn how to use paging to manage the amount of data returned to your Windows Phone app from Mobile Services." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Refine Mobile Services queries with paging" authors="glenga" solutions="" manager="dwrede" editor="" />
...
Ce didacticiel s'appuie sur la procédure et l'exemple d'application du didacticiel précédent [Ajout de services mobiles à une application existante](/fr-fr/documentation/articles/mobile-services-windows-phone-get-started-data/). Avant de commencer ce didacticiel, vous devez suivre intégralement celui-ci :  
