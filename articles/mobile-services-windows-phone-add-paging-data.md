...
Ce didacticiel s'appuie sur la procédure et l'exemple d'application présentés dans le didacticiel précédent intitulé [Prise en main des données](/fr-fr/documentation/articles/mobile-services-windows-phone-get-started-data/). Avant de commencer ce didacticiel, vous devez suivre au moins le premier didacticiel consacré à l'utilisation des séries de données, intitulé [Prise en main des données](/fr-fr/documentation/articles/mobile-services-windows-phone-get-started-data/).
