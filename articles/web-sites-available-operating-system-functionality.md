<properties title="Operating System Functionality Available to Applications on Azure Websites" pageTitle="Fonctionnalités de système d'exploitation accessibles aux applications sur Sites Web Azure" description="En savoir plus sur les fonctionnalités de système d'exploitation disponibles pour les applications web sur Sites Web Azure" metaKeywords="Azure,Web Sites,web applications,operating system functionality" services="web-sites" solutions="web" documentationCenter="" authors="cephalin" manager="wpickett" editor="mollybos" videoId="" scriptId="" />
