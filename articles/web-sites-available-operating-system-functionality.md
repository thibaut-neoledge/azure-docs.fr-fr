<properties 
	pageTitle="Fonctionnalités de système d'exploitation accessibles aux applications sur Sites Web Azure" 
	description="En savoir plus sur les fonctionnalités de système d'exploitation disponibles pour les applications Web sur Sites Web Azure" 
	services="web-sites" 
	documentationCenter="" 
	authors="cephalin" 
	manager="wpickett" 
...
* [Infrastructure de développement](#developmentframeworks)
* [Accès aux fichiers](#FileAccess)
	* [Lecteurs locaux](#LocalDrives)
	* [Lecteurs réseaux (partages UNC)](#NetworkDrives)
...
* [Exécution du code, processus et mémoire](#Code)
