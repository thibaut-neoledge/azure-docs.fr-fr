...
* [**A Journey to Social**](https://medium.com/@Ealsur/a-journey-to-social-c47636bf25c9#.an669sx41) - *par Matías Quaranta* 
* [**Azure DocumentDB protocol support for MongoDB in Preview, my test with Sitecore**](https://alwaysupalwayson.blogspot.ca/2016/05/azure-documentdb-protocol-support-for.html) - *par Mathieu Benoit* 
* [**Going Social with DocumentDB (Réseaux sociaux avec DocumentDB)**](https://blogs.msdn.microsoft.com/mvpawardprogram/2016/03/15/going-social-with-documentdb/) - *par Matias Quarantaas*
* [**UWP, Azure App Services, and DocumentDB Soup: A photo-sharing app (UWP, Azure App Services et DocumentDB : une application de partage de photos)**](https://blogs.windows.com/buildingapps/2016/03/17/uwp-azure-app-services-and-documentdb-soup-a-photo-sharing-app/) - *par Eric Langland*
...
* [**DocumentDB revisited Part 1/2 – The theory (DocumentDB revisité, partie 1/2 – La théorie)**](https://peterintheazuresky.wordpress.com/2016/02/19/documentdb-revisited-part-12-the-theory/) - *par Peter Mannerhult*
* [**What to love and hate about Azure’s DocumentDB (Atouts et inconvénients d’Azure DocumentDB)**](http://blog.falafel.com/4-what-to-love-and-hate-about-azures-documentdb/) - *par George Saadeh*
* [**Azure DocumentDB Server-Side Scripting (Script côté serveur d’Azure DocumentDB)**](https://www.simple-talk.com/cloud/cloud-data/azure-documentdb-server-side-scripting/) - *par Robert Sheldon*
...
*Vous souhaitez partager un billet de blog, un exemple de code ou une étude de cas ? [Dites-le-nous](mailto:askcosmosdb@microsoft.com) !*

## <a name="events-and-recordings"></a>Événements et enregistrements
...
*Vous accueillez un événement ou y participez ? [Dites-nous](mailto:askcosmosdb@microsoft.com) en quoi nous pouvons vous aider !*
...
| [AzureCon](https://azure.microsoft.com/azurecon/) |David Makogon, Ryan Crawcour, John Macintyre |Événement virtuel |29 septembre 2015 |[Azure data and analytics platform](https://channel9.msdn.com/events/Microsoft-Azure/AzureCon-2015/ACON207) (Plateforme de données et d’analyse Azure) [Working with NoSQL Data in DocumentDB](https://channel9.msdn.com/Events/Microsoft-Azure/AzureCon-2015/ACON338) (Utilisation de données NoSQL dans DocumentDB) |
| [SQL Saturday #434 - Holland 2015](http://www.sqlsaturday.com/434/Sessions/Details.aspx?sid=36413) |Leonard Lobel |Utrecht, Pays-Bas |26 septembre 2015 |[Présentation d’Azure DocumentDB](https://channel9.msdn.com/Blogs/Azure/SQL-Saturday-Holland-2015-Introduction-to-Azure-DocumentDB) |
...
| [Meetup: Charlotte Microsoft Cloud](http://www.meetup.com/Charlotte-Microsoft-Cloud/events/221503519/) |Jamie Rance |Charlotte, Caroline du Nord |8 avril 2015 |n/a |
...
| --- | --- | --- | --- |
| Azure Friday |Kirill Gavrylyuk |31 octobre 2016 |[Nouveautés d’Azure DocumentDB](https://channel9.msdn.com/Shows/Azure-Friday/AzureFridayNewinDocumentDB) |
| Channel 9 : Microsoft + Open Source |Jose Miguel Parrella |14 avril 2016 |[De MEAN à DEAN dans Azure avec Bitnami, les jeux de mise à l’échelle de machine virtuelle et DocumentDB](https://channel9.msdn.com/Blogs/Open/From-MEAN-to-DEAN-in-Azure-with-Bitnami-VM-Scale-Sets-and-DocumentDB) |
...
| --- | --- |
| [![Microsoft Virtual Academy](./media/community/mva.png)](https://mva.microsoft.com/en-US/training-courses/azure-documentdb-planetscale-nosql-16847) |[**Microsoft Virtual Academy**](https://mva.microsoft.com/en-US/training-courses/azure-documentdb-planetscale-nosql-16847) sont dirigées par les personnes qui participent au développement d’Azure DocumentDB. |
...
| --- | --- |
| [![Stackoverflow](./media/community/stack-overflow.png)](http://stackoverflow.com/questions/tagged/azure-documentdb) |Site de questions et réponses indépendant du langage géré en collaboration pour les programmeurs. Suivez notre balise : [azure-documentdb](http://stackoverflow.com/questions/tagged/azure-documentdb) |

## <a name="contact-the-team"></a>Contactez l’équipe
![Équipe](./media/community/team.png)

Vous avez besoin d’une assistance technique ? Vous avez des questions ? Vous vous demandez si NoSQL vous convient ? Vous pouvez planifier une conversation individuelle directement avec l’équipe d’ingénierie DocumentDB en nous envoyant un [message électronique](mailto:askcosmosdb@microsoft.com) ou un tweet à [@DocumentDB](https://twitter.com/DocumentDB).
