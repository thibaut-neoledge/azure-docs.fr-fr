...
# Azure Cosmos DB : Développer une application console API MongoDB avec Golang et le Portail Azure
...
### Interroger ou lire un document
...
## Réviser votre document dans l’Explorateur de données
