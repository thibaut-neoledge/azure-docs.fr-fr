...
# Prise en charge du pare-feu Azure Cosmos DB
...
## Connexions à partir de services cloud
...
## Connexions à partir de machines virtuelles
...
## Dépannage de la stratégie de contrôle d’accès IP
<a id="portal-operations" class="xliff"></a>

### Opérations du portail
...
### Kit de développement logiciel (SDK) et API REST
