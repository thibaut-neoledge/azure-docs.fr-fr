...
Azure Scheduler vous permet de façon déclarative de décrire des actions à exécuter dans le cloud.  Ensuite, il planifie et exécute ces actions automatiquement.  Scheduler conserve un historique consultable des résultats de l’exécution des travaux.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>En savoir plus sur Scheduler</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>PowerShell</h3>
                        <p>Applets de commande PowerShell d’Azure Scheduler</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>.NET</h3>
                        <p>Informations de référence sur l’API managée de Scheduler</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p>Informations de référence sur l'API REST de Scheduler</p>
                    </div>
                </div>
            </div>
        </div>
