...
---
# <a name="how-to-retain-a-constant-virtual-ip-address-for-a-cloud-service"></a>Conserver une adresse IP virtuelle constante pour un service cloud
...
### <a name="to-update-a-cloud-service-without-changing-its-vip"></a>Pour mettre à jour un service cloud sans modifier son adresse IP virtuelle
