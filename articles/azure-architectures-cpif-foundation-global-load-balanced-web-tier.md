<properties 
   ...
   description="Le niveau global du web à charge équilibrée fait partie de la Fondation, qui est décrite en détail dans le document d'architecture CPIF" 
   services="" 
   documentationCenter="" 
   authors="arynes" 
   manager="fredhar" 
...
Le modèle du **niveau global du web à charge équilibrée** fait partie de la **Fondation**, qui est décrite en détail dans le document de l'architecture CPIF 
...
[Niveau global du web à charge équilibrée (pdf)](https://gallery.technet.microsoft.com/Cloud-Platform-Integration-2c3c663a) 
