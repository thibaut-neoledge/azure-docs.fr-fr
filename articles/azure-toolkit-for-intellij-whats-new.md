<properties
	pageTitle="Nouveautés du kit de ressources Azure pour IntelliJ | Microsoft Azure"
...
## Versions du kit de ressources Azure pour IntelliJ
...
* **Intégration d’outils HDInsight**. Les outils HDInsight d’Azure sont désormais fournis avec le kit de ressources Azure pour IntelliJ. Pour en savoir plus, consultez [Plug-in Outils HDInsight pour IntelliJ].
...
[Plug-in Outils HDInsight pour IntelliJ]: ./hdinsight/hdinsight-apache-spark-eclipse-tool-plugin.md
