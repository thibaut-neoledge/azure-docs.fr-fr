...
---
# <a name="new-schema-version-2016-06-01"></a>Nouvelle version de schéma 2016-06-01
...
## <a name="2-conditions-and-loops-changes"></a>2. Modifications des conditions et boucles
Dans les versions précédentes du schéma, les conditions et les boucles étaient des paramètres associés à une seule action.  Cette limitation a été levée dans ce schéma et, à présent, les conditions et les boucles s’affichent en tant que type d’action.  [Cet article](../logic-apps/logic-apps-loops-and-scopes.md)propose plus d’informations et un exemple simple d’une action de condition est indiqué ci-dessous :
...
## <a name="upgrading-to-2016-06-01-schema"></a>Mise à niveau vers le schéma 2016-06-01
La mise à niveau vers le nouveau schéma 2016-06-01 se déroule en quelques étapes seulement.  Des détails sur les modifications du schéma sont disponibles [dans cet article](../logic-apps/logic-apps-schema-2016-04-01.md).  Le processus de mise à niveau implique l’exécution du script de mise à niveau, l’enregistrement en tant que nouvelle application logique et, éventuellement, le remplacement de l’ancienne application logique, si nécessaire.
...
### <a name="manual-trigger-renamed-to-request-trigger"></a>Déclencheur manuel renommé déclencheur à la demande
...
### <a name="foreach-and-until-action-restrictions"></a>Restrictions d’action ForEach et Until
...
* [Utilisation de la définition de flux de travail d’application logique](../logic-apps/logic-apps-author-definitions.md)
