---
title: "Scénario d’application logique : créer un déclencheur Service Bus d’Azure Functions | Microsoft Docs"
...
---
# <a name="logic-app-scenario-create-an-azure-service-bus-trigger-by-using-azure-functions"></a>Scénario d’application logique : créer un déclencheur Azure Service Bus à l’aide d’Azure Functions
...
1. Créez une application logique puis sélectionnez le déclencheur **Manual - When an HTTP Request is Received** (Manuel - À réception d’une requête HTTP).  
