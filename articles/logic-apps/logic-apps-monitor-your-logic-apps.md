...
![Vue d'ensemble](media/logic-apps-monitor-your-logic-apps/overview.png)
...
> [!NOTE]
> Tous les détails et les événements d’exécution sont chiffrés au repos dans le service Logic App. Ils sont uniquement déchiffrés lorsqu’un utilisateur souhaite les consulter. L'accès à ces événements peut également être contrôlé par le contrôle d'accès en fonction du rôle (RBAC) Azure.
> 
> 
...
![Exécution et actions](media/logic-apps-monitor-your-logic-apps/monitor-view.png)
...
2. Cliquez pour configurer les **Paramètres de diagnostic**
3. Configurez un Event Hub ou un compte de stockage vers lequel émettre des données.
...
![Métriques d’alerte Azure](media/logic-apps-monitor-your-logic-apps/alerts.png)
