---
title: "Recommandations en matière de cache | Microsoft Docs"
...
> [!NOTE]
> N'utilisez pas le fournisseur d'état de session pour le Cache Redis Azure pour les applications ASP.NET qui s'exécutent en dehors de l'environnement Microsoft Azure. La latence de l’accès au cache depuis l’extérieur d'Azure peut éliminer les avantages en matière de performances de la mise en cache de données.
> 
> 
...
> *Conseil :* vous pouvez supprimer manuellement un élément du cache à l’aide de la commande DEL, disponible via la bibliothèque StackExchange en tant que méthode`IDatabase.KeyDeleteAsync`.
> 
> 
