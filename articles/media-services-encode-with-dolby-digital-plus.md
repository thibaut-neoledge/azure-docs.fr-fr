...
Cette présélection XML doit être transmise à l'**Encodeur multimédia Azure** pour créer un travail d'encodage comme décrit dans [cette](../media-services-dotnet-encode-asset) rubrique (plutôt qu'une chaîne de présélection prédéfinie, vous transmettrez la présélection XML entière, comme décrit [ici](#configure_preset)).
...
- 8 fichiers MP4 vidéo uniquement
	...
	- Vidéo 1080p @ 4700 Kbits/s
	- Vidéo 720p @ 3 400 Kbits/s
	- Vidéo 960 x 540 @ 2 250 Kbits/s
	- Vidéo 960 x 540 @ 1500 Kbits/s
	- Vidéo 640 x 380 @ 1000 Kbits/s
