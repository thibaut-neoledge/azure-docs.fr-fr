---
title: "Création d’une zone DNS à l’aide d’Azure CLI 1.0 | Microsoft Docs"
description: "Apprenez à créer des zones DNS dans Azure DNS. Il s’agit d’un guide pas à pas pour la création et la gestion de votre première zone DNS à l’aide d’Azure CLI 1.0."
services: dns
...
# <a name="create-an-azure-dns-zone-using-azure-cli-10"></a>Création d’une zone Azure DNS à l’aide d’Azure CLI 1.0
