...
Azure DNS utilise Azure Resource Manager (ARM). Suivez ces instructions pour Azure PowerShell 1.0.0 et les versions ultérieures. Pour plus d’informations, voir l’article [Utilisation d’Azure Powershell avec Azure Resource Manager](../powershell-azure-resource-manager.md).
