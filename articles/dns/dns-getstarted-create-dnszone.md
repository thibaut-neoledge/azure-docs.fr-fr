...
Azure DNS utilise Azure Resource Manager (ARM). Suivez ces instructions pour Azure PowerShell 1.0.0 et les versions ultérieures. Pour plus d’informations, consultez la page [Utilisation de Windows PowerShell avec Resource Manager](powershell-azure-resource-manager.md).<BR><BR>
