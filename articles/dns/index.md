...
---
# <a name="dns-documentation"></a>Documentation DNS

Apprenez à gérer vos enregistrements DNS à l’aide du service d’hébergement DNS Azure. Des didacticiels, références d’API et autres documents vous montrent comment configurer et gérer des zones DNS et des enregistrements de noms de domaine.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>En savoir plus sur Azure DNS</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prise en main d’Azure DNS à l’aide du Portail Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prise en main d’Azure DNS à l’aide d’Azure PowerShell</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prise en main d’Azure DNS à l’aide de l’interface de ligne de commande Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardPadding">
            <div class="card">
                <div class="cardText">
                    ...
                    <p><a href="/cli/azure/network/dns">Interface de ligne de commande Azure</a></p>
                </div>
            </div>
        </div>
    </div>
