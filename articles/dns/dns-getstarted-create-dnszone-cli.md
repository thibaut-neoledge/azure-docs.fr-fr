...
### <a name="2-switch-cli-mode"></a>2. Passage en mode CLI
...
### <a name="3-sign-in-to-your-azure-account"></a>3. Connexion à votre compte Azure
...
### <a name="4-select-the-subscription"></a>4. Sélection de l’abonnement
...
### <a name="6-register"></a>6. S’inscrire
...
### <a name="to-create-a-dns-zone-and-tags"></a>Création d’une zone DNS et de balises
...
*Syntaxe : network dns record-set show <groupe_ressources> <nom_zone_dns><name> <type>*
...
Dans l’exemple ci-dessous, si vous exécutez la commande avec le groupe de ressources *myresourcegroup*, le nom du jeu d’enregistrements *"@"* (pour un enregistrement racine) et au type *SOA*, vous obtenez la sortie suivante :
    ...
    data:                                    :
<BR>
 Pour afficher les enregistrements NS créés avec la zone, utilisez la commande suivante :
