...
Dans l'exemple ci-dessus, la zone est spécifiée à l'aide d'un objet de la zone, tel que retourné par Get-AzureRmDnsZone ou New-AzureRmDnsZone Autrement, vous pouvez également spécifier la zone suivant le nom de zone et le nom de groupe de ressources :
...
Comme avec New-AzureRmDnsRecordSet, le nom de l'enregistrement doit être un nom relatif, c'est-à-dire qu'il doit être différent du nom de la zone. La zone peut être spécifiée à l'aide d'un objet de zone (comme indiqué ci-dessus) ou par nom de zone et le nom de groupe de ressources :
