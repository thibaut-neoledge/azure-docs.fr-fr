...
- Nom ou prénom incorrects.
- Numéro de téléphone non valide.
- Adresse non valide.
- Utilisation de caractères non standard.

Suggestions
- Entrez vos informations avec exactitude pour vous inscrire correctement.

## Je ne reçois de message texte ou d’appel pour la vérification du compte lors de la tentative d’inscription.
...
- MPN
  - Accédez au [portail MPN](https://mspartner.microsoft.com/en/us/Pages/Locale.aspx), puis vérifiez l’état de votre éligibilité Vous pouvez bénéficier d’avantages supplémentaires si vous disposez des [compétences en matière de plateforme cloud](https://mspartner.microsoft.com/en/us/pages/membership/cloud-platform-competency.aspx) appropriées.
