...
## [Sans serveur](https://docs.microsoft.com/azure/azure-functions/functions-create-first-azure-function)
## Microservices
...
## [Créer une fonction connectée à Azure](https://docs.microsoft.com/azure/azure-functions/functions-create-an-azure-connected-function)
...
### [Modèles et scénarios de microservices](https://docs.microsoft.com/azure/service-fabric/service-fabric-patterns-and-scenarios)
## Développement
### [Machine virtuelle Linux](https://docs.microsoft.com/azure/virtual-machines/linux/create-ssh-secured-vm-from-template)
### [Machine virtuelle Windows](https://docs.microsoft.com/azure/virtual-machines/windows/ps-template)
...
## Stocker des données
### [Objets blob](https://docs.microsoft.com/azure/storage/blobs/storage-dotnet-how-to-use-blobs)
### [Partages de fichiers](https://docs.microsoft.com/azure/storage/files/storage-dotnet-how-to-use-files)
### [Paires clé-valeur](https://docs.microsoft.com/azure/cosmos-db/table-storage-how-to-use-dotnet)
### [Documents JSON](https://docs.microsoft.com/azure/cosmos-db/documentdb-get-started)
### [Tables relationnelles](https://docs.microsoft.com/azure/sql-database/sql-database-get-started)
...
# Ressources
## [Limites et quotas Azure](../../azure-subscription-service-limits.md)
