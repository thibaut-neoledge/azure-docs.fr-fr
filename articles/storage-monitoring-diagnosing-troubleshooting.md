<properties 
	pageTitle="Analyse, diagnostic et résolution des problèmes de stockage | Azure" 
...
Pour obtenir un guide pratique de bout en bout pour la résolution des problèmes dans les applications Azure Storage, consultez [Dépannage de bout en bout à l'aide des mesures Azure Storage et de la journalisation, AzCopy et l'analyseur de message](../articles/storage-e2e-troubleshooting/).
...
> [AZURE.NOTE] Plusieurs demandes peuvent partager le même ID de demande client, car le client peut affecter cette valeur (même si la bibliothèque cliente de stockage affecte une 
...
Pour plus d'informations sur l'utilisation de Wireshark pour résoudre les problèmes de réseau, consultez la section [" Annexe 2 : utilisation de Wireshark pour capturer le trafic réseau] ".
...
<table>
 ...
 <tr>
    ...
    <td>3</td>
    <td>85d077ab -...</td>
    <td>Démarrage d'une demande synchrone vershttps://domemaildist.blob.core.windows.netazure<br>imblobcontainer/blobCreatedViaSAS.txt?
...
<table>
  ...
  <tr>
    <td>07b26a5d-...</td>
    <td>
    Méthode <b>DeleteIfExists</b> pour supprimer le conteneur de l'objet blob. Notez que cette opération inclut une requête 
    <b>HEAD</b> afin de vérifier l'existence du conteneur.</td>
  </tr>
  <tr>
    <td>e2d06d78...</td>
    <td>
    Méthode <b>CreateIfNotExists</b> pour créer le conteneur de l'objet blob. Notez que cette opération inclut une requête 
    <b>HEAD</b> qui vérifie l'existence du conteneur. La requête 
    <b>HEAD</b> renvoie un message 404, mais continue.</td>
  </tr>
  <tr>
    <td>de8b1c3c-...</td>
    <td>
    Méthode <b>UploadFromStream</b> pour créer l'objet blob. La requête 
    <b>PUT</b> échoue avec un message 404</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td>07b26a5d-...</td>
    <td> Démarrage d'une requête synchrone vers https://domemaildist.blob.core.windows.net/azuremmblobcontainer.</td>
  </tr>
  <tr>
    <td>07b26a5d-...</td>
  ...
  <tr>
    <td>07b26a5d-...</td>
    <td> Réponse reçue. Code d'état = 200, ID de demande = eeead849 -...Content-MD5 = , ETag =
  ...
  <tr>
    <td>e2d06d78-...</td>
    <td> Démarrage d'une requête asynchrone vers https://domemaildist.blob.core.windows.net/azuremmblobcontainer.</td>
  </tr>
  <tr>
    <td>e2d06d78-...</td>
  ...
  <tr>
    <td>de8b1c3c-...</td>
    <td> Démarrage d'une requête synchrone vers https://domemaildist.blob.core.windows.net/azuremmblobcontainer/blobCreated.txt.</td>
  </tr>
  <tr>
    <td>de8b1c3c-...</td>
    <td> StringToSign =
...
<table>
  ...
  <tr>
    <td>En-tête d'ID de la demande</td>
...
- Consultez vos métriques afin d'identifier tout changement par rapport au comportement de base normal. Sur la base des métriques, vous pouvez déterminer si le problème est provisoire ou permanent, ainsi que les opérations de stockage affectées par le problème.
...
Pour plus d'informations sur l'utilisation de Fiddler, consultez la section " [Annexe 1 : utilisation de Fiddler pour capturer le trafic HTTP et HTTPS] ".

Pour plus d'informations sur l'utilisation de Wireshark, consultez la section " [Annexe 2 : utilisation de Wireshark pour capturer le trafic réseau] ".

Pour plus d'informations sur l'utilisation de l'analyseur de message Microsoft, consultez la section " [Annexe 3 : utilisation de l'analyseur de message Microsoft pour capturer le trafic réseau] ".
