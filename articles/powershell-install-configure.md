...
Si vous avez installé Azure PowerShell par le biais de PowerShell Gallery, mais que vous souhaitez utiliser l’installation WebPI, cette dernière supprime automatiquement les applets de commande installées à partir de la galerie.
