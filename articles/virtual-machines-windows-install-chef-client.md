<properties pageTitle="À propos des machines virtuelles Chef et Azure" description="Explique l'installation et la configuration de Chef sur une machine virtuelle dans Azure" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
...
Chef est un système client-serveur. Pour découvrir les options d'utilisation d'un serveur Chef, consultez la page [Choisir votre installation](http://www.getchef.com/chef/choose-your-version/). Vous aurez besoin des informations relatives au serveur Chef pour configurer le client. 

Pour installer le client Chef sur une machine virtuelle Azure, vous disposez des options suivantes :

- Utilisez le portail de gestion Azure pour installer le client Chef lorsque vous créez une machine virtuelle exécutant Windows Server 2012 ou Windows Server 2012 R2. Pour obtenir des instructions, consultez [Microsoft Azure Portal](https://docs.chef.io/azure_portal.html).
