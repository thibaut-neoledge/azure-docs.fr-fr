...
- **conteneur** :
    ...
    - **name** : obligatoire. Spécifiez la collection DocumentDB à indexer. 
...
<table style="font-size:12">
    ...
    <tr>
        <td>Tableaux de primitives, par exemple, [ " a ", " b ", " c "]</td>
...
##<a name="GetIndexerStatus"></a>Étape 5 : Obtention de l'état de l'indexeur
