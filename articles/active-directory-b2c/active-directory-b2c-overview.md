<properties
	pageTitle="Azure Active Directory B2C : vue d’ensemble | Microsoft Azure"
...
# Azure Active Directory B2C : inscription et connexion de consommateurs à vos applications
...
Nous vous encourageons à activer les notifications d’incidents de sécurité en accédant à [cette page](https://technet.microsoft.com/security/dd252948) et en vous abonnant aux alertes d’avis de sécurité.
