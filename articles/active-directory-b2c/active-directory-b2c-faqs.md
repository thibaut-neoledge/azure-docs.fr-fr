...
Cette page répond aux questions fréquemment posées sur la version préliminaire d’Azure Active Directory (Azure AD) B2C. N'hésitez pas à la consulter pour vous tenir au courant des mises à jour.
...
La stratégie de mot de passe Azure AD B2C pour les comptes locaux est basée sur la stratégie pour Azure AD. Azure Active Directory B2C utilise la force du mot d’un passe « fort » et les mots de passe n’expirent jamais. Pour plus d’informations, consultez [Stratégie de mot de passe Azure AD](https://msdn.microsoft.com/library/azure/jj943764.aspx)
...
Consultez [Dépôt de demandes de support pour Azure Active Directory B2C](active-directory-b2c-support.md).
