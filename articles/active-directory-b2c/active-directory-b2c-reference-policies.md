...
7. Cliquez sur **Create**. Notez que la stratégie créée s’affiche sous la forme « **B2C\_1\_SiIn** » (le fragment **B2C\_1\_** est automatiquement ajouté) dans le panneau **Stratégies de connexion**.
...
8. Cliquez sur **Create**. Notez que la stratégie créée s’affiche sous la forme « **B2C\_1\_SiPe** » (le fragment **B2C\_1\_** est automatiquement ajouté en préfixe) dans le panneau **Stratégies de modification du profil**.
