...
# Azure AD B2C : création d’une application de bureau Windows
...
### Installation de la bibliothèque MSAL
...
### Création de la PublicClientApplication
...
### Vérification des jetons sur le démarrage de l’application
