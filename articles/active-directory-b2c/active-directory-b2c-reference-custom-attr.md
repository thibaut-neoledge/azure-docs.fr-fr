<properties
	pageTitle="Azure Active Directory B2C : attributs personnalisés | Microsoft Azure"
...
#  Azure Active Directory B2C : utilisation d’attributs personnalisés pour recueillir des informations sur vos consommateurs
