...
Pour utiliser un compte Microsoft en tant que fournisseur d’identité dans Azure Active Directory (AD) B2C, vous devez commencer par créer une application de compte Microsoft et lui fournir les paramètres appropriés. Pour ce faire, vous avez besoin d’un compte Microsoft. Si vous n’en avez pas, vous pouvez en obtenir un via le site [http://www.live.com/](https://www.live.com/).
...
2. Cliquez sur **Créer une application**.
    ...
    ![MSA - ajout de nouvelle application](./media/active-directory-b2c-setup-msa-app/msa-add-new-app.png)

3. Saisissez un **Nom d’application** puis cliquez sur **J’accepte**). Remarque : cela exige que vous acceptiez les conditions d’utilisation des services Microsoft.

    ![MSA - Nom de l’application](./media/active-directory-b2c-setup-msa-app/msa-app-name.png)

4. Cliquez sur **Paramètres d’API** dans la barre de navigation à gauche. Entrez une valeur **Contact Email** valide.

    ![MSA - Paramètres API](./media/active-directory-b2c-setup-msa-app/msa-api-settings.png)

5. Saisissez `https://login.microsoftonline.com/te/{tenant}/oauth2/authresp` dans le champ **URL de redirection**, où **{client}** est remplacé par le nom de votre client (par exemple, contosob2c.onmicrosoft.com). Cliquez sur **Enregistrer** au bas de la page.
...
1. [Accédez au panneau des fonctionnalités B2C sur le portail Azure](active-directory-b2c-app-registration.md#navigate-to-the-b2c-features-blade).
