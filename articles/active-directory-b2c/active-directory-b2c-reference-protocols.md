<properties
	...
	description="Création d’applications directement à l’aide des protocoles pris en charge par la version préliminaire d’Azure Active Directory B2C."
...
# Version préliminaire d’Azure AD B2C : protocoles d’authentification
...
- un **URI de redirection** ou un **identificateur de package** pouvant être utilisé pour rediriger des réponses vers votre application ;
...
- Génération de démons et de processus côté serveur avec le flux d’informations d’identification de client OAuth 2.0 (prochainement)
