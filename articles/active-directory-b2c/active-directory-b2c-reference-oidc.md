...
| p | required | Indique la stratégie à exécuter. Il s’agit du nom d’une stratégie créée dans votre client B2C, dont la valeur doit commencer par « b2c\_1\_ ». En savoir plus sur les stratégies [ici](active-directory-b2c-reference-policies.md). |
