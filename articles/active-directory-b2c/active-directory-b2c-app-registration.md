...
### 1\. Accès direct via le portail Azure
...
Vous pouvez également accéder au panneau en cliquant sur **Parcourir** puis **Azure AD B2C** dans la barre de navigation à gauche du [portail Azure](https://portal.azure.com/).
...
1. Dans le panneau de fonctionnalités B2C sur le portail Azure Classic, cliquez sur **Applications**.
