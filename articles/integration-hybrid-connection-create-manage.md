...
1.  [Création d'une connexion hybride][Création d'une connexion hybride] avec spécification du nom d'hôte ou de l'adresse IP de la ressource locale dans votre réseau privé.

2.  [Liaison de votre site web Azure ou votre service mobile Azure][Liaison de votre site web Azure ou votre service mobile Azure] à la connexion hybride.

3.  [Installation du Gestionnaire de connexions hybrides][Installation du Gestionnaire de connexions hybrides] sur votre ressource locale et connexion à la connexion hybride spécifique. Le portail Azure offre des possibilités d'installation et de connexion en un seul clic.

4.  [Gestion des connexion hybrides][Gestion des connexion hybrides] et de leurs clés de connexion.
...
**Pour créer des connexions hybrides avec Sites Web**, consultez la page [Connexion d'un site web Azure à une ressource locale][Connexion d'un site web Azure à une ressource locale].
...
2.  Dans le volet de navigation sur la gauche, sélectionnez **BizTalk Services**, puis sélectionnez votre service BizTalk.
    Si vous ne disposez pas d'un service BizTalk existant, vous pouvez [en créer un][en créer un].
...
<tr>
   <td><strong>Nom</strong></td>
    <td>Le nom de la connexion hybride doit &ecirc;tre unique et ne doit pas &ecirc;tre le m&ecirc;me que celui du service BizTalk. Vous pouvez entrer n'importe quel nom, mais soyez pr&eacute;cis quant &agrave; son objet. Voici quelques exemples&nbsp;:<br/><br/>
    FichePaie<em>SQLServer</em><br/>
    ListeFournitures<em>SharepointServer</em><br/>
    Clients<em>OracleServer</em>
    </td>
</tr>
<tr>
    <td><strong>Nom d'h&ocirc;te</strong></td>
    <td>Entrez le nom d'h&ocirc;te complet, uniquement le nom d'h&ocirc;te ou l'adresse IPv4 de la ressource locale. En voici quelques exemples&nbsp;:
    <br/><br/>
<em>monSQLServer</em>
<br/>
<em>monSQLServer</em>.<em>Domaine</em>.corp.<em>votreSoci&eacute;t&eacute;</em>.com
<br/>
<em>monHTTPSharePointServer</em>
<br/>
<em>monHTTPSharePointServer</em>.<em>votreSoci&eacute;t&eacute;</em>.com
<br/>
10.100.10.10
   </td>
</tr>
<tr>
    ...
    <td>Entrez le num&eacute;ro de port de la ressource locale. Par exemple, si vous utilisez un site web, entrez le port&nbsp;80 ou le port&nbsp;443. Si vous utilisez SQL Server, entrez le port&nbsp;1433.</td>
</tr>
</table>
...
-   Il est possible de créer plusieurs connexions hybrides. Pour connaître le nombre de connexions autorisées, consultez la page [BizTalk Services : tableau comparatif des éditions][BizTalk Services : tableau comparatif des éditions].
...
Pour lier le site web Azure à une connexion hybride existante, sélectionnez **utiliser une connexion hybride existante** dans le volet Connexions hybrides. Consultez la page [Connexion d'un site web Azure à une ressource locale][Connexion d'un site web Azure à une ressource locale].

Pour lier le service mobile Azure à une connexion hybride existante, sélectionnez **ajouter une connexion hybride** lors de la modification ou de la création d'un service mobile. Consultez la page [Azure Mobile Services et connexions hybrides][Azure Mobile Services et connexions hybrides].
...
-   Le Gestionnaire de connexions hybrides doit utiliser une chaîne de connexion locale valide pour l'autorisation. Le site web Azure ou le service mobile doit utiliser une chaîne de connexion d'application valide pour l'autorisation.
...
-   utiliser les [API REST][API REST].
...
3.  Sélectionnez l'onglet **Connexions hybrides** :
    ![Hybrid Connections Tab][Hybrid Connections Tab]
4.  Sélectionnez la connexion hybride. Dans la barre des tâches, sélectionnez **Gérer les connexions** :
    ![Manage Options][Manage Options]
    L'option **Gérer les connexions** répertorie les chaînes de connexion d'application et locales. Vous pouvez copier les chaînes de connexion ou régénérer la clé d'accès employée dans la chaîne de connexion.
    **Si vous sélectionnez Régénérer**, la clé d'accès partagé utilisée avec la chaîne de connexion est modifiée. Procédez comme suit :

5.   Dans le portail de gestion Azure, sélectionnez **Clés de synchronisation** dans l'application Azure.
6.   Réexécutez l'**Installation locale**. Lorsque vous réexécutez l'installation locale, la ressource locale est automatiquement configurée pour utiliser la chaîne de connexion principale mise à jour.
...
-   [Aperçu des connexions hybrides][Aperçu des connexions hybrides]

## Voir aussi

-   [API REST pour gérer BizTalk Services sur Microsoft Azure][API REST]
...
-   [BizTalk Services : Tableau de bord, Surveiller et Mettre à l'échelle dans BizTalk Services][BizTalk Services : Tableau de bord, Surveiller et Mettre à l'échelle dans BizTalk Services]
  ...
  [Création d'une connexion hybride]: #CreateHybridConnection
  [Liaison de votre site web Azure ou votre service mobile Azure]: #LinkWebSite
  [Installation du Gestionnaire de connexions hybrides]: #InstallHCM
  [Gestion des connexion hybrides]: #ManageHybridConnection
  ...
  [en créer un]: http://go.microsoft.com/fwlink/p/?LinkID=329870
