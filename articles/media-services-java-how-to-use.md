<properties urlDisplayName="Media Services" pageTitle="Utilisation de Media Services (Java) - Guide des fonctionnalit&eacute;s Azure" metaKeywords="Azure Media Services, Azure media, Azure streaming, azure media, azure streaming, azure encoding" description="Explique comment utiliser Azure Media Services pour ex&eacute;cuter les t&acirc;ches courantes, notamment l'encodage, le chiffrement et la diffusion en continu des ressources." metaCanonical="" services="media-services" documentationCenter="Java" title="Utilisation de Media Services" authors="robmcm" solutions="" manager="wpickett" editor="mollybos" scriptId="" videoId="" />
