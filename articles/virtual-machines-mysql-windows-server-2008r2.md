<properties urlDisplayName="Install MySQL" pageTitle="Cr&eacute;ation d'une machine virtuelle ex&eacute;cutant&nbsp;MySQL dans&nbsp;Azure " metaKeywords="Azure virtual machines, Azure Windows Server, Azure installing MySQL, Azure configuring MySQL, Azure databases" description="Cr&eacute;ation d'une machine virtuelle&nbsp;Azure ex&eacute;cutant&nbsp;Windows&nbsp;Server&nbsp;2008&nbsp;R2&nbsp;; installation et configuration d'une base de donn&eacute;es&nbsp;MySQL sur cette machine virtuelle" metaCanonical="" services="virtual-machines" documentationCenter="" title="Installation de MySQL sur une machine virtuelle ex&eacute;cutant Windows Server&nbsp;2008&nbsp;R2 sur Azure" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
3.  Accédez à la page [Téléchargement de MySQL Community Server][Téléchargement de MySQL Community Server].
...
30. Après l'installation de MySQL, vous devez configurer un point de terminaison pour que MySQL soit accessible à distance. Connectez-vous au [portail de gestion Azure][portail de gestion Azure]. Dans le portail Azure, cliquez sur **Machines virtuelles**, puis sur le nom de votre nouvelle machine virtuelle, sur **Points de terminaison**, puis sur **Ajouter un point de terminaison**.
