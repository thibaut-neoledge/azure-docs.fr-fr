...
Ce didacticiel explique comment héberger un site Web Django dans Azure à l'aide d'une machine virtuelle Windows Server. Ce didacticiel part du principe que vous n'avez pas d'expérience en tant qu'utilisateur d'Azure. À la fin de ce guide, vous disposerez d'une application Django fonctionnelle dans le cloud.
...
1.  Suivez les instructions disponibles [ici](/en-us/manage/windows/tutorials/virtual-machine-from-gallery/) pour créer une machine virtuelle Azure de distribution *Windows Server 2012 Datacenter*.
...
2.  Indiquez à Azure d'acheminer le trafic du port **80** du Web vers le port **80** de la machine virtuelle :
    ...
    -   Cliquez sur le bouton *AJOUTER UN POINT DE TERMINAISON* en bas de l'écran. 
...
Pour plus d'informations sur la configuration des environnements Python et Django, consultez le [Guide d'installation](../python-how-to-install/).
...
7.  Téléchargez le fichier wfastcgi.py depuis [codeplex](http://go.microsoft.com/fwlink/?LinkID=316392&clcid=0x409) et enregistrez-le sous C:\\Python27\\Scripts. Il s'agit de l'emplacement des commandes précédemment utilisées pour enregistrer le gestionnaire FastCGI. Vous pouvez également l'installer via Web Platform Installer. Recherchez « WFastCGI ».
