<properties urlDisplayName="Get Started with Mobile Analytics" pageTitle="Prise en main de Mobile Analytics | Centre de d&eacute;veloppement mobile" metaKeywords="" description="Prenez en main Mobile Analytics." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Prise en main de Mobile Analytics" authors="mahender" manager="kirillg"/>
...
Dans ce didacticiel, vous allez ajouter des capacités analytiques à votre application avec [Capptain][Capptain]. Mobile Analytics vous permet de déterminer comment les utilisateurs interagissent avec votre application et quelles sont les sections qui génèrent le plus d'activité. Pour commencer à obtenir ces données, vous allez associer à votre application le Kit de développement logiciel (SDK) Capptain.
...
1.  [Initialisation du Kit de développement logiciel (SDK) Capptain][Initialisation du Kit de développement logiciel (SDK) Capptain]
2.  [Surcharge d'UIViewController][Surcharge d'UIViewController]

Ce didacticiel requiert les éléments suivants :

-   un compte [Capptain][Capptain] ;
-   une application [Mobile Services niveau Standard][Mobile Services niveau Standard].
