...
Si vous ne l'avez pas encore fait, ajoutez [Application Insights à votre projet d’application][platforms] et publiez-le de nouveau.
...
![À partir du graphique d’incidents, cliquez sur Règles d'alerte, puis sur Ajouter une alerte](./media/app-insights-crashes/appinsights-d023-alert.png)
