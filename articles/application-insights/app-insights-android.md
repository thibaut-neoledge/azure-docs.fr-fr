...
Pour une analyse de l’utilisation, utilisez le [Kit de développement logiciel (SDK) Application Insights pour Android](https://github.com/Microsoft/ApplicationInsights-Android). Si votre application dispose d’un côté serveur, vous pouvez envoyer les données client et serveur à la même ressource Application Insights.
