...
Il existe un [Kit de développement logiciel (SDK) Application Insights pour iOS](https://github.com/Microsoft/ApplicationInsights-iOS) qui n’est plus pris en charge.
