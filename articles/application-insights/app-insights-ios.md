<properties
    pageTitle="Analyse des applications iOS"
...
* [HockeyApp pour iOS](http://support.hockeyapp.net/kb/client-integration-ios-mac-os-x-tvos/hockeyapp-for-ios)
...
> [AZURE.NOTE] Vous pourrez bientôt utiliser [Application Insights – Analyses](app-insights-analytics.md) et [l’exportation continue](app-insights-export-telemetry.md) avec les données de télémétrie envoyées depuis le Kit de développement logiciel (SDK) HockeyApp.
>
> [En savoir plus sur cette modification.](https://azure.microsoft.com/blog/update-on-transitioning-mobile-apps-from-application-insights-to-hockeyapp/)
