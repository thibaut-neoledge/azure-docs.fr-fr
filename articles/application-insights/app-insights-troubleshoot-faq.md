...
Les pages d'aide que vous voyez font référence à [Application Insights pour la version préliminaire de Microsoft Azure][start], qui est déjà activée dans Visual Studio 2013 Update 3 et version ultérieure.
