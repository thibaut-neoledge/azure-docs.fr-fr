---
title: Analyse de l'utilisation avec Application Insights
...
Pour commencer, créez un compte gratuit [Microsoft Azure](https://azure.com). À l’issue de la période d’essai, vous pouvez poursuivre avec le niveau Gratuit du service.
