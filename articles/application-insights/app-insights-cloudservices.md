---
title: Application Insights pour Azure Cloud Services
...
Il est généralement [préférable de créer une ressource distincte pour les données à partir de chaque rôle Web et de travail](app-insights-separate-resources.md).
...
1. Définissez le fichier ApplicationInsights.config pour que celui-ci soit toujours copié dans le répertoire de sortie.
...
2. Sélectionnez la même ressource Application Insights que pour votre autre télémétrie.
