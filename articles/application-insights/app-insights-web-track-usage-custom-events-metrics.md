...
![Accédez aux ressources de votre application dans portal.azure.com](./media/app-insights-web-track-usage-custom-events-metrics/01-custom.png)
...
![Définissez le groupe, puis sélectionnez la propriété sous Grouper par](./media/app-insights-web-track-usage-custom-events-metrics/04-segment-metric-event.png)
...
![Ajouter un nouveau graphique ou sélectionnez un graphique et sélectionnez votre métrique sous Personnalisé](./media/app-insights-web-track-usage-custom-events-metrics/03-track-custom.png)
...
## <a name="default-properties"></a>Définir les propriétés par défaut pour toute la télémétrie
...
Une utilisation typique consiste à identifier la télémétrie provenant de différentes versions ou de différents composants de votre application. Dans le portail, vous pouvez filtrer ou regrouper des résultats suivant cette propriété.
