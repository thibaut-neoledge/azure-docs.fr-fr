---
title: Surveiller votre application Node.js avec Azure Application Insights | Microsoft Docs
...
Vérifiez que [les ports de pare-feu nécessaires sont ouverts](app-insights-ip-addresses.md).
