<properties 
    pageTitle="Analytics pour les applications C++ Windows Store" 
    description="Analysez l’utilisation et les performances de votre application C++ Windows Store." 
...
# Analytics pour les applications C++ Windows Store
...
> [AZURE.NOTE] Le 15 juin 2016, nous arrêterons d’afficher des données correspondant aux applications iOS, Android, Windows Store et Windows Phone dans Application Insights.
