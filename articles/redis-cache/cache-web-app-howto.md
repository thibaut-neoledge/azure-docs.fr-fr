...
3. Faites défiler le fichier **Index.cshtml`tr` vers le bas pour visualiser la fin du fichier, puis ajoutez l’élément ** suivant, de sorte qu’il représente la dernière ligne de la dernière table du fichier.
