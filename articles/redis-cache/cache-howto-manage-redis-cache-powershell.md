...
- [Utilisation de groupes de ressources pour gérer vos ressources Azure](../azure-portal/resource-group-portal) : découvrez comment créer et gérer des groupes de ressources dans le portail de gestion Azure.
