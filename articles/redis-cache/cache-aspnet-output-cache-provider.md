...
---
# <a name="asp.net-output-cache-provider-for-azure-redis-cache"></a>Fournisseur de caches de sortie ASP.NET pour le Cache Redis Azure
...
## <a name="store-asp.net-page-output-in-the-cache"></a>Stockage de la sortie de pages ASP.NET dans le cache
