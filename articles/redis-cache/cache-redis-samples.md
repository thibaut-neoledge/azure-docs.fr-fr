...
L’exemple [How to use Azure Redis Cache with Node.js](cache-nodejs-get-started.md) montre comment utiliser le cache Redis Azure avec Node.js et le client [node\_redis](https://github.com/mranney/node_redis).
