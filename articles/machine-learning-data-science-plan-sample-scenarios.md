<properties
	pageTitle="Procédures pas à pas du processus de science des données cloud | Azure" 
	description="Procédures pas à pas du processus de science des données cloud" 
	metaKeywords="" 
...
# Processus de science des données cloud dans Azure Machine Learning

Cet article vous présente le mappage du processus de science des données cloud et quelques scénarios sources et cibles d’exemples de données. Il illustre certaines des options et des séquences de traitement basées sur les caractéristiques des données, l’emplacement source et les référentiels cibles dans Azure. Le flux du processus de science des données cloud pour les exemples de scénarios est résumé dans la dernière section.

[AZURE.INCLUDE [machine-learning-free-trial](../includes/machine-learning-free-trial.md)]

**Pour tous les scénarios, vous devez :**
...
- [Scénario n°1 : jeu de données tabulaires petit à moyen dans des fichiers locaux](#smalllocal)
- [Scénario n°2 : jeu de données petit à moyen dans des fichiers locaux, nécessitant un traitement](#smalllocalprocess)
- [Scénario n°3 : jeu de données volumineux dans des fichiers locaux, ciblant des objets blob Azure](#largelocal)
