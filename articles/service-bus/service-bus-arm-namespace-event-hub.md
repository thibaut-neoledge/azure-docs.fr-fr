<properties
    pageTitle="Créer un espace de noms Service Bus avec un concentrateur d'événements et un groupe de consommateurs | Microsoft Azure"
    description="Créer un espace de noms Service Bus avec un concentrateur d'événements et un groupe de consommateurs à l’aide d’un modèle ARM"
...
# Créer un espace de noms Service Bus avec un concentrateur d'événements et un groupe de consommateurs à l’aide d’un modèle ARM
...
>-    [Créer un espace de noms Service Bus avec file d’attente](service-bus-arm-namespace-queue.md)
...
[![Déploiement sur Azure](./media/service-bus-arm-namespace-event-hub/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F201-servicebus-create-eventhub-and-consumergroup%2Fazuredeploy.json)
