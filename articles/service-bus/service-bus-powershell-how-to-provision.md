...
Pour approvisionner d'autres entités, telles que des files d'attente, des rubriques et des concentrateurs d'événements, utilisez l'[API .NET pour Service Bus]. Cet article traite uniquement les concentrateurs d'événements, mais les étapes à suivre pour les autres entités sont similaires. Vous trouverez également d'autres exemples détaillés, notamment pour les autres entités, à la fin de cet article.
