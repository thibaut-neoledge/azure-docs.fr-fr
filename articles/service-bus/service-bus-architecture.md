<properties 
   pageTitle="Architecture de Service Bus"
...
La section suivante décrit l'architecture de traitement de message d'Azure Service Bus.
...
Un espace de noms Service Bus est mappé à une unité d'échelle. L'unité d'échelle gère tous les types d'entités Service Bus : relais, entités de messagerie répartie (files d'attente, rubriques, abonnements) et concentrateurs de notification. Une unité d'échelle Service Bus est constituée des éléments suivants :
