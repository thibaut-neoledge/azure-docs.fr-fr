...
Cet article répond à certaines questions fréquemment posées sur la tarification de Service Bus. Vous pouvez également visiter le [Forum aux questions de Support Azure](http://go.microsoft.com/fwlink/?LinkID=185083) pour obtenir des informations de tarification générale Microsoft Azure. Pour obtenir toutes les informations sur la tarification Service Bus, voir la section [détails de tarification Service Bus](https://azure.microsoft.com/pricing/details/service-bus/).

>[AZURE.NOTE] La structure de prix des Event Hubs est décrite dans la rubrique [FAQ relative à la disponibilité et au support des Event Hubs](../event-hubs/event-hubs-availability-and-support-faq.md). D’autres informations figurent dans la rubrique [Tarification des Event Hubs](https://azure.microsoft.com/pricing/details/event-hubs/).
...
À l’instar d’autres services sur Azure, Service Bus applique un ensemble de [quotas](service-bus-quotas.md) spécifiques pour assurer une utilisation juste des ressources. Les quotas d’utilisation appliqués par le service sont les suivantes :
