...
Voir [cette rubrique](service-bus-faq.md#how-is-the-relay-hours-meter-calculated).
...
- Pour plus d’informations sur Service Bus, consultez la section [FAQ sur la tarification et la facturation de Service Bus](service-bus-faq.md#service-bus-pricing).
