...
Pour plus d'informations, consultez [AMQP de Service Bus : guide du développeur](http://msdn.microsoft.com/library/jj841071.aspx). Cette rubrique inclut une liste détaillée des API non prises en charge.
