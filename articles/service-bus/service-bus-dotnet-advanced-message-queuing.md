...
Où `[namespace]` et `[SAS key]` sont obtenues à partir du [portail Azure Classic][]. Pour plus d’informations, consultez la page [Utilisation des files d’attente Service Bus][].
