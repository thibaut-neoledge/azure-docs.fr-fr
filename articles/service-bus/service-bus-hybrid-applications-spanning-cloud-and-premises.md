<properties 
	pageTitle="Activation des applications hybrides locales et dans le cloud |Microsoft Azure" 
...
- [Messagerie par relais et répartie](service-bus-messaging-overview.md)

## Créer

- [Création d’une application hybride .NET locale/dans le cloud avec Service Bus Relay](service-bus-dotnet-hybrid-app-using-service-bus-relay.md)
- [Utilisation de Service Bus Relay (vidéo et exemple de code)](http://appfabricdemos.codeplex.com/releases/view/67597)
- [Intégration d’un site Web Azure avec une application métier via Service Bus Relay](https://code.msdn.microsoft.com/How-to-integrate-a-Windows-f1fedff8) 
