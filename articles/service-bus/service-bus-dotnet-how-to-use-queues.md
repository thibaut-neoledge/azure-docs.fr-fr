...
Le moyen conseillé de recevoir les messages d'une file d'attente est d'utiliser un objet [QueueClient][]. Les objets [QueueClient][] peuvent fonctionner dans deux modes différents : [ReceiveAndDelete et PeekLock](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.receivemode.aspx).
