...
1. Cliquez sur le nom de votre espace de noms de service dans la liste.

1. Cliquez sur **Connection Information**. Dans la boîte de dialogue **Accéder aux informations de connexion**, copiez la chaîne de connexion dans le presse-papiers.

1. Collez la chaîne de connexion dans le fichier App.config de l’exemple.
