...
[Génération d’une application multiniveau .NET avec les files d’attente Service Bus](cloud-services-dotnet-multi-tier-app-using-service-bus-queues.md)
 
## Explorer

- [Principes de base de Microsoft Azure Service Bus](fundamentals-service-bus-hybrid-solutions.md)
...
- [Meilleures pratiques pour protéger les applications Service Bus contre les pannes de Service Bus et les sinistres](http://msdn.microsoft.com/library/azure/jj554355.aspx)
- [Messagerie répartie : exemple de réponse à une demande](http://code.msdn.microsoft.com/windowsazure/Brokered-Messaging-Request-2b4ff5d8) 
- [Application multiniveau avec Azure Service Bus](cloud-services-dotnet-multi-tier-app-using-service-bus-queues.md)
