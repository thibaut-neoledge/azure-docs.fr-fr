...
## Étapes suivantes
* Pour en savoir plus sur les autres services, comme le stockage Azure, Service Bus, la base de données SQL, etc. à inclure dans vos applications Java, consultez les informations disponibles sur la page <http://azure.microsoft.com/develop/java/>.
