...
### Quelle est la différence entre la suppression d’un groupe de ressources dans le portail Azure en version préliminaire et un clic sur l’option supprimer d’une solution préconfigurée dans azureiotsuite.com ?
...
- Si vous supprimez le groupe de ressources dans le [portail Azure preview][lnk-azure-portal], vous supprimez uniquement les ressources présentes dans ce groupe de ressources. Vous devrez également supprimer l’application Azure Active Directory associée à la solution préconfigurée dans le [portail de gestion Azure][lnk-classic-portal].
