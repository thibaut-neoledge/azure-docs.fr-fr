...
# Sécurisation de l’Internet des objets de bout en bout
...
[Azure IoT Hub](../iot-hub/iot-hub-what-is-iot-hub.md), inclus dans [IoT Suite](iot-suite-what-is-azure-iot.md), offre un service entièrement géré, qui assure une communication bidirectionnelle fiable et sécurisée entre les appareils IoT et les services Azure tels qu’[Azure Machine Learning](../machine-learning/machine-learning-what-is-machine-learning.md) et [Azure Stream Analytics](../stream-analytics/stream-analytics-introduction.md), en utilisant les informations d’identification de sécurité et le contrôle d’accès pour chaque appareil.
...
![Azure IoT Suite](media/securing-iot-ground-up/securing-iot-ground-up-fig2.png)

### Approvisionnement et authentification sécurisés des appareils
...
### Traitement et stockage sécurisés dans le cloud 
