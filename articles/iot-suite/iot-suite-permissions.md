...
1. Accédez au [portail de gestion Azure][lnk-classic-portal].
...
1. Accédez au [portail de gestion Azure][lnk-classic-portal], cliquez sur **paramètres** dans la liste des services sur le côté gauche.
