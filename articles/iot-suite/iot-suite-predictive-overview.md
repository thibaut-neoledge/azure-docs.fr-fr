...
> [AZURE.NOTE] Le modèle de solution utilise les données réelles d’usure du moteur.
...
[lnk_machine_learning]: https://azure.microsoft.com/fr-FR/services/machine-learning/
