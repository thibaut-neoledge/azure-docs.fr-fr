...
## <a name="use-the-mobile-experience"></a>Profitez de l’expérience mobile
...
1. Sur votre appareil iOS, connectez-vous à [HockeyApp](https://rink.hockeyapp.net).
   Utilisez l’un des boutons de connexion Microsoft, puis connectez-vous avec le compte Microsoft que vous avez spécifié lors de la conférence. (N’utilisez pas les champs d’adresse de messagerie et de mot de passe).
