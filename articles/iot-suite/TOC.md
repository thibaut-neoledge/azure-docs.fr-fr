# Vue d'ensemble
## [Concepts d’architecture IoT](iot-suite-what-is-azure-iot.md)
## [Comparer les options d’Azure IoT](iot-suite-options.md)
## [Vue d’ensemble des solutions préconfigurées](iot-suite-what-are-preconfigured-solutions.md)
...
### Concepts
#### [Architecture de surveillance à distance](iot-suite-remote-monitoring-sample-walkthrough.md)
