...
L'interface est écrite en JavaScript et nécessite Node.js. Elle est mise en œuvre à l'aide du Kit de développement logiciel (SDK) Azure pour Node.js et publiée sous une licence Apache 2.0. Le référentiel du projet se trouve à la page [][]<https://github.com/WindowsAzure/azure-sdk-tools-xplat></a>.
...
## <span id="Configure"></span></a>Connexion à votre abonnement Azure
...
Dans la liste ci-dessus, la colonne **Current** indique l'abonnement par défaut actuel, à savoir Azure-sub-1. Pour changer l'abonnement par défaut, utilisez la commande `azure account set` et indiquez l'abonnement de votre choix. Par exemple :
...
## <span id="use"></span></a>Utilisation de l'interface de ligne de commande interplateforme Azure
...
3.  Pour arrêter le site Web, utilisez la commande suivante : Remplacez **mywebsite** par le nom du site.
...
4.  Pour démarrer le site Web, utilisez la commande suivante : Remplacez **mywebsite** par le nom du site.
...
5.  Pour supprimer le site Web, utilisez la commande suivante : Remplacez **mywebsite** par le nom du site.
...
## <span id="script"></span></a>Création de scripts dans l'interface de ligne de commande interplateforme Azure
...
-   Pour plus d'informations sur Azure, consultez le site [][2][http://azure.microsoft.com/fr-fr/][http://azure.microsoft.com/fr-fr/]</a>.
  ...
  [Script Shell]: http://en.wikipedia.org/wiki/Shell_script
