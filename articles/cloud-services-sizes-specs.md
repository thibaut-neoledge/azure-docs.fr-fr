<properties 
 ...
 description="Répertorie les différentes tailles des rôles web et de travail." 
...
|---|---|---|---|
|Très petite|1|768 Mo|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 19 Go</p><p>Applications = environ 1,5 Go</p>|
|Petite|1|1,75 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 224 Go</p><p>Applications = environ 1,5 Go</p>|
|Moyenne|2|3,5 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 489 Go</p><p>Applications = environ 1,5 Go</p>|
|Grande|4|7 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 999 Go</p><p>Applications = environ 1,5 Go</p>|
|Très grande|8|14 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 2 039 Go</p><p>Applications = environ 1,5 Go</p>|
|A5|2|14 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 489 Go</p><p>Applications = environ 1,5 Go</p>|
|A6|4|28 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 999 Go</p><p>Applications = environ 1,5 Go</p>|
|A7|8|56 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 2 039 Go</p><p>Applications = environ 1,5 Go</p>
|A8|8|56 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 1,77 To</p><p>Applications = environ 1,5 Go</p><blockquote><p>[AZURE.NOTE]Pour plus d'informations et pour connaître les éléments à prendre en considération sur l'utilisation de cette taille, consultez l'article <a href="http://go.microsoft.com/fwlink/p/?linkid=328042">À propos des instances de calcul intensif A8, A9, A10 et A11</a>.</p></blockquote>|
|A9|16|<p>112 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 1,77 To</p><p>Applications = environ 1,5 Go</p><blockquote><p>[AZURE.NOTE]Pour plus d'informations et pour connaître les éléments à prendre en considération sur l'utilisation de cette taille, consultez l'article <a href="http://go.microsoft.com/fwlink/p/?linkid=328042">À propos des instances de calcul intensif A8, A9, A10 et A11</a>.</p></blockquote>|
|A10|8|<p>56 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 1,77 To</p><p>Applications = environ 1,5 Go</p><blockquote><p>[AZURE.NOTE]Pour plus d'informations et pour connaître les éléments à prendre en considération sur l'utilisation de cette taille, consultez l'article <a href="http://go.microsoft.com/fwlink/p/?linkid=328042">À propos des instances de calcul intensif A8, A9, A10 et A11</a>.</p></blockquote>|
|A11|16|<p>112 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 1,77 To</p><p>Applications = environ 1,5 Go</p><blockquote><p>[AZURE.NOTE]Pour plus d'informations et pour connaître les éléments à prendre en considération sur l'utilisation de cette taille, consultez l'article <a href="http://go.microsoft.com/fwlink/p/?linkid=328042">À propos des instances de calcul intensif A8, A9, A10 et A11</a>.</p></blockquote>|
|D1 standard|1|3,5 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 50 Go</p><p>Applications = environ 1,5 Go</p>|
|D2 standard|2|7 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 100 Go</p><p>Applications = environ 1,5 Go</p>|
|D3 standard|4|14 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 200 Go</p><p>Applications = environ 1,5 Go</p>|
|D4 standard|8|28 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 400 Go</p><p>Applications = environ 1,5 Go</p>|
|D11 standard|2|14 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 100 Go</p><p>Applications = environ 1,5 Go</p>|
|D12 standard|4|28 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 200 Go</p><p>Applications = environ 1,5 Go</p>|
|D13 standard|8|56 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 400 Go</p><p>Applications = environ 1,5 Go</p>|
|D14 standard|16|112 Go|<p>Système d'exploitation = taille du système d'exploitation invité</p><p>Ressources locales = 800 Go</p><p>Applications = environ 1,5 Go</p>|
...
[Configurer les tailles pour les services cloud](https://msdn.microsoft.com/library/ee814754)
