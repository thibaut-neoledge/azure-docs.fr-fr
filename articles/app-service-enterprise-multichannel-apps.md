...
L'exemple d'application de déplacement des employés ci-dessous montre une application multicanal d'entreprise sécurisée via Azure Active Directory (AAD) qui s'intègre à la fois aux ressources locales et aux services SaaS (Software-as-a-Service) comme Office 365 et 
Salesforce.
...
Pour plus d'informations sur la configuration de l'intégration AAS à AAD, consultez [Intégration AAS à AAD][AASIntegrationwithAAD]. 
...
Pour plus d'informations sur l'intégration de réseau virtuel de point à site, consultez [Intégration de réseau virtuel][VNETIntegration].
...
Les entreprises aujourd'hui utilisent une variété de services SaaS et ont besoin d'interagir avec les données SaaS à partir d'autres applications.  L'application de déplacement
est un exemple de ce scénario.  Elle met à jour les informations de compte client dans Salesforce chaque fois qu'un employé envisage un déplacement chez un compte client.
...
Pour plus d'informations sur l'intégration de SaaS, consultez [Intégration de SaaS][SaaSIntegration]

## <a name="NextSteps"></a>Étapes suivantes

Pour plus d'informations, consultez [Azure Application Services][AzureApplicationServices]
