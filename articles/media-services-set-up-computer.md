...
Maintenant que vous avez configuré votre ordinateur et créé une solution Visual Studio pour la programmation Media Services, accédez à la rubrique [Création d'un élément multimédia chiffré et téléchargement dans le stockage][].
