<properties 
	pageTitle="Utilisation de scripts serveur pour valider et modifier des données (Windows Store) | Centre de développement mobile" 
	description="Découvrez comment utiliser des scripts serveurs pour valider, de modifier et compléter les données pour votre application du Windows Store avec Azure Mobile Services." 
