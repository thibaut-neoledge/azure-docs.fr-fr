<properties urlDisplayName="Azure Import/Export Service" pageTitle="Utilisation du service Import/Export pour transf&eacute;rer des donn&eacute;es vers le stockage d'objets blob | Microsoft Azure" metaKeywords="" description="D&eacute;couvrez comment cr&eacute;er des t&acirc;ches d'importation et d'exportation dans le portail de gestion Azure pour transf&eacute;rer des donn&eacute;es vers le stockage d'objets blob." metaCanonical="" disqusComments="1" umbracoNaviHide="0" title="Transfert de donn&eacute;es vers le stockage d'objets blob &agrave; l'aide du service Azure Import/Export" authors="tamram" manager="adinah" editor="cgronlun" />
...
Avant de créer une tâche d'importation, préparez vos lecteurs à l'aide de l'outil Microsoft Azure Import/Export. Pour plus d'informations sur l'utilisation de l'outil Microsoft Azure Import/Export, consultez la [page de référence sur l'outil Microsoft Azure Import/Export][page de référence sur l'outil Microsoft Azure Import/Export]. Vous pouvez télécharger l'[outil Microsoft Azure Import/Export][outil Microsoft Azure Import/Export] comme package autonome.
...
| Expédition          | Votre tâche a été créée et vous avez fourni vos détails d'expédition.                                                                        |
...
> [WACOM.NOTE] Si le convertisseur dont vous disposez n'est pas répertorié ci-dessus, vous pouvez tenter de l'utiliser pour exécuter l'outil Microsoft Azure Import/Export pour voir s'il fonctionne avec d'en acheter un qui soit pris en charge.
...
-   Pour les régions situées aux États-Unis et en Europe, seul [Federal Express][Federal Express] (FedEx) est pris en charge. Tous les colis sont renvoyés via FedEx Ground ou FedEx International Economy.

-   Pour les régions situées en Asie, seul [DHL][DHL] est pris en charge. Tous les colis sont renvoyés via DHL Express Worldwide.
...
-   Lorsque vous expédiez vos colis, vous devez respecter les [conditions d'utilisation des services Microsoft Azure][conditions d'utilisation des services Microsoft Azure].
...
-   Incluez uniquement vos disques durs. N'incluez pas d'accessoires tels que des câbles d'alimentation ou USB.
  ...
  [page de référence sur l'outil Microsoft Azure Import/Export]: http://go.microsoft.com/fwlink/?LinkId=329032
  [outil Microsoft Azure Import/Export]: http://go.microsoft.com/fwlink/?LinkID=301900&clcid=0x409
  ...
  [conditions d'utilisation des services Microsoft Azure]: http://azure.microsoft.com/fr-fr/support/legal/services-terms/
