---
title: Vue d’ensemble du fournisseur de ressources réseau | Microsoft Docs
...
7. Cliquez sur **Créer**. Notez la vignette qui affiche **Approvisionnement du déploiement du modèle**. Une fois le déploiement effectué, vous verrez un écran semblable à celle ci-dessous.
