---
title: Déploiement de machines virtuelles à plusieurs cartes réseau à l'aide de l'Interface de ligne de commande (CLI) Azure dans Resource Manager | Microsoft Docs
...
> [!IMPORTANT]
> Assurez-vous que vos noms de compte de stockage sont uniques. Vous ne pouvez avoir des noms de compte de stockage en double dans Azure.
> 
> 
