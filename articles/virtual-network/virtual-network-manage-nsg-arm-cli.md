---
title: Gérer les groupes de sécurité réseau à l’aide de l’interface CLI Azure dans Resource Manager | Microsoft Docs
...
> [!NOTE]
> Vous pouvez également utiliser `azure network nsg rule list --resource-group RG-NSG --nsg-name NSG-FrontEnd` pour répertorier les règles du groupe de sécurité réseau **NSG-FrontEnd**.
> 
> 
...
> [!NOTE]
> Notez la valeur "" (vide) pour le paramètre **network-security-group-id**. Voilà comment supprimer une association d’un groupe de sécurité réseau. Vous ne pouvez pas faire de même avec le paramètre **network-security-group-name**.
> 
> 
