...
Pour déployer le modèle que vous avez téléchargé à l’aide de PowerShell, installez et configurez PowerShell en effectuant les étapes décrites dans l’article [Installation et configuration de PowerShell](/powershell/azure/overview), puis procédez comme suit :
