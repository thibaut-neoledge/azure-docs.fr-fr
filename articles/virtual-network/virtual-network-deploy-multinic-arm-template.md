---
title: Déployer des machines virtuelles avec plusieurs cartes réseau à l’aide d’un modèle dans Resource Manager | Microsoft Docs
...
1. Pour créer un groupe de ressources à l'aide du modèle, exécutez l'applet de commande **`New-AzureRmResourceGroup`**.
