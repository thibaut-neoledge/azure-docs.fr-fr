---
title: Déploiement de machines virtuelles à plusieurs cartes réseau à l'aide de PowerShell dans le modèle de déploiement classique | Microsoft Docs
...
Découvrez comment [effectuer ces étapes à l’aide du modèle Resource Manager](virtual-network-deploy-multinic-arm-ps.md).
