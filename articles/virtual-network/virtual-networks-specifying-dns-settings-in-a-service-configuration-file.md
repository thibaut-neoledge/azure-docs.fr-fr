...
> [!WARNING]
> L’attribut **name** de l’élément **DnsServer** est utilisé uniquement en tant que nom de référence. Il ne représente aucunement le nom d’hôte attribué au serveur DNS. Chaque valeur d’attribut **DnsServer** doit être unique au sein de l’abonnement Microsoft Azure.
> 
> 
