---
title: Définition d'une adresse IP privée statique en mode ARM à l'aide du portail Azure | Microsoft Docs
...
> [!NOTE]
> Si, après avoir cliqué sur **Enregistrer**, vous remarquez que l’affectation est toujours définie sur **Dynamique**, cela signifie que l’adresse IP que vous avez tapée est déjà en cours d’utilisation. Essayez une autre adresse IP.
> 
> 
