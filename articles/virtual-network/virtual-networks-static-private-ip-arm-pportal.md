<properties 
   pageTitle="Définition d’une adresse IP privée statique en mode ARM à l’aide du portail en version préliminaire | Microsoft Azure"
   description="Présentation des adresses IP privées (adresses IP dynamiques) et de leur gestion en mode ARM à l’aide du portail en version préliminaire"
...
# Définition d’une adresse IP privée dans le portail en version préliminaire
...
Vous ne peut pas définir une adresse IP privée statique lors de la création d’une machine virtuelle dans le mode de déploiement de Resource Manager à l’aide du portail en version préliminaire. Vous devez d’abord créer la machine virtuelle, puis définir son adresse IP privée de façon à ce qu’elle soit statique.
...
2. Cliquez sur **Nouveau** > **Ordinateur** > **Windows Server 2012 R2 Datacenter** (notez que la liste **Sélectionner un modèle de déploiement** contient déjà **Resource Manager**), puis cliquez sur **Créer**, comme illustré dans la figure ci-dessous.
	...
	![Création d’une machine virtuelle dans le portail en version préliminaire](./media/virtual-networks-static-ip-arm-pportal/figure01.png)
...
7. Dans le panneau **Résumé**, cliquez sur **OK**. Notez la vignette ci-dessous affichée dans votre tableau de bord.
	...
	![Création d’une machine virtuelle dans le portail en version préliminaire](./media/virtual-networks-static-ip-arm-pportal/figure06.png)
...
1. Dans le portail Azure en version préliminaire, cliquez sur **PARCOURIR TOUT** > **Machines virtuelles** > **DNS01** > **Tous les paramètres** > **interfaces réseau**, puis cliquez sur la seule interface réseau répertoriée.
...
2. Tapez *192.168.1.101* dans **Adresse IP**, puis cliquez sur **Enregistrer**.
	...
	![Création d’une machine virtuelle dans le portail en version préliminaire](./media/virtual-networks-static-ip-arm-pportal/figure09.png)
