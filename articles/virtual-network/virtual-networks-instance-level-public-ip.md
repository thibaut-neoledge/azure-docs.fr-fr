---
title: Adresses IP publiques de niveau d’instance (ILPIP) | Microsoft Docs
...
Découvrez comment [effectuer ces étapes à l’aide du modèle Resource Manager](virtual-network-ip-addresses-overview-arm.md).
