<properties
   pageTitle="Exemple DMZ : Créer une zone démilitarisée (DMZ) pour protéger les applications avec un pare-feu et des groupes de sécurité réseau | Microsoft Azure"
...
#### (Autorisé) web vers serveur web via le pare-feu
...
#### (Autorisé) RDP vers le serveur principal
...
#### (Refusé) Web direct vers le serveur Web
...
#### (Refusé) recherche DNS web sur le serveur DNS
