...
11. Affectez l’interface réseau à une machine virtuelle lors de la création de la machine virtuelle en suivant les étapes 3 et 6 de l’article [Créer une machine virtuelle](../virtual-machines/virtual-machines-windows-ps-create.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) . À l’étape 6-2, remplacez *Standard_A1* par l’une des tailles de machine virtuelle indiquées dans la section [Limitations](#limitations) de cet article.
