---
title: Déploiement de machines virtuelles à plusieurs cartes réseau à l'aide de l'Interface de ligne de commande (CLI) Azure dans le modèle de déploiement classique | Microsoft Docs
...
Découvrez comment [effectuer ces étapes à l’aide du modèle Resource Manager](virtual-network-deploy-multinic-arm-cli.md).
