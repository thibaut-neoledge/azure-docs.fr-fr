---
title: Contrôle du routage et utilisation des appliances virtuelles dans Resource Manager à l'aide d’un modèle | Microsoft Docs
...
> [!TIP]
> Si vous ne voyez pas toutes les ressources, exécutez la commande `azure group deployment show` pour vérifier que l’état d’approvisionnement du déploiement est défini sur *Succeded*.
> 
> 
