---
title: Création de groupes de sécurité réseau en mode ARM à l'aide du portail Azure | Microsoft Docs
...
6. Répétez les étapes 1 à 6 pour créer une règle entrante nommée *rdp-rule* avec la priorité *250* autorisant l’accès via *TCP* vers le port *3389* d’une machine virtuelle issue de n’importe quelle source.
