...
* Vous pouvez homologuer des réseaux virtuels dans deux abonnements différents, à condition qu’un utilisateur privilégié de chacun de ces abonnements autorise l’homologation et que les abonnements soient associés au même locataire Active Directory.
