...
## <a name="creating-and-migrating-to-regional-vnets"></a>Création de réseaux virtuels régionaux et migration
...
### <a name="about-vnets-currently-associated-with-affinity-groups"></a>À propos des réseaux virtuels actuellement associés à des groupes d’affinités
...
## <a name="affinity-groups-and-vms"></a>Groupes d’affinités et machines virtuelles
...
### <a name="what-to-do-if-you-have-a-vm-in-an-affinity-group"></a>Marche à suivre en cas de machine virtuelle dans un groupe d’affinités
