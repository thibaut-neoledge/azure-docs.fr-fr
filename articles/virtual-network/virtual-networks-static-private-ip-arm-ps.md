---
title: Définition d’une adresse IP privée statique dans Azure Resource Manager à l’aide de PowerShell | Microsoft Docs
...
Cet article traite du modèle de déploiement de Resource Manager. Vous pouvez également [gérer une adresse IP privée statique dans le modèle de déploiement classique](virtual-networks-static-private-ip-classic-ps.md).
