---
title: "Documentation Azure Advisor - Didacticiels | Microsoft Docs"
description: 
services: advisor
author: carolz
manager: carolz
...
---
# <a name="azure-advisor-documentation"></a>Documentation Azure Advisor
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>En savoir plus sur Azure Advisor</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Vidéothèque Azure Advisor</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prise en main d’Azure Advisor</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/advisor">Référence d’API REST</a></p>
                    </div>
                </div>
            </div>
        </div>
