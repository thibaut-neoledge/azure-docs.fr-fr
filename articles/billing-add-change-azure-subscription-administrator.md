...
# <a name="how-to-add-or-change-azure-administrator-roles"></a>Ajout ou modification de rôles d’administrateur Azure
 Les trois types de rôles Administrateur dans Microsoft Azure sont Administrateur de compte, Administrateur de services fédérés et Coadministrateur. Pour afficher les informations de facturation et gérer les abonnements, vous devez vous connecter au [Centre des comptes](https://account.windowsazure.com/Home/Index) en tant qu’administrateur de compte. Le tableau suivant décrit la différence entre ces trois rôles Administrateur.
...
* **Organizational account**</br>
  Un compte professionnel est un compte créé sous Azure Active Directory. L’adresse du compte professionnel a ce format :
    ...
    user@&lt;votre domaine&gt;.onmicrosoft.com

## <a name="limitations-and-restrictions-to-administrator-accounts"></a>Limitations et restrictions des comptes Administrateur
...
## <a name="how-to-check-the-account-administrator-of-the-subscription"></a>Comment vérifier l’administrateur de compte de l’abonnement
