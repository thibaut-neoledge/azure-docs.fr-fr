...
## Explication des rôles d’administrateur
...
**Remarque** Le contrôle d’accès en fonction du rôle (RBAC) Azure Active Directory permet d’ajouter les utilisateurs à plusieurs rôles. Pour plus d’informations, consultez la rubrique [Contrôle d’accès en fonction du rôle Azure Active Directory](./active-directory/role-based-access-control-configure.md).
## Ajout d’un coadministrateur pour un abonnement
...
* **Compte professionnel**</br> Un compte professionnel est un compte créé sous Azure Active Directory. L’adresse du compte professionnel est similaire à ceci : utilisateur@<your domain>.onmicrosoft.com
...
4. Dans la zone **ADMINISTRATEUR DE SERVICES**, entrez l’adresse de messagerie du nouvel administrateur de services fédérés. ![changeSA](./media/billing-add-change-azure-subscription-administrator/changeSA.png)
