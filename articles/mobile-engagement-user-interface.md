<properties 
   pageTitle="Interface utilisateur d'Azure Mobile Engagement - Introduction" 
...
Après avoir intégré le [SDK][Link 5] d'Azure Mobile Engagement dans votre application et compris les [Concepts][Link 6] de base d'Azure Mobile Engagement, il existe deux façons d'interagir avec Azure Mobile Engagement pour votre application : les utilisateurs standard peuvent utiliser l'[Interface utilisateur][Link 1] tandis que les développeurs peuvent utiliser les [API][Link 4] REST HTTP. Pour une présentation détaillée des activités courantes, consultez les [manuels][Link 3]. Si vous rencontrez des difficultés, consultez les [Guides de dépannage][Link 2] d'Azure Mobile Engagement.
