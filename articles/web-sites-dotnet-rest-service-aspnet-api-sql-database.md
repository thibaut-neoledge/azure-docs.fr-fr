...
***Par [Rick Anderson](https://twitter.com/RickAndMSFT) et Tom Dykstra. Mis à jour en mars 2014.***

Ce didacticiel vous montre comment déployer une application Web ASP.NET dans un site Web Azure en utilisant l'Assistant Publier le site Web dans Visual Studio 2013 ou Visual Studio Express 2013 pour le Web (si vous préférez utiliser Visual Studio 2012, consultez [la version précédente de ce didacticiel](/en-us/develop/net/tutorials/get-started-vs2012/)).
...
-   créer et publier un projet Visual Studio ASP.NET MVC 5 dans un site Web Azure ;
...
3.  Lors de l'étape **New Web Site** de l'Assistant, entrez une chaîne dans la zone **URL** pour l'utiliser en tant qu'URL unique pour votre application. L'URL complète se composera du texte entré ici, ainsi que du suffixe affiché sous la zone de texte. L'illustration indique « contactmgr11 », mais cette URL est probablement prise (il faut donc en choisir une autre).
...
5.  Dans la liste déroulante **Base de données**, sélectionnez **Create a free 20 MB SQL database**.
    ...
    ![Étape Créer un nouveau site Web du l'Assistant Créer un site Web](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/rrCWS.png)
...
11. Cliquez sur la coche située en bas de la zone pour indiquer que vous avez terminé.
    ...
    ![Paramètres de base de données du nouveau site Web : Assistant Création avec une base de données](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/dntutmobile-setup-azure-site-004.png)

    L'image suivante montre l'utilisation d'un nom et d'un mot de passe de connexion à une base de données SQL existante.

    ![Paramètres de base de données du nouveau site Web : Assistant Création avec une base de données](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/rxPrevDB.png)
...
3.  Dans la boîte de dialogue **New Project**, développez **Visual C\#** et sélectionnez **Web**, puis **ASP.NET MVC 5 Web Application**. Conservez la valeur par défaut **.NET Framework 4.5**. Nommez l'application **GestionnaireContacts**, puis cliquez sur **OK**. ![Boîte de dialogue New Project](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/rr4.PNG)]
...
6.  Dans la boîte de dialogue **New ASP.NET Project**, cliquez sur **OK**.
    ...
    ![Boîte de dialogue New ASP.NET Project](./media/web-sites-dotnet-get-started-vs2013/GS13newaspnetprojdb.png)
...
2.  Sous l'onglet **Profil** de l'Assistant **Publier le site Web**, cliquez sur **Importer**.
	...
	3.  Sélectionnez Import from an Azure Web Site. Si vous ne l'avez pas déjà fait, vous devez vous connecter. Cliquez sur **Se connecter**. Entrez l'utilisateur associé à votre abonnement, puis suivez la procédure de connexion.
...
5.  Définissez le nom du contrôleur sur **HomeController**. Sélectionnez **Contact** comme classe de modèle. Cliquez sur le bouton **New data context** et acceptez la valeur par défaut « ContactManager.Models.ContactManagerContext » pour le **Type du nouveau contexte de données**. Cliquez sur **Ajouter**.
...
1.  Ouvrez le fichier *Views\\Home\\Index.cshtml*. Dans l'étape suivante, nous allons remplacer le balisage généré par un code utilisant [jQuery](http://jquery.com/) et [Knockout.js](http://knockoutjs.com/). Ce nouveau code récupère la liste des contacts en utilisant l'API Web et JSON, puis relie les données de contact à l'interface utilisateur en utilisant knockout.js. Pour plus d'informations, consultez la section [Étapes suivantes](#nextsteps) à la fin de ce didacticiel.
...
2.  Remplacez le contenu du fichier par le code suivant.
         ...
         '"></span>
                 ...
                 <p><a data-bind="attr: { href: Self }, click: $root.removeContact" class="removeContact ui-state-default ui-corner-all">Supprimer</a></p>
             </li>
         </ul>
...
![Boîte de dialogue Ajouter un nouvel élément](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/rxStyle.png)
...
Ajout d'un contrôleur pour l'interface d'API Web Restful
--------------------------------------------------------
...
1.  Appuyez sur Ctrl+F5 pour exécuter l'application.
    ...
    ![Page d'index](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/dntutmobil-intro-finished-web-app.png)
...
3.  Dans le navigateur, ajoutez **/api/contacts** à l'URL.
    ...
    ![Page d'index avec éléments de liste des tâches](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/rxFFchrome.png)
...
6.  Cliquez sur **Publier**. Une fois le déploiement terminé, le navigateur ouvre la page d'accueil de l'application.

    ![Page d'index sans contacts](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/dntutmobil-intro-finished-web-app.png)
...
![Page d'index avec contacts](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/dntutmobile-webapi-added-contact.png)
