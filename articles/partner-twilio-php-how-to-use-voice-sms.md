...
Pour plus d'informations, consultez la page [][3]<https://github.com/twilio/twilio-php/blob/master/README.md></a>.
...
-   **Remarque** : Pour résoudre les erreurs de validation des certificats SSL, consultez la page [][4]<http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html></a>
...
Lorsque votre application démarre un appel à l'API Twilio, Twilio envoie votre demande à une URL qui est censée renvoyer une réponse TwiML. L'exemple ci-dessus utilise l'URL fournie par Twilio [][5]<http://twimlets.com/message></a>. TwiML est conçu pour être utilisé par Twilio, vous pouvez donc l'afficher dans votre navigateur. Par exemple, cliquez sur [][5]<http://twimlets.com/message></a> pour afficher un élément `<Response>` vide. Autre exemple, cliquez sur [][6]<http://twimlets.com/message?Message%5B0%5D=Hello%20World></a> pour afficher un élément `<Response>` contenant un élément `<Say>`.)
...
Pour plus d'informations sur TwiML, consultez la page [][7]<https://www.twilio.com/docs/api/twiml></a>.
...
-   [Support Twilio][]
  ...
  [Exécution d'un appel téléphonique à l'aide de Twilio dans une application PHP sur Azure]: ../partner-twilio-php-make-phone-call
