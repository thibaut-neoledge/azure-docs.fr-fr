...
Vous allez apprendre à configurer vos appareils StorSimple en consultant une liste de contrôle préalable à l’installation, en respectant les conditions préalables à la configuration et en suivant des étapes de configuration détaillées.
...
|---| --------------------- | ---------------------- | ------------- |
| 1 | Nom convivial pour votre appareil | Nom descriptif pour l’appareil | |
| 2 | Paramètres réseau <ol><li>Adresse IP de l’appareil</li><li>Interfaces réseau, 4x1 GbE, 2x10 GbE</li><li>Adresse IP de contrôleur fixe</li><li>Masque de sous-réseau</li><li>Passerelle</li></ol> | Nombre total d’adresses IP requises : 8 <ol><li>Une par appareil</li><li>Une par interface réseau activée, pour un nombre total de 6</li><li>Une par contrôleur, pour un nombre total de 2</li><li>Une pour chaque adresse IP</li><li>Une par appareil</li></ol> | |
...
> * Si vous avez activé la création automatique d’un compte de stockage, passez à l’étape 2 : obtention de la clé d’inscription.
...
Si vous devez créer un compte de stockage Azure dans une autre région, consultez la page [À propos des comptes de stockage Azure](storage-create-storage-account.md) pour obtenir des instructions détaillées.
