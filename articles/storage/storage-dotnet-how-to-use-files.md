...
### <a name="save-your-storage-account-credentials-to-the-app.config-file"></a>Enregistrement des informations d’identification de votre compte de stockage dans le fichier app.config
