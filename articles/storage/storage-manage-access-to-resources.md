<properties 
	pageTitle="Gestion de l’accès aux ressources d’Azure Storage | Microsoft Azure" 
	description="Apprenez à gérer le mode d’accès des utilisateurs à vos ressources Azure Storage." 
	services="storage" 
	documentationCenter="" 
	authors="tamram" 
	manager="jdial" 
