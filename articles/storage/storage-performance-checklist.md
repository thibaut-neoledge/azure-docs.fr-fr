...
## <a name="a-nameallservicesaall-services"></a><a name="allservices"></a>Tous les Services
...
### <a name="a-namesubheading1ascalability-targets"></a><a name="subheading1"></a>Objectifs d’extensibilité
...
#### <a name="a-namesub1bandwidthabandwidth-scalability-target-for-all-services"></a><a name="sub1bandwidth"></a>Cible d’extensibilité de bande passante pour tous les services
...
### <a name="a-namesubheading47apartition-naming-convention"></a><a name="subheading47"></a>Conventions d’affectation de noms aux partitions
...
##### <a name="a-namesubheading2athroughput"></a><a name="subheading2"></a>Débit
...
##### <a name="a-namesubheading3alink-quality"></a><a name="subheading3"></a>Qualité de la liaison
...
##### <a name="useful-resources"></a>Ressources utiles
Pour plus d’informations sur les tailles de machines virtuelles et la bande passante allouée, consultez la rubrique [Tailles des machines virtuelles](../virtual-machines/virtual-machines-windows-sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) ou [Tailles des machines virtuelles Linux](../virtual-machines/virtual-machines-linux-sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).  

#### <a name="a-namesubheading4alocation"></a><a name="subheading4"></a>Emplacement
...
### <a name="a-namesubheading5acontent-distribution"></a><a name="subheading5"></a>Distribution de contenu
...
### <a name="a-namesubheading6ausing-sas-and-cors"></a><a name="subheading6"></a>Utilisation de SAP et de CORS
...
#### <a name="a-namesubheading7agetting-data"></a><a name="subheading7"></a>Récupération de données
...
#### <a name="a-namesubheading8auploading-data-in-batches"></a><a name="subheading8"></a>Téléchargement de données par lots
...
#### <a name="a-namesubheading9aincrease-default-connection-limit"></a><a name="subheading9"></a>Augmentation de la limite de connexions par défaut
...
#### <a name="a-namesubheading10aincrease-threadpool-min-threads-if-using-synchronous-code-with-async-tasks"></a><a name="subheading10"></a>Augmentation du nombre minimum de threads du pool de threads en cas d’utilisation de code synchrone avec Async Tasks
...
#### <a name="a-namesubheading11atake-advantage-of-net-45-garbage-collection"></a><a name="subheading11"></a>Utilisation du nettoyage de la mémoire de .NET 4.5
...
### <a name="a-namesubheading12aunbounded-parallelism"></a><a name="subheading12"></a>Parallélisme illimité
...
### <a name="a-namesubheading13astorage-client-libraries-and-tools"></a><a name="subheading13"></a>Outils et bibliothèques clientes de stockage
...
#### <a name="a-namesubheading14athrottlingserverbusy"></a><a name="subheading14"></a>Limitation/Serveur occupé
...
#### <a name="a-namesubheading15anon-retryable-errors"></a><a name="subheading15"></a>Erreurs non renouvelables
...
#### <a name="a-namesubheading46amultiple-clients-accessing-a-single-object-concurrently"></a><a name="subheading46"></a>Plusieurs clients accédant simultanément à un seul objet
...
#### <a name="a-namesubheading16abandwidth-and-operations-per-blob"></a><a name="subheading16"></a>Bande passante et opérations par objet blob
...
#### <a name="a-namesubheading17acopy-blob"></a><a name="subheading17"></a>Copie d’un objet blob
...
#### <a name="a-namesubheading18ause-azcopy"></a><a name="subheading18"></a>Utilisation d’AzCopy
...
#### <a name="a-namesubheading19aazure-importexport-service"></a><a name="subheading19"></a>Service Azure Import/Export
...
### <a name="a-namesubheading20ause-metadata"></a><a name="subheading20"></a>Utilisation de métadonnées
...
Pour savoir comment récupérer les métadonnées d’un objet blob à l’aide de .NET, consultez [Configuration et récupération des propriétés et des métadonnées](storage-properties-metadata.md).  
...
#### <a name="a-namesubheading21auploading-one-large-blob-quickly"></a><a name="subheading21"></a>Téléchargement rapide d’un objet blob volumineux
...
#### <a name="a-namesubheading22auploading-many-blobs-quickly"></a><a name="subheading22"></a>Téléchargement rapide de nombreux objets blob
...
### <a name="a-namesubheading23achoosing-the-correct-type-of-blob"></a><a name="subheading23"></a>Choix du type d’objet blob approprié
...
### <a name="a-namesubheading24atable-specific-scalability-targets"></a><a name="subheading24"></a>Objectifs d’extensibilité propres aux tables
...
#### <a name="a-namesubheading25ause-json"></a><a name="subheading25"></a>Utilisation de JSON
...
#### <a name="a-namesubheading26anagle-off"></a><a name="subheading26"></a>Désactivation de Nagle
...
#### <a name="a-namesubheading27atables-and-partitions"></a><a name="subheading27"></a>Tables et partitions
...
##### <a name="a-namesubheading28aappend-only-and-prepend-only-patterns"></a><a name="subheading28"></a>Modèles « Ajouter après uniquement » et « Ajouter avant uniquement »
...
##### <a name="a-namesubheading29ahigh-traffic-data"></a><a name="subheading29"></a>Données à trafic élevé
...
##### <a name="a-namesubheading30aquery-scope"></a><a name="subheading30"></a>Étendue de requête
...
##### <a name="a-namesubheading31aquery-density"></a><a name="subheading31"></a>Densité des requêtes
...
###### <a name="a-namesubheading32afiltering"></a><a name="subheading32"></a>Filtrage
...
###### <a name="a-namesubheading33aprojection"></a><a name="subheading33"></a>Projection
...
##### <a name="a-namesubheading34adenormalization"></a><a name="subheading34"></a>Dénormalisation
...
##### <a name="a-namesubheading35abatching"></a><a name="subheading35"></a>Traitement par lot
...
##### <a name="a-namesubheading36aupsert"></a><a name="subheading36"></a>Opération Upsert
...
##### <a name="a-namesubheading37astoring-data-series-in-a-single-entity"></a><a name="subheading37"></a>Stockage de séries de données dans une seule entité
...
##### <a name="a-namesubheading38astoring-structured-data-in-blobs"></a><a name="subheading38"></a>Stockage de données structurées dans des objets blob
...
### <a name="a-namesubheading39ascalability-limits"></a><a name="subheading39"></a>Limites d’extensibilité
...
### <a name="a-namesubheading40anagle-off"></a><a name="subheading40"></a>Désactivation de Nagle
...
### <a name="a-namesubheading41amessage-size"></a><a name="subheading41"></a>Taille des messages
...
### <a name="a-namesubheading42abatch-retrieval"></a><a name="subheading42"></a>Récupération par lots
...
### <a name="a-namesubheading43aqueue-polling-interval"></a><a name="subheading43"></a>Intervalle d'interrogation de file d'attente
...
### <a name="a-namesubheading45aapplication-architecture"></a><a name="subheading45"></a>Architecture de l’application
