...
# Signatures d’accès partagé, partie 2 : créer et utiliser un SAS avec le service BLOB
...
## Partie 2 : créer une application console pour tester les signatures d’accès partagé
