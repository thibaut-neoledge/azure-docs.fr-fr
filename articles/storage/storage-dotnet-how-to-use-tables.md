...
La classe **CloudTableClient** vous permet de récupérer des tables et entités stockées dans Table Storage. Ajoutez le code suivant à la méthode **Main()** :
