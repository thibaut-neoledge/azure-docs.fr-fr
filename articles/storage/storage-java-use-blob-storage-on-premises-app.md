...
Appelez une fonction d’assistance nommée **MakeHTMLPage** pour créer une page HTML de base contenant un élément **&lt;image&gt;** dont la source est l’objet blob situé maintenant dans votre compte de stockage Azure. (Le code pour **MakeHTMLPage** est abordé plus loin dans cette rubrique.)
...
Voici le code complet pour cet exemple. N'oubliez pas de modifier les valeurs des espaces réservés **your_account_name** et **your_account_key** pour utiliser respectivement votre nom et votre clé de compte.
