...
## Création d'un message de file d'attente pendant le traitement d'un message de file d'attente
...
Si vous devez effectuer un travail dans votre fonction avant de lier un objet blob à un objet, vous pouvez utiliser l’attribut dans le corps de la fonction [comme indiqué plus haut pour l’attribut Queue](#use-webjobs-sdk-attributes-in-the-body-of-a-function).

###Types avec lesquels vous pouvez utiliser l’attribut Blob
...
##Gestion de messages incohérents
...
Vous pouvez désactiver la journalisation en [affectant la valeur null à la chaîne de connexion du tableau de bord](#how-to-set-configuration-options).
