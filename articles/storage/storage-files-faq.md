...
* **Q. Quand utiliser Stockage Fichier Azure, Stockage Blob Azure ou un stockage sur disque Azure ?**  
    ...
    Pour plus d’informations, voir [Quand utiliser des objets blob Azure, des fichiers Azure ou des disques de données Azure](storage-decide-blobs-files-disks.md).
...
* **Q. Comment commencer à utiliser Stockage Fichier Azure ?**  
    ...
    * [Création d’un partage de fichiers via le portail](storage-file-how-to-create-file-share.md#create-file-share-through-the-portal)
    * [Création d’un partage de fichiers via PowerShell](storage-file-how-to-create-file-share.md#create-file-share-through-powershell)
    * [Création d’un partage de fichiers via l’Interface de ligne de commande (CLI)](storage-file-how-to-create-file-share.md#create-file-share-through-command-line-interface-cli)
...
* **Q. Quelles sont les limites de mise à l’échelle de Stockage Fichier Azure ?**
    Pour plus d’informations sur les objectifs d’extensibilité et de performance de Stockage Fichier Azure, voir [Objectifs de performance et évolutivité d'Azure Storage](storage-scalability-targets.md#scalability-targets-for-blobs-queues-tables-and-files).
...
* **Q. Comment résoudre les erreurs de Stockage Fichier Azure ?**
    ...
    Pour obtenir des instructions de résolution de problème de bout en bout, voir [Résoudre les problèmes liés à Stockage Fichier Azure](storage-troubleshoot-file-connection-problems.md). 
...
* [Résolution des problèmes de stockage de fichiers Azure](storage-troubleshoot-file-connection-problems.md)
