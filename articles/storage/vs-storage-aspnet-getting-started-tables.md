...
## Vue d'ensemble
Cet article explique comment prendre en main le stockage de tables Azure une fois que vous avez créé ou référencé un compte de stockage Azure dans un service cloud Azure via la boîte de dialogue **Ajouter des services connectés** de Visual Studio. Pour obtenir des informations plus générales sur l’utilisation du stockage de tables Azure, consultez la page [Comment utiliser le stockage de tables à partir de .NET](storage-dotnet-how-to-use-tables.md).
