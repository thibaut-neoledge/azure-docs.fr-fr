...
## <a name="dequeue-the-next-message"></a>Enlèvement du message suivant de la file d'attente
...
## <a name="use-asyncawait-pattern-with-common-queue-storage-apis"></a>Utiliser le modèle Async-Await avec les API de stockage de files d’attente communes
...
## <a name="leverage-additional-options-for-dequeuing-messages"></a>Utilisation d’options supplémentaires pour l’enlèvement des messages
