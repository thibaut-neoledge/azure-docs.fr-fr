...
Le nom du paramètre est _supportsHttpsTrafficOnly_ dans les propriétés du compte de stockage. Vous pouvez l’activer avec l’API REST, des outils ou des bibliothèques :
