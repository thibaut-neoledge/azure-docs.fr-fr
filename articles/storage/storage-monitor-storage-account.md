...
# Surveillance d'un compte de stockage dans le portail de gestion Azure
...
> [AZURE.NOTE]L'analyse des données de surveillance dans le portail de gestion occasionne des frais supplémentaires. Pour plus d'informations, consultez la page <a href="http://msdn.microsoft.com/library/azure/hh360997.aspx">Storage Analytics et facturation</a>. <br />
