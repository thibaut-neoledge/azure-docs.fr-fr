...
> [!NOTE]
> Le stockage Azure utilise un [stockage Table](storage-introduction.md#table-storage) pour stocker les métriques pour votre compte de stockage, et stocke les métriques dans des tables de votre compte. Pour plus d’informations, consultez. [Stockage des métriques](storage-analytics.md#how-metrics-are-stored).
>
