...
Pour bénéficier des avantages du stockage Premium, créez d'abord un compte de stockage Premium de type *Premium\_LRS*. Pour ce faire, vous pouvez utiliser le [portail Azure](https://portal.azure.com), [Azure PowerShell](../powershell-install-configure.md) ou l’[API REST de gestion des services](http://msdn.microsoft.com/library/azure/ee460799.aspx). Pour des instructions détaillées, consultez [Création et utilisation du compte de stockage Premium pour disques](#create-and-use-a-premium-storage-account-for-a-virtual-machine-data-disk).
...
Pour une description complète de la procédure pas à pas dans un environnement Azure, consultez [Création d’une machine virtuelle exécutant Windows dans le portail Azure](../virtual-machines/virtual-machines-windows-hero-tutorial.md).
...
- [Créer une machine virtuelle exécutant Windows](../virtual-machines-windows-hero-tutorial-azure-preview.md)
