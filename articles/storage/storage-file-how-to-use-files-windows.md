...
3. **Copiez le chemin d’accès UNC depuis le volet « Connexion » dans le portail Azure** : découvrez en détail comment trouver ces informations, en cliquant [ici](storage-file-how-to-use-files-portal.md#connect-to-file-share).
