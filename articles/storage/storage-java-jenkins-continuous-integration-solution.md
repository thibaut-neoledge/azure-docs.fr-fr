...
7. Dans le champ **Nom du conteneur**, indiquez le nom du conteneur. Le conteneur est créé s’il n’existe pas déjà au téléchargement des artefacts de build. Vous pouvez utiliser des variables d'environnement : pour cet exemple, entrez **${JOB_NAME}** comme nom de conteneur.
...
11. Dans le cadre de ce didacticiel, entrez **${BUILD_ID}/${BUILD_NUMBER}** pour **Chemin virtuel commun pour les artefacts téléchargés**.
