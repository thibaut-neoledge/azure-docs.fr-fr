<properties urlDisplayName="Detach a Disk" pageTitle="Détachement d'un disque d'une machine virtuelle Linux dans Azure" metaKeywords="Azure detaching disk, VM detached disk" description="Learn how to detach a data disk from an Azure virtual machine." metaCanonical="http://www.windowsazure.com/fr-fr/manage/windows/how-to-guides/detach-a-disk/" services="virtual-machines" documentationCenter="" title="" authors="kathydav" solutions="" manager="timlt" editor="" />
