...
2.  [Création d'un site Web dans Azure][]
3.  [Création d'une application ASP.NET MVC 4][]
4.  [Déploiement de l'application dans Azure][]
5.  [Étapes suivantes][]
...
1.  Dans le [portail de gestion Azure][], cliquez sur **Sites Web**, puis sur **Nouveau**.
...
4.  Cliquez sur la flèche **Créer un site Web**.
    ...
    ![Page Sites Web du portail de gestion, site Web créé][]
...
![Sites Web Azure dans l'Explorateur de serveurs][]

![Configuration du site Web dans Visual Studio][]
...
![Onglet Tableau de bord du portail de gestion][]

Vous pouvez modifier les paramètres du site sur l'onglet **Configurer**. Pour plus d'informations, consultez la page [Gestion de sites Web][].
...
![Onglet Échelle du portail de gestion][]

Pour plus d'informations, consultez la page [Mise à l'échelle d’un site Web][]. Notez que l'ajout de ressources serveur pour la mise à l'échelle d'un site web entraîne des frais.
...
![Journaux dans Visual Studio][]

Pour plus d'informations, consultez la page [Résolution des problèmes de sites Web Azure dans Visual Studio][].
...
Dans certains cas, vous pouvez exécuter votre application dans un service cloud Azure au lieu d'un site web Azure. Pour plus d'informations, consultez les pages [Modèles d'exécution Azure][] et [Comparaison entre Sites Web Azure, Azure Cloud Services et Azure Virtual Machines][]. Pour accéder à une série de didacticiels qui vous expliquent comment créer une application Web ASP.NET multiniveau et la déployer sur un service cloud, consultez la page [Application .NET multiniveau avec tables, files d'attente et objets blob de stockage][].
