...
| Sources de l’événement | Détails |
|-------------------------	|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|
...
L’outil collecte les journaux localement, dans un sous-dossier nommé de façon aléatoire sous **%LocalAppData%\\ElevatedDiagnostics**
