...
#  <a name="prerequisites-for-replication-to-azure-by-using-azure-site-recovery"></a>Configuration requise pour la réplication vers Azure à l’aide d’Azure Site Recovery
