...
# <a name="replicate-applications"></a>Répliquer des applications
...
Une fois la protection terminée, vous pouvez essayer de tester le basculement pour vérifier si votre application s’affiche dans Azure ou non.
