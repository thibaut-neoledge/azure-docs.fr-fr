...
9. Dans **Machines virtuelles** > **Sélectionner les machines virtuelles**, cliquez sur et sélectionnez chaque machine à répliquer. Vous pouvez uniquement sélectionner les machines pour lesquelles la réplication peut être activée. Cliquez ensuite sur **OK**.
...
13. Cliquez sur **Activer la réplication**. Vous pouvez suivre la progression de la tâche **Activer la protection** dans **Paramètres** > **Tâches** > **Site Recovery Jobs** (Tâches de récupération de sites). Lorsque la tâche **Finaliser la protection** est exécutée, la machine est prête pour le basculement.
...
3. Vous pouvez gérer et surveiller la réplication dans les vignettes **Éléments répliqués**, **Plans de récupération** et **Site Recovery Jobs** (Tâches de récupération de sites). Vous pouvez examiner les travaux plus en détail dans **Paramètres** -> **Travaux** -> **Site Recovery Jobs (Travaux Site Recovery)**.
...
4. Dans **Avant de commencer**, sélectionnez **Ajouter des serveurs de processus supplémentaires pour effectuer un déploiement avec montée en puissance**.
