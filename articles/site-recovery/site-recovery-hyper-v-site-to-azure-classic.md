...
2. Développez **Services de données** > **Recovery Services**, puis cliquez sur **Coffre Site Recovery**.
...
>[AZURE.NOTE] La protection des machines virtuelles exécutant Linux avec une adresse IP statique n’est pas prise en charge. 
