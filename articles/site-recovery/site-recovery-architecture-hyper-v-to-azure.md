...
Cet article décrit les composants et les processus impliqués dans la réplication des machines virtuelles Hyper-V locales sur Azure à l’aide du service [Azure Site Recovery](site-recovery-overview.md).
...
Un certain nombre de composants sont impliqués dans la réplication des machines virtuelles Hyper-V sur Azure.
...
**Serveur VMM** | Les hôtes Hyper-V sont situés dans des clouds VMM. | Si les hôtes Hyper-V sont gérés dans des clouds VMM, vous inscrivez le serveur VMM dans le coffre Recovery Services.<br/><br/> Sur le serveur VMM, vous installez le fournisseur Site Recovery pour orchestrer la réplication avec Azure.<br/><br/> Vous avez besoin d’un réseau logique et d’un réseau de machines virtuelles pour configurer le mappage réseau. Un réseau de machines virtuelles doit être lié à un réseau logique lui-même associé au cloud.
...
**Figure 2 : réplication de site Hyper-V dans des clouds VMM vers Azure**
...
**Figure 3 : processus de réplication et de récupération pour la réplication de Hyper-V vers Azure**
...
4. Vous pouvez surveiller le travail dans l'onglet **Travaux**.      ![Liste des travaux](media/site-recovery-hyper-v-azure-architecture/image1.png)![Activer l’exploration de la protection](media/site-recovery-hyper-v-azure-architecture/image2.png)
