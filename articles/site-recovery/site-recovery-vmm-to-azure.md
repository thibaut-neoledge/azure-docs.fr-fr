...
2. Dans la liste des machines virtuelles du cloud, sélectionnez celle que vous voulez protéger.
	...
	Suivez la progression du processus **Activer la protection**, notamment la réplication initiale, dans l’onglet **Tâches**. Une fois la tâche de **finalisation de la protection** exécutée, la machine virtuelle est prête pour le basculement. Une fois la protection activée et les machines virtuelles répliquées, celles-ci sont affichées dans Azure.
