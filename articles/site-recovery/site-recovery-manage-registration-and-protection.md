<properties
    pageTitle="Supprimer les serveurs et désactiver la protection | Microsoft Azure" 
...
Cet article explique comment annuler l’inscription des serveurs du coffre Microsoft Site Recovery et comment désactiver la protection des machines virtuelles protégées par ce logiciel. 
...
- **Serveur VMM non connecté**: si le serveur VMM n’est pas connecté lorsque vous le supprimez, vous devez exécuter un script manuellement afin d’effectuer le nettoyage. Ce script est disponible dans la [galerie Microsoft](http://aka.ms/asr-cleanup-script-vmm). Notez l’ID VMM du serveur, afin d’effectuer le processus de nettoyage manuel.
...
2. Dans l’onglet **Serveurs** du portail Azure Site Recovery, sélectionnez le serveur, puis cliquez sur Supprimer. Lorsque vous effectuez cette opération, il n’est pas nécessaire que le serveur soit connecté à Microsoft Azure.
...
## <a name="stop-protecting-a-hyper-v-virtual-machine"></a>Arrêter la protection d’une machine virtuelle Hyper-V
...
### <a name="clean-up-protection-settings-manually-(between-vmm-sites)"></a>Nettoyer les paramètres de protection manuellement (entre des sites VMM)
...
### <a name="clean-up-protection-settings-manually-(between-on-premises-vmm-sites-and-azure)"></a>Nettoyer les paramètres de protection manuellement (entre des sites VMM locaux et Azure)
...
### <a name="clean-up-protection-settings-manually-(between-hyper-v-sites-and-azure)"></a>Nettoyer les paramètres de protection manuellement (entre des sites Hyper-V et Azure)
...
## <a name="stop-protecting-a-vmware-virtual-machine-or-a-physical-server"></a>Arrêter la protection d'une machine virtuelle VMware ou d’un serveur physique
...
2. Dans **Supprimer une machine virtuelle** sélectionnez l’une des options suivantes :
    ...
    - **Désactiver la protection (pour l’extraction de récupération et le redimensionnement de volume)**. Vous ne pourrez voir et activer cette option que si vous avez :
