...
2. Un compte dédié dans votre serveur VMware vCenter qui peut être utilisé pour la [découverte automatique](./site-recovery-vmware-to-azure.md#vmware-account-permissions)
3. Une machine virtuelle pour installer le serveur de configuration.
...
1. Installation et inscription d’un serveur de configuration avec le service Site Recovery.
2. Découverte de vos machines virtuelles locales par la connexion d’Azure Site Recovery à vos hôtes Mware vCenter ou vSphere EXSi locaux

### <a name="step-1-install--register-a-configuration-server"></a>Étape 1 : Installer et inscrire un serveur de configuration
...
Cliquez sur le bouton +vCenter pour connecter un serveur VMware vCenter ou un ordinateur hôte VMware vSphere ESXi.
