---
title: Réplication vers Azure de machines virtuelles Hyper-V hébergées dans des clouds VMM | Microsoft Docs
...
5. L’emplacement de l’installation du fournisseur est défini dans **<Lecteur système>\\Program Files\\Microsoft System Center 2012 R2\\Virtual Machine Manager\\bin**. Cliquez sur **Installer**.
...
> [!NOTE]
> [Migration of storage accounts](../ressources-groupe-move-resources.md) entre les groupes de ressources d’un même abonnement ou de plusieurs abonnements n’est pas pris en charge pour les comptes de stockage utilisés pour le déploiement de Site Recovery.
> 
> 
