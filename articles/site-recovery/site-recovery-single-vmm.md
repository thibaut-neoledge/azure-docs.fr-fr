...
---
title: 'Azure Site Recovery : Répliquer des machines virtuelles Hyper-V sur un seul serveur VMM | Microsoft Docs'
...
6. Activez la réplication initiale pour les machines virtuelles que vous souhaitez protéger via le réseau, car les deux clouds sont situés sur le même serveur.
