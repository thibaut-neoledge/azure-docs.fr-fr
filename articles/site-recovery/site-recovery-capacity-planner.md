...
3.	Dans la feuille de calcul **Qualification de la charge de travail**, saisissez les informations obligatoires. Vous devez renseigner tous les champs marqués.
	...
	-  Dans **Nombre de disques rattachés**, spécifiez le nombre total de disques d’un serveur source.
	-  Dans **Taux d’utilisation de capacité de disque**, spécifiez l’utilisation moyenne.
