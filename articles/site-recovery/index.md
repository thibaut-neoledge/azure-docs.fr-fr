...
Découvrez comment utiliser Site Recovery pour contribuer à la continuité de votre entreprise et à sa stratégie de récupération d’urgence, afin de préserver la disponibilité des applications et des charges de travail pendant le temps d’arrêt. Des didacticiels et d’autres articles vous montrent comment planifier, déployer et gérer la réplication, le basculement et la récupération des machines locales et des machines virtuelles Azure.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>En savoir plus sur Azure Site Recovery</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Vidéothèque Azure Site Recovery</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prise en main d’Azure Site Recovery</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prise en main de la réplication des machines virtuelles Hyper-V vers Azure (sans VMM)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Prise en main de la réplication des machines virtuelles Hyper-V des clouds VMM vers Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://msdn.microsoft.com/en-us/library/mt750497">Référence d’API REST</a></p>
                    </div>
                </div>
            </div>
        </div>
