---
title: "Planifier la capacité et la mise à l’échelle de la réplication de serveurs physiques vers Azure avec Azure Site Recovery | Microsoft Docs"
description: "Utilisez cet article pour planifier la capacité et la mise à l’échelle lors de la réplication de serveurs physiques Windows/Linux vers Azure avec Azure Site Recovery"
...
---
# <a name="step-3-plan-capacity-and-scaling-for-physical-server-to-azure-replication"></a>Étape 3 : Planifier la capacité et la mise à l’échelle pour la réplication de serveurs physiques vers Azure

Utilisez cet article pour déterminer la capacité et la mise à l’échelle lors de la réplication de serveurs physiques Windows/Linux locaux vers Azure avec [Azure Site Recovery](site-recovery-overview.md).
...
1. Lisez cet [article](site-recovery-plan-capacity-vmware.md) pour en savoir plus sur l’estimation des besoins de réplication et obtenir des conseils sur le redimensionnement des composants Site Recovery.
2. Lisez les informations ci-dessous pour en savoir plus sur la mise à l’échelle des serveurs des composants, mais aussi le contrôle de la bande passante de la machine répliquée.

## <a name="replication-considerations"></a>Informations relatives à la réplication

Utilisez ces informations pour déterminer les exigences concernant le serveur répliqué.
...
1. Suivez [ces instructions](site-recovery-vmware-setup-azure-ps-resource-manager.md) pour configurer un serveur de processus supplémentaire.
2. Si vous ne connaissez pas la phrase secrète, exécutez la commande suivante : **[SiteRecoveryInstallationFolder]\home\sysystems\bin\genpassphrase.exe –n** sur le serveur de configuration pour l’obtenir.
3. Après avoir configuré le serveur de processus, vous pouvez migrer les machines sources pour l’utiliser.
...
Aller à l’[Étape 4 : Planifier la mise en réseau](physical-walkthrough-network.md).
