...
---
# Diagnostiquer et résoudre les problèmes dans votre environnement Time Series Insights
<a id="diagnose-and-solve-problems-in-your-time-series-insights-environment" class="xliff"></a>

## Mes données ne s’affichent pas
<a id="i-dont-see-my-data" class="xliff"></a>
...
### Votre source d’événement ne contient pas de données au format JSON
<a id="your-event-source-doesnt-have-data-in-json-format" class="xliff"></a>
...
### Lorsque vous avez inscrit votre source d’événements, vous n’avez pas fourni la clé qui a l’autorisation requise
<a id="when-you-registered-your-event-source-you-didnt-provide-the-key-that-has-the-required-permission" class="xliff"></a>
...
### Le groupe de consommateurs fourni n’est pas exclusif à Time Series Insights
<a id="the-provided-consumer-group-is-not-exclusive-to-time-series-insights" class="xliff"></a>
...
## Mes données s’affichent, mais avec un décalage
<a id="i-see-my-data-but-theres-a-lag" class="xliff"></a>
...
### Votre environnement est sujet à des limitations
<a id="your-environment-is-getting-throttled" class="xliff"></a>
...
### Vous envoyez des données d’historique et causez un ralentissement en entrée
<a id="youre-pushing-historical-data-and-causing-slow-ingress" class="xliff"></a>
...
## Le paramètre *Nom de la propriété timestamp* de ma source d’événement ne fonctionne pas
<a id="my-event-sources-timestamp-property-name-setting-doesnt-work" class="xliff"></a>
