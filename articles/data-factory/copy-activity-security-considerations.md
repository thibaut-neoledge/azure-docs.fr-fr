---
title: "Considérations en matière de sécurité pour Azure Data Factory | Microsoft Docs"
...
---
# <a name="security-considerations-for-azure-data-factory"></a>Considérations en matière de sécurité pour Azure Data Factory
> [!div class="op_single_selector" title1="Select the version of Data Factory service you are using:"]
> * [Version 1 - Disponibilité générale](v1/data-factory-data-movement-security-considerations.md)
> * [Version 2 - Préversion](copy-activity-security-considerations.md)

> [!NOTE]
> Cet article s’applique à la version 2 de Data Factory, actuellement en préversion. Si vous utilisez la version 1 du service Data Factory, qui est généralement disponible (GA), consultez [Considérations en matière de sécurité de l’activité de copie dans V1](v1/data-factory-data-movement-security-considerations.md).
