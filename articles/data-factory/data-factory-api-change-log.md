...
## Version 4.9.1
_Date de lancement : 05/07/2016_
...
## Version 4.9.0
_Date de lancement : 10/06/2016_
...
## Version 4.8.0
_Date de lancement : 25/05/2016_
...
- Les types de service lié suivants ont été ajoutés en tant que sources de données pour les activités de copie :
	- [HdfsLinkedService](https://msdn.microsoft.com/library/azure/microsoft.azure.management.datafactories.models.hdfslinkedservice.aspx). Consultez la section [Transfert de données à partir d’un HDFS à l’aide d’Azure Data Factory](data-factory-hdfs-connector.md) pour obtenir des informations conceptuelles et des exemples.
