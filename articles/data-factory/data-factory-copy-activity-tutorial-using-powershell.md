...
# Didacticiel : Créer un pipeline Data Factory qui déplace les données à l’aide d’Azure PowerShell
...
### Créer un service lié pour une base de données Azure SQL
...
### Créer un jeu de données d’entrée
