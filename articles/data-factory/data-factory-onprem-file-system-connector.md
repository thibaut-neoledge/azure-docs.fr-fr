...
Format | Deux types de formats sont pris en charge : **TextFormat** et **AvroFormat**. Vous devez définir la propriété de type sous format sur l'une de cette valeur. Lorsque le format AvroFormat est le format du texte, vous pouvez spécifier des propriétés facultatives supplémentaires pour le format. Consultez la section format ci-dessous pour plus de détails. **La propriété de format n’est actuellement pas prise en charge pour les systèmes de fichiers locaux. Elle sera activée sous peu comme indiqué ici.** | Non
...
Si le format est défini sur **TextFormat**, vous pouvez spécifier les propriétés **facultatives** suivantes dans la section **Format** de **typeProperties**.
...
L’exemple suivant montre certaines des propriétés de format pour **TextFormat**.
...
Pour utiliser AvroFormat dans une table Hive suivante, reportez-vous au [didacticiel d’Apache Hive](https://cwiki.apache.org/confluence/display/Hive/AvroSerDe).
...
| Propriété | Description | Valeurs autorisées | Requis |
| -------- | ----------- | -------------- | -------- |
| copyBehavior | Cette propriété définit le comportement de copie lorsque la source est BlobSource ou FileSystem. | <p>Il existe trois valeurs possibles pour la propriété copyBehavior. </p><ul><li>**PreserveHierarchy :** conserve la hiérarchie des fichiers dans le dossier cible, c’est-à-dire que le chemin relatif du fichier source dans le dossier source est identique au chemin relatif du fichier cible dans le dossier cible.</li><li>**FlattenHierarchy :** tous les fichiers du dossier source figurent dans le premier niveau du dossier cible. Les fichiers cible ont un nom généré automatiquement.</li><li>**MergeFiles :** fusionne tous les fichiers du dossier source en un seul fichier. Si le nom de fichier/d’objet blob est spécifié, le nom du fichier fusionné est le nom spécifié. Dans le cas contraire, le nom du fichier est généré automatiquement.</li></ul> | Non |
...
--------- | ------------ | --------
true | preserveHierarchy | <p>Pour un dossier source nommé Dossier1 avec la structure suivante :</p> <p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier2<br/>&nbsp;&nbsp;&nbsp;&nbsp;Sous-dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier3<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier4<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier5</p>le dossier cible Dossier1 aura la même structure que le dossier source <p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier2<br/>&nbsp;&nbsp;&nbsp;&nbsp;Sous-dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier3<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier4<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier5</p>.  
true | flattenHierarchy | <p>Pour un dossier source nommé Dossier1 avec la structure suivante :</p> <p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier2<br/>&nbsp;&nbsp;&nbsp;&nbsp;Sous-dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier3<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier4<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier5</p>le dossier cible Dossier1 aura la même structure : <p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;nom généré automatiquement pour le Fichier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;nom généré automatiquement pour le Fichier2<br/>&nbsp;&nbsp;&nbsp;&nbsp;nom généré automatiquement pour le Fichier3<br/>&nbsp;&nbsp;&nbsp;&nbsp;nom généré automatiquement pour le Fichier4<br/>&nbsp;&nbsp;&nbsp;&nbsp;nom généré automatiquement pour le Fichier5</p>
true | mergeFiles | <p>Pour un dossier source nommé Dossier1 avec la structure suivante :</p> <p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier2<br/>&nbsp;&nbsp;&nbsp;&nbsp;Sous-dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier3<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier4<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier5</p>le dossier cible Dossier1 aura la structure suivante : <p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Les contenus Fichier1 + Fichier2 + Fichier3 + Fichier4 + Fichier5 seront fusionnés en un seul fichier avec un nom généré automatiquement</p>
false | preserveHierarchy | <p>Pour un dossier source nommé Dossier1 avec la structure suivante :</p> <p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier2<br/>&nbsp;&nbsp;&nbsp;&nbsp;Sous-dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier3<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier4<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier5</p>le dossier cible Dossier1 aura la structure suivante : <p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier2<br/></p><p>Sous-dossier1, où Fichier3, Fichier4 et Fichier5 ne sont pas sélectionnés.</p>
false | flattenHierarchy | <p>Pour un dossier source nommé Dossier1 avec la structure suivante :</p> <p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier2<br/>&nbsp;&nbsp;&nbsp;&nbsp;Sous-dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier3<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier4<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier5</p>le dossier cible Dossier1 aura la structure suivante :<p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;nom généré automatiquement pour Fichier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;nom généré automatiquement pour Fichier2<br/></p><p>Sous-dossier1, où Fichier3, Fichier4 et Fichier5 ne sont pas sélectionnés.</p>
false | mergeFiles | <p>Pour un dossier source nommé Dossier1 avec la structure suivante :</p> <p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Fichier2<br/>&nbsp;&nbsp;&nbsp;&nbsp;Sous-dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier3<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier4<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fichier5</p>le dossier cible Dossier1 aura la structure suivante :<p>Dossier1<br/>&nbsp;&nbsp;&nbsp;&nbsp;Les contenus Fichier1 + Fichier2 seront fusionnés en un seul fichier avec un nom généré automatiquement pour Fichier1</p><p>Sous-dossier1, où Fichier3, Fichier4 et Fichier5 ne sont pas sélectionnés.</p>
