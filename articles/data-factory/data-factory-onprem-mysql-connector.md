<properties 
	pageTitle="Connecteur MySQL - Déplacement de données à partir de MySQL" 
	description="En savoir plus sur le connecteur MySQL pour le service Data Factory qui vous permet de déplacer des données depuis une base de données MySQL" 
...
# Connecteur MySQL - Déplacement de données à partir de MySQL
...
1.	Un service lié de type OnPremisesMySql.
...
4.	Un pipeline avec une activité de copie qui utilise RelationalSource et BlobSink.
...
| Propriété | Description | Requis |
| -------- | ----------- | -------- |
| TableName | Nom de la table dans l'instance de base de données MySQL à laquelle le service lié fait référence. | Oui | 
