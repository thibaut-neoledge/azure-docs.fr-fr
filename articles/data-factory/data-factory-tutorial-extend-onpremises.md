<properties 
	pageTitle="Procédure pas à pas : Copie des données de sortie vers une base de données SQL Server (portail Azure)" 
...
# Procédure pas à pas : Copie des données de sortie vers une base de données SQL Server locale (portail Azure) 
