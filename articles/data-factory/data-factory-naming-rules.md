...
Services/tableaux/pipelines liés | Unique dans une fabrique de données. Les noms sont sensibles à la casse. | <ul><li>Nombre maximal de caractères dans un nom de tableau : 260.</li><li>Les noms d'objets doivent commencer par un numéro, une lettre ou un trait de soulignement (_).</li><li>Les caractères suivants ne sont pas autorisés : « . », « + », « ? », « / », « < », « > », « * », « % », « & », « : », « \\ »</li></ul> Groupe de ressources | Unique sur Microsoft Azure. Les noms ne respectent pas la casse. | <ul><li>Nombre maximal de caractères : 1000.</li><li>Un nom peut contenir des lettres, des chiffres et les caractères suivants : « - », « _ », « , » et « . ».</li></ul>
