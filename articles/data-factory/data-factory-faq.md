...
### Quel défi le client peut-il relever avec Data Factory ?
...
### quel est le public ciblé par Data Factory ?
...
### comment les clients accèdent-ils à Data Factory ?

Les clients peuvent accéder à Data Factory via le [portail Azure][azure-portal].
...
### quelles sont les sources de données et les activités prises en charge ?
