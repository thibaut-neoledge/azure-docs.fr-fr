...
En version publique, Data Factory sera uniquement disponible dans l'Ouest des États-Unis. Les services de calcul et de stockage utilisés par les fabriques de données peuvent être proposés dans d'autres régions.
...
- **Sources de données prises en charge :** 
	- Azure Storage (objets blob et tables)
	- Azure SQL
	- Document DB Azure
	- SQL Server local
	- Oracle local 
...
- **Activités prises en charge :** 
	- Copier une activité (de l'installation locale vers le cloud et du cloud vers l'installation locale)
	- Activité HDInsight (Pig, Hive, MapReduce, transformations de diffusion en continu Hadoop)
	- Activité de notation par lot d'Azure Machine Learning
	- Activité de procédure stockée Azure SQL
	- Activités .NET personnalisées.
