...
9. Sur la page **Spécifier la base de données SQL Azure** :
	...
	5. Cliquez sur **Next**.  
9. Sur la page **Mappage de table**, sélectionnez **emp** comme champ **Destination** dans la liste déroulante, cliquez sur **Flèche vers le bas** (facultatif) pour afficher le schéma et afficher un aperçu des données.
