...
> [!IMPORTANT]
> Ce script crée les fichiers JSON qui définissent les entités Data Factory (service lié, jeu de données et pipeline) sur votre disque dur dans le dossier c:\.
...
| [Get-AzureRmDataFactoryV2ActivityRun](/powershell/module/azurerm.datafactoryv2/get-azurermdatafactoryv2activityrun) | Obtient des détails sur l’exécution de l’activité (exécution d’activité) dans le pipeline. 
