...
Fournissez les données transformées issues du cloud aux sources locales, telles que SQL Server, ou conservez-les dans vos sources de stockage sur le cloud à des fins de consommation par les outils décisionnels (BI) et d’analyse et d’autres applications
