...
1. Créez un **service lié** pour votre stockage **Azure Storage**. Si les fichiers d’entrée et de sortie sont dans des comptes de stockage distincts, vous aurez besoin de deux services liés. Voici un exemple JSON :
...
4. Créez un **service lié** de type **AzureMLLinkedService** en fournissant la clé API et l’URL d’exécution par lot du modèle.
