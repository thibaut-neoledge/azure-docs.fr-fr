...
# Copier ou déplacer facilement des données avec l’Assistant de copie Azure Data Factory
...
## Un Assistant intuitif pour copier des données
...
### Filtrage des données dans une base de données
...
### Filtrage des données dans un dossier d’objets blob Azure
...
## Prise en charge de divers types d’objet et de données
