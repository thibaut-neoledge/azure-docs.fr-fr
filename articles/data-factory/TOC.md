...
### [Activités de déplacement des données](data-factory-data-movement-activities.md)
...
## [Didacticiel : Déplacer des données locales vers le cloud](data-factory-move-data-between-onprem-and-cloud.md)
## [Didacticiel : Créer et utiliser une activité personnalisée dans un pipeline](data-factory-use-custom-activities.md)

# Procédure
## Déplacer des données
### [Assistant Data Factory Copy](data-factory-copy-wizard.md)
### [Charger 1 To en 15 minutes avec l’Assistant copie de](data-factory-load-sql-data-warehouse.md)
### [activité de copie](data-factory-data-movement-activities.md)
### [Déplacement de données hybrides](data-factory-move-data-between-onprem-and-cloud.md)
### [Passerelle de gestion de données](data-factory-data-management-gateway.md)
### [Guide sur les performances et le réglage de l’activité de copie](data-factory-copy-activity-performance.md)
### [Stockage Blob Azure](data-factory-azure-blob-connector.md)
### [Tables Azure](data-factory-azure-table-connector.md)
...
## Développement
### [En passant par le portail Azure](data-factory-copy-activity-tutorial-using-azure-portal.md)
...
### [Utilisation d’un modèle Azure Resource Manager](data-factory-how-to-use-resource-manager-templates.md)
...
### [En passant par le portail Azure](data-factory-api-change-log.md)
### [Utilisation de l’application Surveillance et gestion](data-factory-monitor-manage-app.md)
...
### [Effectuer un déploiement à l’aide de modèles Azure Resource Manager](data-factory-how-to-use-resource-manager-templates.md)
# Référence 
