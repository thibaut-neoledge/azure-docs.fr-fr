...
14. (facultatif) Cliquez sur **Pipelines** dans la page d’accueil de l’élément **ADFTutorialDataFactory**, cliquez ensuite sur **ADFTutorialPipeline** dans le panneau **Pipelines**, puis extrayez les tables d’entrée (**Consumed**) ou les tables de sortie (**Produced**).
