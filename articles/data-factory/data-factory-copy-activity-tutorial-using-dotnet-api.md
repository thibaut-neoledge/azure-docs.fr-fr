<properties 
	pageTitle="Didacticiel : Créer un pipeline avec l’activité de copie à l’aide de l’API .NET | Microsoft Azure" 
...
3. Exécutez la commande suivante pour sélectionner l’abonnement que vous souhaitez utiliser. Remplacez **&lt;NameOfAzureSubscription**&gt; par le nom de votre abonnement Azure.
	...
	> [AZURE.IMPORTANT] Notez les éléments **SubscriptionId** et **TenantId** dans la sortie de cette commande.
...
5. Créez une application Azure Active Directory.
...
6. Créez le principal du service AD.

		New-AzureRmADServicePrincipal -ApplicationId $azureAdApplication.ApplicationId

7. Ajoutez le principal du service au rôle **Contributeurs de Data Factory**.

		New-AzureRmRoleAssignment -RoleDefinitionName "Data Factory Contributor" -ServicePrincipalName $azureAdApplication.ApplicationId.Guid

8. Récupérez l’ID de l’application.
...
6. Ajoutez la section **appSettings** suivante au fichier **App.config**. Ces valeurs sont utilisées par la méthode d’assistance **GetAuthorizationHeader**.
	...
	Remplacez les valeurs de **&lt;ID de l’application&gt;**, **&lt;Mot de passe&gt;**, **&lt;ID de l’abonnement&gt;** et **&lt;ID du locataire&gt;** par les vôtres.
...
8. Ajoutez le code suivant pour créer un **service lié Azure Storage** dans la méthode **Main**.
	...
	> [AZURE.IMPORTANT] Remplacez **storageaccountname** et **accountkey** par le nom et la clé de votre compte Azure Storage.
...
9. Ajoutez le code suivant pour créer un **service lié Azure SQL** dans la méthode **Main**.
	...
	> [AZURE.IMPORTANT] Remplacez **servername**, **databasename**, **username** et **password** par le nom de votre serveur SQL Azure, le nom de la base de données, le nom de l’utilisateur et le mot de passe.
...
14. Ajoutez à la méthode **Main** le code suivant pour obtenir les détails d’exécution d’une tranche de données.
...
13. Ajoutez à la classe **Program** la méthode d'assistance suivante utilisée par la méthode **Main**.
...
16. Vérifiez qu’il existe au moins un fichier dans le conteneur **adftutorial** de votre stockage d’objets blob Azure. Si tel n’est pas le cas, créez le fichier **Emp.txt** dans le bloc-notes avec le contenu suivant, puis chargez-le dans le conteneur adftutorial.
