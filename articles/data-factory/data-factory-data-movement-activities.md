...
Pour l'activité de copie, la section **typeProperties** varie selon le type de source et de récepteur. Cliquez sur une source/un récepteur dans la section [Sources/récepteurs pris en charge](#supported-data-stores) pour en savoir plus sur les propriétés de type prises en charge par l'activité de copie de ce magasin de données.
