...
---
# <a name="monitor-and-manage-azure-data-factory-pipelines-using-new-monitoring-and-management-app"></a>Surveiller et gérer les pipelines Azure Data Factory à l’aide de la nouvelle application de surveillance et gestion.
...
## <a name="launching-the-monitoring-and-management-app-a"></a>Lancer l’application de surveillance et gestion a
...
> [!NOTE]
> Si vous voyez que le navigateur web est bloqué au niveau « Autorisation... », désactivez/décochez l’option **Bloquer les cookies et les données de site tiers** (ou) laissez cette option activée et créez une exception pour **login.microsoftonline.com**, puis réessayez de lancer l’application.
> 
> 
...
## <a name="understanding-the-monitoring-and-management-app"></a>Présentation de l’application de surveillance et gestion
...
* **d’activités Windows** en bas du volet central.
* **Propriétés**/**Explorateur de fenêtres d’activité** dans le volet droit. 
...
## <a name="using-system-views"></a>Utiliser les vues système
...
## <a name="sorting-and-filtering-activity-windows"></a>Trier et filtrer les fenêtres d’activité
...
## <a name="performing-batch-actions"></a>Exécuter des actions batch
...
3. Sélectionnez **l’événement**, le **statut** et **l’état secondaire** (facultatif) dont vous souhaitez que le service Data Factory vous informe, puis cliquez sur **Suivant**. La page **Destinataires** doit s’afficher.
...
### <a name="to-editdeletedisable-an-alert"></a>Pour modifier, supprimer ou désactiver une alerte
