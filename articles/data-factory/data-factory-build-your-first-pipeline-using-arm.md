...
> [!IMPORTANT]
> Changez les valeurs des variables **storageAccountName** et **storageAccountKey**. Changez également **dataFactoryName**, car le nom doit être unique.
> 
> 
...
> [!NOTE]
> Vous pouvez trouver un autre exemple de modèle Resource Manager pour créer une fabrique de données Azure sur [Github](https://github.com/Azure/azure-quickstart-templates/blob/master/101-data-factory-blob-to-sql/azuredeploy.json).
> 
> 
...
3. Dans le panneau **Fabrique de données** de votre fabrique de données, cliquez sur **Diagramme**. ![Vignette du diagramme](./media/data-factory-build-your-first-pipeline-using-arm/DiagramTile.png)
