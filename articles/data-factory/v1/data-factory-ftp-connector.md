...
> * [Version 1 - Disponibilité générale](data-factory-ftp-connector.md)
> * [Version 2 - Préversion](../connector-ftp.md)

> [!NOTE]
> Cet article s’applique à la version 1 de Data factory, qui est généralement disponible (GA). Si vous utilisez la version 2 de Data Factory, disponible en préversion, consultez [Connecteur FTP dans V2](../connector-ftp.md).
