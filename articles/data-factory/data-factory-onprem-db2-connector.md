...
La passerelle de gestion des données fournit un pilote DB2 intégré qui prend en charge :

- SQLAM 9 / 10 / 11
- DB2 pour LUW (Linux, Unix, Windows)
- DB2 pour z/OS et DB2 pour i (aka AS/400)
...
> [AZURE.NOTE] Les noms de schéma et de table respectent la casse. Entourez les noms de "" (guillemets doubles) dans la requête.
