<properties 
	pageTitle="Connecteur DB2 - Déplacement de données à partir de DB2" 
	description="En savoir plus sur le connecteur DB2 pour le service Data Factory qui vous permet de déplacer des données depuis une base de données DB2" 
...
# Connecteur DB2 - Déplacement de données à partir de DB2
...
1.	Un service lié de type OnPremisesDb2.
...
5.	Un pipeline avec une activité de copie qui utilise RelationalSource et BlobSink. 
...
Dans le cas d’une activité de copie, lorsque la source est de type **RelationalSource**(qui inclut DB2), les propriétés suivantes sont disponibles dans la section typeProperties :
