...
À l'aide de l'URL et des clés API que vous avez copiées précédemment, spécifiez l'URL, clé d’administration et la clé de requête dans le fichier de configuration.
