...
[WACOM.INCLUDE [stockage-table](../includes/howto-table-storage.md)]
...
## <h2><a name="setup-connection-string"></a>Configuration d'une chaîne de connexion de stockage</h2>

[WACOM.INCLUDE [stockage-configuration-chaine-connexion](../includes/storage-configure-connection-string.md)]

## <h2> <a name="configure-access"> </a>Utilisation Accès au stockage de tables par programme</h2>
...
<h2><a name="create-table"></a>Utilisation Création d'une table</h2>
...
<h2><a name="add-entity"></a>Utilisation Ajout d'une entité à une table</h2>
...
<h2><a name="insert-batch"></a>Utilisation Insertion d'un lot d'entités</h2>
...
<h2><a name="retrieve-all-entities"></a>Utilisation Extraction de toutes les entités d'une partition</h2>
...
<h2><a name="retrieve-range-entities"></a>Utilisation Extraction d'un ensemble d'entités dans une partition</h2>
...
<h2><a name="retrieve-single-entity"></a>Utilisation Extraction d'une seule entité</h2>
...
<h2><a name="replace-entity"></a>Utilisation Remplacement d'une entité</h2>
...
<h2><a name="query-entity-properties"></a>Utilisation Interrogation d'un sous-ensemble de propriétés d'entité</h2>
...
<h2><a name="delete-entity"></a>Utilisation Suppression d'une entité</h2>
...
<h2><a name="delete-table"></a>Utilisation Suppression d'une table</h2>
...
<li>Pour plus d'informations sur les autres options de stockage de données dans Azure, consultez d'autres guides de fonctionnalités.
  <ul>
    ...
    <li>Utilisation du <a href="/fr-fr/documentation/articles/storage-dotnet-how-to-use-queues/">Stockage de files d'attente</a> pour stocker les données structurées.</li>
