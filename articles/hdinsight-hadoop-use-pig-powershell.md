...
2. Ouvrez une nouvelle invite **Microsoft Azure PowerShell**. Accédez à l'emplacement du fichier **pigjob.ps1**, puis utilisez les éléments suivants pour exécuter le script.
...
Cela renverra les informations écrites dans STDERR sur le serveur lors de l'exécution du travail et peut vous aider à déterminer la raison ou les raisons pour lesquelles la tâche échoue.
