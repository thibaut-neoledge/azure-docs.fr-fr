...
Le modèle du **niveau d'Azure Search** fait partie de la **Fondation**, qui est décrite en détail dans le document d'architecture CPIF. 
...
[Niveau d'Azure Search (pdf)](https://gallery.technet.microsoft.com/Cloud-Platform-Integration-e581d65d) 
