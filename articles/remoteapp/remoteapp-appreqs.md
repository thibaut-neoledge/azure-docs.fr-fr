...
Info : nous travaillons sur la création de quelques exemples d’applications fonctionnelles pour vous. Avant la fin du mois, vous verrez de nouvelles rubriques décrivant l’utilisation de Microsoft Access, QuickBooks et App-V dans RemoteApp.
