...
-------------
Téléchargez d’abord les applets de commande Azure Powershell [ici](http://go.microsoft.com/?linkid=9811175), qui incluent les applets de commande RemoteApp.

Consultez l'[aide pour l'applet de commande Azure RemoteApp](https://msdn.microsoft.com/library/mt428031.aspx).
...
3.	Exécutez **Add-AzureAccount** pour vous authentifier sur votre abonnement Azure. À l’invite, entrez le nom d’utilisateur et le mot de passe que vous utilisez pour vous connecter au portail Azure.  
