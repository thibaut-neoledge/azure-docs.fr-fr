...
> [!NOTE]
> Si vous ne pouvez pas faire vos propres tests de réseau ou si vous n’avez pas le temps de le faire, consultez nos [recommandations et estimations de base relatives à la bande passante réseau](remoteapp-bandwidthguidelines.md). Néanmoins, comme votre consommation peut varier, *exécutez* vos propres tests si vous en avez la possibilité.
> 
> 
