---
title: Utilisation de la redirection dans Azure RemoteApp | Microsoft Docs
...
### <a name="enable-usb-redirection-for-the-remoteapp-collection"></a>Activation de la redirection USB pour la collection RemoteApp
Utilisez l'applet de commande suivante pour activer la redirection USB au niveau de la collection :

    Set-AzureRemoteAppCollection -CollectionName <collection_name> -CustomRdpProperty "nusbdevicestoredirect:s:*"

### <a name="enable-usb-redirection-for-the-client-computer"></a>Activation de la redirection USB pour l'ordinateur client
