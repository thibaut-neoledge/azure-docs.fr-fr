---
title: SQL Azure avec Azure RemoteApp | Microsoft Docs
...
Commencez par la [Migration d’une base de données SQL Server vers une base de données Azure SQL Database](../sql-database/sql-database-cloud-migrate.md). 
