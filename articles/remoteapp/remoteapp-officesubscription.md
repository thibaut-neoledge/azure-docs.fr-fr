---
title: Utilisation de votre abonnement Office 365 avec Azure RemoteApp | Microsoft Docs
...
(Remarque : si votre déploiement Azure RemoteApp est fourni par un partenaire d’hébergement, ce dernier peut éventuellement vous fournir des licences Office dans le cadre d’un [contrat de licence de fournisseur de services](http://www.microsoft.com/en-us/Licensing/licensing-programs/spla-program.aspx))
...
Vous pouvez utiliser votre abonnement Office 365 pour activer et partager Office 2013 dans les déploiements Azure RemoteApp. Nous ne supportons pas actuellement l’utilisation d’autres versions d’Office avec Azure RemoteApp. Ceci inclut Office 2003, Office 2007, Office 2010 et Office 2016.
...
### <a name="use-the-azure-gallery-image"></a>Utilisation de l’image de galerie Azure
Pour déployer Office 365 ProPlus sur une collection, le plus simple est de [démarrer avec l’une des images de galerie Azure](remoteapp-image-on-azurevm.md) incluses dans votre abonnement Azure RemoteApp. Veillez à choisir l’image **Hôte de session Bureau à distance Windows Server avec Office 365 ProPlus préinstallé** . Ensuite, installez les autres applications souhaitées sur cette image, et vous êtes fin prêt.
...
### <a name="replace-your-image-with-the-latest-azure-gallery-image--add-customizations"></a>Remplacement de votre image avec la dernière image de galerie Azure et ajout de personnalisations
...
> [!IMPORTANT]
> N’oubliez pas : désactivez les mises à jour automatiques d’Office 365 ProPlus.
> 
> 
