...
Cet article vous fournit quelques extraits de code des opérations de base requises pour la migration de contenu. Pour découvrir des flux associés concernant certains types de rapports, consultez l’article [Comment migrer le contenu d’une collection d’espaces de travail Power BI Embedded vers Power BI](migrate-from-power-bi-workspace-collections.md#content-migration).

Un **outil de migration** est disponible pour vous aider à copier le contenu de collections d’espace de travail Power BI vers Power BI Embedded, en particulier dans le cas d’un contenu volumineux. Pour plus d’informations, consultez l’article [Utiliser l’outil de migration de Power BI Embedded](migrate-tool.md).
...
## <a name="export-report-from-a-power-bi-workspace-collection-workspace"></a>Exporter un rapport à partir d’un espace de travail de collection d’espaces de travail Power BI
...
## <a name="import-report-to-power-bi-embedded"></a>Importer un rapport vers Power BI Embedded
...
## <a name="extract-directquery-connection-string-from-power-bi-workspace-collections"></a>Extraire une chaîne de connexion DirectQuery à partir des collections d’espaces de travail Power BI

Ce code s’applique à la mise à jour du PBIX après la migration vers Power BI Embedded.
...
## <a name="update-directquery-connection-string-in-power-bi-embedded"></a>Mettre à jour une chaîne de connexion DirectQuery dans Power BI Embedded
...
## <a name="set-directquery-credentials-in-power-bi-embedded"></a>Définir les informations d’identification DirectQuery dans Power BI Embedded
...
Dans cet extrait de code, nous supposons que le jeu de données transmissible figure déjà dans un espace de travail d’application dans Power BI. Pour plus d’informations sur l’API Push, consultez l’article [Transmission de données à un jeu de données Power BI](https://powerbi.microsoft.com/documentation/powerbi-developer-walkthrough-push-data/).
...
Pour plus d’informations sur le processus de migration, consultez l’article [Guide pratique pour migrer du contenu Collections d’espaces de travail Power BI vers Power BI Embedded](migrate-from-power-bi-workspace-collections.md).
