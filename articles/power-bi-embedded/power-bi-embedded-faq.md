...
# <a name="power-bi-embedded-faq"></a>Forum Aux Questions de Power BI Embedded

## <a name="what's-your-most-recent-announcement-about-power-bi-embedded?"></a>Quelle est votre annonce la plus récente sur Power BI Embedded ?
...
## <a name="who-would-want-to-use-microsoft-power-bi-embedded,-and-why?"></a>À qui et en quoi Microsoft Power BI Embedded peut-il être utile ?
...
## <a name="how-does-power-bi-embedded-relate-to-the-power-bi-service?"></a>Quelle est la relation entre Power BI Embedded et le service Power BI ?
...
## <a name="how-does-power-bi-embedded-improve-my-app?"></a>De quelle façon Power BI Embedded améliore-t-il mon application ?
...
## <a name="are-there-any-rules-or-restrictions-about-how-i-can-use-power-bi-embedded-in-my-app?"></a>L’utilisation de Power BI Embedded dans mon application est-elle soumise à certaines règles ou limitations ?
...
## <a name="can-power-bi-embedded-be-used-to-create-internal-applications?"></a>Est-il possible d’utiliser Power BI Embedded pour créer des applications internes ?
...
## <a name="is-this-service-available-globally?"></a>Ce service est-il disponible partout dans le monde ?
...
## <a name="what-is-the-available-sla-for-the-service?"></a>Quel est le contrat SLA disponible pour le service ?
...
## <a name="do-you-offer-any-tools-or-guidance-to-help-me-estimate-how-many-renders/session-i-should-expect?-how-will-i-know-how-many-renders-have-been-completed?"></a>Fournissez-vous des outils ou une assistance pour m’aider à estimer le nombre de rendus/session ? Comment suivre le nombre de rendus réalisés ?
...
## <a name="do-i-need-a-power-bi-subscription-in-order-to-develop-applications-with-power-bi-embedded?-how-do-i-get-started?"></a>Ai-je besoin d’un abonnement Power BI pour développer des applications avec Power BI Embedded ? Comment faire pour démarrer ?
...
## <a name="i-have-an-azure-subscription.-can-i-use-power-bi-embedded-using-my-existing-subscription?"></a>J’ai un abonnement Azure. Puis-je utiliser Power BI Embedded dans le cadre de cet abonnement ?
...
## <a name="how-does-user-authentication-work-with-power-bi-embedded?"></a>Comment les utilisateurs sont-ils authentifiés par Power BI Embedded ?
