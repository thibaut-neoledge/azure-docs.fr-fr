<properties
   pageTitle="Interagir avec des rapports Power BI à l’aide de l’API JavaScript | Microsoft Azure"
...
## Que pouvez-vous faire avec l’API JavaScript de Power BI ?
...
### Accéder aux pages d’un rapport
