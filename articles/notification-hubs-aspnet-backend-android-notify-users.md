...
> [AZURE.NOTE] Ce didacticiel part du principe que vous avez créé et configuré votre concentrateur de notification comme décrit dans [Prise en main de Notification Hubs (Android)](/fr-fr/documentation/articles/notification-hubs-android-get-started/). 
