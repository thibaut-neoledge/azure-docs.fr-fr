...
Cette rubrique explique comment utiliser [Docker](https://www.docker.com/) avec [machine](https://github.com/docker/machine) et l'[interface de ligne de commande multiplateforme Azure](https://github.com/Azure/azure-xplat-cli) pour créer une machine virtuelle Azure afin de gérer rapidement et facilement des conteneurs Linux à partir d'un ordinateur exécutant Ubuntu. À fin d'illustration, le didacticiel montre comment déployer l'[image Docker Hub busybox](https://registry.hub.docker.com/_/busybox/) et l'[image Docker Hub nginx](https://registry.hub.docker.com/_/nginx/) et configurer le conteneur pour acheminer les requêtes web vers le conteneur nginx. (La documentation Docker **machine** décrit comment modifier ces instructions pour d'autres plateformes.)
...
2. [L'interface de ligne de commande multiplateforme Azure](https://github.com/Azure/azure-xplat-cli)
...
1. Créez un dossier local puis, sur la ligne de commande, accédez à ce dossier et tapez :
	...
	Tenez-vous prêt à saisir le mot de passe pour exporter votre certificat et le mémoriser pour un usage futur. Saisissez ensuite :
...
2. Téléchargez le fichier .cer de votre certificat sur Azure. Dans le [portail Azure](https://manage.windowsazure.com), cliquez sur **Paramètres** dans la partie inférieure gauche de la zone de service (voir ci-dessous)
	...
	puis cliquez sur **Certificats de gestion** 
...
Nous pouvons voir que docker a affecté le port 80 du conteneur au port 49153 de la machine virtuelle. Nous pouvons à présent utiliser l'interface de ligne de commande multiplateforme pour mapper le port public 80 du service cloud externe au port 49153 de la machine virtuelle. Docker vérifie ensuite que le trafic tcp entrant sur le port 49153 de la machine virtuelle est acheminé vers le conteneur nginx. 
...
## Étapes suivantes
Accédez au [guide de l'utilisateur Docker](https://docs.docker.com/userguide/) et créez des applications sur Microsoft Azure. Ou bien, expérimentez [**docker** et [swarm](https://github.com/docker/swarm) sur Azure](https:azure.microsoft.com/documentation/articles/virtual-machines-docker-swarm/) et découvrez comment swarm peut être utilisé avec docker et Azure.
