<properties urlDisplayName="Notify iOS app users by using Mobile Services" pageTitle="Inscription de l'utilisateur actif aux notifications Push au moyen d'un service mobile - Notification Hubs" metaKeywords="application d'inscription Azure, Notification Hubs, notifications Push Azure, application iOS notification Push" description="Learn how to request push notification registration in an iOS app with Azure Notification Hubs when registeration is performed by Azure Mobile Services." metaCanonical="" services="mobile-services,notification-hubs" documentationCenter="" title="Register the current user for push notifications by using a mobile service" authors="yuaxu" solutions="" manager="dwrede" editor="" />
