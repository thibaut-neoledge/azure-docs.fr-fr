<properties urlDisplayName="details" pageTitle="Détails du centre vidéo" metaKeywords="" description="" metaCanonical="" services="" documentationCenter="" title="How to Use ASP.NET Web Forms Output Caching with Azure Websites" authors="sdanie" solutions="" manager="wpickett" editor="" />
...
<h2><a id="configureproject"></a>Configuration du projet ASP.NET</h2>
...
<h2><a id="useoutputcaching"></a>Utilisation de la mise en cache de sortie</h2>
...
[installed the latest]: http://www.windowsazure.com/fr-fr/downloads/?sdk=net
