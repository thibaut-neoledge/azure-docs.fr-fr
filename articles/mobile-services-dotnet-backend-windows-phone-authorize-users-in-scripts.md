...
[.NET principal](/fr-fr/documentation/articles/mobile-services-dotnet-backend-windows-phone-authorize-users-in-scripts/ ".NET principal") | [JavaScript principal](/fr-fr/documentation/articles/mobile-services-windows-phone-authorize-users-in-scripts/ "JavaScript principal")
...
Ce didacticiel est basé sur le démarrage rapide de Mobile Services et s'appuie sur le didacticiel précédent [Prise en main de l'authentification](/fr-fr/documentation/articles/mobile-services-dotnet-backend-windows-phone-get-started-users). Avant de commencer, vous devez suivre le didacticiel [Prise en main de l'authentification](/fr-fr/documentation/articles/mobile-services-dotnet-backend-windows-phone-get-started-users).
...
1.  Dans Visual Studio 2013 pour Windows Phone, ouvrez le projet que vous avez modifié en suivant le didacticiel [Prise en main de l'authentification](/fr-fr/documentation/articles/mobile-services-dotnet-backend-windows-phone-get-started-users).
