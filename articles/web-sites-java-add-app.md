...
Une fois que vous avez initialisé votre site web Java comme indiqué dans [Prise en main de Microsoft Azure Web Sites et de Java][Prise en main de Microsoft Azure Web Sites et de Java], vous pouvez télécharger votre application en plaçant votre fichier WAR dans le dossier **webapps**.
