...
![Comparaison des fonctionnalités de l'authentification multi-facteur Azure][]

**Ressources supplémentaires**

-   [Inscription à Azure en tant qu'organisation][]
-   [Identité Azure][]
-   [Bibliothèque Azure Multi-Factor Authentication][]
