<properties 
	pageTitle="Ajout de la pagination de données (iOS) | Centre de développement mobile" 
	description="Découvrez comment utiliser la pagination pour gérer la quantité de données renvoyées vers votre application iOS à partir de Mobile Services." 
