...
-   Isolation du réseau pour utilisation avec [Azure Connect](http://msdn.microsoft.com/fr-fr/library/windowsazure/gg433122.aspx) et [Réseau virtuel Azure](http://msdn.microsoft.com/fr-fr/library/windowsazure/jj156007.aspx).
-   Accès Bureau à distance pour le débogage et le diagnostic avancé.
-   Mises à niveau propagées avec [Échange d'adresses IP virtuelles](http://msdn.microsoft.com/fr-fr/library/windowsazure/ee517253.aspx "échange d'adresses IP virtuelles"). Cette fonction échange le contenu de votre déploiement intermédiaire et de votre déploiement de production.
...
Pour plus d'informations sur le choix entre Sites Web Azure et Azure Cloud Services, consultez la page [Modèles d'exécution Azure](http://www.windowsazure.com/fr-fr/manage/windows/fundamentals/compute/).
