...
Création d'un espace de noms de serviceCréation d'un espace de noms de service
------------------------------------------------------------------------------
...
Obtention des informations d'identification de gestionObtention des informations d'identification de gestion par défaut pour l'espace de noms
---------------------------------------------------------------------------------------------------------------------------------------------
...
Exposition et consommation d'un service Web SOAPUtilisation de Service Bus pour exposer et consommer un service Web SOAP avec TCP
---------------------------------------------------------------------------------------------------------------------------------
...
3.  Ajoutez le package **Azure Service Bus NuGet** aux deux projets. Cela a pour effet d'ajouter toutes les références d'assembly nécessaires à vos projets.
