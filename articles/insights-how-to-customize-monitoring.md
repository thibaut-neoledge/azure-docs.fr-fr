...
1.  Dans la [version préliminaire du portail Azure][], cliquez sur **Browse**, puis sur une ressource de surveillance qui vous intéresse.
2.  Le filtre **Monitoring** contient les mesures les plus importantes pour chaque ressource Azure. Par exemple, les sites web proposent des options pour les demandes, les erreurs, les [tests web][] et les [analyses][]. Cliquez sur **Requests and errors today** pour afficher le volet **Metric**.  
    ![Filtre Monitoring][]
