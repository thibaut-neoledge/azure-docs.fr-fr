...
Le portail de gestion Azure permet de créer un projet d'équipe sur Visual Studio Online et de configurer votre application Web pour le déploiement continu sur un site Web.
