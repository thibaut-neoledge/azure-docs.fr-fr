...
-   Utilisation de listes de contrôle d’accès réseau sur les points de terminaison
...
-   [Installation et configuration de Symantec Endpoint Protection sur une machine virtuelle Azure][Installation et configuration de Symantec Endpoint Protection sur une machine virtuelle Azure]
-   [Installation et configuration de Trend Micro Deep Security comme service sur une machine virtuelle Azure][Installation et configuration de Trend Micro Deep Security comme service sur une machine virtuelle Azure]
-   [Déploiement de solutions anti-programmes malveillants sur des machines virtuelles Azure][Déploiement de solutions anti-programmes malveillants sur des machines virtuelles Azure]

## Utilisation de listes de contrôle d’accès réseau sur les points de terminaison de machine virtuelle
