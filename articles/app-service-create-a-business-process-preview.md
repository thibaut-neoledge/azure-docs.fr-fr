...
La répétition permet de prendre une liste d'éléments et d'exécuter l'action pour chaque élément de la liste. Pour utiliser la répétition, cliquez sur l'icône de flèche circulaire en haut de l'action. Vous ouvrez ainsi une zone de texte et tapez :
...
Pour définir les paramètres, accédez à l'objet parameters {} et ajoutez ce qui suit à l'intérieur :
    "emailAddress" : {
	    "type" : "string",
...
Les paramètres représentent un bon moyen d'extraire des valeurs que vous êtes susceptible de beaucoup modifier.
