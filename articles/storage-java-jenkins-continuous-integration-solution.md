...
-   [Présentation de Jenkins][Présentation de Jenkins]
-   [Avantages de l'utilisation du service BLOB][Avantages de l'utilisation du service BLOB]
-   [Configuration requise][Configuration requise]
-   [Utilisation du service BLOB avec Jenkins CI][Utilisation du service BLOB avec Jenkins CI]
...
## <a name="overview"></a><span class="short header">Présentation</span>Présentation de Jenkins
...
Pour plus d'informations sur Jenkins, consultez la page de [présentation de Jenkins][présentation de Jenkins].

## <a name="benefits"></a><span class="short header">Avantages</span>Avantages de l'utilisation du service BLOB
...
## <a name="prerequisites"></a><span class="short header">Configuration requise</span>Configuration requise
...
## <a name="howtouse"></a><span class="short header">Utilisation du service BLOB</span>Utilisation du service BLOB avec Jenkins CI
...
## <a name="howtoinstall"></a><span class="short header">Installation</span>Installation du plug-in Azure Storage
...
## <a name="howtoconfigure"></a><span class="short header">Configuration</span>Configuration du plug-in Azure Storage pour l'utilisation de votre compte de stockage
...
## <a name="howtocreatepostbuild"></a><span class="short header">Création d'une action post-build</span>Création d'une action post-build qui télécharge vos artefacts de build sur votre compte de stockage
...
## <a name="components"></a><span class="short header">Composants du service BLOB</span>Composants utilisés par le service BLOB
