<properties urlDisplayName="Jenkins Continuous Integration" pageTitle="Utilisation d'Azure Storage avec une solution d'intégration continue Jenkins | Microsoft Azure" metaKeywords="" description="Ce didacticiel décrit l'utilisation du service BLOB Azure comme référentiel d'artefacts de build créés par une solution d'intégration continue Jenkins." metaCanonical="" services="storage" documentationCenter="Java" title="Using Azure Storage with a Jenkins Continuous Integration solution" authors="robmcm" solutions="" manager="wpickett" editor="mollybos" scriptId="" videoId="" />
