<properties pageTitle="Utilisation de Media Services" description="" services="media-services" documentationCenter="" authors="juliako" manager="dwrede" editor=""/>
...
Vous pouvez également programmer Media Services à l'aide des API REST basées sur OData. Vous pouvez créer une application qui passe des appels d'API REST à Media Services à partir des langages .NET ou d'autres langages de programmation. Une documentation complète sur la programmation à l'aide de l'API REST de Media Services est disponible dans la rubrique [Création d'applications avec l'API REST d'Azure Media Services](http://go.microsoft.com/fwlink/?linkid=252967). 

Pour programmer avec l'API REST de Media Services ou le Kit de développement logiciel (SDK) de Media Services, commencez par activer votre compte Azure pour Media Services, comme décrit dans la section [Configuration d'un compte Azure pour Media Services][].
...
À présent que vous en savez un peu plus sur Media Services, consultez la rubrique [Configuration de votre ordinateur pour Media Services](../media-services-set-up-computer/).
  ...
  [WCF Data Services 5.0 pour OData V3]: http://www.microsoft.com/download/en/details.aspx?id=29306
  ...
  [Version préliminaire de Media Services :  Fonctionnalités prises en charge]: http://social.msdn.microsoft.com/Forums/fr-fr/MediaServices/thread/eb946433-16f2-4eac-834d-4057335233e0
  [Futures versions de Media Services :  Prise en charge de fonctionnalités planifiée]: http://social.msdn.microsoft.com/Forums/fr-fr/MediaServices/thread/431ef036-0939-4784-a939-0ecb31151ded
