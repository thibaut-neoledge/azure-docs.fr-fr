...
* **Redéploiement après incident**: dans cette approche, l’application est redéployée de toutes pièces au moment de l’incident. Cette stratégie est appropriée pour les applications non critiques qui ne nécessitent pas une garantie de délai de récupération.
...
### <a name="geo-replication-pricing:"></a>Tarif de géoréplication :
...
## <a name="web-apps-checklist"></a>Liste de contrôle de Web Apps
...
## <a name="mobile-services-checklist"></a>Liste de contrôle des services mobiles
