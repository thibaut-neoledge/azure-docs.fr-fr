---
title: "Guide technique de la résilience Azure pour la récupération suite à une corruption de données ou à une suppression accidentelle | Microsoft Docs"
...
---
# <a name="azure-resiliency-technical-guidance-recovery-from-data-corruption-or-accidental-deletion"></a>Guide technique de la résilience Azure : récupération suite à une corruption de données ou à une suppression accidentelle
...
### <a name="blob-and-table-storage-backup"></a>Sauvegarde d’objets blob et Table Storage
...
## <a name="checklists-for-data-corruption-or-accidental-deletion"></a>Listes de contrôle pour la corruption ou la suppression accidentelle des données
