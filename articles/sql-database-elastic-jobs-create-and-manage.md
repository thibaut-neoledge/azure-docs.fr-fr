...
* Installation des composants du service de tâches de bases de données élastiques. Voir [Installation du service de tâches de bases de données élastiques](vsql-database-elastic-jobs-service-installation.md).
