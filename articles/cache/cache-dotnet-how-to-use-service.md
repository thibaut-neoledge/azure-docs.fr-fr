...
Pour plus d'informations sur l'utilisation du fournisseur d'état de session du Service de cache géré, consultez la rubrique [Fournisseur d'état de session pour Azure Cache][Fournisseur d'état de session pour Azure Cache].
...
* Apprenez comment migrer vers Service de cache géré : [Migration vers Service de cache géré][Migration vers Service de cache géré]
