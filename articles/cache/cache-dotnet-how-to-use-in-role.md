...
Ce guide offre un aperçu de la prise en main de In-Role Cache. Pour plus d'informations sur les fonctions qui ne sont pas présentées dans ce guide de prise en main, consultez la page [À propos de In-Role Cache pour le Cache Microsoft Azure][À propos de In-Role Cache pour le Cache Microsoft Azure].
...
Pour plus d'informations sur l'utilisation du fournisseur de l'état de session du service de mise en cache, consultez la page [Fournisseur de l'état de session pour In-Role Cache][Fournisseur de l'état de session pour In-Role Cache].
