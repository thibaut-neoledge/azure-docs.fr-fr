...
1. Accédez à la page d’accueil du [portail Azure en version préliminaire] et cliquez sur **Marketplace**.
	...
	![Marketplace dans le portail Azure en version préliminaire](./media/app-service-api-connect-your-app-to-saas-connector/marketplace.png)

2. Recherchez Dropbox, puis cliquez sur l’icône **Connecteur Dropbox**.

	![Cliquez sur Connecteur Dropbox](./media/app-service-api-connect-your-app-to-saas-connector/searchdb.png)
...
9. <a id="gateway"></a>Conservez la valeur par défaut « DropboxConnector » comme **nom** du connecteur, puis cliquez sur **Créer**.
	...
	![Cliquez sur créer](./media/app-service-api-connect-your-app-to-saas-connector/createdropbox.png)
...
3. Après la création du connecteur par Azure, cliquez sur **Parcourir > Groupes de ressources > DropboxRG**.
	...
	![Schéma du groupe de ressources](./media/app-service-api-connect-your-app-to-saas-connector/rgdiagram.png)
...
1. Accédez au [portail des développeurs Dropbox](https://www.dropbox.com/developers/apps), cliquez sur **App Console**, puis sur **Create App**.
	...
	![Créer une application Dropbox](./media/app-service-api-connect-your-app-to-saas-connector/dbappcreate.png)
...
3. Cliquez sur **Create app**.
	...
	![Créer une application Dropbox](./media/app-service-api-connect-your-app-to-saas-connector/dbapiapp.png)
	...
	![Créer une application Dropbox](./media/app-service-api-connect-your-app-to-saas-connector/dbappsettings.png)
...
4. Cliquez sur **Paramètres**, et dans le panneau **Paramètres**, cliquez sur **Authentification**.
	...
	![Cliquez sur Paramètres](./media/app-service-api-connect-your-app-to-saas-connector/clicksettings.png)

	![Cliquez sur Authentification](./media/app-service-api-connect-your-app-to-saas-connector/clickauth.png)
...
5. Dans le panneau d’authentification, entrez l’ID client et la clé secrète client du site Dropbox, puis cliquez sur **Enregistrer**.
	...
	![Entrez les paramètres et cliquez sur Enregistrer](./media/app-service-api-connect-your-app-to-saas-connector/authblade.png)
...
3. Copiez l’**URI de redirection** (la zone grise au-dessus de la clé secrète client et de l’ID client) et ajoutez cette valeur à la page que vous avez laissée ouverte à l’étape précédente.
	...
	![Obtenir un URI de redirection](./media/app-service-api-connect-your-app-to-saas-connector/redirecturi.png)

	![Créer une application Dropbox](./media/app-service-api-connect-your-app-to-saas-connector/dbappsettings2.png)
...
2. Dans le panneau **Paramètres de l’application**, définissez le **Niveau d’accès** sur **Public (authentifié)**, puis cliquez sur **Enregistrer**.
	...
	![Définir la valeur Public (authentifié)](./media/app-service-api-connect-your-app-to-saas-connector/pubauth.png)
...
2. Accédez à l’URL de connexion de la passerelle et du fournisseur d’authentification que vous avez configurés. L’URL suit ce modèle : 
	...
	![URL de la passerelle](./media/app-service-api-connect-your-app-to-saas-connector/gatewayurl.png)
...
1. Dans la fenêtre du navigateur qui contient le message « Connexion terminée », accédez aux outils de développement du navigateur et recherchez le cookie `x-zumo-auth`. Laissez cette fenêtre ouverte afin de pouvoir copier la valeur du cookie à l’étape suivante.
	...
	![Copiez le jeton](./media/app-service-api-connect-your-app-to-saas-connector/copytoken.png)
...
4. Dans une nouvelle fenêtre ou un nouvel onglet du navigateur, créez et envoyez une demande HTTP Post à la passerelle pour demander une URL de consentement. Ajoutez le jeton `x-zumo-auth` comme en-tête HTTP.
	...
	![Envoyez l’URL de consentement](./media/app-service-api-connect-your-app-to-saas-connector/sendforconsent.png)
	...
	![URL de consentement](./media/app-service-api-connect-your-app-to-saas-connector/getconsenturl.png)
...
4. Cliquez sur l’icône **Définition de l’API** pour afficher les méthodes d’API disponibles dans le connecteur.
	...
	![Panneau Application API](./media/app-service-api-connect-your-app-to-saas-connector/apiappblade.png)

	![Définition de l’API](./media/app-service-api-connect-your-app-to-saas-connector/apidef.png)
...
3. Par exemple, si l’URL de votre connecteur est https://dropboxrg784237ad3e7.azurewebsites.net et que vous souhaitez voir les fichiers du dossier de votre blog, l’URL est :
	...
	![Obtenir la réponse à une demande de dossier](./media/app-service-api-connect-your-app-to-saas-connector/dbresponse.png)

## Étapes suivantes

Vous avez vu comment installer, configurer et tester un connecteur SaaS. Pour plus d’informations, consultez la page [Utilisation de connecteurs](app-service-logic-use-biztalk-connectors.md).
