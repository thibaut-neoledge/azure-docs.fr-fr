...
Pour utiliser Cloud9, vous devez d'abord visiter le site Web et [prendre un abonnement](http://cloud9ide.com/). Vous pouvez vous connecter avec un compte GitHub ou BitBucket, ou bien créer un compte Cloud9. Il existe aussi un abonnement gratuit, ainsi qu'une offre payante qui comporte plus d'options. Pour plus d'informations, consultez le site Web [IDE Cloud9](http://cloud9ide.com/).
