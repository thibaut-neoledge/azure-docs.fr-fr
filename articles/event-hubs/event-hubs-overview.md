---
title: "Vue d’ensemble d’Azure Event Hubs | Microsoft Docs"
...
![Hubs d'événements](./media/event-hubs-overview/IC759857.png)
...
![Hubs d'événements](./media/event-hubs-overview/IC759858.png)
...
![Hubs d'événements](./media/event-hubs-overview/IC759859.png)
...
## <a name="capacity-and-security"></a>Capacité et sécurité
...
Pour obtenir des informations de tarification détaillées, consultez la page [Tarification des hubs d’événements](https://azure.microsoft.com/pricing/details/event-hubs/).
