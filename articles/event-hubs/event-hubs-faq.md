<properties 
    pageTitle="Forum Aux Questions (FAQ) sur Event Hubs | Microsoft Azure"
...
## <a name="can-i-use-a-single-amqp-connection-to-send-and-receive-from-event-hubs-and-service-bus-queues/topics?"></a>Puis-je utiliser une connexion AMQP unique pour l’envoi et la réception à partir de Event Hubs et de files d’attente/rubriques Service Bus ?
