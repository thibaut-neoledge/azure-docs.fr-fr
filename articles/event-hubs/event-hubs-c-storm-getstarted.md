...
> [AZURE.NOTE] Dans le cadre de ce didacticiel, utilisez exclusivement Storm en mode local destiné au développement. Pour plus d’informations sur les déploiements et les modèles Storm, voir la [Présentation de Storm HDInsight] et la documentation [Apache Storm] officielle.
...
- [Développement d’applications de traitement de données de diffusion avec SCP.NET et C# sur Storm et HDInsight][] décrit la marche à suivre pour écrire des pipelines Storm en C#.
