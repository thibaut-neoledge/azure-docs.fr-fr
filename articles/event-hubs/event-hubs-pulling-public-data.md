...
3. La chaîne de connexion Service Bus et le nom du hub d’événements dans cet espace de noms Service Bus, auquel vous transmettez les données. Ces informations sont disponibles dans le portail Azure Classic.
