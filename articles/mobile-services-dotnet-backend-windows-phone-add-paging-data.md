<properties 
	pageTitle="Ajout d'une pagination aux données (Windows Phone) | Centre de développement mobile" 
	description="Découvrez comment utiliser la pagination pour gérer la quantité de données renvoyées vers votre application Windows Phone à partir de Mobile Services." 
