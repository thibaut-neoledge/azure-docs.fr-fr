...
1. Modifiez le fichier de configuration yum (/etc/yum.conf) et mettez en commentaire l’exclusion des mises à jour des en-têtes de noyau (\# exclude=kernel\*). Cette étape est nécessaire pour installer le compilateur gcc.
2. Installez les packages requis :
   ...
   yum install epydoc
   ```
3. Téléchargez la bibliothèque Proton :
   ...
   ```
4. Extrayez le code Proton de l'archive de distribution :
   
   ```
   tar xvfz qpid-proton-0.9.tar.gz
   ```
5. Générez et installez le code à l'aide de la procédure suivante, extraite du fichier Lisez-moi :
