---
title: Vue d’ensemble d’AMQP de Service Bus avec Java | Microsoft Docs
...
---
# <a name="amqp-1.0-support-in-service-bus"></a>Prise en charge d’AMQP 1.0 dans Service Bus
...
## <a name="introduction:-what-is-amqp-1.0-and-why-is-it-important?"></a>Introduction : qu’est-ce qu’AMQP 1.0 ? En quoi ce protocole est-il important ?
...
## <a name="amqp-1.0-technical-features"></a>Fonctionnalités techniques d’AMQP 1.0
...
## <a name="amqp-1.0-is-a-standard-(with-a-capital-'s')"></a>AMQP 1.0 est une Norme (avec une majuscule N)
...
## <a name="amqp-1.0-and-service-bus"></a>AMQP 1.0 et Service Bus
...
Pour plus d’informations sur l’obtention et l’utilisation de ces bibliothèques avec Service Bus, consultez le [Guide du développeur AMPQ Service Bus][Guide du développeur AMPQ Service Bus]. Consultez la section [Étapes suivantes](service-bus-java-amqp-overview.md#next-steps) pour obtenir une liste de liens permettant d’accéder à d’autres informations.
...
* [Guide du développeur AMPQ Service Bus][Guide du développeur AMPQ Service Bus]
