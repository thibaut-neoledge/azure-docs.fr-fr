<properties
    pageTitle="Utilisation des rubriques Service Bus (Ruby | Microsoft Azure"
...
> [AZURE.NOTE]
> Pour obtenir cette clé, vous pouvez également ouvrir une session sur le [portail Azure][] et accéder aux informations de connexion de votre espace de noms.
...
Les rubriques et les abonnements sont persistants et doivent être supprimés de façon explicite par le biais du [portail Azure][] ou par programme. L’exemple suivant montre comme supprimer la rubrique intitulée « test-topic ».
