...
* [Créer un espace de noms Event Hubs avec Event Hub et un groupe de consommateurs à l’aide d’un modèle Azure Resource Manager](../event-hubs/event-hubs-resource-manager-namespace-event-hub.md)
