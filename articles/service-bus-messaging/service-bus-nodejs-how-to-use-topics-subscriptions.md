<properties 
    pageTitle="Utilisation des rubriques Service Bus avec Node.js | MicrosoftAzure" 
...
## <a name="create-a-node.js-application"></a>Création d’une application Node.js
...
Les rubriques et les abonnements sont persistants et doivent être supprimés de façon explicite par le biais du [portail Azure Classic][] ou par programme.
