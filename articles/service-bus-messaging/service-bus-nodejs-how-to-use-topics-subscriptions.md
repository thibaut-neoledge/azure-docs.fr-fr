...
Les rubriques et les abonnements sont persistants et doivent être supprimés de façon explicite par le biais du [portail Azure Classic][] ou par programme. L’exemple suivant montre comment supprimer la rubrique `MyTopic` :
