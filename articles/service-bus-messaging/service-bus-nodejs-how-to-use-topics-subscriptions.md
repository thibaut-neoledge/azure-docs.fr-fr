...
Pour un exemple de configuration des variables d’environnement dans le [portail Azure Classic][portail Azure Classic] pour un site web Azure, consultez [Application web Node.js avec Storage][].
