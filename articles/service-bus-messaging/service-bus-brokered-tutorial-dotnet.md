...
### <a name="create-a-receiver-and-receive-messages-from-the-queue"></a>Créer un récepteur et recevoir les messages de la file d'attente
...
### <a name="end-the-queue-method-and-clean-up-resources"></a>Terminer la méthode Queue et nettoyer les ressources
...
### <a name="call-the-queue-method"></a>Appeler la méthode Queue
...
### <a name="build-the-queuesample-application"></a>Générer l’application QueueSample
