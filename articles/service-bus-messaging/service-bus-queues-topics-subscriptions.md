---
title: "Présentation des files d’attente de messagerie, des rubriques et des abonnements Service Bus | Microsoft Docs"
...
Pour plus d’informations sur les valeurs de filtre possibles, consultez la documentation des classes [SqlFilter](https://docs.microsoft.com/dotnet/api/microsoft.servicebus.messaging.sqlfilter) et [SqlRuleAction](https://docs.microsoft.com/dotnet/api/microsoft.servicebus.messaging.sqlruleaction). Consultez également les exemples [Brokered Messaging: Advanced Filters](http://code.msdn.microsoft.com/Brokered-Messaging-6b0d2749) (Messagerie répartie : Filtres avancés) et [Topic Filters](https://github.com/Azure-Samples/azure-servicebus-messaging-samples/tree/master/TopicFilters) (Filtres de rubrique).
