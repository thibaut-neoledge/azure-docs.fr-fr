...
Pour le modèle complet, consultez le [modèle de règle d’autorisation d'espace de noms Service Bus][modèle de règle d’autorisation d'espace de noms Service Bus] sur GitHub.
