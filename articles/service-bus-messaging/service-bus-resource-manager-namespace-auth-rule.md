...
Pour connaître le modèle complet, consultez le [modèle de règle d’autorisation d’espace de noms Service Bus][] sur GitHub.
...
- [Authentification et de autorisation Service Bus](../service-bus/service-bus-authentication-and-authorization.md)
