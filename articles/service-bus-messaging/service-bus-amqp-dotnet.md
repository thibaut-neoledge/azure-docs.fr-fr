...
# <a name="using-service-bus-from-.net-with-amqp-1.0"></a>Utilisation de Service Bus à partir de .NET avec AMQP 1.0
...
## <a name="configuring-.net-applications-to-use-amqp-1.0"></a>Configuration des applications .NET pour utiliser AMQP 1.0
...
### <a name="configuration-using-app.config"></a>Configuration à l’aide d’App.config
...
Où `[namespace]` et `SharedAccessKey` sont obtenus sur le [portail Azure][]. Pour plus d’informations, consultez [Prise en main des files d’attente Service Bus][].
