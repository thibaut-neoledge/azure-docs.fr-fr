...
> [AZURE.NOTE] Pour obtenir cette clé, vous pouvez également ouvrir une session sur le [portail Azure](https://portal.azure.com/) et accéder aux informations de connexion pour votre espace de noms Service Bus.
