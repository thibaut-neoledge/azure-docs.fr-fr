---
title: Utilisation d’AMQP 1.0 avec l’API .NET Service Bus | Microsoft Docs
...
---
# <a name="how-to-use-amqp-1.0-with-the-service-bus-.net-api"></a>Utilisation d’AMQP 1.0 avec l’API .NET Service Bus
...
## <a name="code-.net-applications"></a>Codage des applications .NET
...
### <a name="configure-the-service-bus-connection-string"></a>Configuration de la chaîne de connexion de Service Bus
...
Où `[namespace]` et `[SAS key]` sont obtenus sur le [portail Azure][portail Azure]. Pour plus d’informations, consultez la page [Utilisation des files d’attente Service Bus][].
...
### <a name="configure-the-entity-name"></a>Configuration du nom d’entité
...
### <a name="a-simple-.net-application-using-a-service-bus-queue"></a>Une simple application .NET utilisant une file d’attente Service Bus
...
À l’aide de l’exemple d’application .NET décrit ci-dessus et d’une application Java similaire extraite d’un manuel complémentaire, [Utilisation de l’API Java Message Service (JMS) avec Service Bus et AMQP 1.0](service-bus-java-how-to-use-jms-api-amqp.md), il est possible d’échanger des messages entre .NET et Java. 

Pour plus d’informations sur les détails de la messagerie interplateforme utilisant Service Bus et AMQP 1.0, consultez [Prise en charge d’AMQP 1.0 dans Service Bus](service-bus-amqp-overview.md).
