...
---
# <a name="how-to-use-amqp-10-with-the-service-bus-net-api"></a>Utilisation d’AMQP 1.0 avec l’API .NET Service Bus
...
### <a name="configure-via-appconfig"></a>Configuration via App.config
