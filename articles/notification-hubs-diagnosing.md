...
1. **Utilisez le portail Azure**
	...
	d) Si vous avez mal configuré les paramètres d'authentification du concentrateur de notification, vous verrez une erreur d'authentification PNS. Il s'agit d'une bonne indication vous poussant à vérifier les informations d'identification PNS. 
