<properties pageTitle="Ajout de la pagination aux données (JavaScript) | Azure Mobile Services" metaKeywords="" description="Découvrez comment utiliser la pagination pour gérer la quantité de données renvoyées vers votre application Windows Store JavaScript à partir de Mobile Services." metaCanonical="http://www.windowsazure.com/fr-fr/develop/mobile/tutorials/add-paging-to-data-dotnet/" services="mobile-services" documentationCenter="Mobile" title="Refine Mobile Services queries with paging" authors="glenga" solutions="" manager="dwrede" editor="" />
