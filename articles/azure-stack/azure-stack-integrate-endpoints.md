...
|Portail (administrateur)|`Adminportal.[Region].[External FQDN]`|HTTPS|443|
...
|Key Vault (utilisateur)|`*.vault.[Region].[External FQDN]`|TCP<br>TCP|443<br>12490|
|Key Vault (administrateur)|`*.adminvault.[Region].[External FQDN]`|TCP<br>TCP|443<br>12492|
