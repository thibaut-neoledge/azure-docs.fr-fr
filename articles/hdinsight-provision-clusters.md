...
1.  Créez un certificat auto-signé utilisé pour authentifier les demandes. Vous pouvez utiliser IIS ou [makecert][makecert] pour créer le certificat.
