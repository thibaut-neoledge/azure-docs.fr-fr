...
Pour plus d'informations sur les fonctions, les avantages et les capacités d'Azure Virtual Network, consultez la rubrique [Présentation du réseau virtuel](http://msdn.microsoft.com/library/azure/jj156007.aspx).

> [WACOM.NOTE] Vous devez créer un Azure Virtual Network avant d'approvisionner un cluster HDInsight. Pour plus d'informations, consultez la rubrique [Tâches de configuration du réseau virtuel](http://msdn.microsoft.com/fr-fr/library/azure/jj156206.aspx).
>
...
> [WACOM.NOTE] Actuellement, seules les régions **Est de l'Asie**, **Asie du Sud-Est**, **Europe du Nord**, **Europe de l'Ouest**, **Est des États-Unis**, **Ouest des États-Unis**, **Nord du centre des États-Unis** et **Sud du centre des États-Unis** peuvent héberger des clusters HDInsight.
...
3. Dans la page **Détails du cluster**, tapez ou sélectionnez les valeurs suivantes :
...
5. Sur la page **Configurer l'utilisateur du cluster**, entrez les valeurs suivantes :
	...
	>[WACOM.NOTE] La base de données SQL Azure utilisée pour le metastore doit autoriser la connectivité aux autres services Azure, y compris Azure HDInsight. Sur le côté droit du tableau de bord de la base de données Azure SQL, cliquez sur le nom du serveur. Il s'agit du serveur sur lequel l'instance de base de données SQL est exécutée. Une fois sur l'affichage du serveur, cliquez sur **Configurer** puis, pour **Windows Azure Services**, cliquez sur **Oui** et sur **Enregistrer**.
...
**Installation de l'interface de ligne de commande au moyen de NPM**
...
**Installation de l'interface de ligne de commande au moyen de Windows Installer**
...
**Téléchargement et importation de paramètres de publication**
...
- À partir de la fenêtre d'invite de commandes, exécutez la commande suivante pour créer un compte Azure Storage :
	...
	À l'invite demandant d'indiquer un emplacement, sélectionnez l'endroit où approvisionner un cluster HDINsight. Le stockage doit se trouver dans le lieu que le cluster HDInsight. Actuellement, seules les régions **Est de l'Asie**, **Asie du Sud-Est**, **Europe du Nord**, **Europe de l'Ouest**, **Est des États-Unis**, **Ouest des États-Unis**, **Nord du centre des États-Unis** et **Sud du centre des États-Unis** peuvent héberger des clusters HDInsight.  
...
Pour savoir comment obtenir des informations avec le portail de gestion, consultez la section * Affichage, copie et régénération de clés d'accès de stockage* de la rubrique [Création, gestion ou suppression d'un compte de stockage][azure-create-storageaccount].
...
**Affichage de la liste et des détails du cluster**
...
Créez un certificat auto-signé, installez-le sur votre poste de travail et téléchargez-le dans votre abonnement Azure. Pour obtenir des instructions, consultez la rubrique [Création d'un certificat auto-signé](http://go.microsoft.com/fwlink/?LinkId=511138).
...
[hdinsight-sdk-documentation]: http://msdn.microsoft.com/fr-fr/library/dn479185.aspx
[hdinsight-hbase-custom-provision]: http://azure.microsoft.com/fr-fr/documentation/articles/hdinsight-hbase-get-started/
...
[hdi-remote]: http://azure.microsoft.com/fr-fr/documentation/articles/hdinsight-administer-use-management-portal/#rdp
