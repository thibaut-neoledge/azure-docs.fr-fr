<properties urlDisplayName="Request Azure Store Integration" pageTitle="Envoi de courriers électroniques à l'aide de SendGrid à partir de Java dans un déploiement Azure" metaKeywords="" description="" metaCanonical="" services="" documentationCenter="" title="How to Send Email Using SendGrid from Java in an Azure Deployment" authors="robmcm" solutions="" manager="wpickett" editor="mollybos" videoId="" scriptId="" />
...
Déployez votre application sur l'émulateur de calcul, puis dans un navigateur, exécutez emailform.jsp, entrez les valeurs dans le formulaire, cliquez sur **Envoyer ce courrier électronique**, puis consultez les résultats dans sendemail.jsp.
