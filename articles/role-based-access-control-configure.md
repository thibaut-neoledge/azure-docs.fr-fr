...
<tr class="even">
<td align="left">
Collaborateur (autorise toutes les actions, à l'exception des affectations de rôles d'écriture et de suppression)
...
<tr class="odd">
<td align="left">
Lecteur (autorise toutes les actions de lecture)
...
Toutefois, le nouveau modèle RBAC n'est pris en charge que par les API de la version préliminaire du portail Azure et du gestionnaire des ressources Azure. Les utilisateurs et services qui se voient affecter des rôles RBAC ne peuvent pas accéder aux API du portail de gestion Azure ni aux API de gestion des services. Ajouter un utilisateur au rôle Propriétaire d'un abonnement dans la version préliminaire du portail Azure ne fait pas de cet utilisateur un coadministrateur de l'abonnement dans la version complète du portail Azure.
