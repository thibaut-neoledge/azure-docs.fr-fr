...
3. Si vous avez téléchargé le modèle exporté et les scripts, trouvez le fichier **deploy.ps1** (pour PowerShell) ou **deploy.sh** (pour l’interface de ligne de commande Azure).
