...
#Gestion d'Azure Cloud Services à l'aide d'Azure Automation
...
Consultez le [didacticiel de prise en main d'Azure Automation](../automation/automation-create-runbook-from-samples.md)
