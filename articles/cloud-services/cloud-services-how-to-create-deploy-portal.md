...
## Étape 3 : création d’un service cloud et téléchargement du package de déploiement

1. Connectez-vous au [portail Azure en version préliminaire][]. 
2. Cliquez sur **New**, puis sur **Compute**, puis faites défiler vers le bas et cliquez sur **Cloud Service**.

    ![Publier votre service cloud](media/cloud-services-how-to-create-deploy-portal/create-cloud-service.png)

3. Dans le nouveau panneau **Cloud Service**, entrez une valeur pour le **nom DNS**
4. Créez un **groupe de ressources**ou sélectionnez-en un existant.
5. Sélectionnez un **Emplacement**.
6. Sélectionnez **Package**, et dans le panneau **Télécharger un package**, renseignez les champs requis.  
      
     (Si un de vos rôles contient une seule instance, assurez-vous que l'option **Deploy even if one or more roles contain a single instance** est cochée.)

7. Assurez-vous que **Start deployment** est *coché*.
8. Cliquez sur **OK**. 
...
9. Sélectionnez **Certificats**, et sur le panneau **Ajouter des certificats**, sélectionnez le fichier .pfx du certificat SSL et renseignez le **mot de passe**pour le certificat, 
10. Cliquez sur **Attach certificate**, puis sur **OK** dans le panneau **Ajouter des certificats**.
...
2. Sous **Essentials**, cliquez sur l'**URL du site** pour ouvrir le service cloud dans un navigateur Web.
