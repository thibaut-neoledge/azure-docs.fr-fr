...
* Création d'un compte de stockage Azure
  ...
  > [!NOTE]
  > Notez votre ID d’abonnement Azure. Il vous sera utile par la suite. Vous trouverez ces informations dans le portail Azure Classic en cliquant sur **Paramètres** > **Abonnements**.
  > 
  > 
...
2. Cliquez sur **Calcul** > **Service cloud** > **Création rapide**.
...
4. Pour confirmer l’exécution des instances de rôle, dans le [portail Classic](https://manage.windowsazure.com), cliquez sur **Services cloud** > *le_nom_de_votre_service_cloud* > **Instances**.
...
4. Pour confirmer la non-exécution des instances de rôle, cliquez sur **Services cloud** > *le_nom_de_votre_service_cloud* > **Instances** dans le [portail Classic](https://manage.windowsazure.com). Aucune instance n'est déployée dans l'environnement de production.
