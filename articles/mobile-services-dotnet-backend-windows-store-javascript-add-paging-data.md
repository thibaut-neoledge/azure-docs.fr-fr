<properties 
	...
	description="Découvrez comment utiliser la pagination pour gérer la quantité de data returned to your Windows Store JavaScript app from Mobile Services." 
