...
Vous avez besoin d’un cluster DC/OS ACS pour suivre les étapes de ce didacticiel. Le cas échéant, cet [exemple de script](./scripts/container-service-cli-deploy-dcos.md) peut en créer un pour vous.
