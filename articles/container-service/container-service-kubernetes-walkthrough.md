...
# <a name="azure-container-service---kubernetes-walkthrough"></a>Azure Container Service - Procédure pas à pas Kubernetes
...
Cette procédure pas à pas suppose que vous avez installé et configuré [Azure CLI v. 2.0](/cli/azure/install-az-cli2). Vous devez également avoir une clé publique SSH RSA sur `~/.ssh/id_rsa.pub`. Si vous n’en avez pas, consultez les étapes pour [OS X et Linux](../virtual-machines/virtual-machines-linux-mac-create-ssh-keys.md) ou [Windows](../virtual-machines/virtual-machines-linux-ssh-from-windows.md).
