...
* L’[Interface de ligne de commande (CLI) Microsoft Azure].
...
> [!NOTE]
>
> En raison des exigences de la virtualisation de ce didacticiel, vous ne pouvez pas suivre les étapes décrites dans cet article sur une machine virtuelle. Vous devez utiliser un ordinateur physique et activer les fonctionnalités de virtualisation.
>
...
[Interface de ligne de commande (CLI) Microsoft Azure]: /cli/azure/overview
