...
> [!TIP]
> La [procédure pas à pas Kubernetes](container-service-kubernetes-walkthrough.md) montre comment utiliser `az acs create` avec les valeurs par défaut pour créer un cluster Kubernetes.
>
