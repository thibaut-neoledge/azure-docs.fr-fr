<properties 
	pageTitle="Gestion des travaux Azure Media Services" 
...
Un **travail** contient des métadonnées sur le traitement à effectuer. Chaque **travail** se compose d'une ou plusieurs **tâches**, qui spécifient une tâche de traitement atomique, ses ressources d'entrée, ses ressources de sortie, un processeur multimédia et les paramètres associés. Pour plus d'informations sur les paramètres d'encodage, consultez Guides d'encodage et Schémas d'encodage.
...
##Manipulation des travaux/tâches
...
[Quotas et limitations] :(../media-services-quotas-and-limitations) décrit les quotas utilisés et les limitations de l'Encodeur de Media Services
