...
Pour obtenir un nombre précis d'unités de demande pour votre application, vous pouvez utiliser la calculatrice correspondante pour calculer les unités de demande consommées pour diverses opérations. Vous pouvez également inspecter l'en-tête de réponse x-ms-request-charge qui inclut le nombre d'unités de demande consommées pour une demande donnée.

[Calculatrice d'unités de demande](http://go.microsoft.com/fwlink/?LinkID=510088)
