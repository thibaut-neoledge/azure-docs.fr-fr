<properties 
	pageTitle="Ajout d'une pagination aux données (Android) | Centre de développement mobile" 
	description="Découvrez comment utiliser la pagination pour gérer la quantité de données renvoyées vers votre application Android à partir de Mobile Services." 
