...
![Option de menu Publier le projet](./media/app-service-dotnet-publish-api-app/20-publish-gesture-v3.png)

Cliquez sur l’onglet **Profil** et sur **Microsoft Azure API Apps (version préliminaire)**.

![Boîte de dialogue Publier le site web](./media/app-service-dotnet-publish-api-app/21-select-api-apps-for-deployment-v2.png)

Cliquez sur **Nouveau** pour configurer une nouvelle application API dans votre abonnement Azure.

![Boîte de dialogue de sélection des services API existants](./media/app-service-dotnet-publish-api-app/23-publish-to-apiapps-v3.png)
...
![Boîte de dialogue de configuration de l’application web Microsoft Azure](./media/app-service-dotnet-publish-api-app/24-new-api-app-dialog-v3.png)
...
![Message de confirmation de la création du service de l’API](./media/app-service-dotnet-publish-api-app/25-api-provisioning-started-v3.png)
...
![Notification d’état via la fenêtre Activité d’Azure App Service](./media/app-service-dotnet-publish-api-app/26-provisioning-success-v3.png)
...
![Déploiement de l’application API](./media/app-service-dotnet-publish-api-app/26-5-deployment-success-v3.png)

La fenêtre **Activité d’Azure App Service** affiche la progression du déploiement.

![Notification d’état de la fenêtre Activité d’Azure App Service](./media/app-service-dotnet-publish-api-app/26-5-deployment-success-v4.png)
...
![Parcourir les options sur le portail Azure](./media/app-service-dotnet-publish-api-app/27-browse-in-portal-v3.png)

Sélectionnez l'API que vous avez créée dans la liste des applications API dans votre abonnement.

![Liste des applications API](./media/app-service-dotnet-publish-api-app/28-view-api-list-v3.png)
...
![Définition de l’API](./media/app-service-dotnet-publish-api-app/29-api-definition-v3.png)
...
![Ajout de la méthode Post au contrôleur](./media/app-service-dotnet-publish-api-app/30-post-method-added-v3.png)

Dans l’**Explorateur de solutions**, cliquez avec le bouton droit sur le projet, puis sélectionnez **Publier**.

![Menu contextuel de publication du projet](./media/app-service-dotnet-publish-api-app/31-publish-gesture-v3.png)
...
![Paramètres Publier le site web](./media/app-service-dotnet-publish-api-app/36.5-select-debug-option-v3.png)

Sous l’onglet **Aperçu** de l’Assistant **Publier le site web**, cliquez sur **Publier**.

![Boîte de dialogue Publier le site web](./media/app-service-dotnet-publish-api-app/39-re-publish-preview-step-v2.png)
...
![Définition de l’API](./media/app-service-dotnet-publish-api-app/38-portal-with-post-method-v4.png)
