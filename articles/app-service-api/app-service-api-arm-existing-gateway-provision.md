...
Pour accéder au modèle complet, voir [Application API avec le nouveau modèle de passerelle](https://github.com/tfitzmac/AppServiceTemplates/blob/master/existing-gateway-existing-plan-new-apiapp.json).
