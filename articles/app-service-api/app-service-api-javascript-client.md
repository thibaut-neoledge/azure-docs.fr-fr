...
1. La dernière étape pour activer CORS consiste à délimiter les méthodes d’action individuelles que vous voulez activer. Ajoutez l’attribut **EnableCors** à chacune des méthodes ou sur la totalité du contrôleur, comme illustré dans le code ci-dessous.
	...
	> **Remarque** : l’utilisation des caractères génériques pour tous les paramètres avec l’attribut EnableCors est destinée uniquement à des fins de démonstration. Elle ouvre votre API à toutes les origines et à toutes les requêtes HTTP. Utilisez cet attribut avec précaution et assurez-vous d’en comprendre les implications.
