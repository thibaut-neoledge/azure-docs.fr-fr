...
-   [Inscription pour l'obtention d'un compte AppDynamics][]
-   [Téléchargement de l'agent .NET à partir d'AppDynamics][]
-   [Ajout de l'agent .NET aux rôles Azure et modification du démarrage][]
-   [Publication de l'application instrumentée avec AppDynamics sur Azure][]
...
1.  Cliquez sur **Try Free** ou **S'inscrire** pour AppDynamics sur Azure Marketplace à l'adresse [][]<https://datamarket.azure.com/browse/Applications></a>.
...
Les mises à jour les plus récentes pour ce document sont disponibles dans sa version wiki à l'adresse [][1]<http://docs.appdynamics.com/display/ADAZ/How+To+Use+AppDynamics+for+Windows+Azure></a>.
