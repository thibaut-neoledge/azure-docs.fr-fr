---
title: "Déploiement du portail de l&quot;utilisateur pour le serveur Azure Multi-Factor Authentication"
...
### <a name="install-the-user-portal"></a>Installation du portail de l'utilisateur
...
* Si un pare-feu ou un proxy inverse est assis devant le serveur web du portail de l’utilisateur et effectue un déchargement SSL, vous pouvez modifier le fichier web.config du portail de l’utilisateur et ajouter la clé suivante à la section <appSettings> pour que le portail de l’utilisateur puisse utiliser http au lieu de https. <add key="SSL_REQUIRED" value="false"/>
...
## <a name="passed-sessions"></a>Sessions précédentes
## <a name="saml"></a>SAML
...
## <a name="trusted-ips"></a>Adresses IP de confiance
...
> [!NOTE]
> Pour utiliser l'application Azure Multi-Factor Authentication, l'utilisateur doit activer les notifications push sur son appareil.
> 
> 
