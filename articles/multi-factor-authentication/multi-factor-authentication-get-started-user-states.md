...
7. **Cochez** la case en regard du nom des utilisateurs.
8. Sur la droite, cliquez sur **Désactiver**. ![Désactiver l’utilisateur](./media/multi-factor-authentication-get-started-user-states/userstate2.png)
9. Un message apparaît, vous invitant à confirmer votre décision. Cliquez sur **Oui**. ![Désactiver l’utilisateur](./media/multi-factor-authentication-get-started-user-states/userstate3.png)
10. Vous verrez si l’opération s’est terminée correctement. Cliquez sur **Fermer** ![Désactiver l’utilisateur](./media/multi-factor-authentication-get-started-user-states/userstate4.png).
