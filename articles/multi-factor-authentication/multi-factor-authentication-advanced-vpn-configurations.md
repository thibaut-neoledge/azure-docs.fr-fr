...
L'authentification multifacteur Azure permet la connexion de façon transparente avec un large éventail de solutions VPN tierces. Cela inclut l'appareil Cisco® ASA VPN, l'appareil Citrix NetScaler SSL VPN et l'appareil Juniper Networks Secure Access/Pulse Secure Connect Secure SSL VPN.
