---
title: Authentification LDAP et serveur Azure Multi-Factor Authentication
...
17. En cas de liaison vers un autre répertoire LDAP ou pour modifier les mappages d’attributs préconfigurés, cliquez sur le bouton Modifier… .
