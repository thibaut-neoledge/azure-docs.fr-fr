...
Si vous souhaitez utiliser votre téléphone professionnel comme méthode de contact principale, vous pouvez utiliser cet article. Il vous guide dans la configuration de l’authentification multifacteur pour utiliser votre téléphone professionnel comme méthode de contact pour un appel.

## Pour utiliser votre téléphone professionnel comme méthode de contact

<ol>
<li>Sélectionnez Téléphone professionnel dans la liste déroulante.</li>
...
<li>Cliquez sur le bouton Vérifier maintenant. Un appel est passé à votre téléphone. Assurez-vous que ce dernier est près de vous. <li>Cliquez sur Suivant</li> <li>À ce stade, vous avez configuré votre méthode de contact et il est temps de définir les mots de passe d’application pour les applications sans navigateur comme Outlook 2010 ou antérieur. Si vous n’utilisez pas ces applications, cliquez sur **Terminé**. Sinon, passez à l'étape suivante. <li>Si vous utilisez ces applications, copiez alors le mot de passe d’application fourni.</li>
