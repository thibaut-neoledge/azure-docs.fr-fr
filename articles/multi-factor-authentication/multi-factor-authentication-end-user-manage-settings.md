...
Lorsque vous contactez le support, il est recommandé de fournir les informations suivantes :
 ...
 - **ErrorCode** : le code d'erreur que vous recevez.
...
5. Ceci vous amènera à la page qui vous permet de modifier vos paramètres. ![O365](./media/multi-factor-authentication-end-user-manage/o365b.png)
...
4. Ceci vous amènera à la page qui vous permet de modifier vos paramètres. ![Vérification](./media/multi-factor-authentication-end-user-manage-azure/proofup.png)
