...
# Modification des paramètres avec Azure Multi-Factor Authentication
Les informations suivantes sont fournies pour vous aider à gérer vos paramètres d’authentification multifacteur.

## La procédure à suivre dépend de votre utilisation de l’authentification multifacteur
Il existe plusieurs endroits différents où vous pouvez modifier vos paramètres d’authentification multifacteur. Celui que vous choisissez dépend de la façon dont vous utilisez l’authentification multifacteur. Choisissez celle qui vous correspond le mieux.
...
[Je ne sais pas](#changing-your-settings-with-the-myapps-portal)|Cela signifie que vous souhaitez vous connecter à [http://myapps.microsoft.com](http://myapps.microsoft.com) et modifier votre paramètre ici.
...
![Paramétrage](./media/multi-factor-authentication-end-user-manage-myapps/proofup.png)
...
3. Dans la liste déroulante, sélectionnez Vérification de sécurité supplémentaire. ![Paramétrage](./media/multi-factor-authentication-end-user-manage/azure1.png)
4. Cette opération vous amènera sur la page qui vous permet de modifier vos paramètres. ![Paramétrage](./media/multi-factor-authentication-end-user-manage-azure/proofup.png)
