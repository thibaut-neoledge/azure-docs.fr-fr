...
---
# <a name="choose-the-azure-multifactor-authentication-solution-for-you"></a>Choisissez la solution Azure Multi-Factor Authentication qui vous convient
...
| Emplacement de l'utilisateur | Multi-Factor Authentication dans le cloud | Serveur Multi-Factor Authentication |
| --- |:---:|:---:|
