...
Pas de panique. Cela signifie simplement que votre organisation souhaite prendre des mesures supplémentaires pour s’assurer que vous êtes bien celui ou celle que vous prétendez être lorsque vous vous connectez. Ces vérifications se font à l’aide d'une combinaison de votre nom d'utilisateur, de votre mot de passe et d’un numéro de téléphone.  

La première chose que vous avez à faire est de terminer le processus d'inscription.  Mais avant de commencer ce processus, vous avez quelques choix à faire.
...
> [!NOTE]
> Le support de votre entreprise peut désactiver une ou plusieurs de ces options.  Dans ce cas, ces options ne seront pas disponibles pendant le processus d’inscription.  
