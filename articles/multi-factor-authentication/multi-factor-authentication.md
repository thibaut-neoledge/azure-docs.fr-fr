<properties
    pageTitle="Vue d’ensemble d’Azure MFA | Microsoft Azure"
...
>[AZURE.NOTE] Ce tableau de comparaison répertorie les fonctionnalités de chaque abonnement. Si vous avez Azure AD Premium ou Enterprise Mobility Suite, la disponibilité de certaines fonctionnalités varie selon que vous utilisez [MFA dans le cloud ou localement](multi-factor-authentication-get-started.md).
