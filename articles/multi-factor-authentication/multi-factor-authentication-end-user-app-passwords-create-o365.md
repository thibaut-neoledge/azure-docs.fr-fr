...
# Création de mots de passe d’application dans le portail Office 365 pour Azure Multi-Factor Authentication

Si vous utilisez l’authentification multifacteur avec Office 365, vous souhaitez créer des mots de passe d’application par le biais du portail Office 365.
