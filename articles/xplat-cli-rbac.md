...
-   Quel rôle vous souhaitez affecter : vous pouvez utiliser l'applet de commande suivant pour afficher les définitions de rôles prises en charge.
...
Et donc, lorsque vous tentez d'exécuter un autre applet de commande tel que `azure group create`, vous recevez une erreur d’accès refusé si vous ne disposez pas de l'autorisation requise.
