<properties pageTitle="Optimisation des performances MySQL sur les machines virtuelles Linux Azure" description="Apprenez à optimiser MySQL sur une machine virtuelle Azure exécutant Linux." services="virtual-machines" documentationCenter="" authors="NingKuang" manager="timlt" editor="tysonn"/>
...
Les étapes suivantes montrent comment créer RAID sur Azure à l'aide du portail de gestion Windows Azure. Vous pouvez également configurer RAID à l'aide de scripts Windows PowerShell. 
...
Pour les disques de données, la propriété **Préférence de cache hôte** doit être définie comme **aucune**.  
...
[http://azure.microsoft.com/fr-fr/documentation/articles/virtual-machines-linux-configure-RAID/](http://azure.microsoft.com/fr-fr/documentation/articles/virtual-machines-linux-configure-RAID/)
