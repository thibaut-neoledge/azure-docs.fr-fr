...
- Un graphique qui résume l'utilisation du site Web sous forme de mesures de certains indicateurs.mesure de l'utilisation de l'UC du site Web
 ...
 <br />**Remarque :**
vous pouvez ajouter des indicateurs de performance supplémentaires sur la page de gestion **Monitor** en choisissant **Add Metrics** en bas de cette page. Pour plus d'informations, consultez la page [Surveillance des sites Web](http://www.windowsazure.com/fr-fr/manage/services/web-sites/how-to-monitor-websites/).
...
-   Une section **Quick Glance** qui comprend les informations résumées suivantes ainsi que des liens (en fonction de vos paramètres, il se peut que certaines options mentionnées ci-dessous ne s'affichent pas) :
 ...
 - **Compute Mode** : spécifie si le site Web fonctionne en mode Gratuit, Partagé, Basique ou Standard. Pour plus d'informations sur les modes de groupe d'échelle Web , consultez la page [Mise à l’échelle d’un site Web](http://www.windowsazure.com/fr-fr/manage/services/web-sites/how-to-scale-websites).
...
Pour plus d'informations sur la configuration d'un site Web, consultez la page [Configuration des sites Web](http://www.windowsazure.com/fr-fr/manage/services/web-sites/how-to-configure-websites).
...
Pour plus d'informations sur la configuration des options d'échelle, consultez la page [Mise à l’échelle d’un site Web](http://www.windowsazure.com/fr-fr/manage/services/web-sites/how-to-scale-websites).
