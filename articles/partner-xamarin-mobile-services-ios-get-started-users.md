<properties urlDisplayName="Get Started with Authentication (Xamarin.iOS)" pageTitle="Prise en main de l'authentification (Xamarin.iOS) - Mobile Services" metaKeywords="inscription de l'application Azure, authentification Azure, authentification de l'application, authentification des services mobiles, Mobile Services Xamarin.iOS" description="Découvrez comment utiliser l'authentification dans votre application Azure Mobile Services pour Xamarin.iOS." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile"  services="mobile-services" title="Get started with authentication in Mobile Services" manager="dwrede" authors="donnam" />
