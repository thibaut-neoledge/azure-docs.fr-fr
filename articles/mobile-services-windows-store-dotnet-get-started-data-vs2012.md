...
-   [Guide de fonctionnement Mobile Services .NET][]
  ...
  [regarder le didacticiel]: http://channel9.msdn.com/Series/Windows-Azure-Mobile-Services/Windows-Store-app-Getting-Started-with-Data-Connecting-your-app-to-Windows-Azure-Mobile-Services
  [Prise en main des données dans Mobile Services]: /fr-fr/develop/mobile/tutorials/get-started-with-data-dotnet/
