<properties urlDisplayName="Django with Visual Studio" pageTitle="Didacticiel Django avec Visual Studio (Python) - Azure" metaKeywords="Azure Django web app, Azure Django virtual machine" description="Didacticiel qui vous apprend &agrave; cr&eacute;er une application web Django h&eacute;berg&eacute;e sur une machine virtuelle Azure." metaCanonical="" services="cloud-services" documentationCenter="Python" title="Cr&eacute;ation d'applications Django avec Python&nbsp;Tools for Visual&nbsp;Studio&nbsp;1.5" authors="huvalo" solutions="" manager="wpickett" editor="" />
...
**Remarque :** ce didacticiel est également encapsulé dans une [vidéo YouTube][vidéo YouTube].

**Remarque :** un [didacticiel plus récent et exhaustif][didacticiel plus récent et exhaustif] relatif à PTVS 2.0 Beta est désormais disponible.
...
Dans ce didacticiel, vous allez créer une simple application web
Hello World. L'application sera hébergée dans une instance de rôle web
...
Avant de commencer à développer votre application Azure, vous devez obtenir des outils et configurer votre environnement de développement. Pour plus de détails sur l'obtention et l'installation du Kit de développement logiciel (SDK) Azure pour Python, consultez la section [Installation de Python][Installation de Python].
...
![Modèles de nouveau projet Python][Modèles de nouveau projet Python]

**Cliquez sur OK**. Vous avez créé votre première application Django.

![Visual Studio ouvert avec votre premier projet Django][Visual Studio ouvert avec votre premier projet Django]
...
![Élément de menu d'ajout d'une nouvelle application][Élément de menu d'ajout d'une nouvelle application]

Vous pouvez ensuite entrer le nom de votre nouvelle application :

![Invite d'ajout de nom pour la nouvelle application][Invite d'ajout de nom pour la nouvelle application]

Après que vous avez saisi un nom pour l'application et cliqué sur **OK**, une nouvelle application est ajoutée à votre projet :

![Explorateur de solutions avec nouvelle application ajoutée][Explorateur de solutions avec nouvelle application ajoutée]
...
![Ajout de l'application à views.py dans la section INSTALLED\_APPS][Ajout de l'application à views.py dans la section INSTALLED\_APPS]
...
![Ajout d'un nouvel élément au dossier Modèles][Ajout d'un nouvel élément au dossier Modèles]
...
![Modèle ajouté à l'explorateur de solutions][Modèle ajouté à l'explorateur de solutions]
...
![Modèle IntelliSense pour filtres Django][Modèle IntelliSense pour filtres Django]
...
![Enregistrement de l'URL][Enregistrement de l'URL]
...
![Django Hello World dans un navigateur et le serveur de test][Django Hello World dans un navigateur et le serveur de test]
...
![Débogueur arrêté à un point d'arrêt de modèle][Débogueur arrêté à un point d'arrêt de modèle]
...
![Ajout d'un projet de déploiement][Ajout d'un projet de déploiement]

Après l'exécution de cette commande, vous verrez un projet nouvellement ajouté dans l'Explorateur de solutions :

![Après l'ajout d'un projet de déploiement][Après l'ajout d'un projet de déploiement]
...
![Menu application package][Menu application package]
...
![Abonnement de package][Abonnement de package]
...
![Paramètres du package][Paramètres du package]

Vous devez à présent attendre que l'application soit configurée et déployée.

![Déploiement du package][Déploiement du package]
...
![Votre application Django dans le cloud][Votre application Django dans le cloud]
