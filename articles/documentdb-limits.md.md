...
|Nombre de procédures stockées, de déclencheurs et de fonctions définies par l'utilisateur par collection       |5 chacune
...
|Taille de demande maximale des documents, pièces jointes, procédures stockées, déclencheurs et fonctions définies par l'utilisateur        |16 Ko
...
|Nombre maximal de clauses AND par requête      |3
|Nombre maximal de clauses OR par requête       |3
