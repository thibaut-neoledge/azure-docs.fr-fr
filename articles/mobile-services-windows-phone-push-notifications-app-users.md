...
Cette rubrique s'inscrit dans le prolongement du [didacticiel précédent sur les notifications Push][] en ajoutant une nouvelle table pour le stockage des URI des canaux du Service de notifications Push Microsoft (MPNS). Ceux-ci peuvent ensuite être utilisés pour envoyer des notifications Push aux utilisateurs de l'application Windows Phone 8.

Ce didacticiel vous guide tout au long de la procédure de mise à jour des notifications Push dans votre application :

1.  [Création de la table de canaux][]
