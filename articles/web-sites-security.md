...
* Un fichier de **paramètres de publication** contient :
	...
	* Un certificat de gestion qui vous permet d'effectuer des tâches de gestion pour votre abonnement *without having to provide an account name or password*.
