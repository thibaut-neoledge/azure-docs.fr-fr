<properties
   pageTitle="Utilisation d’Azure PowerShell en mode Gestionnaire des ressources pour réaliser les tâches courantes de la machine virtuelle"
   description="Vous indique les commandes permettant de réaliser les tâches courantes de la machine virtuelle à l’aide du mode Gestionnaire des ressources dans Azure PowerShell"
...
# Utilisation d’Azure PowerShell en mode Gestionnaire des ressources pour réaliser les tâches courantes de la machine virtuelle
...
Il est possible d’automatiser les nombreuses tâches quotidiennes liées à la gestion de vos machines virtuelles en utilisant les applets de commande en mode Gestionnaire des ressources. Cet article donne des exemples de commandes pour réaliser des tâches simples et contient des liens vers des articles indiquant les commandes à utiliser pour des tâches plus complexes.
...
Si vous exécutez la commande avec un groupe de ressources nommé "MyRG" et une machine virtuelle nommée "MyVM", les informations s’afficheront de la manière suivante :
