...
Pour plus d'informations sur ACS, consultez la page [Service de contrôle d'accès 2.0][].
...
-	Identity and Access Tool for Visual Studio 2012 (téléchargement disponible à la page [Outil d'identité et d'accès][])
...
3.  Pour créer un espace de noms de contrôle d'accès, cliquez sur **Nouveau**. **App Services** et **Access Control** sont sélectionnés. Cliquez sur **Création rapide**. 

	![][2]

4.  Entrez le nom de l'espace de noms. Azure vérifie que le nom est unique.

5.  Sélectionnez la région dans laquelle l'espace de noms sera utilisé. Pour bénéficier de performances optimales, utilisez la région dans laquelle vous déployez votre application, puis cliquez sur **Créer**.
...
1.	Sélectionnez le modèle Visual C#/Web, puis **Application Web ASP.NET MVC 4**.
...
1.	Dans l'Explorateur de solutions, cliquez avec le bouton droit sur le projet MvcACS, puis sélectionnez **Identité et accès**.
	...
	Si l'option **Identité et accès** ne s'affiche pas dans le menu contextuel, installez Identity and Access Tool. Pour plus d'informations, consultez la page [Outil d'identité et d'accès]. 
...
1. Effectuez un clic droit sur la méthode  *Claims* puis sélectionnez **Ajouter une vue**.
...
4.	Cliquez sur **Applications par partie de confiance**.
...
Pour en savoir plus sur les fonctionnalités d'ACS et découvrir d'autres scénarios, consultez la page [Service de contrôle d'accès 2.0].
  ...
  [Affichage de l'application dans le portail de gestion ACS]: acs-portal
  ...
  [Outil d'identité et d'accès]: http://go.microsoft.com/fwlink/?LinkID=245849
