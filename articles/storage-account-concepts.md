<properties umbracoNaviHide="0" pageTitle="Concepts liés aux comptes de stockage | Azure" metaKeywords="Azure storage, storage service, service, storage account, account, create storage account, create account" description="Découvrez les concepts liés au compte de stockage." urlDisplayName="How to: storage accounts" headerExpose="" footerExpose="" disqusComments="1" title="Storage Account Concepts" services="storage" authors="tamram" manager="adinah" />
...
Vous pouvez également configurer un nom de domaine personnalisé pour utiliser votre compte de stockage. Consultez la rubrique [Configuration d'un nom de domaine personnalisé pour des données d'objets blob dans un compte de stockage](http://azure.microsoft.com/fr-fr/documentation/articles/storage-custom-domain-name/) pour en savoir plus.
