<properties umbracoNaviHide="0" pageTitle="Concepts li&eacute;s aux comptes de stockage | Azure" metaKeywords="Azure storage, storage service, service, storage account, account, create storage account, create account" description="D&eacute;couvrez les concepts li&eacute;s au compte de stockage." urlDisplayName="How to: storage accounts" headerExpose="" footerExpose="" disqusComments="1" title="Concepts li&eacute;s aux comptes de stockage" services="storage" authors="tamram" manager="adinah" editor="cgronlun" />
