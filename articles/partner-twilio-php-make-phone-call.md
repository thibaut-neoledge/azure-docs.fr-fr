...
* [Création d'un site web Azure PHP-MySQL et déploiement avec Git][website-git]
* [Création d'un site web Azure PHP-MySQL et déploiement avec FTP][website-ftp]
