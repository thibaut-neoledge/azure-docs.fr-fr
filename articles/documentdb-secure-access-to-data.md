...
Cet article fournit une vue d'ensemble de la sécurisation de l'accès aux données stockées dans [Microsoft Azure DocumentDB](../../services/documentdb/). 
...
- Clés principales : Lors de la création d'un compte DocumentDB, deux clés principales (principale et secondaire) sont créées.  Ces clés permettent l'accès administratif complet à toutes les ressources au sein du compte DocumentDB.

![DocumentDB master keys illustration](./media/documentdb-secure-access-to-data/masterkeys.png)

- Clés en lecture seule : Lors de la création d'un compte DocumentDB, deux clés en lecture seule (principale et secondaire) sont créées.  Ces clés permettent l'accès en lecture seule à toutes les ressources au sein du compte DocumentDB.
...
##<a id="Sub2"></a>Utilisation des clés principales et en lecture seule DocumentDB ##
...
##<a id="Sub3"></a>Vue d'ensemble des jetons de ressource DocumentDB ##
...
##<a id="Sub4"></a>Utilisation des autorisations et des utilisateurs DocumentDB ##
...
- Toutes : L'utilisateur dispose de toutes les autorisations concernant la ressource.
