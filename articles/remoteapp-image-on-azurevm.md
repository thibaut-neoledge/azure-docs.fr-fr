<properties 
    pageTitle="Création d'une image RemoteApp basée sur une machine virtuelle Azure"
...
1. Créez une machine virtuelle Azure. Vous pouvez utiliser l'image " Hôte de session de Bureau à distance Windows Server " de la galerie d'images de machines virtuelles Azure. Cette image répond à toutes les exigences d'image de modèle Azure RemoteApp. 
	...
	Pour plus d'informations, consultez [Création d'une machine virtuelle exécutant Windows](virtual-machines-windows-tutorial.md).
...
4. SYSPREP généralise et capture l'image. Pour obtenir des instructions, consultez [Capture d'une machine virtuelle Windows pour l'utiliser comme modèle](virtual-machines/virtual-machines-capture-image-windows-server.md).
