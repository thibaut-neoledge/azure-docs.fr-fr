...
4. SYSPREP généralise et capture l'image. Pour obtenir des instructions, consultez [Capture d'une machine virtuelle Windows pour l'utiliser comme modèle](virtual-machines-capture-image-windows-server.md).
