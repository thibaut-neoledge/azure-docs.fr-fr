...
<td align="left"><a href="http://azure.microsoft.com/en-us/gallery/store/sendgrid/sendgrid-azure/">SendGrid</a> et le <a href="http://wordpress.org/plugins/sendgrid-email-delivery-simplified/">plug-in WordPress pour l'utilisation de SendGrid</a></td>
</tr>
<tr class="odd">
...
-   [Astuces pour WordPress sur Azure][Astuces pour WordPress sur Azure]
  ...
  [Magasin Azure]: http://azure.microsoft.com/en-us/gallery/store/
  ...
  [Détails sur les tarifs, incluant les capacités en termes de tailles et de modes pour les sites web]: https://azure.microsoft.com/en-us/pricing/details/web-sites/
