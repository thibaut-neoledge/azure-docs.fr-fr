<properties 
	pageTitle="Charger un certificat d’API de gestion Microsoft Azure sur le portail" 
	description="Découvrez comment charger le certificat d’API de gestion dans Microsoft Azure" 
