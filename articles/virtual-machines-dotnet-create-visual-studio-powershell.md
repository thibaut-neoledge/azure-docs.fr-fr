<properties pageTitle="Création d'une machine virtuelle pour un projet web avec Visual Studio" description="Création d'une machine virtuelle pour un site web" services="virtual-machines" documentationCenter="" authors="ghogen" manager="douge" editor=""/>
