...
Si vous souhaitez personnaliser les scripts de publication que vous avez créé, consultez des informations plus détaillées [ici](http://msdn.microsoft.com/library/dn642480.aspx).
