...
2. Dans la boîte de dialogue **Nouveau projet ASP.NET**, sélectionnez le type d'application web souhaité. Dans la section Azure de la boîte de dialogue (en bas à droite), veillez à ce que l'option **Héberger dans le cloud** soit activée (elle est intitulée **Créer des ressources distantes** dans certaines installations).

	![][0]

3. Sélectionnez **Machine virtuelle**, puis cliquez sur le bouton **OK**.
...
11. Sélectionnez **OK** pour démarrer la création de la machine virtuelle. Vous pouvez suivre la progression dans la fenêtre **Sortie**.
...
13. (Facultatif) Dans l'**Explorateur de serveurs**, développez le nœud **Machines virtuelles**. Choisissez le nœud de la machine virtuelle que vous avez créée, puis sélectionnez **Se connecter avec le Bureau à distance** pour vous connecter à la machine virtuelle.

# Étapes suivantes

Si vous souhaitez personnaliser les scripts de publication que vous avez créés, consultez des informations plus détaillées [ici](http://msdn.microsoft.com/library/dn642480.aspx).
