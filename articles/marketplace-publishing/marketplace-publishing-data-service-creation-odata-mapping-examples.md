...
## Exemple : FunctionImport utilisant « DELETE »
...
## Exemple : FunctionImport utilisant « POST »
...
## Exemple : FunctionImport utilisant « PUT »
...
## Exemple : FunctionImport pour des données de type « Raw » (brutes) renvoyées à l’aide de « PUT »
...
## Exemple : FunctionImport pour des données de type « Raw » (brutes) renvoyées à l’aide de « GET »
...
## Exemple : FunctionImport pour « Paging » via des données renvoyées
