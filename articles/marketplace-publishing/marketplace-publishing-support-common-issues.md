...
Cet article explique comment résoudre ou obtenir de l’aide pour résoudre certains scénarios courants du Marketplace, de la façon suivante :

## Avoirs et remboursements

Dans certains cas, vous pouvez avoir besoin de demander un avoir ou un remboursement pour le compte d’un client. Le support Microsoft peut s’assurer que les demandes d’avoir et/ou de remboursement de vos clients sont prises en compte et que vous recevez une réponse en temps voulu*.

Les étapes suivantes vous indiquent comment demander un avoir ou un remboursement pour le compte d’un client.

* [AZURE.NOTE]Si un client ou un revendeur Azure nous contacte pour demander un avoir ou un remboursement, nous appliquons les mêmes politiques que celles utilisées pour la mise à disposition des services Azure. Si nos politiques indiquent qu’un avoir ou un remboursement est dû, nous délivrons de manière proactive, avec votre autorisation de le faire en votre nom, un avoir ou un remboursement au client ou revendeur Azure (selon le cas). Si nos politiques n’indiquent pas qu’un avoir ou remboursement est dû, nous pouvons inviter le client ou revendeur Azure à vous contacter directement.

  ![1\_RequestRefund][1]

  1. Accédez aux pages de support
  2. Sélectionnez **Gestion des clients**
  3. Sélectionnez **Approuver ou demander un remboursement du client**
  4. Cliquez sur **Envoyer une demande**

  ![2\_RequestRefund][2]

5. Fournissez les coordonnées
6. Remplissez le champ « Quel est le problème » et fournissez les informations suivantes :
...
- Vous ne savez pas comment vérifier si cette personne est un client authentique pour cette offre
...
Si vous voulez mettre à jour votre profil d’éditeur, vous pouvez le faire par le biais du Tableau de bord vendeur

**1. Connectez-vous au Tableau de bord vendeur**

- Ouvrez une nouvelle session de navigation Chrome Incognito ou IE InPrivate pour vous assurer que vous n’êtes pas connecté à un compte personnel
- Accédez à http://sellerdashboard.microsoft.com

![inprivate][4]

**2. Connectez-vous avec votre compte Microsoft (MSA) utilisé pour l’inscription de l’entreprise** (par exemple, AzureStore@yourcompany.com)
...
**4. Accédez aux détails du compte et aux détails de l’entreprise**
...
Pour les problèmes suivants, envoyez une demande de support sur le site https://portal.azure.com
...
Pour les problèmes suivants, créez une demande de support sur le site http://go.microsoft.com/fwlink/?LinkId=272975

- Je rencontre des problèmes pour gérer les services web
- Comment modifier le compte MSA associé à mon compte vendeur ?
