...
Découvrez les conditions préalables générales centrées sur le processus d’entreprise qui sont nécessaires dans les étapes de création et de déploiement de l’offre.
...
- Si vous êtes **déjà inscrit**, déterminez qui est le propriétaire du compte dans votre entreprise ou quelles sont les informations d’identification qui ont été utilisées pour l’inscription
- Si vous n’êtes **pas le propriétaire du compte de publication**, vous pouvez demander au propriétaire du compte d’ajouter votre compte Microsoft en tant que coadministrateur dans le [portail de publication](https://publish.windowsazure.com) -> onglet **Éditeurs** -> lien **Administrateurs**
...
> Si vous rencontrez des problèmes pendant l’inscription du vendeur, ouvrez un ticket de support comme indiqué ci-dessous : 1. Accédez au site [Aide et support](http://go.microsoft.com/fwlink?LinkId=272975) 2. Choisissez **Inscription au Tableau de bord vendeur et votre compte** 3. Choisissez **Inscription pour un compte de développeur** 4. Choisissez une **méthode de contact**


## Acquérir un abonnement Azure avec « paiement à l’utilisation »
...
> [AZURE.WARNING]Avant de pouvoir vendre vos services dans Microsoft Azure Marketplace, l’entité inscrite doit résider dans l’un des pays autorisés. Cette restriction s’applique pour des raisons de revenus et de taxes. Nous cherchons activement à étendre cette liste de pays dans un avenir proche, donc restez connecté. Pour obtenir la liste complète, consultez la **Section 1b** des [Politiques concernant la participation à Microsoft Azure Marketplace](http://go.microsoft.com/fwlink/?LinkID=526833).
...
|-----|-----|-----|-----|
| [Conditions préalables techniques des machines virtuelles](marketplace-publishing-vm-image-creation-prerequisites.md) | Conditions préalables techniques des services de développement | Conditions préalables techniques des services de données | [Conditions préalables techniques des modèles de solution](marketplace-publishing-solution-template-creation-prerequisites.md) |
