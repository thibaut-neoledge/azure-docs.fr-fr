...
## <a name="make-a-decision-on-what-technology-will-be-used-to-publish-your-data-service-offer"></a>Prendre une décision sur la technologie qui sera utilisée pour publier votre offre de service de données
