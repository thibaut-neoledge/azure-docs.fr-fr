...
Ce didacticiel fait partie de la [série][hdinsight-hbase-replication] portant sur la création d’une géoréplication HBase. 
...
## <a name="create-two-azure-vnets"></a>Créer deux réseaux virtuels Azure
...
## <a name="configure-a-vpn-connection-between-the-two-vnets"></a>Configurer une connexion VPN entre les deux réseaux virtuels
...
3. Cliquez sur **Yes** (Oui) pour confirmer. Notez que le graphique de la passerelle sur la page devient jaune et indique Création d'une passerelle. La création d'une passerelle dure généralement environ 15 minutes.
...
### <a name="set-the-vpn-device-ip-addresses-for-local-networks"></a>Définir les adresses IP du périphérique VPN pour des réseaux locaux
...
### <a name="set-vnet-gateway-keys"></a>Définir des clés de passerelle de réseau virtuel
...
## <a name="check-the-vpn-connection"></a>Vérifier la connexion VPN
