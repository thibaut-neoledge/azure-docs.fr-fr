...
5. Récupérez la clé utilisée pour accéder au compte de stockage.
   ...
   * Remplacez **storagename** par le nom du compte de stockage.
     ...
     Dans les données renvoyées, enregistrez la valeur de **clé** pour **key1**.
6. Création d’un cluster HDInsight
   ...
   * Remplacez **sshuser** et **sshuserpassword** par le nom d’utilisateur et le mot de passe à utiliser lors de l’accès au cluster via SSH.
