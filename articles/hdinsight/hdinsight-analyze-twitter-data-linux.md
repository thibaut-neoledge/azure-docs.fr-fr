...
- Un __cluster Azure HDInsight sous Linux__. Pour plus d’informations sur la création d’un cluster, consultez la rubrique [Prise en main de HDInsight sous Linux](hdinsight-hadoop-linux-tutorial-get-started.md).
