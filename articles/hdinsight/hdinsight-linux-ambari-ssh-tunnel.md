...
4. Une page semblable à celle-ci doit s'afficher :
    ...
    > [AZURE.NOTE] Notez l’URL de cette page. Elle doit être semblable à __http://hn1-CLUSTERNAME.randomcharacters.cx.internal.cloudapp.net:8088/cluster__. Elle utilise le nom de domaine complet (FQDN) interne du nœud et n'est pas accessible sans l’utilisation d’un tunnel SSH.
