---
title: Utilisation des outils Hadoop Visual Studio pour HDInsight | Microsoft Docs
...
* une station de travail avec les logiciels suivants :
  ...
  * Visual Studio (l'une des versions suivantes) :
    ...
    * Visual Studio 2015 (Community/Enterprise)
    ...
    > [!NOTE]
    > Actuellement, HDInsight Tools pour Visual Studio n’est fourni qu’avec la version anglaise.
    > 
    > 
...
5. Cliquez sur **Envoyer** ou sur **Envoyer (Avancé)**. Avec l’option d’envoi avancé, vous allez configurer les éléments **Nom de la tâche**, **Arguments**, **Configurations supplémentaires** et **Répertoire d’états** pour le script :
