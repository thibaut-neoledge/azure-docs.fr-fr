...
> [!NOTE]
> Dans les versions HDInsight antérieures à 3.0, `asv://` était utilisé à la place de `wasb://`. `asv://` ne doit pas être utilisé avec les clusters HDInsight 3.0 ou versions ultérieures, car cela entraînerait une erreur.
> 
> 
