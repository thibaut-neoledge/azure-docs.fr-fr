...
Un serveur R sur HDInsight (version préliminaire) a accès aux objets blob Azure et aura bientôt accès au stockage Azure Data Lake comme moyen de conserver les données, le code, les objets de résultats d’analyse, etc.
