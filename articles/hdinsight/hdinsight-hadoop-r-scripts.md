...
1. Quand vous créez un cluster HDInsight à partir de la version préliminaire du portail, cliquez sur **Configuration facultative**, puis cliquez sur **Actions de Script**.
