...
2. Utilisez la commande suivante pour démarrer un exemple de topologie :
   ...
   > [!NOTE]
   > La partie `0.10.0.2.4.2.4-5` du nom de fichier peut varier si HDinsight est mis à jour avec des versions plus récentes de Storm.
   > 
   > 
...
1. Ouvrez un navigateur web et accédez à https://CLUSTERNAME.azurehdinsight.net/stormui, où **CLUSTERNAME** est le nom de votre cluster. L’interface utilisateur de Storm s’ouvre.
