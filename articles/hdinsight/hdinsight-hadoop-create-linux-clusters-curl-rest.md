...
2. Générez un nouveau jeton à l’aide de l’API REST Azure.
    ...
    Le document JSON renvoyé par cette demande comporte un élément nommé __access_token__. La valeur de cet élément est le jeton d’accès à utiliser pour authentifier les demandes effectuées dans les sections suivantes de ce document.
