<properties
   ...
   description="Apprenez à créer un Apache Spark sur un cluster HDInsight (version préliminaire) incluant R Server, puis à envoyer un script R sur le cluster."
   services="HDInsight"
   documentationCenter=""
