...
Les exemples storm-starter sont situés dans le répertoire __ /usr/hdp/current/storm-client/contrib/storm-starter__ sur les clusters Linux et dans le répertoire **%storm_home%\contrib\storm-starter** sur les clusters Windows.
