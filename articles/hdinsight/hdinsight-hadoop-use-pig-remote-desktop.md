...
##<a name="<a-id="connect"></a>connect-with-remote-desktop"></a><a id="connect"></a>Connexion avec le Bureau à distance
...
2. Lorsque vous disposez d’une connexion Bureau à distance, démarrez la **ligne de commande Hadoop** en cliquant sur l’icône sur le bureau.
