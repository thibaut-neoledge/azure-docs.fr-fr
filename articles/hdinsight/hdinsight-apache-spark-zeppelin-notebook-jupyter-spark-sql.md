...
# Prise en main : créer Apache Spark sur HDInsight Windows et exécuter des requêtes interactives à l’aide de Spark SQL (version préliminaire)
...
3. Entrez un **Nom de cluster**, sélectionnez **Spark** comme **Type de cluster**, et à partir du menu déroulant **Système d’exploitation du cluster**, sélectionnez **Windows Server 2012 R2 Datacenter**. Une coche verte s’affiche en regard du nom de cluster s’il est disponible.
