...
5. Testez la forêt en classant l’ensemble de données __KDDTest+.arff__ . Utilisez la commande suivante :
  ...
  Cette tâche produit également un fichier situé dans __wasbs:///example/data/predictions/KDDTest+.arff.out__. Toutefois, ce fichier n’est pas lisible par les humains.
