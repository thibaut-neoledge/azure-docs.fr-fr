---
title: Utiliser des packages externes avec les blocs-notes Jupyter dans des clusters Apache Spark sur HDInsight | Microsoft Docs
...
1. Dans l’extrait de code ci-dessus, `packages` attend une liste de coordonnées maven dans le référentiel central Maven. Dans cet extrait de code, `com.databricks:spark-csv_2.10:1.4.0` est la coordonnée maven pour le package **spark-csv**. Voici comment vous construire les coordonnées d’un package.
