...
* Visual Studio et les outils HDInsight pour Visual Studio : voir [Prise en main des outils HDInsight pour Visual Studio](hdinsight-hadoop-visual-studio-tools-get-started.md) pour plus d’informations sur l’installation.
...
* Un cluster Apache HBase sur HDInsight (Linux ou Windows). Il s’agit de la source de données pour cet exemple.
