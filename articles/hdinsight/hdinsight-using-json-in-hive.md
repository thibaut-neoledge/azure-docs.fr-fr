...
Pour rechercher les matières dans lesquelles l'élève à obtenu un score de plus de 80 points SÉLECTIONNEZ  
      la collection jt.StudentClassCollection.ClassId from json_table jt lateral view explode(jt.StudentClassCollection.Score) en tant que score quand le score > 80 ;
...
* [Exécution d'une tâche Hadoop avec DocumentDB et HDInsight](../documentdb/documentdb-run-hadoop-with-hdinsight.md)
