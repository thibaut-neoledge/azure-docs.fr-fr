...
2. Ouvrez une nouvelle invite Azure PowerShell. Si vous n’êtes pas familiarisé avec Azure PowerShell ou que vous ne l’avez pas installé, voir [Installer et configurer Azure PowerShell][powershell].
