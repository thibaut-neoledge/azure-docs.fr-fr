...
[!INCLUDE [sélecteur-JDBC-ODBC](../../includes/hdinsight-selector-odbc-jdbc.md)]
...
4. Dans la boîte de dialogue Ajouter un pilote, ajoutez les informations suivantes.
   ...
   * **Nom** : Hive
   * **URL de l’exemple** : jdbc:hive2://localhost:443/default;ssl=true?hive.server2.transport.mode=http;hive.server2.thrift.http.path=/hive2
...
**Cause** : cette erreur est due à une incohérence entre la version du fichier commons-codec.jar utilisé par SQuirreL et celle du fichier exigés par les composants JDBC Hive téléchargés à partir du cluster HDInsight.
