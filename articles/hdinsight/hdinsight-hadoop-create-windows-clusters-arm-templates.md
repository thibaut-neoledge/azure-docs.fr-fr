---
title: "Création de clusters Hadoop basés sur Windows dans HDInsight à l’aide de modèles Azure Resource Manager | Microsoft Docs"
...
Consultez [Déployer avec l’API REST](../resource-group-template-deploy-rest.md).
