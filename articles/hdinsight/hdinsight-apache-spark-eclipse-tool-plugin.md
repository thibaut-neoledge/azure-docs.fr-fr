...
# Utiliser le kit de ressources Azure pour Eclipse pour créer des applications Spark pour un cluster HDInsight
...
## Exécuter une application Spark Scala sur un cluster Azure Data Lake Store
