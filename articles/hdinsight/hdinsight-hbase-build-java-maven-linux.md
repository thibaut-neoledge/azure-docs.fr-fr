...
3. Supprimez le fichier **src/test/java/com/microsoft/examples/apptest.java**, car il ne sera pas utilisé dans cet exemple.
...
## <a name="upload-the-jar-file-and-run-jobs"></a>Téléchargement du fichier JAR et exécution de tâches
...
3. Une fois connecté, utilisez ce qui suit pour créer une nouvelle table HBase à l’aide de l’application Java :
    ...
    Cela engendre la création d’une table HBase nommée **people** et contenant des données.
