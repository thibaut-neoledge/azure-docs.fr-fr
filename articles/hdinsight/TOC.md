...
# Prise en main
## [Plan pour la capacité du cluster HDInsight](hdinsight-capacity-planning.md)
...
## [Démarrer avec la requête interactive](hdinsight-hadoop-use-interactive-hive.md)
...
#### [Utilisation d'Azure PowerShell](hdinsight-hadoop-use-hive-powershell.md)
...
#### [Utilisation d'Azure PowerShell](hdinsight-hadoop-use-mapreduce-powershell.md)
#### [Utiliser le Bureau à distance](hdinsight-hadoop-use-mapreduce-remote-desktop.md)
#### [Utilisation du Kit de développement logiciel (SDK) .NET](hdinsight-hadoop-use-mapreduce-dotnet-sdk.md)
...
#### [Utilisation d'Azure PowerShell](hdinsight-hadoop-use-pig-powershell.md)
...
#### [Utiliser un interpréteur de commandes Spark interactif](hdinsight-spark-shell.md)
...
### [Qu’est-ce que la diffusion en continu de Spark ?](hdinsight-spark-streaming-overview.md)
...
#### [Traiter des événements avec les topologies Java](https://azure.microsoft.com/resources/samples/hdinsight-java-storm-eventhub/)
...
## Utiliser la requête interactive
### [Utiliser Zeppelin pour exécuter des requêtes Hive](hdinsight-connect-hive-zeppelin.md)
## Développement
...
### [Utiliser l’outil HDInsight VSCode](hdinsight-for-vscode.md)
## Analyser les données volumineuses (Big Data)
### [Analyser à l’aide de Power Query](hdinsight-connect-excel-power-query.md)
### [Connecter Power BI à Hadoop](hdinsight-connect-hive-power-bi.md)
...
### [Autoriser les utilisateurs pour Ambari Views](hdinsight-authorize-users-to-ambari.md)
### [Gérer les autorisations utilisateur au niveau des fichiers et des dossiers](hdinsight-add-acls-at-file-folder-levels.md)
## Gérer
...
#### [Exécuter à l’aide d’Azure PowerShell](hdinsight-hadoop-use-sqoop-powershell.md)
...
## Surveiller
### [Utiliser Azure Log Analytics](hdinsight-hadoop-oms-log-analytics-tutorial.md)
### [Tableaux de bord spécifiques au cluster](hdinsight-hadoop-oms-log-analytics-management-solutions.md)
### [Utiliser des requêtes avec Log Analytics](hdinsight-hadoop-oms-log-analytics-use-queries.md)
