<properties
	...
	description="Qu’est-ce que R Server sur HDInsight (version préliminaire) et comment utiliser R pour créer des applications pour l’analyse du Big Data."
	services="hdinsight"
	documentationCenter=""
...
#Vue d’ensemble : R Server sur HDInsight (version préliminaire)
