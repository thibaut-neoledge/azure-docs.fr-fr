...
L’exemple suivant utilise l’authentification utilisateur interactive. Pour utiliser l’authentification non interactive, voir [Créer des applications HDInsight .NET d’authentification non interactive](hdinsight-create-non-interactive-authentication-dotnet-applications.md)
