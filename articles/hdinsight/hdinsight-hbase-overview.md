...
---
# <a name="what-is-hbase-in-hdinsight-a-nosql-database-that-provides-bigtablelike-capabilities-for-hadoop"></a>Présentation de HBase dans HDInsight : une base de données NoSQL fournissant des fonctionnalités similaires à BigTable pour Hadoop
...
## <a name="a-namenextstepsanext-steps"></a><a name="next-steps"></a>Étapes suivantes
...
## <a name="a-nameseealsoasee-also"></a><a name="see-also"></a>Voir aussi
