---
title: "Configurer DNS entre deux réseaux virtuels Azure | Microsoft Docs"
...
---
# <a name="configure-dns-between-two-azure-virtual-networks"></a>Configurer des serveurs DNS entre deux réseaux virtuels Azure
...
Ce didacticiel constitue la deuxième partie de la [série][hdinsight-hbase-geo-replication] portant sur la création d’une géo-réplication HBase :
...
* [Configurer la géoréplication HBase][hdinsight-hbase-geo-replication]
...
## <a name="create-azure-virtual-machines-to-be-used-as-dns-servers"></a>Créer des machines virtuelles à utiliser en tant que serveurs DNS
...
## <a name="set-static-ip-addresses-for-the-two-virtual-machines"></a>Définir les adresses IP statiques pour les deux machines virtuelles
...
## <a name="add-the-dns-server-role-the-two-virtual-machines"></a>Ajoutez les rôles Serveur DNS des deux machines virtuelles
...
5. Dans la session RDP, cliquez sur le bouton Windows en bas à gauche pour ouvrir l'écran d'accueil.
6. Cliquez sur la vignette **Gestionnaire de serveur** .
7. Cliquez sur **Ajouter des rôles et fonctionnalités**.
8. Cliquez sur **Suivant**
9. Sélectionnez **Installation basée sur un rôle ou une fonctionnalité**, puis cliquez sur **Suivant**.
10. Sélectionnez votre machine virtuelle DNS (elle doit être mise en surbrillance), puis cliquez sur **Suivant**.
11. Vérifiez le **Serveur DNS**:
12. Cliquez sur **Ajouter des fonctionnalités**, puis sur **Continuer**.
13. Cliquez sur **Suivant** trois fois de suite, puis sur **Installer**. 

**Pour ajouter le rôle Serveur DNS pour Contoso-DNS-US**

* Répétez les étapes pour ajouter le rôle DNS à **Contoso-DNS-US**.

## <a name="assign-dns-servers-to-the-virtual-networks"></a>Assigner des serveurs DNS aux réseaux virtuels
...
## <a name="configure-dns-conditional-forwarders"></a>Configurer des redirecteurs DNS conditionnels
