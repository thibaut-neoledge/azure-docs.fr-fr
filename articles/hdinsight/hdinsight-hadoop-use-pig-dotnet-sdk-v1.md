...
> 
> Ce document inclut également des informations sur l’utilisation du Kit de développement logiciel (SDK) .NET de HDInsight. Les extraits de code fournis sont basés sur des commandes qui utilisent Azure Service Management (ASM) pour travailler avec HDInsight et qui sont **déconseillées**. Ces commandes seront supprimées d’ici au 1er janvier 2017.
> 
> Pour obtenir une version de ce document qui utilise le portail Azure, ainsi que les extraits de code du Kit de développement logiciel (SDK) .NET HDInsight qui utilisent Azure Resource Manager (ARM), consultez [Exécution de tâches Pig à l’aide du Kit de développement logiciel (SDK) .NET pour Hadoop dans HDInsight](hdinsight-hadoop-use-pig-dotnet-sdk.md)
> 
> 
...
> [!NOTE]
> Lors de la création du certificat, veillez à noter le nom convivial que vous utilisez, car il vous sera utile ultérieurement.
> 
> 
...
2. Appuyez sur **Entrée** pour quitter l’application.
