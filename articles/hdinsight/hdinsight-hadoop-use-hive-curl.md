---
title: "Utiliser Hadoop Hive avec Curl dans HDInsight | Microsoft Docs"
...
---
# <a name="run-hive-queries-with-hadoop-in-hdinsight-with-curl"></a>Exécution de requêtes Hive avec Hadoop dans HDInsight via Curl
...
## <a name="a-idcurlarun-hive-queries-by-using-curl"></a><a id="curl"></a>Exécution de requêtes Hive à l'aide de Curl
> [!NOTE]
