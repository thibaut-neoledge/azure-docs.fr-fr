...
<!-- URLs. -->
  ...
  [Kit de développement logiciel (SDK) Azure Mobile Services version 1.3.0-alpha3 (ou versions ultérieures)]: http://www.nuget.org/packages/WindowsAzure.MobileServices/1.3.0-alpha3
  [Azure Mobile Services SQLite Store version 1.0.0-alpha2 (ou versions ultérieures)]: http://www.nuget.org/packages/WindowsAzure.MobileServices.SQLiteStore/1.0.0-alpha2
