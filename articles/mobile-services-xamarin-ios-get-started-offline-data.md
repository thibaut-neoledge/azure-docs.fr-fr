...
[WACOM.INCLUDE [mobile-services-sélecteur-hors-connexion](../includes/mobile-services-selector-offline.md)]
...
>[WACOM.NOTE] Les instructions qui suivent partent du principe que vous utilisez Visual Studio 2012 ou version ultérieure avec l'extension Xamarin. Si vous utilisez Xamarin Studio sur OS X, utilisez la prise en charge intégrée du Gestionnaire de package NuGet.
...
Un projet avec l'état terminé de ce didacticiel est disponible [ici](https://github.com/Azure/mobile-services-samples/tree/master/TodoOffline/Xamarin.iOS).
...
2. Modifiez le type du membre " todoTable " en remplaçant " IMobileServiceTable " par " IMobileServicesSyncTable "
...
2. Modifiez la méthode " AddRefreshControl " pour appeler " SyncAsync " avant l'appel de " RefreshAsync " :
...
Vous pouvez télécharger la version terminée de ce didacticiel dans notre [référentiel d'exemples GitHub](https://github.com/Azure/mobile-services-samples/tree/master/TodoOffline/Xamarin.iOS).
