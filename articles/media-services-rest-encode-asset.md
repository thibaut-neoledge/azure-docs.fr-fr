...
Si votre ressource de sortie est stockée sous forme chiffrée, vous devez configurer une stratégie de remise de ressources. Pour plus d'informations, consultez la rubrique [Configuration de la stratégie de remise de ressources](media-services-rest-configure-asset-delivery-policy.md).
...
[Établissement obtention d'une instance de processeur multimédia]:http://go.microsoft.com/fwlink/?LinkId=301732
[Établissement téléchargement d'une ressource chiffrée]:http://go.microsoft.com/fwlink/?LinkId=301733
[Établissement remise d'une ressource par téléchargement]:http://go.microsoft.com/fwlink/?LinkId=301734
