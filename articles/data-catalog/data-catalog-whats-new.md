...
- Nous avons ajouté un nouveau bouton « Utilisateur » et un menu à notre barre de navigation supérieure. Ce menu indique à l’utilisateur le compte sous lequel il se connecte à **Azure Data Catalog** et éventuellement se déconnecte. Ce menu affiche également le nom du catalogue, information précieuse pour les développeurs qui utilisent l’API REST **Azure Data Catalog**.
