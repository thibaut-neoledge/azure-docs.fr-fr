...
L'inscription et la connexion à Oracle Database lors de la connexion aux utilisateurs de sources de données d’Oracle Database doivent avoir installé les pilotes Oracle appropriés qui correspondent au nombre de bits (32 bits ou 64 bits) du logiciel utilisé.
...
Lors de l'ouverture des ressources de données dans Microsoft Excel à partir du portail d’Azure Data Catalog, les utilisateurs peuvent voir apparaître une boîte de dialogue, intitulée **Avis de sécurité Microsoft Excel** Il s’agit là d’un comportement attendu ; les utilisateurs peuvent sélectionner **Activer** pour continuer.

Pour plus d'informations, consultez la rubrique [Activation ou désactivation des alertes de sécurité concernant les liens et les fichiers depuis des sites Web suspects](https://support.office.com/fr-fr/article/Enable-or-disable-security-alerts-about-links-and-files-from-suspicious-websites-A1AC6AE9-5C4A-4EB3-B3F8-143336039BBE).
...
Pour plus d'informations, consultez la rubrique [Configuration de l'authentification intranet par formulaire pour les périphériques qui ne prennent pas en charge WIA](https://technet.microsoft.com/library/dn727110.aspx).
