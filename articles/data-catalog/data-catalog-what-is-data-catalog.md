...
> [AZURE.NOTE] Pour afficher la liste des types de sources de données et de ressources pris en charge par **Azure Data Catalog**, consultez [Sources de données prises en charge par Azure Data Catalog](data-catalog-dsr.md)
