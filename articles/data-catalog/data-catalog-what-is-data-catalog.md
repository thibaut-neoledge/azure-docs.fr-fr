...
> [AZURE.NOTE] La version préliminaire **Azure Data Catalog** prend actuellement en charge les sources de données et les types de ressources suivants : [Sources de données prises en charge par Azure Data Catalog](data-catalog-dsr.md)
