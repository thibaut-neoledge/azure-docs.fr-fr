...
| Balises | Des balises peuvent être fournies aux niveaux des sources de données et attributs / colonnes. Les balises sont des étiquettes définies par l’utilisateur, qui peuvent être utilisées pour classer les attributs ou ressources de données. |
