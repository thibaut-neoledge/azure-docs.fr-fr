...
* **Azure Monitor** : prend en charge les alertes sur la base de valeurs de mesures et d’événements de journal d’activité. Azure inclut les [API REST d’Azure Monitor](https://msdn.microsoft.com/library/dn931943.aspx).  Pour plus d’informations, consultez [Utilisation du portail Azure, de PowerShell ou de l’interface de ligne de commande pour créer des alertes](insights-alerts-portal.md).
