---
title: "Réception de notifications d’alerte pour les services Azure | Microsoft Docs"
...
---
# <a name="receive-alert-notifications"></a>Réception de notifications d'alerte
...
* [Affichage des événements et des journaux d’activité](insights-debugging-with-events.md) pour découvrir tout ce qui s'est produit dans votre service.
