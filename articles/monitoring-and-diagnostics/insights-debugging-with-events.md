---
title: "Afficher les événements et journaux d’activité (audit)"
...
---
# <a name="view-events-and-activity-logs"></a>Afficher les événements et journaux d’activité
...
## <a name="browse-the-events-impacting-your-azure-subscription"></a>Recherchez les événements ayant un impact sur votre abonnement Azure
1. Connectez-vous au [portail Azure](https://portal.azure.com/).
2. Cliquez sur **Parcourir** et sélectionnez **Journaux d'Audit**.  
...
> [!NOTE]
> Vous ne pouvez afficher que les 500 derniers événements d’un abonnement donné dans le portail Azure.
> 
> 

1. Vous pouvez cliquer sur une entrée de journal pour afficher les événements qui la composent. Par exemple, lorsque vous déployez un élément vers un groupe de ressources, différentes ressources sont créées ou modifiées. Pour chaque entrée, vous pouvez découvrir :
...
2. Vous pouvez vous rendre ainsi dans le panneau des détails pour découvrir les détails de l'événement.
...
## <a name="filter-to-specific-logs"></a>Filtrage des journaux spécifiques
...
![Filtrer](./media/insights-debugging-with-events/Insights_EventFilter.png)
...
## <a name="monitor-events-impacting-specific-resources"></a>Surveillance des événements ayant un impact sur des ressources spécifiques
...
2. Sur le panneau des ressources, faites défiler l’écran vers le bas jusqu'à ce que vous trouviez la vignette des **événements** .  
    ![Vignette d'événements](./media/insights-debugging-with-events/Insights_EventsTile.png)
