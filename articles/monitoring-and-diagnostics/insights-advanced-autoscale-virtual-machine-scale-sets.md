...
> [!NOTE]
> Bien que cette procédure concerne plus spécifiquement VM Scale Sets, les mêmes informations s’appliquent pour la mise à l’échelle automatique de Cloud Services et de Web Apps.
