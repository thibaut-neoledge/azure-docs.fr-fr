...
3.	Dans le panneau Base de données SQL, cliquez sur la vignette **Niveau de tarification** :

    ![vignette de tarification][1]
...
3.	Vérifiez la vignette **Niveau de tarification** et confirmez que le niveau approprié est défini.
