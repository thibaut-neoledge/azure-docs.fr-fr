---
title: Modifier les niveaux de service et de performances d’une base de données SQL Azure
...
4. Cliquez sur la base de données à modifier.
5. Dans le panneau de la base de données SQL, cliquez sur **Tous les paramètres**, puis sur **Niveau tarifaire (mise à l'échelle de DTU)** :
   
   ![niveau tarifaire][1]
6. Sélectionnez un nouveau niveau, puis cliquez sur **Sélectionner** :
...
7. Dans le ruban gauche, cliquez sur **Notifications** :
...
1. Cliquez sur **PARCOURIR TOUT**.
2. Cliquez sur **Bases de données SQL**.
3. Cliquez sur la base de données mise à jour.
4. Vérifiez le **Niveau de tarification** et confirmez que le niveau approprié est défini.
