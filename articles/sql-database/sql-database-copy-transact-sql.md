<properties 
    pageTitle="Création d'une copie d'une base de données SQL Azure à l'aide de Transact-SQL" 
...
# Création d'une copie d'une base de données SQL Azure à l'aide de Transact-SQL
