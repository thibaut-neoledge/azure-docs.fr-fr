...
> [!NOTE]
> Vous pouvez également copier une base de données SQL à l’aide du [portail Azure ](sql-database-copy-portal.md) ou de [PowerShell](scripts/sql-database-copy-database-to-new-server-powershell.md).
>
