...
Le tableau suivant décrit les caractéristiques des niveaux de service de pools de base de données élastiques. Consultez la page de [référence du pool élastique de base de données SQL](sql-database-elastic-pool-reference.md) pour obtenir des définitions et des détails supplémentaires.
