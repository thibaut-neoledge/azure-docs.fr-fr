...
6. Une fois le **Serveur cible** sélectionné, les options **Pool de base de données élastique** et **Niveau tarifaire** sont activées. Si le serveur dispose d’un pool, vous pouvez y copier la base de données.
