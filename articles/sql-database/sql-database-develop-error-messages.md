...
| 40501 |20 |Le service est actuellement occupé. Relancez la demande dans 10 secondes. ID de l'incident : %ls. Code : %d.<br/><br/>*Remarque :* pour en savoir plus, consultez :<br/>• [Limites de ressources de base de données SQL Azure](sql-database-resource-limits.md). |
...
* [Créer un pool élastique (C#)](sql-database-elastic-pool-create-csharp.md) 
* [Gérer un pool élastique (C#)](sql-database-elastic-pool-manage-csharp.md). 
* [Créer un pool élastique (PowerShell)](sql-database-elastic-pool-create-powershell.md) 
