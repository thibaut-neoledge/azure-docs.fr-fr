---
title: Migration d’une base de données SQL Server vers une base de données SQL à l’aide de l’Assistant de déploiement de base de données vers une base de données Microsoft Azure | Microsoft Docs
