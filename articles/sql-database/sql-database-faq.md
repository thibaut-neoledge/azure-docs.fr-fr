<properties 
   ...
   description="Réponses fréquemment posées sur les bases de données du cloud et Azure SQL Database, le système de gestion de base de données relationnelle azure.microsoft.com/ (SGBDR) et la base de données en tant que service dans cloud." 
...
Nous exposons le décalage de réplication en temps réel entre la base de données primaire et la zone géographique secondaire par le biais d’une vue de gestion dynamique (DMV). Pour plus d’informations, consultez [sys.dm\_geo\_replication\_link\_status](https://msdn.azure.microsoft.com/.com/library/mt575504.aspx).
