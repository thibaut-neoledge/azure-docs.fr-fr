...
Un court exemple de code C# qui utilise EntLib60 dans sa logique de nouvelle tentative est disponible à la page suivante :

- [Exemple de code : logique C# de nouvelle tentative Enterprise Library 6 pour se connecter à SQL Database](sql-database-develop-entlib-csharp-retry-windows.md)
