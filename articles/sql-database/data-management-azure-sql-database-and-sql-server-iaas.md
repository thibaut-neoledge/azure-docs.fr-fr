...
Les sections suivantes offrent de plus amples informations sur ces deux derniers éléments : la base de données SQL Azure et SQL Server dans les machines virtuelles Azure. Nous allons également explorer les motivations métier courantes permettant de déterminer l'option qui convient le mieux à votre application.
...
<tr>
   ...
   <td valign="middle">
      ...
      <li type=round>Récupération d’urgence pour les applications SQL Server locales utilisant la <a href="http://msdn.microsoft.com/library/jj919148.aspx">sauvegarde sur Azure Storage</a> ou les <a href="http://msdn.microsoft.com/library/azure/jj870962.aspx">réplicas AlwaysOn dans les machines virtuelles Azure</a>.
...
- [Détails de tarification - Base de données SQL Azure](http://azure.microsoft.com/pricing/details/sql-database/) 
- [Détails de tarification - Machines virtuelles](http://azure.microsoft.com/pricing/details/virtual-machines/)
...
Cet article est consacré à Base de données SQL Azure et SQL Server dans les machines virtuelles Azure. En outre, nous avons abordé les motivations métier courantes susceptibles d'affecter le choix entre les deux.
...
- Vous développez des applications entièrement nouvelles dans le cloud ou vous souhaitez migrer votre base de données SQL Server existante vers Azure, mais votre base de données n'utilise pas l'une des fonctionnalités non prises en charge dans Base de données SQL Azure. Pour en savoir plus, consultez le [Guide de référence Transact-SQL de la base de données SQL Azure](http://msdn.microsoft.com/library/azure/ee336281.aspx). Cette approche offre les avantages d'un service cloud entièrement géré et assure une mise sur le marché rapide.
