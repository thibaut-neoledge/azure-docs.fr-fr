...
*Coût de l'application = coûts réduits de modification/développement logiciel + coûts d'administration + coûts de licence SQL Server et Windows Server + coûts Azure Storage*
