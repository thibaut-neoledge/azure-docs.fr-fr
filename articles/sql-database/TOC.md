...
#### Découvrir
##### [Didacticiel du portail Azure : Créer une base de données SQL Azure à l’aide du portail Azure](sql-database-get-started.md)
#### À faire
##### [Didacticiel du portail Azure : Créer une base de données SQL Azure à l’aide du portail Azure](sql-database-get-started.md)
##### [Didacticiel du portail Azure : Créer une base de données SQL Azure à l’aide de PowerShell](sql-database-get-started-powershell.md)
##### [Didacticiel du portail Azure : Créer une base de données SQL Azure à l’aide de C#](sql-database-get-started-csharp.md)
...
### Montée en charge
#### Découvrir
##### [Montée en charge](sql-database-elastic-scale-introduction.md)
...
##### [Désinstaller des tâches élastiques](sql-database-elastic-jobs-uninstall.md)
...
### À faire
#### Déterminer la compatibilité de la base de données
...
##### [Assistant Migration SQL Server Management Studio](sql-database-cloud-migrate-compatible-using-ssms-migration-wizard.md)
...
## Authentifier et accorder l’accès
### Découvrir
...
### À faire
### [Didacticiel : Accès et authentification SQL](sql-database-get-started-security.md)
...
#### Restauration géographique des bases de données
...
#### Configuration de la géo-réplication active
##### [portail Azure](sql-database-geo-replication-portal.md)
##### [PowerShell](sql-database-geo-replication-powershell.md)
##### [T-SQL](sql-database-geo-replication-transact-sql.md)
#### Basculement avec géo-réplication active
...
### Implémentations clientes de logiciels en tant que service
...
#### [Recommandations sur les niveaux tarifaires](sql-database-service-tier-advisor.md)
# Procédure
## Créer et gérer
...
#### [Créer et gérer des tâches élastiques dans le portail Azure](sql-database-elastic-jobs-create-and-manage.md)
...
#### [À l’aide du portail Azure](sql-database-scale-up.md)
#### [Utiliser PowerShell](sql-database-scale-up-powershell.md)
...
## [Applets de commande Azure SQL Database](/powershell/resourcemanager/AzureRM.Sql/v1.0.12/AzureRM.Sql)
