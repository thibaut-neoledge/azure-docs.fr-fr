---
title: "Instructions de sécurité et limitations d’Azure SQL Database | Microsoft Docs"
...
---
# <a name="azure-sql-database-security-guidelines-and-limitations"></a>Instructions et limitations de sécurité d’Azure SQL Database
...
## <a name="access-to-the-virtual-master-database"></a>Accès à la base de données master virtuelle
...
Le pare-feu SQL Server étendu pour l’ensemble du serveur SQL Azure est généralement configuré via le portail et doit accepter uniquement les adresses IP utilisées par les administrateurs. Pour créer une règle de pare-feu de base de données qui ouvrira la plage d’adresses IP nécessaire pour chaque base de données, connectez-vous à une base de données utilisateur, puis utilisez l’instruction Transact-SQL [sp_set_database_firewall_rule](https://msdn.microsoft.com/library/dn270010.aspx).
...
Pour plus d’évolutivité, utilisez des utilisateurs de base de données à relation contenant-contenu. Pour plus d’informations, consultez [Utilisateurs de base de données à relation contenant-contenu - Rendre votre base de données portable](https://msdn.microsoft.com/library/ff929188.aspx), [CREATE USER (Transact-SQL)](https://technet.microsoft.com/library/ms173463.aspx) et [Bases de données à relation contenant-contenu](https://technet.microsoft.com/library/ff929071.aspx).
