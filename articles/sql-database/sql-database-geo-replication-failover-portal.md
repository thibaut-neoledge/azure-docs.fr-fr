...
Cet article montre comment lancer le basculement vers une base de données SQL secondaire avec le [portail Azure](http://portal.azure.com). Pour configurer la géo-réplication, consultez [Configurer la géo-réplication pour une base de données SQL Azure](sql-database-geo-replication-portal.md).
