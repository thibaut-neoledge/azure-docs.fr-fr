...
Vous pouvez également supprimer un serveur grâce à la commande [Remove-AzureRMSqlServer](https://msdn.microsoft.com/library/azure/mt603488.aspx). L’exemple suivant supprime un serveur nommé server12.
