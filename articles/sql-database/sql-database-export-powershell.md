...
L’applet de commande [New-AzureRmSqlDatabaseExport](https://msdn.microsoft.com/library/mt707796.aspx) soumet une demande d’exportation de base de données au service. Selon la taille de votre base de données, l'opération d'exportation peut prendre plus ou moins longtemps.
