<properties 
   pageTitle="Récupération d'une base de données SQL Azure à l'aide de la géo-restauration dans le portail Azure" 
...
# Récupération d'une base de données SQL Azure à l'aide de la géo-restauration dans le portail Azure
...
1. Connectez-vous au portail Azure en utilisant votre compte Microsoft, puis sélectionnez **Bases de données SQL**.
