---
title: "Lancer un basculement planifié ou non planifié pour Azure SQL Database avec PowerShell | Microsoft Docs"
...
> [!NOTE]
> Dans de rares cas, il est possible que l’opération ne puisse pas se terminer et ne réponde plus. Dans ce cas, l’utilisateur peut appeler la commande de basculement forcé (basculement non planifié) et accepter une perte de données.
> 
> 
