...
Seuls la connexion de l’administrateur au serveur Azure SQL ou l’administrateur Azure Active Directory peuvent créer une règle de pare-feu de niveau serveur à l’aide de Transact-SQL.
...
1. Après avoir créé un pare-feu au niveau du serveur pour votre adresse IP, lancez une fenêtre de requête par le biais du portail Azure ou de SQL Server Management Studio.
