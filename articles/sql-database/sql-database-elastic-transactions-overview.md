<properties
   pageTitle="Vue d’ensemble des transactions de bases de données élastiques avec la base de données SQL Azure"
...
# Vue d’ensemble des transactions de bases de données élastiques avec la base de données SQL Azure
