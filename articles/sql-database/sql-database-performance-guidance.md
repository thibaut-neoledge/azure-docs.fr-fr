...
Le prix unitaire des eDTU d’un pool élastique est supérieur au prix unitaire des DTU d’une base de données autonome au sein du même niveau de service. Pour en savoir plus, voir [Tarification de la base de données SQL](https://azure.azure.microsoft.com/.com/pricing/details/sql-database/).
...
- [sys.dm\_db\_resource\_stats](https://msdn.azure.microsoft.com/.com/library/dn800981.aspx)
- [sys.resource\_stats](https://msdn.azure.microsoft.com/.com/library/dn269979.aspx)
...
Si une charge de travail contient un ensemble de requêtes répétitives, il est souvent judicieux de capturer et de valider l’optimalité de ces choix de plan dans la mesure où ils proposeront probablement l’unité de taille de ressource minimum requise pour héberger la base de données. Une fois la validation effectuée, un réexamen occasionnel de ces plans peut vous assurer qu’ils ne sont pas dégradés. Pour plus d'informations sur les indicateurs de requête, consultez [Indicateurs de requête (Transact-SQL)](https://msdn.azure.microsoft.com/.com/library/ms181714.aspx).
