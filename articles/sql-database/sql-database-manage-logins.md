...
2. Créez une connexion à l’aide de la commande ``CREATE LOGIN``. Pour plus d’informations, voir [CRÉER UNE CONNEXION (Transact-SQL)](https://msdn.microsoft.com/library/ms189751.aspx).
...
1. Connectez-vous à la base de données **MASTER** (avec une connexion associée aux rôles **loginmanager** et **dbmanager**).
