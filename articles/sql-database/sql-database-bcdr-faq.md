...
Pour une récupération après une erreur utilisateur : l'heure actuelle est le dernier point de restauration disponible. Pour trouver le plus ancien point de restauration disponible, utilisez [Obtenir la base de donnée](https://msdn.microsoft.com/library/dn505708.aspx) (*RecoveryPeriodStartDate*) pour obtenir le plus ancien point de restauration (point de restauration sans réplication géographique).
