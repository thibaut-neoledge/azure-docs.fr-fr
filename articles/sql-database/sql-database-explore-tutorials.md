---
title: Exploration des didacticiels relatifs à la base de données SQL Azure | Microsoft Docs
...
| [Copier une base de données SQL Azure à l’aide de PowerShell](sql-database-copy-powershell.md#copy-your-sql-database) |Ce didacticiel vous apprend à copier une base de données SQL Azure à l’aide de PowerShell. |
