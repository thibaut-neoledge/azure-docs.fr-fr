---
title: Surveiller et gérer un pool de bases de données élastique avec le portail Azure | Microsoft Docs
...
4. Dans le panneau **Configurer le pool**, cliquez sur **Enregistrer**.
