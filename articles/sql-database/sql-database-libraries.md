...
| Node.js | Windows, Linux, Mac | [Connexion à SQL Database à l’aide de Node.js](sql-database-develop-nodejs-simple.md) | [Télécharger](https://msdn.microsoft.com/library/mt652094.aspx) |
| Python | Windows, Linux, Mac | [Connexion à SQL Database à l’aide de Python](sql-database-develop-python-simple.md) | [Télécharger](https://msdn.microsoft.com/library/mt694094.aspx) |
| Ruby | Windows, Linux, Mac | [Connexion à SQL Database à l’aide de Ruby](sql-database-develop-ruby-simple.md) | [Télécharger](https://msdn.microsoft.com/library/mt711041.aspx) |
