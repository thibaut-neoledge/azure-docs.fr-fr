---
title: Prise en main de SQL In-Memory | Microsoft Docs
...
> [!NOTE]
> Ces fonctionnalités en version préliminaire sont uniquement disponibles pour [*Premium*](sql-database-service-tiers.md) bases de données SQL Azure, pas pour les bases de données sur le niveau de service Standard ou de base.
> 
> 
...
* L’utilisation des fonctionnalités In-Memory OLTP avec les bases de données dans des pools élastiques n’est pas prise en charge pour l’instant dans la version préliminaire.
  ...
  * 1. Modifiez le niveau de service de la base de données en standard
  * 1. Déplacez la base de données vers le pool élastique
