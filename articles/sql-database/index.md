---
title: "Documentation Azure SQL Database - Didacticiels, informations de référence sur les API | Microsoft Docs"
description: "Découvrez comment utiliser les bases de données SQL Azure."
...
---
<div class="content">
    <h1>Documentation SQL Database</h1>
    <div class="introHolder" style="justify-content: space-between;">
        <div class="intro" style="min-width: 200px">
            <p>Azure SQL Database est une base de données relationnelle en tant que service reposant sur le moteur Microsoft SQL Server. SQL Database est une base de données hautes performances, fiable et sécurisée, que vous pouvez utiliser pour créer des applications et des sites web axés sur les données dans le langage de programmation de votre choix, sans avoir à gérer l’infrastructure. Découvrez comment utiliser SQL Database avec nos guides de démarrage rapide, nos didacticiels et nos exemples.</p>
        </div>
        <a href="https://azure.microsoft.com/en-us/resources/videos/create-sql-database-on-azure/">
            <div class="calloutHolder" style="max-width: 250px">
                ...
                <div>
                    <p style="margin-top: 0; color: #6e6e6e">Créez une base de données SQL sur Azure. (3:12)</p>
                </div>
            </div>
        </a>
    </div>
<h2 style="margin-top: 18px; margin-bottom: 0px;">Démarrages en 5 minutes</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">Apprenez à créer une base de données SQL, à la gérer à l’aide de SQL Management Studio, et à la développer dans C#, Java, Python, Node.js et Ruby :</p>
<div class="ico48Case">
    <div class="ico48Link">
...
<p>Apprenez à créer, gérer et migrer des bases de données à l’aide de SQL DB</p>
<ol>
    <li><a href="/azure/sql-database/sql-database-design-first-database">Créer et concevoir le schéma pour une nouvelle base de données SQL</a></li>
    <li><a href="/azure/sql-database/sql-database-migrate-your-sql-server-database">Migrer une base de données SQL Server existante vers Azure SQL Database</a></li>
</ol>

<h2 style="margin-top: 36px">Formation vidéo gratuite Pluralsight</h2>
...
<p>Trouver des scripts pour gérer les tâches courantes</p>
<ul class="spaced">
    <li><a href="/azure/sql-database/sql-database-cli-samples">Interface de ligne de commande Azure</a></li>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/powershell/elasticdatabasejobs/v0.8.33/elasticdatabasejobs">Azure PowerShell (base de données élastique)</a></p>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://msdn.microsoft.com/library/mt238365.aspx">Outils SQL Server</a></p>
                        <p><a href="https://msdn.microsoft.com/library/mt238290.aspx">SQL Server Management Studio (SSMS)</a></p>
                        <p><a href="https://msdn.microsoft.com/library/mt204009.aspx">Outils SQL Server Data Tools (SSDT)</a></p>
                        ...
                        <p><a href="https://www.nuget.org/packages/Microsoft.Azure.Management.Sql">Package de bibliothèque de gestion SQL Database</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Pilotes SQL Server</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt654049.aspx">Pilotes SQL Server</a></p>
