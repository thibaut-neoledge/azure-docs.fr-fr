---
title: Prise en main du masquage des données dynamiques de base de données SQL (portail Azure Classic)
...
> [!NOTE]
> Pour configurer le masquage des données dynamiques dans le portail Azure, consultez [Prise en main du masquage des données dynamiques de base de données SQL (portail Azure)](sql-database-dynamic-data-masking-get-started.md).
> 
> 
