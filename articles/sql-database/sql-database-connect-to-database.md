...
# Connexion à une base de données SQL Azure avec SSMS

Voici les étapes pour vous connecter à une base de données SQL Azure Microsoft à l'aide de SQL Server Management Studio.
