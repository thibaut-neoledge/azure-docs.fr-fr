---
title: 'Développement de base de données C# : pools de bases de données élastiques | Microsoft Docs'
...
> [!NOTE]
> La bibliothèque SQL Database pour .NET est actuellement en version préliminaire.
> 
> 
