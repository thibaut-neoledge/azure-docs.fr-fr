...
- Déterminez la compatibilité de la base de données, puis choisissez la méthode de migration adaptée à vos besoins. Suivez les instructions et les options dans Migration d’une base de données SQL Server.
