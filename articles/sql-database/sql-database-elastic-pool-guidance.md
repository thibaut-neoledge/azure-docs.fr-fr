...
Pour plus d’informations sur les tailles disponibles, consultez l’article [Limites relatives aux eDTU et au stockage pour les pools et bases de données élastiques](sql-database-elastic-pool.md#edtu-and-storage-limits-for-elastic-pools-and-elastic-databases).
...
Pour obtenir des évaluations plus flexibles de l’utilisation des ressources, qui acceptent des estimations de dimensionnement ad hoc pour les serveurs antérieurs à la version 12, ainsi que des estimations de dimensionnement pour les bases de données de différents serveurs, voir [Script PowerShell pour identifier les bases de données adaptées à un pool de bases de données élastique](sql-database-elastic-pool-database-assessment-powershell.md).
...
* [Créer un pool élastique](sql-database-elastic-pool-create-portal.md)
...
* [PowerShell script for identifying databases suitable for an elastic pool (Script PowerShell pour identifier les bases de données adaptées à un pool élastique)](sql-database-elastic-pool-database-assessment-powershell.md)
