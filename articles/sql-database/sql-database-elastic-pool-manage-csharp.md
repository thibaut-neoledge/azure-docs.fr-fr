<properties
    pageTitle="Gérer un pool de bases de données élastique (C#) | Microsoft Azure"
...
# Gérer un pool de bases de données élastique (C#)
...
## Gérer un exemple de pool de bases de données élastique (C#)
