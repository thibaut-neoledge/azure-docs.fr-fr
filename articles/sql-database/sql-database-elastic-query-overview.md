...
---
# <a name="azure-sql-database-elastic-database-query-overview-preview"></a>Vue d’ensemble de la requête de base de données élastique Azure SQL Database (version préliminaire)
...
## <a name="elastic-database-query-scenarios"></a>Requêtes de base de données élastique : scénarios
...
## <a name="implementing-elastic-database-queries"></a>Implémentation de requêtes de base de données élastique
...
Vous trouverez d’autres informations sur les opérations requises pour le scénario de partitionnement vertical dans [Requête élastique pour le partitionnement vertical](sql-database-elastic-query-vertical-partitioning.md).  
