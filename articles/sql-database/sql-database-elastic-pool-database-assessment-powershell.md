...
> [!IMPORTANT]
> Conservez la fenêtre PowerShell ouverte pendant l’exécution du script. Ne fermez pas la fenêtre PowerShell tant que vous n’avez pas exécuté le script pendant la durée nécessaire. 
> 
> 
...
* La dernière version de Microsoft Azure PowerShell. Pour plus de détails, consultez la rubrique [Installation et configuration d’Azure PowerShell](/powershell/azureps-cmdlets-docs).
