...
- Consultez la [page de tarification](https://azure.microsoft.com/pricing/details/sql-database/) pour une base de données unique et les tarifs et calculatrices pour les bases de données élastiques.
