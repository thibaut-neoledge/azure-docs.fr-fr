<properties
	pageTitle="Prise en main de Tâches de bases de données élastiques"
...
##Créez la tâche pour exécuter un script sur le groupe de bases de données personnalisé
...
## Récupérez l'état de l'exécution d'une tâche unique
