---
title: "Prise en main de Tâches de bases de données élastiques"
...
## <a name="creates-a-custom-collection-and-adds-all-databases-in-the-server-to-the-custom-collection-target-with-the-exception-of-master"></a>Crée une collecte personnalisée et ajoute toutes les bases de données du serveur à la cible de la collecte personnalisée, à l'exception de la base de données principale.
