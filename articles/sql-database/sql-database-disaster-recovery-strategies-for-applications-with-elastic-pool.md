---
title: "Concevoir une application pour la récupération d’urgence cloud à l’aide de la géoréplication active dans une base de données SQL | Documents Microsoft"
...
* Comme le pool 2 ne contient désormais que les bases de données primaires, la charge de travail totale du pool va augmenter. Vous devez donc immédiatement augmenter la taille de son eDTU (5). 
