...
2. Restaurez une sauvegarde de votre base de données à un point dans le temps que vous souhaitez récupérer. Pour cela, consultez les étapes de la section [Point-In\_Time Restore](sql-database-recovery-using-backups.md#point-in-time-restore).
