<properties
	pageTitle="Créer et gérer un pool élastique de base de données SQL à l’aide de PowerShell | Microsoft Azure"
...
# Créer et gérer un pool élastique de bases de données SQL Azure
...
Cet article vous montre comment créer un pool élastique de bases de données avec le [portail Azure en version préliminaire](https://portal.azure.com).
