...
[Prerequisites for using the pymsSQL Python Driver for SQL Server](https://msdn.microsoft.com/library/mt694094.aspx#Mac) (Configuration requise pour l’utilisation du pilote Python pymsSQL pour SQL Server)
