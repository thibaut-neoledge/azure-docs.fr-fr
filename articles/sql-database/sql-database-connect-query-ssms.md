...
[!INCLUDE [Installation de SSMS](../../includes/sql-server-management-studio-install.md)]

[!INCLUDE [Connecter SSMS](../../includes/sql-database-sql-server-management-studio-connect-server-principal.md)]
