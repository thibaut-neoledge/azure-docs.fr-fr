...
3. Cliquez sur **Options**. Dans la section **Se connecter à la base de données**, entrez **mySampleDatabase** pour vous connecter à cette base de données que vous avez créée précédemment.
