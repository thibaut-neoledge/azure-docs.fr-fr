---
title: "Mises à l’échelle instantanées de bases de données SQL Azure"
...
---
# <a name="azure-sql-database-scales-on-the-fly"></a>Mises à l’échelle instantanées de bases de données SQL Azure
## <a name="when-your-app-grows-from-a-small-number-of-customers-to-just-about-everyone-azure-sql-database-can-scale-on-the-fly-with-minimal-app-downtime"></a>Lorsque votre application passe d’un petit nombre de clients à une utilisation quasi universelle, votre base de données SQL Azure peut évoluer simultanément avec une interruption minimale de l’application.
...
## <a name="within-your-budget"></a>Respecter le budget
La dernière chose dont vous devriez vous préoccuper lorsque vous créez une application est le coût de la base de données. C’est pourquoi les bases de données SQL disposent d’un plan de paiement à l’utilisation. Choisissez l’offre de base, standard ou premium, en fonction des performances dont vous avez besoin et de votre budget. Ensuite, si votre application rencontre un franc succès, vous pouvez à tout moment passer à un plan supérieur.

[Lire la documentation](http://go.microsoft.com/fwlink/?LinkID=787570)

## <a name="get-the-fastest-performance"></a>Obtenir des performances optimales
