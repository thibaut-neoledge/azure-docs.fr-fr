...
* [Documentations officielles sur le module][docs] (en anglais)
* [Didacticiel sur VoIP avec des applications node.js][voipnode] (en anglais)
* [Votr - application de vote par SMS en temps réel avec node.js et CouchDB (trois parties)][votr] (en anglais)
* [Programmation par paire dans le navigateur avec node.js][pair] (en anglais)
