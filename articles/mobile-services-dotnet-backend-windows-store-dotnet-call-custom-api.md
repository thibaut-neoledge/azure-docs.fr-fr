...
[.NET principal](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-call-custom-api ".NET principal") | [JavaScript principal](/en-us/documentation/articles/mobile-services-windows-store-dotnet-call-custom-api "JavaScript principal")
...
-   [Définition d'une API personnalisée qui prend en charge les notifications périodiques](/en-us/documentation/articles/mobile-services-windows-store-dotnet-create-pull-notifications)
