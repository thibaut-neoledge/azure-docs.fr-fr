<properties title="Enable your pipelines to work with on-premises data" pageTitle="Activation de vos pipelines pour utiliser des données locales | Azure Data Factory" description="Learn how to register an on-premises data source with an Azure data factory and copy data to/from the data source." metaKeywords=""  services="data-factory" solutions=""  documentationCenter="" authors="spelluru" manager="jhubbard" editor="monicar" />
