---
title: Développer et exécuter Azure Functions en local | Microsoft Docs
...
3. Créez une variable d’environnement nommée AzureWebJobsServiceBus et affectez-lui votre chaîne de connexion Service Bus.
...
4. Assurez-vous que les autres variables d’environnement dont vous avez besoin sont définies. (Consultez la section précédente [Conditions préalables conditionnelles](#conditional-prerequisites)).
5. Démarrez Visual Studio et ouvrez la solution WebJobs.Script.
...
7. Si votre projet de démarrage est WebJobs.Script.Host :
...
8. Si votre projet de démarrage est WebJobs.Script.WebHost :
...
9. Ouvrez le fichier *sample\\host.json* et ajoutez une propriété `functions` pour spécifier les fonctions que vous souhaitez exécuter.
...
10. Créez et exécutez la solution.
