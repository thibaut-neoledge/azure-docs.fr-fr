...
[!INCLUDE [structure de dossier de fonctions](../../includes/functions-folder-structure.md)]
...
[!INCLUDE [calcul dynamique](../../includes/functions-bindings.md)]

## Problèmes liés aux rapports
[!INCLUDE [Problèmes liés aux rapports](../../includes/functions-reporting-issues.md)]
