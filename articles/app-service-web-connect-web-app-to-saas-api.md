...
1. Mettez à jour l’affichage `Contact` afin de refléter la liste dynamique de contacts par le code suivant : <pre>// Add to the very top of the view file @model IList&lt;MyContactsList.Web.Models.Contact&gt;
