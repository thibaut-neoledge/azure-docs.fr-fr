...
<ol start="3">
<li><p>Dans Visual Studio 2012 Express pour Windows 8, ouvrez le projet que vous avez créé en suivant le didacticiel <a href="/fr-fr/develop/mobile/tutorials/get-started/">Prise en main de Mobile Services</a>.</p></li> 
