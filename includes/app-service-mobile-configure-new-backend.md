...
2. Sous **Créer une table API**, sélectionnez le **langage du serveur principal**, **C#** ou **Node.js** :
	...
	+ **Serveur principal Node.js** (via portail) : 
	acceptez l’accusé de réception, puis cliquez sur **Créer une table TodoItem**. Cette action crée une table *TodoItem* dans votre base de données.
