...
1. Ajoutez le fichier **ClientManager.swift** avec le contenu suivant. Remplacez _%AppUrl %_ par l’URL du serveur principal Azure Mobile App.
...
2. Dans **AppDelegate.swift**, ajoutez les méthodes de gestionnaire suivantes. L’application est mise à jour et prend en charge les notifications Push.
