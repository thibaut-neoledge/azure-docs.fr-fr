...
2. Accédez à la page Swagger en ajoutant `/swagger` à la fin de l’URL de base.
   
   ![](./media/app-service-api-define-api-app/swaggerhome.png)
3. Cliquez sur **Contacts > Obtenir > Essayez-le**. Vous constatez que l’API fonctionne et retourne le résultat attendu.
   
    ![](./media/app-service-api-define-api-app/swaggertry.png)
4. Dans Visual Studio, cliquez sur **Déboguer > Arrêter le débogage**.
