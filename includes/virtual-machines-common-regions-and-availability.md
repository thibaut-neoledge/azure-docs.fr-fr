...
Vous pouvez également créer vos propres images personnalisées et les charger à l’aide de la [CLI Azure](../articles/virtual-machines/linux/upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) ou d’[Azure PowerShell](../articles/virtual-machines/windows/upload-generalized-managed.md) pour créer rapidement des machines virtuelles personnalisées selon les besoins spécifiques de votre build.
