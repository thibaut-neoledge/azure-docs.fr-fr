...
* Cliquez sur **Manage subscriptions** pour installer un certificat de gestion permettant d’accéder à votre compte.
  ...
  Dans la boîte de dialogue **Gérer les abonnements Azure**, cliquez sur l’onglet **Certificats**, puis sur **Importer**. Suivez la procédure pour télécharger et importer un fichier d’abonnement (portant l’extension *.publishsettings* ) pour votre compte Azure.
