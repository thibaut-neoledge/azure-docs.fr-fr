...
### <a name="apply-literal-value-to-tag-name"></a>Appliquer une valeur littérale au nom de balise
...
### <a name="apply-object-to-tag-element"></a>Appliquer un objet à l’élément de balise
...
### <a name="apply-json-string-to-tag-name"></a>Appliquer une chaîne JSON au nom de balise
