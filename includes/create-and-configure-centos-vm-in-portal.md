...
Si vous utilisez un ordinateur Windows, connectez-vous à la machine virtuelle en utilisant PuTTY, que vous pouvez télécharger sur la [page de téléchargement de PuTTY][3].
...
2.  Entrez le **Host Name** << testlinuxvm.cloudapp.net >> et le numéro de **Port** << 22 >>. 
	![Écran PuTTY](./media/create-and-configure-centos-vm-in-portal/putty.png)
