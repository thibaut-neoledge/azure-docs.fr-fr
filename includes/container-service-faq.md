...
Vous pouvez faire évoluer le nombre d’agents dans le cluster à l’aide du portail Azure ou d’outils de ligne de commande. Consultez [Mise à l’échelle d’un cluster Azure Container Service](../articles/container-service/kubernetes/container-service-scale.md).
