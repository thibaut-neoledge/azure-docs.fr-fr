...
> [AZURE.NOTE]
> Les objets <a href="http://msdn.microsoft.com/fr-FR/library/windowsazure/jj554218.aspx" target="_blank">request</a> et <a href="http://msdn.microsoft.com/fr-FR/library/windowsazure/dn303373.aspx" target="_blank">response</a> fournis aux fonctions API personnalisées sont implémentés par la <a href="http://go.microsoft.com/fwlink/p/?LinkId=309046" target="_blank">bibliothèque Express.js</a>. Pour plus d'informations, consultez la page <a href="http://msdn.microsoft.com/fr-FR/library/windowsazure/dn280974.aspx" target="_blank">API personnalisée</a>. 
