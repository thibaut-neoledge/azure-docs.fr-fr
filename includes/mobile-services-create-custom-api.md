...
> [WACOM.NOTE]
> Les objets [request][] et [response][] fournis aux fonctions API personnalisées sont implémentés par la [bibliothèque Express.js][]. Pour plus d'informations, consultez la page [API personnalisée][].
