...
Les disques de données résident sur Azure Storage et peuvent être utilisés pour le stockage permanent des fichiers et des données d'application.
...
2. Cliquez sur **Machines virtuelles**, puis sélectionnez la machine virtuelle **MaMVTest1** créée précédemment.

3. Dans la barre de commandes, cliquez sur **Attacher**, puis sur **Attacher un disque vide**.
	
	La boîte de dialogue **Attacher un disque vide** apparaît.
