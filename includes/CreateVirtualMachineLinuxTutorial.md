...
1.  Connectez-vous au [portail de gestion][3] Azure. 
	Dans la barre de commandes, cliquez sur **New**.
...
Sous Linux, le disque de ressources est habituellement géré par l'agent Linux Azure et monté automatiquement dans **/mnt/resource** (ou **/mnt** pour les images Ubuntu). Pour plus d'informations, consultez le [guide d'utilisation de l'agent Linux Azure][8].
...
* [Utilisation des outils en ligne de commande Azure pour Mac et Linux][10]
