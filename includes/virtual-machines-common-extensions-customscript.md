...
- [Déploiement de modèles avec l'interface de ligne de commande Azure](virtual-machines-linux-cli-manage.md)
- [Déploiement de modèles avec Azure Powershell](virtual-machines-windows-ps-manage.md)
...
2. Si les scripts sont exécutés sur une machine virtuelle existante, vérifiez que l’agent de machine virtuelle est activé sur la machine virtuelle. Sinon, suivez [the Linux](virtual-machines-linux-classic-manage extensions.md) ou [Windows](virtual-machines-windows-classic-manage extensions.md) pour en installer un.
