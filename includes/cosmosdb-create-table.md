...
1. Dans le portail Azure, dans le menu de navigation, sous **Tables**, cliquez sur **Explorateur de données**. 
2. Dans le panneau Explorateur de données, cliquez sur **Nouvelle collection**, puis renseignez la page à l’aide des informations suivantes.
    ...
    ![Explorateur de données dans le portail Azure](./media/cosmosdb-create-graph/azure-cosmosdb-data-explorer.png)
    ...
    ID de la collection|sample-database|L’ID de votre nouvelle collection. Les noms de collection sont soumis aux mêmes exigences de nombre de caractères que les ID de base de données.
