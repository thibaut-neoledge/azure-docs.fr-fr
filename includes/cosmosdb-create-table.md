...
2. Dans le panneau Explorateur de données, cliquez sur **Nouvelle table**, puis renseignez la page à l’aide des informations suivantes.
    ...
    ![Explorateur de données dans le portail Azure](./media/cosmosdb-create-table/azure-cosmosdb-data-explorer.png)
    ...
    ID de la table|sample-database|L’ID de votre nouvelle table. Les noms de tables sont soumis aux mêmes exigences de nombre de caractères que les ID de bases de données.
