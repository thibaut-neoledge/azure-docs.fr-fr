...
Si vous n'avez pas déjà ajouté votre site web comme point de terminaison de Traffic Manager, vous devez effectuer cette action pour faire fonctionner la résolution de noms, car le nom de domaine personnalisé assure l'acheminement vers Traffic Manager. Traffic Manager effectue ensuite l'acheminement vers votre site web. Utilisez les informations de la rubrique [Ajout ou suppression de points de terminaison][Ajout ou suppression de points de terminaison] pour ajouter votre site web comme point de terminaison dans votre profil Traffic Manager.
