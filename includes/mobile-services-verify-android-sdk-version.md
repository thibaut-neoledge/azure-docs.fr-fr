...
2. Dans l'onglet Explorateur de projets, sous **Scripts Gradle**, ouvrez le fichier **build.gradle (module : app)**. Vérifiez que **compileSdkVersion** et **buildToolsVersion** sont définis sur la dernière version installée du Kit de développement logiciel (SDK). Les balises peuvent se présenter comme suit :
