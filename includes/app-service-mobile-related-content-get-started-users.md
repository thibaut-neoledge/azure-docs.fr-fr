* [Présentation de l’authentification / autorisation App Service](../articles/app-service/app-service-authentication-overview.md)
* [Ajout de l’authentification à une application Web](../articles/app-service-web/app-service-web-get-started-2.md#authenticate-your-users)
* Ajoutez l’authentification à votre application mobile : [iOS][ios-get-started-users], [Android][android-get-started-users], [Windows universel][windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Forms][xamarin-forms-get-started-users], [Cordova][cordova-get-started-users]  
  Découvrez comment ajouter l’authentification App Service à votre application mobile.
* Authentification dans API Apps : [principal de l’utilisateur](../articles/app-service-api/app-service-api-dotnet-user-principal-auth.md), [principal du service](../articles/app-service-api/app-service-api-dotnet-service-principal-auth.md)  
  Découvrez comment sécuriser votre application API avec l’authentification App Service.
