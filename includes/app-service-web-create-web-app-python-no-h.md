...
Dans la commande suivante, le runtime est défini sur `python|3.4`. Pour voir tous les runtimes pris en charge, exécutez [az webapp list-runtimes](/cli/azure/webapp#list-runtimes). 
