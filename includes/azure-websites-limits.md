...
<tr>
   <td valign="middle"><p>plans d'hébergement Web</a><sup>3</sup></p></td>
...
<tr>
   <td valign="middle"><p>types d'instance de calcul<sup>4</sup></p></td>
...
<tr>
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-scale/">Mise à l'échelle</a> (instances max.)</p></td>
...
<tr>
   ...
   <td valign="middle"><p>1024 Mo<sup>7</sup></p></td>
   <td valign="middle"><p>1024 Mo</p></td>
...
<tr>
   <td valign="middle"><p>Prises Web<sup>8</sup></p></td>
   <td valign="middle"><p>5</p></td>
   <td valign="middle"><p>35</p></td>
   <td valign="middle"><p>350</p></td>
   <td valign="middle"><p>Illimité</p></td>
</tr><tr>
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-dotnet-troubleshoot-visual-studio/">Connexions de débogage</a> simultanées par application</p></td>
   ...
   <td valign="middle"><p>Pris en charge de <a href="http://azure.microsoft.com/documentation/articles/web-sites-custom-domain-name/">domaine personnalisé</a></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
</tr><tr>
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-configure-ssl-certificate/">Prise en charge SSL</a> de domaine personnalisé<sup>9</sup></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p>X</p></td>
   ...
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-configure/">Activation continue</a></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
...
<tr>
   <td valign="middle"><p>Prise en charge d'<a href="http://azure.microsoft.com/services/scheduler/">Azure Scheduler</a></p></td>
   <td valign="middle"><p></p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
   <td valign="middle"><p>X</p></td>
...
<tr>
   <td valign="middle"><p><a href="http://azure.microsoft.com/documentation/articles/web-sites-staged-publishing/">Emplacements intermédiaires (Aperçu)</a></p></td>
...
<sup>1</sup>Les quotas de sites Web et de stockage s'appliquent pour chaque plan d'hébergement Web, sauf mention contraire.
...
<sup>4</sup>Les instances dédiées peuvent être de petite, moyenne ou grande taille. Consultez la [page de tarification Sites Web Azure][websitespricing] pour plus de détails. Des instances supplémentaires sont disponibles par le biais d'une demande d'assistance.
...
<sup>10</sup>Exécution d'exécutables et/ou de scripts personnalisés à la demande, de manière programmée ou en continu en tant que tâche en arrière-plan au sein de votre instance de sites Web. La fonctionnalité AlwaysOn est nécessaire à l'exécution de tâches Web en continu. Azure Scheduler (version Gratuite ou Standard) est nécessaire aux tâches Web programmées.
