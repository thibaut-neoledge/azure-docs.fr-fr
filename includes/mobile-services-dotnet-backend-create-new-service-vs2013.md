...
4. De retour dans la boîte de dialogue **Créer un service mobile**, sélectionnez votre **Abonnement**, le backend **.NET Framework** dans **Exécution**, ainsi qu'une **Région** pour votre service mobile, puis tapez un **Nom** pour votre service mobile.
