...
## <a name="connect-to-the-virtual-machine"></a>Connexion à la machine virtuelle
...
## <a name="update-the-virtual-machine-optional"></a>Mise à jour de la machine virtuelle (facultatif)
