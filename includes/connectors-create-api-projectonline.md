...
1. Pour créer une connexion à ProjectOnline, dans le Concepteur d’applications logiques, sélectionnez **Afficher les API gérées** par Microsoft dans la liste déroulante, puis entrez *ProjectOnline* dans la zone de recherche. Sélectionnez le déclencheur ou l’action que vous allez utiliser :   
   ![ProjectOnline étape 1](./media/connectors-create-api-projectonline/projectonline-1.png)
2. Si vous n’avez créé aucune connexion à ProjectOnline auparavant, vous êtes invité à indiquer vos informations d’identification ProjectOnline. Ces informations d’identification serviront à autoriser votre application logique à se connecter et à accéder aux données de votre compte ProjectOnline :  
   ![ProjectOnline étape 2](./media/connectors-create-api-projectonline/projectonline-2.png)
3. Indiquez votre nom d’utilisateur et votre mot de passe ProjectOnline pour autoriser votre application logique :  
