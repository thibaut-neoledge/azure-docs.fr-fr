...
7. Accédez à **Haute disponibilité AlwaysOn** | **Groupes de disponibilité** | **<AvailabilityGroupName>** | **Écouteurs du groupe de disponibilité**.
...
9. Dans la zone **Port**, spécifiez le numéro de port pour l’écouteur du groupe de disponibilité à l’aide du $EndpointPort utilisé précédemment (dans ce didacticiel, la valeur par défaut était 1433), puis cliquez sur **OK**.
