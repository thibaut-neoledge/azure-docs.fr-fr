...
1. Ouvrez un navigateur web et accédez à la page <http://azure.microsoft.com/>.
...
## <a name="enable-azure-preview-features"></a>Activer des fonctionnalités préliminaires d'Azure
1. Accédez à la page <https://account.windowsazure.com/> et connectez-vous avec votre compte Azure.
2. Cliquez sur **Fonctionnalités préliminaires** pour afficher les versions préliminaires disponibles.<br />
   ![onglet Fonctionnalités préliminaires ouvert][1]
3. Faites défiler la page vers le bas pour afficher la fonctionnalité que vous voulez activer, puis cliquez sur **Essayez maintenant**.<br />
   ![sélection d’une fonctionnalité préliminaire][2]
4. Sélectionnez votre abonnement et cliquez sur la coche.<br />
   ![sélection d’un abonnement][3]
