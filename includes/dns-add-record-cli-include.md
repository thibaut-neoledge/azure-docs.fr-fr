...
Si vous créez un enregistrement SRV à la racine de la zone, vous pouvez spécifier « \_service » et « \_protocol » dans le nom de l’enregistrement. Il est inutile d’inclure également « . @ » dans le nom de l’enregistrement.
