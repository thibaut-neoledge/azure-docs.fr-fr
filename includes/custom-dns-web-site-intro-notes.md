> [AZURE.NOTE]**Cet article concerne Web Apps** ; pour Cloud Services, consultez la rubrique <a href="/develop/net/common-tasks/custom-dns/">Configuration d’un nom de domaine personnalisé dans Azure</a>.
>
