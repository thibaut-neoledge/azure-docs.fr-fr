...
> [AZURE.NOTE]  Si votre application est équilibrée par [Azure Traffic Manager](https://azure.microsoft.com/services/traffic-manager/), cliquez sur le sélecteur en haut de cet article pour obtenir des étapes spécifiques.
>
