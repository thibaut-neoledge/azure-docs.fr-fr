...
* **RegistryRead**. Accorde l’accès en lecture au registre d’identité des appareils. Pour plus d’informations, voir [Registre des identités des appareils][lnk-identity-registry].
* **RegistryReadWrite**. Accorde l’accès en lecture et en écriture au registre d’identité des appareils. Pour plus d’informations, voir [Registre des identités des appareils][lnk-identity-registry].
