 <h1>Livres blancs à propos d'Azure</h1>
  <p>Les livres blancs répertoriés ci-dessous apportent de nouvelles vues et perspectives à propos des services Azure.</p>
  <p>(par ordre de popularité)</p>
  <table border="1" cellspacing="0" cellpadding="10" style="border: 0.5px solid #000000;">
    <tbody>
      <tr>
        ...
        <td style="width: 400px;">Ce document se concentre sur les défis liés à la sécurité et les approches recommandées pour concevoir et développer des applications à la sécurité renforcée pour la plateforme Azure de Microsoft.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
        ...
        <td style="width: 400px;">Ce document décrit les dispositifs de contrôle implémentés au sein d'Azure afin que les utilisateurs puissent déterminer si ces fonctions et contrôles correspondent à leurs besoins propres.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
        ...
        <td style="width: 400px;">Ce document contient les instructions étape par étape pour utiliser Windows Identity Foundation, Azure et Active Directory Federation Services (AD FS) 2.0 pour bénéficier de l'identification SSO sur l'ensemble des applications Web déployées sur site et dans le cloud.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
          <a href="http://go.microsoft.com/fwlink/?LinkId=153401">Table Azure - Programmation du stockage des tables</a>
        </td>
        <td style="width: 400px;">Ce document décrit la table Azure, stockage structuré fourni par la plateforme Azure. Celui-ci prend en charge des tables très évolutives sur le cloud, pouvant contenir des milliards d'entités et plusieurs téraoctets de données.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
      ...
      <tr>
        ...
        <td style="width: 400px;">Ce document présente les avantages de l'offre cloud <em>PAAS</em> et indique comment cette dernière est implémentée au sein d'Azure.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
      ...
      <tr>
        ...
        <td style="width: 400px;">Ce document étudie ce qu'apporte Azure Caching aux différents types de modèle de cache pris en charge par le service caching. Il couvre également les principaux problèmes liés à l'utilisation d'un cache. Des points importants à prendre en compte lors de la conception d'applications pour tirer pleinement parti du cache.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
      ...
      <tr>
        ...
        <td style="width: 400px;">Ce document fournit des indications sur le déploiement d'une base de données SQL Server existante locale dans SQL Azure. Il présente également les meilleures pratiques concernant la migration de données. </td>
      </tr>
