...
>[AZURE.NOTE] Pour plus d’informations sur les capacités des machines virtuelles, consultez la page [Tailles des machines virtuelles Linux](../articles/virtual-machines/virtual-machines-linux-sizes.md) ou [Tailles des machines virtuelles Windows](../articles/virtual-machines/virtual-machines-windows-sizes.md).
