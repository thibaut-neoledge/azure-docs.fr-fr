1. Dans l’explorateur de projets, développez **app** => **src** => **main** => **java** => **com.example.GetStartedWithData**, puis ouvrez le fichier *ToDoActivity.java*.
   	...
   	Notez que des commentaires `//TODO` indiquent les étapes à suivre pour que cette application fonctionne avec votre service mobile.
...
4. Choisissez un périphérique connecté ou *Lancez l’émulateur*.
