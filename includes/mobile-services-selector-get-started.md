...
-   [(Appcelerator | Javascript)][]
  ...
  [(Windows Store C# | .NET)]: /fr-fr/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started/
  [(Windows Store C# | Javascript)]: /fr-fr/documentation/articles/mobile-services-javascript-backend-windows-store-dotnet-get-started/
  [(Windows Store JavaScript | .NET)]: /fr-fr/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started/
  [(Windows Store JavaScript | Javascript)]: /fr-fr/documentation/articles/mobile-services-javascript-backend-windows-store-javascript-get-started/
