...
4. Lorsque l’application apparaît, tapez un texte explicite, par exemple *Terminer le didacticiel*, puis cliquez sur **Ajouter**.
   ...
   > 
   > 
5. De retour dans le portail Azure Classic, cliquez sur l’onglet **Données**, puis sur le tableau **TodoItems**.
