...
2.	Dans la barre de lancement, cliquez sur **Nouveau**, sélectionnez **Données + stockage**, puis cliquez sur **DocumentDB**. 
	...
	![Capture d’écran du portail Azure en version préliminaire pour créer une base de données, mise en surbrillance du bouton Nouveau, de Données + stockage dans le panneau Créer et d’Azure DocumentDB dans le panneau Données + stockage](media/documentdb-create-dbaccount/ca1.png)

3. Dans le panneau **Nouveau compte DocumentDB**, indiquez la configuration souhaitée pour le compte DocumentDB.
 
	![Capture d’écran du panneau Nouveau DocumentDB](media/documentdb-create-dbaccount/ca3.png)
