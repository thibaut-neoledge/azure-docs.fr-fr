...
- équilibrer la charge du trafic Internet entrant sur les machines virtuelles. L’équilibreur de charge auquel nous faisons référence dans ce scénario est un [équilibreur de charge accessible sur Internet](../articles/load-balancer/load-balancer-internet-overview.md) ;
