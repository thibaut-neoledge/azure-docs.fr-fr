...
[Visual Studio Application Insights](../article/application-insights/app-insights-overview.md) surveille vos applications en direct pour vous aider à [détecter et diagnostiquer les problèmes de performances et les exceptions](../article/application-insights/app-insights-detect-triage-diagnose.md), mais aussi [découvrir comment votre application est utilisée](../article/application-insights/app-insights-overview-usage.md).
