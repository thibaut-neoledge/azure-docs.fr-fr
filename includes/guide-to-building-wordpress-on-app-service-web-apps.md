...
### <a name="wordpress-and-azure-app-service"></a>WordPress et Azure App Service
...
* [Déploiement d'une application web WordPress prise en charge par le cluster de réplication MySQL](https://azure.microsoft.com/documentation/templates/wordpress-mysql-replication/)
* [Génération de votre propre cluster MySQL maître-maître à l’aide du cluster Percona](https://azure.microsoft.com/documentation/templates/mysql-ha-pxc/) et [en savoir plus sur la gestion du cluster](https://github.com/fanjeffrey/axiom.articles/tree/master/pxc)
* [Déploiement de WordPress pris en charge par le cluster de réplication MySQL avec une configuration maître-esclave](https://azure.microsoft.com/documentation/templates/mysql-replication/)
* [Déploiement d'une application WordPress prise en charge par la base de données SQL Azure gérée par ProjectNami](https://azure.microsoft.com/marketplace/partners/projectnami/projectnami/)
* [Création d’une application web WordPress multisite](../articles/app-service-web/web-sites-php-convert-wordpress-multisite.md)

### <a name="porting-your-application-to-app-service"></a>Portage de votre application vers App Service
* [Planification de votre migration vers Azure App Service](https://azure.microsoft.com/blog/how-to-plan-your-migration-to-azure-websites/)
* [Migration d’un site WordPress vers Azure Web Apps](https://sunithamk.wordpress.com/2013/11/06/migrate-your-existing-wordpress-site-to-windows-azure/)
* [Migration de votre application web de Linux vers Azure Web Apps](https://www.movemetothecloud.net/LinuxMigration)
...
* [Configuration de PHP](../articles/app-service-web/web-sites-php-configure.md)
* [Configuration de plusieurs environnements de développement pour votre application WordPress](../articles/app-service-web/app-service-web-staged-publishing-realworld-scenarios.md)
