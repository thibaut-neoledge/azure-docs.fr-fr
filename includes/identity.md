...
L'exécution de Windows Server AD dans les machines virtuelles Azure est fort similaire à une exécution locale. La [figure 1](#fig1) illustre un exemple type.
...
La [figure 2](#fig2) illustre la première de ces deux possibilités, dans laquelle Azure Active Directory est tout ce qu'il faut.
...
Ce jeton contient des informations identifiant l'utilisateur et il est signé numériquement par Azure AD. Pour obtenir le jeton, l'utilisateur s'authentifie auprès d'Azure AD en fournissant un nom d'utilisateur et un mot de passe (étape 2). Azure AD renvoie ensuite le jeton requis
(étape 3).
...
David Chappell est directeur associé de Chappell & Associates [www.davidchappell.com][4] à San Francisco, en Californie. Par le biais de ses conférences, de ses livres et de ses services de conseil, il permet aux individus du monde entier de comprendre, d'utiliser et de mettre à profit les nouvelles technologies.
