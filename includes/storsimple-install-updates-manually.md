<properties
   pageTitle="Installation manuelle des mises à jour"
   description="Explique comment utiliser la fonctionnalité de mise à jour de StorSimple et le portail de gestion pour installer les mises à jour manuellement."
   services="storsimple"
...
4. Un message s’affiche si des mises à jour logicielles sont disponibles. Cliquez sur **Installer les mises à jour** pour lancer la mise à jour de l’appareil.
    ...
    Un message s’affiche une fois que la mise à jour a été correctement installée. <!--HONumber=52-->
