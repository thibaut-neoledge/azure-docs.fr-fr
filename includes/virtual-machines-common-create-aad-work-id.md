...
## <a name="locate-your-default-directory-in-the-azure-classic-portal"></a>Localisez votre répertoire par défaut sur le portail Azure Classic
...
## <a name="creating-a-new-user-in-the-default-domain"></a>Création d'un nouvel utilisateur dans le domaine par défaut
...
## <a name="logging-in-and-changing-the-new-users-password"></a>Connexion et modification du mot de passe du nouvel utilisateur
