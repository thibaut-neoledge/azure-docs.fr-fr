## <a name="column-mapping-with-translator-rules"></a>Mappage de colonnes avec règles de conversion
...
## <a name="column-mapping-samples"></a>Exemples de mappages de colonnes
> [!NOTE]
