...
### Bloc 1 C# : Connexion via ADO.NET
...
### Bloc 2 C# : Création de tables via T-SQL
...
### Bloc 3 C# : Intégration de données via T-SQL
...
### Bloc 4 C# : Mise à jour de la jointure via T-SQL
...
### Bloc 5 C# : Suppression de la jointure via T-SQL
...
### Bloc 6 C# : Sélection de lignes via T-SQL
...
### Bloc 8 C# : Résultats effectifs du test de la console
