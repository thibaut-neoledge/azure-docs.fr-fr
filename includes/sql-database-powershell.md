...
>[AZURE.NOTE] Parmi les nouvelles fonctionnalités de la Base de données SQL, plusieurs sont uniquement prises en charge avec le [modèle de déploiement Azure Resource Manager (ARM)](../articles/resource-group-overview.md). Les exemples cités utilisent donc des [applets de commande PowerShell de base de données SQL Azure](https://msdn.microsoft.com/library/azure/mt574084.aspx) basées sur ARM. Les [applets de commande de base de données SQL Azure (classique)](https://msdn.microsoft.com/library/azure/dn546723.aspx) du modèle de déploiement existant sont prises en charge à des fins de compatibilité descendante. Cependant, l’utilisation d’applets de commande basées sur ARM est recommandée.
