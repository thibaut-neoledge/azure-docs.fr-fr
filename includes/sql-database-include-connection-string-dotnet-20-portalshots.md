...
Utilisez le [portail Azure en version préliminaire](http://portal.azure.com/) pour obtenir la chaîne de connexion nécessaire pour que votre programme client interagisse avec Azure SQL Database :
...
6. Si vous prévoyez d’utiliser la bibliothèque de connexions ADO.NET, copiez la chaîne intitulée **ADO.NET**.

	![Copier la chaîne de connexion ADO.NET pour votre base de données][3-get-connection-string]
...
Pour plus d’informations, consultez : [Chaînes de connexion et fichiers de configuration](http://msdn.microsoft.com/library/ms254494.aspx).
