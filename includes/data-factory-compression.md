...
> [AZURE.NOTE] Les paramètres de compression ne sont pas pris en charge pour les données au format **AvroFormat**, **OrcFormat** ou **ParquetFormat**. 
...
- **Type** : codec de compression, qui peut être **GZIP**, **Deflate** ou **BZIP2**.  
- **Level** : taux de compression, qui peut être **Optimal** ou **Fastest**. 
