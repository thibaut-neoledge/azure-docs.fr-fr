1. Sur votre serveur de configuration, lancez l’outil CSPSConfigtool.exe. Il est disponible sous forme de raccourci sur le bureau. Il se trouve dans le dossier [EMPLACEMENT D’INSTALLATION]\home\svsystems\bin.
