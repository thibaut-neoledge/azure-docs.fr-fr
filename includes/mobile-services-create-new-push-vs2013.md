...
5. Une fois l'Assistant terminé, une nouvelle page **L'installation Push est presque terminée** s'ouvre dans Visual Studio. Cette page présente une toute autre méthode permettant de configurer votre projet de service mobile pour envoyer des notifications. 
