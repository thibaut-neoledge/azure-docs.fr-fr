...
-   [Services de développement](#DevService)

**Services supplémentaires**
-   [Identité et accès](#identity)
-   [Mobilité](#mobile)
-   [Sauvegarde](#backup)
-   [Messagerie et intégration](#messaging)
-   [Assistance au calcul](#ComputeAssist)
-   [Performances](#Performance)
-   [Big Compute et données volumineuses](#BigStuff)
-   [Support](#media)
-   [Commerce](#commerce)
...
Le [portail de gestion Azure](http://manage.windowsazure.com) est une interface web qui permet aux administrateurs d'accéder à la plupart des fonctionnalités Azure (mais pas à toutes).  Microsoft publie généralement une version Bêta du nouveau portail d'interface utilisateur avant de supprimer l'ancien portail. La plus récente est appelée le [" Verison préliminaire du portail Azure "](https://portal.azure.com/). 
...
<h2><a id="Backup"></a>Sauvegarde</h2>
...
Compte tenu de la croissance qu'a connue Azure, les files d'attente Azure Storage et Service Bus fournissent des services de mise en file d'attente similaires. Les raisons qui peuvent vous inciter à utiliser l'une plutôt que l'autre sont présentées dans le document technique [<LINK>](http://msdn.microsoft.com/library/azure/hh767287.aspx "Azure Queues and Service Bus Queues - Compared and Contrasted").   Dans de nombreux scénarios, celles-ci peuvent être utilisées indifféremment. 
...
- Opérations d'application récurrentes : à titre d'exemple, un service peut régulièrement obtenir des données de Twitter et les rassembler dans un flux régulier.
...
Pour obtenir un aperçu visuel du fonctionnement de Media Services, téléchargez le [Poster Azure Media Services][Poster Azure Media Services].
...
Maintenant que vous connaissez les grandes lignes, la prochaine étape est de créer votre première application Azure. Choisissez votre langage, [téléchargez le Kit de développement logiciel (SDK) approprié](/fr-fr/downloads/), et vous n'avez plus qu'à vous lancer. Le cloud computing est la nouvelle norme. Adoptez-le dès maintenant.
