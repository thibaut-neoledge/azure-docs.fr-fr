...
4. Twilio et les applications logiques utilisent des noms différents pour identifier ces deux informations. Voici comment vous devez les mapper dans la boîte de dialogue Logic Apps :  
