1. Dans le [portail Azure Classic](https://manage.windowsazure.com/), cliquez sur votre nouveau service mobile ou sur son onglet d’icône cloud pour accéder à la page de présentation.
...
3. Si vous ne l'avez pas encore fait, téléchargez et installez [Visual Studio Professional 2013](https://go.microsoft.com/fwLink/p/?LinkID=391934) ou une version ultérieure.
...
5. En bas de cette section **Prise en main**, accédez à l'étape intitulée **Télécharger et publier votre service dans le cloud**. Cliquez sur le lien présenté dans la capture d’écran ci-dessous afin de télécharger un fichier de profil de publication pour le service mobile que vous venez de télécharger.
   ...
   > [!NOTE]
   > Enregistrez le fichier en lieu sûr, car il contient des informations sensibles sur votre compte Azure. Vous supprimerez ce fichier après la publication du service mobile, comme expliqué plus loin dans ce didacticiel.
   > 
   > 
