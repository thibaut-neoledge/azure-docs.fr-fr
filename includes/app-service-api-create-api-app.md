...
Créez une [application API](../articles/app-service-api/app-service-api-apps-why-best-platform.md) dans le plan App Service `myAppServicePlan` avec la commande [az webapp create](/cli/azure/appservice/web#create). 
