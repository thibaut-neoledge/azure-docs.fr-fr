...
3. Les options **Nom de la machine virtuelle**, **Emplacement de stockage** et **Nom de fichier** sont déjà définies pour vous. Il vous suffit d’entrer la taille de disque souhaitée. Tapez **5** dans le champ **Size**.
...
## <a name="connect-to-the-virtual-machine-using-ssh-or-putty-and-complete-setup"></a>Connexion à la machine virtuelle à l’aide de SSH ou PuTTY et achèvement de l’installation
