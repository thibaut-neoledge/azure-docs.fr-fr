...
1. Créez le réseau virtuel dans le [portail Azure](http://manage.windowsazure.com). Pour plus d'informations, consultez la page [Tâches de configuration du réseau virtuel](../documentation/services/virtual-machines.md).
...
[Tâches de configuration du réseau virtuel](../documentation/services/virtual-machines.md)
