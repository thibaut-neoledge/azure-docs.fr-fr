...
> [AZURE.NOTE] Quand les machines virtuelles sont dans le même service cloud, vous pouvez aussi en équilibrer la charge et gérer leur disponibilité, ce qui requiert des étapes supplémentaires. Pour plus d'informations, consultez les pages [Équilibrage de charge des machines virtuelles](../../articles/load-balance-virtual-machines/) et [Gestion de la disponibilité des machines virtuelles)]../../articles/manage-availability-virtual-machines/). 

Tout d'abord, vous devez créer une machine virtuelle avec un nouveau service cloud. Ensuite, vous allez créer des machines virtuelles supplémentaires dans le même service cloud. Ceci permet de les 'connecter'. 

1. Créez la première machine virtuelle en observant la procédure indiquée à la page [Création d'une machine virtuelle personnalisée)]../../articles/virtual-machines-create-custom/).
