...
### <a name="can-i-have-more-than-one-tunnels-between-azure-vpn-gateway-and-my-on-premises-network"></a>Puis-je avoir plusieurs tunnels entre ma passerelle VPN Azure et mon réseau local ?
