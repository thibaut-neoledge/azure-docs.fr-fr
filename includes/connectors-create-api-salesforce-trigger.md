...
- Le contrôle **Lors de la création d’un objet** s’affiche.  
![Image de déclencheur Salesforce 2](./media/connectors-create-api-salesforce/trigger-2.png)  
- Sélectionnez le **Type d’objet** puis sélectionnez *Prospect* à partir de la liste d’objets. Lors de cette étape, vous indiquez que vous créez un déclencheur qui informe votre application logique de la création d’un prospect dans Salesforce.  
![Image de déclencheur Salesforce 3](./media/connectors-create-api-salesforce/trigger-3.png)  
- Vous avez terminé. Vous avez créé le déclencheur. Toutefois, vous devez créer au moins une action pour en faire une application logique valide.  
