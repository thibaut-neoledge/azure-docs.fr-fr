...
<p>Si vous utilisez un fournisseur d'identit&eacute; autre que Facebook, remplacez la valeur transmise &agrave; la m&eacute;thode <strong>loginWithProvider</strong> ci-dessus par l'une des valeurs suivantes&nbsp;: <em>microsoftaccount</em>, <em>facebook</em>, <em>twitter</em>, <em>google</em> ou <em>windowsazureactivedirectory</em>.</p>
</div>
