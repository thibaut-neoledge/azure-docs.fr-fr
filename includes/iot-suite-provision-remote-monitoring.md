...
> [!NOTE]
> Si vous rencontrez des problèmes lors du déploiement de la solution préconfigurée, voir [Autorisations sur le site azureiotsuite.com][lnk-permissions] et la section [Forum Aux Questions][lnk-faq]. Si les problèmes persistent, créez un ticket de service sur le [portail][lnk-portal].
> 
> 
