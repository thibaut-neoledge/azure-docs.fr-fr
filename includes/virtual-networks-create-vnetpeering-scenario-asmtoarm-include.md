## <a name="a-namex-modelapeering-virtual-networks-created-through-different-deployment-models"></a><a name="x-model"></a>Homologation de réseaux virtuels créés via des modèles de déploiement différents
