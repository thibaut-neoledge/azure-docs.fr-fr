...
1.  Cliquez sur le nouveau site sur la page **Web Sites** pour ouvrir le tableau de bord du site.
...
5.  Vous obtenez un nouveau site WordPress ressemblant au site ci-dessous.
    ...
    ![votre site WordPress](./media/website-from-gallery/wordpressgallery-09.png)
