...
> [!NOTE]
> Ces étapes sont facultatives, car elles s'appliquent seulement au fournisseur de connexion Azure Active Directory.
> 
> 
...
2. Dans Visual Studio, développez App\_Start et ouvrez WebApiConfig.cs. Ajoutez l'instruction `using` suivante au début :
