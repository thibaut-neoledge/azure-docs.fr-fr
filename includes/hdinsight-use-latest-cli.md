> [!IMPORTANT]
> La prise en charge de la gestion des ressources HDInsight par l’interface de ligne de commande Azure à l’aide d’Azure Service Manager (ASM) est **déconseillée** ; elle sera supprimée le 1er janvier 2017. Dans ce document, la procédure repose sur les nouvelles commandes de l’interface de ligne de commande Azure qui fonctionnent avec Azure Resource Manager (ARM).
> 
