...
-->
## <a name="connect-to-the-azure-portal-with-a-subscription"></a>Connexion au portail Azure avec un abonnement
Vous devez disposer d’un abonnement pour vous connecter au portail Azure.

### <a name="get-a-new-account"></a>Obtention d’un nouveau compte
