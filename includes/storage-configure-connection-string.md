...
5.  Indiquez si vous souhaitez cibler l'émulateur de stockage (simulation de stockage Windows
    Azure sur votre ordinateur local) ou un
    compte de stockage dans le cloud. Le code de ce guide fonctionne dans
    les deux cas. Entrez la valeur **Clé d'accès primaire** copiée lors de l'étape
    précédente de ce didacticiel si vous souhaitez cibler
    le compte de stockage créé précédemment dans Azure.
