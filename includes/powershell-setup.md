...
Pour des instructions et un lien vers la dernière version, consultez la rubrique [Installation et configuration d’Azure PowerShell](../articles/powershell-install-configure.md).
...
Pour plus d’informations sur les comptes et les abonnements Azure, consultez [Procédure : Connexion à votre abonnement](../articles/powershell-install-configure.md#Connect).
