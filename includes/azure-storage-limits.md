...
| Taille maximale d'un bloc dans un objet blob de blocs ou ajouter des objets blob |100 Mo |
| Taille maximale d'un objet blob de blocs ou ajouter des objets blob |50 000 x 100 Mo (4,75 Go environ) |
