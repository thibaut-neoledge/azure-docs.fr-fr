...
2. Cliquez sur le nom de l'application web dans la liste Applications web.  
   ![WebAppEntry][entry-website]  
   Le tableau de bord de l'application web s'affiche.
...
5. Sans le champ **Name**, saisissez MONGOLAB_URI.
...
**Remarque :** Azure ajoute le préfixe **CUSTOMCONNSTR\_** à cette variable, ce qui explique pourquoi le code ci-dessus référence **CUSTOMCONNSTR\_MONGOLAB_URI.**
