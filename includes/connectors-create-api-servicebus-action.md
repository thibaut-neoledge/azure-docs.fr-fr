...
2. Sélectionnez le lien **Ajouter une action**. Ouvre la zone de recherche dans laquelle vous pouvez rechercher l’action que vous souhaitez effectuer. Pour cet exemple, les actions Service Bus nous intéressent.  
   ![Image d’action Service Bus 1](./media/connectors-create-api-servicebus/action-1.png)  
3. Saisissez *service bus* pour rechercher des actions liées à Service Bus.  
...
7. Vous pouvez éventuellement fournir d’autres détails sur le message.      
   ![Image d’action Service Bus 3](./media/connectors-create-api-servicebus/action-3.png)    
8. Enregistrez les modifications dans votre flux de travail   
