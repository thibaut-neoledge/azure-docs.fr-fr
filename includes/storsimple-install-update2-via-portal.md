...
6. Un ensemble de vérifications préalables démarre. Il s’agit des actions suivantes :
...
7. Une fois les vérifications préalables terminées, une tâche de mise à jour est créée. Un message s’affiche une fois la mise à jour créée.
