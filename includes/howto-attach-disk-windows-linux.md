Pour plus d'informations sur les disques des machines virtuelles Azure, consultez la rubrique [À propos des disques des machines virtuelles dans Azure][].

## <a id="attachempty"></a> Attacher un disque vide
...
1.  Cliquez sur **Virtual Machines**, puis sélectionnez la machine virtuelle appropriée.
...
2.  Dans la barre de commandes, cliquez sur **Attach**, puis sélectionnez **Attach Empty Disk**.
    ...
    ![Attacher un nouveau disque vide][]
...
5.  Cliquez sur la coche pour attacher le disque de données vide.
    ...
    ![Disque de données vide correctement attaché][]

## <a id="attachexisting"></a> Association d'un disque existant

Pour attacher un disque existant, vous devez disposer d'un fichier .vhd dans un compte de stockage. Utilisez le cmdlet [Add-AzureVhd][] pour télécharger le fichier .vhd dans le compte de stockage. Après avoir créé et téléchargé le fichier .vhd, vous pouvez l'attacher à une machine virtuelle.
...
2.  Dans la barre de commandes, cliquez sur **Attach**, puis sur **Attach Disk**.
    ...
    ![Entrer les détails du disque de données][]
...
4.  Cliquez sur la coche pour attacher le disque de données à la machine virtuelle.
    ...
    ![Disque de données correctement attaché][]
