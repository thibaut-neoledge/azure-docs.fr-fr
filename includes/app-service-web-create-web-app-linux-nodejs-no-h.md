...
Le runtime de la commande suivante est défini sur `NODE|8.1`. Pour voir tous les runtimes pris en charge, exécutez [az webapp list-runtimes](/cli/azure/webapp#list-runtimes). 
