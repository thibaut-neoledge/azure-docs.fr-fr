...
5.  Dans la boîte de dialogue **Personalize Add-on**, sélectionnez le plan **SendGrid** de votre choix pour l'inscription.
...
2.  Dans la boîte de dialogue *Connection info*, copiez le **Mot de passe** et le nom d'utilisateur pour une utilisation ultérieure dans ce didacticiel.
    ...
    Pour plus d'informations sur la mise en route de SendGrid, consultez la page [Mise en route de SendGrid][3].
