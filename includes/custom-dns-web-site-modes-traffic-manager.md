...
Pour plus d'informations sur les modes de plan App Service, notamment sur la modification du mode de votre site, voir [Mise à l'échelle des sites web](../article/app-service-web/web-sites-scale.md).
