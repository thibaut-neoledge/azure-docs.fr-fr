...
* [Sécurisation du trafic vers votre application avec l'activation du protocole TLS/SSL (Transport Layer Security) - HTTPS](../articles/app-service-web/app-service-web-tutorial-custom-ssl.md)
