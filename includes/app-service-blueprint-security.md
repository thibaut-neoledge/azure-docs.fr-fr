...
* [Sécurisation du trafic vers votre application avec l'activation du protocole TLS/SSL (Transport Layer Security) - HTTPS](../articles/app-service/app-service-web-tutorial-custom-ssl.md)
...
* [Configuration de l'authentification mutuelle TLS pour exiger des certificats client pour la connexion à votre application web](../articles/app-service/app-service-web-configure-tls-mutual-auth.md)
...
* [Connexion sécurisée de votre application aux ressources d'un réseau privé à l'aide d'un VPN de point à site](../articles/app-service/web-sites-integrate-with-vnet.md)
* [Isolation de la sécurité pour vos applications à l'aide d'environnements App Service Environments (ASE)](../articles/app-service/environment/intro.md)
  * [Configuration d'un pare-feu d'applications web (WAF) devant votre ASE ](../articles/app-service/environment/app-service-app-service-environment-web-application-firewall.md)
  * [Configuration du contrôle d'accès pour le trafic réseau entrant pour votre ASE](../articles/app-service/environment/app-service-app-service-environment-control-inbound-traffic.md)
  * [Connexion sécurisée aux ressources principales à partir de votre ASE](../articles/app-service/environment/app-service-app-service-environment-securely-connecting-to-backend-resources.md)
