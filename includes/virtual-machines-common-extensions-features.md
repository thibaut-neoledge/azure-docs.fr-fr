...
| **LinuxChefClient** | | |
| **DockerExtension** |Installe le démon Docker pour prendre en charge des commandes Docker distantes. |[Utilisation de l’extension de machine virtuelle Docker](../articles/virtual-machines/linux/dockerextension.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)Pour en savoir plus, consultez le [Guide de l’utilisateur Docker VM Extension](https://github.com/Azure/azure-docker-extension/blob/master/README.md). |
