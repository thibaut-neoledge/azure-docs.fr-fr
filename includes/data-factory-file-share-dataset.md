...
Pour obtenir une liste complète des sections et propriétés disponibles pour la définition de jeux de données, consultez l’article [Création de jeux de données](../articles/data-factory/v1/data-factory-create-datasets.md). Les sections comme la structure, la disponibilité et la stratégie d'un jeu de données JSON sont similaires pour tous les types de jeux de données.
...
Consultez les articles [Jeux de données dans Azure Data Factory](../articles/data-factory/v1/data-factory-create-datasets.md), [Planification et exécution avec Data Factory](../articles/data-factory/v1/data-factory-scheduling-and-execution.md) et [Pipelines et activités dans Azure Data Factory](../articles/data-factory/v1/data-factory-create-pipelines.md) pour en savoir plus sur les jeux de données de série chronologique, la planification et les segments.
