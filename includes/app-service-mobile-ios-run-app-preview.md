...
2. Appuyez sur le bouton **Exécuter** pour générer le projet et démarrer l'application dans l'émulateur iPhone.

3. Dans l'application, tapez un texte explicite, par exemple Suivre le didacticiel, puis cliquez sur l'icône plus (**+**).
