...
4. Arrêtez le débogage, changez le projet de démarrage par défaut de la solution Windows universelle en application du Windows Phone Store (cliquez avec le bouton droit sur le projet `<your app name>.WindowsPhone` et cliquez sur **Définir comme projet de démarrage**), puis appuyez de nouveau sur F5.
