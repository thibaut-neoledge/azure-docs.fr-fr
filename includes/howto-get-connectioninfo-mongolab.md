...
4. Cliquez sur **Connection Info**. ![ConnectionInfoButton][button-connectioninfo] Votre URI MongoLab s’affiche : ![ÉcranInformationsDeConnexion][screen-connectioninfo]  
