...
2. Développez **Azure Mobile Services**, cliquez sur **Contrôleur personnalisé Azure Mobile Services**, cliquez sur **Ajouter**, indiquez un **Nom de contrôleur** pour `CompleteAllController`, puis cliquez à nouveau sur **Ajouter**.
	...
	Cela crée une nouvelle classe de contrôleur vide nommée **CompleteAllController**.
...
3. Dans **CompleteAllController.cs**, ajoutez l'instruction **using** suivante : 	Remplacez `todolistService` par l'espace de noms de votre projet de service mobile, qui doit correspondre au nom du service mobile auquel est ajouté `Service`.
