...
2.  Publiez à nouveau le projet de service mobile dans Azure.
  ...
  [Prise en charge de plusieurs plateformes d'appareil à partir d'un service mobile unique]: /fr-fr/documentation/articles/mobile-services-how-to-use-multiple-clients-single-service/#push
