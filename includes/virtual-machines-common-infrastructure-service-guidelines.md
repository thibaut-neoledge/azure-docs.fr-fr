...
> [!NOTE]
> Groupes d’affinités sont déconseillés. Leur utilisation n’est pas décrite ici. Pour en savoir plus, consultez [À propos des réseaux virtuels régionaux et des groupes d’affinités](../articles/virtual-network/virtual-networks-migrate-to-regional-vnet.md).
> 
> 

## <a name="1-naming-conventions"></a>1. Conventions d’affectation de noms
...
### <a name="azure-building-block-names"></a>Noms des blocs de construction Azure
...
### <a name="implementation-guidelines-recap-for-naming-conventions"></a>Récapitulatif des instructions d’implémentation pour les conventions d’affectation de noms
Décision :
...
## <a name="2-subscriptions-and-accounts"></a>2. Abonnements et comptes
...
### <a name="implementation-guidelines-recap-for-subscriptions-and-accounts"></a>Récapitulatif des instructions d’implémentation pour les abonnements et les comptes
Décision :
...
### <a name="storage-layout-design"></a>Conception de la disposition du stockage
...
### <a name="implementation-guidelines-recap-for-storage"></a>Récapitulatif des instructions d’implémentation pour le stockage
Décisions :
...
## <a name="4-cloud-services"></a>4. Services cloud
...
> [!NOTE]
> Les services cloud n’existent pas dans Azure Resource Manager. Pour découvrir les avantages de Resource Manager, voir la page [Fournisseurs de calcul, de réseau et de stockage Azure dans Azure Resource Manager](../articles/virtual-machines/virtual-machines-windows-compare-deployment-models.md).
> 
> 
...
### <a name="implementation-guidelines-recap-for-cloud-services"></a>Récapitulatif des instructions d’implémentation pour les services cloud
Décision :
...
## <a name="5-virtual-networks"></a>5. Réseaux virtuels
...
### <a name="implementation-guidelines-recap-for-virtual-networks"></a>Récapitulatif des instructions d’implémentation pour les réseaux virtuels
Décisions :
...
## <a name="6-availability-sets"></a>6. Groupes à haute disponibilité
...
### <a name="implementation-guidelines-recap-for-availability-sets"></a>Récapitulatif des instructions d’implémentation pour groupes à haute disponibilité
Décision :
...
## <a name="7-virtual-machines"></a>7. Machines virtuelles
...
### <a name="implementation-guidelines-recap-for-virtual-machines"></a>Récapitulatif des instructions d’implémentation pour les machines virtuelles
Décision :
...
## <a name="example-of-an-it-workload-the-contoso-financial-analysis-engine"></a>Exemple d’une charge de travail informatique : le moteur d’analyse financière Contoso
...
### <a name="a-virtual-network-with-subnets"></a>Un réseau virtuel avec des sous-réseaux
