...
2. Rendez-vous sur le site Web <a href="http://go.microsoft.com/fwlink/p/?LinkId=268300" target="_blank">Twitter Developers</a>, connectez-vous avec les informations d'identification de votre compte Twitter, accédez à **My Applications**, puis sélectionnez votre application Twitter.
...
4. Connectez-vous au [portail de gestion Windows Azure], cliquez sur **Mobile Services**, puis sur votre service mobile.

5. Cliquez sur l'onglet **Identité**, entrez les valeurs **Consumer key** et **Consumer secret** obtenues sur le site de Twitter, puis cliquez sur **Enregistrer**. 

	![](./media/mobile-services-register-twitter-access/mobile-identity-tab-twitter-only.png)

2. Cliquez sur l'onglet **Configurer**, faites défiler jusqu'à **Paramètres de l'application** puis entrez une paire **Nom**/**Valeur**pour chacun des éléments suivants obtenus à partir du site de Twitter. Cliquez ensuite sur**Enregistrer**.
