1. Cliquez avec le bouton droit sur l’application API dans l’**Explorateur de solutions** et sélectionnez **Publier** pour ouvrir la boîte de dialogue de publication. Le profil de publication que vous avez créé précédemment doit être présélectionné. 
2. Cliquez sur **Publier** pour commencer le processus de déploiement.
...
3. Dans votre navigateur, accédez au [portail Azure en version préliminaire](https://portal.azure.com).
4. Accédez au panneau **Application API** pour l’application API que vous avez déployée.
...
5. Cliquez sur le lien **Passerelle**.
6. Dans le panneau **Passerelle**, cliquez sur **Redémarrer**.
