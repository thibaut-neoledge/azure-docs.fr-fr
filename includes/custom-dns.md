...
<h2><a name="add-aname"></a>Ajout d'un enregistrement A pour votre nom de domaine personnalisé</h2>
...
3. Sélectionnez ou entrez le domaine ou sous-domaine qui utilisera cet enregistrement A. Par exemple, sélectionnez **www** si vous souhaitez créer un alias pour **www.domainepersonnalisé.com**. Si vous souhaitez créer une entrée de caractère générique pour tous les sous-domaines, entrez '__*__'.couvre tous les sous-domaines tels que **mail.domainepersonnalisé.com**, **login.domainepersonnalisé.com**, et **www.domainepersonnalisé.com**.
...
-   [Mappage du contenu CDN à un domaine personnalisé][]
  ...
  [Échange d'adresses IP virtuelles]: http://msdn.microsoft.com/fr-fr/library/ee517253.aspx
