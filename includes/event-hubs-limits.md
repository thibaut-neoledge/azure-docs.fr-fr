...
| --- | --- | --- | --- | --- |
| Nombre d’Event Hubs par espace de noms |Espace de noms |statique |Les demandes suivantes de création d’un Event Hub seront rejetées. |10 |
...
| Taille maximale du nom d’un Event Hub |Entité |Statique |- |50 caractères |
