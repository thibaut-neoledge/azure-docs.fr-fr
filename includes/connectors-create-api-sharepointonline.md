...
1. Entrez SharePoint dans la zone de recherche et attendez que la recherche renvoie l’ensemble des actions et déclencheurs liés à SharePoint Online : ![Configurer SharePoint][1]
...
5. Une fois l’authentification terminée, vous reviendrez à votre application logique. Et c’est tout, vous pouvez voir que la connexion a été créée. Notez le message en bas qui indique que vous êtes maintenant connecté à SharePoint. ![Configurer SharePoint][4]
