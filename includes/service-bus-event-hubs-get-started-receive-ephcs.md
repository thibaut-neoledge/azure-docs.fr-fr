...
2. Cliquez sur **Services de données**, **Stockage**, puis **Création rapide**. Ensuite, tapez le nom de votre compte de stockage. Sélectionnez la région de votre choix, puis cliquez sur **Créer un compte de stockage**.
...
4. Dans Visual Studio, créez un projet d'application de bureau Visual C# à l'aide du modèle de projet **d'application console**. Nommez le projet **Récepteur**.
...
7. Créez une classe du nom de **SimpleEventProcessor**, puis ajoutez les instructions suivantes en haut du fichier :
...
[Guide de programmation de concentrateurs d'événements]: http://msdn.microsoft.com/fr-fr/library/azure/dn789972.aspx
