...
Avant de pouvoir stocker des données dans le nouveau service mobile, vous devez y créer une table de stockage. Cette procédure utilise Visual Studio 2013 pour créer une table dans le service mobile. Ensuite, vous mettez à jour l'application pour utiliser Mobile Services afin de stocker les éléments dans Azure et non dans la collection locale.
