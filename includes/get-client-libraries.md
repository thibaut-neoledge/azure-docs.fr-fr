...
Pour plus d’informations sur l’installation des bibliothèques clientes PHP pour Azure (y compris des informations sur l’installation en tant que package PEAR), consultez la page [Télécharger le Kit de développement logiciel (SDK) Azure pour PHP][Télécharger le Kit de développement logiciel (SDK) Azure pour PHP].
