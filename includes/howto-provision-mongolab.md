...
2. Cliquez sur **Nouveau**. ![Nouveau][button-new]
3. Sélectionnez **Store**. ![Store][button-store]
4. Sélectionnez MongoLab. Vous pouvez nous trouver sous la catégorie **App Services** ainsi que sous **Tout**. ![MongoLab][entry-mongolab]
5. Cliquez sur **Next**. ![Suivant][button-next] L'entrée du MongoLab Store s'affiche. ![NewMongoLab][screen-newmongolab]
...
9. Cliquez sur **Suivant**. ![Suivant][button-next]
10. Vérifiez les informations relatives à votre achat sur le store, puis cliquez sur **Acheter** pour confirmer. ![Suivant][button-purchase]  
11. Le bouton de progression de la barre d’outils vous indique l’état de la configuration. ![ProgressButton][button-progress] Un message de réussite s'affiche lorsque la configuration est terminée. ![SuccessMessage][message-success]
