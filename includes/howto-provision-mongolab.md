...
![Store][button-store]
1. Sélectionnez MongoLab. Vous pouvez nous trouver sous la catégorie ** 	Services d'application**, ainsi que dans la section **Tous**.  
![MongoLab][entry-mongolab]
1. Cliquez sur **Suivant**.  
![Suivant][button-next]  
  L'entrée du MongoLab Store s'affiche.  
![NewMongoLab][screen-newmongolab]
1. Sélectionnez l'option **Abonnement** souhaitée.
1. Entrez un **Nom** pour votre base de données. Le nom peut uniquement être composé de lettres, de chiffres, de tirets, de points et de traits de soulignement. MongoLab requiert également que ce nom soit unique. Il est possible que vous soyez invité à envoyer à nouveau votre demande si le nom est déjà pris.
...
1. Le bouton de progression de la barre d'outils vous indique l'état de la configuration.  
