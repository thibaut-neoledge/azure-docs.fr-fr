...
7. Saisissez une valeur dans la zone **Nom** pour votre base de données. Le nom peut uniquement être composé de lettres, de chiffres, de tirets, de points et de traits de soulignement. MongoLab requiert également que ce nom soit unique. Il est possible que vous soyez invité à envoyer à nouveau votre demande si le nom est déjà pris.
8. Sélectionnez la **Région**souhaitée.
9. Cliquez sur **Next**.  
   ![Next][button-next]
10. Vérifiez les informations relatives à votre achat sur le store, puis cliquez sur **Acheter** pour confirmer.  
