...
2. Dans le [portail Azure Classic](https://manage.windowsazure.com/), cliquez sur votre nouveau service mobile et sur la page de démarrage rapide, cliquez sur la plateforme **Android**, puis sous **Prise en main**, développez **Création d’une application Android**.
   
    ![](./media/mobile-services-download-service-locally/download-service-project.png)
3. Sous **Télécharger et publier votre service dans le cloud**, cliquez sur **Télécharger**.
