...
2. Dans le panneau Explorateur de données, cliquez sur **Nouvelle collection**, puis renseignez la page à l’aide des informations suivantes.
    ...
    ID de la collection|sample-graph|L’ID de votre nouvelle collection. Les noms de collection sont soumis aux mêmes exigences de nombre de caractères que les ID de base de données.
