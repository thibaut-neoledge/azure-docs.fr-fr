...
2. Sélectionnez le bouton **Outils** dans le coin supérieur droit. Dans **Options Internet**, sélectionnez l’onglet **Sécurité**, l’icône **Sites de confiance**, puis cliquez sur le bouton **Sites**. Ajoutez *http://*.mongodb.org* à la liste des sites de confiance. 3. Accédez à [Téléchargements - MongoDB][MongoDownloads].
...
13. Cliquez sur **Ajouter un point de terminaison** en bas de la page. Sélectionnez **Ajouter un point de terminaison**, puis cliquez sur **Suivant**.
