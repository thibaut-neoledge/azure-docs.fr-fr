...
2. Cliquez sur le bouton **Outils** dans le coin supérieur droit.  Dans **Options Internet**, sélectionnez l'onglet **Sécurité**, cliquez sur l'icône **Sites de confiance**, puis cliquez sur le bouton **Sites**. Ajoutez <i>http://*.mongodb.org</i> à la liste des sites de confiance.
