...
- Un compte [Dynamics CRM Online](https://www.microsoft.com/fr-FR/dynamics/crm-free-trial-overview.aspx)
...
1. Créez une application logique. Dans le Concepteur d’applications logiques, sélectionnez **Afficher les API gérées par Microsoft** dans la liste déroulante, puis entrez « dynamics » dans la zone de recherche. Sélectionnez l’un des déclencheurs ou actions : ![](./media/connectors-create-api-crmonline/dynamics-triggers.png)
