...
La requête ci-dessus lira les données de « MyTable » comprises dans la plage de durée de la tranche. La réexécution de cette tranche garantit toujours un tel comportement.
