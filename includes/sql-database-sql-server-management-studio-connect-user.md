## <a name="connect-to-azure-sql-database-as-a-user"></a>Connexion à une base de données SQL Azure en tant qu’utilisateur
...
* **Type de serveur**: la valeur par défaut est le moteur de base de données ; ne modifiez pas cette valeur.
  ...
  * **Nom du serveur** : Entrez le nom du serveur qui héberge votre base de données SQL Database au format *&lt;nomserveur>*.**database.windows.net**
