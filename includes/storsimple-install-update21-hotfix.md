...
5. Recherchez les correctifs supplémentaires répertoriés dans le tableau ci-dessus (**3103616**, **3146621**) et ajoutez-les au panier.
...
4. Tapez **Y** lorsque vous êtes invité à confirmer l’installation du correctif.
   ...
   > [!IMPORTANT]
   > Si vous installez la mise à jour 2.2, installez uniquement le fichier binaire, précédé de « all-hcsmdssoftwareudpate ». N’installez pas la mise à jour des agents CIS et MDS, précédée de all-cismdsagentupdatebundle. Dans le cas contraire, vous obtiendrez une erreur.
   > 
   > 
...
1. Lorsque la mise à jour logicielle est terminée, vérifiez les versions des logiciels du système. Entrez :
   ...
   * `MdsAgentVersion: 30.0.4698.16`
     ...
     > 
     > 
2. Répétez les étapes 3 à 5 pour installer le correctif logiciel restant en mode Normal.
   
   * Mise à jour de iSCSI KB3146621
   * Mise à jour de WMI KB3103616
3. Ignorez cette étape si vous mettez à jour à partir de la mise à jour 2. Si vous mettez à jour à partir d’une version antérieure à celle-ci, vous devrez également télécharger :

    - Pilote LSI KB3121900

    - Mise à jour de Spaceport KB3090322

    - Mise à jour de Storport KB3080728
