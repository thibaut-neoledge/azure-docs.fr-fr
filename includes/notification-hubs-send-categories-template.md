...
Si vous utilisez Mobile Services, reportez-vous aux didacticiels [Prise en main des notifications Push](mobile-services-dotnet-backend-windows-store-dotnet-get-started-push.md).
