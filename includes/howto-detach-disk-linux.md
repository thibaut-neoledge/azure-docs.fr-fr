...
3. Démontez chaque partition répertoriée pour le disque. Dans cet exemple : `$ sudo umount /dev/sdc1`
4. Utilisez la commande `blkid` pour détecter les UUID de toutes les partitions.
