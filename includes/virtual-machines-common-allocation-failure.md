...
- Supprimez toutes les machines virtuelles du service cloud et recréez-les.<br> Cliquez sur **Parcourir tout** > **Machines virtuelles (classiques)** > votre machine virtuelle > **Supprimer**. Cliquez ensuite sur **Nouveau** > **Calcul** > [image de machine virtuelle].
...
- Si votre service cloud existant n’utilise pas de réseau virtuel régional, créez un réseau virtuel pour le nouveau service cloud, puis connectez votre [réseau virtuel existant au nouveau réseau virtuel](https://azure.microsoft.com/blog/vnet-to-vnet-connecting-virtual-networks-in-azure-across-different-regions/). En savoir plus sur les [réseaux virtuels régionaux](https://azure.microsoft.com/blog/2014/05/14/regional-virtual-networks/).
