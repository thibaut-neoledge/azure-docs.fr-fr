...
> [!NOTE]
> L’erreur répertoriée dans chaque scénario d’allocation est une forme abrégée. Reportez-vous à la [Recherche de chaîne d’erreur](Recherche de chaîne .md#Error) pour les chaînes d’erreur détaillées.
> 
> 
