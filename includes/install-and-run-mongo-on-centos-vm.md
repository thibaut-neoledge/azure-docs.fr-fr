...
7. Après l'installation de MongoDB, vous devez configurer un point de terminaison pour que MongoDB soit accessible à distance. Dans le portail de gestion, cliquez sur **Machines virtuelles**, puis cliquez sur le nom de votre machine virtuelle, puis sur **Points de terminaison**.
