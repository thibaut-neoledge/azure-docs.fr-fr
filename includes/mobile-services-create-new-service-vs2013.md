...
5. Dans la boîte de dialogue **Créer un service mobile**, sélectionnez votre **Abonnement**, le serveur principal **JavaScript** dans **Runtime** et une **Région** pour votre service mobile, puis tapez un **Nom** pour votre service mobile.

	>[WACOM.NOTE]Les noms des services mobiles doivent être uniques. Une croix rouge s'affiche en regard du **Nom** lorsqu'il n'est pas disponible. 
