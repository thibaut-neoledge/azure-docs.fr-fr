...
### <a name="gwipnoconnection"></a>Modification de l’adresse IP de la passerelle sans connexion de passerelle
...
### <a name="gwipwithconnection"></a>Modification de l’adresse IP de la passerelle avec une connexion de passerelle existante
...
>[AZURE.IMPORTANT] Ne supprimez pas la passerelle VPN. Si vous la supprimez, vous devrez reprendre toute la procédure de création et reconfigurer votre routeur local avec l’adresse IP qui sera attribuée à la nouvelle passerelle.
