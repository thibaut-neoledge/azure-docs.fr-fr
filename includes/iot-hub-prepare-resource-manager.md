## Préparation de l’authentification des demandes de Resource Manager
...
Si vous n’avez pas installé [Azure PowerShell 1.0][lnk-powershell-install], vous pouvez le faire avec les commandes PowerShell suivantes. Vous devrez exécuter PowerShell en tant qu’administrateur.
