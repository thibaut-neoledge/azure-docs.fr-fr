## <a name="generate-an-api-app-client"></a>Générer un client de l'application API
...
1. Dans Visual Studio, ouvrez la solution qui contient l’application API de la rubrique [Créer une application API](../articles/app-service-api/app-service-dotnet-create-api-app.md). 
...
## <a name="test-the-api-app-client"></a>Test de l’application API
