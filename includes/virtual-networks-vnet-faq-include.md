...
Consultez la page [Présentation du réseau virtuel](../articles/virtual-network/virtual-networks-overview.md) pour afficher une table des décisions qui vous aidera à déterminer la meilleure option de conception de réseau pour vous.
...
### <a name="what-services-can-i-use-with-vnets"></a>Quels services puis-je utiliser avec les réseaux virtuels ?
...
* Fichier de configuration réseau (netcfg - pour les réseaux virtuels classiques uniquement). Voir [Configuration d’un réseau virtuel à l’aide d’un fichier de configuration réseau](../articles/virtual-network/virtual-networks-using-network-configuration-file.md).
...
Oui. Pour plus d’informations sur les plages d’adresses IP publiques, voir [Espace d’adressage IP Public dans un réseau virtuel (VNet)](../articles/virtual-network/virtual-networks-public-ip-within-vnet.md). N’oubliez pas que vos adresses IP publiques ne seront pas directement accessibles à partir d’Internet.
...
Oui. Vous pouvez utiliser le routage défini par utilisateur (UDR, User Defined Routing). Pour plus d’informations sur l’UDR, voir [Itinéraires définis d’utilisateur et transfert IP](../articles/virtual-network/virtual-networks-udr-overview.md).
...
Oui. Vous pouvez créer une communication de réseau virtuel à réseau virtuel à l’aide des API REST ou de Windows PowerShell. Vous pouvez également connecter des réseaux virtuels via l’homologation de réseau virtuel. Pour en savoir plus sur l’homologation, cliquez [ici](../articles/virtual-network/virtual-network-peering-overview.md).
...
Utilisez la table des décisions sur la page [Résolution de noms pour les machines virtuelles et les instances de rôle](../articles/virtual-network/virtual-networks-name-resolution-for-vms-and-role-instances.md) pour plus informations sur les options DNS disponibles.
...
## <a name="vnets-and-vms"></a>Réseaux virtuels et machines virtuelles
### <a name="can-i-deploy-vms-to-a-vnet"></a>Puis-je déployer des machines virtuelles sur un réseau virtuel ?
Oui.

### <a name="can-i-deploy-linux-vms-to-a-vnet"></a>Puis-je déployer des machines virtuelles Linux sur un réseau virtuel ?
...
### <a name="what-ip-address-will-my-vm-receive"></a>Quelle adresse IP ma machine virtuelle recevra-t-elle ?
...
### <a name="do-internal-ip-addresses-change-for-vms-in-a-vnet"></a>Les adresses IP internes peuvent-elles changer pour les machines virtuelles d’un réseau virtuel ?
...
### <a name="can-i-manually-assign-ip-addresses-to-nics-in-vms"></a>Puis-je attribuer manuellement des adresses IP aux cartes réseau des machines virtuelles ?
...
### <a name="what-happens-to-my-ip-addresses-if-i-shut-down-a-vm"></a>Qu’advient-il des adresses IP lorsqu’une machine virtuelle est arrêtée ?
...
> [!NOTE]
> Si vous voulez simplement arrêter la machine virtuelle, n’utilisez pas le portail de gestion pour ce faire. Actuellement, le bouton d’arrêt désalloue la machine virtuelle.
> 
> 
...
Oui. Pour plus d’informations, consultez la [page suivante](../articles/virtual-network/virtual-networks-move-vm-role-to-subnet.md):
...
Oui, l’adresse MAC est identique pour une machine virtuelle qui a été arrêtée (désallouée) et relancée.
...
### <a name="can-i-use-web-apps-with-virtual-network"></a>Puis-je utiliser des applications web avec un réseau virtuel ?
...
* [Création d'applications web dans un environnement App Service](../articles/app-service-web/app-service-web-how-to-create-a-web-app-in-an-ase.md)
...
### <a name="how-do-i-deploy-paas-roles-to-a-vnet"></a>Comment déployer des rôles PaaS sur un réseau virtuel ?
...
## <a name="vnets-and-security"></a>Réseaux virtuels et sécurité
...
### <a name="can-i-define-acls-or-nsgs-on-my-vnets"></a>Puis-je définir des listes ACL ou des groupes NSG sur mes réseaux virtuels ?
...
### <a name="is-there-a-vnet-security-whitepaper"></a>Existe-t-il un livre blanc sécurité des réseaux virtuels ?
