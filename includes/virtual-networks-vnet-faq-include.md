...
Consultez la page [Présentation du réseau virtuel](virtual-networks-overview.md) pour afficher une table des décisions qui vous aidera à déterminer la meilleure option de conception de réseau pour vous.
