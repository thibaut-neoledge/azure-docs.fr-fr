* [Déploiement d'une application dans Azure App Service](../app-service-web/web-sites-deploy.md)
* [Configuration du contrôle de code source et de l'intégration continue](../app-service-web/web-sites-publish-source-control.md)
* [Déploiements intermédiaires avec les emplacements de déploiement](../app-service-web/web-sites-staged-publishing.md)
