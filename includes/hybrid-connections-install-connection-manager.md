...
1. La connexion que vous venez de créer doit avoir pour **état** **Le programme d’installation local n’a pas terminé**. Cliquez sur cette connexion, puis sur **Programme d’installation local**.
   
    ![Programme d’installation local](./media/hybrid-connections-install-connection-manager/5-1.png)
