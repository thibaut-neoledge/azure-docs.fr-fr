...
3. Dans la boîte de dialogue **Ajouter une stratégie de sauvegarde**, sous **Définir votre stratégie de sauvegarde** :
...
4. Sous **Définir une planification**, procédez comme suit :
    ...
    6. Cliquez sur l’icône en forme de coche ![icône en forme de coche](./media/storsimple-add-backup-policy-u2/HCS_CheckIcon-include.png) pour enregistrer la stratégie.
