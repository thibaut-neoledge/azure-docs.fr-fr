...
Pour plus d’informations sur les comptes et les abonnements Azure, consultez la [procédure de connexion à votre abonnement](../articles/powershell-install-configure.md#step-3-connect).
