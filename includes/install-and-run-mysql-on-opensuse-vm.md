...
11. Après l'installation de MySQL, vous devez configurer un point de terminaison pour que MySQL soit accessible à distance. Connectez-vous au [portail Azure][AzurePortal]. Cliquez sur **Machines virtuelles**, sur le nom de la nouvelle machine virtuelle, puis sur **Points de terminaison**.

12. Cliquez sur **Ajouter** en bas de la page.

13. Ajoutez un point de terminaison avec le nom « MySQL », le protocole **TCP** ainsi que les ports **Public** et **Privé** définis sur « 3306 ».

14. Pour vous connecter à distance à la machine virtuelle à partir de votre ordinateur, tapez :
