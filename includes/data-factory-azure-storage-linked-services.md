...
Consultez l’article suivant pour savoir comment afficher ou copier la clé de compte pour un stockage Azure : [Affichage, copie et régénération de clés d’accès de stockage](../articles/storage/storage-create-storage-account.md#view-copy-and-regenerate-storage-access-keys).
